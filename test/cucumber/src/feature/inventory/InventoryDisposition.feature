Feature: Employee inventory disposition
  ...
  Scenario: Existing employee adds an inventory disposition, edits it, changes its status, and then deletes it
    ...
    And the user sets the inventory disposition's inventory disposition name to "CucumberInventoryDisposition"
    ...
    And the user sets the inventory disposition's description to "Cucumber Inventory Disposition"
    ...
    And the user sets the inventory disposition's description to "Edited Cucumber Inventory Disposition"
