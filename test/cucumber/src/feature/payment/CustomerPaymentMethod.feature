Feature: Party payment methods
  ...
  Scenario: Existing customer tries to add a credit card that has a bad number
    ...
    And the customer Test sets the payment method to be the default
    And the customer Test sets the payment method's sort order to "1"
    And the customer Test sets the payment method's number to "1111111111111111"
    And the customer Test sets the payment method's security code to "123"
    And the customer Test sets the payment method's expiration month to "3"
    And the customer Test sets the payment method's expiration year to "2030"
    And the customer Test sets the payment method's first name to "Test"
  ...
  Scenario: Existing customer tries to add a credit card that is expired
    ...
    And the customer Test sets the payment method's security code to "123"
    And the customer Test sets the payment method's expiration month to "3"
    And the customer Test sets the payment method's expiration year to "2010"
    And the customer Test sets the payment method's first name to "Test"
    And the customer Test sets the payment method's last name to "Customer"
    And the customer Test begins entering a new postal address
    And the customer Test sets the postal address's first name to "Test"
  ...
  Scenario: Existing customer adds, edits and then deletes a credit card
    ...
    And the customer Test adds the new payment method
    Then no error should occur
    And the customer Test begins editing the last payment method added
    And the customer Test sets the payment method's description to "My Edited Card"
    And the customer Test sets the payment method's number to "4444333322221111"
    And the customer Test sets the payment method's security code to "456"
    And the customer Test sets the payment method's expiration month to "4"
    And the customer Test sets the payment method's expiration year to "2031"
    And the customer Test finishes editing the payment method
    And the customer Test deletes the last payment method added
    Then no error should occur
    And the customer Test deletes the last postal address added
    Then no error should occur
