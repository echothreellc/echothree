...
public class TermServicePingTest
        extends TestCase {
    private TermService termService;
    
    /** Creates a new instance of TermServiceTest */
    public TermServicePingTest(String name) {
        super(name);
    }
    ...
    public static Test suite() {
        ...
        suite.addTest(new TermServicePingTest("testPingTermService"));
    ...
    public void testPingTermService() {
        setUp();
        try {
            termService.ping();
        } catch (Exception e) {
