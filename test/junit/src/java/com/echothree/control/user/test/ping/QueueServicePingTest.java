...
public class QueueServicePingTest
        extends TestCase {
    private QueueService queueService;
    
    /** Creates a new instance of QueueServiceTest */
    public QueueServicePingTest(String name) {
        super(name);
    }
    ...
    public static Test suite() {
        ...
        suite.addTest(new QueueServicePingTest("testPingQueueService"));
    ...
    public void testPingQueueService() {
        setUp();
        try {
            queueService.ping();
        } catch (Exception e) {
