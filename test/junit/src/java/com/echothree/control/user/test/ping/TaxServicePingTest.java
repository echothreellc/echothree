...
public class TaxServicePingTest
        extends TestCase {
    private TaxService taxService;
    
    /** Creates a new instance of TaxServiceTest */
    public TaxServicePingTest(String name) {
        super(name);
    }
    ...
    public static Test suite() {
        ...
        suite.addTest(new TaxServicePingTest("testPingTaxService"));
    ...
    public void testPingTaxService() {
        setUp();
        try {
            taxService.ping();
        } catch (Exception e) {
