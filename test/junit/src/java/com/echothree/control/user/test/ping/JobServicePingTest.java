...
public class JobServicePingTest
        extends TestCase {
    private JobService jobService;
    
    /** Creates a new instance of JobServiceTest */
    public JobServicePingTest(String name) {
        super(name);
    }
    ...
    public static Test suite() {
        ...
        suite.addTest(new JobServicePingTest("testPingJobService"));
    ...
    public void testPingJobService() {
        setUp();
        try {
            jobService.ping();
        } catch (Exception e) {
