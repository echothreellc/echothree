...
/usr/local/jboss
    ...
    ... wildfly-latest -> wildfly-15.0.0.Final
```
...
As jboss:
```
$ cd Java/wildfly-15.0.0.Final/bin
$ ./add-user.sh
...
Added user 'lukeskywalker' to file '/usr/local/jboss/wildfly-15.0.0.Final/standalone/configuration/mgmt-users.properties'
Added user 'lukeskywalker' to file '/usr/local/jboss/wildfly-15.0.0.Final/domain/configuration/mgmt-users.properties'
Added user 'lukeskywalker' with groups  to file '/usr/local/jboss/wildfly-15.0.0.Final/standalone/configuration/mgmt-groups.properties'
Added user 'lukeskywalker' with groups  to file '/usr/local/jboss/wildfly-15.0.0.Final/domain/configuration/mgmt-groups.properties'
