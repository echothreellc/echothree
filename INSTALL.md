...
/usr/local/jboss
    ...
    ... wildfly-latest -> wildfly-26.1.2.Final
```
...
Added user 'lukeskywalker' to file '/usr/local/jboss/wildfly-26.1.2.Final/standalone/configuration/mgmt-users.properties'
Added user 'lukeskywalker' to file '/usr/local/jboss/wildfly-26.1.2.Final/domain/configuration/mgmt-users.properties'
Added user 'lukeskywalker' with groups  to file '/usr/local/jboss/wildfly-26.1.2.Final/standalone/configuration/mgmt-groups.properties'
Added user 'lukeskywalker' with groups  to file '/usr/local/jboss/wildfly-26.1.2.Final/domain/configuration/mgmt-groups.properties'
