...
public class OrderRoleControl
    ...
    public OrderRole createOrderRole(Order order, Party party, OrderRoleType orderRoleType, BasePK createdBy) {
        ...
        sendEventUsingNames(order.getPrimaryKey(), EventTypes.MODIFY, orderRole.getPrimaryKey(), EventTypes.CREATE, createdBy);
    ...
    public void deleteOrderRole(OrderRole orderRole, BasePK deletedBy) {
        ...
        sendEventUsingNames(orderRole.getOrderPK(), EventTypes.MODIFY, orderRole.getPrimaryKey(), EventTypes.DELETE, deletedBy);
    }
