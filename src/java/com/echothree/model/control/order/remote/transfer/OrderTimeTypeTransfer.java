...
public class OrderTimeTypeTransfer
    ...
    /** Creates a new instance of OrderTimeTypeTransfer */
    public OrderTimeTypeTransfer(String orderTimeTypeName, Boolean isDefault, Integer sortOrder, String description) {
