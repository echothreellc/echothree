...
public class CommentControl
    ...
    public CommentType createCommentType(EntityType entityType, String commentTypeName, Sequence commentSequence,
        ...
        sendEventUsingNames(commentType.getPrimaryKey(), EventTypes.CREATE, null, null, createdBy);
    ...
    public void updateCommentTypeFromValue(CommentTypeDetailValue commentTypeDetailValue, BasePK updatedBy) {
        if(commentTypeDetailValue.hasBeenModified()) {
            ...
            sendEventUsingNames(commentTypePK, EventTypes.MODIFY, null, null, updatedBy);
        }
    }
    ...
    public void deleteCommentType(CommentType commentType, BasePK deletedBy) {
        ...
        sendEventUsingNames(commentType.getPrimaryKey(), EventTypes.DELETE, null, null, deletedBy);
    }
    ...
    public CommentTypeDescription createCommentTypeDescription(CommentType commentType, Language language, String description,
        ...
        sendEventUsingNames(commentType.getPrimaryKey(), EventTypes.MODIFY, commentTypeDescription.getPrimaryKey(), EventTypes.CREATE, createdBy);
    ...
    public void updateCommentTypeDescriptionFromValue(CommentTypeDescriptionValue commentTypeDescriptionValue, BasePK updatedBy) {
        if(commentTypeDescriptionValue.hasBeenModified()) {
            ...
            sendEventUsingNames(commentType.getPrimaryKey(), EventTypes.MODIFY, commentTypeDescription.getPrimaryKey(), EventTypes.MODIFY, updatedBy);
        }
    }
    ...
    public void deleteCommentTypeDescription(CommentTypeDescription commentTypeDescription, BasePK deletedBy) {
        ...
        sendEventUsingNames(commentTypeDescription.getCommentTypePK(), EventTypes.MODIFY, commentTypeDescription.getPrimaryKey(), EventTypes.DELETE, deletedBy);
    ...
    public CommentUsageType createCommentUsageType(CommentType commentType, String commentUsageTypeName, Boolean selectedByDefault,
        ...
        sendEventUsingNames(commentUsageType.getPrimaryKey(), EventTypes.CREATE, null, null, createdBy);
    ...
    public void updateCommentUsageTypeFromValue(CommentUsageTypeDetailValue commentUsageTypeDetailValue, BasePK updatedBy) {
        if(commentUsageTypeDetailValue.hasBeenModified()) {
            ...
            sendEventUsingNames(commentUsageTypePK, EventTypes.MODIFY, null, null, updatedBy);
        }
    }
    ...
    public void deleteCommentUsageType(CommentUsageType commentUsageType, BasePK deletedBy) {
        ...
        sendEventUsingNames(commentUsageType.getPrimaryKey(), EventTypes.DELETE, null, null, deletedBy);
    }
    ...
    public CommentUsageTypeDescription createCommentUsageTypeDescription(CommentUsageType commentUsageType, Language language,
        ...
        sendEventUsingNames(commentUsageType.getPrimaryKey(), EventTypes.MODIFY, commentUsageTypeDescription.getPrimaryKey(), EventTypes.CREATE, createdBy);
    ...
    public void updateCommentUsageTypeDescriptionFromValue(CommentUsageTypeDescriptionValue commentUsageTypeDescriptionValue, BasePK updatedBy) {
        if(commentUsageTypeDescriptionValue.hasBeenModified()) {
            ...
            sendEventUsingNames(commentUsageType.getPrimaryKey(), EventTypes.MODIFY, commentUsageTypeDescription.getPrimaryKey(), EventTypes.MODIFY, updatedBy);
        }
    }
    ...
    public void deleteCommentUsageTypeDescription(CommentUsageTypeDescription commentUsageTypeDescription, BasePK deletedBy) {
        ...
        sendEventUsingNames(commentUsageTypeDescription.getCommentUsageTypePK(), EventTypes.MODIFY, commentUsageTypeDescription.getPrimaryKey(), EventTypes.DELETE, deletedBy);
    ...
    public Comment createComment(String commentName, CommentType commentType, EntityInstance commentedEntityInstance,
        ...
        sendEventUsingNames(comment.getPrimaryKey(), EventTypes.CREATE, null, null, createdBy);
        sendEventUsingNames(commentedEntityInstance, EventTypes.TOUCH, comment.getPrimaryKey(), EventTypes.CREATE, createdBy);
    ...
    public void updateCommentFromValue(CommentDetailValue commentDetailValue,  BasePK updatedBy) {
        if(commentDetailValue.hasBeenModified()) {
            ...
            sendEventUsingNames(comment.getPrimaryKey(), EventTypes.MODIFY, null, null, updatedBy);
            sendEventUsingNames(commentDetail.getCommentedEntityInstance(), EventTypes.TOUCH, comment.getPrimaryKey(), EventTypes.MODIFY, updatedBy);
        }
    }
        ...
        if(workflowEntrance != null) {
            ...
            if(workflowDestination != null || commentStatusChoice == null) {
                ...
                if(!eea.hasExecutionErrors()) {
                    sendEventUsingNames(comment.getLastDetail().getCommentedEntityInstance(), EventTypes.TOUCH, comment.getPrimaryKey(), EventTypes.MODIFY, modifiedBy);
                }
            } else {
    ...
    public void deleteComment(Comment comment, BasePK deletedBy) {
        ...
        sendEventUsingNames(comment.getPrimaryKey(), EventTypes.DELETE, null, null, deletedBy);
        sendEventUsingNames(commentDetail.getCommentedEntityInstance(), EventTypes.TOUCH, comment.getPrimaryKey(), EventTypes.DELETE, deletedBy);
    }
    ...
    public CommentString createCommentString(Comment comment, String string, BasePK createdBy) {
        ...
        sendEventUsingNames(comment.getPrimaryKey(), EventTypes.MODIFY, commentString.getPrimaryKey(), EventTypes.CREATE, createdBy);
        sendEventUsingNames(comment.getLastDetail().getCommentedEntityInstance(), EventTypes.TOUCH, comment.getPrimaryKey(), EventTypes.MODIFY, createdBy);
    ...
    public void updateCommentStringFromValue(CommentStringValue commentStringValue, BasePK updatedBy) {
        if(commentStringValue.hasBeenModified()) {
            ...
            sendEventUsingNames(commentPK, EventTypes.MODIFY, commentString.getPrimaryKey(), EventTypes.MODIFY, updatedBy);
            sendEventUsingNames(commentString.getComment().getLastDetail().getCommentedEntityInstance(), EventTypes.TOUCH, commentString.getCommentPK(), EventTypes.MODIFY, updatedBy);
        }
    }
    ...
    public void deleteCommentString(CommentString commentString, BasePK deletedBy) {
        ...
        sendEventUsingNames(commentString.getCommentPK(), EventTypes.MODIFY, commentString.getPrimaryKey(), EventTypes.DELETE, deletedBy);
        sendEventUsingNames(commentString.getComment().getLastDetail().getCommentedEntityInstance(), EventTypes.TOUCH, commentString.getCommentPK(), EventTypes.MODIFY, deletedBy);
    }
    ...
    public CommentBlob createCommentBlob(Comment comment, ByteArray blob, BasePK createdBy) {
        ...
        sendEventUsingNames(comment.getPrimaryKey(), EventTypes.MODIFY, commentBlob.getPrimaryKey(), EventTypes.CREATE, createdBy);
        sendEventUsingNames(comment.getLastDetail().getCommentedEntityInstance(), EventTypes.TOUCH, comment.getPrimaryKey(), EventTypes.MODIFY, createdBy);
    ...
    public void updateCommentBlobFromValue(CommentBlobValue commentBlobValue, BasePK updatedBy) {
        if(commentBlobValue.hasBeenModified()) {
            ...
            sendEventUsingNames(commentPK, EventTypes.MODIFY, commentBlob.getPrimaryKey(), EventTypes.MODIFY, updatedBy);
            sendEventUsingNames(commentBlob.getComment().getLastDetail().getCommentedEntityInstance(), EventTypes.TOUCH, commentBlob.getCommentPK(), EventTypes.MODIFY, updatedBy);
        }
    }
    ...
    public void deleteCommentBlob(CommentBlob commentBlob, BasePK deletedBy) {
        ...
        sendEventUsingNames(commentBlob.getCommentPK(), EventTypes.MODIFY, commentBlob.getPrimaryKey(), EventTypes.DELETE, deletedBy);
        sendEventUsingNames(commentBlob.getComment().getLastDetail().getCommentedEntityInstance(), EventTypes.TOUCH, commentBlob.getCommentPK(), EventTypes.MODIFY, deletedBy);
    }
    ...
    public CommentClob createCommentClob(Comment comment, String clob, BasePK createdBy) {
        ...
        sendEventUsingNames(comment.getPrimaryKey(), EventTypes.MODIFY, commentClob.getPrimaryKey(), EventTypes.CREATE, createdBy);
        sendEventUsingNames(comment.getLastDetail().getCommentedEntityInstance(), EventTypes.TOUCH, comment.getPrimaryKey(), EventTypes.MODIFY, createdBy);
    ...
    public void updateCommentClobFromValue(CommentClobValue commentClobValue, BasePK updatedBy) {
        if(commentClobValue.hasBeenModified()) {
            ...
            sendEventUsingNames(commentPK, EventTypes.MODIFY, commentClob.getPrimaryKey(), EventTypes.MODIFY, updatedBy);
            sendEventUsingNames(commentClob.getComment().getLastDetail().getCommentedEntityInstance(), EventTypes.TOUCH, commentClob.getCommentPK(), EventTypes.MODIFY, updatedBy);
        }
    }
    ...
    public void deleteCommentClob(CommentClob commentClob, BasePK deletedBy) {
        ...
        sendEventUsingNames(commentClob.getCommentPK(), EventTypes.MODIFY, commentClob.getPrimaryKey(), EventTypes.DELETE, deletedBy);
        sendEventUsingNames(commentClob.getComment().getLastDetail().getCommentedEntityInstance(), EventTypes.TOUCH, commentClob.getCommentPK(), EventTypes.MODIFY, deletedBy);
    }
    ...
    public CommentUsage createCommentUsage(Comment comment, CommentUsageType commentUsageType, BasePK createdBy) {
        ...
        sendEventUsingNames(comment.getPrimaryKey(), EventTypes.MODIFY, commentUsage.getPrimaryKey(), EventTypes.CREATE, createdBy);
        sendEventUsingNames(comment.getLastDetail().getCommentedEntityInstance(), EventTypes.TOUCH, comment.getPrimaryKey(), EventTypes.MODIFY, createdBy);
    ...
    public void deleteCommentUsage(CommentUsage commentUsage, BasePK deletedBy) {
        ...
        sendEventUsingNames(commentUsage.getCommentPK(), EventTypes.MODIFY, commentUsage.getPrimaryKey(), EventTypes.DELETE, deletedBy);
        sendEventUsingNames(commentUsage.getComment().getLastDetail().getCommentedEntityInstance(), EventTypes.TOUCH, commentUsage.getCommentPK(), EventTypes.MODIFY, deletedBy);
    }
