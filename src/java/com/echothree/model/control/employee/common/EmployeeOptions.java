...
package com.echothree.model.control.employee.common;

public interface EmployeeOptions {
    
    String EmployeeIncludePartyRelationships = "EmployeeIncludePartyRelationships";
    String EmployeeIncludePartyRelationshipsByFromParty = "EmployeeIncludePartyRelationshipsByFromParty";
    String EmployeeIncludePartyRelationshipsByToParty = "EmployeeIncludePartyRelationshipsByToParty";
    String EmployeeIncludeEmployments = "EmployeeIncludeEmployments";
    String EmployeeIncludeLeaves = "EmployeeIncludeLeaves";
