...
public abstract class BaseCancellationPolicyTransferCache<K extends BaseEntity, V extends BaseTransfer>
    ...
    public BaseCancellationPolicyTransferCache(UserVisit userVisit, CancellationPolicyControl cancellationPolicyControl) {
        super(userVisit);
