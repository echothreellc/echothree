...
@GraphQLDescription("create sales order line result object")
@GraphQLName("CreateSalesOrderLineResult")
public class CreateSalesOrderLineResultObject
        extends MutationResultWithIdObject {

    String orderName;
    String orderLineSequence;

    public void setCreateSalesOrderLineResult(final CreateSalesOrderLineResult result) {
        setEntityInstanceFromEntityRef(result.getEntityRef());

        this.orderName = result.getOrderName();
        this.orderLineSequence = result.getOrderLineSequence();
    }
