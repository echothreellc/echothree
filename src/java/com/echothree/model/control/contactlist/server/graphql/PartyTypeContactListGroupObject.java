...
@GraphQLDescription("party type contact list group object")
@GraphQLName("PartyTypeContactListGroup")
public class PartyTypeContactListGroupObject
        extends BaseObject {

    private final PartyTypeContactListGroup partyTypeContactListGroup; // Always Present

    public PartyTypeContactListGroupObject(PartyTypeContactListGroup partyTypeContactListGroup) {
        this.partyTypeContactListGroup = partyTypeContactListGroup;
    }

    @GraphQLField
    @GraphQLDescription("party type")
    public PartyTypeObject getPartyType(final DataFetchingEnvironment env) {
        var partyType = partyTypeContactListGroup.getPartyType();
    ...
    public ContactListGroupObject getContactListGroup(final DataFetchingEnvironment env) {
        var contactListGroup = partyTypeContactListGroup.getContactListGroup();
    ...
    public boolean getAddWhenCreated() {
        return partyTypeContactListGroup.getAddWhenCreated();
    }
