...
public class ContactListFrequencyTransfer
    ...
    /** Creates a new instance of ContactListFrequencyTransfer */
    public ContactListFrequencyTransfer(String contactListFrequencyName, Boolean isDefault, Integer sortOrder, String description) {
