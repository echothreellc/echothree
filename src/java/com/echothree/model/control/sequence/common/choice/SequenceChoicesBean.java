...
public class SequenceChoicesBean
        extends BaseChoicesBean {
    
    /** Creates a new instance of SequenceChoicesBean */
    public SequenceChoicesBean(List<String> labels, List<String> values, String defaultValue) {
