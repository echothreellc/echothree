...
public class SequenceEncoderTypeObject
    ...
    public SequenceEncoderTypeObject(SequenceEncoderType sequenceEncoderType) {
        this.sequenceEncoderType = sequenceEncoderType;
    }

    @GraphQLField
    @GraphQLDescription("sequence encoder type name")
    @GraphQLNonNull
    public String getSequenceEncoderTypeName() {
        return sequenceEncoderType.getSequenceEncoderTypeName();
    }
    ...
    public boolean getIsDefault() {
        return sequenceEncoderType.getIsDefault();
    }
    ...
    public int getSortOrder() {
        return sequenceEncoderType.getSortOrder();
    }
