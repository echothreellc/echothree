...
import com.echothree.model.control.printer.common.exception.UnknownPrinterGroupUseTypeNameException;
...
public class PrinterGroupUseTypeLogic
    ...
    public static PrinterGroupUseTypeLogic getInstance() {
        return CDI.current().select(PrinterGroupUseTypeLogic.class).get();
    }
    ...
    public PrinterGroupUseType getPrinterGroupUseTypeByName(final ExecutionErrorAccumulator eea, final String printerGroupUseTypeName) {
        ...
        if(printerGroupUseType == null) {
            handleExecutionError(UnknownPrinterGroupUseTypeNameException.class, eea, ExecutionErrors.UnknownPrinterGroupUseTypeName.name(), printerGroupUseTypeName);
        }
