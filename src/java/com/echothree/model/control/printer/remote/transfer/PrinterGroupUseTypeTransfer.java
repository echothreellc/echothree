...
public class PrinterGroupUseTypeTransfer
    ...
    /** Creates a new instance of PrinterGroupUseTypeTransfer */
    public PrinterGroupUseTypeTransfer(String printerGroupUseTypeName, Boolean isDefault, Integer sortOrder, String description) {
    ...
    /**
     * @param printerGroupUseTypeName the printerGroupUseTypeName to set
     */
