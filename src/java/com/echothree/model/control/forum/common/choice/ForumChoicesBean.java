...
public class ForumChoicesBean
        extends BaseChoicesBean {
    
    /** Creates a new instance of ForumChoicesBean */
    public ForumChoicesBean(List<String> labels, List<String> values, String defaultValue) {
