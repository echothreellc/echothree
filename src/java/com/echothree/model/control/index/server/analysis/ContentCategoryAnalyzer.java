...
public class ContentCategoryAnalyzer
    ...
    public ContentCategoryAnalyzer(final ExecutionErrorAccumulator eea, final Language language, final EntityType entityType, final List<EntityAttribute> entityAttributes,
