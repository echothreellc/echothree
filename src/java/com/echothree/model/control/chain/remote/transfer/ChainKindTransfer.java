...
public class ChainKindTransfer
    ...
    /** Creates a new instance of ChainKindTransfer */
    public ChainKindTransfer(String chainKindName, Boolean isDefault, Integer sortOrder, String description) {
    ...
    /**
     * @param chainKindName the chainKindName to set
     */
