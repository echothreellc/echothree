...
public class FilterChoicesBean
        extends BaseChoicesBean {
    
    /** Creates a new instance of FilterChoicesBean */
    public FilterChoicesBean(List<String> labels, List<String> values, String defaultValue) {
