...
public class FilterAdjustmentTypeObject
    ...
    public String getDescription(final DataFetchingEnvironment env) {
        ...
        return filterAdjustmentControl.getBestFilterAdjustmentTypeDescription(filterAdjustmentType, userControl.getPreferredLanguageFromUserVisit(BaseGraphQl.getUserVisit(env)));
    }
