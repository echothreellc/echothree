...
public class CountyChoicesBean
        extends BaseChoicesBean {
    
    /** Creates a new instance of CountyChoicesBean */
    public CountyChoicesBean(List<String> labels, List<String> values, String defaultValue) {
