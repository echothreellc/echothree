...
public class StateChoicesBean
        extends BaseChoicesBean {
    
    /** Creates a new instance of StateChoicesBean */
    public StateChoicesBean(List<String> labels, List<String> values, String defaultValue) {
