...
public class PostalCodeTransfer
        extends GeoCodeTransfer {
    
    private CountryTransfer country;
    
    /** Creates a new instance of PostalCodeTransfer */
    public PostalCodeTransfer(CountryTransfer country, String geoCodeName, GeoCodeTypeTransfer geoCodeType,
