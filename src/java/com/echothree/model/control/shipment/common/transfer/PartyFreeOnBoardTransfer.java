...
public class PartyFreeOnBoardTransfer
    ...
    public PartyFreeOnBoardTransfer(PartyTransfer party, FreeOnBoardTransfer freeOnBoard) {
        this.party = party;
    ...
    public void setFreeOnBoard(final FreeOnBoardTransfer freeOnBoard) {
        this.freeOnBoard = freeOnBoard;
    }
