...
package com.echothree.model.control.customer.server.analyzer;
...
public class CustomerAnalyzer
    ...
    public CustomerAnalyzer(final ExecutionErrorAccumulator eea, final Language language, final EntityType entityType, final List<EntityAliasType> entityAliasTypes, final List<EntityAttribute> entityAttributes,
    ...
    public CustomerAnalyzer(final ExecutionErrorAccumulator eea, final Language language, final EntityType entityType,
    ...
    protected Map<String, Analyzer> getAdditionalAnalyzers(final Map<String, Analyzer> fieldAnalyzers) {
        fieldAnalyzers.put(IndexFields.customerTypeName.name(), new WhitespaceLowerCaseAnalyzer());
