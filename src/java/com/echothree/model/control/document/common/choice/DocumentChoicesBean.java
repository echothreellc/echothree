...
public class DocumentChoicesBean
        extends BaseChoicesBean {
    
    /** Creates a new instance of DocumentChoicesBean */
    public DocumentChoicesBean(List<String> labels, List<String> values, String defaultValue) {
