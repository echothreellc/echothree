...
package com.echothree.model.control.security.server.search;
...
public class SecurityRoleSearchEvaluator
    ...
    /** Creates a new instance of SecurityRoleSearchEvaluator */
    public SecurityRoleSearchEvaluator(UserVisit userVisit, Language language, SearchType searchType, SearchDefaultOperator searchDefaultOperator,
        ...
        super(userVisit, searchDefaultOperator, searchType, searchSortOrder, searchSortDirection, searchUseType, ComponentVendors.ECHOTHREE.name(),
                EntityTypes.SecurityRole.name(), IndexConstants.IndexType_SECURITY_ROLE, language, null);
    ...
    public SortField[] getSortFields(String searchSortOrderName) {
        ...
        if(searchSortOrderName.equals(SearchSortOrders.SCORE.name())) {
            ...
            sortFields = new SortField[]{
                new SortField(IndexConstants.IndexField_SecurityRoleGroupName + IndexConstants.IndexFieldVariation_Separator + IndexConstants.IndexFieldVariation_Sortable, SortField.Type.STRING, reverse),
                new SortField(IndexConstants.IndexField_SecurityRoleName + IndexConstants.IndexFieldVariation_Separator + IndexConstants.IndexFieldVariation_Sortable, SortField.Type.STRING, reverse)
            };
