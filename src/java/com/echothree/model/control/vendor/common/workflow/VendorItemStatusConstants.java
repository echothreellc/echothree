...
package com.echothree.model.control.vendor.common.workflow;

public interface VendorItemStatusConstants {
    
    String Workflow_VENDOR_ITEM_STATUS = "VENDOR_ITEM_STATUS";
