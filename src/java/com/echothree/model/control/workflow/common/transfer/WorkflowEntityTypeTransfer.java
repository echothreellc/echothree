...
public class WorkflowEntityTypeTransfer
        extends BaseTransfer {
    
    private WorkflowTransfer workflow;
    private EntityTypeTransfer entityType;
    
    /** Creates a new instance of WorkflowEntityTypeTransfer */
    public WorkflowEntityTypeTransfer(WorkflowTransfer workflow, EntityTypeTransfer entityType) {
