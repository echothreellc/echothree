...
public class RatingTypeLogic
    ...
    private RatingTypeLogic() {
        super();
    }

    private static class RatingTypeLogicHolder {
        static RatingTypeLogic instance = new RatingTypeLogic();
    }

    public static RatingTypeLogic getInstance() {
        return RatingTypeLogicHolder.instance;
    }
