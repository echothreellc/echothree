...
public class UserVisitGroupTransfer
        extends BaseTransfer {
    
    private String userVisitGroupName;
    private WorkflowEntityStatusTransfer userVisitGroupStatus;
    
    /** Creates a new instance of UserVisitGroupTransfer */
    public UserVisitGroupTransfer(String userVisitGroupName,
