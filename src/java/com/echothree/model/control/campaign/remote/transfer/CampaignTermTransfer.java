...
public class CampaignTermTransfer
        extends BaseTransfer {
    
    private String campaignTermName;
    private String valueSha1Hash;
    private String value;
    private Boolean isDefault;
    private Integer sortOrder;
    private String description;
    private WorkflowEntityStatusTransfer campaignTermStatus;
    
    /** Creates a new instance of CampaignTermTransfer */
    public CampaignTermTransfer(String campaignTermName, String valueSha1Hash, String value, Boolean isDefault, Integer sortOrder, String description,
            WorkflowEntityStatusTransfer campaignTermStatus) {
        this.campaignTermName = campaignTermName;
        this.valueSha1Hash = valueSha1Hash;
        this.value = value;
        this.isDefault = isDefault;
        this.sortOrder = sortOrder;
        this.description = description;
        this.campaignTermStatus = campaignTermStatus;
    }
