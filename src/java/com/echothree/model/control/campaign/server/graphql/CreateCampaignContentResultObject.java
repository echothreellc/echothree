...
@GraphQLName("CreateCampaignContentResult")
public class CreateCampaignContentResultObject
        extends MutationResultWithIdObject {

    String campaignContentName;

    public void setCreateCampaignContentResult(final CreateCampaignContentResult result) {
        setEntityInstanceFromEntityRef(result.getEntityRef());

        this.campaignContentName = result.getCampaignContentName();
    }
