...
public class TransactionGlAccountTransfer
        extends BaseTransfer {
    
    private TransactionGlAccountCategoryTransfer transactionGlAccountCategory;
    private GlAccountTransfer glAccount;
    
    /** Creates a new instance of TransactionGlAccountTransfer */
    public TransactionGlAccountTransfer(TransactionGlAccountCategoryTransfer transactionGlAccountCategory, GlAccountTransfer glAccount) {
