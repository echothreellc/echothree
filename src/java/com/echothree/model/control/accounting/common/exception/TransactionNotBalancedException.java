...
public class TransactionNotBalancedException
        extends BaseOfferException {

    /** Creates a new instance of TransactionNotBalancedException */
    ...
    /** Creates a new instance of TransactionNotBalancedException */
    public TransactionNotBalancedException(Throwable cause) {
        super(cause);
    }

    /** Creates a new instance of TransactionNotBalancedException */
    public TransactionNotBalancedException(Message message) {
        super(message);
    }
