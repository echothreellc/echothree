...
import com.echothree.model.control.accounting.remote.transfer.TransactionEntityRoleTransfer;
import com.echothree.model.control.accounting.remote.transfer.TransactionEntityRoleTypeTransfer;
...
public class TransactionEntityRoleTransferCache
    ...
    public TransactionEntityRoleTransfer getTransfer(TransactionEntityRole transactionEntityRole) {
        ...
        if(transactionEntityRoleTransfer == null) {
            ...
            EntityInstanceTransfer entityInstance = coreControl.getEntityInstanceTransfer(userVisit, transactionEntityRole.getEntityInstance(), false, false, false, false, false);
