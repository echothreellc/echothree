...
public class TransactionBalancedResult
        implements BaseDatabaseResult {
    
    private Long originalDifference;
    private Long difference;

    public Long getOriginalDifference() {
        return originalDifference;
    }

    public void setOriginalDifference(final Long originalDifference) {
