...
public class GenderChoicesBean
        extends BaseChoicesBean {
    
    /** Creates a new instance of GenderChoicesBean */
    public GenderChoicesBean(List<String> labels, List<String> values, String defaultValue) {
