...
public class MoodTransfer
    ...
    /** Creates a new instance of MoodTransfer */
    public MoodTransfer(String moodName, IconTransfer icon, Boolean isDefault, Integer sortOrder, String description) {
