...
public class MessageChoicesBean
        extends BaseChoicesBean {
    
    /** Creates a new instance of MessageChoicesBean */
    public MessageChoicesBean(List<String> labels, List<String> values, String defaultValue) {
