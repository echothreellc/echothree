...
public class FinancialAccountTransactionTypeChoicesBean
    ...
    /** Creates a new instance of FinancialAccountTransactionTypeChoicesBean */
    public FinancialAccountTransactionTypeChoicesBean(List<String> labels, List<String> values, String defaultValue) {
