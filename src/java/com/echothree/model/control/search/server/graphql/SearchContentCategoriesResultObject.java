...
@GraphQLDescription("search content categories result object")
@GraphQLName("SearchContentCategoriesResult")
public class SearchContentCategoriesResultObject
        extends MutationResultObject {
    
    private SearchContentCategoriesResult result;
    
    public void setResult(SearchContentCategoriesResult result) {
        this.result = result;
    }
