...
@GraphQLDescription("search attributes result object")
@GraphQLName("SearchEntityAttributesResult")
public class SearchEntityAttributesResultObject
        extends MutationResultObject {
    
    private SearchEntityAttributesResult result;
    
    public void setResult(SearchEntityAttributesResult result) {
        this.result = result;
    }
