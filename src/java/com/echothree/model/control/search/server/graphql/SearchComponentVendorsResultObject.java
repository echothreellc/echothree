...
@GraphQLDescription("search component vendors result object")
@GraphQLName("SearchComponentVendorsResult")
public class SearchComponentVendorsResultObject
        extends MutationResultObject {
    
    private SearchComponentVendorsResult result;
    
    public void setResult(SearchComponentVendorsResult result) {
        this.result = result;
    }
