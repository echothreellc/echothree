...
@GraphQLDescription("search entity list items result object")
@GraphQLName("SearchEntityListItemsResult")
public class SearchEntityListItemsResultObject
        extends MutationResultObject {
    
    private SearchEntityListItemsResult result;
    
    public void setResult(SearchEntityListItemsResult result) {
        this.result = result;
    }
