...
@GraphQLDescription("search entity types result object")
@GraphQLName("SearchEntityTypesResult")
public class SearchEntityTypesResultObject
        extends MutationResultObject {
    
    private SearchEntityTypesResult result;
    
    public void setResult(SearchEntityTypesResult result) {
        this.result = result;
    }
