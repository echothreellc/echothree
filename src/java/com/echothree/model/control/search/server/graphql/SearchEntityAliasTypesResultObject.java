...
@GraphQLDescription("search alias types result object")
@GraphQLName("SearchEntityAliasTypesResult")
public class SearchEntityAliasTypesResultObject
        extends MutationResultObject {
    
    private SearchEntityAliasTypesResult result;
    
    public void setResult(SearchEntityAliasTypesResult result) {
        this.result = result;
    }
