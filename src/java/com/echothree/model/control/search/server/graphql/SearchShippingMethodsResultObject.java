...
@GraphQLDescription("search shipping method object")
@GraphQLName("SearchShippingMethodsResult")
public class SearchShippingMethodsResultObject
        extends MutationResultObject {
    
    private SearchShippingMethodsResult result;
    
    public void setResult(SearchShippingMethodsResult result) {
        this.result = result;
    }
