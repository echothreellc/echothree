...
public class SearchCheckSpellingActionTypeTransfer
        extends BaseTransfer {
    
    private String searchCheckSpellingActionTypeName;
    private Boolean isDefault;
    private Integer sortOrder;
    private String description;
    
    /** Creates a new instance of SearchCheckSpellingActionTypeTransfer */
    public SearchCheckSpellingActionTypeTransfer(String searchCheckSpellingActionTypeName, Boolean isDefault, Integer sortOrder, String description) {
    ...
    public String getSearchCheckSpellingActionTypeName() {
        return searchCheckSpellingActionTypeName;
    }
