...
public class TermTypeLogic
    ...
    private TermTypeLogic() {
        super();
    }

    private static class TermTypeLogicHolder {
        static TermTypeLogic instance = new TermTypeLogic();
    }

    public static TermTypeLogic getInstance() {
        return TermTypeLogic.TermTypeLogicHolder.instance;
    }
