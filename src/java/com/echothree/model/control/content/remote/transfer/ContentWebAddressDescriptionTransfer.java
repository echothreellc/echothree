...
public class ContentWebAddressDescriptionTransfer
        extends BaseTransfer {
    
    private LanguageTransfer language;
    private ContentWebAddressTransfer contentWebAddress;
    private String description;
    
    /** Creates a new instance of ContentWebAddressDescriptionTransfer */
    public ContentWebAddressDescriptionTransfer(LanguageTransfer language, ContentWebAddressTransfer contentWebAddress,
            String description) {
