...
public class DuplicateContentPageLayoutNameException
    ...
    /** Creates a new instance of DuplicateContentPageLayoutNameException */
    public DuplicateContentPageLayoutNameException(String message) {
        super(message);
    }
    
    /** Creates a new instance of DuplicateContentPageLayoutNameException */
    public DuplicateContentPageLayoutNameException(Throwable cause) {
        super(cause);
    }
    
    /** Creates a new instance of DuplicateContentPageLayoutNameException */
    public DuplicateContentPageLayoutNameException(Message message) {
        super(message);
    }
