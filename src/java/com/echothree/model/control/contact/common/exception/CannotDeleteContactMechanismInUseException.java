...
public class CannotDeleteContactMechanismInUseException
    ...
    /** Creates a new instance of CannotDeleteContactMechanismInUseException */
    public CannotDeleteContactMechanismInUseException(String message) {
        super(message);
    }
    
    /** Creates a new instance of CannotDeleteContactMechanismInUseException */
    public CannotDeleteContactMechanismInUseException(Throwable cause) {
        super(cause);
    }
    
    /** Creates a new instance of CannotDeleteContactMechanismInUseException */
    public CannotDeleteContactMechanismInUseException(Message message) {
        super(message);
    }
