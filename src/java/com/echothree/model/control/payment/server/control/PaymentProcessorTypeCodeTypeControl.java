...
public class PaymentProcessorTypeCodeTypeControl
    ...
    public PaymentProcessorTypeCodeType createPaymentProcessorTypeCodeType(final PaymentProcessorType paymentProcessorType,
        ...
        sendEventUsingNames(paymentProcessorTypeCodeType.getPrimaryKey(), EventTypes.CREATE.name(), null, null, createdBy);
    ...
    public List<PaymentProcessorTypeCodeTypeTransfer> getPaymentProcessorTypeCodeTypeTransfers(final UserVisit userVisit,
        ...
        var paymentProcessorTypeCodeTypeTransferCache = getPaymentTransferCaches(userVisit).getPaymentProcessorTypeCodeTypeTransferCache();

        paymentProcessorTypeCodeTypes.stream().forEach((paymentProcessorTypeCodeType) -> {
            paymentProcessorTypeCodeTypeTransfers.add(paymentProcessorTypeCodeTypeTransferCache.getTransfer(paymentProcessorTypeCodeType));
        });
    ...
    public PaymentProcessorTypeCodeTypeChoicesBean getPaymentProcessorTypeCodeTypeChoices(final PaymentProcessorType paymentProcessorType,
        ...
        for(PaymentProcessorTypeCodeType paymentProcessorTypeCodeType: paymentProcessorTypeCodeTypes) {
    ...
    private void updatePaymentProcessorTypeCodeTypeFromValue(final PaymentProcessorTypeCodeTypeDetailValue paymentProcessorTypeCodeTypeDetailValue,
        ...
        if(paymentProcessorTypeCodeTypeDetailValue.hasBeenModified()) {
            ...
            paymentProcessorTypeCodeTypeDetail.setThruTime(session.START_TIME_LONG);
            ...
            paymentProcessorTypeCodeTypeDetail = PaymentProcessorTypeCodeTypeDetailFactory.getInstance().create(paymentProcessorTypeCodeTypePK,
                    paymentProcessorTypePK, paymentProcessorTypeCodeTypeName, isDefault, sortOrder, session.START_TIME_LONG, Session.MAX_TIME_LONG);

            paymentProcessorTypeCodeType.setActiveDetail(paymentProcessorTypeCodeTypeDetail);
            paymentProcessorTypeCodeType.setLastDetail(paymentProcessorTypeCodeTypeDetail);

            sendEventUsingNames(paymentProcessorTypeCodeTypePK, EventTypes.MODIFY.name(), null, null, updatedBy);
        }
    }
    ...
    public PaymentProcessorTypeCodeTypeDescription createPaymentProcessorTypeCodeTypeDescription(final PaymentProcessorTypeCodeType paymentProcessorTypeCodeType,
        ...
        sendEventUsingNames(paymentProcessorTypeCodeType.getPrimaryKey(), EventTypes.MODIFY.name(), paymentProcessorTypeCodeTypeDescription.getPrimaryKey(), EventTypes.CREATE.name(), createdBy);
    ...
    public String getBestPaymentProcessorTypeCodeTypeDescription(final PaymentProcessorTypeCodeType paymentProcessorTypeCodeType, final Language language) {
        ...
        if(paymentProcessorTypeCodeTypeDescription == null && !language.getIsDefault()) {
            paymentProcessorTypeCodeTypeDescription = getPaymentProcessorTypeCodeTypeDescription(paymentProcessorTypeCodeType, getPartyControl().getDefaultLanguage());
        }
    ...
    public List<PaymentProcessorTypeCodeTypeDescriptionTransfer> getPaymentProcessorTypeCodeTypeDescriptionTransfersByPaymentProcessorTypeCodeType(final UserVisit userVisit,
        ...
        var paymentProcessorTypeCodeTypeDescriptionTransferCache = getPaymentTransferCaches(userVisit).getPaymentProcessorTypeCodeTypeDescriptionTransferCache();

        paymentProcessorTypeCodeTypeDescriptions.stream().forEach((paymentProcessorTypeCodeTypeDescription) -> {
            paymentProcessorTypeCodeTypeDescriptionTransfers.add(paymentProcessorTypeCodeTypeDescriptionTransferCache.getTransfer(paymentProcessorTypeCodeTypeDescription));
        });
    ...
    public void updatePaymentProcessorTypeCodeTypeDescriptionFromValue(final PaymentProcessorTypeCodeTypeDescriptionValue paymentProcessorTypeCodeTypeDescriptionValue,
        ...
        if(paymentProcessorTypeCodeTypeDescriptionValue.hasBeenModified()) {
            ...
            paymentProcessorTypeCodeTypeDescription.setThruTime(session.START_TIME_LONG);
            ...
            sendEventUsingNames(paymentProcessorTypeCodeType.getPrimaryKey(), EventTypes.MODIFY.name(), paymentProcessorTypeCodeTypeDescription.getPrimaryKey(), EventTypes.MODIFY.name(), updatedBy);
        }
    }
    ...
    public void deletePaymentProcessorTypeCodeTypeDescription(final PaymentProcessorTypeCodeTypeDescription paymentProcessorTypeCodeTypeDescription, final BasePK deletedBy) {
        ...
        sendEventUsingNames(paymentProcessorTypeCodeTypeDescription.getPaymentProcessorTypeCodeTypePK(), EventTypes.MODIFY.name(), paymentProcessorTypeCodeTypeDescription.getPrimaryKey(), EventTypes.DELETE.name(), deletedBy);
