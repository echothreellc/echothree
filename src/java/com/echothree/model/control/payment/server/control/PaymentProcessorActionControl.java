...
public class PaymentProcessorActionControl
    ...
    public PaymentProcessorAction createPaymentProcessorAction(final PaymentProcessor paymentProcessor,
        ...
        sendEventUsingNames(paymentProcessor.getPrimaryKey(), EventTypes.MODIFY.name(), paymentProcessorAction.getPrimaryKey(), EventTypes.CREATE.name(), createdBy);
    ...
    public List<PaymentProcessorActionTransfer> getPaymentProcessorActionTransfers(final UserVisit userVisit,
        ...
        paymentProcessorActions.stream().forEach((paymentProcessorAction) -> {
    ...
    public void deletePaymentProcessorAction(final PaymentProcessorAction paymentProcessorAction, final BasePK deletedBy) {
        ...
        sendEventUsingNames(paymentProcessorAction.getPaymentProcessorPK(), EventTypes.MODIFY.name(), paymentProcessorAction.getPrimaryKey(), EventTypes.DELETE.name(), deletedBy);
