...
public class PaymentProcessorTypeCodeTypeTransfer
        extends BaseTransfer {

    private PaymentProcessorTypeTransfer paymentProcessorTypeTransfer;
    private String paymentProcessorTypeCodeTypeName;
    private Boolean isDefault;
    private Integer sortOrder;
    private String description;

    /** Creates a new instance of PaymentProcessorTypeTransfer */
    public PaymentProcessorTypeCodeTypeTransfer(PaymentProcessorTypeTransfer paymentProcessorTypeTransfer,
            String paymentProcessorTypeCodeTypeName, Boolean isDefault, Integer sortOrder, String description) {
    ...
    public String getPaymentProcessorTypeCodeTypeName() {
        return paymentProcessorTypeCodeTypeName;
    }
    
    public void setPaymentProcessorTypeCodeTypeName(String paymentProcessorTypeCodeTypeName) {
        this.paymentProcessorTypeCodeTypeName = paymentProcessorTypeCodeTypeName;
    }
