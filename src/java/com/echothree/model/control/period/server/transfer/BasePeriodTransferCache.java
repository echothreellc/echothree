...
public abstract class BasePeriodTransferCache<K extends BaseEntity, V extends BaseTransfer>
        extends BaseTransferCache<K, V> {
    
    PeriodControl periodControl;
    
    /** Creates a new instance of BasePeriodTransferCache */
    public BasePeriodTransferCache(UserVisit userVisit, PeriodControl periodControl) {
        super(userVisit);
