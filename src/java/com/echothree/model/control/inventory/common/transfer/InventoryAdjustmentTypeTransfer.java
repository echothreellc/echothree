...
public class InventoryAdjustmentTypeTransfer
        extends BaseTransfer {
    
    private String inventoryAdjustmentTypeName;
    private Boolean isDefault;
    private Integer sortOrder;
    private String description;
    
    /** Creates a new instance of InventoryAdjustmentTypeTransfer */
    public InventoryAdjustmentTypeTransfer(String inventoryAdjustmentTypeName, Boolean isDefault, Integer sortOrder,
            String description) {
    ...
    public String getInventoryAdjustmentTypeName() {
        return inventoryAdjustmentTypeName;
    }

    public void setInventoryAdjustmentTypeName(String inventoryAdjustmentTypeName) {
        this.inventoryAdjustmentTypeName = inventoryAdjustmentTypeName;
    }
