...
public class InventoryBucketTypeTransfer
        extends BaseTransfer {
    
    private String inventoryBucketTypeName;
    private Boolean isDefault;
    private Integer sortOrder;
    private String description;
    
    /** Creates a new instance of InventoryBucketTypeTransfer */
    public InventoryBucketTypeTransfer(String inventoryBucketTypeName, Boolean isDefault, Integer sortOrder,
            String description) {
    ...
    public String getInventoryBucketTypeName() {
        return inventoryBucketTypeName;
    }

    public void setInventoryBucketTypeName(String inventoryBucketTypeName) {
        this.inventoryBucketTypeName = inventoryBucketTypeName;
    }
