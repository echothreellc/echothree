...
public class InventoryLayerBucketTransfer
        extends BaseTransfer {

    private InventoryLayerTransfer inventoryLayer;
    private InventoryBucketTypeTransfer inventoryBucketType;
    private String quantity;

    public InventoryLayerBucketTransfer(InventoryLayerTransfer inventoryLayer,
    ...
    public InventoryLayerTransfer getInventoryLayer() {
        return inventoryLayer;
    }

    public void setInventoryLayer(InventoryLayerTransfer inventoryLayer) {
        this.inventoryLayer = inventoryLayer;
    }
