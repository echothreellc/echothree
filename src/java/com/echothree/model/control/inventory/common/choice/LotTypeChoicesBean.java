...
public class LotTypeChoicesBean
        extends BaseChoicesBean {
    
    /** Creates a new instance of LotTypeChoicesBean */
    public LotTypeChoicesBean(List<String> labels, List<String> values, String defaultValue) {
