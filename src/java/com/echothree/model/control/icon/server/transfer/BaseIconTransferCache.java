...
public abstract class BaseIconTransferCache<K extends BaseEntity, V extends BaseTransfer>
        extends BaseTransferCache<K, V> {
    
    IconControl iconControl;
    
    /** Creates a new instance of BaseIconTransferCache */
    public BaseIconTransferCache(UserVisit userVisit, IconControl iconControl) {
        super(userVisit);
