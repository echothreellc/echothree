...
public class UseTypeSearchEvaluator
    ...
    public SortField[] getSortFields(final String searchSortOrderName) {
        ...
        switch(SearchSortOrders.valueOf(searchSortOrderName)) {
            ...
            case USE_TYPE_NAME ->
                    sortFields = new SortField[]{new SortField(IndexFields.useTypeName.name() + IndexConstants.INDEX_FIELD_VARIATION_SEPARATOR + IndexFieldVariations.sortable.name(), SortField.Type.STRING, reverse)};
            case CREATED_TIME ->
