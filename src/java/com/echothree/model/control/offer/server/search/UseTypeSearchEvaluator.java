...
public class UseTypeSearchEvaluator
        extends BaseSearchEvaluator {
    
    /** Creates a new instance of SecurityRoleGroupSearchEvaluator */
    public UseTypeSearchEvaluator(UserVisit userVisit, Language language, SearchType searchType, SearchDefaultOperator searchDefaultOperator,
        ...
        super(userVisit, searchType, searchDefaultOperator, searchSortOrder, searchSortDirection, searchUseType, ComponentVendors.ECHOTHREE.name(),
                EntityTypes.UseType.name(), IndexConstants.IndexType_USE_TYPE, language, null);
    ...
    public SortField[] getSortFields(String searchSortOrderName) {
        ...
        switch (searchSortOrderName) {
            ...
            case SearchConstants.SearchSortOrder_DESCRIPTION:
                ...
                break;
            case SearchConstants.SearchSortOrder_USE_TYPE_NAME:
                sortFields = new SortField[]{new SortField(IndexConstants.IndexField_UseTypeName + IndexConstants.IndexFieldVariationSeparator + IndexConstants.IndexFieldVariation_Sortable, SortField.Type.STRING, reverse)};
                break;
