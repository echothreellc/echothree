...
public class UseNameElementLogic
    ...
    private UseNameElementLogic() {
        super();
    }

    private static class UseNameElementLogicHolder {
        static UseNameElementLogic instance = new UseNameElementLogic();
    }

    public static UseNameElementLogic getInstance() {
        return UseNameElementLogic.UseNameElementLogicHolder.instance;
    }
