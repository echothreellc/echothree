...
public class SourceChoicesBean
        extends BaseChoicesBean {
    
    /** Creates a new instance of SourceChoicesBean */
    public SourceChoicesBean(List<String> labels, List<String> values, String defaultValue) {
