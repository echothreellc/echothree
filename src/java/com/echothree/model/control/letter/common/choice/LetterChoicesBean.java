...
public class LetterChoicesBean
        extends BaseChoicesBean {
    
    /** Creates a new instance of LetterChoicesBean */
    public LetterChoicesBean(List<String> labels, List<String> values, String defaultValue) {
