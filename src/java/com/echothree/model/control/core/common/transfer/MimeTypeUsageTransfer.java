...
public class MimeTypeUsageTransfer
        extends BaseTransfer {
    
    private MimeTypeTransfer mimeType;
    private MimeTypeUsageTypeTransfer mimeTypeUsageType;
    
    /** Creates a new instance of MimeTypeUsageTransfer */
    public MimeTypeUsageTransfer(MimeTypeTransfer mimeType, MimeTypeUsageTypeTransfer mimeTypeUsageType) {
