...
public class MimeTypeUsageTypeTransfer
    ...
    /** Creates a new instance of MimeTypeUsageTypeTransfer */
    public MimeTypeUsageTypeTransfer(String mimeTypeUsageTypeName, Boolean isDefault, Integer sortOrder, String description) {
