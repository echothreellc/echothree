...
@GraphQLDescription("entity entity attribute history object")
@GraphQLName("EntityEntityAttributeHistory")
public class EntityEntityAttributeHistoryObject
        extends BaseEntityEntityAttributeObject
        implements VersionInterface {

    public EntityEntityAttributeHistoryObject(EntityEntityAttribute entityEntityAttribute) {
    ...
    public TimeObject getFromTime(final DataFetchingEnvironment env) {
        return new TimeObject(entityEntityAttribute.getFromTime());
    }
    ...
    public TimeObject getThruTime(final DataFetchingEnvironment env) {
        return new TimeObject(entityEntityAttribute.getThruTime());
    }
