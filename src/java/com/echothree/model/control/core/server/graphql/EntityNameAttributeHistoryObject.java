...
@GraphQLName("EntityNameAttributeHistory")
public class EntityNameAttributeHistoryObject
        extends BaseEntityNameAttributeObject
        implements VersionInterface {

    public EntityNameAttributeHistoryObject(EntityNameAttribute entityNameAttribute) {
    ...
    public TimeObject getFromTime(final DataFetchingEnvironment env) {
        return new TimeObject(entityNameAttribute.getFromTime());
    }
    ...
    public TimeObject getThruTime(final DataFetchingEnvironment env) {
        return new TimeObject(entityNameAttribute.getThruTime());
    }
