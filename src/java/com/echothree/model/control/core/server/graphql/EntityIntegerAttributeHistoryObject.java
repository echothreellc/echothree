...
@GraphQLDescription("entity integer attribute history object")
@GraphQLName("EntityIntegerAttributeHistory")
public class EntityIntegerAttributeHistoryObject
        extends BaseEntityIntegerAttributeObject
        implements VersionInterface {

  public EntityIntegerAttributeHistoryObject(EntityIntegerAttribute entityIntegerAttribute) {
  ...
  public TimeObject getFromTime(final DataFetchingEnvironment env) {
    return new TimeObject(entityIntegerAttribute.getFromTime());
  }
  ...
  public TimeObject getThruTime(final DataFetchingEnvironment env) {
    return new TimeObject(entityIntegerAttribute.getThruTime());
  }
