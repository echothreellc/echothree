...
public class EntityStringDefaultTransferCache
    ...
    protected EntityStringDefaultTransferCache() {
        ...
        if(options != null) {
            includeString = options.contains(CoreOptions.EntityStringDefaultIncludeString);
        }
    }
    ...
    public EntityStringDefaultTransfer getEntityStringDefaultTransfer(UserVisit userVisit, EntityStringDefault entityStringDefault) {
        ...
        if(entityStringDefaultTransfer == null) {
            var entityAttribute = coreControl.getEntityAttributeTransfer(userVisit, entityStringDefault.getEntityAttribute(), null);
            var language = partyControl.getLanguageTransfer(userVisit, entityStringDefault.getLanguage());
