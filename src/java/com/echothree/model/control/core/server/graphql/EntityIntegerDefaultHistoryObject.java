...
@GraphQLDescription("entity integer default history object")
@GraphQLName("EntityIntegerDefaultHistory")
public class EntityIntegerDefaultHistoryObject
        extends BaseEntityIntegerDefaultObject
        implements VersionInterface {

    public EntityIntegerDefaultHistoryObject(EntityIntegerDefault entityIntegerDefault) {
    ...
    public TimeObject getFromTime(final DataFetchingEnvironment env) {
        return new TimeObject(entityIntegerDefault.getFromTime());
    }
    ...
    public TimeObject getThruTime(final DataFetchingEnvironment env) {
        return new TimeObject(entityIntegerDefault.getThruTime());
    }
