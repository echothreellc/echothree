...
import com.echothree.model.control.index.server.analysis.EntityAttributeAnalyzer;
...
public class EntityAttributeSearchEvaluator
        extends BaseSearchEvaluator {
    
    /** Creates a new instance of EntityAttributeSearchEvaluator */
    public EntityAttributeSearchEvaluator(UserVisit userVisit, Language language, SearchType searchType, SearchDefaultOperator searchDefaultOperator,
        ...
        super(userVisit, searchDefaultOperator, searchType, searchSortOrder, searchSortDirection, searchUseType, ComponentVendors.ECHO_THREE.name(),
                EntityTypes.EntityAttribute.name(), IndexTypes.ENTITY_ATTRIBUTE.name(), language, null);
    ...
    public SortField[] getSortFields(String searchSortOrderName) {
        ...
        } else if(searchSortOrderName.equals(SearchSortOrders.ENTITY_ATTRIBUTE_NAME.name())) {
            sortFields = new SortField[]{
    ...
    public Analyzer getAnalyzer(final ExecutionErrorAccumulator eea, final Language language) {
        return new EntityAttributeAnalyzer(eea, language, entityType);
    }
