...
public class BaseEntityListItemAttributeObject
        implements BaseGraphQl {

    protected final EntityListItemAttribute entityListItemAttribute; // Always Present

    public BaseEntityListItemAttributeObject(EntityListItemAttribute entityListItemAttribute) {
