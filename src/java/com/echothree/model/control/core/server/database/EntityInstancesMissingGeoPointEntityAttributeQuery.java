...
public class EntityInstancesMissingGeoPointEntityAttributeQuery
        extends BaseDatabaseQuery<EntityInstanceResult> {

    public EntityInstancesMissingGeoPointEntityAttributeQuery() {
        super("""
                ...
                AND eni_entityinstanceid NOT IN
                    (SELECT engeopnta_eni_entityinstanceid
