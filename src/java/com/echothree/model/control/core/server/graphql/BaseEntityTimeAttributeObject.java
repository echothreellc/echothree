...
public class BaseEntityTimeAttributeObject
        implements BaseGraphQl {

    protected final EntityTimeAttribute entityTimeAttribute; // Always Present

    public BaseEntityTimeAttributeObject(EntityTimeAttribute entityTimeAttribute) {
