...
public class EntityInstancesMissingMultipleListItemEntityAttributeQuery
        extends BaseDatabaseQuery<EntityInstanceResult> {

    public EntityInstancesMissingMultipleListItemEntityAttributeQuery() {
        super("""
                ...
                AND eni_entityinstanceid NOT IN
                    (SELECT emlia_eni_entityinstanceid
