...
@GraphQLDescription("entity geo point default history object")
@GraphQLName("EntityGeoPointDefaultHistory")
public class EntityGeoPointDefaultHistoryObject
        extends BaseEntityGeoPointDefaultObject
        implements VersionInterface {

    public EntityGeoPointDefaultHistoryObject(EntityGeoPointDefault entityGeoPointDefault) {
    ...
    public TimeObject getFromTime(final DataFetchingEnvironment env) {
        return new TimeObject(entityGeoPointDefault.getFromTime());
    }
    ...
    public TimeObject getThruTime(final DataFetchingEnvironment env) {
        return new TimeObject(entityGeoPointDefault.getThruTime());
    }
