...
@GraphQLDescription("entity date attribute history object")
@GraphQLName("EntityDateAttributeHistory")
public class EntityDateAttributeHistoryObject
        extends BaseEntityDateAttributeObject
        implements VersionInterface {

    public EntityDateAttributeHistoryObject(EntityDateAttribute entityDateAttribute) {
    ...
    public TimeObject getFromTime(final DataFetchingEnvironment env) {
        return new TimeObject(entityDateAttribute.getFromTime());
    }
    ...
    public TimeObject getThruTime(final DataFetchingEnvironment env) {
        return new TimeObject(entityDateAttribute.getThruTime());
    }
