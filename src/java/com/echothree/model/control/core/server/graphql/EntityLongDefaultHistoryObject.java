...
@GraphQLDescription("entity long default history object")
@GraphQLName("EntityLongDefaultHistory")
public class EntityLongDefaultHistoryObject
        extends BaseEntityLongDefaultObject
        implements VersionInterface {

    public EntityLongDefaultHistoryObject(EntityLongDefault entityLongDefault) {
    ...
    public TimeObject getFromTime(final DataFetchingEnvironment env) {
        return new TimeObject(entityLongDefault.getFromTime());
    }
    ...
    public TimeObject getThruTime(final DataFetchingEnvironment env) {
        return new TimeObject(entityLongDefault.getThruTime());
    }
