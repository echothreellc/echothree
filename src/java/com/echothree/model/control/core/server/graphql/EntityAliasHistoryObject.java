...
@GraphQLDescription("entity alias history object")
@GraphQLName("EntityAliasHistory")
public class EntityAliasHistoryObject
        extends BaseEntityAliasObject
        implements VersionInterface {

    public EntityAliasHistoryObject(EntityAlias entityAlias) {
        super(entityAlias);
    }
    ...
    public TimeObject getFromTime(final DataFetchingEnvironment env) {
        return new TimeObject(entityAlias.getFromTime());
    }
    ...
    public TimeObject getThruTime(final DataFetchingEnvironment env) {
        return new TimeObject(entityAlias.getThruTime());
    }
