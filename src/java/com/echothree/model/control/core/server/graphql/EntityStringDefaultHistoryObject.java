...
@GraphQLDescription("entity string default history object")
@GraphQLName("EntityStringDefaultHistory")
public class EntityStringDefaultHistoryObject
        extends BaseEntityStringDefaultObject
        implements VersionInterface {

    public EntityStringDefaultHistoryObject(EntityStringDefault entityStringDefault) {
    ...
    public TimeObject getFromTime(final DataFetchingEnvironment env) {
        return new TimeObject(entityStringDefault.getFromTime());
    }
    ...
    public TimeObject getThruTime(final DataFetchingEnvironment env) {
        return new TimeObject(entityStringDefault.getThruTime());
    }
