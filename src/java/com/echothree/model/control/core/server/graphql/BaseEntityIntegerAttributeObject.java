...
public class BaseEntityIntegerAttributeObject
        implements BaseGraphQl {

    protected final EntityIntegerAttribute entityIntegerAttribute; // Always Present

    public BaseEntityIntegerAttributeObject(EntityIntegerAttribute entityIntegerAttribute) {
