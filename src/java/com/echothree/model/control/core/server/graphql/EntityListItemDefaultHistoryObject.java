...
@GraphQLDescription("entity list item default history object")
@GraphQLName("EntityListItemDefaultHistory")
public class EntityListItemDefaultHistoryObject
        extends BaseEntityListItemDefaultObject
        implements VersionInterface {

    public EntityListItemDefaultHistoryObject(EntityListItemDefault entityListItemDefault) {
    ...
    public TimeObject getFromTime(final DataFetchingEnvironment env) {
        return new TimeObject(entityListItemDefault.getFromTime());
    }
    ...
    public TimeObject getThruTime(final DataFetchingEnvironment env) {
        return new TimeObject(entityListItemDefault.getThruTime());
    }
