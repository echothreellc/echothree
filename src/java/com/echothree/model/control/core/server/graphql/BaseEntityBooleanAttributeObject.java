...
public class BaseEntityBooleanAttributeObject
        implements BaseGraphQl {

    protected final EntityBooleanAttribute entityBooleanAttribute; // Always Present

    protected BaseEntityBooleanAttributeObject(EntityBooleanAttribute entityBooleanAttribute) {
