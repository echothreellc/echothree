...
public class EntityInstancesMissingBooleanEntityAttributeQuery
        extends BaseDatabaseQuery<EntityInstanceResult> {

    public EntityInstancesMissingBooleanEntityAttributeQuery() {
        super("""
                ...
                AND eni_entityinstanceid NOT IN
                    (SELECT enbla_eni_entityinstanceid
