...
@GraphQLDescription("entity clob attribute history object")
@GraphQLName("EntityClobAttributeHistory")
public class EntityClobAttributeHistoryObject
        extends BaseEntityClobAttributeObject
        implements VersionInterface {

    public EntityClobAttributeHistoryObject(EntityClobAttribute entityClobAttribute) {
    ...
    public TimeObject getFromTime(final DataFetchingEnvironment env) {
        return new TimeObject(entityClobAttribute.getFromTime());
    }
    ...
    public TimeObject getThruTime(final DataFetchingEnvironment env) {
        return new TimeObject(entityClobAttribute.getThruTime());
    }
