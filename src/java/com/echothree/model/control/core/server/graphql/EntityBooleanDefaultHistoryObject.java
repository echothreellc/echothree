...
@GraphQLDescription("entity boolean default history object")
@GraphQLName("EntityBooleanDefaultHistory")
public class EntityBooleanDefaultHistoryObject
        extends BaseEntityBooleanDefaultObject
        implements VersionInterface {

    public EntityBooleanDefaultHistoryObject(EntityBooleanDefault entityBooleanDefault) {
    ...
    public TimeObject getFromTime(final DataFetchingEnvironment env) {
        return new TimeObject(entityBooleanDefault.getFromTime());
    }
    ...
    public TimeObject getThruTime(final DataFetchingEnvironment env) {
        return new TimeObject(entityBooleanDefault.getThruTime());
    }
