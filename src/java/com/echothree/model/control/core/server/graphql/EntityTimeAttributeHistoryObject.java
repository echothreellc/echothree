...
@GraphQLDescription("entity time attribute history object")
@GraphQLName("EntityTimeAttributeHistory")
public class EntityTimeAttributeHistoryObject
        extends BaseEntityTimeAttributeObject
        implements VersionInterface {

    public EntityTimeAttributeHistoryObject(EntityTimeAttribute entityTimeAttribute) {
    ...
    public TimeObject getFromTime(final DataFetchingEnvironment env) {
        return new TimeObject(entityTimeAttribute.getFromTime());
    }
    ...
    public TimeObject getThruTime(final DataFetchingEnvironment env) {
        return new TimeObject(entityTimeAttribute.getThruTime());
    }
