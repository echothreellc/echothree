...
@GraphQLDescription("entity time default history object")
@GraphQLName("EntityTimeDefaultHistory")
public class EntityTimeDefaultHistoryObject
        extends BaseEntityTimeDefaultObject
        implements VersionInterface {

    public EntityTimeDefaultHistoryObject(EntityTimeDefault entityTimeDefault) {
    ...
    public TimeObject getFromTime(final DataFetchingEnvironment env) {
        return new TimeObject(entityTimeDefault.getFromTime());
    }
    ...
    public TimeObject getThruTime(final DataFetchingEnvironment env) {
        return new TimeObject(entityTimeDefault.getThruTime());
    }
