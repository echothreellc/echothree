...
public class ServerTransferCache
        extends BaseCoreTransferCache<Server, ServerTransfer> {

    /** Creates a new instance of ServerTransferCache */
    public ServerTransferCache(UserVisit userVisit, CoreControl coreControl) {
