...
@GraphQLDescription("entity long attribute history object")
@GraphQLName("EntityLongAttributeHistory")
public class EntityLongAttributeHistoryObject
        extends BaseEntityLongAttributeObject
        implements VersionInterface {

    public EntityLongAttributeHistoryObject(EntityLongAttribute entityLongAttribute) {
    ...
    public TimeObject getFromTime(final DataFetchingEnvironment env) {
        return new TimeObject(entityLongAttribute.getFromTime());
    }
    ...
    public TimeObject getThruTime(final DataFetchingEnvironment env) {
        return new TimeObject(entityLongAttribute.getThruTime());
    }
