...
@GraphQLDescription("entity geo point attribute history object")
@GraphQLName("EntityGeoPointAttributeHistory")
public class EntityGeoPointAttributeHistoryObject
        extends BaseEntityGeoPointAttributeObject
        implements VersionInterface {

    public EntityGeoPointAttributeHistoryObject(EntityGeoPointAttribute entityGeoPointAttribute) {
    ...
    public TimeObject getFromTime(final DataFetchingEnvironment env) {
        return new TimeObject(entityGeoPointAttribute.getFromTime());
    }
    ...
    public TimeObject getThruTime(final DataFetchingEnvironment env) {
        return new TimeObject(entityGeoPointAttribute.getThruTime());
    }
