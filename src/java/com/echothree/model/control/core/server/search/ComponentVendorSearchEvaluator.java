...
public class ComponentVendorSearchEvaluator
        extends BaseSearchEvaluator {
    
    /** Creates a new instance of ComponentVendorSearchEvaluator */
    public ComponentVendorSearchEvaluator(UserVisit userVisit, Language language, SearchType searchType, SearchDefaultOperator searchDefaultOperator,
        ...
        super(userVisit, searchDefaultOperator, searchType, searchSortOrder, searchSortDirection, searchUseType, ComponentVendors.ECHO_THREE.name(),
                EntityTypes.ComponentVendor.name(), IndexTypes.COMPONENT_VENDOR.name(), language, null);
    ...
    public SortField[] getSortFields(String searchSortOrderName) {
        ...
        } else if(searchSortOrderName.equals(SearchSortOrders.COMPONENT_VENDOR_NAME.name())) {
            sortFields = new SortField[]{
    ...
    public BasicAnalyzer getAnalyzer(final ExecutionErrorAccumulator eea, final Language language) {
        return new ComponentVendorAnalyzer(eea, language, entityType);
    }
