...
public class EntityAttributeGroupSearchEvaluator
        extends BaseSearchEvaluator {

    /** Creates a new instance of EntityAttributeGroupSearchEvaluator */
    public EntityAttributeGroupSearchEvaluator(UserVisit userVisit, Language language, SearchType searchType, SearchDefaultOperator searchDefaultOperator,
        ...
        super(userVisit, searchDefaultOperator, searchType, searchSortOrder, searchSortDirection, searchUseType, ComponentVendors.ECHO_THREE.name(),
                EntityTypes.EntityAttributeGroup.name(), IndexTypes.ENTITY_ATTRIBUTE_GROUP.name(), language, null);
    ...
    public SortField[] getSortFields(String searchSortOrderName) {
        ...
        } else if(searchSortOrderName.equals(SearchSortOrders.ENTITY_ATTRIBUTE_GROUP_NAME.name())) {
            sortFields = new SortField[]{
                new SortField(IndexFields.entityAttributeGroupName.name() + IndexConstants.INDEX_FIELD_VARIATION_SEPARATOR + IndexFieldVariations.sortable.name(), SortField.Type.STRING, reverse)
            };
    ...
    public BasicAnalyzer getAnalyzer(final ExecutionErrorAccumulator eea, final Language language) {
        return new EntityAttributeGroupAnalyzer(eea, language, entityType);
    }
