...
@GraphQLDescription("entity list item attribute history object")
@GraphQLName("EntityListItemAttributeHistory")
public class EntityListItemAttributeHistoryObject
        extends BaseEntityListItemAttributeObject
        implements VersionInterface {

    public EntityListItemAttributeHistoryObject(EntityListItemAttribute entityListItemAttribute) {
    ...
    public TimeObject getFromTime(final DataFetchingEnvironment env) {
        return new TimeObject(entityListItemAttribute.getFromTime());
    }
    ...
    public TimeObject getThruTime(final DataFetchingEnvironment env) {
        return new TimeObject(entityListItemAttribute.getThruTime());
    }
