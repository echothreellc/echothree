...
public class ContactListGroupTag
        extends BaseTag {
    
    protected String contactListGroupName;
    ...
    /** Creates a new instance of ContactListGroupTag */
    public ContactListGroupTag() {
        super();
        init();
    }
