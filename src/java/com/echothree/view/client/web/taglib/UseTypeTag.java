...
import com.echothree.control.user.offer.remote.form.GetUseTypeForm;
import com.echothree.control.user.offer.remote.result.GetUseTypeResult;
...
public class UseTypeTag
        extends BaseTag {
    
    protected String useTypeName;
    ...
    /** Creates a new instance of UseTypeTag */
    public UseTypeTag() {
        super();
        init();
    }
    ...
    public int doStartTag()
        ...
        try {
            ...
            CommandResult commandResult = OfferUtil.getHome().getUseType(getUserVisitPK(), commandForm);
            ...
            if(commandResult.hasErrors()) {
                ...
                pageContext.setAttribute(var, result.getUseType(), scope);
            }
