...
public class CommunicationEventTag
        extends BaseTag {
    
    protected String communicationEventName;
    ...
    /** Creates a new instance of CommunicationEventTag */
    public CommunicationEventTag() {
        super();
        init();
    }
