...
import com.echothree.control.user.communication.remote.form.GetCommunicationEventPurposeForm;
import com.echothree.control.user.communication.remote.result.CommunicationResultFactory;
import com.echothree.control.user.communication.remote.result.GetCommunicationEventPurposeResult;
...
public class GetCommunicationEventPurposeCommand
    ...
    public GetCommunicationEventPurposeCommand(UserVisitPK userVisitPK, GetCommunicationEventPurposeForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(communicationEventPurpose != null) {
            ...
            sendEventUsingNames(communicationEventPurpose.getPrimaryKey(), EventTypes.READ.name(), null, null, getPartyPK());
        } else {
