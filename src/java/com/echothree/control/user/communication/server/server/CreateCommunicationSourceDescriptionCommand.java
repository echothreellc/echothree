...
@RequestScoped
public class CreateCommunicationSourceDescriptionCommand
        extends BaseSimpleCommand<CreateCommunicationSourceDescriptionForm> {
        ...
        if(communicationSource != null) {
            ...
            if(language != null) {
                ...
                if(communicationSourceDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateCommunicationSourceDescription.name());
                }
            } else {
