...
public interface EditCommunicationSourceDescriptionResult
        extends BaseEditResult<CommunicationSourceDescriptionEdit> {
    
    CommunicationSourceDescriptionTransfer getCommunicationSourceDescription();
    void setCommunicationSourceDescription(CommunicationSourceDescriptionTransfer communicationSourceDescription);
