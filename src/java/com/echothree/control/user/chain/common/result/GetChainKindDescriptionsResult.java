...
public interface GetChainKindDescriptionsResult
        extends BaseResult {
    
    ChainKindTransfer getChainKind();
    void setChainKind(ChainKindTransfer chainKind);
    
    List<ChainKindDescriptionTransfer> getChainKindDescriptions();
    void setChainKindDescriptions(List<ChainKindDescriptionTransfer> chainKindDescriptions);
