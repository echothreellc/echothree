...
public interface CreateChainTypeDescriptionForm
        extends ChainTypeDescriptionSpec, ChainTypeDescriptionEdit {
    
    // Nothing additional beyond ChainTypeDescriptionSpec, ChainTypeDescriptionEdit
