...
public interface CreateChainActionTypeDescriptionForm
        extends ChainActionTypeDescriptionSpec, ChainActionTypeDescriptionEdit {
    
    // Nothing additional beyond ChainActionTypeDescriptionSpec, ChainActionTypeDescriptionEdit
