...
public interface GetChainActionSetChoicesForm
        extends ChainSpec {
    
    String getDefaultChainActionSetChoice();
    void setDefaultChainActionSetChoice(String defaultChainActionSetChoice);
