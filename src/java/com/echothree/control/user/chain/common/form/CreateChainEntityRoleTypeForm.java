...
public interface CreateChainEntityRoleTypeForm
        extends ChainTypeSpec, ChainEntityRoleTypeEdit {
    
    // Nothing additional beyond ChainTypeSpec, ChainEntityRoleTypeEdit
