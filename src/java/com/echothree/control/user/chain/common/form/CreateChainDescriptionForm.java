...
public interface CreateChainDescriptionForm
        extends ChainDescriptionSpec, ChainDescriptionEdit {
    
    // Nothing additional beyond ChainDescriptionSpec, ChainDescriptionEdit
