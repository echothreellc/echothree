...
import com.echothree.control.user.chain.common.form.GetChainActionDescriptionsForm;
import com.echothree.control.user.chain.common.result.ChainResultFactory;
import com.echothree.control.user.chain.common.result.GetChainActionDescriptionsResult;
...
public class GetChainActionDescriptionsCommand
        extends BaseSimpleCommand<GetChainActionDescriptionsForm> {
    ...
    /** Creates a new instance of GetChainActionDescriptionsCommand */
    public GetChainActionDescriptionsCommand(UserVisitPK userVisitPK, GetChainActionDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetChainActionDescriptionsResult result = ChainResultFactory.getGetChainActionDescriptionsResult();
                ...
                if(chain != null) {
                    ...
                    if(chainActionSet != null) {
                        ...
                        if(chainAction != null) {
                            ...
                            result.setChainActionDescriptions(chainControl.getChainActionDescriptionTransfersByChainAction(getUserVisit(), chainAction));
                        } else {
