...
import com.echothree.control.user.chain.remote.form.CreateChainActionSetDescriptionForm;
...
public class CreateChainActionSetDescriptionCommand
        extends BaseSimpleCommand<CreateChainActionSetDescriptionForm> {
    ...
    /** Creates a new instance of CreateChainActionSetDescriptionCommand */
    public CreateChainActionSetDescriptionCommand(UserVisitPK userVisitPK, CreateChainActionSetDescriptionForm form) {
                    ...
                    if(chainActionSet != null) {
                        ...
                        if(language != null) {
                            ...
                            if(chainActionSetDescription == null) {
                                ...
                                addExecutionError(ExecutionErrors.DuplicateChainActionSetDescription.name(), chainKindName, chainTypeName, chainName,
