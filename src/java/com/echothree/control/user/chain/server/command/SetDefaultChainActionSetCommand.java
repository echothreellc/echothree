...
import com.echothree.control.user.chain.common.form.SetDefaultChainActionSetForm;
...
public class SetDefaultChainActionSetCommand
        extends BaseSimpleCommand<SetDefaultChainActionSetForm> {
    ...
    /** Creates a new instance of SetDefaultChainActionSetCommand */
    public SetDefaultChainActionSetCommand(UserVisitPK userVisitPK, SetDefaultChainActionSetForm form) {
        ...
        if(chainKind != null) {
            ...
            if(chainType != null) {
                ...
                if(chain != null) {
                    ...
                    ChainActionSetDetailValue chainActionSetDetailValue = chainControl.getChainActionSetDetailValueByNameForUpdate(chain, chainActionSetName);
