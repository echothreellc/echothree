...
import com.echothree.control.user.chain.remote.form.GetChainActionSetDescriptionsForm;
import com.echothree.control.user.chain.remote.result.ChainResultFactory;
import com.echothree.control.user.chain.remote.result.GetChainActionSetDescriptionsResult;
...
public class GetChainActionSetDescriptionsCommand
        extends BaseSimpleCommand<GetChainActionSetDescriptionsForm> {
    ...
    /** Creates a new instance of GetChainActionSetDescriptionsCommand */
    public GetChainActionSetDescriptionsCommand(UserVisitPK userVisitPK, GetChainActionSetDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetChainActionSetDescriptionsResult result = ChainResultFactory.getGetChainActionSetDescriptionsResult();
            ...
            if(chainType != null) {
                ...
                if(chain != null) {
                    ...
                    if(chainActionSet != null) {
                        ...
                        result.setChainActionSetDescriptions(chainControl.getChainActionSetDescriptionTransfersByChainActionSet(getUserVisit(), chainActionSet));
                    } else {
