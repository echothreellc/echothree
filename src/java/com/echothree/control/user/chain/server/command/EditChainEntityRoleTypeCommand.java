...
import com.echothree.control.user.chain.remote.edit.ChainEntityRoleTypeEdit;
import com.echothree.control.user.chain.remote.form.EditChainEntityRoleTypeForm;
import com.echothree.control.user.chain.remote.result.ChainResultFactory;
import com.echothree.control.user.chain.remote.result.EditChainEntityRoleTypeResult;
import com.echothree.control.user.chain.remote.spec.ChainEntityRoleTypeSpec;
...
public class EditChainEntityRoleTypeCommand
    ...
    public EditChainEntityRoleTypeCommand(UserVisitPK userVisitPK, EditChainEntityRoleTypeForm form) {
