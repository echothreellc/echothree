...
import com.echothree.control.user.chain.remote.form.GetChainActionsForm;
import com.echothree.control.user.chain.remote.result.ChainResultFactory;
import com.echothree.control.user.chain.remote.result.GetChainActionsResult;
...
public class GetChainActionsCommand
        extends BaseSimpleCommand<GetChainActionsForm> {
    ...
    public GetChainActionsCommand(UserVisitPK userVisitPK, GetChainActionsForm form) {
