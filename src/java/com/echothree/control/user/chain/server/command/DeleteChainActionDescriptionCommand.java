...
import com.echothree.control.user.chain.common.form.DeleteChainActionDescriptionForm;
...
public class DeleteChainActionDescriptionCommand
        extends BaseSimpleCommand<DeleteChainActionDescriptionForm> {
    ...
    public DeleteChainActionDescriptionCommand(UserVisitPK userVisitPK, DeleteChainActionDescriptionForm form) {
                ...
                if(chain != null) {
                    ...
                    if(chainActionSet != null) {
                        ...
                        if(chainAction != null) {
                            ...
                            if(language != null) {
                                ChainActionDescription chainActionDescription = chainControl.getChainActionDescriptionForUpdate(chainAction, language);

                                if(chainActionDescription != null) {
                                    chainControl.deleteChainActionDescription(chainActionDescription, getPartyPK());
                                } else {
