...
import com.echothree.control.user.chain.common.form.GetChainActionTypeDescriptionForm;
import com.echothree.control.user.chain.common.result.ChainResultFactory;
import com.echothree.control.user.chain.common.result.GetChainActionTypeDescriptionResult;
...
public class GetChainActionTypeDescriptionCommand
        extends BaseSimpleCommand<GetChainActionTypeDescriptionForm> {
    ...
    /** Creates a new instance of GetChainActionTypeDescriptionCommand */
    public GetChainActionTypeDescriptionCommand(UserVisitPK userVisitPK, GetChainActionTypeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        var result = ChainResultFactory.getGetChainActionTypeDescriptionResult();
        ...
        if(chainActionType != null) {
            ...
            if(language != null) {
                var chainActionTypeDescription = chainControl.getChainActionTypeDescription(chainActionType, language);
