...
import com.echothree.control.user.chain.remote.form.GetChainKindDescriptionsForm;
import com.echothree.control.user.chain.remote.result.ChainResultFactory;
import com.echothree.control.user.chain.remote.result.GetChainKindDescriptionsResult;
...
public class GetChainKindDescriptionsCommand
    ...
    public GetChainKindDescriptionsCommand(UserVisitPK userVisitPK, GetChainKindDescriptionsForm form) {
