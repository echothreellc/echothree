...
import com.echothree.control.user.chain.remote.form.DeleteChainKindDescriptionForm;
...
public class DeleteChainKindDescriptionCommand
        extends BaseSimpleCommand<DeleteChainKindDescriptionForm> {
    ...
    protected BaseResult execute() {
        ...
        if(chainKind != null) {
            ...
            if(language != null) {
                ChainKindDescription chainKindDescription = chainControl.getChainKindDescriptionForUpdate(chainKind, language);
                
                if(chainKindDescription != null) {
                    chainControl.deleteChainKindDescription(chainKindDescription, getPartyPK());
                } else {
