...
import com.echothree.control.user.chain.common.form.GetChainEntityRoleTypeDescriptionsForm;
import com.echothree.control.user.chain.common.result.ChainResultFactory;
import com.echothree.control.user.chain.common.result.GetChainEntityRoleTypeDescriptionsResult;
...
public class GetChainEntityRoleTypeDescriptionsCommand
        extends BaseSimpleCommand<GetChainEntityRoleTypeDescriptionsForm> {
    ...
    public GetChainEntityRoleTypeDescriptionsCommand(UserVisitPK userVisitPK, GetChainEntityRoleTypeDescriptionsForm form) {
        ...
        if(chainKind != null) {
            ...
            if(chainType != null) {
                ...
                if(chainEntityRoleType != null) {
                    ...
                    result.setChainEntityRoleTypeDescriptions(chainControl.getChainEntityRoleTypeDescriptionTransfersByChainEntityRoleType(getUserVisit(), chainEntityRoleType));
                } else {
