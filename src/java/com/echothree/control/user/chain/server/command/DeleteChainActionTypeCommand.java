...
import com.echothree.control.user.chain.common.form.DeleteChainActionTypeForm;
...
public class DeleteChainActionTypeCommand
        extends BaseSimpleCommand<DeleteChainActionTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                    new SecurityRoleDefinition(SecurityRoleGroups.ChainActionType.name(), SecurityRoles.Delete.name())
                    )))
                )));
    ...
    /** Creates a new instance of DeleteChainActionTypeCommand */
    public DeleteChainActionTypeCommand(UserVisitPK userVisitPK, DeleteChainActionTypeForm form) {
