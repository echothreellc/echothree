...
import com.echothree.control.user.chain.common.form.CreateChainActionDescriptionForm;
...
public class CreateChainActionDescriptionCommand
        extends BaseSimpleCommand<CreateChainActionDescriptionForm> {
    ...
    public CreateChainActionDescriptionCommand(UserVisitPK userVisitPK, CreateChainActionDescriptionForm form) {
                        ...
                        if(chainAction != null) {
                            ...
                            if(language != null) {
                                ...
                                if(chainActionDescription == null) {
                                    ...
                                    chainControl.createChainActionDescription(chainAction, language, description, getPartyPK());
                                } else {
                                    addExecutionError(ExecutionErrors.DuplicateChainActionDescription.name(), chainKindName, chainTypeName, chainName,
