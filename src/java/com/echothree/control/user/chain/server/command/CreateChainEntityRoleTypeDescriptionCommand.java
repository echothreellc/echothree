...
public class CreateChainEntityRoleTypeDescriptionCommand
        extends BaseSimpleCommand<CreateChainEntityRoleTypeDescriptionForm> {
                ...
                if(chainEntityRoleType != null) {
                    ...
                    if(language != null) {
                        ...
                        if(chainEntityRoleTypeDescription == null) {
                            ...
                            addExecutionError(ExecutionErrors.DuplicateChainEntityRoleTypeDescription.name());
                        }
                    } else {
                        addExecutionError(ExecutionErrors.UnknownLanguageIsoName.name(), chainKindName, chainTypeName, chainEntityRoleTypeName, languageIsoName);
                    }
                } else {
