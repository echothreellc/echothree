...
import com.echothree.control.user.chain.common.form.DeleteChainEntityRoleTypeDescriptionForm;
...
public class DeleteChainEntityRoleTypeDescriptionCommand
        extends BaseSimpleCommand<DeleteChainEntityRoleTypeDescriptionForm> {
        ...
        if(chainKind != null) {
            ...
            if(chainType != null) {
                ...
                if(chainEntityRoleType != null) {
                    ...
                    if(language != null) {
                        ChainEntityRoleTypeDescription chainEntityRoleTypeDescription = chainControl.getChainEntityRoleTypeDescriptionForUpdate(chainEntityRoleType, language);

                        if(chainEntityRoleTypeDescription != null) {
                            chainControl.deleteChainEntityRoleTypeDescription(chainEntityRoleTypeDescription, getPartyPK());
                        } else {
