...
public class GetChainActionSetDescriptionCommand
    ...
    public GetChainActionSetDescriptionCommand(UserVisitPK userVisitPK, GetChainActionSetDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetChainActionSetDescriptionResult result = ChainResultFactory.getGetChainActionSetDescriptionResult();
