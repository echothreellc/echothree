...
@Dependent
public class CreateChainDescriptionCommand
        extends BaseSimpleCommand<CreateChainDescriptionForm> {
                ...
                if(chain != null) {
                    ...
                    if(language != null) {
                        ...
                        if(chainDescription == null) {
                            ...
                            chainControl.createChainDescription(chain, language, description, getPartyPK());
                        } else {
                            addExecutionError(ExecutionErrors.DuplicateChainDescription.name());
                        }
                    } else {
                        addExecutionError(ExecutionErrors.UnknownLanguageIsoName.name(), chainKindName, chainTypeName, chainName, languageIsoName);
                    }
                } else {
