...
public class GetChainActionCommand
        extends BaseSingleEntityCommand<ChainAction, GetChainActionForm> {
    ...
    static {
        ...
        FORM_FIELD_DEFINITIONS = List.of(
                ...
                new FieldDefinition("ChainActionName", FieldType.ENTITY_NAME, false, null, null),
    ...
    @Override
    protected ChainAction getEntity() {
        var chainAction = chainActionLogic.getChainActionByUniversalSpec(this, form, true);
    ...
    @Override
    protected BaseResult getResult(ChainAction chainAction) {
