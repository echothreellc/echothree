...
import com.echothree.control.user.chain.remote.form.GetChainActionForm;
import com.echothree.control.user.chain.remote.result.ChainResultFactory;
import com.echothree.control.user.chain.remote.result.GetChainActionResult;
...
public class GetChainActionCommand
        extends BaseSimpleCommand<GetChainActionForm> {
    ...
    public GetChainActionCommand(UserVisitPK userVisitPK, GetChainActionForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetChainActionResult result = ChainResultFactory.getGetChainActionResult();
                ...
                if(chain != null) {
                    ...
                    if(chainActionSet != null) {
                        ...
                        if(chainAction != null) {
                            ...
                            sendEventUsingNames(chainAction.getPrimaryKey(), EventTypes.READ.name(), null, null, getPartyPK());
                        } else {
