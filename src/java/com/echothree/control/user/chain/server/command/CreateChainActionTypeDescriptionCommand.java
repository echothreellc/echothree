...
public class CreateChainActionTypeDescriptionCommand
        extends BaseSimpleCommand<CreateChainActionTypeDescriptionForm> {
    ...
    /** Creates a new instance of CreateChainActionTypeDescriptionCommand */
    public CreateChainActionTypeDescriptionCommand(UserVisitPK userVisitPK, CreateChainActionTypeDescriptionForm form) {
        ...
        if(chainActionType != null) {
            ...
            if(language != null) {
                ...
                if(chainActionTypeDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateChainActionTypeDescription.name(), chainActionTypeName, languageIsoName);
                }
            } else {
