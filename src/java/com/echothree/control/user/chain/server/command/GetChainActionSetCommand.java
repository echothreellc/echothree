...
public class GetChainActionSetCommand
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                    new SecurityRoleDefinition(SecurityRoleGroups.ChainActionSet.name(), SecurityRoles.Review.name())
                    )))
                )));
    ...
    public GetChainActionSetCommand(UserVisitPK userVisitPK, GetChainActionSetForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetChainActionSetResult result = ChainResultFactory.getGetChainActionSetResult();
            ...
            if(chainType != null) {
                ...
                if(chain != null) {
                    ...
                    if(chainActionSet != null) {
                        ...
                        sendEventUsingNames(chainActionSet.getPrimaryKey(), EventTypes.READ.name(), null, null, getPartyPK());
                    } else {
