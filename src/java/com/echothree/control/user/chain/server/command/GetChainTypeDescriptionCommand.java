...
import com.echothree.control.user.chain.remote.form.GetChainTypeDescriptionForm;
import com.echothree.control.user.chain.remote.result.ChainResultFactory;
import com.echothree.control.user.chain.remote.result.GetChainTypeDescriptionResult;
...
public class GetChainTypeDescriptionCommand
        extends BaseSimpleCommand<GetChainTypeDescriptionForm> {
    ...
    /** Creates a new instance of GetChainTypeDescriptionCommand */
    public GetChainTypeDescriptionCommand(UserVisitPK userVisitPK, GetChainTypeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetChainTypeDescriptionResult result = ChainResultFactory.getGetChainTypeDescriptionResult();
