...
public class DeleteChainCommand
        extends BaseSimpleCommand<DeleteChainForm> {
    ...
    /** Creates a new instance of DeleteChainCommand */
    public DeleteChainCommand(UserVisitPK userVisitPK, DeleteChainForm form) {
