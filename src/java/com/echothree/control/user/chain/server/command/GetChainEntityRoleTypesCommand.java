...
import com.echothree.control.user.chain.remote.form.GetChainEntityRoleTypesForm;
import com.echothree.control.user.chain.remote.result.ChainResultFactory;
import com.echothree.control.user.chain.remote.result.GetChainEntityRoleTypesResult;
...
public class GetChainEntityRoleTypesCommand
        extends BaseSimpleCommand<GetChainEntityRoleTypesForm> {
    ...
    protected BaseResult execute() {
        ...
        GetChainEntityRoleTypesResult result = ChainResultFactory.getGetChainEntityRoleTypesResult();
        ...
        if(chainKind != null) {
            ...
            if(chainType != null) {
                ...
                result.setChainEntityRoleTypes(chainControl.getChainEntityRoleTypeTransfersByChainType(getUserVisit(), chainType));
            } else {
