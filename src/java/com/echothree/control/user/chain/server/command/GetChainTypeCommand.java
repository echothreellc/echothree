...
import com.echothree.control.user.chain.remote.form.GetChainTypeForm;
import com.echothree.control.user.chain.remote.result.ChainResultFactory;
import com.echothree.control.user.chain.remote.result.GetChainTypeResult;
...
public class GetChainTypeCommand
    ...
    protected BaseResult execute() {
        ...
        GetChainTypeResult result = ChainResultFactory.getGetChainTypeResult();
        ...
        if(chainKind != null) {
            ...
            if(chainType != null) {
                ...
                sendEventUsingNames(chainType.getPrimaryKey(), EventTypes.READ.name(), null, null, getPartyPK());
            } else {
