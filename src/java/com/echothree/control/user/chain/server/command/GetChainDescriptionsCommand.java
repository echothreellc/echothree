...
import com.echothree.control.user.chain.remote.form.GetChainDescriptionsForm;
import com.echothree.control.user.chain.remote.result.ChainResultFactory;
import com.echothree.control.user.chain.remote.result.GetChainDescriptionsResult;
...
public class GetChainDescriptionsCommand
        extends BaseSimpleCommand<GetChainDescriptionsForm> {
    ...
    /** Creates a new instance of GetChainDescriptionsCommand */
    public GetChainDescriptionsCommand(UserVisitPK userVisitPK, GetChainDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetChainDescriptionsResult result = ChainResultFactory.getGetChainDescriptionsResult();
        ...
        if(chainKind != null) {
            ...
            if(chainType != null) {
                ...
                if(chain != null) {
                    ...
                    result.setChainDescriptions(chainControl.getChainDescriptionTransfersByChain(getUserVisit(), chain));
                } else {
