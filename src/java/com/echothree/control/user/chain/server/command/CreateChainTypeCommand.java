...
public class CreateChainTypeCommand
        extends BaseSimpleCommand<CreateChainTypeForm> {
    ...
    /** Creates a new instance of CreateChainTypeCommand */
    public CreateChainTypeCommand(UserVisitPK userVisitPK, CreateChainTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(chainKind != null) {
            ...
            if(chainType == null) {
                ...
                chainType = chainControl.createChainType(chainKind, chainTypeName, isDefault, sortOrder, partyPK);

                if(description != null) {
                    chainControl.createChainTypeDescription(chainType, getPreferredLanguage(), description, partyPK);
                }
            } else {
                addExecutionError(ExecutionErrors.DuplicateChainTypeName.name(), chainKindName, chainTypeName);
            }
        } else {
