...
public class DeleteChainActionSetDescriptionCommand
        extends BaseSimpleCommand<DeleteChainActionSetDescriptionForm> {
    ...
    /** Creates a new instance of DeleteChainActionSetDescriptionCommand */
    public DeleteChainActionSetDescriptionCommand(UserVisitPK userVisitPK, DeleteChainActionSetDescriptionForm form) {
            ...
            if(chainType != null) {
                ...
                if(chain != null) {
                    ...
                    if(chainActionSet != null) {
                        ...
                        if(language != null) {
                            ChainActionSetDescription chainActionSetDescription = chainControl.getChainActionSetDescriptionForUpdate(chainActionSet, language);

                            if(chainActionSetDescription != null) {
                                chainControl.deleteChainActionSetDescription(chainActionSetDescription, getPartyPK());
                            } else {
                                addExecutionError(ExecutionErrors.UnknownChainActionSetDescription.name(), chainKindName, chainTypeName, chainName,
                                        chainActionSetName, languageIsoName);
                            }
                        } else {
