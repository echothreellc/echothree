...
import com.echothree.control.user.chain.remote.form.GetChainActionSetChoicesForm;
import com.echothree.control.user.chain.remote.result.ChainResultFactory;
import com.echothree.control.user.chain.remote.result.GetChainActionSetChoicesResult;
...
public class GetChainActionSetChoicesCommand
        extends BaseSimpleCommand<GetChainActionSetChoicesForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                    new SecurityRoleDefinition(SecurityRoleGroups.ChainActionSet.name(), SecurityRoles.Choices.name())
                    )))
                )));
        ...
        FORM_FIELD_DEFINITIONS = Collections.unmodifiableList(Arrays.asList(
                ...
                new FieldDefinition("DefaultChainActionSetChoice", FieldType.ENTITY_NAME, false, null, null),
                new FieldDefinition("AllowNullChoice", FieldType.BOOLEAN, true, null, null)
                ));
    }
    
    /** Creates a new instance of GetChainActionSetChoicesCommand */
    public GetChainActionSetChoicesCommand(UserVisitPK userVisitPK, GetChainActionSetChoicesForm form) {
