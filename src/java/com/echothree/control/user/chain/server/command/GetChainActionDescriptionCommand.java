...
import com.echothree.control.user.chain.remote.form.GetChainActionDescriptionForm;
import com.echothree.control.user.chain.remote.result.ChainResultFactory;
import com.echothree.control.user.chain.remote.result.GetChainActionDescriptionResult;
...
public class GetChainActionDescriptionCommand
        extends BaseSimpleCommand<GetChainActionDescriptionForm> {
    ...
    /** Creates a new instance of GetChainActionDescriptionCommand */
    public GetChainActionDescriptionCommand(UserVisitPK userVisitPK, GetChainActionDescriptionForm form) {
                ...
                if(chain != null) {
                    ...
                    if(chainActionSet != null) {
                        ...
                        if(chainAction != null) {
                            ...
                            if(language != null) {
                                ChainActionDescription chainActionDescription = chainControl.getChainActionDescription(chainAction, language);
                            ...
                            addExecutionError(ExecutionErrors.UnknownChainActionName.name(), chainKindName, chainTypeName, chainName, chainActionSetName, chainActionName);
                        }
                    } else {
