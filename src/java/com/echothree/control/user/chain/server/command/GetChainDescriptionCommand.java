...
import com.echothree.control.user.chain.remote.form.GetChainDescriptionForm;
import com.echothree.control.user.chain.remote.result.ChainResultFactory;
import com.echothree.control.user.chain.remote.result.GetChainDescriptionResult;
...
public class GetChainDescriptionCommand
        extends BaseSimpleCommand<GetChainDescriptionForm> {
    ...
    /** Creates a new instance of GetChainDescriptionCommand */
    public GetChainDescriptionCommand(UserVisitPK userVisitPK, GetChainDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetChainDescriptionResult result = ChainResultFactory.getGetChainDescriptionResult();
        ...
        if(chainKind != null) {
            ...
            if(chainType != null) {
                ...
                if(chain != null) {
                    ...
                    if(language != null) {
                        ChainDescription chainDescription = chainControl.getChainDescription(chain, language);
