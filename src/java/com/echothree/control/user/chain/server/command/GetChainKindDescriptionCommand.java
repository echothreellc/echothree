...
import com.echothree.control.user.chain.remote.form.GetChainKindDescriptionForm;
import com.echothree.control.user.chain.remote.result.ChainResultFactory;
import com.echothree.control.user.chain.remote.result.GetChainKindDescriptionResult;
...
public class GetChainKindDescriptionCommand
        extends BaseSimpleCommand<GetChainKindDescriptionForm> {
    ...
    /** Creates a new instance of GetChainKindDescriptionCommand */
    public GetChainKindDescriptionCommand(UserVisitPK userVisitPK, GetChainKindDescriptionForm form) {
