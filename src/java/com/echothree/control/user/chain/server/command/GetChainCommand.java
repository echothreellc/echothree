...
import com.echothree.control.user.chain.remote.form.GetChainForm;
import com.echothree.control.user.chain.remote.result.ChainResultFactory;
import com.echothree.control.user.chain.remote.result.GetChainResult;
...
public class GetChainCommand
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                    new SecurityRoleDefinition(SecurityRoleGroups.Chain.name(), SecurityRoles.Review.name())
                    )))
                )));
    ...
    public GetChainCommand(UserVisitPK userVisitPK, GetChainForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetChainResult result = ChainResultFactory.getGetChainResult();
