...
public interface GetSearchSortOrderChoicesForm
        extends SearchTypeSpec {
    
    String getDefaultSearchSortOrderChoice();
    void setDefaultSearchSortOrderChoice(String defaultSearchSortOrderChoice);
