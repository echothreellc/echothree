...
public interface CreateSearchResultActionTypeResult
        extends SearchResultActionTypeSpec, EntityRefSpec, BaseResult {
    
    // Nothing additional beyond SearchResultActionTypeSpec, EntityRefSpec, BaseResult
