...
public interface CreateSearchSortOrderDescriptionForm
        extends SearchSortOrderDescriptionSpec, SearchSortOrderDescriptionEdit {
    
    // Nothing additional beyond SearchSortOrderDescriptionSpec, SearchSortOrderDescriptionEdit
