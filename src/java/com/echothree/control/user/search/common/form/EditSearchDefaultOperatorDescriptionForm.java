...
public interface EditSearchDefaultOperatorDescriptionForm
        extends BaseEditForm<SearchDefaultOperatorDescriptionSpec, SearchDefaultOperatorDescriptionEdit> {
