...
public interface CreateSearchTypeDescriptionForm
        extends SearchTypeDescriptionSpec, SearchTypeDescriptionEdit {
    
    // Nothing additional beyond SearchTypeDescriptionSpec, SearchTypeDescriptionEdit
