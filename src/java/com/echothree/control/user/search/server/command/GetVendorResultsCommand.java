...
import com.echothree.control.user.search.remote.form.GetVendorResultsForm;
import com.echothree.control.user.search.remote.result.GetVendorResultsResult;
        ...
        if(searchKind != null) {
            ...
            if(searchType != null) {
                ...
                if(userVisitSearch != null) {
                    ...
                    result.setVendorResults(searchControl.getVendorResultTransfers(userVisit, userVisitSearch));
                } else {
