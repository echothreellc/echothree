...
import com.echothree.control.user.search.remote.form.DeleteSearchTypeForm;
...
public class DeleteSearchTypeCommand
        extends BaseSimpleCommand<DeleteSearchTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                    new SecurityRoleDefinition(SecurityRoleGroups.SearchType.name(), SecurityRoles.Delete.name())
                    )))
                )));
    ...
    public DeleteSearchTypeCommand(UserVisitPK userVisitPK, DeleteSearchTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(searchKind != null) {
            ...
            SearchType searchType = searchControl.getSearchTypeByNameForUpdate(searchKind, searchTypeName);
            
            if(searchType != null) {
                searchControl.deleteSearchType(searchType, getPartyPK());
            } else {
