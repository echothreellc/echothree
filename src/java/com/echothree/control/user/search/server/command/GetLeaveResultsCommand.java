...
import com.echothree.control.user.search.remote.form.GetLeaveResultsForm;
import com.echothree.control.user.search.remote.result.GetLeaveResultsResult;
...
public class GetLeaveResultsCommand
        extends BaseSimpleCommand<GetLeaveResultsForm> {
    ...
    public GetLeaveResultsCommand(UserVisitPK userVisitPK, GetLeaveResultsForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(!hasExecutionErrors()) {
            ...
            result.setLeaveResults(searchControl.getLeaveResultTransfers(userVisit, userVisitSearch));
        }
