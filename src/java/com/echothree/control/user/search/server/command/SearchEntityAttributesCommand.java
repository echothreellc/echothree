...
public class SearchEntityAttributesCommand
    ...
    public SearchEntityAttributesCommand(UserVisitPK userVisitPK, SearchEntityAttributesForm form) {
    ...
    protected BaseResult execute() {
        ...
        var searchKind = searchLogic.getSearchKindByName(null, SearchKinds.ENTITY_ATTRIBUTE.name());
