...
public class GetEntityAliasTypeResultsCommand
        extends BaseSimpleCommand<GetEntityAliasTypeResultsForm> {
    ...
    protected BaseResult execute() {
        ...
        if(searchKind != null) {
            ...
            if(searchType != null) {
                ...
                addExecutionError(ExecutionErrors.UnknownSearchTypeName.name(), SearchKinds.ENTITY_ALIAS_TYPE.name(), searchTypeName);
            }
        } else {
            addExecutionError(ExecutionErrors.UnknownSearchKindName.name(), SearchKinds.ENTITY_ALIAS_TYPE.name());
        }
