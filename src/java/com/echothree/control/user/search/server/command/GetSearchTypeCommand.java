...
import com.echothree.control.user.search.remote.form.GetSearchTypeForm;
import com.echothree.control.user.search.remote.result.GetSearchTypeResult;
...
public class GetSearchTypeCommand
        extends BaseSimpleCommand<GetSearchTypeForm> {
    ...
    protected BaseResult execute() {
        ...
        GetSearchTypeResult result = SearchResultFactory.getGetSearchTypeResult();
        ...
        if(searchKind != null) {
            ...
            if(searchType != null) {
                ...
                sendEventUsingNames(searchType.getPrimaryKey(), EventTypes.READ.name(), null, null, getPartyPK());
            } else {
