...
public class GetSearchKindDescriptionsCommand
        extends BaseSimpleCommand<GetSearchKindDescriptionsForm> {
    ...
    /** Creates a new instance of GetSearchKindDescriptionsCommand */
    public GetSearchKindDescriptionsCommand(UserVisitPK userVisitPK, GetSearchKindDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        var result = SearchResultFactory.getGetSearchKindDescriptionsResult();
        ...
        if(searchKind != null) {
            ...
            result.setSearchKindDescriptions(searchControl.getSearchKindDescriptionTransfersBySearchKind(getUserVisit(), searchKind));
        } else {
