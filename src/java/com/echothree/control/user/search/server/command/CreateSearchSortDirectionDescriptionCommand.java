...
import com.echothree.control.user.search.remote.form.CreateSearchSortDirectionDescriptionForm;
...
public class CreateSearchSortDirectionDescriptionCommand
        extends BaseSimpleCommand<CreateSearchSortDirectionDescriptionForm> {
    ...
    public CreateSearchSortDirectionDescriptionCommand(UserVisitPK userVisitPK, CreateSearchSortDirectionDescriptionForm form) {
        ...
        if(searchSortDirection != null) {
            ...
            if(language != null) {
                ...
                if(searchSortDirectionDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateSearchSortDirectionDescription.name(), searchSortDirectionName, languageIsoName);
                }
            } else {
