...
public class DeleteSearchTypeDescriptionCommand
        extends BaseSimpleCommand<DeleteSearchTypeDescriptionForm> {
    ...
    /** Creates a new instance of DeleteSearchTypeDescriptionCommand */
    public DeleteSearchTypeDescriptionCommand(UserVisitPK userVisitPK, DeleteSearchTypeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(searchKind != null) {
            ...
            if(searchType != null) {
                ...
                if(language != null) {
                    SearchTypeDescription searchTypeDescription = searchControl.getSearchTypeDescriptionForUpdate(searchType, language);
                    
                    if(searchTypeDescription != null) {
                        searchControl.deleteSearchTypeDescription(searchTypeDescription, getPartyPK());
                    } else {
