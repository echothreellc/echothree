...
import com.echothree.control.user.search.remote.form.GetSearchResultActionTypeForm;
import com.echothree.control.user.search.remote.result.GetSearchResultActionTypeResult;
...
public class GetSearchResultActionTypeCommand
    ...
    protected BaseResult execute() {
        ...
        int parameterCount = (searchResultActionTypeName == null ? 0 : 1) + EntityInstanceLogic.getInstance().countPossibleEntitySpecs(form);
