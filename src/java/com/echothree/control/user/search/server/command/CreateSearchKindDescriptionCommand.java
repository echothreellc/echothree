...
public class CreateSearchKindDescriptionCommand
        extends BaseSimpleCommand<CreateSearchKindDescriptionForm> {
    ...
    /** Creates a new instance of CreateSearchKindDescriptionCommand */
    public CreateSearchKindDescriptionCommand(UserVisitPK userVisitPK, CreateSearchKindDescriptionForm form) {
        ...
        if(searchKind != null) {
            ...
            if(language != null) {
                ...
                if(searchKindDescription == null) {
                    ...
                    searchControl.createSearchKindDescription(searchKind, language, description, getPartyPK());
                } else {
                    addExecutionError(ExecutionErrors.DuplicateSearchKindDescription.name());
                }
            } else {
