...
import com.echothree.control.user.search.common.form.SearchEntityAttributeGroupsForm;
...
@Dependent
public class SearchEntityAttributeGroupsCommand
        extends BaseSearchCommand<SearchEntityAttributeGroupsForm, SearchEntityAttributeGroupsResult> {
    ...
    protected BaseResult execute() {
        var result = SearchResultFactory.getSearchEntityAttributeGroupsResult();
        var searchLogic = SearchLogic.getInstance();
        var searchKind = searchLogic.getSearchKindByName(this, SearchKinds.ENTITY_ATTRIBUTE_GROUP.name());
                        ...
                        if(!hasExecutionErrors()) {
                            ...
                            if(!hasExecutionErrors()) {
                                ...
                                if(!hasExecutionErrors()) {
                                    ...
                                    var entityListItemSearchEvaluator = new EntityAttributeGroupSearchEvaluator(userVisit, language,
