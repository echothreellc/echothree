...
import com.echothree.control.user.search.remote.form.CreateSearchDefaultOperatorForm;
...
public class CreateSearchDefaultOperatorCommand
        extends BaseSimpleCommand<CreateSearchDefaultOperatorForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.SearchDefaultOperator.name(), SecurityRoles.Create.name())
                        )))
                )));
    ...
    /** Creates a new instance of CreateSearchDefaultOperatorCommand */
    public CreateSearchDefaultOperatorCommand(UserVisitPK userVisitPK, CreateSearchDefaultOperatorForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(searchDefaultOperator == null) {
            ...
            searchDefaultOperator = searchControl.createSearchDefaultOperator(searchDefaultOperatorName, isDefault, sortOrder, partyPK);
