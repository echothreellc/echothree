...
public class GetEntityAttributeResultsCommand
        extends BaseSimpleCommand<GetEntityAttributeResultsForm> {
    ...
    protected BaseResult execute() {
        ...
        if(searchKind != null) {
            ...
            if(searchType != null) {
                ...
                addExecutionError(ExecutionErrors.UnknownSearchTypeName.name(), SearchKinds.ENTITY_ATTRIBUTE.name(), searchTypeName);
            }
        } else {
            addExecutionError(ExecutionErrors.UnknownSearchKindName.name(), SearchKinds.ENTITY_ATTRIBUTE.name());
        }
