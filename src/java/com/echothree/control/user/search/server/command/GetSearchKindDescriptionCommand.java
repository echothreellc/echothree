...
import com.echothree.control.user.search.remote.form.GetSearchKindDescriptionForm;
import com.echothree.control.user.search.remote.result.GetSearchKindDescriptionResult;
...
public class GetSearchKindDescriptionCommand
        extends BaseSimpleCommand<GetSearchKindDescriptionForm> {
    ...
    /** Creates a new instance of GetSearchKindDescriptionCommand */
    public GetSearchKindDescriptionCommand(UserVisitPK userVisitPK, GetSearchKindDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetSearchKindDescriptionResult result = SearchResultFactory.getGetSearchKindDescriptionResult();
