...
import com.echothree.control.user.search.common.form.SearchShippingMethodsForm;
...
import com.echothree.model.control.shipping.server.search.ShippingMethodSearchEvaluator;
...
@Dependent
public class SearchShippingMethodsCommand
        extends BaseSearchCommand<SearchShippingMethodsForm, SearchShippingMethodsResult> {
                        ...
                        if(!hasExecutionErrors()) {
                            ...
                            if(!hasExecutionErrors()) {
                                ...
                                if(!hasExecutionErrors()) {
                                    ...
                                    var entityListItemSearchEvaluator = new ShippingMethodSearchEvaluator(userVisit, language,
