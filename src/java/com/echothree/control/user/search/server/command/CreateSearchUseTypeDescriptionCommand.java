...
@Dependent
public class CreateSearchUseTypeDescriptionCommand
        extends BaseSimpleCommand<CreateSearchUseTypeDescriptionForm> {
        ...
        if(searchUseType != null) {
            ...
            if(language != null) {
                ...
                if(searchUseTypeDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateSearchUseTypeDescription.name(), searchUseTypeName, languageIsoName);
                }
            } else {
