...
import com.echothree.control.user.search.remote.form.GetEntityTypeResultsForm;
import com.echothree.control.user.search.remote.result.GetEntityTypeResultsResult;
    ...
    protected BaseResult execute() {
        ...
        if(searchKind != null) {
            ...
            if(searchType != null) {
                ...
                addExecutionError(ExecutionErrors.UnknownSearchTypeName.name(), SearchConstants.SearchKind_ENTITY_TYPE, searchTypeName);
            }
        } else {
            addExecutionError(ExecutionErrors.UnknownSearchKindName.name(), SearchConstants.SearchKind_ENTITY_TYPE);
        }
