...
import com.echothree.control.user.search.common.form.GetSearchResultActionTypeDescriptionForm;
import com.echothree.control.user.search.common.result.GetSearchResultActionTypeDescriptionResult;
...
public class GetSearchResultActionTypeDescriptionCommand
        extends BaseSimpleCommand<GetSearchResultActionTypeDescriptionForm> {
    ...
    /** Creates a new instance of GetSearchResultActionTypeDescriptionCommand */
    public GetSearchResultActionTypeDescriptionCommand(UserVisitPK userVisitPK, GetSearchResultActionTypeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetSearchResultActionTypeDescriptionResult result = SearchResultFactory.getGetSearchResultActionTypeDescriptionResult();
