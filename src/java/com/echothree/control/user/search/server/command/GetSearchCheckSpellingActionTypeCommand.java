...
import com.echothree.control.user.search.remote.form.GetSearchCheckSpellingActionTypeForm;
import com.echothree.control.user.search.remote.result.GetSearchCheckSpellingActionTypeResult;
...
public class GetSearchCheckSpellingActionTypeCommand
        extends BaseSimpleCommand<GetSearchCheckSpellingActionTypeForm> {
        ...
        if(parameterCount == 1) {
            ...
            if(searchCheckSpellingActionTypeName == null) {
                ...
                if(!hasExecutionErrors()) {
                    searchCheckSpellingActionType = searchControl.getSearchCheckSpellingActionTypeByEntityInstance(entityInstance);
                }
            } else {
