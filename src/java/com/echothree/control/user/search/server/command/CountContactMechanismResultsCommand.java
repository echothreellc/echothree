...
import com.echothree.control.user.search.remote.form.CountContactMechanismResultsForm;
import com.echothree.control.user.search.remote.result.CountContactMechanismResultsResult;
...
public class CountContactMechanismResultsCommand
    ...
    protected BaseResult execute() {
        return execute(SearchConstants.SearchKind_CONTACT_MECHANISM, SearchResultFactory.getCountContactMechanismResultsResult());
    }
