...
import com.echothree.control.user.search.remote.form.SetDefaultSearchUseTypeForm;
...
public class SetDefaultSearchUseTypeCommand
    ...
    public SetDefaultSearchUseTypeCommand(UserVisitPK userVisitPK, SetDefaultSearchUseTypeForm form) {
