...
import com.echothree.control.user.search.common.form.SetDefaultSearchCheckSpellingActionTypeForm;
...
public class SetDefaultSearchCheckSpellingActionTypeCommand
        extends BaseSimpleCommand<SetDefaultSearchCheckSpellingActionTypeForm> {
    ...
    public SetDefaultSearchCheckSpellingActionTypeCommand(UserVisitPK userVisitPK, SetDefaultSearchCheckSpellingActionTypeForm form) {
