...
public class GetShippingMethodResultsCommand
        extends BaseSimpleCommand<GetShippingMethodResultsForm> {
    ...
    protected BaseResult execute() {
        ...
        if(searchKind != null) {
            ...
            if(searchType != null) {
                ...
                addExecutionError(ExecutionErrors.UnknownSearchTypeName.name(), SearchKinds.SHIPPING_METHOD.name(), searchTypeName);
            }
        } else {
            addExecutionError(ExecutionErrors.UnknownSearchKindName.name(), SearchKinds.SHIPPING_METHOD.name());
        }
