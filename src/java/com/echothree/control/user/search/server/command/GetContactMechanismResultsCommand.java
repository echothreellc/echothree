        ...
        if(searchKind != null) {
            ...
            if(searchType != null) {
                ...
                if(userVisitSearch != null) {
                    ...
                    result.setContactMechanismResults(searchControl.getContactMechanismResultTransfers(userVisit, userVisitSearch));
                } else {
                    addExecutionError(ExecutionErrors.UnknownUserVisitSearch.name());
                }
            } else {
                addExecutionError(ExecutionErrors.UnknownSearchTypeName.name(), SearchConstants.SearchKind_CONTACT_MECHANISM, searchTypeName);
            }
        } else {
            addExecutionError(ExecutionErrors.UnknownSearchKindName.name(), SearchConstants.SearchKind_CONTACT_MECHANISM);
        }
