...
import com.echothree.control.user.search.common.form.GetContactMechanismResultsForm;
import com.echothree.control.user.search.common.result.GetContactMechanismResultsResult;
import com.echothree.control.user.search.common.result.SearchResultFactory;
import com.echothree.model.control.contact.server.control.ContactMechanismControl;
...
public class GetContactMechanismResultsCommand
        extends BaseSimpleCommand<GetContactMechanismResultsForm> {
    ...
    protected BaseResult execute() {
        ...
        SearchKind searchKind = searchControl.getSearchKindByName(SearchKinds.CONTACT_MECHANISM.name());
        ...
        if(searchKind != null) {
            ...
            if(searchType != null) {
                ...
                addExecutionError(ExecutionErrors.UnknownSearchTypeName.name(), SearchKinds.CONTACT_MECHANISM.name(), searchTypeName);
            }
        } else {
            addExecutionError(ExecutionErrors.UnknownSearchKindName.name(), SearchKinds.CONTACT_MECHANISM.name());
        }
