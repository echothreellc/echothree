...
import com.echothree.control.user.search.remote.form.GetUseResultsForm;
import com.echothree.control.user.search.remote.result.GetUseResultsResult;
...
public class GetUseResultsCommand
        extends BaseSimpleCommand<GetUseResultsForm> {
        ...
        if(searchKind != null) {
            ...
            if(searchType != null) {
                ...
                if(userVisitSearch != null) {
                    ...
                    result.setUseResults(searchControl.getUseResultTransfers(userVisit, userVisitSearch));
                } else {
                    addExecutionError(ExecutionErrors.UnknownUserVisitSearch.name());
                }
            } else {
                addExecutionError(ExecutionErrors.UnknownSearchTypeName.name(), SearchConstants.SearchKind_USE, searchTypeName);
            }
        } else {
            addExecutionError(ExecutionErrors.UnknownSearchKindName.name(), SearchConstants.SearchKind_USE);
        }
