...
import com.echothree.control.user.search.remote.form.GetSearchSortOrderDescriptionsForm;
import com.echothree.control.user.search.remote.result.GetSearchSortOrderDescriptionsResult;
...
public class GetSearchSortOrderDescriptionsCommand
        extends BaseSimpleCommand<GetSearchSortOrderDescriptionsForm> {
    ...
    /** Creates a new instance of GetSearchSortOrderDescriptionsCommand */
    public GetSearchSortOrderDescriptionsCommand(UserVisitPK userVisitPK, GetSearchSortOrderDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetSearchSortOrderDescriptionsResult result = SearchResultFactory.getGetSearchSortOrderDescriptionsResult();
        ...
        if(searchKind != null) {
            ...
            if(searchSortOrder != null) {
                ...
                result.setSearchSortOrderDescriptions(searchControl.getSearchSortOrderDescriptionTransfersBySearchSortOrder(getUserVisit(), searchSortOrder));
            } else {
