...
import com.echothree.control.user.search.common.form.DeleteSearchDefaultOperatorForm;
...
public class DeleteSearchDefaultOperatorCommand
        extends BaseSimpleCommand<DeleteSearchDefaultOperatorForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.SearchDefaultOperator.name(), SecurityRoles.Delete.name())
                        )))
                )));
    ...
    /** Creates a new instance of DeleteSearchDefaultOperatorCommand */
    public DeleteSearchDefaultOperatorCommand(UserVisitPK userVisitPK, DeleteSearchDefaultOperatorForm form) {
