...
import com.echothree.control.user.search.common.form.DeleteSearchSortDirectionForm;
...
public class DeleteSearchSortDirectionCommand
        extends BaseSimpleCommand<DeleteSearchSortDirectionForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.SearchSortDirection.name(), SecurityRoles.Delete.name())
                        )))
                )));
    ...
    public DeleteSearchSortDirectionCommand(UserVisitPK userVisitPK, DeleteSearchSortDirectionForm form) {
