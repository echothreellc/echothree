...
import com.echothree.control.user.search.common.form.CreateSearchUseTypeForm;
...
public class CreateSearchUseTypeCommand
        extends BaseSimpleCommand<CreateSearchUseTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.SearchUseType.name(), SecurityRoles.Create.name())
                        )))
                )));
    ...
    /** Creates a new instance of CreateSearchUseTypeCommand */
    public CreateSearchUseTypeCommand(UserVisitPK userVisitPK, CreateSearchUseTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(searchUseType == null) {
            ...
            searchUseType = searchControl.createSearchUseType(searchUseTypeName, isDefault, sortOrder, partyPK);
