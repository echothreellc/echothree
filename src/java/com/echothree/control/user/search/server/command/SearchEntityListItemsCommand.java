...
import com.echothree.control.user.search.remote.form.SearchEntityListItemsForm;
import com.echothree.control.user.search.remote.result.SearchEntityListItemsResult;
...
public class SearchEntityListItemsCommand
    ...
    public SearchEntityListItemsCommand(UserVisitPK userVisitPK, SearchEntityListItemsForm form) {
        super(userVisitPK, form, null, FORM_FIELD_DEFINITIONS, false);
    }
    
    @Override
    protected BaseResult execute() {
        SearchEntityListItemsResult result = SearchResultFactory.getSearchEntityListItemsResult();
        SearchLogic searchLogic = SearchLogic.getInstance();
        SearchKind searchKind = searchLogic.getSearchKindByName(null, SearchConstants.SearchKind_ENTITY_LIST_ITEM);
                        ...
                        if(!hasExecutionErrors()) {
                            ...
                            if(!hasExecutionErrors()) {
                                ...
                                if(!hasExecutionErrors()) {
                                    ...
                                    EntityListItemSearchEvaluator entityListItemSearchEvaluator = new EntityListItemSearchEvaluator(userVisit, language,
