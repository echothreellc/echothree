...
public class CreateSearchTypeDescriptionCommand
        extends BaseSimpleCommand<CreateSearchTypeDescriptionForm> {
    ...
    /** Creates a new instance of CreateSearchTypeDescriptionCommand */
    public CreateSearchTypeDescriptionCommand(UserVisitPK userVisitPK, CreateSearchTypeDescriptionForm form) {
            ...
            if(searchType != null) {
                ...
                if(language != null) {
                    ...
                    if(searchTypeDescription == null) {
                        ...
                        addExecutionError(ExecutionErrors.DuplicateSearchTypeDescription.name());
                    }
                } else {
                    addExecutionError(ExecutionErrors.UnknownLanguageIsoName.name(), searchKindName, searchTypeName, languageIsoName);
                }
            } else {
