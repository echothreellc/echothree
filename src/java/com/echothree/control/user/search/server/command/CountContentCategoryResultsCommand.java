...
public class CountContentCategoryResultsCommand
    ...
    /** Creates a new instance of CountContentCategoryResultsCommand */
    public CountContentCategoryResultsCommand(UserVisitPK userVisitPK, CountContentCategoryResultsForm form) {
        super(userVisitPK, form, null);
    }
    
    @Override
    protected BaseResult execute() {
        return execute(SearchConstants.SearchKind_CONTENT_CATEGORY, SearchResultFactory.getCountContentCategoryResultsResult());
    }
