...
import com.echothree.control.user.search.remote.form.GetUseResultsFacetForm;
import com.echothree.control.user.search.remote.result.GetUseResultsFacetResult;
...
public class GetUseResultsFacetCommand
    ...
    protected BaseResult execute() {
        return execute(SearchConstants.SearchKind_USE, SearchResultFactory.getGetUseResultsFacetResult());
    }
