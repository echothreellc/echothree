...
public class DeleteSearchSortOrderDescriptionCommand
        extends BaseSimpleCommand<DeleteSearchSortOrderDescriptionForm> {
    ...
    /** Creates a new instance of DeleteSearchSortOrderDescriptionCommand */
    public DeleteSearchSortOrderDescriptionCommand(UserVisitPK userVisitPK, DeleteSearchSortOrderDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(searchKind != null) {
            ...
            if(searchSortOrder != null) {
                ...
                if(language != null) {
                    SearchSortOrderDescription searchSortOrderDescription = searchControl.getSearchSortOrderDescriptionForUpdate(searchSortOrder, language);
                    
                    if(searchSortOrderDescription != null) {
                        searchControl.deleteSearchSortOrderDescription(searchSortOrderDescription, getPartyPK());
                    } else {
