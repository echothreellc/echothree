...
import com.echothree.control.user.search.common.form.SearchComponentVendorsForm;
...
@Dependent
public class SearchComponentVendorsCommand
        extends BaseSearchCommand<SearchComponentVendorsForm, SearchComponentVendorsResult> {
                        ...
                        if(!hasExecutionErrors()) {
                            ...
                            if(!hasExecutionErrors()) {
                                ...
                                if(!hasExecutionErrors()) {
                                    ...
                                    var entityListItemSearchEvaluator = new ComponentVendorSearchEvaluator(userVisit, language,
