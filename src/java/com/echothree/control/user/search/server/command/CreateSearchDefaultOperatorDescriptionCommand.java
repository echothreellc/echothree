...
@Dependent
public class CreateSearchDefaultOperatorDescriptionCommand
        extends BaseSimpleCommand<CreateSearchDefaultOperatorDescriptionForm> {
        ...
        if(searchDefaultOperator != null) {
            ...
            if(language != null) {
                ...
                if(searchDefaultOperatorDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateSearchDefaultOperatorDescription.name(), searchDefaultOperatorName, languageIsoName);
                }
            } else {
