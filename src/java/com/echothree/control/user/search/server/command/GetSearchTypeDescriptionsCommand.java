...
import com.echothree.control.user.search.remote.form.GetSearchTypeDescriptionsForm;
import com.echothree.control.user.search.remote.result.GetSearchTypeDescriptionsResult;
...
public class GetSearchTypeDescriptionsCommand
        extends BaseSimpleCommand<GetSearchTypeDescriptionsForm> {
    ...
    /** Creates a new instance of GetSearchTypeDescriptionsCommand */
    public GetSearchTypeDescriptionsCommand(UserVisitPK userVisitPK, GetSearchTypeDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetSearchTypeDescriptionsResult result = SearchResultFactory.getGetSearchTypeDescriptionsResult();
        ...
        if(searchKind != null) {
            ...
            if(searchType != null) {
                ...
                result.setSearchTypeDescriptions(searchControl.getSearchTypeDescriptionTransfersBySearchType(getUserVisit(), searchType));
            } else {
