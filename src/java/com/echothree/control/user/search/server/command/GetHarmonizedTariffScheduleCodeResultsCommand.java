...
public class GetHarmonizedTariffScheduleCodeResultsCommand
        extends BaseSimpleCommand<GetHarmonizedTariffScheduleCodeResultsForm> {
    ...
    public GetHarmonizedTariffScheduleCodeResultsCommand(UserVisitPK userVisitPK, GetHarmonizedTariffScheduleCodeResultsForm form) {
