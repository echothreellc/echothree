...
public class CountForumMessageResultsCommand
    ...
    protected BaseResult execute() {
        return execute(SearchConstants.SearchKind_FORUM_MESSAGE, SearchResultFactory.getCountForumMessageResultsResult());
    }
