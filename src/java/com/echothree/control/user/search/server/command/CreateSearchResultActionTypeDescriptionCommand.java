...
@Dependent
public class CreateSearchResultActionTypeDescriptionCommand
        extends BaseSimpleCommand<CreateSearchResultActionTypeDescriptionForm> {
        ...
        if(searchResultActionType != null) {
            ...
            if(language != null) {
                ...
                if(searchResultActionTypeDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateSearchResultActionTypeDescription.name(), searchResultActionTypeName, languageIsoName);
                }
            } else {
