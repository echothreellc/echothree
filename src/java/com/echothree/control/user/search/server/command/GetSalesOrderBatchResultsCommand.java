...
@Dependent
public class GetSalesOrderBatchResultsCommand
        extends BaseSimpleCommand<GetSalesOrderBatchResultsForm> {
    ...
    /** Creates a new instance of GetSalesOrderBatchResultsCommand */
    public GetSalesOrderBatchResultsCommand() {
        super(null, FORM_FIELD_DEFINITIONS, true);
    }
    
    @Override
    protected BaseResult execute() {
        var result = SearchResultFactory.getGetSalesOrderBatchResultsResult();
        var searchKind = searchControl.getSearchKindByName(SearchKinds.SALES_ORDER_BATCH.name());
            ...
            if(searchType != null) {
                ...
                if(userVisitSearch != null) {
                    if(session.hasLimit(com.echothree.model.data.search.server.factory.SearchResultFactory.class)) {
                        result.setSalesOrderBatchResultCount(searchLogic.countSearchResults(userVisitSearch.getSearch()));
                    }

                    result.setSalesOrderBatchResults(salesOrderBatchControl.getSalesOrderBatchResultTransfers(userVisit, userVisitSearch));
                } else {
