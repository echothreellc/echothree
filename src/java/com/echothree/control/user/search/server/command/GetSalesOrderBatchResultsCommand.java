...
import com.echothree.control.user.search.remote.form.GetSalesOrderBatchResultsForm;
import com.echothree.control.user.search.remote.result.GetSalesOrderBatchResultsResult;
...
public class GetSalesOrderBatchResultsCommand
    ...
    public GetSalesOrderBatchResultsCommand(UserVisitPK userVisitPK, GetSalesOrderBatchResultsForm form) {
        ...
        if(searchKind != null) {
            ...
            if(searchType != null) {
                ...
                if(userVisitSearch != null) {
                    ...
                    result.setSalesOrderBatchResults(searchControl.getSalesOrderBatchResultTransfers(userVisit, userVisitSearch));
                } else {
