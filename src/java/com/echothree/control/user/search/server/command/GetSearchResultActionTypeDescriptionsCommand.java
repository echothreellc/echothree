...
import com.echothree.control.user.search.remote.form.GetSearchResultActionTypeDescriptionsForm;
import com.echothree.control.user.search.remote.result.GetSearchResultActionTypeDescriptionsResult;
...
public class GetSearchResultActionTypeDescriptionsCommand
        extends BaseSimpleCommand<GetSearchResultActionTypeDescriptionsForm> {
    ...
    protected BaseResult execute() {
        ...
        if(searchResultActionType != null) {
            ...
            result.setSearchResultActionTypeDescriptions(searchControl.getSearchResultActionTypeDescriptionTransfersBySearchResultActionType(getUserVisit(), searchResultActionType));
        } else {
