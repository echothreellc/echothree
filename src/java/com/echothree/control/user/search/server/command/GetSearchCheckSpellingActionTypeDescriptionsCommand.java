...
import com.echothree.control.user.search.remote.form.GetSearchCheckSpellingActionTypeDescriptionsForm;
import com.echothree.control.user.search.remote.result.GetSearchCheckSpellingActionTypeDescriptionsResult;
...
public class GetSearchCheckSpellingActionTypeDescriptionsCommand
        extends BaseSimpleCommand<GetSearchCheckSpellingActionTypeDescriptionsForm> {
    ...
    /** Creates a new instance of GetSearchCheckSpellingActionTypeDescriptionsCommand */
    public GetSearchCheckSpellingActionTypeDescriptionsCommand(UserVisitPK userVisitPK, GetSearchCheckSpellingActionTypeDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(searchCheckSpellingActionType != null) {
            ...
            result.setSearchCheckSpellingActionTypeDescriptions(searchControl.getSearchCheckSpellingActionTypeDescriptionTransfersBySearchCheckSpellingActionType(getUserVisit(), searchCheckSpellingActionType));
        } else {
