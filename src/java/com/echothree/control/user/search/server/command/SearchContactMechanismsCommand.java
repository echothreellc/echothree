...
import com.echothree.control.user.search.remote.form.SearchContactMechanismsForm;
import com.echothree.control.user.search.remote.result.SearchContactMechanismsResult;
...
public class SearchContactMechanismsCommand
    ...
    protected BaseResult execute() {
        SearchContactMechanismsResult result = SearchResultFactory.getSearchContactMechanismsResult();
        SearchLogic searchLogic = SearchLogic.getInstance();
        SearchKind searchKind = searchLogic.getSearchKindByName(null, SearchConstants.SearchKind_CONTACT_MECHANISM);
                        ...
                        if(!hasExecutionErrors()) {
                            ...
                            if(!hasExecutionErrors()) {
                                ...
                                if(!hasExecutionErrors()) {
                                    ...
                                    ContactMechanismSearchEvaluator contactMechanismSearchEvaluator = new ContactMechanismSearchEvaluator(userVisit, language,
