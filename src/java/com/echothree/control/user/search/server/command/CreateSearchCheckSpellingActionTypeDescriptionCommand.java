...
public class CreateSearchCheckSpellingActionTypeDescriptionCommand
        extends BaseSimpleCommand<CreateSearchCheckSpellingActionTypeDescriptionForm> {
    ...
    /** Creates a new instance of CreateSearchCheckSpellingActionTypeDescriptionCommand */
    public CreateSearchCheckSpellingActionTypeDescriptionCommand(UserVisitPK userVisitPK, CreateSearchCheckSpellingActionTypeDescriptionForm form) {
        ...
        if(searchCheckSpellingActionType != null) {
            ...
            if(language != null) {
                ...
                if(searchCheckSpellingActionTypeDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateSearchCheckSpellingActionTypeDescription.name(), searchCheckSpellingActionTypeName, languageIsoName);
                }
            } else {
