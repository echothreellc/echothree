...
import com.echothree.control.user.message.remote.form.DeleteEntityMessageForm;
...
public class DeleteEntityMessageCommand
    ...
    public DeleteEntityMessageCommand(UserVisitPK userVisitPK, DeleteEntityMessageForm form) {
            ...
            if(componentVendor != null) {
                ...
                if(entityType != null) {
                    ...
                    if(messageType != null) {
                        ...
                        if(message != null) {
                            EntityMessage entityMessage = messageControl.getEntityMessageForUpdate(entityInstance, message);
