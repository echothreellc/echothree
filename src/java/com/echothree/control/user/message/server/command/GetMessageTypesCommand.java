...
public class GetMessageTypesCommand
        extends BaseSimpleCommand<GetMessageTypesForm> {
    ...
    public GetMessageTypesCommand(UserVisitPK userVisitPK, GetMessageTypesForm form) {
        super(userVisitPK, form, null, FORM_FIELD_DEFINITIONS, true);
    }
    
    @Override
    protected BaseResult execute() {
        GetMessageTypesResult result = MessageResultFactory.getGetMessageTypesResult();
