...
public class DeleteMessageCommand
        extends BaseSimpleCommand<DeleteMessageForm> {
    ...
    public DeleteMessageCommand(UserVisitPK userVisitPK, DeleteMessageForm form) {
        ...
        if(componentVendor != null) {
            ...
            if(entityType != null) {
                ...
                if(messageType != null) {
                    ...
                    Message message = messageControl.getMessageByNameForUpdate(messageType, messageName);
                    
                    if(message != null) {
                        messageControl.deleteMessage(message, getPartyPK());
                    } else {
