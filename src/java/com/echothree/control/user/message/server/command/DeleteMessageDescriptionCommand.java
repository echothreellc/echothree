...
public class DeleteMessageDescriptionCommand
        extends BaseSimpleCommand<DeleteMessageDescriptionForm> {
    ...
    public DeleteMessageDescriptionCommand(UserVisitPK userVisitPK, DeleteMessageDescriptionForm form) {
            ...
            if(entityType != null) {
                ...
                if(messageType != null) {
                    ...
                    if(message != null) {
                        ...
                        if(language != null) {
                            MessageDescription messageDescription = messageControl.getMessageDescriptionForUpdate(message, language);
                            
                            if(messageDescription != null) {
                                messageControl.deleteMessageDescription(messageDescription, getPartyPK());
                            } else {
