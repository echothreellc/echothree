...
import com.echothree.control.user.forum.common.form.DeleteForumPartyRoleForm;
...
public class DeleteForumPartyRoleCommand
        extends BaseSimpleCommand<DeleteForumPartyRoleForm> {
    ...
    /** Creates a new instance of DeleteForumPartyRoleCommand */
    public DeleteForumPartyRoleCommand(UserVisitPK userVisitPK, DeleteForumPartyRoleForm form) {
        ...
        if(forum != null) {
            ...
            if(party != null) {
                ...
                if(forumRoleType != null) {
                    ForumPartyRole forumPartyRole = forumControl.getForumPartyRoleForUpdate(forum, party, forumRoleType);
                    
                    if(forumPartyRole != null) {
                        forumControl.deleteForumPartyRole(forumPartyRole, getPartyPK());
                    } else {
                        addExecutionError(ExecutionErrors.UnknownForumPartyRole.name());
                    }
                } else {
