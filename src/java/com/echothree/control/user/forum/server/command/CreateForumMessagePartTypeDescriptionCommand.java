...
import com.echothree.control.user.forum.remote.form.CreateForumMessagePartTypeDescriptionForm;
...
public class CreateForumMessagePartTypeDescriptionCommand
        extends BaseSimpleCommand<CreateForumMessagePartTypeDescriptionForm> {
    ...
    /** Creates a new instance of CreateForumMessagePartTypeDescriptionCommand */
    public CreateForumMessagePartTypeDescriptionCommand(UserVisitPK userVisitPK, CreateForumMessagePartTypeDescriptionForm form) {
        ...
        if(forumMessagePartType != null) {
            ...
            if(language != null) {
                ...
                if(forumMessagePartTypeDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateForumMessagePartTypeDescription.name());
                }
            } else {
