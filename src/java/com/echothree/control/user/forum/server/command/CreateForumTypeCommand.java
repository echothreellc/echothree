...
public class CreateForumTypeCommand
        extends BaseSimpleCommand<CreateForumTypeForm> {
    ...
    /** Creates a new instance of CreateForumTypeCommand */
    public CreateForumTypeCommand(UserVisitPK userVisitPK, CreateForumTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(forumType == null) {
            ...
            addExecutionError(ExecutionErrors.DuplicateForumTypeName.name(), forumTypeName);
        }
