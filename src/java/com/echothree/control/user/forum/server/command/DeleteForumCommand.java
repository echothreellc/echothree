...
import com.echothree.control.user.forum.remote.form.DeleteForumForm;
...
public class DeleteForumCommand
        extends BaseSimpleCommand<DeleteForumForm> {
    ...
    public DeleteForumCommand(UserVisitPK userVisitPK, DeleteForumForm form) {
