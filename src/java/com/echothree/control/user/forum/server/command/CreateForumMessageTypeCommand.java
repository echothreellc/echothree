...
import com.echothree.control.user.forum.remote.form.CreateForumMessageTypeForm;
...
public class CreateForumMessageTypeCommand
    ...
    public CreateForumMessageTypeCommand(UserVisitPK userVisitPK, CreateForumMessageTypeForm form) {
