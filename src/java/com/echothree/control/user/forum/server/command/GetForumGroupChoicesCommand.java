...
public class GetForumGroupChoicesCommand
        extends BaseSimpleCommand<GetForumGroupChoicesForm> {
    
    private final static List<FieldDefinition> FORM_FIELD_DEFINITIONS;
    
    static {
        FORM_FIELD_DEFINITIONS = Collections.unmodifiableList(Arrays.asList(
            new FieldDefinition("DefaultForumGroupChoice", FieldType.ENTITY_NAME, false, null, null),
            new FieldDefinition("AllowNullChoice", FieldType.BOOLEAN, true, null, null)
        ));
    }
    
    /** Creates a new instance of GetForumGroupChoicesCommand */
    public GetForumGroupChoicesCommand(UserVisitPK userVisitPK, GetForumGroupChoicesForm form) {
