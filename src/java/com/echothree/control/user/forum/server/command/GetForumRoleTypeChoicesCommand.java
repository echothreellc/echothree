...
public class GetForumRoleTypeChoicesCommand
        extends BaseSimpleCommand<GetForumRoleTypeChoicesForm> {
    ...
    public GetForumRoleTypeChoicesCommand(UserVisitPK userVisitPK, GetForumRoleTypeChoicesForm form) {
    ...
    protected BaseResult execute() {
        ...
        result.setForumRoleTypeChoices(forumControl.getForumRoleTypeChoices(defaultForumRoleTypeChoice, getPreferredLanguage(),
                allowNullChoice));
