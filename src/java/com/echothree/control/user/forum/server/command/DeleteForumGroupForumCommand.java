...
import com.echothree.control.user.forum.common.form.DeleteForumGroupForumForm;
...
public class DeleteForumGroupForumCommand
        extends BaseSimpleCommand<DeleteForumGroupForumForm> {
    ...
    protected BaseResult execute() {
        ...
        if(forumGroup != null) {
            ...
            if(forum != null) {
                ForumGroupForum forumGroupForum = forumControl.getForumGroupForumForUpdate(forumGroup,
                        forum);
                
                if(forumGroupForum != null) {
                    forumControl.deleteForumGroupForum(forumGroupForum, getPartyPK());
                } else {
