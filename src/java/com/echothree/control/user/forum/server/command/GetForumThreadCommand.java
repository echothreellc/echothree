...
import com.echothree.control.user.forum.remote.form.GetForumThreadForm;
import com.echothree.control.user.forum.remote.result.ForumResultFactory;
import com.echothree.control.user.forum.remote.result.GetForumThreadResult;
...
public class GetForumThreadCommand
    ...
    public GetForumThreadCommand(UserVisitPK userVisitPK, GetForumThreadForm form) {
            ...
            if(!hasExecutionErrors()) {
                if(forumThread.getLastDetail().getPostedTime() <= session.START_TIME
                    ...
                    if(form.getKey() != null || ForumLogic.getInstance().isForumRoleTypePermitted(this, forumThread, getParty(), ForumConstants.ForumRoleType_READER)) {
                        ...
                        sendEventUsingNames(forumThread.getPrimaryKey(), EventTypes.READ.name(), null, null, getPartyPK());
                    } else {
