...
public class CreateForumGroupForumCommand
        extends BaseSimpleCommand<CreateForumGroupForumForm> {
    ...
    /** Creates a new instance of CreateForumGroupForumCommand */
    public CreateForumGroupForumCommand(UserVisitPK userVisitPK, CreateForumGroupForumForm form) {
        ...
        if(forumGroup != null) {
            ...
            if(forum != null) {
                ...
                if(forumGroupForum == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateForumGroupForum.name());
                }
            } else {
