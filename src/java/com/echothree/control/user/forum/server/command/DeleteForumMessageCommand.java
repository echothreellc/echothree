...
import com.echothree.control.user.forum.remote.form.DeleteForumMessageForm;
...
public class DeleteForumMessageCommand
    ...
    public DeleteForumMessageCommand(UserVisitPK userVisitPK, DeleteForumMessageForm form) {
