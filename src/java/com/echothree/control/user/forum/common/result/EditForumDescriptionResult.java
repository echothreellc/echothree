...
public interface EditForumDescriptionResult
        extends BaseEditResult<ForumDescriptionEdit> {
    
    ForumDescriptionTransfer getForumDescription();
    void setForumDescription(ForumDescriptionTransfer forumDescription);
