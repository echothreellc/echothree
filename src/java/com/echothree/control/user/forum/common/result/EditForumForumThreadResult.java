...
public interface EditForumForumThreadResult
        extends BaseEditResult<ForumForumThreadEdit> {
    
    ForumForumThreadTransfer getForumForumThread();
    void setForumForumThread(ForumForumThreadTransfer forumForumThread);
