...
public interface CreateBlogEntryForm
        extends UserLoginSpec, ForumSpec, BlogEntryEdit, LanguageSpec {
    
    // Nothing additional beyond ForumSpec, BlogEntryEdit, LanguageSpec
