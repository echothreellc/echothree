...
public interface CreateBlogCommentForm
        extends UserLoginSpec, BlogCommentEdit, LanguageSpec {
    
    String getParentForumMessageName();
    void setParentForumMessageName(String parentForumMessageName);
