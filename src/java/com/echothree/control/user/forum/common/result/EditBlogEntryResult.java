...
public interface EditBlogEntryResult
        extends GetForumMessageResult, BaseEditResult<BlogEntryEdit> {
    
    // Nothing additional beyond GetForumMessageResult, BaseEditResult<BlogEntryEdit>
