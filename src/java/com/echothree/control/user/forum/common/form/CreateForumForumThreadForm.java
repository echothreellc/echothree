...
public interface CreateForumForumThreadForm
        extends ForumForumThreadSpec, ForumForumThreadEdit {
    
    // Nothing additional beyond ForumForumThreadSpec, ForumForumThreadEdit
