...
public interface CreateTagScopeDescriptionForm
        extends TagScopeDescriptionSpec, TagScopeDescriptionEdit {
    
    // Nothing additional beyond TagScopeDescriptionSpec, TagScopeDescriptionEdit
