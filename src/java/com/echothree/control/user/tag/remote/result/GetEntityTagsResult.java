...
public interface GetEntityTagsResult
        extends BaseResult {
    
    EntityInstanceTransfer getTaggedEntityInstance();
    void setTaggedEntityInstance(EntityInstanceTransfer taggedEntityInstance);
