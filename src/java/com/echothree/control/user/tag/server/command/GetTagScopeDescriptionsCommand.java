...
import com.echothree.control.user.tag.remote.form.GetTagScopeDescriptionsForm;
import com.echothree.control.user.tag.remote.result.GetTagScopeDescriptionsResult;
...
public class GetTagScopeDescriptionsCommand
        extends BaseSimpleCommand<GetTagScopeDescriptionsForm> {
    ...
    /** Creates a new instance of GetTagScopeDescriptionsCommand */
    public GetTagScopeDescriptionsCommand(UserVisitPK userVisitPK, GetTagScopeDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(tagScope != null) {
            ...
            result.setTagScopeDescriptions(tagControl.getTagScopeDescriptionTransfers(getUserVisit(), tagScope));
        } else {
