...
public class DeleteTagScopeDescriptionCommand
        extends BaseSimpleCommand<DeleteTagScopeDescriptionForm> {
    ...
    /** Creates a new instance of DeleteTagScopeDescriptionCommand */
    public DeleteTagScopeDescriptionCommand(UserVisitPK userVisitPK, DeleteTagScopeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(tagScope != null) {
            ...
            if(language != null) {
                TagScopeDescription tagScopeDescription = tagControl.getTagScopeDescriptionForUpdate(tagScope, language);
                
                if(tagScopeDescription != null) {
                    tagControl.deleteTagScopeDescription(tagScopeDescription, getPartyPK());
                } else {
