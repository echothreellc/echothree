...
public class CreateTagScopeDescriptionCommand
        extends BaseSimpleCommand<CreateTagScopeDescriptionForm> {
    ...
    public CreateTagScopeDescriptionCommand(UserVisitPK userVisitPK, CreateTagScopeDescriptionForm form) {
        ...
        if(tagScope != null) {
            ...
            if(language != null) {
                ...
                if(tagScopeDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateTagScopeDescription.name(), tagScopeName, languageIsoName);
                }
            } else {
