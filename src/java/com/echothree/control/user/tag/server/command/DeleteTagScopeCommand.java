...
public class DeleteTagScopeCommand
        extends BaseSimpleCommand<DeleteTagScopeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.TagScope.name(), SecurityRoles.Delete.name())
                        )))
                )));
    ...
    protected BaseResult execute() {
        ...
        TagScope tagScope = tagControl.getTagScopeByNameForUpdate(tagScopeName);
        
        if(tagScope != null) {
            tagControl.deleteTagScope(tagScope, getPartyPK());
        } else {
