...
import com.echothree.control.user.associate.remote.form.GetAssociatePartyContactMechanismsForm;
import com.echothree.control.user.associate.remote.result.AssociateResultFactory;
import com.echothree.control.user.associate.remote.result.GetAssociatePartyContactMechanismsResult;
...
public class GetAssociatePartyContactMechanismsCommand
        extends BaseSimpleCommand<GetAssociatePartyContactMechanismsForm> {
    ...
    public GetAssociatePartyContactMechanismsCommand(UserVisitPK userVisitPK, GetAssociatePartyContactMechanismsForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(associateProgram != null) {
            ...
            if(associate != null) {
                ...
                result.setAssociatePartyContactMechanisms(associateControl.getAssociatePartyContactMechanismTransfersByAssociate(associate, getUserVisit()));
            } else {
