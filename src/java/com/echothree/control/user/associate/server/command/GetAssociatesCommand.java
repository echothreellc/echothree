...
import com.echothree.control.user.associate.remote.form.GetAssociatesForm;
import com.echothree.control.user.associate.remote.result.AssociateResultFactory;
import com.echothree.control.user.associate.remote.result.GetAssociatesResult;
...
public class GetAssociatesCommand
        extends BaseSimpleCommand<GetAssociatesForm> {
    ...
    public GetAssociatesCommand(UserVisitPK userVisitPK, GetAssociatesForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetAssociatesResult result = AssociateResultFactory.getGetAssociatesResult();
        ...
        if(associateProgram != null) {
            ...
            result.setAssociates(associateControl.getAssociateTransfersByAssociateProgram(associateProgram, getUserVisit()));
        } else {
