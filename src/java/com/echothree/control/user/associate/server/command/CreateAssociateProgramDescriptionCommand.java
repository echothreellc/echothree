...
public class CreateAssociateProgramDescriptionCommand
        extends BaseSimpleCommand<CreateAssociateProgramDescriptionForm> {
    ...
    /** Creates a new instance of CreateAssociateProgramDescriptionCommand */
    public CreateAssociateProgramDescriptionCommand(UserVisitPK userVisitPK, CreateAssociateProgramDescriptionForm form) {
            ...
            if(associateProgram != null) {
                ...
                if(language != null) {
                    ...
                    if(associateProgramDescription == null) {
                        ...
                        addExecutionError(ExecutionErrors.DuplicateAssociateProgramDescription.name());
                    }
                } else {
