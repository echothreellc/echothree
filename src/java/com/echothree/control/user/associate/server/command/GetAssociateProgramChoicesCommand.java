...
import com.echothree.control.user.associate.remote.form.GetAssociateProgramChoicesForm;
import com.echothree.control.user.associate.remote.result.AssociateResultFactory;
import com.echothree.control.user.associate.remote.result.GetAssociateProgramChoicesResult;
...
public class GetAssociateProgramChoicesCommand
        extends BaseSimpleCommand<GetAssociateProgramChoicesForm> {
    
    private final static List<FieldDefinition> FORM_FIELD_DEFINITIONS;
    
    static {
        FORM_FIELD_DEFINITIONS = Collections.unmodifiableList(Arrays.asList(
            new FieldDefinition("DefaultAssociateProgramChoice", FieldType.ENTITY_NAME, false, null, null),
            new FieldDefinition("AllowNullChoice", FieldType.BOOLEAN, true, null, null)
        ));
    }
    
    /** Creates a new instance of GetAssociateProgramChoicesCommand */
    public GetAssociateProgramChoicesCommand(UserVisitPK userVisitPK, GetAssociateProgramChoicesForm form) {
