...
import com.echothree.control.user.associate.remote.form.GetAssociatePartyContactMechanismChoicesForm;
import com.echothree.control.user.associate.remote.result.AssociateResultFactory;
import com.echothree.control.user.associate.remote.result.GetAssociatePartyContactMechanismChoicesResult;
...
public class GetAssociatePartyContactMechanismChoicesCommand
        extends BaseSimpleCommand<GetAssociatePartyContactMechanismChoicesForm> {
    ...
    /** Creates a new instance of GetAssociatePartyContactMechanismChoicesCommand */
    public GetAssociatePartyContactMechanismChoicesCommand(UserVisitPK userVisitPK, GetAssociatePartyContactMechanismChoicesForm form) {
