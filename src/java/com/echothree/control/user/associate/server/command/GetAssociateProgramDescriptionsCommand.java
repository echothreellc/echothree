...
import com.echothree.control.user.associate.remote.form.GetAssociateProgramDescriptionsForm;
import com.echothree.control.user.associate.remote.result.AssociateResultFactory;
import com.echothree.control.user.associate.remote.result.GetAssociateProgramDescriptionsResult;
...
public class GetAssociateProgramDescriptionsCommand
        extends BaseSimpleCommand<GetAssociateProgramDescriptionsForm> {
    ...
    protected BaseResult execute() {
        ...
        if(associateProgram != null) {
            ...
            result.setAssociateProgramDescriptions(associateControl.getAssociateProgramDescriptionTransfersByAssociateProgram(getUserVisit(), associateProgram));
        } else {
