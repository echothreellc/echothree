...
public interface GetAssociateProgramDescriptionsResult
        extends BaseResult {
    
    AssociateProgramTransfer getAssociateProgram();
    void setAssociateProgram(AssociateProgramTransfer associateProgram);
    
    List<AssociateProgramDescriptionTransfer> getAssociateProgramDescriptions();
    void setAssociateProgramDescriptions(List<AssociateProgramDescriptionTransfer> associateProgramDescriptions);
