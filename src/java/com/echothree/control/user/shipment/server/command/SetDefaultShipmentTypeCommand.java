...
import com.echothree.control.user.shipment.common.form.SetDefaultShipmentTypeForm;
...
public class SetDefaultShipmentTypeCommand
        extends BaseSimpleCommand<SetDefaultShipmentTypeForm> {
    ...
    /** Creates a new instance of SetDefaultShipmentTypeCommand */
    public SetDefaultShipmentTypeCommand(UserVisitPK userVisitPK, SetDefaultShipmentTypeForm form) {
