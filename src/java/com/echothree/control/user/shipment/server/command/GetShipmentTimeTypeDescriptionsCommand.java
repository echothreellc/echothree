...
import com.echothree.control.user.shipment.common.form.GetShipmentTimeTypeDescriptionsForm;
import com.echothree.control.user.shipment.common.result.GetShipmentTimeTypeDescriptionsResult;
...
public class GetShipmentTimeTypeDescriptionsCommand
        extends BaseSimpleCommand<GetShipmentTimeTypeDescriptionsForm> {
    ...
    /** Creates a new instance of GetShipmentTimeTypeDescriptionsCommand */
    public GetShipmentTimeTypeDescriptionsCommand(UserVisitPK userVisitPK, GetShipmentTimeTypeDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(shipmentType != null) {
            ...
            if(shipmentTimeType != null) {
                ...
                result.setShipmentTimeTypeDescriptions(shipmentControl.getShipmentTimeTypeDescriptionTransfersByShipmentTimeType(getUserVisit(), shipmentTimeType));
            } else {
