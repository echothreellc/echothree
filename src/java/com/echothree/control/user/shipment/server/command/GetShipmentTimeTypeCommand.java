...
import com.echothree.control.user.shipment.common.result.GetShipmentTimeTypeResult;
...
public class GetShipmentTimeTypeCommand
    ...
    public GetShipmentTimeTypeCommand(UserVisitPK userVisitPK, GetShipmentTimeTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetShipmentTimeTypeResult result = ShipmentResultFactory.getGetShipmentTimeTypeResult();
        ...
        if(shipmentType != null) {
            ...
            if(shipmentTimeType != null) {
                ...
                sendEventUsingNames(shipmentTimeType.getPrimaryKey(), EventTypes.READ, null, null, getPartyPK());
            } else {
