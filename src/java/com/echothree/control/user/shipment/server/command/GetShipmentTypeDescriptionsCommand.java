...
import com.echothree.control.user.shipment.common.form.GetShipmentTypeDescriptionsForm;
import com.echothree.control.user.shipment.common.result.GetShipmentTypeDescriptionsResult;
...
public class GetShipmentTypeDescriptionsCommand
        extends BaseSimpleCommand<GetShipmentTypeDescriptionsForm> {
    ...
    /** Creates a new instance of GetShipmentTypeDescriptionsCommand */
    public GetShipmentTypeDescriptionsCommand(UserVisitPK userVisitPK, GetShipmentTypeDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(shipmentType != null) {
            ...
            result.setShipmentTypeDescriptions(shipmentControl.getShipmentTypeDescriptionTransfersByShipmentType(getUserVisit(), shipmentType));
        } else {
