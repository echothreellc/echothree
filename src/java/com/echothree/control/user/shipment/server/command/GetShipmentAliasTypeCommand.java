...
import com.echothree.control.user.shipment.remote.form.GetShipmentAliasTypeForm;
import com.echothree.control.user.shipment.remote.result.GetShipmentAliasTypeResult;
...
public class GetShipmentAliasTypeCommand
        extends BaseSimpleCommand<GetShipmentAliasTypeForm> {
    ...
    public GetShipmentAliasTypeCommand(UserVisitPK userVisitPK, GetShipmentAliasTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetShipmentAliasTypeResult result = ShipmentResultFactory.getGetShipmentAliasTypeResult();
        ...
        if(shipmentType != null) {
            ...
            if(shipmentAliasType != null) {
                ...
                sendEventUsingNames(shipmentAliasType.getPrimaryKey(), EventTypes.READ.name(), null, null, getPartyPK());
            } else {
