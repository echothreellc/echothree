...
import com.echothree.control.user.shipment.remote.form.GetShipmentTypesForm;
import com.echothree.control.user.shipment.remote.result.GetShipmentTypesResult;
...
public class GetShipmentTypesCommand
        extends BaseSimpleCommand<GetShipmentTypesForm> {
    ...
    public GetShipmentTypesCommand(UserVisitPK userVisitPK, GetShipmentTypesForm form) {
