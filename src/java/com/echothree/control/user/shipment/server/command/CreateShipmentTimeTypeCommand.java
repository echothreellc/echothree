...
@Dependent
public class CreateShipmentTimeTypeCommand
        extends BaseSimpleCommand<CreateShipmentTimeTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                    new SecurityRoleDefinition(SecurityRoleGroups.ShipmentTimeType.name(), SecurityRoles.Create.name())
                    )))
                )));
    ...
    protected BaseResult execute() {
        ...
        if(shipmentType != null) {
            ...
            if(shipmentTimeType == null) {
                ...
                shipmentTimeType = shipmentControl.createShipmentTimeType(shipmentType, shipmentTimeTypeName, isDefault, sortOrder, partyPK);
