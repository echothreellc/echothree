...
import com.echothree.control.user.shipment.remote.form.DeleteShipmentAliasForm;
...
public class DeleteShipmentAliasCommand
    ...
    public DeleteShipmentAliasCommand(UserVisitPK userVisitPK, DeleteShipmentAliasForm form) {
