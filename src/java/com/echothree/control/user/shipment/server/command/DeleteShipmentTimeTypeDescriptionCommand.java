...
import com.echothree.control.user.shipment.remote.form.DeleteShipmentTimeTypeDescriptionForm;
...
public class DeleteShipmentTimeTypeDescriptionCommand
        extends BaseSimpleCommand<DeleteShipmentTimeTypeDescriptionForm> {
    ...
    /** Creates a new instance of DeleteShipmentTimeTypeDescriptionCommand */
    public DeleteShipmentTimeTypeDescriptionCommand(UserVisitPK userVisitPK, DeleteShipmentTimeTypeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(shipmentType != null) {
            ...
            if(shipmentTimeType != null) {
                ...
                if(language != null) {
                    ShipmentTimeTypeDescription shipmentTimeTypeDescription = shipmentControl.getShipmentTimeTypeDescriptionForUpdate(shipmentTimeType, language);

                    if(shipmentTimeTypeDescription != null) {
                        shipmentControl.deleteShipmentTimeTypeDescription(shipmentTimeTypeDescription, getPartyPK());
                    } else {
