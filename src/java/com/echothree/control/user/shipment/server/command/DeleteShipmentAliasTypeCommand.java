...
import com.echothree.control.user.shipment.common.form.DeleteShipmentAliasTypeForm;
...
public class DeleteShipmentAliasTypeCommand
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.ShipmentAliasType.name(), SecurityRoles.Delete.name())
                        )))
                )));
    ...
    public DeleteShipmentAliasTypeCommand(UserVisitPK userVisitPK, DeleteShipmentAliasTypeForm form) {
