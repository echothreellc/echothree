...
import com.echothree.control.user.shipment.common.form.GetShipmentTimeTypeChoicesForm;
import com.echothree.control.user.shipment.common.result.GetShipmentTimeTypeChoicesResult;
...
public class GetShipmentTimeTypeChoicesCommand
        extends BaseSimpleCommand<GetShipmentTimeTypeChoicesForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.ShipmentTimeType.name(), SecurityRoles.Choices.name())
                        )))
                )));
        
        FORM_FIELD_DEFINITIONS = Collections.unmodifiableList(Arrays.asList(
                new FieldDefinition("ShipmentTypeName", FieldType.ENTITY_NAME, true, null, null),
                new FieldDefinition("DefaultShipmentTimeTypeChoice", FieldType.ENTITY_NAME, false, null, null),
