...
public class GetShipmentTypeCommand
    ...
    protected BaseResult execute() {
        ...
        GetShipmentTypeResult result = ShipmentResultFactory.getGetShipmentTypeResult();
        ...
        if(shipmentType != null) {
            ...
            sendEventUsingNames(shipmentType.getPrimaryKey(), EventTypes.READ.name(), null, null, getPartyPK());
        } else {
