...
import com.echothree.control.user.shipment.remote.form.CreateShipmentTypeForm;
...
public class CreateShipmentTypeCommand
    ...
    public CreateShipmentTypeCommand(UserVisitPK userVisitPK, CreateShipmentTypeForm form) {
