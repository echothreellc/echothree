...
public class CreateShipmentTimeTypeDescriptionCommand
        extends BaseSimpleCommand<CreateShipmentTimeTypeDescriptionForm> {
    ...
    /** Creates a new instance of CreateShipmentTimeTypeDescriptionCommand */
    public CreateShipmentTimeTypeDescriptionCommand(UserVisitPK userVisitPK, CreateShipmentTimeTypeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(shipmentType != null) {
            ...
            if(shipmentTimeType != null) {
                ...
                if(language != null) {
                    var shipmentTimeTypeDescription = shipmentControl.getShipmentTimeTypeDescription(shipmentTimeType, language);
                    ...
                    if(shipmentTimeTypeDescription == null) {
                        ...
                        addExecutionError(ExecutionErrors.DuplicateShipmentTimeTypeDescription.name(), shipmentTypeName, shipmentTimeTypeName, languageIsoName);
                    }
                } else {
