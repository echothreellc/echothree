...
import com.echothree.control.user.shipment.remote.form.GetShipmentAliasForm;
import com.echothree.control.user.shipment.remote.result.GetShipmentAliasResult;
...
public class GetShipmentAliasCommand
    ...
    protected BaseResult execute() {
        ...
        GetShipmentAliasResult result = ShipmentResultFactory.getGetShipmentAliasResult();
        ...
        if(shipmentType != null) {
            ...
            if(shipment != null) {
                ...
                if(shipmentAliasType != null) {
                    ShipmentAlias shipmentAlias = shipmentControl.getShipmentAlias(shipment, shipmentAliasType);
