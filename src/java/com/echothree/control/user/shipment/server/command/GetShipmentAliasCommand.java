...
public class GetShipmentAliasCommand
        extends BaseSingleEntityCommand<ShipmentAlias, GetShipmentAliasForm> {
    ...
    @Override
    protected ShipmentAlias getEntity() {
    ...
    @Override
    protected BaseResult getResult(ShipmentAlias shipmentAlias) {
