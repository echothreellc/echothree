...
import com.echothree.control.user.shipment.common.form.DeleteFreeOnBoardForm;
...
public class DeleteFreeOnBoardCommand
        extends BaseSimpleCommand<DeleteFreeOnBoardForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.FreeOnBoard.name(), SecurityRoles.Delete.name())
                        )))
                )));
    ...
    public DeleteFreeOnBoardCommand(UserVisitPK userVisitPK, DeleteFreeOnBoardForm form) {
