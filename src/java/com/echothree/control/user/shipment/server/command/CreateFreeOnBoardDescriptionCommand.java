...
import com.echothree.control.user.shipment.common.form.CreateFreeOnBoardDescriptionForm;
...
public class CreateFreeOnBoardDescriptionCommand
        extends BaseSimpleCommand<CreateFreeOnBoardDescriptionForm> {
    ...
    public CreateFreeOnBoardDescriptionCommand(UserVisitPK userVisitPK, CreateFreeOnBoardDescriptionForm form) {
        ...
        if(freeOnBoard != null) {
            ...
            if(language != null) {
                ...
                if(freeOnBoardDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateFreeOnBoardDescription.name());
                }
            } else {
