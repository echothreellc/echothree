...
import com.echothree.control.user.shipment.common.form.DeleteShipmentTypeDescriptionForm;
...
public class DeleteShipmentTypeDescriptionCommand
        extends BaseSimpleCommand<DeleteShipmentTypeDescriptionForm> {
    ...
    /** Creates a new instance of DeleteShipmentTypeDescriptionCommand */
    public DeleteShipmentTypeDescriptionCommand(UserVisitPK userVisitPK, DeleteShipmentTypeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(shipmentType != null) {
            ...
            if(language != null) {
                ShipmentTypeDescription shipmentTypeDescription = shipmentControl.getShipmentTypeDescriptionForUpdate(shipmentType, language);
                
                if(shipmentTypeDescription != null) {
                    shipmentControl.deleteShipmentTypeDescription(shipmentTypeDescription, getPartyPK());
                } else {
