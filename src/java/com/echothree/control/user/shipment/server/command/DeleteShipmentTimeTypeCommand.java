...
import com.echothree.control.user.shipment.common.form.DeleteShipmentTimeTypeForm;
...
public class DeleteShipmentTimeTypeCommand
        extends BaseSimpleCommand<DeleteShipmentTimeTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.ShipmentTimeType.name(), SecurityRoles.Delete.name())
                        )))
                )));
    ...
    /** Creates a new instance of DeleteShipmentTimeTypeCommand */
    public DeleteShipmentTimeTypeCommand(UserVisitPK userVisitPK, DeleteShipmentTimeTypeForm form) {
