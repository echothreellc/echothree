...
@RequestScoped
public class GetFreeOnBoardDescriptionsCommand
        extends BaseSimpleCommand<GetFreeOnBoardDescriptionsForm> {
    ...
    protected BaseResult execute() {
        ...
        if(freeOnBoard != null) {
            ...
            result.setFreeOnBoardDescriptions(freeOnBoardControl.getFreeOnBoardDescriptionTransfersByFreeOnBoard(getUserVisit(), freeOnBoard));
        } else {
