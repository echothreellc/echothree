...
import com.echothree.control.user.shipment.remote.form.GetShipmentAliasTypeDescriptionForm;
import com.echothree.control.user.shipment.remote.result.GetShipmentAliasTypeDescriptionResult;
...
public class GetShipmentAliasTypeDescriptionCommand
        extends BaseSimpleCommand<GetShipmentAliasTypeDescriptionForm> {
    ...
    /** Creates a new instance of GetShipmentAliasTypeDescriptionCommand */
    public GetShipmentAliasTypeDescriptionCommand(UserVisitPK userVisitPK, GetShipmentAliasTypeDescriptionForm form) {
