...
import com.echothree.control.user.shipment.common.form.DeleteFreeOnBoardDescriptionForm;
...
public class DeleteFreeOnBoardDescriptionCommand
        extends BaseSimpleCommand<DeleteFreeOnBoardDescriptionForm> {
    ...
    protected BaseResult execute() {
        ...
        if(freeOnBoard != null) {
            ...
            if(language != null) {
                FreeOnBoardDescription freeOnBoardDescription = freeOnBoardControl.getFreeOnBoardDescriptionForUpdate(freeOnBoard, language);
                
                if(freeOnBoardDescription != null) {
                    freeOnBoardControl.deleteFreeOnBoardDescription(freeOnBoardDescription, getPartyPK());
                } else {
