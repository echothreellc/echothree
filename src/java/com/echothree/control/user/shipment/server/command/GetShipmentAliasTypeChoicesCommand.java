...
import com.echothree.control.user.shipment.common.form.GetShipmentAliasTypeChoicesForm;
import com.echothree.control.user.shipment.common.result.GetShipmentAliasTypeChoicesResult;
...
public class GetShipmentAliasTypeChoicesCommand
        extends BaseSimpleCommand<GetShipmentAliasTypeChoicesForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.ShipmentAliasType.name(), SecurityRoles.Choices.name())
                        )))
                )));
        
        FORM_FIELD_DEFINITIONS = Collections.unmodifiableList(Arrays.asList(
                new FieldDefinition("ShipmentTypeName", FieldType.ENTITY_NAME, true, null, null),
                new FieldDefinition("DefaultShipmentAliasTypeChoice", FieldType.ENTITY_NAME, false, null, null),
