...
public class GetFreeOnBoardDescriptionCommand
        extends BaseSimpleCommand<GetFreeOnBoardDescriptionForm> {
    ...
    /** Creates a new instance of GetFreeOnBoardDescriptionCommand */
    public GetFreeOnBoardDescriptionCommand(UserVisitPK userVisitPK, GetFreeOnBoardDescriptionForm form) {
        ...
        if(freeOnBoard != null) {
            ...
            if(language != null) {
                ...
                if(freeOnBoardDescription != null) {
                    ...
                    addExecutionError(ExecutionErrors.UnknownFreeOnBoardDescription.name(), freeOnBoardName, languageIsoName);
                }
            } else {
