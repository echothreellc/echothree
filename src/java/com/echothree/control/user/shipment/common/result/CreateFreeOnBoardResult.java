...
public interface CreateFreeOnBoardResult
        extends FreeOnBoardSpec, EntityRefSpec, BaseResult {
    
    // Nothing additional beyond FreeOnBoardSpec, EntityRefSpec, BaseResult
