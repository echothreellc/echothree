...
public interface EditFreeOnBoardResult
        extends GetFreeOnBoardResult, BaseEditResult<FreeOnBoardEdit> {
    
    // Nothing additional beyond GetFreeOnBoardResult, BaseEditResult<FreeOnBoardEdit>
