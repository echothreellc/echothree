...
public interface EditFreeOnBoardDescriptionResult 
        extends BaseEditResult<FreeOnBoardDescriptionEdit> {
    
    FreeOnBoardDescriptionTransfer getFreeOnBoardDescription();
    void setFreeOnBoardDescription(FreeOnBoardDescriptionTransfer freeOnBoardDescription);
