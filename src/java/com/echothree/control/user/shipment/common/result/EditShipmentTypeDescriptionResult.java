...
public interface EditShipmentTypeDescriptionResult
        extends BaseEditResult<ShipmentTypeDescriptionEdit> {

    ShipmentTypeDescriptionTransfer getShipmentTypeDescription();
    void setShipmentTypeDescription(ShipmentTypeDescriptionTransfer shipmentType);
