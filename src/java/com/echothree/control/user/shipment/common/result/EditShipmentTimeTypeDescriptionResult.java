...
public interface EditShipmentTimeTypeDescriptionResult
        extends BaseEditResult<ShipmentTimeTypeDescriptionEdit> {

    ShipmentTimeTypeDescriptionTransfer getShipmentTimeTypeDescription();
    void setShipmentTimeTypeDescription(ShipmentTimeTypeDescriptionTransfer shipmentTimeType);
