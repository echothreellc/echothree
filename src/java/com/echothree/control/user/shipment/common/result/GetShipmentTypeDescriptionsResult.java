...
public interface GetShipmentTypeDescriptionsResult
        extends BaseResult {
    
    ShipmentTypeTransfer getShipmentType();
    void setShipmentType(ShipmentTypeTransfer shipmentType);
    
    List<ShipmentTypeDescriptionTransfer> getShipmentTypeDescriptions();
    void setShipmentTypeDescriptions(List<ShipmentTypeDescriptionTransfer> shipmentTypeDescriptions);
