...
public interface CreateCampaignMediumDescriptionForm
        extends CampaignMediumDescriptionSpec, CampaignMediumDescriptionEdit {
    
    // Nothing additional beyond CampaignMediumDescriptionSpec, CampaignMediumDescriptionEdit
