...
public interface EditCampaignSourceResult
        extends BaseEditResult<CampaignSourceEdit> {
    
    CampaignSourceTransfer getCampaignSource();
    void setCampaignSource(CampaignSourceTransfer campaignSource);
