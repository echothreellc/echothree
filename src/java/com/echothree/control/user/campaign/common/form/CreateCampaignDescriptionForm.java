...
public interface CreateCampaignDescriptionForm
        extends CampaignDescriptionSpec, CampaignDescriptionEdit {
    
    // Nothing additional beyond CampaignDescriptionSpec, CampaignDescriptionEdit
