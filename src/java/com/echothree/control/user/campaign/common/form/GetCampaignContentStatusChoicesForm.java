...
public interface GetCampaignContentStatusChoicesForm
        extends CampaignContentSpec {
    
    String getDefaultCampaignContentStatusChoice();
    void setDefaultCampaignContentStatusChoice(String defaultCampaignContentStatusChoice);
