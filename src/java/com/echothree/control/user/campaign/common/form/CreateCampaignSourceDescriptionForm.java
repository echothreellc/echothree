...
public interface CreateCampaignSourceDescriptionForm
        extends CampaignSourceDescriptionSpec, CampaignSourceDescriptionEdit {
    
    // Nothing additional beyond CampaignSourceDescriptionSpec, CampaignSourceDescriptionEdit
