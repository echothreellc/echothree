...
public interface CreateCampaignContentDescriptionForm
        extends CampaignContentDescriptionSpec, CampaignContentDescriptionEdit {
    
    // Nothing additional beyond CampaignContentDescriptionSpec, CampaignContentDescriptionEdit
