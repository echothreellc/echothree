...
public interface GetCampaignMediumStatusChoicesForm
        extends CampaignMediumSpec {
    
    String getDefaultCampaignMediumStatusChoice();
    void setDefaultCampaignMediumStatusChoice(String defaultCampaignMediumStatusChoice);
