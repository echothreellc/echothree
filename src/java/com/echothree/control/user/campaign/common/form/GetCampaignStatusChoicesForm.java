...
public interface GetCampaignStatusChoicesForm
        extends CampaignSpec {
    
    String getDefaultCampaignStatusChoice();
    void setDefaultCampaignStatusChoice(String defaultCampaignStatusChoice);
