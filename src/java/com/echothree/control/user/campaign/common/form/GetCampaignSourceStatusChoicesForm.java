...
public interface GetCampaignSourceStatusChoicesForm
        extends CampaignSourceSpec {
    
    String getDefaultCampaignSourceStatusChoice();
    void setDefaultCampaignSourceStatusChoice(String defaultCampaignSourceStatusChoice);
