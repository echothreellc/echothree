...
import com.echothree.control.user.campaign.common.form.GetCampaignMediumStatusChoicesForm;
import com.echothree.control.user.campaign.common.result.CampaignResultFactory;
import com.echothree.control.user.campaign.common.result.GetCampaignMediumStatusChoicesResult;
...
public class GetCampaignMediumStatusChoicesCommand
        extends BaseSimpleCommand<GetCampaignMediumStatusChoicesForm> {
    ...
    static {
        ...
        FORM_FIELD_DEFINITIONS = Collections.unmodifiableList(Arrays.asList(
            ...
            new FieldDefinition("DefaultCampaignMediumStatusChoice", FieldType.ENTITY_NAME, false, null, null),
            new FieldDefinition("AllowNullChoice", FieldType.BOOLEAN, true, null, null)
        ));
    }
    
    /** Creates a new instance of GetCampaignMediumStatusChoicesCommand */
    public GetCampaignMediumStatusChoicesCommand(UserVisitPK userVisitPK, GetCampaignMediumStatusChoicesForm form) {
