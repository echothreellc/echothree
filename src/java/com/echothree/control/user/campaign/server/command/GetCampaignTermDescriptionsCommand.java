...
import com.echothree.control.user.campaign.common.form.GetCampaignTermDescriptionsForm;
import com.echothree.control.user.campaign.common.result.CampaignResultFactory;
import com.echothree.control.user.campaign.common.result.GetCampaignTermDescriptionsResult;
...
public class GetCampaignTermDescriptionsCommand
        extends BaseSimpleCommand<GetCampaignTermDescriptionsForm> {
    ...
    /** Creates a new instance of GetCampaignTermDescriptionsCommand */
    public GetCampaignTermDescriptionsCommand(UserVisitPK userVisitPK, GetCampaignTermDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        var result = CampaignResultFactory.getGetCampaignTermDescriptionsResult();
        ...
        if(campaignTerm != null) {
            ...
            result.setCampaignTermDescriptions(campaignControl.getCampaignTermDescriptionTransfersByCampaignTerm(getUserVisit(), campaignTerm));
        } else {
