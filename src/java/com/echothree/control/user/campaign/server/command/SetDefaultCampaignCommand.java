...
import com.echothree.control.user.campaign.common.form.SetDefaultCampaignForm;
...
@Dependent
public class SetDefaultCampaignCommand
        extends BaseSimpleCommand<SetDefaultCampaignForm> {
    ...
    protected BaseResult execute() {
        ...
        if(!hasExecutionErrors()) {
            ...
            campaignControl.updateCampaignFromValue(campaignDetailValue, getPartyPK());
        }
