...
import com.echothree.control.user.campaign.remote.form.GetCampaignMediumForm;
import com.echothree.control.user.campaign.remote.result.CampaignResultFactory;
import com.echothree.control.user.campaign.remote.result.GetCampaignMediumResult;
...
public class GetCampaignMediumCommand
    ...
    protected BaseResult execute() {
        ...
        int parameterCount = (campaignMediumName == null ? 0 : 1) + EntityInstanceLogic.getInstance().countPossibleEntitySpecs(form);
        ...
        if(parameterCount == 1) {
            ...
            if(!hasExecutionErrors()) {
                ...
                sendEventUsingNames(campaignMedium.getPrimaryKey(), EventTypes.READ.name(), null, null, getPartyPK());
            }
        } else {
