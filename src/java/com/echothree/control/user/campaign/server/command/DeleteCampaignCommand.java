...
import com.echothree.control.user.campaign.common.form.DeleteCampaignForm;
...
public class DeleteCampaignCommand
        extends BaseSimpleCommand<DeleteCampaignForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.Campaign.name(), SecurityRoles.Delete.name())
                        )))
                )));
    ...
    /** Creates a new instance of DeleteCampaignCommand */
    public DeleteCampaignCommand(UserVisitPK userVisitPK, DeleteCampaignForm form) {
