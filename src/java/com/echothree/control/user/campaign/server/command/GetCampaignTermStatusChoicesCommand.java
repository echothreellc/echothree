...
import com.echothree.control.user.campaign.common.form.GetCampaignTermStatusChoicesForm;
import com.echothree.control.user.campaign.common.result.CampaignResultFactory;
import com.echothree.control.user.campaign.common.result.GetCampaignTermStatusChoicesResult;
...
public class GetCampaignTermStatusChoicesCommand
        extends BaseSimpleCommand<GetCampaignTermStatusChoicesForm> {
    ...
    static {
        ...
        FORM_FIELD_DEFINITIONS = Collections.unmodifiableList(Arrays.asList(
            ...
            new FieldDefinition("DefaultCampaignTermStatusChoice", FieldType.ENTITY_NAME, false, null, null),
            new FieldDefinition("AllowNullChoice", FieldType.BOOLEAN, true, null, null)
        ));
    }
    
    /** Creates a new instance of GetCampaignTermStatusChoicesCommand */
    public GetCampaignTermStatusChoicesCommand(UserVisitPK userVisitPK, GetCampaignTermStatusChoicesForm form) {
