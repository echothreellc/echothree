...
import com.echothree.control.user.campaign.common.form.GetCampaignDescriptionForm;
import com.echothree.control.user.campaign.common.result.CampaignResultFactory;
import com.echothree.control.user.campaign.common.result.GetCampaignDescriptionResult;
...
public class GetCampaignDescriptionCommand
        extends BaseSimpleCommand<GetCampaignDescriptionForm> {
    ...
    /** Creates a new instance of GetCampaignDescriptionCommand */
    public GetCampaignDescriptionCommand(UserVisitPK userVisitPK, GetCampaignDescriptionForm form) {
