...
import com.echothree.control.user.campaign.remote.form.GetCampaignContentForm;
import com.echothree.control.user.campaign.remote.result.CampaignResultFactory;
import com.echothree.control.user.campaign.remote.result.GetCampaignContentResult;
...
public class GetCampaignContentCommand
    ...
    public GetCampaignContentCommand(UserVisitPK userVisitPK, GetCampaignContentForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(parameterCount == 1) {
            ...
            if(!hasExecutionErrors()) {
                ...
                sendEventUsingNames(campaignContent.getPrimaryKey(), EventTypes.READ.name(), null, null, getPartyPK());
            }
        } else {
