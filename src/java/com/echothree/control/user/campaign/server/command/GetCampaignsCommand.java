...
import com.echothree.control.user.campaign.remote.form.GetCampaignsForm;
import com.echothree.control.user.campaign.remote.result.CampaignResultFactory;
import com.echothree.control.user.campaign.remote.result.GetCampaignsResult;
...
public class GetCampaignsCommand
        extends BaseSimpleCommand<GetCampaignsForm> {
    ...
    public GetCampaignsCommand(UserVisitPK userVisitPK, GetCampaignsForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetCampaignsResult result = CampaignResultFactory.getGetCampaignsResult();
        
        result.setCampaigns(campaignControl.getCampaignTransfers(getUserVisit()));
