...
import com.echothree.control.user.campaign.common.form.CreateCampaignDescriptionForm;
...
public class CreateCampaignDescriptionCommand
        extends BaseSimpleCommand<CreateCampaignDescriptionForm> {
    ...
    /** Creates a new instance of CreateCampaignDescriptionCommand */
    public CreateCampaignDescriptionCommand(UserVisitPK userVisitPK, CreateCampaignDescriptionForm form) {
        ...
        if(campaign != null) {
            ...
            if(language != null) {
                ...
                if(campaignDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateCampaignDescription.name(), campaignName, languageIsoName);
                }
            } else {
