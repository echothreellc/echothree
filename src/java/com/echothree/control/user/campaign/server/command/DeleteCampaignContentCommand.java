...
import com.echothree.control.user.campaign.remote.form.DeleteCampaignContentForm;
...
public class DeleteCampaignContentCommand
        extends BaseSimpleCommand<DeleteCampaignContentForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.CampaignContent.name(), SecurityRoles.Delete.name())
                        )))
                )));
    ...
    public DeleteCampaignContentCommand(UserVisitPK userVisitPK, DeleteCampaignContentForm form) {
    ...
    protected BaseResult execute() {
        ...
        CampaignContent campaignContent = campaignControl.getCampaignContentByNameForUpdate(campaignContentName);
