...
import com.echothree.control.user.campaign.common.form.DeleteCampaignDescriptionForm;
...
public class DeleteCampaignDescriptionCommand
        extends BaseSimpleCommand<DeleteCampaignDescriptionForm> {
    ...
    /** Creates a new instance of DeleteCampaignDescriptionCommand */
    public DeleteCampaignDescriptionCommand(UserVisitPK userVisitPK, DeleteCampaignDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(campaign != null) {
            ...
            if(language != null) {
                CampaignDescription campaignDescription = campaignControl.getCampaignDescriptionForUpdate(campaign, language);
                
                if(campaignDescription != null) {
                    campaignControl.deleteCampaignDescription(campaignDescription, getPartyPK());
                } else {
