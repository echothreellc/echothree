...
import com.echothree.control.user.campaign.common.form.CreateCampaignTermDescriptionForm;
...
@Dependent
public class CreateCampaignTermDescriptionCommand
        extends BaseSimpleCommand<CreateCampaignTermDescriptionForm> {
        ...
        if(campaignTerm != null) {
            ...
            if(language != null) {
                ...
                if(campaignTermDescription == null) {
                    ...
                    campaignControl.createCampaignTermDescription(campaignTerm, language, description, getPartyPK());
                } else {
                    addExecutionError(ExecutionErrors.DuplicateCampaignTermDescription.name(), campaignTermName, languageIsoName);
                }
            } else {
