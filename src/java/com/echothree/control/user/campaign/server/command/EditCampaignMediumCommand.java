...
import com.echothree.control.user.campaign.remote.edit.CampaignMediumEdit;
import com.echothree.control.user.campaign.remote.form.EditCampaignMediumForm;
import com.echothree.control.user.campaign.remote.result.CampaignResultFactory;
import com.echothree.control.user.campaign.remote.result.EditCampaignMediumResult;
import com.echothree.control.user.campaign.remote.spec.CampaignMediumSpec;
...
public class EditCampaignMediumCommand
    ...
    public EditCampaignMediumCommand(UserVisitPK userVisitPK, EditCampaignMediumForm form) {
