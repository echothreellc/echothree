...
import com.echothree.control.user.campaign.remote.form.GetCampaignSourceStatusChoicesForm;
import com.echothree.control.user.campaign.remote.result.CampaignResultFactory;
import com.echothree.control.user.campaign.remote.result.GetCampaignSourceStatusChoicesResult;
...
public class GetCampaignSourceStatusChoicesCommand
    ...
    protected BaseResult execute() {
        ...
        GetCampaignSourceStatusChoicesResult result = CampaignResultFactory.getGetCampaignSourceStatusChoicesResult();
        ...
        if(campaignSource != null) {
            String defaultCampaignSourceStatusChoice = form.getDefaultCampaignSourceStatusChoice();
