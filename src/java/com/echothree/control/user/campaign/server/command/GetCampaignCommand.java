...
public class GetCampaignCommand
        extends BaseSingleEntityCommand<Campaign, GetCampaignForm> {
    ...
    protected Campaign getEntity() {
        var campaign = campaignLogic.getCampaignByUniversalSpec(this, form);
    ...
    @Override
    protected BaseResult getResult(Campaign campaign) {
