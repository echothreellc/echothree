...
import com.echothree.control.user.campaign.remote.form.SetDefaultCampaignSourceForm;
...
public class SetDefaultCampaignSourceCommand
    ...
    public SetDefaultCampaignSourceCommand(UserVisitPK userVisitPK, SetDefaultCampaignSourceForm form) {
