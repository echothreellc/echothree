...
import com.echothree.control.user.campaign.remote.form.CreateCampaignMediumForm;
import com.echothree.control.user.campaign.remote.result.CampaignResultFactory;
import com.echothree.control.user.campaign.remote.result.CreateCampaignMediumResult;
...
public class CreateCampaignMediumCommand
        extends BaseSimpleCommand<CreateCampaignMediumForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.CampaignMedium.name(), SecurityRoles.Create.name())
                        )))
                )));
    ...
    /** Creates a new instance of CreateCampaignMediumCommand */
    public CreateCampaignMediumCommand(UserVisitPK userVisitPK, CreateCampaignMediumForm form) {
    ...
    protected BaseResult execute() {
        ...
        result.setCampaignMediumName(campaignMedium.getLastDetail().getCampaignMediumName());
