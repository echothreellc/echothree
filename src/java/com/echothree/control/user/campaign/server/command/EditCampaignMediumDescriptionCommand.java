...
import com.echothree.control.user.campaign.remote.edit.CampaignMediumDescriptionEdit;
import com.echothree.control.user.campaign.remote.form.EditCampaignMediumDescriptionForm;
import com.echothree.control.user.campaign.remote.result.CampaignResultFactory;
import com.echothree.control.user.campaign.remote.result.EditCampaignMediumDescriptionResult;
...
public class EditCampaignMediumDescriptionCommand
    ...
    public EditCampaignMediumDescriptionCommand(UserVisitPK userVisitPK, EditCampaignMediumDescriptionForm form) {
