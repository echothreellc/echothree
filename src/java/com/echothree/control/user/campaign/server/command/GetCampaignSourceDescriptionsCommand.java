...
import com.echothree.control.user.campaign.common.form.GetCampaignSourceDescriptionsForm;
import com.echothree.control.user.campaign.common.result.CampaignResultFactory;
import com.echothree.control.user.campaign.common.result.GetCampaignSourceDescriptionsResult;
...
public class GetCampaignSourceDescriptionsCommand
        extends BaseSimpleCommand<GetCampaignSourceDescriptionsForm> {
    ...
    /** Creates a new instance of GetCampaignSourceDescriptionsCommand */
    public GetCampaignSourceDescriptionsCommand(UserVisitPK userVisitPK, GetCampaignSourceDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        var result = CampaignResultFactory.getGetCampaignSourceDescriptionsResult();
        ...
        if(campaignSource != null) {
            ...
            result.setCampaignSourceDescriptions(campaignControl.getCampaignSourceDescriptionTransfersByCampaignSource(getUserVisit(), campaignSource));
        } else {
