...
public class GetCampaignTermCommand
        extends BaseSingleEntityCommand<CampaignTerm, GetCampaignTermForm> {
    ...
    @Override
    protected CampaignTerm getEntity() {
        var campaignTerm = campaignTermLogic.getCampaignTermByUniversalSpec(this, form);
    ...
    @Override
    protected BaseResult getResult(CampaignTerm campaignTerm) {
