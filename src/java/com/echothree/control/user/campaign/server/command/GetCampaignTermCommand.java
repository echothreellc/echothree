...
import com.echothree.control.user.campaign.remote.form.GetCampaignTermForm;
import com.echothree.control.user.campaign.remote.result.CampaignResultFactory;
import com.echothree.control.user.campaign.remote.result.GetCampaignTermResult;
...
public class GetCampaignTermCommand
    ...
    public GetCampaignTermCommand(UserVisitPK userVisitPK, GetCampaignTermForm form) {
