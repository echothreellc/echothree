...
import com.echothree.control.user.campaign.remote.form.CreateCampaignContentForm;
import com.echothree.control.user.campaign.remote.result.CampaignResultFactory;
import com.echothree.control.user.campaign.remote.result.CreateCampaignContentResult;
...
public class CreateCampaignContentCommand
    ...
    public CreateCampaignContentCommand(UserVisitPK userVisitPK, CreateCampaignContentForm form) {
