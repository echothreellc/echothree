...
import com.echothree.control.user.batch.common.form.CreateBatchAliasTypeDescriptionForm;
...
@Dependent
public class CreateBatchAliasTypeDescriptionCommand
        extends BaseSimpleCommand<CreateBatchAliasTypeDescriptionForm> {
            ...
            if(batchAliasType != null) {
                ...
                if(language != null) {
                    ...
                    if(batchAliasTypeDescription == null) {
                        ...
                        addExecutionError(ExecutionErrors.DuplicateBatchAliasTypeDescription.name(), batchTypeName, batchAliasTypeName, languageIsoName);
                    }
                } else {
