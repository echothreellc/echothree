...
import com.echothree.control.user.batch.common.form.DeleteBatchAliasTypeDescriptionForm;
...
@RequestScoped
public class DeleteBatchAliasTypeDescriptionCommand
        extends BaseSimpleCommand<DeleteBatchAliasTypeDescriptionForm> {
