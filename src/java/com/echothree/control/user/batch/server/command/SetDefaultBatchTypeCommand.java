...
import com.echothree.control.user.batch.common.form.SetDefaultBatchTypeForm;
...
public class SetDefaultBatchTypeCommand
        extends BaseSimpleCommand<SetDefaultBatchTypeForm> {
    ...
    public SetDefaultBatchTypeCommand(UserVisitPK userVisitPK, SetDefaultBatchTypeForm form) {
