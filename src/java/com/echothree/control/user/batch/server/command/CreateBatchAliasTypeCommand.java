...
import com.echothree.control.user.batch.common.form.CreateBatchAliasTypeForm;
...
public class CreateBatchAliasTypeCommand
        extends BaseSimpleCommand<CreateBatchAliasTypeForm> {
    ...
    public CreateBatchAliasTypeCommand(UserVisitPK userVisitPK, CreateBatchAliasTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(batchType != null) {
            ...
            if(batchAliasType == null) {
                ...
                if(description != null) {
                    batchControl.createBatchAliasTypeDescription(batchAliasType, getPreferredLanguage(), description, createdBy);
                }
            } else {
                addExecutionError(ExecutionErrors.DuplicateBatchAliasTypeName.name(), batchTypeName, batchAliasTypeName);
            }
        } else {
