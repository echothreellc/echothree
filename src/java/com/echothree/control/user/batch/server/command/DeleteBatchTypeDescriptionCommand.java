...
import com.echothree.control.user.batch.common.form.DeleteBatchTypeDescriptionForm;
...
public class DeleteBatchTypeDescriptionCommand
        extends BaseSimpleCommand<DeleteBatchTypeDescriptionForm> {
    ...
    /** Creates a new instance of DeleteBatchTypeDescriptionCommand */
    public DeleteBatchTypeDescriptionCommand(UserVisitPK userVisitPK, DeleteBatchTypeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(batchType != null) {
            ...
            if(language != null) {
                BatchTypeDescription batchTypeDescription = batchControl.getBatchTypeDescriptionForUpdate(batchType, language);
                
                if(batchTypeDescription != null) {
                    batchControl.deleteBatchTypeDescription(batchTypeDescription, getPartyPK());
                } else {
