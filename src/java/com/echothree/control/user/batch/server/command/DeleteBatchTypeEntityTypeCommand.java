...
import com.echothree.control.user.batch.remote.form.DeleteBatchTypeEntityTypeForm;
...
public class DeleteBatchTypeEntityTypeCommand
        extends BaseSimpleCommand<DeleteBatchTypeEntityTypeForm> {
