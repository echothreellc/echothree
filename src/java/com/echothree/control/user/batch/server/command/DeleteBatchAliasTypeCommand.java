...
import com.echothree.control.user.batch.common.form.DeleteBatchAliasTypeForm;
...
public class DeleteBatchAliasTypeCommand
        extends BaseSimpleCommand<DeleteBatchAliasTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.BatchAliasType.name(), SecurityRoles.Delete.name())
                        )))
                )));
    ...
    /** Creates a new instance of DeleteBatchAliasTypeCommand */
    public DeleteBatchAliasTypeCommand(UserVisitPK userVisitPK, DeleteBatchAliasTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(batchType != null) {
            ...
            BatchAliasType batchAliasType = batchControl.getBatchAliasTypeByNameForUpdate(batchType, batchAliasTypeName);

            if(batchAliasType != null) {
                batchControl.deleteBatchAliasType(batchAliasType, getPartyPK());
            } else {
