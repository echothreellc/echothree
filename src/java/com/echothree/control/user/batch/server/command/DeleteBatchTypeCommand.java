...
import com.echothree.control.user.batch.common.form.DeleteBatchTypeForm;
...
public class DeleteBatchTypeCommand
        extends BaseSimpleCommand<DeleteBatchTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.BatchType.name(), SecurityRoles.Delete.name())
                        )))
                )));
