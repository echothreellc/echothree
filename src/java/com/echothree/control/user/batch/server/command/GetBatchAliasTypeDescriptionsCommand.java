...
import com.echothree.control.user.batch.common.form.GetBatchAliasTypeDescriptionsForm;
import com.echothree.control.user.batch.common.result.BatchResultFactory;
import com.echothree.control.user.batch.common.result.GetBatchAliasTypeDescriptionsResult;
...
public class GetBatchAliasTypeDescriptionsCommand
        extends BaseSimpleCommand<GetBatchAliasTypeDescriptionsForm> {
    ...
    /** Creates a new instance of GetBatchAliasTypeDescriptionsCommand */
    public GetBatchAliasTypeDescriptionsCommand(UserVisitPK userVisitPK, GetBatchAliasTypeDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetBatchAliasTypeDescriptionsResult result = BatchResultFactory.getGetBatchAliasTypeDescriptionsResult();
        ...
        if(batchType != null) {
            ...
            if(batchAliasType != null) {
                ...
                result.setBatchAliasTypeDescriptions(batchControl.getBatchAliasTypeDescriptionTransfersByBatchAliasType(getUserVisit(), batchAliasType));
            } else {
