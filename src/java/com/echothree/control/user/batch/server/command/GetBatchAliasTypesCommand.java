...
import com.echothree.control.user.batch.remote.form.GetBatchAliasTypesForm;
import com.echothree.control.user.batch.remote.result.BatchResultFactory;
import com.echothree.control.user.batch.remote.result.GetBatchAliasTypesResult;
...
public class GetBatchAliasTypesCommand
        extends BaseSimpleCommand<GetBatchAliasTypesForm> {
    ...
    public GetBatchAliasTypesCommand(UserVisitPK userVisitPK, GetBatchAliasTypesForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetBatchAliasTypesResult result = BatchResultFactory.getGetBatchAliasTypesResult();
        ...
        if(batchType != null) {
            ...
            result.setBatchAliasTypes(batchControl.getBatchAliasTypeTransfers(getUserVisit(), batchType));
        } else {
