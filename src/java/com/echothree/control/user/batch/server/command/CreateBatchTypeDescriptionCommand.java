...
public class CreateBatchTypeDescriptionCommand
        extends BaseSimpleCommand<CreateBatchTypeDescriptionForm> {
    ...
    /** Creates a new instance of CreateBatchTypeDescriptionCommand */
    public CreateBatchTypeDescriptionCommand(UserVisitPK userVisitPK, CreateBatchTypeDescriptionForm form) {
        ...
        if(batchType != null) {
            ...
            if(language != null) {
                ...
                if(batchTypeDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateBatchTypeDescription.name(), batchTypeName, languageIsoName);
                }
            } else {
