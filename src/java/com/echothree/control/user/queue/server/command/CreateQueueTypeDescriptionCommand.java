...
public class CreateQueueTypeDescriptionCommand
        extends BaseSimpleCommand<CreateQueueTypeDescriptionForm> {
    ...
    /** Creates a new instance of CreateQueueTypeDescriptionCommand */
    public CreateQueueTypeDescriptionCommand(UserVisitPK userVisitPK, CreateQueueTypeDescriptionForm form) {
        ...
        if(queueType != null) {
            ...
            if(language != null) {
                ...
                if(queueTypeDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateQueueTypeDescription.name(), queueTypeName, languageIsoName);
                }
            } else {
