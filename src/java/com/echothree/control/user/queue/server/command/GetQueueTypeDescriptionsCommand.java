...
import com.echothree.control.user.queue.remote.form.GetQueueTypeDescriptionsForm;
import com.echothree.control.user.queue.remote.result.GetQueueTypeDescriptionsResult;
...
public class GetQueueTypeDescriptionsCommand
        extends BaseSimpleCommand<GetQueueTypeDescriptionsForm> {
    ...
    protected BaseResult execute() {
        ...
        if(queueType != null) {
            ...
            result.setQueueTypeDescriptions(queueControl.getQueueTypeDescriptionTransfersByQueueType(getUserVisit(), queueType));
        } else {
