...
public interface CreateOfferDescriptionForm
        extends OfferDescriptionSpec, OfferDescriptionEdit {
    
    // Nothing additional beyond OfferDescriptionSpec, OfferDescriptionEdit
