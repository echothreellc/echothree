...
public interface CreateUseTypeDescriptionForm
        extends UseTypeDescriptionSpec, UseTypeDescriptionEdit {
    
    // Nothing additional beyond UseTypeDescriptionSpec, UseTypeDescriptionEdit
