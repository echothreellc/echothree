...
public interface GetOfferItemsResult
        extends BaseResult {
    
    OfferTransfer getOffer();
    void setOffer(OfferTransfer offer);
    
    Long getOfferItemCount();
    void setOfferItemCount(Long offerItemCount);

    List<OfferItemTransfer> getOfferItems();
    void setOfferItems(List<OfferItemTransfer> offerItems);
