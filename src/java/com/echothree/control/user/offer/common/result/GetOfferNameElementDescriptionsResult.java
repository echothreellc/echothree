...
public interface GetOfferNameElementDescriptionsResult
        extends BaseResult {
    
    OfferNameElementTransfer getOfferNameElement();
    void setOfferNameElement(OfferNameElementTransfer offerNameElement);
    
    List<OfferNameElementDescriptionTransfer> getOfferNameElementDescriptions();
    void setOfferNameElementDescriptions(List<OfferNameElementDescriptionTransfer> offerNameElementDescriptions);
