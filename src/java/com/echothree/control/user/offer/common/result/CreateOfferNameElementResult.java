...
public interface CreateOfferNameElementResult
        extends OfferNameElementSpec, EntityRefSpec, BaseResult {
    
    // Nothing additional beyond OfferNameElementSpec, EntityRefSpec, BaseResult
