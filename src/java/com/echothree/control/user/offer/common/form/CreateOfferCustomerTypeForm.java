...
public interface CreateOfferCustomerTypeForm
        extends OfferCustomerTypeSpec, OfferCustomerTypeEdit {
    
    // Nothing additional beyond OfferCustomerTypeSpec, OfferCustomerTypeEdit
