...
import com.echothree.control.user.offer.remote.form.DeleteOfferItemForm;
...
public class DeleteOfferItemCommand
        extends BaseSimpleCommand<DeleteOfferItemForm> {
    ...
    public DeleteOfferItemCommand(UserVisitPK userVisitPK, DeleteOfferItemForm form) {
