...
import com.echothree.control.user.offer.remote.form.GetOfferNameElementsForm;
...
public class GetOfferNameElementsCommand
        extends BaseMultipleEntitiesCommand<OfferNameElement, GetOfferNameElementsForm> {
