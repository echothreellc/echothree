...
import com.echothree.control.user.offer.remote.form.GetUseNameElementsForm;
...
public class GetUseNameElementsCommand
        extends BaseMultipleEntitiesCommand<UseNameElement, GetUseNameElementsForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.UseNameElement.name(), SecurityRoles.List.name())
                        )))
                )));
    ...
    public GetUseNameElementsCommand(UserVisitPK userVisitPK, GetUseNameElementsForm form) {
