...
public class DeleteUseNameElementDescriptionCommand
        extends BaseSimpleCommand<DeleteUseNameElementDescriptionForm> {
    ...
    public DeleteUseNameElementDescriptionCommand(UserVisitPK userVisitPK, DeleteUseNameElementDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(useNameElement != null) {
            ...
            if(language != null) {
                var useNameElementDescription = useNameElementControl.getUseNameElementDescriptionForUpdate(useNameElement, language);
