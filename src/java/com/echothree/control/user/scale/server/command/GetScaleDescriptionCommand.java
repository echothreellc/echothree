...
import com.echothree.control.user.scale.remote.form.GetScaleDescriptionForm;
import com.echothree.control.user.scale.remote.result.GetScaleDescriptionResult;
...
public class GetScaleDescriptionCommand
        extends BaseSimpleCommand<GetScaleDescriptionForm> {
    ...
    public GetScaleDescriptionCommand(UserVisitPK userVisitPK, GetScaleDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetScaleDescriptionResult result = ScaleResultFactory.getGetScaleDescriptionResult();
