...
import com.echothree.control.user.scale.remote.form.GetScaleForm;
import com.echothree.control.user.scale.remote.result.GetScaleResult;
...
public class GetScaleCommand
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.Scale.name(), SecurityRoles.Review.name())
                        )))
                )));
    ...
    public GetScaleCommand(UserVisitPK userVisitPK, GetScaleForm form) {
