...
import com.echothree.control.user.scale.remote.form.GetScaleTypesForm;
import com.echothree.control.user.scale.remote.result.GetScaleTypesResult;
...
public class GetScaleTypesCommand
    ...
    public GetScaleTypesCommand(UserVisitPK userVisitPK, GetScaleTypesForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetScaleTypesResult result = ScaleResultFactory.getGetScaleTypesResult();
