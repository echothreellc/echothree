...
import com.echothree.control.user.scale.remote.form.GetScaleDescriptionsForm;
import com.echothree.control.user.scale.remote.result.GetScaleDescriptionsResult;
...
public class GetScaleDescriptionsCommand
   ...
   private final static List<FieldDefinition> FORM_FIELD_DEFINITIONS;
    ...
    public GetScaleDescriptionsCommand(UserVisitPK userVisitPK, GetScaleDescriptionsForm form) {
   ...
   @Override
    protected BaseResult execute() {
        ...
        GetScaleDescriptionsResult result = ScaleResultFactory.getGetScaleDescriptionsResult();
