...
import com.echothree.control.user.scale.remote.form.CreateScaleUseTypeDescriptionForm;
...
public class CreateScaleUseTypeDescriptionCommand
        extends BaseSimpleCommand<CreateScaleUseTypeDescriptionForm> {
   ...
   private final static List<FieldDefinition> FORM_FIELD_DEFINITIONS;
    ...
    /** Creates a new instance of CreateScaleUseTypeDescriptionCommand */
    public CreateScaleUseTypeDescriptionCommand(UserVisitPK userVisitPK, CreateScaleUseTypeDescriptionForm form) {
        ...
        if(scaleUseType != null) {
            ...
            if(language != null) {
                ...
                if(scaleDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateScaleUseTypeDescription.name());
                }
            } else {
