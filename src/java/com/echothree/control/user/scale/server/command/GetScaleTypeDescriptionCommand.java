...
import com.echothree.control.user.scale.remote.form.GetScaleTypeDescriptionForm;
import com.echothree.control.user.scale.remote.result.GetScaleTypeDescriptionResult;
...
public class GetScaleTypeDescriptionCommand
        extends BaseSimpleCommand<GetScaleTypeDescriptionForm> {
    ...
    protected BaseResult execute() {
        ...
        if(scaleType != null) {
            ...
            if(language != null) {
                ScaleTypeDescription scaleTypeDescription = scaleControl.getScaleTypeDescription(scaleType, language);
