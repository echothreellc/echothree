...
import com.echothree.control.user.scale.remote.form.GetScaleUseTypeChoicesForm;
import com.echothree.control.user.scale.remote.result.GetScaleUseTypeChoicesResult;
...
public class GetScaleUseTypeChoicesCommand
        extends BaseSimpleCommand<GetScaleUseTypeChoicesForm> {
    
   private final static List<FieldDefinition> FORM_FIELD_DEFINITIONS;

    static {
        FORM_FIELD_DEFINITIONS = Collections.unmodifiableList(Arrays.asList(
                new FieldDefinition("DefaultScaleUseTypeChoice", FieldType.ENTITY_NAME, false, null, null),
                new FieldDefinition("AllowNullChoice", FieldType.BOOLEAN, true, null, null)
                ));
    }

    /** Creates a new instance of GetScaleUseTypeChoicesCommand */
    public GetScaleUseTypeChoicesCommand(UserVisitPK userVisitPK, GetScaleUseTypeChoicesForm form) {
