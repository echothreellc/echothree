...
public class SetDefaultScaleCommand
   ...
   private final static List<FieldDefinition> FORM_FIELD_DEFINITIONS;
    ...
    public SetDefaultScaleCommand(UserVisitPK userVisitPK, SetDefaultScaleForm form) {
   ...
   @Override
    protected BaseResult execute() {
        ...
        ScaleDetailValue scaleDetailValue = scaleControl.getScaleDetailValueByNameForUpdate(scaleName);
