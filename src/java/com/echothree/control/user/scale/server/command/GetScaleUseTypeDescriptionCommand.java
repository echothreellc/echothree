...
public class GetScaleUseTypeDescriptionCommand
        extends BaseSimpleCommand<GetScaleUseTypeDescriptionForm> {
    ...
    /** Creates a new instance of GetScaleUseTypeDescriptionCommand */
    public GetScaleUseTypeDescriptionCommand(UserVisitPK userVisitPK, GetScaleUseTypeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetScaleUseTypeDescriptionResult result = ScaleResultFactory.getGetScaleUseTypeDescriptionResult();
        ...
        if(scaleUseType != null) {
            ...
            if(language != null) {
                ScaleUseTypeDescription scaleUseTypeDescription = scaleControl.getScaleUseTypeDescription(scaleUseType, language);
