...
public class GetScaleTypeDescriptionsCommand
        extends BaseSimpleCommand<GetScaleTypeDescriptionsForm> {
   ...
   private final static List<FieldDefinition> FORM_FIELD_DEFINITIONS;
    ...
    public GetScaleTypeDescriptionsCommand(UserVisitPK userVisitPK, GetScaleTypeDescriptionsForm form) {
   ...
   @Override
    protected BaseResult execute() {
        ...
        GetScaleTypeDescriptionsResult result = ScaleResultFactory.getGetScaleTypeDescriptionsResult();
        ...
        if(scaleType != null) {
            ...
            result.setScaleTypeDescriptions(scaleControl.getScaleTypeDescriptionTransfersByScaleType(getUserVisit(), scaleType));
        } else {
