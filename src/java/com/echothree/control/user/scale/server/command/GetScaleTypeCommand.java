...
public class GetScaleTypeCommand
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.ScaleType.name(), SecurityRoles.Review.name())
                        )))
                )));
    ...
    public GetScaleTypeCommand(UserVisitPK userVisitPK, GetScaleTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetScaleTypeResult result = ScaleResultFactory.getGetScaleTypeResult();
