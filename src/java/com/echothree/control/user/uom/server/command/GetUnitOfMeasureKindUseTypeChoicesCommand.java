...
public class GetUnitOfMeasureKindUseTypeChoicesCommand
        extends BaseSimpleCommand<GetUnitOfMeasureKindUseTypeChoicesForm> {
    
    private final static List<FieldDefinition> FORM_FIELD_DEFINITIONS;
    
    static {
        FORM_FIELD_DEFINITIONS = Collections.unmodifiableList(Arrays.asList(
                new FieldDefinition("DefaultUnitOfMeasureKindUseTypeChoice", FieldType.ENTITY_NAME, false, null, null),
                new FieldDefinition("AllowNullChoice", FieldType.BOOLEAN, true, null, null)
                ));
    }
    
    /** Creates a new instance of GetUnitOfMeasureKindUseTypeChoicesCommand */
    public GetUnitOfMeasureKindUseTypeChoicesCommand(UserVisitPK userVisitPK, GetUnitOfMeasureKindUseTypeChoicesForm form) {
    ...
    protected BaseResult execute() {
        ...
        result.setUnitOfMeasureKindUseTypeChoices(uomControl.getUnitOfMeasureKindUseTypeChoices(defaultUnitOfMeasureKindUseTypeChoice,
