...
import com.echothree.control.user.uom.remote.form.GetUnitOfMeasureKindsForm;
import com.echothree.control.user.uom.remote.result.GetUnitOfMeasureKindsResult;
...
public class GetUnitOfMeasureKindsCommand
    ...
    public GetUnitOfMeasureKindsCommand(UserVisitPK userVisitPK, GetUnitOfMeasureKindsForm form) {
    ...
    @Override
    protected BaseResult getTransfers(Collection<UnitOfMeasureKind> entities) {
        GetUnitOfMeasureKindsResult result = UomResultFactory.getGetUnitOfMeasureKindsResult();
        UomControl uomControl = (UomControl)Session.getModelController(UomControl.class);
