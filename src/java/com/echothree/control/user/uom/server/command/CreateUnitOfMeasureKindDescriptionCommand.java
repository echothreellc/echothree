...
public class CreateUnitOfMeasureKindDescriptionCommand
        extends BaseSimpleCommand<CreateUnitOfMeasureKindDescriptionForm> {
    ...
    /** Creates a new instance of CreateUnitOfMeasureKindDescriptionCommand */
    public CreateUnitOfMeasureKindDescriptionCommand(UserVisitPK userVisitPK, CreateUnitOfMeasureKindDescriptionForm form) {
        ...
        if(unitOfMeasureKind != null) {
            ...
            if(language != null) {
                ...
                if(unitOfMeasureKindDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateUnitOfMeasureKindDescription.name());
                }
            } else {
