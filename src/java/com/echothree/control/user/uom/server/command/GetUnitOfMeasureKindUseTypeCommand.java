...
import com.echothree.control.user.uom.remote.form.GetUnitOfMeasureKindUseTypeForm;
import com.echothree.control.user.uom.remote.result.GetUnitOfMeasureKindUseTypeResult;
...
public class GetUnitOfMeasureKindUseTypeCommand
    ...
    public GetUnitOfMeasureKindUseTypeCommand(UserVisitPK userVisitPK, GetUnitOfMeasureKindUseTypeForm form) {
    ...
    @Override
    protected BaseResult getTransfer(UnitOfMeasureKindUseType unitOfMeasureKindUseType) {
        UomControl uomControl = (UomControl)Session.getModelController(UomControl.class);
        GetUnitOfMeasureKindUseTypeResult result = UomResultFactory.getGetUnitOfMeasureKindUseTypeResult();
