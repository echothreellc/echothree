...
import com.echothree.control.user.uom.remote.form.GetUnitOfMeasureKindUseForm;
import com.echothree.control.user.uom.remote.result.GetUnitOfMeasureKindUseResult;
...
public class GetUnitOfMeasureKindUseCommand
    ...
    public GetUnitOfMeasureKindUseCommand(UserVisitPK userVisitPK, GetUnitOfMeasureKindUseForm form) {
    ...
    protected UnitOfMeasureKindUse getEntity() {
        ...
        if(!hasExecutionErrors()) {
            sendEventUsingNames(unitOfMeasureKindUse.getPrimaryKey(), EventTypes.READ.name(), null, null, getPartyPK());
        }
    ...
    @Override
    protected BaseResult getTransfer(UnitOfMeasureKindUse unitOfMeasureKindUse) {
