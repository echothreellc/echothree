...
import com.echothree.control.user.uom.remote.form.CreateUnitOfMeasureKindUseForm;
...
public class CreateUnitOfMeasureKindUseCommand
        extends BaseSimpleCommand<CreateUnitOfMeasureKindUseForm> {
            ...
            if(!multipleUseError) {
                ...
                if(unitOfMeasureKind != null) {
                    ...
                    if(unitOfMeasureKindUse == null) {
                        ...
                        addExecutionError(ExecutionErrors.DuplicateUnitOfMeasureKindUse.name());
                    }
                } else {
                    addExecutionError(ExecutionErrors.UnknownUnitOfMeasureKindName.name(), unitOfMeasureKindName);
                }
            } else {
                addExecutionError(ExecutionErrors.MultipleUnitOfMeasureKindUsesNotAllowed.name());
            }
        } else {
