...
public class DeleteUnitOfMeasureTypeDescriptionCommand
        extends BaseSimpleCommand<DeleteUnitOfMeasureTypeDescriptionForm> {
    ...
    protected BaseResult execute() {
        ...
        if(unitOfMeasureKind != null) {
            ...
            if(unitOfMeasureType != null) {
                ...
                if(language != null) {
                    UnitOfMeasureTypeDescription unitOfMeasureTypeDescription = uomControl.getUnitOfMeasureTypeDescriptionForUpdate(unitOfMeasureType, language);
                    
                    if(unitOfMeasureTypeDescription != null) {
                        uomControl.deleteUnitOfMeasureTypeDescription(unitOfMeasureTypeDescription, getPartyPK());
                    } else {
