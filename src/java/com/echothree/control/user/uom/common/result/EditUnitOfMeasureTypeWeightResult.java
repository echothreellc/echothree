...
public interface EditUnitOfMeasureTypeWeightResult
        extends BaseEditResult<UnitOfMeasureTypeWeightEdit> {
    
    UnitOfMeasureTypeWeightTransfer getUnitOfMeasureTypeWeight();
    void setUnitOfMeasureTypeWeight(UnitOfMeasureTypeWeightTransfer UnitOfMeasureTypeWeight);
