...
public interface EditUnitOfMeasureEquivalentResult
        extends BaseEditResult<UnitOfMeasureEquivalentEdit> {
    
    UnitOfMeasureEquivalentTransfer getUnitOfMeasureEquivalent();
    void setUnitOfMeasureEquivalent(UnitOfMeasureEquivalentTransfer unitOfMeasureEquivalent);
