...
public interface EditUnitOfMeasureTypeVolumeResult
        extends BaseEditResult<UnitOfMeasureTypeVolumeEdit> {
    
    UnitOfMeasureTypeVolumeTransfer getUnitOfMeasureTypeVolume();
    void setUnitOfMeasureTypeVolume(UnitOfMeasureTypeVolumeTransfer UnitOfMeasureTypeVolume);
