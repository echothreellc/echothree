...
public interface EditUnitOfMeasureKindUseResult
        extends BaseEditResult<UnitOfMeasureKindUseEdit> {
    
    UnitOfMeasureKindUseTransfer getUnitOfMeasureKindUse();
    void setUnitOfMeasureKindUse(UnitOfMeasureKindUseTransfer UnitOfMeasureKindUse);
