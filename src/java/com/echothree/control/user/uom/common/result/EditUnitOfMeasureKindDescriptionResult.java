...
public interface EditUnitOfMeasureKindDescriptionResult
        extends BaseEditResult<UnitOfMeasureKindDescriptionEdit> {
    
    UnitOfMeasureKindDescriptionTransfer getUnitOfMeasureKindDescription();
    void setUnitOfMeasureKindDescription(UnitOfMeasureKindDescriptionTransfer unitOfMeasureKindDescription);
