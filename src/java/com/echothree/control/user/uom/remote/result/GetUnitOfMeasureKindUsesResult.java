...
public interface GetUnitOfMeasureKindUsesResult
        extends BaseResult {
    
    UnitOfMeasureKindTransfer getUnitOfMeasureKind();
    void setUnitOfMeasureKind(UnitOfMeasureKindTransfer unitOfMeasureKind);
    
    UnitOfMeasureKindUseTypeTransfer getUnitOfMeasureKindUseType();
    void setUnitOfMeasureKindUseType(UnitOfMeasureKindUseTypeTransfer unitOfMeasureKindUseType);
