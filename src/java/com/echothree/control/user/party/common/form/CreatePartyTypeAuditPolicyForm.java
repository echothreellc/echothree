...
public interface CreatePartyTypeAuditPolicyForm
        extends PartyTypeSpec, PartyTypeAuditPolicyEdit {
    
    // Nothing additional beyond PartyTypeSpec, PartyTypeAuditPolicyEdit
