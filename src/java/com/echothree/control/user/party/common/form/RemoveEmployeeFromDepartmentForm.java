...
public interface RemoveEmployeeFromDepartmentForm
        extends EmployeeSpec, PartySpec, DepartmentSpec {
    
    // Nothing additional beyond EmployeeSpec, PartySpec, DepartmentSpec
