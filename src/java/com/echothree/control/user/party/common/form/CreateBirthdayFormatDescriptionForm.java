...
public interface CreateBirthdayFormatDescriptionForm
        extends BirthdayFormatDescriptionSpec, BirthdayFormatDescriptionEdit {
    
    // Nothing additional beyond BirthdayFormatDescriptionSpec, BirthdayFormatDescriptionEdit
