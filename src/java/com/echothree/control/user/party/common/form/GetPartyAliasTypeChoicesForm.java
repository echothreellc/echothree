...
public interface GetPartyAliasTypeChoicesForm
        extends PartyTypeSpec {
    
    String getDefaultPartyAliasTypeChoice();
    void setDefaultPartyAliasTypeChoice(String defaultPartyAliasTypeChoice);
