...
public interface GetTimeZoneDescriptionsResult
        extends BaseResult {
    
    TimeZoneTransfer getTimeZone();
    void setTimeZone(TimeZoneTransfer timeZone);
    
    List<TimeZoneDescriptionTransfer> getTimeZoneDescriptions();
    void setTimeZoneDescriptions(List<TimeZoneDescriptionTransfer> timeZoneDescriptions);
