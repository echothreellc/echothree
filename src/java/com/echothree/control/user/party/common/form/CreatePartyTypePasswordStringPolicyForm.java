...
public interface CreatePartyTypePasswordStringPolicyForm
        extends PartyTypeSpec, PartyTypePasswordStringPolicyEdit {
    
    // Nothing additional beyond PartyTypeSpec, PartyTypePasswordStringPolicyEdit
