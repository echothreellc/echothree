...
public interface EditMoodDescriptionResult
        extends BaseEditResult<MoodDescriptionEdit> {
    
    MoodDescriptionTransfer getMoodDescription();
    void setMoodDescription(MoodDescriptionTransfer moodDescription);
