...
public interface GetDateTimeFormatDescriptionsResult
        extends BaseResult {
    
    DateTimeFormatTransfer getDateTimeFormat();
    void setDateTimeFormat(DateTimeFormatTransfer dateTimeFormat);
    
    List<DateTimeFormatDescriptionTransfer> getDateTimeFormatDescriptions();
    void setDateTimeFormatDescriptions(List<DateTimeFormatDescriptionTransfer> dateTimeFormatDescriptions);
