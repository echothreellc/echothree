...
public interface EditPartyAliasTypeDescriptionResult
        extends BaseEditResult<PartyAliasTypeDescriptionEdit> {
    
    PartyAliasTypeDescriptionTransfer getPartyAliasTypeDescription();
    void setPartyAliasTypeDescription(PartyAliasTypeDescriptionTransfer partyAliasTypeDescription);
