...
public interface EditPersonalTitleResult
        extends BaseEditResult<PersonalTitleEdit> {
    
    PersonalTitleTransfer getPersonalTitle();
    void setPersonalTitle(PersonalTitleTransfer personalTitle);
