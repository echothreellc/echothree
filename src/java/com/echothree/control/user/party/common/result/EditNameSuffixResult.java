...
public interface EditNameSuffixResult
        extends BaseEditResult<NameSuffixEdit> {
    
    NameSuffixTransfer getNameSuffix();
    void setNameSuffix(NameSuffixTransfer nameSuffix);
