...
public interface GetDepartmentForm
        extends DepartmentSpec, PartySpec, UniversalEntitySpec {
    
    // Nothing additional beyond DepartmentSpec, PartySpec, UniversalEntitySpec
