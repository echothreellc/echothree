...
import com.echothree.control.user.party.remote.form.GetPartyAliasTypeDescriptionForm;
import com.echothree.control.user.party.remote.result.GetPartyAliasTypeDescriptionResult;
...
public class GetPartyAliasTypeDescriptionCommand
        extends BaseSimpleCommand<GetPartyAliasTypeDescriptionForm> {
    ...
    /** Creates a new instance of GetPartyAliasTypeDescriptionCommand */
    public GetPartyAliasTypeDescriptionCommand(UserVisitPK userVisitPK, GetPartyAliasTypeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetPartyAliasTypeDescriptionResult result = PartyResultFactory.getGetPartyAliasTypeDescriptionResult();
