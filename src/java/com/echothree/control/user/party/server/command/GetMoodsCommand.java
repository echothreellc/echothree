...
import com.echothree.control.user.party.remote.form.GetMoodsForm;
import com.echothree.control.user.party.remote.result.GetMoodsResult;
...
public class GetMoodsCommand
        extends BaseSimpleCommand<GetMoodsForm> {
