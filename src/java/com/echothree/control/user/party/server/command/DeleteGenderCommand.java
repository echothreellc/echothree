...
import com.echothree.control.user.party.remote.form.DeleteGenderForm;
...
public class DeleteGenderCommand
        extends BaseSimpleCommand<DeleteGenderForm> {
    ...
    /** Creates a new instance of DeleteGenderCommand */
    public DeleteGenderCommand(UserVisitPK userVisitPK, DeleteGenderForm form) {
