...
import com.echothree.control.user.party.remote.form.GetPartyAliasTypeChoicesForm;
import com.echothree.control.user.party.remote.result.GetPartyAliasTypeChoicesResult;
...
public class GetPartyAliasTypeChoicesCommand
        extends BaseSimpleCommand<GetPartyAliasTypeChoicesForm> {
    ...
    public GetPartyAliasTypeChoicesCommand(UserVisitPK userVisitPK, GetPartyAliasTypeChoicesForm form) {
