...
public class GetGenderChoicesCommand
        extends BaseSimpleCommand<GetGenderChoicesForm> {
    
    private final static List<FieldDefinition> FORM_FIELD_DEFINITIONS;
    
    static {
        FORM_FIELD_DEFINITIONS = Collections.unmodifiableList(Arrays.asList(
                new FieldDefinition("DefaultGenderChoice", FieldType.ENTITY_NAME, false, null, null),
                new FieldDefinition("AllowNullChoice", FieldType.BOOLEAN, true, null, null)
                ));
    }
    
    /** Creates a new instance of GetGenderChoicesCommand */
    public GetGenderChoicesCommand(UserVisitPK userVisitPK, GetGenderChoicesForm form) {
