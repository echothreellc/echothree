...
import com.echothree.control.user.party.remote.form.GetMoodForm;
import com.echothree.control.user.party.remote.result.GetMoodResult;
...
public class GetMoodCommand
    ...
    public GetMoodCommand(UserVisitPK userVisitPK, GetMoodForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetMoodResult result = PartyResultFactory.getGetMoodResult();
