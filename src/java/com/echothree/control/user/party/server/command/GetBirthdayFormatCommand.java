...
import com.echothree.control.user.party.remote.form.GetBirthdayFormatForm;
import com.echothree.control.user.party.remote.result.GetBirthdayFormatResult;
...
public class GetBirthdayFormatCommand
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.BirthdayFormat.name(), SecurityRoles.Review.name())
                        )))
                )));
    ...
    public GetBirthdayFormatCommand(UserVisitPK userVisitPK, GetBirthdayFormatForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetBirthdayFormatResult result = PartyResultFactory.getGetBirthdayFormatResult();
