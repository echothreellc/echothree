...
import com.echothree.control.user.party.remote.form.SetEmployeeStatusForm;
...
public class SetEmployeeStatusCommand
        extends BaseSimpleCommand<SetEmployeeStatusForm> {
    ...
    public SetEmployeeStatusCommand(UserVisitPK userVisitPK, SetEmployeeStatusForm form) {
