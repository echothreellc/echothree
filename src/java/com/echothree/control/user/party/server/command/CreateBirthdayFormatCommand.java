...
import com.echothree.control.user.party.remote.form.CreateBirthdayFormatForm;
...
public class CreateBirthdayFormatCommand
        extends BaseSimpleCommand<CreateBirthdayFormatForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.BirthdayFormat.name(), SecurityRoles.Create.name())
                        )))
                )));
    ...
    protected BaseResult execute() {
        ...
        if(birthdayFormat == null) {
            ...
            birthdayFormat = partyControl.createBirthdayFormat(birthdayFormatName, isDefault, sortOrder, createdBy);
            
            if(description != null) {
                partyControl.createBirthdayFormatDescription(birthdayFormat, getPreferredLanguage(), description, createdBy);
            }
        } else {
