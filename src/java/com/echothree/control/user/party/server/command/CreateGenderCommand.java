...
public class CreateGenderCommand
        extends BaseSimpleCommand<CreateGenderForm> {
    ...
    /** Creates a new instance of CreateGenderCommand */
    public CreateGenderCommand(UserVisitPK userVisitPK, CreateGenderForm form) {
