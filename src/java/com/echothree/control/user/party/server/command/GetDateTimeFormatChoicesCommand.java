...
@Dependent
public class GetDateTimeFormatChoicesCommand
        extends BaseSimpleCommand<GetDateTimeFormatChoicesForm> {
    ...
    static {
        FORM_FIELD_DEFINITIONS = Collections.unmodifiableList(Arrays.asList(
            new FieldDefinition("DefaultDateTimeFormatChoice", FieldType.ENTITY_NAME, false, null, null),
