...
public class GetMoodChoicesCommand
        extends BaseSimpleCommand<GetMoodChoicesForm> {
    
    private final static List<FieldDefinition> FORM_FIELD_DEFINITIONS;
    
    static {
        FORM_FIELD_DEFINITIONS = Collections.unmodifiableList(Arrays.asList(
                new FieldDefinition("DefaultMoodChoice", FieldType.ENTITY_NAME, false, null, null),
                new FieldDefinition("AllowNullChoice", FieldType.BOOLEAN, true, null, null)
                ));
    }
    
    /** Creates a new instance of GetMoodChoicesCommand */
    public GetMoodChoicesCommand(UserVisitPK userVisitPK, GetMoodChoicesForm form) {
