...
public class GetMoodDescriptionsCommand
        extends BaseSimpleCommand<GetMoodDescriptionsForm> {
    ...
    /** Creates a new instance of GetMoodDescriptionsCommand */
    public GetMoodDescriptionsCommand(UserVisitPK userVisitPK, GetMoodDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        var result = PartyResultFactory.getGetMoodDescriptionsResult();
        ...
        if(mood != null) {
            ...
            result.setMoodDescriptions(partyControl.getMoodDescriptionTransfersByMood(getUserVisit(), mood));
        } else {
