...
import com.echothree.control.user.party.common.form.DeletePartyAliasTypeDescriptionForm;
...
public class DeletePartyAliasTypeDescriptionCommand
        extends BaseSimpleCommand<DeletePartyAliasTypeDescriptionForm> {
    ...
    /** Creates a new instance of DeletePartyAliasTypeDescriptionCommand */
    public DeletePartyAliasTypeDescriptionCommand(UserVisitPK userVisitPK, DeletePartyAliasTypeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(partyType != null) {
            ...
            if(partyAliasType != null) {
                ...
                if(language != null) {
                    PartyAliasTypeDescription partyAliasTypeDescription = partyControl.getPartyAliasTypeDescriptionForUpdate(partyAliasType, language);

                    if(partyAliasTypeDescription != null) {
                        partyControl.deletePartyAliasTypeDescription(partyAliasTypeDescription, getPartyPK());
                    } else {
