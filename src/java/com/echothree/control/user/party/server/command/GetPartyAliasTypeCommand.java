...
public class GetPartyAliasTypeCommand
        extends BaseSimpleCommand<GetPartyAliasTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.PartyAliasType.name(), SecurityRoles.Review.name())
                        )))
                )));
    ...
    public GetPartyAliasTypeCommand(UserVisitPK userVisitPK, GetPartyAliasTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(partyType != null) {
            ...
            if(partyAliasType != null) {
                ...
                sendEventUsingNames(partyAliasType.getPrimaryKey(), EventTypes.READ.name(), null, null, getPartyPK());
            } else {
