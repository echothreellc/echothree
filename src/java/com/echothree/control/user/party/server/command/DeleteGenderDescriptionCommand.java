...
import com.echothree.control.user.party.common.form.DeleteGenderDescriptionForm;
...
public class DeleteGenderDescriptionCommand
        extends BaseSimpleCommand<DeleteGenderDescriptionForm> {
    ...
    protected BaseResult execute() {
        ...
        if(gender != null) {
            ...
            if(language != null) {
                GenderDescription genderDescription = partyControl.getGenderDescriptionForUpdate(gender, language);
                
                if(genderDescription != null) {
                    partyControl.deleteGenderDescription(genderDescription, getPartyPK());
                } else {
