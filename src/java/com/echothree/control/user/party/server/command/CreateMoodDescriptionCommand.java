...
public class CreateMoodDescriptionCommand
        extends BaseSimpleCommand<CreateMoodDescriptionForm> {
    ...
    /** Creates a new instance of CreateMoodDescriptionCommand */
    public CreateMoodDescriptionCommand(UserVisitPK userVisitPK, CreateMoodDescriptionForm form) {
        ...
        if(mood != null) {
            ...
            if(language != null) {
                ...
                if(moodDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateMoodDescription.name());
                }
            } else {
