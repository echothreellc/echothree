...
import com.echothree.control.user.party.common.form.GetPartyAliasTypeDescriptionsForm;
import com.echothree.control.user.party.common.result.GetPartyAliasTypeDescriptionsResult;
...
public class GetPartyAliasTypeDescriptionsCommand
        extends BaseSimpleCommand<GetPartyAliasTypeDescriptionsForm> {
    ...
    protected BaseResult execute() {
        ...
        if(partyType != null) {
            ...
            if(partyAliasType != null) {
                ...
                result.setPartyAliasTypeDescriptions(partyControl.getPartyAliasTypeDescriptionTransfersByPartyAliasType(getUserVisit(), partyAliasType));
            } else {
