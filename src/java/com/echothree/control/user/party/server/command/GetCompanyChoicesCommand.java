...
public class GetCompanyChoicesCommand
        extends BaseSimpleCommand<GetCompanyChoicesForm> {
    
    private final static List<FieldDefinition> FORM_FIELD_DEFINITIONS;
    
    static {
        FORM_FIELD_DEFINITIONS = Collections.unmodifiableList(Arrays.asList(
                new FieldDefinition("DefaultCompanyChoice", FieldType.ENTITY_NAME, false, null, null),
                new FieldDefinition("AllowNullChoice", FieldType.BOOLEAN, true, null, null)
                ));
    }
    
    /** Creates a new instance of GetCompanyChoicesCommand */
    public GetCompanyChoicesCommand(UserVisitPK userVisitPK, GetCompanyChoicesForm form) {
