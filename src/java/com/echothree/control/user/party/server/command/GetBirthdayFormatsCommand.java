...
import com.echothree.control.user.party.remote.form.GetBirthdayFormatsForm;
import com.echothree.control.user.party.remote.result.GetBirthdayFormatsResult;
...
public class GetBirthdayFormatsCommand
        extends BaseSimpleCommand<GetBirthdayFormatsForm> {
    ...
    public GetBirthdayFormatsCommand(UserVisitPK userVisitPK, GetBirthdayFormatsForm form) {
