...
public class GetLanguageChoicesCommand
        extends BaseSimpleCommand<GetLanguageChoicesForm> {
    ...
    static {
        FORM_FIELD_DEFINITIONS = Collections.unmodifiableList(Arrays.asList(
            new FieldDefinition("DefaultLanguageChoice", FieldType.ENTITY_NAME, false, null, null),
            new FieldDefinition("AllowNullChoice", FieldType.BOOLEAN, true, null, null)
        ));
    }
    
    /** Creates a new instance of GetLanguageChoicesCommand */
    public GetLanguageChoicesCommand(UserVisitPK userVisitPK, GetLanguageChoicesForm form) {
