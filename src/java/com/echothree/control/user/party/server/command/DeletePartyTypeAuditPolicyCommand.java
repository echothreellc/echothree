...
import com.echothree.control.user.party.common.form.DeletePartyTypeAuditPolicyForm;
...
@RequestScoped
public class DeletePartyTypeAuditPolicyCommand
        extends BaseSimpleCommand<DeletePartyTypeAuditPolicyForm> {
