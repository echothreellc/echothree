...
import com.echothree.control.user.party.remote.form.GetEmployeeAvailabilityChoicesForm;
import com.echothree.control.user.party.remote.result.GetEmployeeAvailabilityChoicesResult;
...
public class GetEmployeeAvailabilityChoicesCommand
        extends BaseSimpleCommand<GetEmployeeAvailabilityChoicesForm> {
    ...
    public GetEmployeeAvailabilityChoicesCommand(UserVisitPK userVisitPK, GetEmployeeAvailabilityChoicesForm form) {
