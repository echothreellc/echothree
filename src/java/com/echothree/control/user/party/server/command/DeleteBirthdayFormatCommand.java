...
import com.echothree.control.user.party.common.form.DeleteBirthdayFormatForm;
...
@Dependent
public class DeleteBirthdayFormatCommand
        extends BaseSimpleCommand<DeleteBirthdayFormatForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.BirthdayFormat.name(), SecurityRoles.Delete.name())
                        )))
                )));
