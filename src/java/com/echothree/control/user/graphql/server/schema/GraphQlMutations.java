...
public interface GraphQlMutations {
    ...
    @GraphQLField
    @GraphQLRelayMutation
    static MutationResultWithIdObject createInventoryCostingMethod(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var commandResult = InventoryUtil.getHome().createInventoryCostingMethod(BaseGraphQl.getUserVisitPK(env), commandForm);
            mutationResultObject.setCommandResult(commandResult);

            if(!commandResult.hasErrors()) {
                var result = (CreateInventoryCostingMethodResult)commandResult.getExecutionResult().getResult();
    ...
    @GraphQLField
    @GraphQLRelayMutation
    static MutationResultWithIdObject editInventoryCostingMethod(final DataFetchingEnvironment env,
            @GraphQLName("originalInventoryCostingMethodName") final String originalInventoryCostingMethodName,
            @GraphQLName("id") @GraphQLID final String id,
        ...
        try {
            ...
            var commandResult = InventoryUtil.getHome().editInventoryCostingMethod(BaseGraphQl.getUserVisitPK(env), commandForm);

            if(!commandResult.hasErrors()) {
                var executionResult = commandResult.getExecutionResult();
                var result = (EditInventoryCostingMethodResult)executionResult.getResult();
                Map<String, Object> arguments = env.getArgument("input");
                var edit = result.getEdit();

                mutationResultObject.setEntityInstance(result.getInventoryCostingMethod().getEntityInstance());
                ...
                commandResult = InventoryUtil.getHome().editInventoryCostingMethod(BaseGraphQl.getUserVisitPK(env), commandForm);
            }
    ...
    @GraphQLField
    @GraphQLRelayMutation
    static MutationResultObject deleteInventoryCostingMethod(final DataFetchingEnvironment env,
            @GraphQLName("inventoryCostingMethodName") final String inventoryCostingMethodName,
            @GraphQLName("id") @GraphQLID final String id) {
        var mutationResultObject = new MutationResultObject();
        ...
        try {
            ...
            mutationResultObject.setCommandResult(InventoryUtil.getHome().deleteInventoryCostingMethod(BaseGraphQl.getUserVisitPK(env), commandForm));
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static MutationResultWithIdObject createInventoryBucketType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var commandResult = InventoryUtil.getHome().createInventoryBucketType(BaseGraphQl.getUserVisitPK(env), commandForm);
            mutationResultObject.setCommandResult(commandResult);

            if(!commandResult.hasErrors()) {
                var result = (CreateInventoryBucketTypeResult)commandResult.getExecutionResult().getResult();
    ...
    @GraphQLField
    @GraphQLRelayMutation
    static MutationResultWithIdObject editInventoryBucketType(final DataFetchingEnvironment env,
            @GraphQLName("originalInventoryBucketTypeName") final String originalInventoryBucketTypeName,
            @GraphQLName("id") @GraphQLID final String id,
        ...
        try {
            ...
            var commandResult = InventoryUtil.getHome().editInventoryBucketType(BaseGraphQl.getUserVisitPK(env), commandForm);

            if(!commandResult.hasErrors()) {
                var executionResult = commandResult.getExecutionResult();
                var result = (EditInventoryBucketTypeResult)executionResult.getResult();
                Map<String, Object> arguments = env.getArgument("input");
                var edit = result.getEdit();

                mutationResultObject.setEntityInstance(result.getInventoryBucketType().getEntityInstance());
                ...
                commandResult = InventoryUtil.getHome().editInventoryBucketType(BaseGraphQl.getUserVisitPK(env), commandForm);
            }
    ...
    @GraphQLField
    @GraphQLRelayMutation
    static MutationResultObject deleteInventoryBucketType(final DataFetchingEnvironment env,
            @GraphQLName("inventoryBucketTypeName") final String inventoryBucketTypeName,
            @GraphQLName("id") @GraphQLID final String id) {
        var mutationResultObject = new MutationResultObject();
        ...
        try {
            ...
            mutationResultObject.setCommandResult(InventoryUtil.getHome().deleteInventoryBucketType(BaseGraphQl.getUserVisitPK(env), commandForm));
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    @GraphQLField
    @GraphQLRelayMutation
    static MutationResultWithIdObject createInventoryTransactionTimeType(final DataFetchingEnvironment env,
            @GraphQLName("inventoryTransactionTypeName") @GraphQLNonNull final String inventoryTransactionTypeName,
            @GraphQLName("inventoryTransactionTimeTypeName") @GraphQLNonNull final String inventoryTransactionTimeTypeName,
            @GraphQLName("isDefault") @GraphQLNonNull final String isDefault,
            @GraphQLName("sortOrder") @GraphQLNonNull final String sortOrder,
            @GraphQLName("description") final String description) {
        var mutationResultObject = new MutationResultWithIdObject();
        ...
        try {
            var commandForm = InventoryUtil.getHome().getCreateInventoryTransactionTimeTypeForm();
            ...
            var commandResult = InventoryUtil.getHome().createInventoryTransactionTimeType(BaseGraphQl.getUserVisitPK(env), commandForm);
            mutationResultObject.setCommandResult(commandResult);

            if(!commandResult.hasErrors()) {
                var result = (CreateInventoryTransactionTimeTypeResult)commandResult.getExecutionResult().getResult();
    ...
    @GraphQLField
    @GraphQLRelayMutation
    static MutationResultWithIdObject editInventoryTransactionTimeType(final DataFetchingEnvironment env,
            @GraphQLName("inventoryTransactionTypeName") final String inventoryTransactionTypeName,
            @GraphQLName("originalInventoryTransactionTimeTypeName") final String originalInventoryTransactionTimeTypeName,
            @GraphQLName("id") @GraphQLID final String id,
        ...
        try {
            var spec = InventoryUtil.getHome().getInventoryTransactionTimeTypeUniversalSpec();

            spec.setInventoryTransactionTypeName(inventoryTransactionTypeName);
            spec.setInventoryTransactionTimeTypeName(originalInventoryTransactionTimeTypeName);
            spec.setUuid(id);
            ...
            var commandResult = InventoryUtil.getHome().editInventoryTransactionTimeType(BaseGraphQl.getUserVisitPK(env), commandForm);

            if(!commandResult.hasErrors()) {
                var executionResult = commandResult.getExecutionResult();
                var result = (EditInventoryTransactionTimeTypeResult)executionResult.getResult();
                Map<String, Object> arguments = env.getArgument("input");
                var edit = result.getEdit();

                mutationResultObject.setEntityInstance(result.getInventoryTransactionTimeType().getEntityInstance());

                if(arguments.containsKey("inventoryTransactionTimeTypeName"))
                    edit.setInventoryTransactionTimeTypeName(inventoryTransactionTimeTypeName);
                if(arguments.containsKey("isDefault"))
                    edit.setIsDefault(isDefault);
                if(arguments.containsKey("sortOrder"))
                    edit.setSortOrder(sortOrder);
                ...
                commandResult = InventoryUtil.getHome().editInventoryTransactionTimeType(BaseGraphQl.getUserVisitPK(env), commandForm);
            }
    ...
    @GraphQLField
    @GraphQLRelayMutation
    static MutationResultObject deleteInventoryTransactionTimeType(final DataFetchingEnvironment env,
            @GraphQLName("inventoryTransactionTypeName") final String inventoryTransactionTypeName,
            @GraphQLName("inventoryTransactionTimeTypeName") final String inventoryTransactionTimeTypeName,
            @GraphQLName("id") @GraphQLID final String id) {
        var mutationResultObject = new MutationResultObject();
        ...
        try {
            var commandForm = InventoryUtil.getHome().getDeleteInventoryTransactionTimeTypeForm();

            commandForm.setInventoryTransactionTypeName(inventoryTransactionTypeName);
            commandForm.setInventoryTransactionTimeTypeName(inventoryTransactionTimeTypeName);
            commandForm.setUuid(id);

            mutationResultObject.setCommandResult(InventoryUtil.getHome().deleteInventoryTransactionTimeType(BaseGraphQl.getUserVisitPK(env),
                    commandForm));
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    @GraphQLField
    @GraphQLRelayMutation
    static MutationResultWithIdObject createInventoryDisposition(final DataFetchingEnvironment env,
            @GraphQLName("inventoryTransactionTypeName") @GraphQLNonNull final String inventoryTransactionTypeName,
        ...
        try {
            var commandForm = InventoryUtil.getHome().getCreateInventoryDispositionForm();
            ...
            var commandResult = InventoryUtil.getHome().createInventoryDisposition(BaseGraphQl.getUserVisitPK(env), commandForm);
            mutationResultObject.setCommandResult(commandResult);

            if(!commandResult.hasErrors()) {
                var result = (CreateInventoryDispositionResult)commandResult.getExecutionResult().getResult();
    ...
    @GraphQLField
    @GraphQLRelayMutation
    static MutationResultWithIdObject editInventoryDisposition(final DataFetchingEnvironment env,
            @GraphQLName("inventoryTransactionTypeName") final String inventoryTransactionTypeName,
            @GraphQLName("originalInventoryDispositionName") final String originalInventoryDispositionName,
            @GraphQLName("id") @GraphQLID final String id,
        ...
        try {
            var spec = InventoryUtil.getHome().getInventoryDispositionUniversalSpec();

            spec.setInventoryTransactionTypeName(inventoryTransactionTypeName);
            spec.setInventoryDispositionName(originalInventoryDispositionName);
            spec.setUuid(id);
            ...
            var commandResult = InventoryUtil.getHome().editInventoryDisposition(BaseGraphQl.getUserVisitPK(env), commandForm);

            if(!commandResult.hasErrors()) {
                var executionResult = commandResult.getExecutionResult();
                var result = (EditInventoryDispositionResult)executionResult.getResult();
                Map<String, Object> arguments = env.getArgument("input");
                var edit = result.getEdit();

                mutationResultObject.setEntityInstance(result.getInventoryDisposition().getEntityInstance());
                ...
                commandResult = InventoryUtil.getHome().editInventoryDisposition(BaseGraphQl.getUserVisitPK(env), commandForm);
            }
    ...
    @GraphQLField
    @GraphQLRelayMutation
    static MutationResultObject deleteInventoryDisposition(final DataFetchingEnvironment env,
            @GraphQLName("inventoryTransactionTypeName") final String inventoryTransactionTypeName,
            @GraphQLName("inventoryDispositionName") final String inventoryDispositionName,
            @GraphQLName("id") @GraphQLID final String id) {
        var mutationResultObject = new MutationResultObject();
        ...
        try {
            var commandForm = InventoryUtil.getHome().getDeleteInventoryDispositionForm();
    ...
    @GraphQLField
    @GraphQLRelayMutation
    static MutationResultWithIdObject createInventoryTransactionRoleType(final DataFetchingEnvironment env,
            @GraphQLName("inventoryTransactionTypeName") @GraphQLNonNull final String inventoryTransactionTypeName,
            @GraphQLName("inventoryTransactionRoleTypeName") @GraphQLNonNull final String inventoryTransactionRoleTypeName,
            @GraphQLName("isDefault") @GraphQLNonNull final String isDefault,
            @GraphQLName("sortOrder") @GraphQLNonNull final String sortOrder,
            @GraphQLName("description") final String description) {
        var mutationResultObject = new MutationResultWithIdObject();
        ...
        try {
            var commandForm = InventoryUtil.getHome().getCreateInventoryTransactionRoleTypeForm();
            ...
            var commandResult = InventoryUtil.getHome().createInventoryTransactionRoleType(BaseGraphQl.getUserVisitPK(env), commandForm);
            mutationResultObject.setCommandResult(commandResult);

            if(!commandResult.hasErrors()) {
                var result = (CreateInventoryTransactionRoleTypeResult)commandResult.getExecutionResult().getResult();
    ...
    @GraphQLField
    @GraphQLRelayMutation
    static MutationResultWithIdObject editInventoryTransactionRoleType(final DataFetchingEnvironment env,
            @GraphQLName("inventoryTransactionTypeName") final String inventoryTransactionTypeName,
            @GraphQLName("originalInventoryTransactionRoleTypeName") final String originalInventoryTransactionRoleTypeName,
            @GraphQLName("id") @GraphQLID final String id,
        ...
        try {
            var spec = InventoryUtil.getHome().getInventoryTransactionRoleTypeUniversalSpec();

            spec.setInventoryTransactionTypeName(inventoryTransactionTypeName);
            spec.setInventoryTransactionRoleTypeName(originalInventoryTransactionRoleTypeName);
            spec.setUuid(id);
            ...
            var commandResult = InventoryUtil.getHome().editInventoryTransactionRoleType(BaseGraphQl.getUserVisitPK(env), commandForm);

            if(!commandResult.hasErrors()) {
                var executionResult = commandResult.getExecutionResult();
                var result = (EditInventoryTransactionRoleTypeResult)executionResult.getResult();
                Map<String, Object> arguments = env.getArgument("input");
                var edit = result.getEdit();

                mutationResultObject.setEntityInstance(result.getInventoryTransactionRoleType().getEntityInstance());

                if(arguments.containsKey("inventoryTransactionRoleTypeName"))
                    edit.setInventoryTransactionRoleTypeName(inventoryTransactionRoleTypeName);
                if(arguments.containsKey("isDefault"))
                    edit.setIsDefault(isDefault);
                if(arguments.containsKey("sortOrder"))
                    edit.setSortOrder(sortOrder);
                ...
                commandResult = InventoryUtil.getHome().editInventoryTransactionRoleType(BaseGraphQl.getUserVisitPK(env), commandForm);
            }
    ...
    @GraphQLField
    @GraphQLRelayMutation
    static MutationResultObject deleteInventoryTransactionRoleType(final DataFetchingEnvironment env,
            @GraphQLName("inventoryTransactionTypeName") final String inventoryTransactionTypeName,
            @GraphQLName("inventoryTransactionRoleTypeName") final String inventoryTransactionRoleTypeName,
            @GraphQLName("id") @GraphQLID final String id) {
        var mutationResultObject = new MutationResultObject();
        ...
        try {
            var commandForm = InventoryUtil.getHome().getDeleteInventoryTransactionRoleTypeForm();

            commandForm.setInventoryTransactionTypeName(inventoryTransactionTypeName);
            commandForm.setInventoryTransactionRoleTypeName(inventoryTransactionRoleTypeName);
            commandForm.setUuid(id);

            mutationResultObject.setCommandResult(InventoryUtil.getHome().deleteInventoryTransactionRoleType(BaseGraphQl.getUserVisitPK(env),
                    commandForm));
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    @GraphQLField
    @GraphQLRelayMutation
    static MutationResultObject createInventoryLocation(final DataFetchingEnvironment env,
            @GraphQLName("partyName") final String partyName,
            @GraphQLName("warehouseName") final String warehouseName,
            @GraphQLName("locationName") @GraphQLNonNull final String locationName,
            @GraphQLName("ownerPartyName") @GraphQLNonNull final String ownerPartyName,
            @GraphQLName("itemName") @GraphQLNonNull final String itemName,
            @GraphQLName("unitOfMeasureTypeName") @GraphQLNonNull final String unitOfMeasureTypeName,
            @GraphQLName("inventoryConditionName") @GraphQLNonNull final String inventoryConditionName) {
        var mutationResultObject = new MutationResultObject();
        ...
        try {
            var commandForm = InventoryUtil.getHome().getCreateInventoryLocationForm();
            ...
            mutationResultObject.setCommandResult(InventoryUtil.getHome().createInventoryLocation(
                    BaseGraphQl.getUserVisitPK(env), commandForm));
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    @GraphQLField
    @GraphQLRelayMutation
    static MutationResultObject deleteInventoryLocation(final DataFetchingEnvironment env,
            @GraphQLName("partyName") final String partyName,
            @GraphQLName("warehouseName") final String warehouseName,
            @GraphQLName("locationName") @GraphQLNonNull final String locationName,
            @GraphQLName("itemName") @GraphQLNonNull final String itemName) {
        ...
        try {
            var commandForm = InventoryUtil.getHome().getDeleteInventoryLocationForm();
            ...
            mutationResultObject.setCommandResult(InventoryUtil.getHome().deleteInventoryLocation(
                    BaseGraphQl.getUserVisitPK(env), commandForm));
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
