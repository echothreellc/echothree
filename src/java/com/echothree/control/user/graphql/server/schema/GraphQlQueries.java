...
import com.echothree.control.user.inventory.server.command.GetInventoryLayerBucketCommand;
import com.echothree.control.user.inventory.server.command.GetInventoryLayerBucketsCommand;
...
import com.echothree.model.control.campaign.server.graphql.CampaignSourceObject;
...
import com.echothree.model.control.filter.server.graphql.FilterStepDestinationObject;
import com.echothree.model.control.filter.server.graphql.FilterStepElementObject;
...
import com.echothree.model.control.inventory.server.graphql.InventoryLayerBucketObject;
...
import com.echothree.model.control.subscription.server.graphql.SubscriptionTypeObject;
...
import com.echothree.model.data.campaign.common.CampaignSourceConstants;
...
import com.echothree.model.data.subscription.common.SubscriptionTypeConstants;
...
public interface GraphQlQueries {
    ...
    static SearchKindObject searchKind(final DataFetchingEnvironment env,
        ...
        try {
            ...
            searchKind = CDI.current().select(GetSearchKindCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
    ...
    static CountingPaginatedData<SearchKindObject> searchKinds(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            try(var objectLimiter = new ObjectLimiter(env, SearchKindConstants.COMPONENT_VENDOR_NAME, SearchKindConstants.ENTITY_TYPE_NAME, totalCount)) {
                ...
                var entities = CDI.current().select(GetSearchKindsCommand.class).get().getEntitiesForGraphQl(getUserVisitPK(env), commandForm);
    ...
    static SearchTypeObject searchType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            searchType = CDI.current().select(GetSearchTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<SearchTypeObject> searchTypes(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetSearchTypesCommand.class).get();
    ...
    static SearchSortOrderObject searchSortOrder(final DataFetchingEnvironment env,
        ...
        try {
            ...
            searchSortOrder = CDI.current().select(GetSearchSortOrderCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<SearchSortOrderObject> searchSortOrders(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetSearchSortOrdersCommand.class).get();
    ...
    static SearchUseTypeObject searchUseType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            searchUseType = CDI.current().select(GetSearchUseTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<SearchUseTypeObject> searchUseTypes(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            try(var objectLimiter = new ObjectLimiter(env, SearchUseTypeConstants.COMPONENT_VENDOR_NAME, SearchUseTypeConstants.ENTITY_TYPE_NAME, totalCount)) {
                ...
                var entities = CDI.current().select(GetSearchUseTypesCommand.class).get().getEntitiesForGraphQl(getUserVisitPK(env), commandForm);
    ...
    static SearchDefaultOperatorObject searchDefaultOperator(final DataFetchingEnvironment env,
        ...
        try {
            ...
            searchDefaultOperator = CDI.current().select(GetSearchDefaultOperatorCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<SearchDefaultOperatorObject> searchDefaultOperators(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            try(var objectLimiter = new ObjectLimiter(env, SearchDefaultOperatorConstants.COMPONENT_VENDOR_NAME, SearchDefaultOperatorConstants.ENTITY_TYPE_NAME, totalCount)) {
                ...
                var entities = CDI.current().select(GetSearchDefaultOperatorsCommand.class).get().getEntitiesForGraphQl(getUserVisitPK(env), commandForm);
    ...
    static SearchSortDirectionObject searchSortDirection(final DataFetchingEnvironment env,
        ...
        try {
            ...
            searchSortDirection = CDI.current().select(GetSearchSortDirectionCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<SearchSortDirectionObject> searchSortDirections(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            try(var objectLimiter = new ObjectLimiter(env, SearchSortDirectionConstants.COMPONENT_VENDOR_NAME, SearchSortDirectionConstants.ENTITY_TYPE_NAME, totalCount)) {
                ...
                var entities = CDI.current().select(GetSearchSortDirectionsCommand.class).get().getEntitiesForGraphQl(getUserVisitPK(env), commandForm);
    ...
    static SearchResultActionTypeObject searchResultActionType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            searchResultActionType = CDI.current().select(GetSearchResultActionTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<SearchResultActionTypeObject> searchResultActionTypes(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetSearchResultActionTypesCommand.class).get();
    ...
    static SearchCheckSpellingActionTypeObject searchCheckSpellingActionType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            searchCheckSpellingActionType = CDI.current().select(GetSearchCheckSpellingActionTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<SearchCheckSpellingActionTypeObject> searchCheckSpellingActionTypes(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetSearchCheckSpellingActionTypesCommand.class).get();
    ...
    static WorkflowObject workflow(final DataFetchingEnvironment env,
        ...
        try {
            ...
            workflow = CDI.current().select(GetWorkflowCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<WorkflowObject> workflows(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetWorkflowsCommand.class).get();
    ...
    static WorkflowEntityTypeObject workflowEntityType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            workflowEntityType = CDI.current().select(GetWorkflowEntityTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<WorkflowEntityTypeObject> workflowEntityTypes(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetWorkflowEntityTypesCommand.class).get();
    ...
    static WorkflowSelectorKindObject workflowSelectorKind(final DataFetchingEnvironment env,
        ...
        try {
            ...
            workflowSelectorKind = CDI.current().select(GetWorkflowSelectorKindCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<WorkflowEntityStatusObject> workflowEntityStatuses(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetWorkflowEntityStatusesCommand.class).get();
    ...
    static WorkflowStepObject workflowStep(final DataFetchingEnvironment env,
        ...
        try {
            ...
            workflowStep = CDI.current().select(GetWorkflowStepCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<WorkflowStepObject> workflowSteps(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetWorkflowStepsCommand.class).get();
    ...
    static WorkflowDestinationObject workflowDestination(final DataFetchingEnvironment env,
        ...
        try {
            ...
            workflowDestination = CDI.current().select(GetWorkflowDestinationCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<WorkflowDestinationObject> workflowDestinations(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetWorkflowDestinationsCommand.class).get();
    ...
    static WorkflowDestinationStepObject workflowDestinationStep(final DataFetchingEnvironment env,
        ...
        try {
            ...
            workflowDestinationStep = CDI.current().select(GetWorkflowDestinationStepCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<WorkflowDestinationStepObject> workflowDestinationSteps(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetWorkflowDestinationStepsCommand.class).get();
    ...
    static WorkflowDestinationPartyTypeObject workflowDestinationPartyType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            workflowDestinationPartyType = CDI.current().select(GetWorkflowDestinationPartyTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<WorkflowDestinationPartyTypeObject> workflowDestinationPartyTypes(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetWorkflowDestinationPartyTypesCommand.class).get();
    ...
    static WorkflowDestinationSecurityRoleObject workflowDestinationSecurityRole(final DataFetchingEnvironment env,
        ...
        try {
            ...
            workflowDestinationSecurityRole = CDI.current().select(GetWorkflowDestinationSecurityRoleCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<WorkflowDestinationSecurityRoleObject> workflowDestinationSecurityRoles(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetWorkflowDestinationSecurityRolesCommand.class).get();
    ...
    static WorkflowDestinationSelectorObject workflowDestinationSelector(final DataFetchingEnvironment env,
        ...
        try {
            ...
            workflowDestinationSelector = CDI.current().select(GetWorkflowDestinationSelectorCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static WorkflowEntranceObject workflowEntrance(final DataFetchingEnvironment env,
        ...
        try {
            ...
            workflowEntrance = CDI.current().select(GetWorkflowEntranceCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<WorkflowEntranceObject> workflowEntrances(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetWorkflowEntrancesCommand.class).get();
    ...
    static WorkflowEntranceStepObject workflowEntranceStep(final DataFetchingEnvironment env,
        ...
        try {
            ...
            workflowEntranceStep = CDI.current().select(GetWorkflowEntranceStepCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<WorkflowEntranceStepObject> workflowEntranceSteps(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetWorkflowEntranceStepsCommand.class).get();
    ...
    static WorkflowEntrancePartyTypeObject workflowEntrancePartyType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            workflowEntrancePartyType = CDI.current().select(GetWorkflowEntrancePartyTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<WorkflowEntrancePartyTypeObject> workflowEntrancePartyTypes(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetWorkflowEntrancePartyTypesCommand.class).get();
    ...
    static WorkflowEntranceSecurityRoleObject workflowEntranceSecurityRole(final DataFetchingEnvironment env,
        ...
        try {
            ...
            workflowEntranceSecurityRole = CDI.current().select(GetWorkflowEntranceSecurityRoleCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<WorkflowEntranceSecurityRoleObject> workflowEntranceSecurityRoles(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetWorkflowEntranceSecurityRolesCommand.class).get();
    ...
    static WorkflowEntranceSelectorObject workflowEntranceSelector(final DataFetchingEnvironment env,
        ...
        try {
            ...
            workflowEntranceSelector = CDI.current().select(GetWorkflowEntranceSelectorCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static WorkflowStepTypeObject workflowStepType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            workflowStepType = CDI.current().select(GetWorkflowStepTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<WorkflowStepTypeObject> workflowStepTypes(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetWorkflowStepTypesCommand.class).get();
    ...
    static SequenceObject sequence(final DataFetchingEnvironment env,
        ...
        try {
            ...
            sequence = CDI.current().select(GetSequenceCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static SequenceTypeObject sequenceType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            sequenceType = CDI.current().select(GetSequenceTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<SequenceTypeObject> sequenceTypes(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetSequenceTypesCommand.class).get();
    ...
    static SequenceChecksumTypeObject sequenceChecksumType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            sequenceChecksumType = CDI.current().select(GetSequenceChecksumTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<SequenceChecksumTypeObject> sequenceChecksumTypes(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetSequenceChecksumTypesCommand.class).get();
    ...
    static SequenceEncoderTypeObject sequenceEncoderType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            sequenceEncoderType = CDI.current().select(GetSequenceEncoderTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<SequenceEncoderTypeObject> sequenceEncoderTypes(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetSequenceEncoderTypesCommand.class).get();
    ...
    static SelectorKindObject selectorKind(final DataFetchingEnvironment env,
        ...
        try {
            ...
            selectorKind = CDI.current().select(GetSelectorKindCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<SelectorKindObject> selectorKinds(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetSelectorKindsCommand.class).get();
    ...
    static SelectorTypeObject selectorType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            selectorType = CDI.current().select(GetSelectorTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static SelectorObject selector(final DataFetchingEnvironment env,
        ...
        try {
            ...
            selector = CDI.current().select(GetSelectorCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static Collection<SelectorObject> selectors(final DataFetchingEnvironment env,
        ...
        try {
            ...
            selectors = CDI.current().select(GetSelectorsCommand.class).get().getEntitiesForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static FilterKindObject filterKind(final DataFetchingEnvironment env,
        ...
        try {
            ...
            filterKind = CDI.current().select(GetFilterKindCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<FilterKindObject> filterKinds(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetFilterKindsCommand.class).get();
    ...
    static FilterTypeObject filterType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            filterType = CDI.current().select(GetFilterTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static FilterObject filter(final DataFetchingEnvironment env,
        ...
        try {
            ...
            filter = CDI.current().select(GetFilterCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static FilterStepObject filterStep(final DataFetchingEnvironment env,
        ...
        try {
            ...
            filterStep = CDI.current().select(GetFilterStepCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static FilterStepElementObject filterStepElement(final DataFetchingEnvironment env,
            @GraphQLName("filterKindName") final String filterKindName,
            @GraphQLName("filterTypeName") final String filterTypeName,
            @GraphQLName("filterName") final String filterName,
            @GraphQLName("filterStepName") final String filterStepName,
        ...
        try {
            ...
            filterStepElement = CDI.current().select(GetFilterStepElementCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }

        return filterStepElement == null ? null : new FilterStepElementObject(filterStepElement);
    }

    @GraphQLField
    @GraphQLName("filterStepElements")
    @GraphQLNonNull
    @GraphQLConnection(connectionFetcher = CountingDataConnectionFetcher.class)
    static CountingPaginatedData<FilterStepElementObject> filterStepElements(final DataFetchingEnvironment env,
            @GraphQLName("filterKindName") @GraphQLNonNull final String filterKindName,
            @GraphQLName("filterTypeName") @GraphQLNonNull final String filterTypeName,
            @GraphQLName("filterName") @GraphQLNonNull final String filterName,
            @GraphQLName("filterStepName") @GraphQLNonNull final String filterStepName) {
        CountingPaginatedData<FilterStepElementObject> data;

        try {
            var commandForm = FilterUtil.getHome().getGetFilterStepElementsForm();
            var command = CDI.current().select(GetFilterStepElementsCommand.class).get();
            ...
            if(totalEntities == null) {
                ...
                try(var objectLimiter = new ObjectLimiter(env, FilterStepElementConstants.COMPONENT_VENDOR_NAME, FilterStepElementConstants.ENTITY_TYPE_NAME, totalEntities)) {
                    var entities = command.getEntitiesForGraphQl(getUserVisitPK(env), commandForm);

                    var filterStepElements = entities.stream()
                            .map(FilterStepElementObject::new)
                            .collect(Collectors.toCollection(() -> new ArrayList<>(entities.size())));

                    data = new CountedObjects<>(objectLimiter, filterStepElements);
                }
            }
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
    ...
    static FilterStepDestinationObject filterStepDestination(final DataFetchingEnvironment env,
            @GraphQLName("filterKindName") @GraphQLNonNull final String filterKindName,
            @GraphQLName("filterTypeName") @GraphQLNonNull final String filterTypeName,
            @GraphQLName("filterName") @GraphQLNonNull final String filterName,
        ...
        try {
            var commandForm = FilterUtil.getHome().getGetFilterStepDestinationForm();
            ...
            filterStepDestination = CDI.current().select(GetFilterStepDestinationCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }

        return filterStepDestination == null ? null : new FilterStepDestinationObject(filterStepDestination);
    }

    @GraphQLField
    @GraphQLName("filterStepDestinations")
    @GraphQLNonNull
    @GraphQLConnection(connectionFetcher = CountingDataConnectionFetcher.class)
    static CountingPaginatedData<FilterStepDestinationObject> filterStepDestinations(final DataFetchingEnvironment env,
            @GraphQLName("filterKindName") @GraphQLNonNull final String filterKindName,
            @GraphQLName("filterTypeName") @GraphQLNonNull final String filterTypeName,
            @GraphQLName("filterName") @GraphQLNonNull final String filterName,
            @GraphQLName("fromFilterStepName") final String fromFilterStepName,
            @GraphQLName("toFilterStepName") final String toFilterStepName) {
        CountingPaginatedData<FilterStepDestinationObject> data;

        try {
            var commandForm = FilterUtil.getHome().getGetFilterStepDestinationsForm();
            var command = CDI.current().select(GetFilterStepDestinationsCommand.class).get();
            ...
            if(totalEntities == null) {
                ...
                try(var objectLimiter = new ObjectLimiter(env, FilterStepDestinationConstants.COMPONENT_VENDOR_NAME, FilterStepDestinationConstants.ENTITY_TYPE_NAME, totalEntities)) {
                    var entities = command.getEntitiesForGraphQl(getUserVisitPK(env), commandForm);

                    var filterStepDestinations = entities.stream()
                            .map(FilterStepDestinationObject::new)
                            .collect(Collectors.toCollection(() -> new ArrayList<>(entities.size())));

                    data = new CountedObjects<>(objectLimiter, filterStepDestinations);
                }
            }
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
    ...
    static FilterAdjustmentSourceObject filterAdjustmentSource(final DataFetchingEnvironment env,
        ...
        try {
            ...
            filterAdjustmentSource = CDI.current().select(GetFilterAdjustmentSourceCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static FilterAdjustmentTypeObject filterAdjustmentType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            filterAdjustmentType = CDI.current().select(GetFilterAdjustmentTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static FilterAdjustmentObject filterAdjustment(final DataFetchingEnvironment env,
        ...
        try {
            ...
            filterAdjustment = CDI.current().select(GetFilterAdjustmentCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static Collection<FilterAdjustmentObject> filterAdjustments(final DataFetchingEnvironment env,
        ...
        try {
            ...
            filterAdjustments = CDI.current().select(GetFilterAdjustmentsCommand.class).get().getEntitiesForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static FilterAdjustmentAmountObject filterAdjustmentAmount(final DataFetchingEnvironment env,
        ...
        try {
            ...
            filterAdjustmentAmount = CDI.current().select(GetFilterAdjustmentAmountCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static Collection<FilterAdjustmentAmountObject> filterAdjustmentAmounts(final DataFetchingEnvironment env,
        ...
        try {
            ...
            filterAdjustmentAmounts = CDI.current().select(GetFilterAdjustmentAmountsCommand.class).get().getEntitiesForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static FilterAdjustmentFixedAmountObject filterAdjustmentFixedAmount(final DataFetchingEnvironment env,
        ...
        try {
            ...
            filterAdjustmentFixedAmount = CDI.current().select(GetFilterAdjustmentFixedAmountCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static Collection<FilterAdjustmentFixedAmountObject> filterAdjustmentFixedAmounts(final DataFetchingEnvironment env,
        ...
        try {
            ...
            filterAdjustmentFixedAmounts = CDI.current().select(GetFilterAdjustmentFixedAmountsCommand.class).get().getEntitiesForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static FilterAdjustmentPercentObject filterAdjustmentPercent(final DataFetchingEnvironment env,
        ...
        try {
            ...
            filterAdjustmentPercent = CDI.current().select(GetFilterAdjustmentPercentCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static Collection<FilterAdjustmentPercentObject> filterAdjustmentPercents(final DataFetchingEnvironment env,
        ...
        try {
            ...
            filterAdjustmentPercents = CDI.current().select(GetFilterAdjustmentPercentsCommand.class).get().getEntitiesForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static OfferUseObject offerUse(final DataFetchingEnvironment env,
        ...
        try {
            ...
            offerUse = CDI.current().select(GetOfferUseCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static OfferObject offer(final DataFetchingEnvironment env,
        ...
        try {
            ...
            offer = CDI.current().select(GetOfferCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<OfferObject> offers(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetOffersCommand.class).get();
    ...
    static OfferItemObject offerItem(final DataFetchingEnvironment env,
        ...
        try {
            ...
            offerItem = CDI.current().select(GetOfferItemCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static OfferItemPriceObject offerItemPrice(final DataFetchingEnvironment env,
        ...
        try {
            ...
            offerItemPrice = CDI.current().select(GetOfferItemPriceCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static UseObject use(final DataFetchingEnvironment env,
        ...
        try {
            ...
            use = CDI.current().select(GetUseCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<UseObject> uses(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetUsesCommand.class).get();
    ...
    static OfferNameElementObject offerNameElement(final DataFetchingEnvironment env,
        ...
        try {
            ...
            offerNameElement = CDI.current().select(GetOfferNameElementCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static UseNameElementObject useNameElement(final DataFetchingEnvironment env,
        ...
        try {
            ...
            useNameElement = CDI.current().select(GetUseNameElementCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static UseTypeObject useType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            useType = CDI.current().select(GetUseTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<UseTypeObject> useTypes(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetUseTypesCommand.class).get();
    ...
    static FreeOnBoardObject freeOnBoard(final DataFetchingEnvironment env,
        ...
        try {
            ...
            freeOnBoard = CDI.current().select(GetFreeOnBoardCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<FreeOnBoardObject> freeOnBoards(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetFreeOnBoardsCommand.class).get();
    ...
    static PaymentProcessorTypeCodeTypeObject paymentProcessorTypeCodeType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            paymentProcessorTypeCodeType = CDI.current().select(GetPaymentProcessorTypeCodeTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static PaymentProcessorTypeCodeObject paymentProcessorTypeCode(final DataFetchingEnvironment env,
        ...
        try {
            ...
            paymentProcessorTypeCode = CDI.current().select(GetPaymentProcessorTypeCodeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static PaymentProcessorTransactionObject paymentProcessorTransaction(final DataFetchingEnvironment env,
        ...
        try {
            ...
            paymentProcessorTransaction = CDI.current().select(GetPaymentProcessorTransactionCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static PaymentProcessorObject paymentProcessor(final DataFetchingEnvironment env,
        ...
        try {
            ...
            paymentProcessor = CDI.current().select(GetPaymentProcessorCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static PaymentProcessorTypeObject paymentProcessorType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            paymentProcessorType = CDI.current().select(GetPaymentProcessorTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static PaymentMethodTypeObject paymentMethodType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            paymentMethodType = CDI.current().select(GetPaymentMethodTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static PaymentProcessorResultCodeObject paymentProcessorResultCode(final DataFetchingEnvironment env,
        ...
        try {
            ...
            paymentProcessorResultCode = CDI.current().select(GetPaymentProcessorResultCodeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    @GraphQLNonNull
    @GraphQLConnection(connectionFetcher = CountingDataConnectionFetcher.class)
    static CountingPaginatedData<PaymentProcessorResultCodeObject> paymentProcessorResultCodes(final DataFetchingEnvironment env) {
        CountingPaginatedData<PaymentProcessorResultCodeObject> data;

        try {
            var commandForm = PaymentUtil.getHome().getGetPaymentProcessorResultCodesForm();
            var command = CDI.current().select(GetPaymentProcessorResultCodesCommand.class).get();

            var totalEntities = command.getTotalEntitiesForGraphQl(getUserVisitPK(env), commandForm);
            if(totalEntities == null) {
                data = Connections.emptyConnection();
            } else {
                try(var objectLimiter = new ObjectLimiter(env, PaymentProcessorResultCodeConstants.COMPONENT_VENDOR_NAME, PaymentProcessorResultCodeConstants.ENTITY_TYPE_NAME, totalEntities)) {
                    var entities = command.getEntitiesForGraphQl(getUserVisitPK(env), commandForm);
    ...
    static PaymentProcessorActionTypeObject paymentProcessorActionType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            paymentProcessorActionType = CDI.current().select(GetPaymentProcessorActionTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    @GraphQLNonNull
    @GraphQLConnection(connectionFetcher = CountingDataConnectionFetcher.class)
    static CountingPaginatedData<PaymentProcessorActionTypeObject> paymentProcessorActionTypes(final DataFetchingEnvironment env) {
        CountingPaginatedData<PaymentProcessorActionTypeObject> data;

        try {
            var commandForm = PaymentUtil.getHome().getGetPaymentProcessorActionTypesForm();
            var command = CDI.current().select(GetPaymentProcessorActionTypesCommand.class).get();

            var totalEntities = command.getTotalEntitiesForGraphQl(getUserVisitPK(env), commandForm);
            if(totalEntities == null) {
                data = Connections.emptyConnection();
            } else {
                try(var objectLimiter = new ObjectLimiter(env, PaymentProcessorActionTypeConstants.COMPONENT_VENDOR_NAME, PaymentProcessorActionTypeConstants.ENTITY_TYPE_NAME, totalEntities)) {
                    var entities = command.getEntitiesForGraphQl(getUserVisitPK(env), commandForm);
                    var objects = entities.stream()
    ...
    static AppearanceObject appearance(final DataFetchingEnvironment env,
        ...
        try {
            ...
            appearance = CDI.current().select(GetAppearanceCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<AppearanceObject> appearances(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetAppearancesCommand.class).get();
    ...
    static EntityAliasTypeObject entityAliasType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            entityAliasType = CDI.current().select(GetEntityAliasTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<EntityAliasTypeObject> entityAliasTypes(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetEntityAliasTypesCommand.class).get();
    ...
    static EntityAliasObject entityAlias(final DataFetchingEnvironment env,
        ...
        try {
            ...
            entityAlias = CDI.current().select(GetEntityAliasCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<EntityAliasObject> entityAliases(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetEntityAliasesCommand.class).get();
    ...
    static EntityAttributeGroupObject entityAttributeGroup(final DataFetchingEnvironment env,
        ...
        try {
            ...
            entityAttributeGroup = CDI.current().select(GetEntityAttributeGroupCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<EntityAttributeGroupObject> entityAttributeGroups(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetEntityAttributeGroupsCommand.class).get();
    ...
    static EntityAttributeObject entityAttribute(final DataFetchingEnvironment env,
        ...
        try {
            ...
            entityAttribute = CDI.current().select(GetEntityAttributeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<EntityAttributeObject> entityAttributes(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetEntityAttributesCommand.class).get();
    ...
    static EntityAttributeEntityAttributeGroupObject entityAttributeEntityAttributeGroup(final DataFetchingEnvironment env,
        ...
        try {
            ...
            entityAttributeEntityAttributeGroup = CDI.current().select(GetEntityAttributeEntityAttributeGroupCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<EntityAttributeEntityAttributeGroupObject> entityAttributeEntityAttributeGroups(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetEntityAttributeEntityAttributeGroupsCommand.class).get();
    ...
    static EntityInstanceObject entityInstance(final DataFetchingEnvironment env,
        ...
        try {
            ...
            entityInstance = CDI.current().select(GetEntityInstanceCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<EntityInstanceObject> entityInstances(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetEntityInstancesCommand.class).get();
    ...
    static EntityTypeObject entityType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            entityType = CDI.current().select(GetEntityTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<EntityTypeObject> entityTypes(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetEntityTypesCommand.class).get();
    ...
    static ComponentVendorObject componentVendor(final DataFetchingEnvironment env,
        ...
        try {
            ...
            componentVendor = CDI.current().select(GetComponentVendorCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<ComponentVendorObject> componentVendors(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetComponentVendorsCommand.class).get();
    ...
    static InventoryConditionObject inventoryCondition(final DataFetchingEnvironment env,
        ...
        try {
            ...
            inventoryCondition = CDI.current().select(GetInventoryConditionCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<InventoryConditionObject> inventoryConditions(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetInventoryConditionsCommand.class).get();
    ...
    static AllocationPriorityObject allocationPriority(final DataFetchingEnvironment env,
        ...
        try {
            ...
            allocationPriority = CDI.current().select(GetAllocationPriorityCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<AllocationPriorityObject> allocationPriorities(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetAllocationPrioritiesCommand.class).get();
    ...
    static InventoryTransactionTypeObject inventoryTransactionType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            inventoryTransactionType = CDI.current().select(GetInventoryTransactionTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static InventoryAdjustmentTypeObject inventoryAdjustmentType(final DataFetchingEnvironment env,
        ...
        try {
            var commandForm = InventoryUtil.getHome().getGetInventoryAdjustmentTypeForm();

            commandForm.setInventoryAdjustmentTypeName(inventoryAdjustmentTypeName);
            commandForm.setUuid(id);

            inventoryAdjustmentType = CDI.current().select(GetInventoryAdjustmentTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }

        return inventoryAdjustmentType == null ? null : new InventoryAdjustmentTypeObject(inventoryAdjustmentType);
    }

    @GraphQLField
    @GraphQLName("inventoryAdjustmentTypes")
    @GraphQLNonNull
    @GraphQLConnection(connectionFetcher = CountingDataConnectionFetcher.class)
    static CountingPaginatedData<InventoryAdjustmentTypeObject> inventoryAdjustmentTypes(final DataFetchingEnvironment env) {
        CountingPaginatedData<InventoryAdjustmentTypeObject> data;

        try {
            var commandForm = InventoryUtil.getHome().getGetInventoryAdjustmentTypesForm();
            var command = CDI.current().select(GetInventoryAdjustmentTypesCommand.class).get();

            var totalEntities = command.getTotalEntitiesForGraphQl(getUserVisitPK(env), commandForm);
            if(totalEntities == null) {
                data = Connections.emptyConnection();
            } else {
                try(var objectLimiter = new ObjectLimiter(env, InventoryAdjustmentTypeConstants.COMPONENT_VENDOR_NAME, InventoryAdjustmentTypeConstants.ENTITY_TYPE_NAME, totalEntities)) {
                    var entities = command.getEntitiesForGraphQl(getUserVisitPK(env), commandForm);

                    var inventoryAdjustmentTypes = entities.stream()
                            .map(InventoryAdjustmentTypeObject::new)
                            .collect(Collectors.toCollection(() -> new ArrayList<>(entities.size())));
    ...
    static PartyBucketObject partyBucket(final DataFetchingEnvironment env,
            @GraphQLName("partyName") final String partyName,
        ...
        PartyBucket partyBucket;

        try {
            var commandForm = InventoryUtil.getHome().getGetPartyBucketForm();
            ...
            partyBucket = CDI.current().select(GetPartyBucketCommand.class).get()
                    .getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }

        return partyBucket == null ? null : new PartyBucketObject(partyBucket);
    }

    @GraphQLField
    @GraphQLName("partyBuckets")
    @GraphQLNonNull
    @GraphQLConnection(connectionFetcher = CountingDataConnectionFetcher.class)
    static CountingPaginatedData<PartyBucketObject> partyBuckets(final DataFetchingEnvironment env,
            @GraphQLName("partyName") final String partyName,
            @GraphQLName("companyName") final String companyName,
            @GraphQLName("warehouseName") final String warehouseName,
            @GraphQLName("itemName") final String itemName,
            ...
            @GraphQLName("inventoryConditionName") final String inventoryConditionName,
            @GraphQLName("inventoryBucketTypeName") final String inventoryBucketTypeName) {
        CountingPaginatedData<PartyBucketObject> data;

        try {
            var commandForm = InventoryUtil.getHome().getGetPartyBucketsForm();
            var command = CDI.current().select(GetPartyBucketsCommand.class).get();
            ...
            if(totalEntities == null) {
                ...
                try(var objectLimiter = new ObjectLimiter(env, PartyBucketConstants.COMPONENT_VENDOR_NAME,
                        PartyBucketConstants.ENTITY_TYPE_NAME, totalEntities)) {
                    var entities = command.getEntitiesForGraphQl(getUserVisitPK(env), commandForm);
                    var partyBuckets = entities.stream()
                            .map(PartyBucketObject::new)
                            .collect(Collectors.toCollection(() -> new ArrayList<>(entities.size())));
    ...
    static InventoryCostingPoolObject inventoryCostingPool(final DataFetchingEnvironment env,
        ...
        try {
            var commandForm = InventoryUtil.getHome().getGetInventoryCostingPoolForm();
        ...
        return inventoryCostingPool == null ? null : new InventoryCostingPoolObject(inventoryCostingPool);
    }

    @GraphQLField
    @GraphQLName("inventoryCostingPools")
    @GraphQLNonNull
    @GraphQLConnection(connectionFetcher = CountingDataConnectionFetcher.class)
    static CountingPaginatedData<InventoryCostingPoolObject> inventoryCostingPools(final DataFetchingEnvironment env,
            @GraphQLName("partyName") final String partyName,
            @GraphQLName("companyName") final String companyName,
            @GraphQLName("itemName") final String itemName,
            @GraphQLName("inventoryConditionName") final String inventoryConditionName) {
        CountingPaginatedData<InventoryCostingPoolObject> data;

        try {
            var commandForm = InventoryUtil.getHome().getGetInventoryCostingPoolsForm();
            var command = CDI.current().select(GetInventoryCostingPoolsCommand.class).get();
            ...
            if(totalEntities == null) {
                ...
                try(var objectLimiter = new ObjectLimiter(env, InventoryCostingPoolConstants.COMPONENT_VENDOR_NAME,
                        InventoryCostingPoolConstants.ENTITY_TYPE_NAME, totalEntities)) {
                    var entities = command.getEntitiesForGraphQl(getUserVisitPK(env), commandForm);
                    var inventoryCostingPools = entities.stream()
                            .map(InventoryCostingPoolObject::new)
                            .collect(Collectors.toCollection(() -> new ArrayList<>(entities.size())));

                    data = new CountedObjects<>(objectLimiter, inventoryCostingPools);
                }
            }
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
    ...
    static InventoryLayerObject inventoryLayer(final DataFetchingEnvironment env,
        ...
        try {
            var commandForm = InventoryUtil.getHome().getGetInventoryLayerForm();
        ...
        return inventoryLayer == null ? null : new InventoryLayerObject(inventoryLayer);
    }

    @GraphQLField
    @GraphQLName("inventoryLayers")
    @GraphQLNonNull
    @GraphQLConnection(connectionFetcher = CountingDataConnectionFetcher.class)
    static CountingPaginatedData<InventoryLayerObject> inventoryLayers(final DataFetchingEnvironment env,
            @GraphQLName("partyName") final String partyName,
            @GraphQLName("companyName") final String companyName,
            @GraphQLName("itemName") final String itemName,
            @GraphQLName("inventoryConditionName") final String inventoryConditionName,
            @GraphQLName("inventoryTransactionTypeName") final String inventoryTransactionTypeName,
            @GraphQLName("inventoryTransactionName") final String inventoryTransactionName,
            @GraphQLName("inventoryTransactionLineSequence") final String inventoryTransactionLineSequence) {
        CountingPaginatedData<InventoryLayerObject> data;

        try {
            var commandForm = InventoryUtil.getHome().getGetInventoryLayersForm();
            var command = CDI.current().select(GetInventoryLayersCommand.class).get();
            ...
            commandForm.setInventoryConditionName(inventoryConditionName);
            commandForm.setInventoryTransactionTypeName(inventoryTransactionTypeName);
            commandForm.setInventoryTransactionName(inventoryTransactionName);
            commandForm.setInventoryTransactionLineSequence(inventoryTransactionLineSequence);

            var totalEntities = command.getTotalEntitiesForGraphQl(getUserVisitPK(env), commandForm);
            if(totalEntities == null) {
                data = Connections.emptyConnection();
            } else {
                try(var objectLimiter = new ObjectLimiter(env, InventoryLayerConstants.COMPONENT_VENDOR_NAME,
                        InventoryLayerConstants.ENTITY_TYPE_NAME, totalEntities)) {
                    var entities = command.getEntitiesForGraphQl(getUserVisitPK(env), commandForm);
                    var inventoryLayers = entities.stream()
                            .map(InventoryLayerObject::new)
                            .collect(Collectors.toCollection(() -> new ArrayList<>(entities.size())));

                    data = new CountedObjects<>(objectLimiter, inventoryLayers);
                }
            }
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
    ...
    static LotObject lot(final DataFetchingEnvironment env,
        ...
        try {
            ...
            lot = CDI.current().select(GetLotCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<LotObject> lots(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetLotsCommand.class).get();
    ...
    static ContentPageLayoutObject contentPageLayout(final DataFetchingEnvironment env,
        ...
        try {
            ...
            contentPageLayout = CDI.current().select(GetContentPageLayoutCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<ContentPageLayoutObject> contentPageLayouts(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetContentPageLayoutsCommand.class).get();
    ...
    static ContentPageLayoutAreaObject contentPageLayoutArea(final DataFetchingEnvironment env,
        ...
        try {
            ...
            contentPageLayoutArea = CDI.current().select(GetContentPageLayoutAreaCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<ContentPageLayoutAreaObject> contentPageLayoutAreas(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetContentPageLayoutAreasCommand.class).get();
    ...
    static ContentPageAreaTypeObject contentPageAreaType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            contentPageAreaType = CDI.current().select(GetContentPageAreaTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<ContentPageAreaTypeObject> contentPageAreaTypes(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetContentPageAreaTypesCommand.class).get();
    ...
    static ContentWebAddressObject contentWebAddress(final DataFetchingEnvironment env,
        ...
        try {
            ...
            contentWebAddress = CDI.current().select(GetContentWebAddressCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<ContentWebAddressObject> contentWebAddresses(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetContentWebAddressesCommand.class).get();
    ...
    static ContentCollectionObject contentCollection(final DataFetchingEnvironment env,
        ...
        try {
            ...
            contentCollection = CDI.current().select(GetContentCollectionCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<ContentCollectionObject> contentCollections(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetContentCollectionsCommand.class).get();
    ...
    static ContentSectionObject contentSection(final DataFetchingEnvironment env,
        ...
        try {
            ...
            contentSection = CDI.current().select(GetContentSectionCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<ContentSectionObject> contentSections(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetContentSectionsCommand.class).get();
    ...
    static ContentPageObject contentPage(final DataFetchingEnvironment env,
        ...
        try {
            ...
            contentPage = CDI.current().select(GetContentPageCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<ContentPageObject> contentPages(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetContentPagesCommand.class).get();
    ...
    static ContentPageAreaObject contentPageArea(final DataFetchingEnvironment env,
        ...
        try {
            ...
            contentPageArea = CDI.current().select(GetContentPageAreaCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<ContentPageAreaObject> contentPageAreas(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetContentPageAreasCommand.class).get();
    ...
    static ContentCatalogObject contentCatalog(final DataFetchingEnvironment env,
        ...
        try {
            ...
            contentCatalog = CDI.current().select(GetContentCatalogCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<ContentCatalogObject> contentCatalogs(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetContentCatalogsCommand.class).get();
    ...
    static ContentCatalogItemObject contentCatalogItem(final DataFetchingEnvironment env,
        ...
        try {
            ...
            contentCatalogItem = CDI.current().select(GetContentCatalogItemCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<ContentCatalogItemObject> contentCatalogItems(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetContentCatalogItemsCommand.class).get();
    ...
    static ContentCategoryObject contentCategory(final DataFetchingEnvironment env,
        ...
        try {
            ...
            contentCategory = CDI.current().select(GetContentCategoryCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<ContentCategoryObject> contentCategories(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetContentCategoriesCommand.class).get();
    ...
    static ContentCategoryItemObject contentCategoryItem(final DataFetchingEnvironment env,
        ...
        try {
            ...
            contentCategoryItem = CDI.current().select(GetContentCategoryItemCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<ContentCategoryItemObject> contentCategoryItems(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetContentCategoryItemsCommand.class).get();
    ...
    static MimeTypeFileExtensionObject mimeTypeFileExtension(final DataFetchingEnvironment env,
        ...
        try {
            ...
            mimeTypeFileExtension = CDI.current().select(GetMimeTypeFileExtensionCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static MimeTypeUsageTypeObject mimeTypeUsageType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            mimeTypeUsageType = CDI.current().select(GetMimeTypeUsageTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static MimeTypeObject mimeType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            mimeType = CDI.current().select(GetMimeTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<MimeTypeObject> mimeTypes(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetMimeTypesCommand.class).get();
    ...
    static QueueTypeObject queueType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            queueType = CDI.current().select(GetQueueTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<QueueTypeObject> queueTypes(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetQueueTypesCommand.class).get();
    ...
    static UnitOfMeasureKindUseObject unitOfMeasureKindUse(final DataFetchingEnvironment env,
        ...
        try {
            ...
            unitOfMeasureKindUse = CDI.current().select(GetUnitOfMeasureKindUseCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static UnitOfMeasureTypeObject unitOfMeasureType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            unitOfMeasureType = CDI.current().select(GetUnitOfMeasureTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<UnitOfMeasureTypeObject> unitOfMeasureTypes(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetUnitOfMeasureTypesCommand.class).get();
    ...
    static UnitOfMeasureKindObject unitOfMeasureKind(final DataFetchingEnvironment env,
        ...
        try {
            ...
            unitOfMeasureKind = CDI.current().select(GetUnitOfMeasureKindCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<UnitOfMeasureKindObject> unitOfMeasureKinds(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetUnitOfMeasureKindsCommand.class).get();
    ...
    static UnitOfMeasureKindUseTypeObject unitOfMeasureKindUseType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            unitOfMeasureKindUseType = CDI.current().select(GetUnitOfMeasureKindUseTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static EntityAttributeTypeObject entityAttributeType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            entityAttributeType = CDI.current().select(GetEntityAttributeTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<EntityAttributeTypeObject> entityAttributeTypes(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetEntityAttributeTypesCommand.class).get();
    ...
    static ComponentVendorResultsObject componentVendorResults(final DataFetchingEnvironment env,
        ...
        try {
            ...
            if(CDI.current().select(GetComponentVendorResultsCommand.class).get().canQueryByGraphQl(getUserVisitPK(env), commandForm)) {
    ...
    static EntityTypeResultsObject entityTypeResults(final DataFetchingEnvironment env,
        ...
        try {
            ...
            if(CDI.current().select(GetEntityTypeResultsCommand.class).get().canQueryByGraphQl(getUserVisitPK(env), commandForm)) {
    ...
    static EntityAliasTypeResultsObject entityAliasTypeResults(final DataFetchingEnvironment env,
        ...
        try {
            ...
            if(CDI.current().select(GetEntityAliasTypeResultsCommand.class).get().canQueryByGraphQl(getUserVisitPK(env), commandForm)) {
    ...
    static EntityAttributeGroupResultsObject entityAttributeGroupResults(final DataFetchingEnvironment env,
        ...
        try {
            ...
            if(CDI.current().select(GetEntityAttributeGroupResultsCommand.class).get().canQueryByGraphQl(getUserVisitPK(env), commandForm)) {
    ...
    static EntityAttributeResultsObject entityAttributeResults(final DataFetchingEnvironment env,
        ...
        try {
            ...
            if(CDI.current().select(GetEntityAttributeResultsCommand.class).get().canQueryByGraphQl(getUserVisitPK(env), commandForm)) {
    ...
    static EntityListItemResultsObject entityListItemResults(final DataFetchingEnvironment env,
        ...
        try {
            ...
            if(CDI.current().select(GetEntityListItemResultsCommand.class).get().canQueryByGraphQl(getUserVisitPK(env), commandForm)) {
    ...
    static CustomerResultsObject customerResults(final DataFetchingEnvironment env,
        ...
        try {
            ...
            if(CDI.current().select(GetCustomerResultsCommand.class).get().canQueryByGraphQl(getUserVisitPK(env), commandForm)) {
    ...
    static EmployeeResultsObject employeeResults(final DataFetchingEnvironment env,
        ...
        try {
            ...
            if(CDI.current().select(GetEmployeeResultsCommand.class).get().canQueryByGraphQl(getUserVisitPK(env), commandForm)) {
    ...
    static ItemResultsObject itemResults(final DataFetchingEnvironment env,
        ...
        try {
            ...
            if(CDI.current().select(GetItemResultsCommand.class).get().canQueryByGraphQl(getUserVisitPK(env), commandForm)) {
    ...
    static VendorResultsObject vendorResults(final DataFetchingEnvironment env,
        ...
        try {
            ...
            if(CDI.current().select(GetVendorResultsCommand.class).get().canQueryByGraphQl(getUserVisitPK(env), commandForm)) {
    ...
    static ShippingMethodResultsObject shippingMethodResults(final DataFetchingEnvironment env,
        ...
        try {
            ...
            if(CDI.current().select(GetShippingMethodResultsCommand.class).get().canQueryByGraphQl(getUserVisitPK(env), commandForm)) {
    ...
    static WarehouseResultsObject warehouseResults(final DataFetchingEnvironment env,
        ...
        try {
            ...
            if(CDI.current().select(GetWarehouseResultsCommand.class).get().canQueryByGraphQl(getUserVisitPK(env), commandForm)) {
    ...
    static ContentCatalogResultsObject contentCatalogResults(final DataFetchingEnvironment env,
        ...
        try {
            ...
            if(CDI.current().select(GetContentCatalogResultsCommand.class).get().canQueryByGraphQl(getUserVisitPK(env), commandForm)) {
    ...
    static ContentCatalogItemResultsObject contentCatalogItemResults(final DataFetchingEnvironment env,
        ...
        try {
            ...
            if(CDI.current().select(GetContentCatalogItemResultsCommand.class).get().canQueryByGraphQl(getUserVisitPK(env), commandForm)) {
    ...
    static ContentCategoryResultsObject contentCategoryResults(final DataFetchingEnvironment env,
        ...
        try {
            ...
            if(CDI.current().select(GetContentCategoryResultsCommand.class).get().canQueryByGraphQl(getUserVisitPK(env), commandForm)) {
    ...
    static ColorObject color(final DataFetchingEnvironment env,
        ...
        try {
            ...
            color = CDI.current().select(GetColorCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<ColorObject> colors(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetColorsCommand.class).get();
    ...
    static FontStyleObject fontStyle(final DataFetchingEnvironment env,
        ...
        try {
            ...
            fontStyle = CDI.current().select(GetFontStyleCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<FontStyleObject> fontStyles(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetFontStylesCommand.class).get();
    ...
    static FontWeightObject fontWeight(final DataFetchingEnvironment env,
        ...
        try {
            ...
            fontWeight = CDI.current().select(GetFontWeightCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<FontWeightObject> fontWeights(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetFontWeightsCommand.class).get();
    ...
    static TextDecorationObject textDecoration(final DataFetchingEnvironment env,
        ...
        try {
            ...
            textDecoration = CDI.current().select(GetTextDecorationCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<TextDecorationObject> textDecorations(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetTextDecorationsCommand.class).get();
    ...
    static TextTransformationObject textTransformation(final DataFetchingEnvironment env,
        ...
        try {
            ...
            textTransformation = CDI.current().select(GetTextTransformationCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<TextTransformationObject> textTransformations(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetTextTransformationsCommand.class).get();
    ...
    static RecoveryQuestionObject recoveryQuestion(final DataFetchingEnvironment env,
        ...
        try {
            ...
            recoveryQuestion = CDI.current().select(GetRecoveryQuestionCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<RecoveryQuestionObject> recoveryQuestions(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetRecoveryQuestionsCommand.class).get();
    ...
    static UserVisitGroupObject userVisitGroup(final DataFetchingEnvironment env,
        ...
        try {
            ...
            userVisitGroup = CDI.current().select(GetUserVisitGroupCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static SymbolPositionObject symbolPosition(final DataFetchingEnvironment env,
        ...
        try {
            ...
            symbolPosition = CDI.current().select(GetSymbolPositionCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<SymbolPositionObject> symbolPositions(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetSymbolPositionsCommand.class).get();
    ...
    static CurrencyObject currency(final DataFetchingEnvironment env,
        ...
        try {
            ...
            currency = CDI.current().select(GetCurrencyCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<CurrencyObject> currencies(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetCurrenciesCommand.class).get();
    ...
    static LanguageObject language(final DataFetchingEnvironment env,
        ...
        try {
            ...
            language = CDI.current().select(GetLanguageCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static DateTimeFormatObject dateTimeFormat(final DataFetchingEnvironment env,
        ...
        try {
            ...
            dateTimeFormat = CDI.current().select(GetDateTimeFormatCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static TimeZoneObject timeZone(final DataFetchingEnvironment env,
        ...
        try {
            ...
            timeZone = CDI.current().select(GetTimeZoneCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CustomerTypeObject customerType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            customerType = CDI.current().select(GetCustomerTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<CustomerTypeObject> customerTypes(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetCustomerTypesCommand.class).get();
    ...
    static CustomerTypeShippingMethodObject customerTypeShippingMethod(final DataFetchingEnvironment env,
            @GraphQLName("customerTypeName") @GraphQLNonNull final String customerTypeName,
            @GraphQLName("shippingMethodName") @GraphQLNonNull final String shippingMethodName) {
        CustomerTypeShippingMethod customerTypeShippingMethod;
        ...
        try {
            ...
            customerTypeShippingMethod = CDI.current().select(GetCustomerTypeShippingMethodCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }

        return customerTypeShippingMethod == null ? null : new CustomerTypeShippingMethodObject(customerTypeShippingMethod);
    }

    @GraphQLField
    @GraphQLName("customerTypeShippingMethods")
    @GraphQLNonNull
    @GraphQLConnection(connectionFetcher = CountingDataConnectionFetcher.class)
    static CountingPaginatedData<CustomerTypeShippingMethodObject> customerTypeShippingMethods(final DataFetchingEnvironment env,
            @GraphQLName("customerTypeName") @GraphQLNonNull final String customerTypeName) {
        CountingPaginatedData<CustomerTypeShippingMethodObject> data;

        try {
            var commandForm = CustomerUtil.getHome().getGetCustomerTypeShippingMethodsForm();
            var command = CDI.current().select(GetCustomerTypeShippingMethodsCommand.class).get();
            ...
            if(totalEntities == null) {
                ...
                try(var objectLimiter = new ObjectLimiter(env, CustomerTypeShippingMethodConstants.COMPONENT_VENDOR_NAME, CustomerTypeShippingMethodConstants.ENTITY_TYPE_NAME, totalEntities)) {
                    var entities = command.getEntitiesForGraphQl(getUserVisitPK(env), commandForm);

                    var customerTypeShippingMethods = entities.stream()
                            .map(CustomerTypeShippingMethodObject::new)
                            .collect(Collectors.toCollection(() -> new ArrayList<>(entities.size())));

                    data = new CountedObjects<>(objectLimiter, customerTypeShippingMethods);
                }
            }
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
    ...
    static CustomerObject customer(final DataFetchingEnvironment env,
        ...
        try {
            ...
            customer = CDI.current().select(GetCustomerCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<CustomerObject> customers(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetCustomersCommand.class).get();
    ...
    static EmployeeObject employee(final DataFetchingEnvironment env,
        ...
        try {
            ...
            partyEmployee = CDI.current().select(GetEmployeeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<EmployeeObject> employees(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetEmployeesCommand.class).get();
    ...
    static VendorTypeObject vendorType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            vendorType = CDI.current().select(GetVendorTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<VendorTypeObject> vendorTypes(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetVendorTypesCommand.class).get();
    ...
    static VendorObject vendor(final DataFetchingEnvironment env,
        ...
        try {
            ...
            vendor = CDI.current().select(GetVendorCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<VendorObject> vendors(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetVendorsCommand.class).get();
    ...
    static VendorItemObject vendorItem(final DataFetchingEnvironment env,
        ...
        try {
            ...
            vendorItem = CDI.current().select(GetVendorItemCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static VendorItemCostObject vendorItemCost(final DataFetchingEnvironment env,
        ...
        try {
            ...
            vendorItemCost = CDI.current().select(GetVendorItemCostCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static RoleTypeObject roleType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            roleType = CDI.current().select(GetRoleTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static PartyTypeObject partyType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            partyType = CDI.current().select(GetPartyTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static PartyAliasTypeObject partyAliasType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            partyAliasType = CDI.current().select(GetPartyAliasTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static PartyAliasObject partyAlias(final DataFetchingEnvironment env,
        ...
        try {
            ...
            partyAlias = CDI.current().select(GetPartyAliasCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static Collection<PartyAliasObject> partyAliases(final DataFetchingEnvironment env,
        ...
        try {
            ...
            partyAliases = CDI.current().select(GetPartyAliasesCommand.class).get().getEntitiesForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static PartyObject party(final DataFetchingEnvironment env,
        ...
        try {
            ...
            party = CDI.current().select(GetPartyCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CompanyObject company(final DataFetchingEnvironment env,
        ...
        try {
            ...
            company = CDI.current().select(GetCompanyCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static DivisionObject division(final DataFetchingEnvironment env,
        ...
        try {
            ...
            division = CDI.current().select(GetDivisionCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static DepartmentObject department(final DataFetchingEnvironment env,
        ...
        try {
            ...
            department = CDI.current().select(GetDepartmentCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static WarehouseTypeObject warehouseType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            warehouseType = CDI.current().select(GetWarehouseTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<WarehouseTypeObject> warehouseTypes(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetWarehouseTypesCommand.class).get();
    ...
    static WarehouseObject warehouse(final DataFetchingEnvironment env,
        ...
        try {
            ...
            warehouse = CDI.current().select(GetWarehouseCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<WarehouseObject> warehouses(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetWarehousesCommand.class).get();
    ...
    static LocationUseTypeObject locationUseType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            locationUseType = CDI.current().select(GetLocationUseTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<LocationUseTypeObject> locationUseTypes(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetLocationUseTypesCommand.class).get();
    ...
    @GraphQLField
    @GraphQLName("inventoryLayerBucket")
    static InventoryLayerBucketObject inventoryLayerBucket(final DataFetchingEnvironment env,
            @GraphQLName("partyName") final String partyName,
            @GraphQLName("companyName") final String companyName,
            @GraphQLName("inventoryConditionName") @GraphQLNonNull final String inventoryConditionName,
        ...
        try {
            var commandForm = InventoryUtil.getHome().getGetInventoryLayerBucketForm();
            ...
            inventoryLayerBucket = CDI.current().select(GetInventoryLayerBucketCommand.class).get()
                    .getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }

        return inventoryLayerBucket == null ? null : new InventoryLayerBucketObject(inventoryLayerBucket);
    }

    @GraphQLField
    @GraphQLName("inventoryLayerBuckets")
    @GraphQLNonNull
    @GraphQLConnection(connectionFetcher = CountingDataConnectionFetcher.class)
    static CountingPaginatedData<InventoryLayerBucketObject> inventoryLayerBuckets(final DataFetchingEnvironment env,
            @GraphQLName("partyName") final String partyName,
            @GraphQLName("companyName") final String companyName,
            @GraphQLName("inventoryConditionName") final String inventoryConditionName,
            @GraphQLName("inventoryLayerSequence") final String inventoryLayerSequence,
            @GraphQLName("itemName") final String itemName,
            @GraphQLName("inventoryBucketTypeName") final String inventoryBucketTypeName) {
        CountingPaginatedData<InventoryLayerBucketObject> data;

        try {
            var commandForm = InventoryUtil.getHome().getGetInventoryLayerBucketsForm();
            var command = CDI.current().select(GetInventoryLayerBucketsCommand.class).get();
            ...
            if(totalEntities == null) {
                ...
                try(var objectLimiter = new ObjectLimiter(env, InventoryLayerBucketConstants.COMPONENT_VENDOR_NAME,
                        InventoryLayerBucketConstants.ENTITY_TYPE_NAME, totalEntities)) {
                    var entities = command.getEntitiesForGraphQl(getUserVisitPK(env), commandForm);
                    var inventoryLayerBuckets = entities.stream()
                            .map(InventoryLayerBucketObject::new)
                            .collect(Collectors.toCollection(() -> new ArrayList<>(entities.size())));

                    data = new CountedObjects<>(objectLimiter, inventoryLayerBuckets);
                }
            }
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
    ...
    @GraphQLField
    @GraphQLName("inventoryLocationBucket")
    static InventoryLocationBucketObject inventoryLocationBucket(final DataFetchingEnvironment env,
            @GraphQLName("partyName") final String partyName,
            @GraphQLName("warehouseName") final String warehouseName,
            @GraphQLName("locationName") @GraphQLNonNull final String locationName,
            @GraphQLName("itemName") @GraphQLNonNull final String itemName,
        ...
        try {
            var commandForm = InventoryUtil.getHome().getGetInventoryLocationBucketForm();
            ...
            inventoryLocationBucket = CDI.current().select(GetInventoryLocationBucketCommand.class).get()
                    .getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }

        return inventoryLocationBucket == null ? null : new InventoryLocationBucketObject(inventoryLocationBucket);
    }

    @GraphQLField
    @GraphQLName("inventoryLocationBuckets")
    @GraphQLNonNull
    @GraphQLConnection(connectionFetcher = CountingDataConnectionFetcher.class)
    static CountingPaginatedData<InventoryLocationBucketObject> inventoryLocationBuckets(final DataFetchingEnvironment env,
            @GraphQLName("partyName") final String partyName,
            @GraphQLName("warehouseName") final String warehouseName,
            @GraphQLName("locationName") final String locationName,
            @GraphQLName("itemName") final String itemName,
            @GraphQLName("inventoryBucketTypeName") final String inventoryBucketTypeName) {
        CountingPaginatedData<InventoryLocationBucketObject> data;

        try {
            var commandForm = InventoryUtil.getHome().getGetInventoryLocationBucketsForm();
            var command = CDI.current().select(GetInventoryLocationBucketsCommand.class).get();
            ...
            if(totalEntities == null) {
                ...
                try(var objectLimiter = new ObjectLimiter(env, InventoryLocationBucketConstants.COMPONENT_VENDOR_NAME,
                        InventoryLocationBucketConstants.ENTITY_TYPE_NAME, totalEntities)) {
                    var entities = command.getEntitiesForGraphQl(getUserVisitPK(env), commandForm);
                    var inventoryLocationBuckets = entities.stream()
                            .map(InventoryLocationBucketObject::new)
                            .collect(Collectors.toCollection(() -> new ArrayList<>(entities.size())));

                    data = new CountedObjects<>(objectLimiter, inventoryLocationBuckets);
                }
            }
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
    ...
    static CancellationKindObject cancellationKind(final DataFetchingEnvironment env,
        ...
        try {
            ...
            cancellationKind = CDI.current().select(GetCancellationKindCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<CancellationKindObject> cancellationKinds(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetCancellationKindsCommand.class).get();
    ...
    static CancellationPolicyObject cancellationPolicy(final DataFetchingEnvironment env,
        ...
        try {
            ...
            cancellationPolicy = CDI.current().select(GetCancellationPolicyCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<CancellationPolicyObject> cancellationPolicies(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetCancellationPoliciesCommand.class).get();
    ...
    static ReturnKindObject returnKind(final DataFetchingEnvironment env,
        ...
        try {
            ...
            returnKind = CDI.current().select(GetReturnKindCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<ReturnKindObject> returnKinds(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetReturnKindsCommand.class).get();
    ...
    static ReturnPolicyObject returnPolicy(final DataFetchingEnvironment env,
        ...
        try {
            ...
            returnPolicy = CDI.current().select(GetReturnPolicyCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<ReturnPolicyObject> returnPolicies(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetReturnPoliciesCommand.class).get();
    ...
    static ItemObject item(final DataFetchingEnvironment env,
        ...
        try {
            ...
            item = CDI.current().select(GetItemCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<ItemObject> items(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetItemsCommand.class).get();

            var totalEntities = command.getTotalEntitiesForGraphQl(getUserVisitPK(env), commandForm);
            if(totalEntities == null) {
                data = Connections.emptyConnection();
            } else {
                try(var objectLimiter = new ObjectLimiter(env, ItemConstants.COMPONENT_VENDOR_NAME, ItemConstants.ENTITY_TYPE_NAME, totalEntities)) {
                    var entities = command.getEntitiesForGraphQl(getUserVisitPK(env), commandForm);
    ...
    static ItemUnitOfMeasureTypeObject itemUnitOfMeasureType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            itemUnitOfMeasureType = CDI.current().select(GetItemUnitOfMeasureTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<ItemUnitOfMeasureTypeObject> itemUnitOfMeasureTypes(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetItemUnitOfMeasureTypesCommand.class).get();
    ...
    static ItemDescriptionObject itemDescription(final DataFetchingEnvironment env,
        ...
        try {
            ...
            itemDescription = CDI.current().select(GetItemDescriptionCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static ItemTypeObject itemType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            itemType = CDI.current().select(GetItemTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<ItemTypeObject> itemTypes(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetItemTypesCommand.class).get();
    ...
    static ItemUseTypeObject itemUseType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            itemUseType = CDI.current().select(GetItemUseTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<ItemUseTypeObject> itemUseTypes(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetItemUseTypesCommand.class).get();
    ...
    static ItemPriceTypeObject itemPriceType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            itemPriceType = CDI.current().select(GetItemPriceTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<ItemPriceTypeObject> itemPriceTypes(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetItemPriceTypesCommand.class).get();
    ...
    static ItemDeliveryTypeObject itemDeliveryType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            itemDeliveryType = CDI.current().select(GetItemDeliveryTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<ItemDeliveryTypeObject> itemDeliveryTypes(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetItemDeliveryTypesCommand.class).get();
    ...
    static ItemInventoryTypeObject itemInventoryType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            itemInventoryType = CDI.current().select(GetItemInventoryTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<ItemInventoryTypeObject> itemInventoryTypes(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetItemInventoryTypesCommand.class).get();
    ...
    static ItemPriceObject itemPrice(final DataFetchingEnvironment env,
        ...
        try {
            ...
            itemPrice = CDI.current().select(GetItemPriceCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static ItemAliasChecksumTypeObject itemAliasChecksumType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            itemAliasChecksumType = CDI.current().select(GetItemAliasChecksumTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<ItemAliasChecksumTypeObject> itemAliasChecksumTypes(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetItemAliasChecksumTypesCommand.class).get();
    ...
    static ItemAliasObject itemAlias(final DataFetchingEnvironment env,
        ...
        try {
            ...
            itemAlias = CDI.current().select(GetItemAliasCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static ItemCategoryObject itemCategory(final DataFetchingEnvironment env,
        ...
        try {
            ...
            itemCategory = CDI.current().select(GetItemCategoryCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<ItemCategoryObject> itemCategories(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetItemCategoriesCommand.class).get();
    ...
    static ItemAccountingCategoryObject itemAccountingCategory(final DataFetchingEnvironment env,
        ...
        try {
            ...
            itemAccountingCategory = CDI.current().select(GetItemAccountingCategoryCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<ItemAccountingCategoryObject> itemAccountingCategories(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetItemAccountingCategoriesCommand.class).get();
    ...
    static GlAccountObject glAccount(final DataFetchingEnvironment env,
        ...
        try {
            ...
            glAccount = CDI.current().select(GetGlAccountCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<GlAccountObject> glAccounts(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetGlAccountsCommand.class).get();
    ...
    static GlAccountTypeObject glAccountType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            glAccountType = CDI.current().select(GetGlAccountTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<GlAccountTypeObject> glAccountTypes(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetGlAccountTypesCommand.class).get();
    ...
    static GlAccountClassObject glAccountClass(final DataFetchingEnvironment env,
        ...
        try {
            ...
            glAccountClass = CDI.current().select(GetGlAccountClassCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<GlAccountClassObject> glAccountClasses(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetGlAccountClassesCommand.class).get();
    ...
    static GlAccountCategoryObject glAccountCategory(final DataFetchingEnvironment env,
        ...
        try {
            ...
            glAccountCategory = CDI.current().select(GetGlAccountCategoryCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<GlAccountCategoryObject> glAccountCategories(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetGlAccountCategoriesCommand.class).get();
    ...
    static GlResourceTypeObject glResourceType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            glResourceType = CDI.current().select(GetGlResourceTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<GlResourceTypeObject> glResourceTypes(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetGlResourceTypesCommand.class).get();
    ...
    static ItemPurchasingCategoryObject itemPurchasingCategory(final DataFetchingEnvironment env,
        ...
        try {
            ...
            itemPurchasingCategory = CDI.current().select(GetItemPurchasingCategoryCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<ItemPurchasingCategoryObject> itemPurchasingCategories(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetItemPurchasingCategoriesCommand.class).get();
    ...
    static ItemDescriptionTypeObject itemDescriptionType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            itemDescriptionType = CDI.current().select(GetItemDescriptionTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<ItemDescriptionTypeObject> itemDescriptionTypes(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetItemDescriptionTypesCommand.class).get();
    ...
    static ItemImageTypeObject itemImageType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            itemImageType = CDI.current().select(GetItemImageTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<ItemImageTypeObject> itemImageTypes(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetItemImageTypesCommand.class).get();
    ...
    static ItemDescriptionTypeUseTypeObject itemDescriptionTypeUseType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            itemDescriptionTypeUseType = CDI.current().select(GetItemDescriptionTypeUseTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<ItemDescriptionTypeUseTypeObject> itemDescriptionTypeUseTypes(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetItemDescriptionTypeUseTypesCommand.class).get();
    ...
    static ItemDescriptionTypeUseObject itemDescriptionTypeUse(final DataFetchingEnvironment env,
        ...
        try {
            ...
            itemDescriptionTypeUse = CDI.current().select(GetItemDescriptionTypeUseCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static ItemAliasTypeObject itemAliasType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            itemAliasType = CDI.current().select(GetItemAliasTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<ItemAliasTypeObject> itemAliasTypes(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetItemAliasTypesCommand.class).get();
    ...
    static ItemWeightTypeObject itemWeightType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            itemWeightType = CDI.current().select(GetItemWeightTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static ItemVolumeTypeObject itemVolumeType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            itemVolumeType = CDI.current().select(GetItemVolumeTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static RelatedItemTypeObject relatedItemType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            relatedItemType = CDI.current().select(GetRelatedItemTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<RelatedItemTypeObject> relatedItemTypes(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetRelatedItemTypesCommand.class).get();
    ...
    static RelatedItemObject relatedItem(final DataFetchingEnvironment env,
        ...
        try {
            ...
            relatedItem = CDI.current().select(GetRelatedItemCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<RelatedItemObject> relatedItems(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetRelatedItemsCommand.class).get();
    ...
    static OrderTypeObject orderType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            orderType = CDI.current().select(GetOrderTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<OrderTypeObject> orderTypes(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetOrderTypesCommand.class).get();
    ...
    static OrderPriorityObject orderPriority(final DataFetchingEnvironment env,
        ...
        try {
            ...
            orderPriority = CDI.current().select(GetOrderPriorityCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<OrderPriorityObject> orderPriorities(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetOrderPrioritiesCommand.class).get();
    ...
    static OrderTimeTypeObject orderTimeType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            orderTimeType = CDI.current().select(GetOrderTimeTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<OrderTimeTypeObject> orderTimeTypes(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetOrderTimeTypesCommand.class).get();
    ...
    static WishlistTypeObject wishlistType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            wishlistType = CDI.current().select(GetWishlistTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<WishlistTypeObject> wishlistTypes(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetWishlistTypesCommand.class).get();
    ...
    static WishlistPriorityObject wishlistPriority(final DataFetchingEnvironment env,
        ...
        try {
            ...
            wishlistPriority = CDI.current().select(GetWishlistPriorityCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<WishlistPriorityObject> wishlistPriorities(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetWishlistPrioritiesCommand.class).get();
    ...
    static TermTypeObject termType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            termType = CDI.current().select(GetTermTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static TermObject term(final DataFetchingEnvironment env,
        ...
        try {
            ...
            term = CDI.current().select(GetTermCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static SecurityRoleGroupObject securityRoleGroup(final DataFetchingEnvironment env,
        ...
        try {
            ...
            securityRoleGroup = CDI.current().select(GetSecurityRoleGroupCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<SecurityRoleGroupObject> securityRoleGroups(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetSecurityRoleGroupsCommand.class).get();
    ...
    static SecurityRoleObject securityRole(final DataFetchingEnvironment env,
        ...
        try {
            ...
            securityRole = CDI.current().select(GetSecurityRoleCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<SecurityRoleObject> securityRoles(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetSecurityRolesCommand.class).get();
    ...
    static CountingPaginatedData<PersonalTitleObject> personalTitles(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetPersonalTitlesCommand.class).get();
    ...
    static CountingPaginatedData<NameSuffixObject> nameSuffixes(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetNameSuffixesCommand.class).get();
    ...
    static TagScopeObject tagScope(final DataFetchingEnvironment env,
        ...
        try {
            ...
            tagScope = CDI.current().select(GetTagScopeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<TagScopeObject> tagScopes(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetTagScopesCommand.class).get();
    ...
    static TagScopeEntityTypeObject tagScopeEntityType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            tagScopeEntityType = CDI.current().select(GetTagScopeEntityTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    @GraphQLNonNull
    @GraphQLConnection(connectionFetcher = CountingDataConnectionFetcher.class)
    static CountingPaginatedData<TagScopeEntityTypeObject> tagScopeEntityTypes(final DataFetchingEnvironment env,
            @GraphQLName("tagScopeName") final String tagScopeName,
            @GraphQLName("componentVendorName") final String componentVendorName,
            @GraphQLName("entityTypeName") final String entityTypeName) {
        try {
            var commandForm = TagUtil.getHome().getGetTagScopeEntityTypesForm();
            var command = CDI.current().select(GetTagScopeEntityTypesCommand.class).get();
            ...
            if(totalEntities == null) {
                ...
                try(var objectLimiter = new ObjectLimiter(env, TagScopeEntityTypeConstants.COMPONENT_VENDOR_NAME, TagScopeEntityTypeConstants.ENTITY_TYPE_NAME, totalEntities)) {
                    var entities = command.getEntitiesForGraphQl(getUserVisitPK(env), commandForm);

                    return new CountedObjects<>(objectLimiter, entities.stream().map(TagScopeEntityTypeObject::new).collect(Collectors.toCollection(() -> new ArrayList<>(entities.size()))));
                }
            }
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
    ...
    static TagObject tag(final DataFetchingEnvironment env,
        ...
        try {
            ...
            tag = CDI.current().select(GetTagCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<TagObject> tags(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetTagsCommand.class).get();
    ...
    static EntityTagObject entityTag(final DataFetchingEnvironment env,
        ...
        try {
            ...
            entityTag = CDI.current().select(GetEntityTagCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static GeoCodeTypeObject geoCodeType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            geoCodeType = CDI.current().select(GetGeoCodeTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static GeoCodeScopeObject geoCodeScope(final DataFetchingEnvironment env,
        ...
        try {
            ...
            geoCodeScope = CDI.current().select(GetGeoCodeScopeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<GeoCodeScopeObject> geoCodeScopes(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            var command = CDI.current().select(GetGeoCodeScopesCommand.class).get();

            var totalEntities = command.getTotalEntitiesForGraphQl(getUserVisitPK(env), commandForm);
            if(totalEntities == null) {
                data = Connections.emptyConnection();
            } else {
                try(var objectLimiter = new ObjectLimiter(env, GeoCodeScopeConstants.COMPONENT_VENDOR_NAME, GeoCodeScopeConstants.ENTITY_TYPE_NAME, totalEntities)) {
                    var entities = command.getEntitiesForGraphQl(getUserVisitPK(env), commandForm);

                    var geoCodeScopes = entities.stream()
                            .map(GeoCodeScopeObject::new)
                            .collect(Collectors.toCollection(() -> new ArrayList<>(entities.size())));
    ...
    static GeoCodeObject geoCode(final DataFetchingEnvironment env,
        ...
        try {
            ...
            geoCode = CDI.current().select(GetGeoCodeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static ShippingMethodObject shippingMethod(final DataFetchingEnvironment env,
        ...
        try {
            ...
            shippingMethod = CDI.current().select(GetShippingMethodCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<ShippingMethodObject> shippingMethods(final DataFetchingEnvironment env) {
        ...
        try {
            ...
            try(var objectLimiter = new ObjectLimiter(env, ShippingMethodConstants.COMPONENT_VENDOR_NAME, ShippingMethodConstants.ENTITY_TYPE_NAME, totalCount)) {
                ...
                var entities = CDI.current().select(GetShippingMethodsCommand.class).get().getEntitiesForGraphQl(getUserVisitPK(env), commandForm);
    ...
    static TransactionTimeTypeObject transactionTimeType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            transactionTimeType = CDI.current().select(GetTransactionTimeTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static TransactionTypeObject transactionType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            transactionType = CDI.current().select(GetTransactionTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static TransactionGlAccountCategoryObject transactionGlAccountCategory(final DataFetchingEnvironment env,
        ...
        try {
            ...
            transactionGlAccountCategory = CDI.current().select(GetTransactionGlAccountCategoryCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<TransactionGlAccountCategoryObject> transactionGlAccountCategories(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetTransactionGlAccountCategoriesCommand.class).get();
    ...
    static TransactionEntityRoleTypeObject transactionEntityRoleType(final DataFetchingEnvironment env,
        ...
        try {
            ...
            transactionEntityRoleType = CDI.current().select(GetTransactionEntityRoleTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<TransactionEntityRoleTypeObject> transactionEntityRoleTypes(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetTransactionEntityRoleTypesCommand.class).get();
    ...
    static TransactionGroupObject transactionGroup(final DataFetchingEnvironment env,
        ...
        try {
            ...
            transactionGroup = CDI.current().select(GetTransactionGroupCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static TransactionObject transaction(final DataFetchingEnvironment env,
        ...
        try {
            ...
            transaction = CDI.current().select(GetTransactionCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    ...
    static CountingPaginatedData<TransactionObject> transactions(final DataFetchingEnvironment env,
        ...
        try {
            ...
            var command = CDI.current().select(GetTransactionsCommand.class).get();
    ...
    static CampaignObject campaign(final DataFetchingEnvironment env,
            @GraphQLName("campaignName") final String campaignName,
            @GraphQLName("id") @GraphQLID final String id) {
        Campaign campaign;

        try {
            var commandForm = CampaignUtil.getHome().getGetCampaignForm();

            commandForm.setCampaignName(campaignName);
            commandForm.setUuid(id);

            campaign = CDI.current().select(GetCampaignCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }

        return campaign == null ? null : new CampaignObject(campaign);
    }

    @GraphQLField
    @GraphQLName("campaigns")
    @GraphQLNonNull
    @GraphQLConnection(connectionFetcher = CountingDataConnectionFetcher.class)
    static CountingPaginatedData<CampaignObject> campaigns(final DataFetchingEnvironment env) {
        CountingPaginatedData<CampaignObject> data;

        try {
            var commandForm = CampaignUtil.getHome().getGetCampaignsForm();
            var command = CDI.current().select(GetCampaignsCommand.class).get();

            var totalEntities = command.getTotalEntitiesForGraphQl(getUserVisitPK(env), commandForm);
            if(totalEntities == null) {
                data = Connections.emptyConnection();
            } else {
                try(var objectLimiter = new ObjectLimiter(env, CampaignConstants.COMPONENT_VENDOR_NAME, CampaignConstants.ENTITY_TYPE_NAME, totalEntities)) {
                    var entities = command.getEntitiesForGraphQl(getUserVisitPK(env), commandForm);

                    var campaigns = entities.stream()
                            .map(CampaignObject::new)
                            .collect(Collectors.toCollection(() -> new ArrayList<>(entities.size())));

                    data = new CountedObjects<>(objectLimiter, campaigns);
                }
            }
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
    ...
    static CampaignContentObject campaignContent(final DataFetchingEnvironment env,
            @GraphQLName("campaignContentName") final String campaignContentName,
            @GraphQLName("id") @GraphQLID final String id) {
        CampaignContent campaignContent;

        try {
            var commandForm = CampaignUtil.getHome().getGetCampaignContentForm();

            commandForm.setCampaignContentName(campaignContentName);
            commandForm.setUuid(id);

            campaignContent = CDI.current().select(GetCampaignContentCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }

        return campaignContent == null ? null : new CampaignContentObject(campaignContent);
    }

    @GraphQLField
    @GraphQLName("campaignContents")
    @GraphQLNonNull
    @GraphQLConnection(connectionFetcher = CountingDataConnectionFetcher.class)
    static CountingPaginatedData<CampaignContentObject> campaignContents(final DataFetchingEnvironment env) {
        CountingPaginatedData<CampaignContentObject> data;

        try {
            var commandForm = CampaignUtil.getHome().getGetCampaignContentsForm();
            var command = CDI.current().select(GetCampaignContentsCommand.class).get();

            var totalEntities = command.getTotalEntitiesForGraphQl(getUserVisitPK(env), commandForm);
            if(totalEntities == null) {
                data = Connections.emptyConnection();
            } else {
                try(var objectLimiter = new ObjectLimiter(env, CampaignContentConstants.COMPONENT_VENDOR_NAME, CampaignContentConstants.ENTITY_TYPE_NAME, totalEntities)) {
                    var entities = command.getEntitiesForGraphQl(getUserVisitPK(env), commandForm);

                    var campaignContents = entities.stream()
                            .map(CampaignContentObject::new)
                            .collect(Collectors.toCollection(() -> new ArrayList<>(entities.size())));

                    data = new CountedObjects<>(objectLimiter, campaignContents);
                }
            }
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
    ...
    @GraphQLField
    @GraphQLName("campaignMedium")
    static CampaignMediumObject campaignMedium(final DataFetchingEnvironment env,
            @GraphQLName("campaignMediumName") final String campaignMediumName,
            @GraphQLName("id") @GraphQLID final String id) {
        CampaignMedium campaignMedium;

        try {
            var commandForm = CampaignUtil.getHome().getGetCampaignMediumForm();

            commandForm.setCampaignMediumName(campaignMediumName);
            commandForm.setUuid(id);

            campaignMedium = CDI.current().select(GetCampaignMediumCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }

        return campaignMedium == null ? null : new CampaignMediumObject(campaignMedium);
    }

    @GraphQLField
    @GraphQLName("campaignMediums")
    @GraphQLNonNull
    @GraphQLConnection(connectionFetcher = CountingDataConnectionFetcher.class)
    static CountingPaginatedData<CampaignMediumObject> campaignMediums(final DataFetchingEnvironment env) {
        CountingPaginatedData<CampaignMediumObject> data;

        try {
            var commandForm = CampaignUtil.getHome().getGetCampaignMediumsForm();
            var command = CDI.current().select(GetCampaignMediumsCommand.class).get();

            var totalEntities = command.getTotalEntitiesForGraphQl(getUserVisitPK(env), commandForm);
            if(totalEntities == null) {
                data = Connections.emptyConnection();
            } else {
                try(var objectLimiter = new ObjectLimiter(env, CampaignMediumConstants.COMPONENT_VENDOR_NAME, CampaignMediumConstants.ENTITY_TYPE_NAME, totalEntities)) {
                    var entities = command.getEntitiesForGraphQl(getUserVisitPK(env), commandForm);

                    var campaignMediums = entities.stream()
                            .map(CampaignMediumObject::new)
                            .collect(Collectors.toCollection(() -> new ArrayList<>(entities.size())));
    ...
    static CampaignSourceObject campaignSource(final DataFetchingEnvironment env,
            @GraphQLName("campaignSourceName") final String campaignSourceName,
            @GraphQLName("id") @GraphQLID final String id) {
        CampaignSource campaignSource;

        try {
            var commandForm = CampaignUtil.getHome().getGetCampaignSourceForm();

            commandForm.setCampaignSourceName(campaignSourceName);
            commandForm.setUuid(id);

            campaignSource = CDI.current().select(GetCampaignSourceCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }

        return campaignSource == null ? null : new CampaignSourceObject(campaignSource);
    }

    @GraphQLField
    @GraphQLName("campaignSources")
    @GraphQLNonNull
    @GraphQLConnection(connectionFetcher = CountingDataConnectionFetcher.class)
    static CountingPaginatedData<CampaignSourceObject> campaignSources(final DataFetchingEnvironment env) {
        CountingPaginatedData<CampaignSourceObject> data;

        try {
            var commandForm = CampaignUtil.getHome().getGetCampaignSourcesForm();
            var command = CDI.current().select(GetCampaignSourcesCommand.class).get();

            var totalEntities = command.getTotalEntitiesForGraphQl(getUserVisitPK(env), commandForm);
            if(totalEntities == null) {
                data = Connections.emptyConnection();
            } else {
                try(var objectLimiter = new ObjectLimiter(env, CampaignSourceConstants.COMPONENT_VENDOR_NAME, CampaignSourceConstants.ENTITY_TYPE_NAME, totalEntities)) {
                    var entities = command.getEntitiesForGraphQl(getUserVisitPK(env), commandForm);

                    var campaignSources = entities.stream()
                            .map(CampaignSourceObject::new)
                            .collect(Collectors.toCollection(() -> new ArrayList<>(entities.size())));

                    data = new CountedObjects<>(objectLimiter, campaignSources);
                }
            }
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
    ...
    static SubscriptionTypeObject subscriptionType(final DataFetchingEnvironment env,
            @GraphQLName("subscriptionKindName") final String subscriptionKindName,
            @GraphQLName("subscriptionTypeName") final String subscriptionTypeName,
            @GraphQLName("id") @GraphQLID final String id) {
        SubscriptionType subscriptionType;

        try {
            var commandForm = SubscriptionUtil.getHome().getGetSubscriptionTypeForm();

            commandForm.setSubscriptionKindName(subscriptionKindName);
            commandForm.setSubscriptionTypeName(subscriptionTypeName);
            commandForm.setUuid(id);

            subscriptionType = CDI.current().select(GetSubscriptionTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }

        return subscriptionType == null ? null : new SubscriptionTypeObject(subscriptionType);
    }

    @GraphQLField
    @GraphQLName("subscriptionTypes")
    @GraphQLNonNull
    @GraphQLConnection(connectionFetcher = CountingDataConnectionFetcher.class)
    static CountingPaginatedData<SubscriptionTypeObject> subscriptionTypes(final DataFetchingEnvironment env,
            @GraphQLName("subscriptionKindName") @GraphQLNonNull final String subscriptionKindName) {
        CountingPaginatedData<SubscriptionTypeObject> data;

        try {
            var commandForm = SubscriptionUtil.getHome().getGetSubscriptionTypesForm();
            var command = CDI.current().select(GetSubscriptionTypesCommand.class).get();
            ...
            if(totalEntities == null) {
                ...
                try(var objectLimiter = new ObjectLimiter(env, SubscriptionTypeConstants.COMPONENT_VENDOR_NAME, SubscriptionTypeConstants.ENTITY_TYPE_NAME, totalEntities)) {
                    var entities = command.getEntitiesForGraphQl(getUserVisitPK(env), commandForm);

                    var subscriptionTypes = entities.stream()
                            .map(SubscriptionTypeObject::new)
                            .collect(Collectors.toCollection(() -> new ArrayList<>(entities.size())));

                    data = new CountedObjects<>(objectLimiter, subscriptionTypes);
                }
            }
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
    ...
    static SubscriptionObject subscription(final DataFetchingEnvironment env,
            @GraphQLName("subscriptionName") final String subscriptionName,
            @GraphQLName("id") @GraphQLID final String id) {
        ...
        try {
            ...
            subscription = CDI.current().select(GetSubscriptionCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }

        return subscription == null ? null : new SubscriptionObject(subscription);
    }
    ...
    @GraphQLNonNull
    @GraphQLConnection(connectionFetcher = CountingDataConnectionFetcher.class)
    static CountingPaginatedData<SubscriptionObject> subscriptions(final DataFetchingEnvironment env,
            @GraphQLName("subscriptionKindName") @GraphQLNonNull final String subscriptionKindName,
            @GraphQLName("subscriptionTypeName") @GraphQLNonNull final String subscriptionTypeName) {
        CountingPaginatedData<SubscriptionObject> data;

        try {
            var commandForm = SubscriptionUtil.getHome().getGetSubscriptionsForm();
            var command = CDI.current().select(GetSubscriptionsCommand.class).get();
            ...
            if(totalEntities == null) {
                ...
                try(var objectLimiter = new ObjectLimiter(env, SubscriptionConstants.COMPONENT_VENDOR_NAME, SubscriptionConstants.ENTITY_TYPE_NAME, totalEntities)) {
                    var entities = command.getEntitiesForGraphQl(getUserVisitPK(env), commandForm);

                    var subscriptions = entities.stream()
                            .map(SubscriptionObject::new)
                            .collect(Collectors.toCollection(() -> new ArrayList<>(entities.size())));

                    data = new CountedObjects<>(objectLimiter, subscriptions);
                }
            }
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
    ...
    static ChainKindObject chainKind(final DataFetchingEnvironment env,
        ...
        try {
            ...
            chainKind = CDI.current().select(GetChainKindCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }

        return chainKind == null ? null : new ChainKindObject(chainKind);
    }

    @GraphQLField
    @GraphQLName("chainKinds")
    @GraphQLNonNull
    @GraphQLConnection(connectionFetcher = CountingDataConnectionFetcher.class)
    static CountingPaginatedData<ChainKindObject> chainKinds(final DataFetchingEnvironment env) {
        CountingPaginatedData<ChainKindObject> data;

        try {
            var commandForm = ChainUtil.getHome().getGetChainKindsForm();
            var command = CDI.current().select(GetChainKindsCommand.class).get();

            var totalEntities = command.getTotalEntitiesForGraphQl(getUserVisitPK(env), commandForm);
            if(totalEntities == null) {
                data = Connections.emptyConnection();
            } else {
                try(var objectLimiter = new ObjectLimiter(env, ChainKindConstants.COMPONENT_VENDOR_NAME, ChainKindConstants.ENTITY_TYPE_NAME, totalEntities)) {
                    var entities = command.getEntitiesForGraphQl(getUserVisitPK(env), commandForm);

                    var chainKinds = entities.stream()
                            .map(ChainKindObject::new)
                            .collect(Collectors.toCollection(() -> new ArrayList<>(entities.size())));
    ...
    @GraphQLField
    @GraphQLName("chain")
    static ChainObject chain(final DataFetchingEnvironment env,
            @GraphQLName("chainKindName") final String chainKindName,
            @GraphQLName("chainTypeName") final String chainTypeName,
        ...
        try {
            ...
            chain = CDI.current().select(GetChainCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }

        return chain == null ? null : new ChainObject(chain);
    }
    ...
    @GraphQLNonNull
    @GraphQLConnection(connectionFetcher = CountingDataConnectionFetcher.class)
    static CountingPaginatedData<ChainObject> chains(final DataFetchingEnvironment env,
            @GraphQLName("chainKindName") @GraphQLNonNull final String chainKindName,
            @GraphQLName("chainTypeName") @GraphQLNonNull final String chainTypeName) {
        CountingPaginatedData<ChainObject> data;

        try {
            var commandForm = ChainUtil.getHome().getGetChainsForm();
            var command = CDI.current().select(GetChainsCommand.class).get();
            ...
            if(totalEntities == null) {
                ...
                try(var objectLimiter = new ObjectLimiter(env, ChainConstants.COMPONENT_VENDOR_NAME, ChainConstants.ENTITY_TYPE_NAME, totalEntities)) {
                    var entities = command.getEntitiesForGraphQl(getUserVisitPK(env), commandForm);

                    var chains = entities.stream()
                            .map(ChainObject::new)
                            .collect(Collectors.toCollection(() -> new ArrayList<>(entities.size())));
    ...
    static ChainActionTypeObject chainActionType(final DataFetchingEnvironment env,
            @GraphQLName("chainActionTypeName") final String chainActionTypeName,
            @GraphQLName("id") @GraphQLID final String id) {
        ChainActionType chainActionType;

        try {
            var commandForm = ChainUtil.getHome().getGetChainActionTypeForm();

            commandForm.setChainActionTypeName(chainActionTypeName);
            commandForm.setUuid(id);

            chainActionType = CDI.current().select(GetChainActionTypeCommand.class).get().getEntityForGraphQl(getUserVisitPK(env), commandForm);
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }

        return chainActionType == null ? null : new ChainActionTypeObject(chainActionType);
    }

    @GraphQLField
    @GraphQLName("chainActionTypes")
    @GraphQLNonNull
    @GraphQLConnection(connectionFetcher = CountingDataConnectionFetcher.class)
    static CountingPaginatedData<ChainActionTypeObject> chainActionTypes(final DataFetchingEnvironment env) {
        CountingPaginatedData<ChainActionTypeObject> data;

        try {
            var commandForm = ChainUtil.getHome().getGetChainActionTypesForm();
            var command = CDI.current().select(GetChainActionTypesCommand.class).get();

            var totalEntities = command.getTotalEntitiesForGraphQl(getUserVisitPK(env), commandForm);
            if(totalEntities == null) {
                data = Connections.emptyConnection();
            } else {
                try(var objectLimiter = new ObjectLimiter(env, ChainActionTypeConstants.COMPONENT_VENDOR_NAME, ChainActionTypeConstants.ENTITY_TYPE_NAME, totalEntities)) {
                    var entities = command.getEntitiesForGraphQl(getUserVisitPK(env), commandForm);

                    var chainActionTypes = entities.stream()
                            .map(ChainActionTypeObject::new)
                            .collect(Collectors.toCollection(() -> new ArrayList<>(entities.size())));
