...
public interface GetSubscriptionKindDescriptionsResult
        extends BaseResult {
    
    SubscriptionKindTransfer getSubscriptionKind();
    void setSubscriptionKind(SubscriptionKindTransfer subscriptionKind);
    
    List<SubscriptionKindDescriptionTransfer> getSubscriptionKindDescriptions();
    void setSubscriptionKindDescriptions(List<SubscriptionKindDescriptionTransfer> subscriptionKindDescriptions);
