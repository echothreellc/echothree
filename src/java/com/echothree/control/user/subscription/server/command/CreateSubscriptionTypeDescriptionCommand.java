...
import com.echothree.control.user.subscription.common.form.CreateSubscriptionTypeDescriptionForm;
...
public class CreateSubscriptionTypeDescriptionCommand
        extends BaseSimpleCommand<CreateSubscriptionTypeDescriptionForm> {
    ...
    /** Creates a new instance of CreateSubscriptionTypeDescriptionCommand */
    public CreateSubscriptionTypeDescriptionCommand(UserVisitPK userVisitPK, CreateSubscriptionTypeDescriptionForm form) {
            ...
            if(subscriptionType != null) {
                ...
                if(language != null) {
                    ...
                    if(subscriptionTypeDescription == null) {
                        ...
                        subscriptionControl.createSubscriptionTypeDescription(subscriptionType, language, description, getPartyPK());
                    } else {
                        addExecutionError(ExecutionErrors.DuplicateSubscriptionTypeDescription.name());
                    }
                } else {
