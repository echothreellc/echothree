...
public class GetSubscriptionTypeDescriptionsCommand
        extends BaseSimpleCommand<GetSubscriptionTypeDescriptionsForm> {
    ...
    /** Creates a new instance of GetSubscriptionTypeDescriptionsCommand */
    public GetSubscriptionTypeDescriptionsCommand(UserVisitPK userVisitPK, GetSubscriptionTypeDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        var result = SubscriptionResultFactory.getGetSubscriptionTypeDescriptionsResult();
        ...
        if(subscriptionKind != null) {
            ...
            if(subscriptionType != null) {
                ...
                result.setSubscriptionTypeDescriptions(subscriptionControl.getSubscriptionTypeDescriptionTransfersBySubscriptionType(getUserVisit(), subscriptionType));
            } else {
