...
public class CreateSubscriptionKindDescriptionCommand
        extends BaseSimpleCommand<CreateSubscriptionKindDescriptionForm> {
    ...
    /** Creates a new instance of CreateSubscriptionKindDescriptionCommand */
    public CreateSubscriptionKindDescriptionCommand(UserVisitPK userVisitPK, CreateSubscriptionKindDescriptionForm form) {
        ...
        if(subscriptionKind != null) {
            ...
            if(language != null) {
                ...
                if(subscriptionKindDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateSubscriptionKindDescription.name());
                }
            } else {
