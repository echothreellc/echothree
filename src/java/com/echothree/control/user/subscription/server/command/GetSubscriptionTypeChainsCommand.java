...
import com.echothree.control.user.subscription.common.result.GetSubscriptionTypeChainsResult;
...
public class GetSubscriptionTypeChainsCommand
        extends BaseSimpleCommand<GetSubscriptionTypeChainsForm> {
    ...
    public GetSubscriptionTypeChainsCommand(UserVisitPK userVisitPK, GetSubscriptionTypeChainsForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetSubscriptionTypeChainsResult result = SubscriptionResultFactory.getGetSubscriptionTypeChainsResult();
        ...
        if(subscriptionKind != null) {
            ...
            if(subscriptionType != null) {
                ...
                result.setSubscriptionTypeChains(subscriptionControl.getSubscriptionTypeChainTransfersBySubscriptionType(getUserVisit(), subscriptionType));
            } else {
