...
import com.echothree.control.user.subscription.remote.form.GetSubscriptionKindChoicesForm;
import com.echothree.control.user.subscription.remote.result.GetSubscriptionKindChoicesResult;
...
public class GetSubscriptionKindChoicesCommand
        extends BaseSimpleCommand<GetSubscriptionKindChoicesForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                    new SecurityRoleDefinition(SecurityRoleGroups.SubscriptionKind.name(), SecurityRoles.Choices.name())
                    )))
                )));

        FORM_FIELD_DEFINITIONS = Collections.unmodifiableList(Arrays.asList(
                new FieldDefinition("DefaultSubscriptionKindChoice", FieldType.ENTITY_NAME, false, null, null),
                new FieldDefinition("AllowNullChoice", FieldType.BOOLEAN, true, null, null)
                ));
    }
    
    /** Creates a new instance of GetSubscriptionKindChoicesCommand */
    public GetSubscriptionKindChoicesCommand(UserVisitPK userVisitPK, GetSubscriptionKindChoicesForm form) {
