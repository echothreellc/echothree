...
import com.echothree.control.user.subscription.remote.form.GetSubscriptionKindForm;
import com.echothree.control.user.subscription.remote.result.GetSubscriptionKindResult;
...
public class GetSubscriptionKindCommand
    ...
    public GetSubscriptionKindCommand(UserVisitPK userVisitPK, GetSubscriptionKindForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(subscriptionKind != null) {
            ...
            sendEventUsingNames(subscriptionKind.getPrimaryKey(), EventTypes.READ.name(), null, null, getPartyPK());
        } else {
