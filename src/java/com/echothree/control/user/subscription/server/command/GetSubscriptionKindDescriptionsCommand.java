...
import com.echothree.control.user.subscription.common.form.GetSubscriptionKindDescriptionsForm;
import com.echothree.control.user.subscription.common.result.GetSubscriptionKindDescriptionsResult;
...
public class GetSubscriptionKindDescriptionsCommand
        extends BaseSimpleCommand<GetSubscriptionKindDescriptionsForm> {
    ...
    public GetSubscriptionKindDescriptionsCommand(UserVisitPK userVisitPK, GetSubscriptionKindDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetSubscriptionKindDescriptionsResult result = SubscriptionResultFactory.getGetSubscriptionKindDescriptionsResult();
        ...
        if(subscriptionKind != null) {
            ...
            result.setSubscriptionKindDescriptions(subscriptionControl.getSubscriptionKindDescriptionTransfersBySubscriptionKind(getUserVisit(), subscriptionKind));
        } else {
