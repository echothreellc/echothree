...
import com.echothree.control.user.subscription.remote.form.GetSubscriptionTypeForm;
import com.echothree.control.user.subscription.remote.result.GetSubscriptionTypeResult;
...
public class GetSubscriptionTypeCommand
    ...
    public GetSubscriptionTypeCommand(UserVisitPK userVisitPK, GetSubscriptionTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetSubscriptionTypeResult result = SubscriptionResultFactory.getGetSubscriptionTypeResult();
        ...
        if(subscriptionKind != null) {
            ...
            SubscriptionType subscriptionType = subscriptionControl.getSubscriptionTypeByName(subscriptionKind,
            ...
            if(subscriptionType != null) {
                ...
                sendEventUsingNames(subscriptionType.getPrimaryKey(), EventTypes.READ.name(), null, null, getPartyPK());
            } else {
