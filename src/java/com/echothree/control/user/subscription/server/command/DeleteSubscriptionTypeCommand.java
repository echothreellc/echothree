...
@Dependent
public class DeleteSubscriptionTypeCommand
        extends BaseSimpleCommand<DeleteSubscriptionTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(List.of(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), List.of(
                        new SecurityRoleDefinition(SecurityRoleGroups.SubscriptionType.name(), SecurityRoles.Delete.name())
                ))
        ));
    ...
    /** Creates a new instance of DeleteSubscriptionTypeCommand */
    public DeleteSubscriptionTypeCommand() {
    ...
    protected BaseResult execute() {
        ...
        if(subscriptionKind != null) {
            ...
            if(subscriptionType != null) {
                subscriptionControl.deleteSubscriptionType(subscriptionType, getPartyPK());
            } else {
