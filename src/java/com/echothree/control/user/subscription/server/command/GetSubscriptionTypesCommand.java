...
import com.echothree.control.user.subscription.remote.form.GetSubscriptionTypesForm;
import com.echothree.control.user.subscription.remote.result.GetSubscriptionTypesResult;
...
public class GetSubscriptionTypesCommand
        extends BaseSimpleCommand<GetSubscriptionTypesForm> {
    ...
    public GetSubscriptionTypesCommand(UserVisitPK userVisitPK, GetSubscriptionTypesForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetSubscriptionTypesResult result = SubscriptionResultFactory.getGetSubscriptionTypesResult();
