...
import com.echothree.control.user.subscription.remote.form.GetSubscriptionKindsForm;
import com.echothree.control.user.subscription.remote.result.GetSubscriptionKindsResult;
...
public class GetSubscriptionKindsCommand
        extends BaseSimpleCommand<GetSubscriptionKindsForm> {
    ...
    public GetSubscriptionKindsCommand(UserVisitPK userVisitPK, GetSubscriptionKindsForm form) {
