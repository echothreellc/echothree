...
public interface CreateSubscriptionForm
        extends SubscriptionTypeSpec, PartySpec {
    
    String getUnitOfMeasureTypeName();
    void setUnitOfMeasureTypeName(String unitOfMeasureTypeName);
    
    String getSubscriptionTime();
    void setSubscriptionTime(String subscriptionTime);
