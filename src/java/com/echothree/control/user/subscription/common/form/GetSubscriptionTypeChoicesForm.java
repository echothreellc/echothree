...
public interface GetSubscriptionTypeChoicesForm
        extends SubscriptionKindSpec {
    
    String getDefaultSubscriptionTypeChoice();
    void setDefaultSubscriptionTypeChoice(String defaultSubscriptionTypeChoice);
