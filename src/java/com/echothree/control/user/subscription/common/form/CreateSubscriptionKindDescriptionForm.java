...
public interface CreateSubscriptionKindDescriptionForm
        extends SubscriptionKindDescriptionSpec, SubscriptionKindDescriptionEdit {
    
    // Nothing additional beyond SubscriptionKindDescriptionSpec, SubscriptionKindDescriptionEdit
