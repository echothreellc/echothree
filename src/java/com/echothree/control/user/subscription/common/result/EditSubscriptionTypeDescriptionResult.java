...
public interface EditSubscriptionTypeDescriptionResult
        extends BaseEditResult<SubscriptionTypeDescriptionEdit> {
    
    SubscriptionTypeDescriptionTransfer getSubscriptionTypeDescription();
    void setSubscriptionTypeDescription(SubscriptionTypeDescriptionTransfer subscriptionTypeDescription);
