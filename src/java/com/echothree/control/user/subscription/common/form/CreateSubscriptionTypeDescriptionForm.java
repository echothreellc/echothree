...
public interface CreateSubscriptionTypeDescriptionForm
        extends SubscriptionTypeDescriptionSpec, SubscriptionTypeDescriptionEdit {
    
    // Nothing additional beyond SubscriptionTypeDescriptionSpec, SubscriptionTypeDescriptionEdit
