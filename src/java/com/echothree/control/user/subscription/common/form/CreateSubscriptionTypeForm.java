...
public interface CreateSubscriptionTypeForm
        extends SubscriptionTypeSpec, SubscriptionTypeEdit {
    
    // Nothing additional beyond SubscriptionTypeSpec, SubscriptionTypeEdit
