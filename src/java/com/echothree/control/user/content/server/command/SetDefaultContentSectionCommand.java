...
import com.echothree.control.user.content.common.form.SetDefaultContentSectionForm;
...
@Dependent
public class SetDefaultContentSectionCommand
        extends BaseSimpleCommand<SetDefaultContentSectionForm> {
