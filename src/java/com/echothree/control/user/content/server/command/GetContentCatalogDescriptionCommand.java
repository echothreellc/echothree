...
public class GetContentCatalogDescriptionCommand
        extends BaseSimpleCommand<GetContentCatalogDescriptionForm> {
    ...
    /** Creates a new instance of GetContentCatalogDescriptionCommand */
    public GetContentCatalogDescriptionCommand(UserVisitPK userVisitPK, GetContentCatalogDescriptionForm form) {
            ...
            if(contentCatalog != null) {
                ...
                if(language != null) {
                    ...
                    if(contentCatalogDescription != null) {
                        ...
                        addExecutionError(ExecutionErrors.UnknownContentCatalogDescription.name(), contentCollectionName, contentCatalogName, contentCatalogName,
                                languageIsoName);
                    }
                } else {
