...
@Dependent
public class CreateContentCategoryDescriptionCommand
        extends BaseSimpleCommand<CreateContentCategoryDescriptionForm> {
                ...
                if(contentCategory != null) {
                    ...
                    if(language != null) {
                        ...
                        if(contentCategoryDescription == null) {
                            ...
                            addExecutionError(ExecutionErrors.DuplicateContentCategoryDescription.name());
                        }
                    } else {
