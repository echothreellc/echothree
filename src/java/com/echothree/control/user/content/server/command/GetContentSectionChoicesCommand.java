...
public class GetContentSectionChoicesCommand
        extends BaseSimpleCommand<GetContentSectionChoicesForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.ContentSection.name(), SecurityRoles.Choices.name())
                        )))
                )));
    ...
    /** Creates a new instance of GetContentSectionChoicesCommand */
    public GetContentSectionChoicesCommand(UserVisitPK userVisitPK, GetContentSectionChoicesForm form) {
