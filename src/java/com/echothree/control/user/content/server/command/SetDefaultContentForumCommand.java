...
@RequestScoped
public class SetDefaultContentForumCommand
        extends BaseSimpleCommand<SetDefaultContentForumForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.ContentForum.name(), SecurityRoles.Edit.name())
                        )))
                )));
            ...
            if(forum != null) {
                ...
                if(contentForumDetailValue != null) {
                    ...
                    addExecutionError(ExecutionErrors.UnknownContentForum.name(),
                            ...
                            forum.getLastDetail().getForumName());
                }
            } else {
