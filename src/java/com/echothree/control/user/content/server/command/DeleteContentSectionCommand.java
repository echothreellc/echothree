...
import com.echothree.control.user.content.remote.form.DeleteContentSectionForm;
...
public class DeleteContentSectionCommand
        extends BaseSimpleCommand<DeleteContentSectionForm> {
    ...
    protected BaseResult execute() {
        ...
        if(contentCollection != null) {
            ...
            if(!contentSectionName.equalsIgnoreCase(ContentConstants.ContentSection_ROOT)) {
                ...
                addExecutionError(ExecutionErrors.InvalidContentSectionName.name(), contentSectionName);
            }
        } else {
