...
public class DeleteContentForumCommand
        extends BaseSimpleCommand<DeleteContentForumForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.ContentForum.name(), SecurityRoles.Delete.name())
                        )))
                )));
    ...
    protected BaseResult execute() {
        ...
        if(contentCollection != null) {
            ...
            if(forum != null) {
                ContentForum contentForum = contentControl.getContentForumForUpdate(contentCollection, forum);
                
                if(contentForum != null) {
                    contentControl.deleteContentForum(contentForum, getPartyPK());
                } else {
