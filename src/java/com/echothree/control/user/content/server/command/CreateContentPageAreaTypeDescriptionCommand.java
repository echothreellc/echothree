...
import com.echothree.control.user.content.remote.form.CreateContentPageAreaTypeDescriptionForm;
...
public class CreateContentPageAreaTypeDescriptionCommand
        extends BaseSimpleCommand<CreateContentPageAreaTypeDescriptionForm> {
    ...
    public CreateContentPageAreaTypeDescriptionCommand(UserVisitPK userVisitPK, CreateContentPageAreaTypeDescriptionForm form) {
        ...
        if(contentPageAreaType != null) {
            ...
            if(language != null) {
                ...
                if(contentPageAreaTypeDescription == null) {
                    ...
                    contentControl.createContentPageAreaTypeDescription(contentPageAreaType, language, description);
                } else {
                    addExecutionError(ExecutionErrors.DuplicateContentPageAreaTypeDescription.name());
                }
            } else {
                addExecutionError(ExecutionErrors.UnknownLanguageIsoName.name(), languageIsoName);
            }
        } else {
            addExecutionError(ExecutionErrors.UnknownContentPageAreaTypeName.name(), contentPageAreaTypeName);
        }
