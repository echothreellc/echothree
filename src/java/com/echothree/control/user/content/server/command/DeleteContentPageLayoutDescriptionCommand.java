...
import com.echothree.control.user.content.common.form.DeleteContentPageLayoutDescriptionForm;
...
public class DeleteContentPageLayoutDescriptionCommand
        extends BaseSimpleCommand<DeleteContentPageLayoutDescriptionForm> {
    ...
    /** Creates a new instance of DeleteContentPageLayoutDescriptionCommand */
    public DeleteContentPageLayoutDescriptionCommand(UserVisitPK userVisitPK, DeleteContentPageLayoutDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(contentPageLayout != null) {
            ...
            if(language != null) {
                ContentPageLayoutDescription contentPageLayoutDescription = contentControl.getContentPageLayoutDescriptionForUpdate(contentPageLayout, language);
                
                if(contentPageLayoutDescription != null) {
                    contentControl.deleteContentPageLayoutDescription(contentPageLayoutDescription, getPartyPK());
                } else {
