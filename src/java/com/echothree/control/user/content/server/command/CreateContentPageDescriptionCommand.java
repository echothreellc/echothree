...
import com.echothree.control.user.content.remote.form.CreateContentPageDescriptionForm;
...
public class CreateContentPageDescriptionCommand
        extends BaseSimpleCommand<CreateContentPageDescriptionForm> {
    ...
    /** Creates a new instance of CreateContentPageDescriptionCommand */
    public CreateContentPageDescriptionCommand(UserVisitPK userVisitPK, CreateContentPageDescriptionForm form) {
                ...
                if(contentPage != null) {
                    ...
                    if(language != null) {
                        ...
                        if(contentPageDescription == null) {
                            ...
                            addExecutionError(ExecutionErrors.DuplicateContentPageDescription.name());
                        }
                    } else {
