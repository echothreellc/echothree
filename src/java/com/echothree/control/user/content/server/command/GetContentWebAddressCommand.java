...
public class GetContentWebAddressCommand
    ...
    public GetContentWebAddressCommand(UserVisitPK userVisitPK, GetContentWebAddressForm form) {
    ...
    protected ContentWebAddress getEntity() {
        ...
        if(contentWebAddress != null) {
            sendEventUsingNames(contentWebAddress.getPrimaryKey(), EventTypes.READ, null, null, getPartyPK());
        } else {
