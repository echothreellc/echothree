...
public class DeleteContentPageDescriptionCommand
        extends BaseSimpleCommand<DeleteContentPageDescriptionForm> {
        ...
        if(contentCollection != null) {
            ...
            if(contentSection != null) {
                ...
                if(contentPage != null) {
                    ...
                    if(language != null) {
                        ContentPageDescription contentPageDescription = contentControl.getContentPageDescriptionForUpdate(contentPage, language);
                        
                        if(contentPageDescription != null) {
                            contentControl.deleteContentPageDescription(contentPageDescription, getPartyPK());
                        } else {
