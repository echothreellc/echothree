...
import com.echothree.control.user.content.remote.form.GetContentSectionDescriptionsForm;
import com.echothree.control.user.content.remote.result.ContentResultFactory;
import com.echothree.control.user.content.remote.result.GetContentSectionDescriptionsResult;
...
public class GetContentSectionDescriptionsCommand
        extends BaseSimpleCommand<GetContentSectionDescriptionsForm> {
    ...
    protected BaseResult execute() {
        ...
        if(contentCollection != null) {
            ...
            if(contentSection != null) {
                ...
                result.setContentSectionDescriptions(contentControl.getContentSectionDescriptionTransfers(getUserVisit(), contentSection));
            } else {
