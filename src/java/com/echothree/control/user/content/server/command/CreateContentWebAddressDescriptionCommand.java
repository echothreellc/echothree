...
public class CreateContentWebAddressDescriptionCommand
        extends BaseSimpleCommand<CreateContentWebAddressDescriptionForm> {
    ...
    /** Creates a new instance of CreateContentWebAddressDescriptionCommand */
    public CreateContentWebAddressDescriptionCommand(UserVisitPK userVisitPK, CreateContentWebAddressDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(contentWebAddress != null) {
            ...
            if(language != null) {
                var contentWebAddressDescription = contentControl.getContentWebAddressDescription(contentWebAddress, language);
                ...
                if(contentWebAddressDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateContentWebAddressDescription.name());
                }
            } else {
