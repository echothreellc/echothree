...
import com.echothree.control.user.content.remote.form.DeleteContentSectionDescriptionForm;
...
public class DeleteContentSectionDescriptionCommand
        extends BaseSimpleCommand<DeleteContentSectionDescriptionForm> {
    ...
    /** Creates a new instance of DeleteContentSectionDescriptionCommand */
    public DeleteContentSectionDescriptionCommand(UserVisitPK userVisitPK, DeleteContentSectionDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(contentCollection != null) {
            ...
            if(contentSection != null) {
                ...
                if(language != null) {
                    ContentSectionDescription contentSectionDescription = contentControl.getContentSectionDescriptionForUpdate(contentSection, language);
                    
                    if(contentSectionDescription != null) {
                        contentControl.deleteContentSectionDescription(contentSectionDescription, getPartyPK());
                    } else {
