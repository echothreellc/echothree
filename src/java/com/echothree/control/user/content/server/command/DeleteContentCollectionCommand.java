...
import com.echothree.control.user.content.remote.form.DeleteContentCollectionForm;
...
public class DeleteContentCollectionCommand
        extends BaseSimpleCommand<DeleteContentCollectionForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.ContentCollection.name(), SecurityRoles.Delete.name())
                        )))
                )));
