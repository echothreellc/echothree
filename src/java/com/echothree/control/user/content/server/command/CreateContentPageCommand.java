...
import com.echothree.control.user.content.remote.form.CreateContentPageForm;
...
public class CreateContentPageCommand
        extends BaseSimpleCommand<CreateContentPageForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.ContentPage.name(), SecurityRoles.Create.name())
                        )))
                )));
