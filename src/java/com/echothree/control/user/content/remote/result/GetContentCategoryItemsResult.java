...
public interface GetContentCategoryItemsResult
        extends BaseResult {
    
    ContentCategoryTransfer getContentCategory();
    void setContentCategory(ContentCategoryTransfer contentCategory);
    
    Long getContentCategoryItemCount();
    void setContentCategoryItemCount(Long contentCategoryItemCount);

    List<ContentCategoryItemTransfer> getContentCategoryItems();
    void setContentCategoryItems(List<ContentCategoryItemTransfer> contentCategoryItems);
