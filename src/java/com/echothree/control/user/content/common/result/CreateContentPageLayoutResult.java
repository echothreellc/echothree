...
public interface CreateContentPageLayoutResult
        extends ContentPageLayoutSpec, EntityRefSpec, BaseResult {
    
    // Nothing additional beyond ContentPageLayoutSpec, EntityRefSpec, BaseResult
