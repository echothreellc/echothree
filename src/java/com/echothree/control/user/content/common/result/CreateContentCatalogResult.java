...
public interface CreateContentCatalogResult
        extends ContentCatalogSpec, EntityRefSpec, BaseResult {
    
    // Nothing additional beyond ContentCatalogSpec, EntityRefSpec, BaseResult
