...
public interface GetContentCatalogItemsResult
        extends BaseResult {
    
    ContentCatalogTransfer getContentCatalog();
    void setContentCatalog(ContentCatalogTransfer contentCatalog);
    
    Long getContentCatalogItemCount();
    void setContentCatalogItemCount(Long contentCatalogItemCount);

    List<ContentCatalogItemTransfer> getContentCatalogItems();
    void setContentCatalogItems(List<ContentCatalogItemTransfer> contentCatalogItems);
