...
public interface CreateContentCollectionResult
        extends ContentCollectionSpec, EntityRefSpec, BaseResult {
    
    // Nothing additional beyond ContentCollectionSpec, EntityRefSpec, BaseResult
