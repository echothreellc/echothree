...
public interface EditContentCollectionDescriptionResult
        extends BaseEditResult<ContentCollectionDescriptionEdit> {
    ...
    ContentCollectionDescriptionTransfer getContentCollectionDescription();

    void setContentCollectionDescription(ContentCollectionDescriptionTransfer contentCollection);
