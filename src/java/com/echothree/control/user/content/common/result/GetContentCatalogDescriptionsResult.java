...
public interface GetContentCatalogDescriptionsResult
        extends BaseResult {
    ...
    List<ContentCatalogDescriptionTransfer> getContentCatalogDescriptions();
    void setContentCatalogDescriptions(List<ContentCatalogDescriptionTransfer> contentCatalogDescriptions);
