...
public interface CreateContentWebAddressForm
        extends ContentWebAddressSpec, ContentWebAddressEdit {
    
    // Nothing additional beyond ContentWebAddressSpec, ContentWebAddressEdit
