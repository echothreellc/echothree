...
public interface CreateContentCategoryForm
        extends ContentCatalogSpec, ContentCategoryEdit {
    
    // Nothing additional beyond ContentCatalogSpec, ContentCategoryEdit
