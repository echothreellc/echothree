...
public interface CreateContentWebAddressResult
        extends ContentWebAddressSpec, EntityRefSpec, BaseResult {
    
    // Nothing additional beyond ContentWebAddressSpec, EntityRefSpec, BaseResult
