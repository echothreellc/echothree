...
public interface CreateContentCategoryResult
        extends ContentCategorySpec, EntityRefSpec, BaseResult {
    
    // Nothing additional beyond ContentCategorySpec, EntityRefSpec, BaseResult
