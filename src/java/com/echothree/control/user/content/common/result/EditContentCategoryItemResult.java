...
public interface EditContentCategoryItemResult
        extends BaseEditResult<ContentCategoryItemEdit> {

    ContentCategoryItemTransfer getContentCategoryItem();

    void setContentCategoryItem(ContentCategoryItemTransfer contentCategoryItem);
