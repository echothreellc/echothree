...
public class CreateRelatedItemTypeDescriptionCommand
        extends BaseSimpleCommand<CreateRelatedItemTypeDescriptionForm> {
    ...
    /** Creates a new instance of CreateRelatedItemTypeDescriptionCommand */
    public CreateRelatedItemTypeDescriptionCommand(UserVisitPK userVisitPK, CreateRelatedItemTypeDescriptionForm form) {
        ...
        if(relatedItemType != null) {
            ...
            if(language != null) {
                ...
                if(relatedItemTypeDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateRelatedItemTypeDescription.name(), relatedItemTypeName, languageIsoName);
                }
            } else {
