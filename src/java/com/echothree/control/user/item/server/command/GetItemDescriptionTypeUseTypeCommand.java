...
import com.echothree.control.user.item.remote.form.GetItemDescriptionTypeUseTypeForm;
import com.echothree.control.user.item.remote.result.GetItemDescriptionTypeUseTypeResult;
...
public class GetItemDescriptionTypeUseTypeCommand
        extends BaseSimpleCommand<GetItemDescriptionTypeUseTypeForm> {
    ...
    public GetItemDescriptionTypeUseTypeCommand(UserVisitPK userVisitPK, GetItemDescriptionTypeUseTypeForm form) {
