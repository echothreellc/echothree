...
import com.echothree.control.user.item.remote.form.DeleteHarmonizedTariffScheduleCodeUseTypeDescriptionForm;
...
public class DeleteHarmonizedTariffScheduleCodeUseTypeDescriptionCommand
        extends BaseSimpleCommand<DeleteHarmonizedTariffScheduleCodeUseTypeDescriptionForm> {
    ...
    /** Creates a new instance of DeleteHarmonizedTariffScheduleCodeUseTypeDescriptionCommand */
    public DeleteHarmonizedTariffScheduleCodeUseTypeDescriptionCommand(UserVisitPK userVisitPK, DeleteHarmonizedTariffScheduleCodeUseTypeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(harmonizedTariffScheduleCodeUseType != null) {
            ...
            if(language != null) {
                HarmonizedTariffScheduleCodeUseTypeDescription harmonizedTariffScheduleCodeUseTypeDescription = itemControl.getHarmonizedTariffScheduleCodeUseTypeDescriptionForUpdate(harmonizedTariffScheduleCodeUseType, language);
                
                if(harmonizedTariffScheduleCodeUseTypeDescription != null) {
                    itemControl.deleteHarmonizedTariffScheduleCodeUseTypeDescription(harmonizedTariffScheduleCodeUseTypeDescription, getPartyPK());
                } else {
