...
import com.echothree.control.user.item.remote.form.GetItemDescriptionTypeUseTypeDescriptionsForm;
import com.echothree.control.user.item.remote.result.GetItemDescriptionTypeUseTypeDescriptionsResult;
...
public class GetItemDescriptionTypeUseTypeDescriptionsCommand
        extends BaseSimpleCommand<GetItemDescriptionTypeUseTypeDescriptionsForm> {
    ...
    public GetItemDescriptionTypeUseTypeDescriptionsCommand(UserVisitPK userVisitPK, GetItemDescriptionTypeUseTypeDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetItemDescriptionTypeUseTypeDescriptionsResult result = ItemResultFactory.getGetItemDescriptionTypeUseTypeDescriptionsResult();
        ...
        if(itemDescriptionTypeUseType != null) {
            ...
            result.setItemDescriptionTypeUseTypeDescriptions(itemControl.getItemDescriptionTypeUseTypeDescriptionTransfersByItemDescriptionTypeUseType(getUserVisit(), itemDescriptionTypeUseType));
        } else {
