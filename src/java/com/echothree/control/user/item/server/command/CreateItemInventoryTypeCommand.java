...
import com.echothree.control.user.item.remote.form.CreateItemInventoryTypeForm;
...
public class CreateItemInventoryTypeCommand
    ...
    protected BaseResult execute() {
        ...
        if(itemInventoryType == null) {
            ...
            itemControl.createItemInventoryType(itemInventoryTypeName, isDefault, sortOrder);
        } else {
