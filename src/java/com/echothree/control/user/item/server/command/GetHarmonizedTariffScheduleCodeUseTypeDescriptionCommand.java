...
import com.echothree.control.user.item.remote.form.GetHarmonizedTariffScheduleCodeUseTypeDescriptionForm;
import com.echothree.control.user.item.remote.result.GetHarmonizedTariffScheduleCodeUseTypeDescriptionResult;
...
public class GetHarmonizedTariffScheduleCodeUseTypeDescriptionCommand
        extends BaseSimpleCommand<GetHarmonizedTariffScheduleCodeUseTypeDescriptionForm> {
    ...
    /** Creates a new instance of GetHarmonizedTariffScheduleCodeUseTypeDescriptionCommand */
    public GetHarmonizedTariffScheduleCodeUseTypeDescriptionCommand(UserVisitPK userVisitPK, GetHarmonizedTariffScheduleCodeUseTypeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetHarmonizedTariffScheduleCodeUseTypeDescriptionResult result = ItemResultFactory.getGetHarmonizedTariffScheduleCodeUseTypeDescriptionResult();
        ...
        if(harmonizedTariffScheduleCodeUseType != null) {
            ...
            if(language != null) {
                HarmonizedTariffScheduleCodeUseTypeDescription harmonizedTariffScheduleCodeUseTypeDescription = itemControl.getHarmonizedTariffScheduleCodeUseTypeDescription(harmonizedTariffScheduleCodeUseType, language);
