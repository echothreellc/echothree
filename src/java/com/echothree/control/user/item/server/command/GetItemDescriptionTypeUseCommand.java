...
public class GetItemDescriptionTypeUseCommand
        extends BaseSingleEntityCommand<ItemDescriptionTypeUse, GetItemDescriptionTypeUseForm> {
    ...
    protected ItemDescriptionTypeUse getEntity() {
        ...
        if(itemDescriptionType != null) {
            ...
            if(itemDescriptionTypeUseType != null) {
                itemDescriptionTypeUse = itemControl.getItemDescriptionTypeUse(itemDescriptionType, itemDescriptionTypeUseType);
