...
public class SetDefaultItemUnitOfMeasureTypeCommand
        extends BaseSimpleCommand<SetDefaultItemUnitOfMeasureTypeForm> {
    ...
    /** Creates a new instance of SetDefaultItemUnitOfMeasureTypeCommand */
    public SetDefaultItemUnitOfMeasureTypeCommand(UserVisitPK userVisitPK, SetDefaultItemUnitOfMeasureTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(item != null) {
            ...
            if(unitOfMeasureType != null) {
                ItemUnitOfMeasureTypeValue itemUnitOfMeasureTypeValue = itemControl.getItemUnitOfMeasureTypeValueForUpdate(item,
                        unitOfMeasureType);
