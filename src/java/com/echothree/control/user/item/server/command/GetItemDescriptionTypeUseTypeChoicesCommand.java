...
public class GetItemDescriptionTypeUseTypeChoicesCommand
        extends BaseSimpleCommand<GetItemDescriptionTypeUseTypeChoicesForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.ItemDescriptionTypeUseType.name(), SecurityRoles.Choices.name())
                        )))
                )));
        
        FORM_FIELD_DEFINITIONS = Collections.unmodifiableList(Arrays.asList(
                new FieldDefinition("DefaultItemDescriptionTypeUseTypeChoice", FieldType.ENTITY_NAME, false, null, null),
                new FieldDefinition("AllowNullChoice", FieldType.BOOLEAN, true, null, null)
                ));
    }
    
    /** Creates a new instance of GetItemDescriptionTypeUseTypeChoicesCommand */
    public GetItemDescriptionTypeUseTypeChoicesCommand(UserVisitPK userVisitPK, GetItemDescriptionTypeUseTypeChoicesForm form) {
