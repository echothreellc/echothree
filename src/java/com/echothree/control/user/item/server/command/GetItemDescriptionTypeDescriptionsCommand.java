...
public class GetItemDescriptionTypeDescriptionsCommand
        extends BaseSimpleCommand<GetItemDescriptionTypeDescriptionsForm> {
    ...
    /** Creates a new instance of GetItemDescriptionTypeDescriptionsCommand */
    public GetItemDescriptionTypeDescriptionsCommand(UserVisitPK userVisitPK, GetItemDescriptionTypeDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(itemDescriptionType != null) {
            ...
            result.setItemDescriptionTypeDescriptions(itemControl.getItemDescriptionTypeDescriptionTransfersByItemDescriptionType(getUserVisit(), itemDescriptionType));
        } else {
