...
import com.echothree.control.user.item.remote.form.GetItemCategoryDescriptionForm;
import com.echothree.control.user.item.remote.result.GetItemCategoryDescriptionResult;
...
public class GetItemCategoryDescriptionCommand
        extends BaseSimpleCommand<GetItemCategoryDescriptionForm> {
    ...
    /** Creates a new instance of GetItemCategoryDescriptionCommand */
    public GetItemCategoryDescriptionCommand(UserVisitPK userVisitPK, GetItemCategoryDescriptionForm form) {
