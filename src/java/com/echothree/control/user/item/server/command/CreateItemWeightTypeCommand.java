...
public class CreateItemWeightTypeCommand
        extends BaseSimpleCommand<CreateItemWeightTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.ItemWeightType.name(), SecurityRoles.Create.name())
                        )))
                )));
    ...
    protected BaseResult execute() {
        var result = ItemResultFactory.getCreateItemWeightTypeResult();
        ...
        if(itemWeightType != null) {
            result.setItemWeightTypeName(itemWeightType.getLastDetail().getItemWeightTypeName());
            result.setEntityRef(itemWeightType.getPrimaryKey().getEntityRef());
        }
