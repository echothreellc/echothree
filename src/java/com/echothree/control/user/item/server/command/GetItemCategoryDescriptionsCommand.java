...
import com.echothree.control.user.item.remote.form.GetItemCategoryDescriptionsForm;
import com.echothree.control.user.item.remote.result.GetItemCategoryDescriptionsResult;
...
public class GetItemCategoryDescriptionsCommand
        extends BaseSimpleCommand<GetItemCategoryDescriptionsForm> {
    ...
    /** Creates a new instance of GetItemCategoryDescriptionsCommand */
    public GetItemCategoryDescriptionsCommand(UserVisitPK userVisitPK, GetItemCategoryDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(itemCategory != null) {
            ...
            result.setItemCategoryDescriptions(itemControl.getItemCategoryDescriptionTransfersByItemCategory(getUserVisit(), itemCategory));
        } else {
