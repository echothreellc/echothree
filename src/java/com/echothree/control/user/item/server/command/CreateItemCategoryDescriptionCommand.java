...
public class CreateItemCategoryDescriptionCommand
        extends BaseSimpleCommand<CreateItemCategoryDescriptionForm> {
    ...
    /** Creates a new instance of CreateItemCategoryDescriptionCommand */
    public CreateItemCategoryDescriptionCommand(UserVisitPK userVisitPK, CreateItemCategoryDescriptionForm form) {
        ...
        if(itemCategory != null) {
            ...
            if(language != null) {
                ...
                if(itemCategoryDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateItemCategoryDescription.name(), itemCategoryName, languageIsoName);
                }
            } else {
