...
public class GetHarmonizedTariffScheduleCodeUseTypeDescriptionsCommand
    ...
    public GetHarmonizedTariffScheduleCodeUseTypeDescriptionsCommand() {
    ...
    protected BaseResult execute() {
        ...
        var result = ItemResultFactory.getGetHarmonizedTariffScheduleCodeUseTypeDescriptionsResult();
