...
import com.echothree.control.user.item.common.form.DeleteRelatedItemTypeDescriptionForm;
...
public class DeleteRelatedItemTypeDescriptionCommand
        extends BaseSimpleCommand<DeleteRelatedItemTypeDescriptionForm> {
    ...
    /** Creates a new instance of DeleteRelatedItemTypeDescriptionCommand */
    public DeleteRelatedItemTypeDescriptionCommand(UserVisitPK userVisitPK, DeleteRelatedItemTypeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(relatedItemType != null) {
            ...
            if(language != null) {
                RelatedItemTypeDescription relatedItemTypeDescription = itemControl.getRelatedItemTypeDescriptionForUpdate(relatedItemType, language);
                
                if(relatedItemTypeDescription != null) {
                    itemControl.deleteRelatedItemTypeDescription(relatedItemTypeDescription, getPartyPK());
                } else {
