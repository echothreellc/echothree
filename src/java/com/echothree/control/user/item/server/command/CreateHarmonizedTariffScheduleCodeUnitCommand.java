...
public class CreateHarmonizedTariffScheduleCodeUnitCommand
        extends BaseSimpleCommand<CreateHarmonizedTariffScheduleCodeUnitForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                    new SecurityRoleDefinition(SecurityRoleGroups.HarmonizedTariffScheduleCodeUnit.name(), SecurityRoles.Create.name())
                    )))
                )));
    ...
    /** Creates a new instance of CreateHarmonizedTariffScheduleCodeUnitCommand */
    public CreateHarmonizedTariffScheduleCodeUnitCommand(UserVisitPK userVisitPK, CreateHarmonizedTariffScheduleCodeUnitForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(harmonizedTariffScheduleCodeUnit == null) {
            ...
            harmonizedTariffScheduleCodeUnit = itemControl.createHarmonizedTariffScheduleCodeUnit(harmonizedTariffScheduleCodeUnitName, isDefault, sortOrder, partyPK);
