...
import com.echothree.control.user.item.common.form.GetItemWeightTypeForm;
...
public class GetItemWeightTypeCommand
        extends BaseSingleEntityCommand<ItemWeightType, GetItemWeightTypeForm> {
    ...
    protected BaseResult getResult(ItemWeightType itemWeightType) {
        ...
        if(itemWeightType != null) {
            result.setItemWeightType(itemWeightTypeControl.getItemWeightTypeTransfer(getUserVisit(), itemWeightType));
        }
