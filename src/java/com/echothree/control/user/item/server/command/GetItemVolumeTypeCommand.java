...
import com.echothree.control.user.item.common.form.GetItemVolumeTypeForm;
...
public class GetItemVolumeTypeCommand
        extends BaseSingleEntityCommand<ItemVolumeType, GetItemVolumeTypeForm> {
    ...
    protected BaseResult getResult(ItemVolumeType itemVolumeType) {
        ...
        if(itemVolumeType != null) {
            result.setItemVolumeType(itemVolumeTypeControl.getItemVolumeTypeTransfer(getUserVisit(), itemVolumeType));
        }
