...
import com.echothree.control.user.item.common.form.GetItemVolumeTypeDescriptionForm;
...
@RequestScoped
public class GetItemVolumeTypeDescriptionCommand
        extends BaseSimpleCommand<GetItemVolumeTypeDescriptionForm> {
    ...
    /** Creates a new instance of GetItemVolumeTypeDescriptionCommand */
    public GetItemVolumeTypeDescriptionCommand() {
    ...
    protected BaseResult execute() {
        ...
        var result = ItemResultFactory.getGetItemVolumeTypeDescriptionResult();
        ...
        if(itemVolumeType != null) {
            ...
            if(language != null) {
                var itemVolumeTypeDescription = itemControl.getItemVolumeTypeDescription(itemVolumeType, language);
