...
import com.echothree.control.user.item.remote.form.GetHarmonizedTariffScheduleCodeUseTypeForm;
import com.echothree.control.user.item.remote.result.GetHarmonizedTariffScheduleCodeUseTypeResult;
...
public class GetHarmonizedTariffScheduleCodeUseTypeCommand
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                    new SecurityRoleDefinition(SecurityRoleGroups.HarmonizedTariffScheduleCodeUseType.name(), SecurityRoles.Review.name())
                    )))
                )));
    ...
    /** Creates a new instance of GetHarmonizedTariffScheduleCodeUseTypeCommand */
    public GetHarmonizedTariffScheduleCodeUseTypeCommand(UserVisitPK userVisitPK, GetHarmonizedTariffScheduleCodeUseTypeForm form) {
