...
import com.echothree.control.user.item.remote.form.GetItemPriceTypesForm;
import com.echothree.control.user.item.remote.result.GetItemPriceTypesResult;
...
public class GetItemPriceTypesCommand
        extends BaseSimpleCommand<GetItemPriceTypesForm> {
