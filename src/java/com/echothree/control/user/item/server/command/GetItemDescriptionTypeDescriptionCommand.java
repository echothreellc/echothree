...
import com.echothree.control.user.item.remote.form.GetItemDescriptionTypeDescriptionForm;
import com.echothree.control.user.item.remote.result.GetItemDescriptionTypeDescriptionResult;
...
public class GetItemDescriptionTypeDescriptionCommand
        extends BaseSimpleCommand<GetItemDescriptionTypeDescriptionForm> {
    ...
    /** Creates a new instance of GetItemDescriptionTypeDescriptionCommand */
    public GetItemDescriptionTypeDescriptionCommand(UserVisitPK userVisitPK, GetItemDescriptionTypeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetItemDescriptionTypeDescriptionResult result = ItemResultFactory.getGetItemDescriptionTypeDescriptionResult();
