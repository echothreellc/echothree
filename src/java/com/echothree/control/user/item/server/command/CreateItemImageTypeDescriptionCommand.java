...
public class CreateItemImageTypeDescriptionCommand
        extends BaseSimpleCommand<CreateItemImageTypeDescriptionForm> {
    ...
    /** Creates a new instance of CreateItemImageTypeDescriptionCommand */
    public CreateItemImageTypeDescriptionCommand(UserVisitPK userVisitPK, CreateItemImageTypeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(itemImageType != null) {
            ...
            if(language != null) {
                var itemImageTypeDescription = itemControl.getItemImageTypeDescription(itemImageType, language);
                ...
                if(itemImageTypeDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateItemImageTypeDescription.name(), itemImageTypeName, languageIsoName);
                }
            } else {
