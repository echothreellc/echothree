...
import com.echothree.control.user.item.common.form.DeleteItemVolumeTypeDescriptionForm;
...
public class DeleteItemVolumeTypeDescriptionCommand
        extends BaseSimpleCommand<DeleteItemVolumeTypeDescriptionForm> {
    ...
    /** Creates a new instance of DeleteItemVolumeTypeDescriptionCommand */
    public DeleteItemVolumeTypeDescriptionCommand() {
    ...
    protected BaseResult execute() {
        ...
        if(itemVolumeType != null) {
            ...
            if(language != null) {
                var itemVolumeTypeDescription = itemControl.getItemVolumeTypeDescriptionForUpdate(itemVolumeType, language);
                
                if(itemVolumeTypeDescription != null) {
                    itemControl.deleteItemVolumeTypeDescription(itemVolumeTypeDescription, getPartyPK());
                } else {
