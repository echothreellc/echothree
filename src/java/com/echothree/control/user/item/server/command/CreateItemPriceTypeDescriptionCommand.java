...
public class CreateItemPriceTypeDescriptionCommand
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.ItemPriceType.name(), SecurityRoles.Description.name())
                )))
        )));
    ...
    protected BaseResult execute() {
        ...
        if(itemPriceType != null) {
            ...
            if(language != null) {
                var itemPriceTypeDescription = itemControl.getItemPriceTypeDescription(itemPriceType, language);
                
                if(itemPriceTypeDescription == null) {
                    var description = form.getDescription();
                    
                    itemControl.createItemPriceTypeDescription(itemPriceType, language, description, getPartyPK());
                } else {
