...
import com.echothree.control.user.item.remote.form.DeleteItemHarmonizedTariffScheduleCodeForm;
...
public class DeleteItemHarmonizedTariffScheduleCodeCommand
        extends BaseSimpleCommand<DeleteItemHarmonizedTariffScheduleCodeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                    new SecurityRoleDefinition(SecurityRoleGroups.ItemHarmonizedTariffScheduleCode.name(), SecurityRoles.Delete.name())
                    )))
                )));
        ...
        if(item != null) {
            ...
            if(countryGeoCode != null) {
                ...
                if(harmonizedTariffScheduleCodeUseType != null) {
                    ItemHarmonizedTariffScheduleCode itemHarmonizedTariffScheduleCode = itemControl.getItemHarmonizedTariffScheduleCodeForUpdate(item,
                            countryGeoCode, harmonizedTariffScheduleCodeUseType);

                    if(itemHarmonizedTariffScheduleCode != null) {
                        itemControl.deleteItemHarmonizedTariffScheduleCode(itemHarmonizedTariffScheduleCode, getPartyPK());
                    } else {
