...
import com.echothree.control.user.item.common.form.DeleteHarmonizedTariffScheduleCodeUnitDescriptionForm;
...
public class DeleteHarmonizedTariffScheduleCodeUnitDescriptionCommand
        extends BaseSimpleCommand<DeleteHarmonizedTariffScheduleCodeUnitDescriptionForm> {
    ...
    /** Creates a new instance of DeleteHarmonizedTariffScheduleCodeUnitDescriptionCommand */
    public DeleteHarmonizedTariffScheduleCodeUnitDescriptionCommand(UserVisitPK userVisitPK, DeleteHarmonizedTariffScheduleCodeUnitDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(harmonizedTariffScheduleCodeUnit != null) {
            ...
            if(language != null) {
                HarmonizedTariffScheduleCodeUnitDescription harmonizedTariffScheduleCodeUnitDescription = itemControl.getHarmonizedTariffScheduleCodeUnitDescriptionForUpdate(harmonizedTariffScheduleCodeUnit, language);
                
                if(harmonizedTariffScheduleCodeUnitDescription != null) {
                    itemControl.deleteHarmonizedTariffScheduleCodeUnitDescription(harmonizedTariffScheduleCodeUnitDescription, getPartyPK());
                } else {
