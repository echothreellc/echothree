...
public class DeleteItemImageTypeCommand
        extends BaseSimpleCommand<DeleteItemImageTypeForm> {
    ...
    public DeleteItemImageTypeCommand(UserVisitPK userVisitPK, DeleteItemImageTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        ItemImageType itemImageType = itemControl.getItemImageTypeByNameForUpdate(itemImageTypeName);
        
        if(itemImageType != null) {
            itemControl.deleteItemImageType(itemImageType, getPartyPK());
        } else {
