...
import com.echothree.control.user.item.common.form.SetDefaultItemDescriptionTypeForm;
...
public class SetDefaultItemDescriptionTypeCommand
        extends BaseSimpleCommand<SetDefaultItemDescriptionTypeForm> {
    ...
    /** Creates a new instance of SetDefaultItemDescriptionTypeCommand */
    public SetDefaultItemDescriptionTypeCommand(UserVisitPK userVisitPK, SetDefaultItemDescriptionTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        ItemDescriptionTypeDetailValue itemDescriptionTypeDetailValue = itemControl.getItemDescriptionTypeDetailValueByNameForUpdate(itemDescriptionTypeName);
