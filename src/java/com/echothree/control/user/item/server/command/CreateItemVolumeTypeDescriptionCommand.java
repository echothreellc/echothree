...
import com.echothree.control.user.item.common.form.CreateItemVolumeTypeDescriptionForm;
...
public class CreateItemVolumeTypeDescriptionCommand
        extends BaseSimpleCommand<CreateItemVolumeTypeDescriptionForm> {
        ...
        if(itemVolumeType != null) {
            ...
            if(language != null) {
                ...
                if(itemVolumeTypeDescription == null) {
                    ...
                    itemControl.createItemVolumeTypeDescription(itemVolumeType, language, description, getPartyPK());
                } else {
                    addExecutionError(ExecutionErrors.DuplicateItemVolumeTypeDescription.name(), itemVolumeTypeName, languageIsoName);
                }
            } else {
