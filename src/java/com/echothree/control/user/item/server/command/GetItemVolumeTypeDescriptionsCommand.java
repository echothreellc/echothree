...
import com.echothree.control.user.item.common.form.GetItemVolumeTypeDescriptionsForm;
...
public class GetItemVolumeTypeDescriptionsCommand
        extends BaseSimpleCommand<GetItemVolumeTypeDescriptionsForm> {
    ...
    protected BaseResult execute() {
        ...
        if(itemVolumeType != null) {
            ...
            result.setItemVolumeTypeDescriptions(itemControl.getItemVolumeTypeDescriptionTransfersByItemVolumeType(getUserVisit(), itemVolumeType));
        } else {
