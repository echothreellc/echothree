...
public class CreateHarmonizedTariffScheduleCodeUnitDescriptionCommand
        extends BaseSimpleCommand<CreateHarmonizedTariffScheduleCodeUnitDescriptionForm> {
    ...
    /** Creates a new instance of CreateHarmonizedTariffScheduleCodeUnitDescriptionCommand */
    public CreateHarmonizedTariffScheduleCodeUnitDescriptionCommand(UserVisitPK userVisitPK, CreateHarmonizedTariffScheduleCodeUnitDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(harmonizedTariffScheduleCodeUnit != null) {
            ...
            if(language != null) {
                var harmonizedTariffScheduleCodeUnitDescription = itemControl.getHarmonizedTariffScheduleCodeUnitDescription(harmonizedTariffScheduleCodeUnit, language);
                ...
                if(harmonizedTariffScheduleCodeUnitDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateHarmonizedTariffScheduleCodeUnitDescription.name());
                }
            } else {
