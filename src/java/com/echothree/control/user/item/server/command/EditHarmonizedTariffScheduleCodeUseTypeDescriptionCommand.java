...
import com.echothree.control.user.item.remote.form.EditHarmonizedTariffScheduleCodeUseTypeDescriptionForm;
import com.echothree.control.user.item.remote.result.EditHarmonizedTariffScheduleCodeUseTypeDescriptionResult;
import com.echothree.control.user.item.remote.result.ItemResultFactory;
import com.echothree.control.user.item.remote.spec.HarmonizedTariffScheduleCodeUseTypeDescriptionSpec;
...
public class EditHarmonizedTariffScheduleCodeUseTypeDescriptionCommand
    ...
    public EditHarmonizedTariffScheduleCodeUseTypeDescriptionCommand(UserVisitPK userVisitPK, EditHarmonizedTariffScheduleCodeUseTypeDescriptionForm form) {
