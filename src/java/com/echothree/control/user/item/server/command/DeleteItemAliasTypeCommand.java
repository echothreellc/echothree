...
import com.echothree.control.user.item.remote.form.DeleteItemAliasTypeForm;
...
public class DeleteItemAliasTypeCommand
        extends BaseSimpleCommand<DeleteItemAliasTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.ItemAliasType.name(), SecurityRoles.Delete.name())
                        )))
                )));
    ...
    public DeleteItemAliasTypeCommand(UserVisitPK userVisitPK, DeleteItemAliasTypeForm form) {
