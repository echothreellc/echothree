...
import com.echothree.control.user.item.remote.form.DeleteItemDescriptionTypeUseTypeForm;
...
public class DeleteItemDescriptionTypeUseTypeCommand
        extends BaseSimpleCommand<DeleteItemDescriptionTypeUseTypeForm> {
    ...
    public DeleteItemDescriptionTypeUseTypeCommand(UserVisitPK userVisitPK, DeleteItemDescriptionTypeUseTypeForm form) {
