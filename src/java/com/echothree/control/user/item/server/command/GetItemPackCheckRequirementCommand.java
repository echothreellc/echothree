...
import com.echothree.control.user.item.remote.form.GetItemPackCheckRequirementForm;
import com.echothree.control.user.item.remote.result.GetItemPackCheckRequirementResult;
...
public class GetItemPackCheckRequirementCommand
    ...
    public GetItemPackCheckRequirementCommand(UserVisitPK userVisitPK, GetItemPackCheckRequirementForm form) {
