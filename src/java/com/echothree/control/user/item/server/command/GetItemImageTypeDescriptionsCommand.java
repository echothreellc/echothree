...
import com.echothree.control.user.item.remote.form.GetItemImageTypeDescriptionsForm;
import com.echothree.control.user.item.remote.result.GetItemImageTypeDescriptionsResult;
...
public class GetItemImageTypeDescriptionsCommand
    ...
    public GetItemImageTypeDescriptionsCommand(UserVisitPK userVisitPK, GetItemImageTypeDescriptionsForm form) {
