...
public class DeleteItemVolumeCommand
        extends BaseSimpleCommand<DeleteItemVolumeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(List.of(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), List.of(
                        new SecurityRoleDefinition(SecurityRoleGroups.ItemVolume.name(), SecurityRoles.Delete.name())
                ))
        ));
            ...
            if(unitOfMeasureType != null) {
                ...
                if(!hasExecutionErrors()) {
                    ...
                    if(itemVolume != null) {
                        ...
                        addExecutionError(ExecutionErrors.UnknownItemVolume.name());
                    }
                }
            } else {
