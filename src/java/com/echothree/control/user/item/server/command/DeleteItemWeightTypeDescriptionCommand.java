...
import com.echothree.control.user.item.common.form.DeleteItemWeightTypeDescriptionForm;
...
@Dependent
public class DeleteItemWeightTypeDescriptionCommand
        extends BaseSimpleCommand<DeleteItemWeightTypeDescriptionForm> {
    ...
    /** Creates a new instance of DeleteItemWeightTypeDescriptionCommand */
    public DeleteItemWeightTypeDescriptionCommand() {
    ...
    protected BaseResult execute() {
        ...
        if(itemWeightType != null) {
            ...
            if(language != null) {
                var itemWeightTypeDescription = itemControl.getItemWeightTypeDescriptionForUpdate(itemWeightType, language);
                
                if(itemWeightTypeDescription != null) {
                    itemControl.deleteItemWeightTypeDescription(itemWeightTypeDescription, getPartyPK());
                } else {
