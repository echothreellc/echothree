...
public class GetItemCommand
    ...
    protected Item getEntity() {
        ...
        var parameterCount = (itemName == null ? 0 : 1) + (itemNameOrAlias == null ? 0 : 1) + entityInstanceLogic.countPossibleEntitySpecs(form);
        ...
        if(parameterCount == 1) {
            if(itemName == null && itemNameOrAlias == null) {
                ...
                item = itemNameOrAlias == null ? itemLogic.getItemByName(this, itemName) : itemLogic.getItemByNameThenAlias(this, itemNameOrAlias);
            }
