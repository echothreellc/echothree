...
public class CreateItemAliasTypeDescriptionCommand
        extends BaseSimpleCommand<CreateItemAliasTypeDescriptionForm> {
    ...
    /** Creates a new instance of CreateItemAliasTypeDescriptionCommand */
    public CreateItemAliasTypeDescriptionCommand(UserVisitPK userVisitPK, CreateItemAliasTypeDescriptionForm form) {
        ...
        if(itemAliasType != null) {
            ...
            if(language != null) {
                ...
                if(itemAliasTypeDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateItemAliasTypeDescription.name(), itemAliasTypeName, languageIsoName);
                }
            } else {
