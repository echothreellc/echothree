...
public class CreateHarmonizedTariffScheduleCodeUseCommand
        extends BaseSimpleCommand<CreateHarmonizedTariffScheduleCodeUseForm> {
    ...
    /** Creates a new instance of CreateHarmonizedTariffScheduleCodeUseCommand */
    public CreateHarmonizedTariffScheduleCodeUseCommand(UserVisitPK userVisitPK, CreateHarmonizedTariffScheduleCodeUseForm form) {
            ...
            if(harmonizedTariffScheduleCode != null) {
                ...
                if(harmonizedTariffScheduleCodeUseType != null) {
                    ...
                    if(harmonizedTariffScheduleCodeUse == null) {
                        itemControl.createHarmonizedTariffScheduleCodeUse(harmonizedTariffScheduleCode, harmonizedTariffScheduleCodeUseType, getPartyPK());
                    } else {
                        addExecutionError(ExecutionErrors.DuplicateHarmonizedTariffScheduleCodeUse.name(), countryName, harmonizedTariffScheduleCodeName, harmonizedTariffScheduleCodeUseTypeName);
                    }
                } else {
