...
public class GetItemAliasChecksumTypeCommand
    ...
    public GetItemAliasChecksumTypeCommand(UserVisitPK userVisitPK, GetItemAliasChecksumTypeForm form) {
    ...
    @Override
    protected BaseResult getTransfer(ItemAliasChecksumType itemAliasChecksumType) {
        var itemControl = Session.getModelController(ItemControl.class);
