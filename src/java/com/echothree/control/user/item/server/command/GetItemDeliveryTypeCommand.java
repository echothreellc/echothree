...
public class GetItemDeliveryTypeCommand
    ...
    @Inject
    ItemDeliveryTypeLogic itemDeliveryTypeLogic;
    ...
    protected ItemDeliveryType getEntity() {
        ...
        var parameterCount = (itemDeliveryTypeName == null ? 0 : 1) + entityInstanceLogic.countPossibleEntitySpecs(form);
        ...
        if(parameterCount == 1) {
            if(itemDeliveryTypeName == null) {
                ...
                itemDeliveryType = itemDeliveryTypeLogic.getItemDeliveryTypeByName(this, itemDeliveryTypeName);
            }
