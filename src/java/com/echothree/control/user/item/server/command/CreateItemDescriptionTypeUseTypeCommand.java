...
public class CreateItemDescriptionTypeUseTypeCommand
        extends BaseSimpleCommand<CreateItemDescriptionTypeUseTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.ItemDescriptionTypeUseType.name(), SecurityRoles.Create.name())
                        )))
                )));
    ...
    public CreateItemDescriptionTypeUseTypeCommand(UserVisitPK userVisitPK, CreateItemDescriptionTypeUseTypeForm form) {
