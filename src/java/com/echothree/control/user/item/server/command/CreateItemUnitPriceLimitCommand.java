...
public class CreateItemUnitPriceLimitCommand
        extends BaseSimpleCommand<CreateItemUnitPriceLimitForm> {
                        ...
                        if(currency != null) {
                            ...
                            if(itemUnitPriceLimit == null) {
                                ...
                                if(!hasExecutionErrors()) {
                                    itemControl.createItemUnitPriceLimit(item, inventoryCondition, unitOfMeasureType, currency, minimumUnitPrice, maximumUnitPrice, getPartyPK());
                                }
                            } else {
                                addExecutionError(ExecutionErrors.DuplicateItemUnitPriceLimit.name());
                            }
                        } else {
