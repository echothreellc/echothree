...
import com.echothree.control.user.item.common.form.SetDefaultItemVolumeTypeForm;
...
public class SetDefaultItemVolumeTypeCommand
        extends BaseSimpleCommand<SetDefaultItemVolumeTypeForm> {
    ...
    protected BaseResult execute() {
        ...
        if(itemVolumeTypeDetailValue != null) {
            itemVolumeTypeDetailValue.setIsDefault(true);
            itemControl.updateItemVolumeTypeFromValue(itemVolumeTypeDetailValue, getPartyPK());
        } else {
