...
public interface CreateItemPackCheckRequirementForm
        extends ItemPackCheckRequirementSpec, ItemPackCheckRequirementEdit {
    
    // Nothing additional beyond ItemPackCheckRequirementSpec, ItemPackCheckRequirementEdit
