...
public interface CreateItemVolumeTypeResult
        extends ItemVolumeTypeSpec, EntityRefSpec, BaseResult {
    
    // Nothing additional beyond ItemVolumeTypeSpec, EntityRefSpec, BaseResult
