...
public interface GetItemDescriptionTypeUsesForm
        extends ItemDescriptionTypeUseTypeSpec, ItemDescriptionTypeSpec {
    
    // Nothing additional beyond ItemDescriptionTypeUseTypeSpec, ItemDescriptionTypeSpec
