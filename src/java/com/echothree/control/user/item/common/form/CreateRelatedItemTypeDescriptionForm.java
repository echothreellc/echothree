...
public interface CreateRelatedItemTypeDescriptionForm
        extends RelatedItemTypeDescriptionSpec, RelatedItemTypeDescriptionEdit {
    
    // Nothing additional beyond RelatedItemTypeDescriptionSpec, RelatedItemTypeDescriptionEdit
