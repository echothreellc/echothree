...
public interface CreateItemUnitOfMeasureTypeForm
        extends ItemUnitOfMeasureTypeSpec, ItemUnitOfMeasureTypeEdit {
    
    // Nothing additional beyond ItemUnitOfMeasureTypeSpec, ItemUnitOfMeasureTypeEdit
