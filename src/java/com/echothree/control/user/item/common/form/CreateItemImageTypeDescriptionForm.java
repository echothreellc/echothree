...
public interface CreateItemImageTypeDescriptionForm
        extends ItemImageTypeDescriptionSpec, ItemImageTypeDescriptionEdit {
    
    // Nothing additional beyond ItemImageTypeDescriptionSpec, ItemImageTypeDescriptionEdit
