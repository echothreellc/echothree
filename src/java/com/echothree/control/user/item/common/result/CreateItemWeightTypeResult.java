...
public interface CreateItemWeightTypeResult
        extends ItemWeightTypeSpec, EntityRefSpec, BaseResult {
    
    // Nothing additional beyond ItemWeightTypeSpec, EntityRefSpec, BaseResult
