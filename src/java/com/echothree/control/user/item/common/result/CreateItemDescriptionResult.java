...
public interface CreateItemDescriptionResult
        extends ItemDescriptionSpec, EntityRefSpec, BaseResult {
    
    // Nothing additional beyond ItemDescriptionSpec, EntityRefSpec, BaseResult
