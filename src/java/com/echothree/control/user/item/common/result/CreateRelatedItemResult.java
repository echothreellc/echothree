...
public interface CreateRelatedItemResult
        extends RelatedItemSpec, EntityRefSpec, BaseResult {
    
    // Nothing additional beyond RelatedItemSpec, EntityRefSpec, BaseResult
