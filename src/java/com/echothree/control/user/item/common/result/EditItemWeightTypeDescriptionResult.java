...
public interface EditItemWeightTypeDescriptionResult
        extends BaseEditResult<ItemWeightTypeDescriptionEdit> {
    
    ItemWeightTypeDescriptionTransfer getItemWeightTypeDescription();
    void setItemWeightTypeDescription(ItemWeightTypeDescriptionTransfer itemWeightTypeDescription);
