...
public interface EditItemVolumeTypeDescriptionResult
        extends BaseEditResult<ItemVolumeTypeDescriptionEdit> {
    
    ItemVolumeTypeDescriptionTransfer getItemVolumeTypeDescription();
    void setItemVolumeTypeDescription(ItemVolumeTypeDescriptionTransfer itemVolumeTypeDescription);
