...
public interface GetHarmonizedTariffScheduleCodeUseTypeDescriptionsResult
        extends BaseResult {
    ...
    List<HarmonizedTariffScheduleCodeUseTypeDescriptionTransfer> getHarmonizedTariffScheduleCodeUseTypeDescriptions();
    void setHarmonizedTariffScheduleCodeUseTypeDescriptions(List<HarmonizedTariffScheduleCodeUseTypeDescriptionTransfer> harmonizedTariffScheduleCodeUseTypeDescriptions);
