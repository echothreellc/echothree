...
public interface CreateItemCountryOfOriginForm
        extends ItemCountryOfOriginSpec, ItemCountryOfOriginEdit {
    
    // Nothing additional beyond ItemCountryOfOriginSpec, ItemCountryOfOriginEdit
