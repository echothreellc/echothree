...
public interface CreateItemDescriptionTypeUseTypeForm
        extends ItemDescriptionTypeUseTypeEdit, MimeTypeUsageTypeSpec {
    
    // Nothing additional beyond ItemDescriptionTypeUseTypeEdit
