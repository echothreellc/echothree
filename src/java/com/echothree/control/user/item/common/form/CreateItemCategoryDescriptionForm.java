...
public interface CreateItemCategoryDescriptionForm
        extends ItemCategoryDescriptionSpec, ItemCategoryDescriptionEdit {
    
    // Nothing additional beyond ItemCategoryDescriptionSpec, ItemCategoryDescriptionEdit
