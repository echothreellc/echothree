...
public interface GetWorkflowsResult
        extends BaseResult {
    ...
    void setWorkflowCount(Long workflowCount);

    List<WorkflowTransfer> getWorkflows();
    void setWorkflows(List<WorkflowTransfer> workflows);
