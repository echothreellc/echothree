...
public interface GetWorkflowStepDescriptionsResult
        extends BaseResult {
    ...
    List<WorkflowStepDescriptionTransfer> getWorkflowStepDescriptions();
    void setWorkflowStepDescriptions(List<WorkflowStepDescriptionTransfer> workflowStepDescriptions);
