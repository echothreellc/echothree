...
public interface CreateWorkflowDestinationForm
        extends WorkflowDestinationSpec, WorkflowDestinationEdit {
    
    // Nothing additional beyond WorkflowDestinationSpec, WorkflowDestinationEdit
