...
public interface CreateWorkflowEntranceResult
        extends EntityRefSpec, WorkflowEntranceSpec, BaseResult {

    // Nothing additional beyond EntityRefSpec, WorkflowEntranceSpec, BaseResult
