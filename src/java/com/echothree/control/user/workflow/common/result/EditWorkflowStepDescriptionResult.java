...
public interface EditWorkflowStepDescriptionResult
        extends BaseEditResult<WorkflowStepDescriptionEdit> {
    
    WorkflowStepDescriptionTransfer getWorkflowStepDescription();
    void setWorkflowStepDescription(WorkflowStepDescriptionTransfer workflowStepDescription);
