...
public interface GetWorkflowStepChoicesForm
        extends WorkflowSpec {
    
    String getDefaultWorkflowStepChoice();
    void setDefaultWorkflowStepChoice(String defaultWorkflowStepChoice);
