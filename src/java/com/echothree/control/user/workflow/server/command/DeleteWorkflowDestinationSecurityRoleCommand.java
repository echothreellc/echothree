...
@Dependent
public class DeleteWorkflowDestinationSecurityRoleCommand
        extends BaseSimpleCommand<DeleteWorkflowDestinationSecurityRoleForm> {
                    ...
                    if(partyType != null) {
                        ...
                        if(workflowDestinationPartyType != null) {
                            ...
                            addExecutionError(ExecutionErrors.UnknownWorkflowDestinationPartyType.name(), workflowName,
                                    workflowDestinationName, partyTypeName);
                        }
                    } else {
