...
@Dependent
public class CreateWorkflowEntranceCommand
        extends BaseSimpleCommand<CreateWorkflowEntranceForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                    new SecurityRoleDefinition(SecurityRoleGroups.WorkflowEntrance.name(), SecurityRoles.Create.name())
                    )))
                )));
    ...
    protected BaseResult execute() {
        ...
        if(workflow != null) {
            ...
            if(workflowEntrance == null) {
                ...
                workflowEntrance = workflowControl.createWorkflowEntrance(workflow, workflowEntranceName, isDefault, sortOrder, partyPK);
                
                if(description != null) {
                    workflowControl.createWorkflowEntranceDescription(workflowEntrance, getPreferredLanguage(), description, partyPK);
                }
            } else {
                addExecutionError(ExecutionErrors.DuplicateWorkflowEntrance.name());
            }
        } else {
