...
import com.echothree.control.user.workflow.common.form.CreateWorkflowDestinationDescriptionForm;
...
public class CreateWorkflowDestinationDescriptionCommand
        extends BaseSimpleCommand<CreateWorkflowDestinationDescriptionForm> {
    ...
    /** Creates a new instance of CreateWorkflowDestinationDescriptionCommand */
    public CreateWorkflowDestinationDescriptionCommand(UserVisitPK userVisitPK, CreateWorkflowDestinationDescriptionForm form) {
                ...
                if(workflowDestination != null) {
                    ...
                    if(language != null) {
                        ...
                        if(workflowStepDescription == null) {
                            ...
                            addExecutionError(ExecutionErrors.DuplicateWorkflowDestinationDescription.name());
                        }
                    } else {
