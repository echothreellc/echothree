...
public class GetWorkflowDestinationPartyTypesCommand
        extends BasePaginatedMultipleEntitiesCommand<WorkflowDestinationPartyType, GetWorkflowDestinationPartyTypesForm> {
    ...
    @Override
    protected Collection<WorkflowDestinationPartyType> getEntities() {
    ...
    protected BaseResult getResult(Collection<WorkflowDestinationPartyType> entities) {
        ...
        if(entities != null) {
            ...
            result.setWorkflowDestinationPartyTypes(workflowControl.getWorkflowDestinationPartyTypeTransfers(userVisit, entities));
        }
