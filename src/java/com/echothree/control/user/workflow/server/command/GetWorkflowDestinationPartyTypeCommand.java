...
public class GetWorkflowDestinationPartyTypeCommand
        extends BaseSingleEntityCommand<WorkflowDestinationPartyType, GetWorkflowDestinationPartyTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(List.of(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, List.of(
    ...
    @Override
    protected WorkflowDestinationPartyType getEntity() {
    ...
    @Override
    protected BaseResult getTransfer(WorkflowDestinationPartyType entity) {
