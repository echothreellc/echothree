...
import com.echothree.control.user.workflow.remote.form.CreateWorkflowStepDescriptionForm;
...
public class CreateWorkflowStepDescriptionCommand
        extends BaseSimpleCommand<CreateWorkflowStepDescriptionForm> {
    ...
    /** Creates a new instance of CreateWorkflowStepDescriptionCommand */
    public CreateWorkflowStepDescriptionCommand(UserVisitPK userVisitPK, CreateWorkflowStepDescriptionForm form) {
            ...
            if(workflowStep != null) {
                ...
                if(language != null) {
                    ...
                    if(workflowStepDescription == null) {
                        ...
                        addExecutionError(ExecutionErrors.DuplicateWorkflowStepDescription.name());
                    }
                } else {
