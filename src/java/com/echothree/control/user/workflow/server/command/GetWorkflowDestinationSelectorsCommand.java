...
import com.echothree.control.user.workflow.remote.form.GetWorkflowDestinationSelectorsForm;
import com.echothree.control.user.workflow.remote.result.GetWorkflowDestinationSelectorsResult;
...
public class GetWorkflowDestinationSelectorsCommand
        extends BaseSimpleCommand<GetWorkflowDestinationSelectorsForm> {
    ...
    public GetWorkflowDestinationSelectorsCommand(UserVisitPK userVisitPK, GetWorkflowDestinationSelectorsForm form) {
        ...
        if(workflow != null) {
            ...
            if(workflowStep != null) {
                ...
                if(workflowDestination != null) {
                    ...
                    result.setWorkflowDestinationSelectors(workflowControl.getWorkflowDestinationSelectorTransfersByWorkflowDestination(getUserVisit(), workflowDestination));
                } else {
