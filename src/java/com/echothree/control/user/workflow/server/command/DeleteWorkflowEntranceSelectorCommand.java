...
import com.echothree.control.user.workflow.common.form.DeleteWorkflowEntranceSelectorForm;
...
public class DeleteWorkflowEntranceSelectorCommand
        extends BaseSimpleCommand<DeleteWorkflowEntranceSelectorForm> {
                ...
                if(workflowEntrance != null) {
                    ...
                    if(selector != null) {
                        ...
                        if(workflowEntranceSelector != null) {
                            ...
                            addExecutionError(ExecutionErrors.UnknownWorkflowEntranceSelector.name());
                        }
                    } else {
