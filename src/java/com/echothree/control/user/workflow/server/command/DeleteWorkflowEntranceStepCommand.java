...
public class DeleteWorkflowEntranceStepCommand
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.WorkflowEntranceStep.name(), SecurityRoles.Delete.name())
                        )))
                )));
    ...
    public DeleteWorkflowEntranceStepCommand(UserVisitPK userVisitPK, DeleteWorkflowEntranceStepForm form) {
