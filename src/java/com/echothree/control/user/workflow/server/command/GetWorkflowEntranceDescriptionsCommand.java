...
import com.echothree.control.user.workflow.remote.form.GetWorkflowEntranceDescriptionsForm;
import com.echothree.control.user.workflow.remote.result.GetWorkflowEntranceDescriptionsResult;
...
public class GetWorkflowEntranceDescriptionsCommand
        extends BaseSimpleCommand<GetWorkflowEntranceDescriptionsForm> {
    ...
    /** Creates a new instance of GetWorkflowEntranceDescriptionsCommand */
    public GetWorkflowEntranceDescriptionsCommand(UserVisitPK userVisitPK, GetWorkflowEntranceDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(workflow != null) {
            ...
            if(workflowEntrance != null) {
                ...
                result.setWorkflowEntranceDescriptions(workflowControl.getWorkflowEntranceDescriptionTransfersByWorkflowEntrance(getUserVisit(), workflowEntrance));
            } else {
