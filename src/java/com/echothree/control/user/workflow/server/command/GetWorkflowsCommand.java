...
import com.echothree.control.user.workflow.remote.form.GetWorkflowsForm;
import com.echothree.control.user.workflow.remote.result.GetWorkflowsResult;
...
public class GetWorkflowsCommand
        extends BaseSimpleCommand<GetWorkflowsForm> {
    ...
    protected BaseResult execute() {
        ...
        if(selectorKindName == null) {
            ...
            if(selectorKind != null) {
                ...
                result.setWorkflows(workflowControl.getWorkflowTransfersBySelectorKind(userVisit, selectorKind));
            } else {
