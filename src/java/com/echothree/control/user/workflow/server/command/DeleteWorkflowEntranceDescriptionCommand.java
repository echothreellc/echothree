...
import com.echothree.control.user.workflow.common.form.DeleteWorkflowEntranceDescriptionForm;
...
public class DeleteWorkflowEntranceDescriptionCommand
        extends BaseSimpleCommand<DeleteWorkflowEntranceDescriptionForm> {
    ...
    /** Creates a new instance of DeleteWorkflowEntranceDescriptionCommand */
    public DeleteWorkflowEntranceDescriptionCommand(UserVisitPK userVisitPK, DeleteWorkflowEntranceDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(workflow != null) {
            ...
            if(workflowEntrance != null) {
                ...
                if(language != null) {
                    WorkflowEntranceDescription workflowStepDescription = workflowControl.getWorkflowEntranceDescriptionForUpdate(workflowEntrance, language);
                    
                    if(workflowStepDescription != null) {
                        workflowControl.deleteWorkflowEntranceDescription(workflowStepDescription, getPartyPK());
                    } else {
