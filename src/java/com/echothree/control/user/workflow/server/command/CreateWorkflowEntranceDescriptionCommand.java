...
public class CreateWorkflowEntranceDescriptionCommand
        extends BaseSimpleCommand<CreateWorkflowEntranceDescriptionForm> {
    ...
    /** Creates a new instance of CreateWorkflowEntranceDescriptionCommand */
    public CreateWorkflowEntranceDescriptionCommand(UserVisitPK userVisitPK, CreateWorkflowEntranceDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(workflow != null) {
            ...
            if(workflowEntrance != null) {
                ...
                if(language != null) {
                    var workflowStepDescription = workflowControl.getWorkflowEntranceDescription(workflowEntrance, language);
                    ...
                    if(workflowStepDescription == null) {
                        ...
                        addExecutionError(ExecutionErrors.DuplicateWorkflowEntranceDescription.name());
                    }
                } else {
