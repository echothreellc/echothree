...
import com.echothree.control.user.workflow.common.form.GetWorkflowStepDescriptionsForm;
import com.echothree.control.user.workflow.common.result.GetWorkflowStepDescriptionsResult;
...
public class GetWorkflowStepDescriptionsCommand
        extends BaseSimpleCommand<GetWorkflowStepDescriptionsForm> {
    ...
    protected BaseResult execute() {
        ...
        var result = WorkflowResultFactory.getGetWorkflowStepDescriptionsResult();
        ...
        if(workflow != null) {
            ...
            if(workflowStep != null) {
                ...
                result.setWorkflowStepDescriptions(workflowControl.getWorkflowStepDescriptionTransfersByWorkflowStep(getUserVisit(), workflowStep));
            } else {
