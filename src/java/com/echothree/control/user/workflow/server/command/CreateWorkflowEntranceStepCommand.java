...
import com.echothree.control.user.workflow.remote.form.CreateWorkflowEntranceStepForm;
...
public class CreateWorkflowEntranceStepCommand
        extends BaseSimpleCommand<CreateWorkflowEntranceStepForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.WorkflowEntranceStep.name(), SecurityRoles.Create.name())
                        )))
                )));
    ...
    /** Creates a new instance of CreateWorkflowEntranceStepCommand */
    public CreateWorkflowEntranceStepCommand(UserVisitPK userVisitPK, CreateWorkflowEntranceStepForm form) {
                ...
                if(entranceWorkflow != null) {
                    ...
                    if(entranceWorkflowStep != null) {
                        ...
                        if(workflowEntranceStep == null) {
                            workflowControl.createWorkflowEntranceStep(workflowEntrance, entranceWorkflowStep, getPartyPK());
                        } else {
                            addExecutionError(ExecutionErrors.DuplicateWorkflowEntranceStep.name(), workflowName, workflowEntranceName, entranceWorkflowName,
