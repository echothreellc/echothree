...
public class GetWorkflowDestinationsCommand
    ...
    protected BaseResult execute() {
        ...
        GetWorkflowDestinationsResult result = WorkflowResultFactory.getGetWorkflowDestinationsResult();
        ...
        if(workflow != null) {
            ...
            if(workflowStep != null) {
                ...
                result.setWorkflowDestinations(workflowControl.getWorkflowDestinationTransfersByWorkflowStep(getUserVisit(), workflowStep));
            } else {
