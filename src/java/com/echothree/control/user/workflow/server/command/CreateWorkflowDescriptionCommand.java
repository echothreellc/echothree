...
public class CreateWorkflowDescriptionCommand
        extends BaseSimpleCommand<CreateWorkflowDescriptionForm> {
    ...
    /** Creates a new instance of CreateWorkflowDescriptionCommand */
    public CreateWorkflowDescriptionCommand(UserVisitPK userVisitPK, CreateWorkflowDescriptionForm form) {
        ...
        if(workflow != null) {
            ...
            if(language != null) {
                ...
                if(workflowDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateWorkflowDescription.name());
                }
            } else {
