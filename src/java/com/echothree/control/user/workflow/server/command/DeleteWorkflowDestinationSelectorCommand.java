...
import com.echothree.control.user.workflow.common.form.DeleteWorkflowDestinationSelectorForm;
...
public class DeleteWorkflowDestinationSelectorCommand
    ...
    public DeleteWorkflowDestinationSelectorCommand() {
            ...
            if(selectorType != null) {
                ...
                if(workflowStep != null) {
                    ...
                    if(workflowDestination != null) {
                        ...
                        if(selector != null) {
                            var workflowDestinationSelector = workflowControl.getWorkflowDestinationSelectorForUpdate(workflowDestination, selector);
