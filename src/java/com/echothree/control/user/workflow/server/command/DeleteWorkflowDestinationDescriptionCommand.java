...
public class DeleteWorkflowDestinationDescriptionCommand
        extends BaseSimpleCommand<DeleteWorkflowDestinationDescriptionForm> {
        ...
        if(workflow != null) {
            ...
            if(workflowStep != null) {
                ...
                if(workflowDestination != null) {
                    ...
                    if(language != null) {
                        WorkflowDestinationDescription workflowStepDescription = workflowControl.getWorkflowDestinationDescriptionForUpdate(workflowDestination, language);
                        
                        if(workflowStepDescription != null) {
                            workflowControl.deleteWorkflowDestinationDescription(workflowStepDescription, getPartyPK());
                        } else {
