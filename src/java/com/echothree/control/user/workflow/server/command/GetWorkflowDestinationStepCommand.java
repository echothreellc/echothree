...
import com.echothree.control.user.workflow.remote.form.GetWorkflowDestinationStepForm;
import com.echothree.control.user.workflow.remote.result.GetWorkflowDestinationStepResult;
...
public class GetWorkflowDestinationStepCommand
        extends BaseSimpleCommand<GetWorkflowDestinationStepForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.WorkflowDestinationStep.name(), SecurityRoles.Review.name())
                        )))
                )));
    ...
    protected BaseResult execute() {
        ...
        GetWorkflowDestinationStepResult result = WorkflowResultFactory.getGetWorkflowDestinationStepResult();
                    ...
                    if(destinationWorkflow != null) {
                        ...
                        if(destinationWorkflowStep != null) {
                            ...
                            if(workflowDestinationStep != null) {
                                result.setWorkflowDestinationStep(workflowControl.getWorkflowDestinationStepTransfer(getUserVisit(), workflowDestinationStep));
                            } else {
