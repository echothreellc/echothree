...
import com.echothree.control.user.workflow.remote.form.GetWorkflowEntranceSecurityRolesForm;
import com.echothree.control.user.workflow.remote.result.GetWorkflowEntranceSecurityRolesResult;
...
public class GetWorkflowEntranceSecurityRolesCommand
        extends BaseSimpleCommand<GetWorkflowEntranceSecurityRolesForm> {
    ...
    protected BaseResult execute() {
        ...
        GetWorkflowEntranceSecurityRolesResult result = WorkflowResultFactory.getGetWorkflowEntranceSecurityRolesResult();
            ...
            if(workflowEntrance != null) {
                ...
                if(partyType != null) {
                    ...
                    if(workflowEntrancePartyType != null) {
                        ...
                        result.setWorkflowEntranceSecurityRoles(workflowControl.getWorkflowEntranceSecurityRoleTransfersByWorkflowEntrancePartyType(userVisit, workflowEntrancePartyType));
                    } else {
