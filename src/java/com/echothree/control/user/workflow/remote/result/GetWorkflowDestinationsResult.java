...
public interface GetWorkflowDestinationsResult
        extends BaseResult {
    ...
    List<WorkflowDestinationTransfer> getWorkflowDestinations();
    void setWorkflowDestinations(List<WorkflowDestinationTransfer> workflowDestinations);
