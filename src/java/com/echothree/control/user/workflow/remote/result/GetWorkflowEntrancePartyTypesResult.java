...
public interface GetWorkflowEntrancePartyTypesResult
        extends BaseResult {
    
    WorkflowEntranceTransfer getWorkflowEntrance();
    void setWorkflowEntrance(WorkflowEntranceTransfer workflowEntrance);
    
    List<WorkflowEntrancePartyTypeTransfer> getWorkflowEntrancePartyTypes();
    void setWorkflowEntrancePartyTypes(List<WorkflowEntrancePartyTypeTransfer> workflowEntrancePartyTypes);
