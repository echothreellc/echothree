...
public interface GetWorkflowDestinationStepsResult
    ...
    List<WorkflowDestinationStepTransfer> getWorkflowDestinationSteps();
    void setWorkflowDestinationSteps(List<WorkflowDestinationStepTransfer> workflowDestinationSteps);
