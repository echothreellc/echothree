...
public interface GetWorkflowEntrancesResult
        extends BaseResult {
    
    WorkflowTransfer getWorkflow();
    void setWorkflow(WorkflowTransfer workflow);
    
    List<WorkflowEntranceTransfer> getWorkflowEntrances();
    void setWorkflowEntrances(List<WorkflowEntranceTransfer> workflowEntrances);
