...
public interface GetWorkflowDestinationDescriptionsResult
        extends BaseResult {
    ...
    List<WorkflowDestinationDescriptionTransfer> getWorkflowDestinationDescriptions();
    void setWorkflowDestinationDescriptions(List<WorkflowDestinationDescriptionTransfer> workflowDestinationDescriptions);
