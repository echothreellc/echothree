...
public interface CreateFilterAdjustmentFixedAmountForm
        extends FilterAdjustmentFixedAmountSpec, FilterAdjustmentFixedAmountEdit {
    
    // Nothing additional beyond FilterAdjustmentFixedAmountSpec, FilterAdjustmentFixedAmountEdit
