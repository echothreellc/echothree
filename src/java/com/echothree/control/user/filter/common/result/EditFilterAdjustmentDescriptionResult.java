...
public interface EditFilterAdjustmentDescriptionResult
        extends BaseEditResult<FilterAdjustmentDescriptionEdit> {
    
    FilterAdjustmentDescriptionTransfer getFilterAdjustmentDescription();
    void setFilterAdjustmentDescription(FilterAdjustmentDescriptionTransfer filterAdjustmentDescription);
