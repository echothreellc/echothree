...
public interface GetFilterAdjustmentDescriptionsResult
        extends BaseResult {
    ...
    List<FilterAdjustmentDescriptionTransfer> getFilterAdjustmentDescriptions();
    void setFilterAdjustmentDescriptions(List<FilterAdjustmentDescriptionTransfer> filterAdjustmentDescriptions);
