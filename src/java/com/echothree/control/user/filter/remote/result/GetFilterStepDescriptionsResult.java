...
public interface GetFilterStepDescriptionsResult
        extends BaseResult {
    ...
    List<FilterStepDescriptionTransfer> getFilterStepDescriptions();
    void setFilterStepDescriptions(List<FilterStepDescriptionTransfer> filterStepDescriptions);
