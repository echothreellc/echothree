...
import com.echothree.control.user.filter.remote.form.CreateFilterKindForm;
...
public class CreateFilterKindCommand
        extends BaseSimpleCommand<CreateFilterKindForm> {
    ...
    public CreateFilterKindCommand(UserVisitPK userVisitPK, CreateFilterKindForm form) {
