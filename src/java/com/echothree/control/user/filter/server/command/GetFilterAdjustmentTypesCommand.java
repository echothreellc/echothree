...
public class GetFilterAdjustmentTypesCommand
    ...
    public GetFilterAdjustmentTypesCommand(UserVisitPK userVisitPK, GetFilterAdjustmentTypesForm form) {
    ...
    @Override
    protected BaseResult getTransfers(Collection<FilterAdjustmentType> entities) {
