...
public class CreateFilterAdjustmentTypeDescriptionCommand
        extends BaseSimpleCommand<CreateFilterAdjustmentTypeDescriptionForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(List.of(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), List.of(
                        new SecurityRoleDefinition(SecurityRoleGroups.FilterAdjustmentType.name(), SecurityRoles.Description.name())
                ))
        ));
    ...
    public CreateFilterAdjustmentTypeDescriptionCommand(UserVisitPK userVisitPK, CreateFilterAdjustmentTypeDescriptionForm form) {
