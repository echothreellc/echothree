...
public class CreateFilterAdjustmentTypeCommand
        extends BaseSimpleCommand<CreateFilterAdjustmentTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(List.of(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), List.of(
                        new SecurityRoleDefinition(SecurityRoleGroups.FilterAdjustmentType.name(), SecurityRoles.Create.name())
                ))
        ));
    ...
    public CreateFilterAdjustmentTypeCommand(UserVisitPK userVisitPK, CreateFilterAdjustmentTypeForm form) {
