...
public class SetDefaultFilterCommand
        extends BaseSimpleCommand<SetDefaultFilterForm> {
    ...
    /** Creates a new instance of SetDefaultFilterCommand */
    public SetDefaultFilterCommand(UserVisitPK userVisitPK, SetDefaultFilterForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(filterKind != null) {
            ...
            if(filterType != null) {
                ...
                FilterDetailValue filterDetailValue = filterControl.getFilterDetailValueByNameForUpdate(filterType, filterName);
