...
import com.echothree.control.user.filter.remote.form.GetFilterStepForm;
import com.echothree.control.user.filter.remote.result.FilterResultFactory;
import com.echothree.control.user.filter.remote.result.GetFilterStepResult;
...
public class GetFilterStepCommand
        extends BaseSimpleCommand<GetFilterStepForm> {
