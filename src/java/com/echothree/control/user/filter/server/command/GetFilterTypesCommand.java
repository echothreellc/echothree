...
public class GetFilterTypesCommand
        extends BaseSimpleCommand<GetFilterTypesForm> {
    ...
    protected BaseResult execute() {
        ...
        GetFilterTypesResult result = FilterResultFactory.getGetFilterTypesResult();
        String filterKindName = form.getFilterKindName();
        FilterKind filterKind = filterControl.getFilterKindByName(filterKindName);
        
        if(filterKind != null) {
            result.setFilterKind(filterControl.getFilterKindTransfer(getUserVisit(), filterKind));
            result.setFilterTypes(filterControl.getFilterTypeTransfersByFilterKind(getUserVisit(), filterKind));
        } else {
