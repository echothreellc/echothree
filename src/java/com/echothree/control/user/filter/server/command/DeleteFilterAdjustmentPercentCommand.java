...
import com.echothree.control.user.filter.remote.form.DeleteFilterAdjustmentPercentForm;
...
public class DeleteFilterAdjustmentPercentCommand
        extends BaseSimpleCommand<DeleteFilterAdjustmentPercentForm> {
    ...
    protected BaseResult execute() {
        ...
        if(filterKind != null) {
            ...
            if(filterAdjustment != null) {
                if(filterAdjustment.getLastDetail().getFilterAdjustmentType().getFilterAdjustmentTypeName().equals(FilterConstants.FilterAdjustmentType_PERCENT)) {
                    ...
                    if(unitOfMeasureKindName != null && unitOfMeasureTypeName != null) {
                        ...
                        if(unitOfMeasureKind != null) {
                            ...
                            if(unitOfMeasureType != null) {
                                ...
                                if(currency != null) {
                                    FilterAdjustmentPercent filterAdjustmentPercent = filterControl.getFilterAdjustmentPercentForUpdate(filterAdjustment, unitOfMeasureType, currency);
