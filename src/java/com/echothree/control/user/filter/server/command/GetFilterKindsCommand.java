...
import com.echothree.control.user.filter.remote.form.GetFilterKindsForm;
import com.echothree.control.user.filter.remote.result.FilterResultFactory;
import com.echothree.control.user.filter.remote.result.GetFilterKindsResult;
...
public class GetFilterKindsCommand
        extends BaseSimpleCommand<GetFilterKindsForm> {
