...
import com.echothree.control.user.filter.remote.form.GetFilterTypeDescriptionsForm;
import com.echothree.control.user.filter.remote.result.FilterResultFactory;
import com.echothree.control.user.filter.remote.result.GetFilterTypeDescriptionsResult;
...
public class GetFilterTypeDescriptionsCommand
        extends BaseSimpleCommand<GetFilterTypeDescriptionsForm> {
    ...
    public GetFilterTypeDescriptionsCommand(UserVisitPK userVisitPK, GetFilterTypeDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetFilterTypeDescriptionsResult result = FilterResultFactory.getGetFilterTypeDescriptionsResult();
