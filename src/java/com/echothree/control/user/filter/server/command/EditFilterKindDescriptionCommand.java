...
import com.echothree.control.user.filter.remote.form.EditFilterKindDescriptionForm;
import com.echothree.control.user.filter.remote.result.EditFilterKindDescriptionResult;
...
public class EditFilterKindDescriptionCommand
    ...
    public EditFilterKindDescriptionCommand(UserVisitPK userVisitPK, EditFilterKindDescriptionForm form) {
