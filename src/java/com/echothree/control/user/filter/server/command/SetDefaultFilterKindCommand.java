...
import com.echothree.control.user.filter.remote.form.SetDefaultFilterKindForm;
...
public class SetDefaultFilterKindCommand
        extends BaseSimpleCommand<SetDefaultFilterKindForm> {
    ...
    public SetDefaultFilterKindCommand(UserVisitPK userVisitPK, SetDefaultFilterKindForm form) {
