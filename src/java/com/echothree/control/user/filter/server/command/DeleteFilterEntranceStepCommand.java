...
import com.echothree.control.user.filter.remote.form.DeleteFilterEntranceStepForm;
...
public class DeleteFilterEntranceStepCommand
        extends BaseSimpleCommand<DeleteFilterEntranceStepForm> {
    ...
    public DeleteFilterEntranceStepCommand(UserVisitPK userVisitPK, DeleteFilterEntranceStepForm form) {
        ...
        if(filterKind != null) {
            ...
            if(filterType != null) {
                ...
                if(filter != null) {
                    ...
                    if(filterStep != null) {
                        FilterEntranceStep filterEntranceStep = filterControl.getFilterEntranceStepForUpdate(filter, filterStep);
