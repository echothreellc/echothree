...
import com.echothree.control.user.filter.remote.form.DeleteFilterStepElementForm;
...
public class DeleteFilterStepElementCommand
        extends BaseSimpleCommand<DeleteFilterStepElementForm> {
    ...
    public DeleteFilterStepElementCommand(UserVisitPK userVisitPK, DeleteFilterStepElementForm form) {
