...
public class GetFilterAdjustmentPercentCommand
    ...
    public GetFilterAdjustmentPercentCommand(UserVisitPK userVisitPK, GetFilterAdjustmentPercentForm form) {
    ...
    @Override
    protected BaseResult getTransfer(FilterAdjustmentPercent entity) {
