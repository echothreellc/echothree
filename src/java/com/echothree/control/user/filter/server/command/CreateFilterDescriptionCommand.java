...
public class CreateFilterDescriptionCommand
        extends BaseSimpleCommand<CreateFilterDescriptionForm> {
                ...
                if(filter != null) {
                    ...
                    if(language != null) {
                        ...
                        if(filterDescription == null) {
                            ...
                            addExecutionError(ExecutionErrors.DuplicateFilterDescription.name());
                        }
                    } else {
