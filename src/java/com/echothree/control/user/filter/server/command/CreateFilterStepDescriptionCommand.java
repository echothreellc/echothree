...
@Dependent
public class CreateFilterStepDescriptionCommand
        extends BaseSimpleCommand<CreateFilterStepDescriptionForm> {
    ...
    /** Creates a new instance of CreateFilterStepDescriptionCommand */
    public CreateFilterStepDescriptionCommand() {
            ...
            if(filterType != null) {
                ...
                if(filter != null) {
                    ...
                    if(filterStep != null) {
                        ...
                        if(language != null) {
                            var filterStepDescription = filterStepControl.getFilterStepDescription(filterStep, language);
                            
                            if(filterStepDescription == null) {
                                var description = form.getDescription();
                                
                                filterStepControl.createFilterStepDescription(filterStep, language, description, getPartyPK());
                            } else {
                                addExecutionError(ExecutionErrors.DuplicateFilterStepDescription.name());
                            }
                        } else {
