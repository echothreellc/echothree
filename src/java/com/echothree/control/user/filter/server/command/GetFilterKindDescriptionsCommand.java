...
import com.echothree.control.user.filter.remote.form.GetFilterKindDescriptionsForm;
import com.echothree.control.user.filter.remote.result.FilterResultFactory;
import com.echothree.control.user.filter.remote.result.GetFilterKindDescriptionsResult;
...
public class GetFilterKindDescriptionsCommand
    ...
    public GetFilterKindDescriptionsCommand(UserVisitPK userVisitPK, GetFilterKindDescriptionsForm form) {
