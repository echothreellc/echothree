...
public class GetFilterStepChoicesCommand
        extends BaseSimpleCommand<GetFilterStepChoicesForm> {
    ...
    static {
        FORM_FIELD_DEFINITIONS = Collections.unmodifiableList(Arrays.asList(
            ...
            new FieldDefinition("DefaultFilterChoice", FieldType.ENTITY_NAME, false, null, null),
            new FieldDefinition("AllowNullChoice", FieldType.BOOLEAN, true, null, null)
        ));
    }
    
    /** Creates a new instance of GetFilterStepChoicesCommand */
    public GetFilterStepChoicesCommand(UserVisitPK userVisitPK, GetFilterStepChoicesForm form) {
