...
public class GetFilterAdjustmentFixedAmountCommand
    ...
    public GetFilterAdjustmentFixedAmountCommand(UserVisitPK userVisitPK, GetFilterAdjustmentFixedAmountForm form) {
    ...
    @Override
    protected BaseResult getTransfer(FilterAdjustmentFixedAmount entity) {
