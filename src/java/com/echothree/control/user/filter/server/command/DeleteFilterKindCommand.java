...
import com.echothree.control.user.filter.remote.form.DeleteFilterKindForm;
...
public class DeleteFilterKindCommand
    ...
    public DeleteFilterKindCommand(UserVisitPK userVisitPK, DeleteFilterKindForm form) {
