...
public class DeleteFilterAdjustmentCommand
        extends BaseSimpleCommand<DeleteFilterAdjustmentForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(List.of(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), List.of(
                        new SecurityRoleDefinition(SecurityRoleGroups.FilterAdjustment.name(), SecurityRoles.Delete.name())
                ))
        ));
    ...
    public DeleteFilterAdjustmentCommand(UserVisitPK userVisitPK, DeleteFilterAdjustmentForm form) {
