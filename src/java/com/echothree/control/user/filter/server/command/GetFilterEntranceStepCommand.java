...
@Dependent
public class GetFilterEntranceStepCommand
        extends BaseSingleEntityCommand<FilterEntranceStep, GetFilterEntranceStepForm> {
    ...
    protected FilterEntranceStep getEntity() {
        ...
        var filterStep = filterStepLogic.getFilterStepByName(this, filterKindName, filterTypeName, filterName,
                filterStepName);
    ...
    @Override
    protected BaseResult getResult(FilterEntranceStep filterEntranceStep) {
