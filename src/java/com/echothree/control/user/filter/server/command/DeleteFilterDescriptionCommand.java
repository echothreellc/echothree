...
import com.echothree.control.user.filter.remote.form.DeleteFilterDescriptionForm;
...
public class DeleteFilterDescriptionCommand
        extends BaseSimpleCommand<DeleteFilterDescriptionForm> {
    ...
    /** Creates a new instance of DeleteFilterDescriptionCommand */
    public DeleteFilterDescriptionCommand(UserVisitPK userVisitPK, DeleteFilterDescriptionForm form) {
        ...
        if(filterKind != null) {
            ...
            if(filterType != null) {
                ...
                if(filter != null) {
                    ...
                    if(language != null) {
                        FilterDescription filterDescription = filterControl.getFilterDescriptionForUpdate(filter, language);
                        
                        if(filterDescription != null) {
                            filterControl.deleteFilterDescription(filterDescription, getPartyPK());
                        } else {
