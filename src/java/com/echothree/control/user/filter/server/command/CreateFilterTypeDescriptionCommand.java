...
public class CreateFilterTypeDescriptionCommand
        extends BaseSimpleCommand<CreateFilterTypeDescriptionForm> {
    ...
    /** Creates a new instance of CreateFilterTypeDescriptionCommand */
    public CreateFilterTypeDescriptionCommand(UserVisitPK userVisitPK, CreateFilterTypeDescriptionForm form) {
            ...
            if(filterType != null) {
                ...
                if(language != null) {
                    ...
                    if(filterTypeDescription == null) {
                        ...
                        filterControl.createFilterTypeDescription(filterType, language, description, getPartyPK());
                    } else {
                        addExecutionError(ExecutionErrors.DuplicateFilterTypeDescription.name());
                    }
                } else {
                    addExecutionError(ExecutionErrors.UnknownLanguageIsoName.name(), filterKindName, filterTypeName, languageIsoName);
                }
            } else {
