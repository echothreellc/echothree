...
public class GetFilterAdjustmentAmountCommand
        ...
        if(!hasExecutionErrors()) {
            if(filterAdjustment.getLastDetail().getFilterAdjustmentType().getFilterAdjustmentTypeName().equals(FilterAdjustmentTypes.AMOUNT.name())) {
                ...
                if(!hasExecutionErrors()) {
                    ...
                    if(!hasExecutionErrors()) {
                        filterAdjustmentAmount = filterAdjustmentControl.getFilterAdjustmentAmount(filterAdjustment, unitOfMeasureType, currency);
    ...
    protected BaseResult getResult(FilterAdjustmentAmount entity) {
        ...
        if(entity != null) {
            result.setFilterAdjustmentAmount(filterAdjustmentControl.getFilterAdjustmentAmountTransfer(getUserVisit(), entity));
        }
