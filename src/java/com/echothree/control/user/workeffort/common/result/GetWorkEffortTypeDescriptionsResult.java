...
public interface GetWorkEffortTypeDescriptionsResult
        extends BaseResult {
    
    WorkEffortTypeTransfer getWorkEffortType();
    void setWorkEffortType(WorkEffortTypeTransfer workEffortType);
    
    List<WorkEffortTypeDescriptionTransfer> getWorkEffortTypeDescriptions();
    void setWorkEffortTypeDescriptions(List<WorkEffortTypeDescriptionTransfer> workEffortTypeDescriptions);
