...
public interface GetWorkEffortScopeDescriptionsResult
        extends BaseResult {
    
    WorkEffortScopeTransfer getWorkEffortScope();
    void setWorkEffortScope(WorkEffortScopeTransfer workEffortScope);
    
    List<WorkEffortScopeDescriptionTransfer> getWorkEffortScopeDescriptions();
    void setWorkEffortScopeDescriptions(List<WorkEffortScopeDescriptionTransfer> workEffortScopeDescriptions);
