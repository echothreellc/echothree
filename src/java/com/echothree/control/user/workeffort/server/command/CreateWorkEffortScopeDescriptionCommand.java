...
public class CreateWorkEffortScopeDescriptionCommand
        extends BaseSimpleCommand<CreateWorkEffortScopeDescriptionForm> {
    ...
    /** Creates a new instance of CreateWorkEffortScopeDescriptionCommand */
    public CreateWorkEffortScopeDescriptionCommand(UserVisitPK userVisitPK, CreateWorkEffortScopeDescriptionForm form) {
            ...
            if(workEffortScope != null) {
                ...
                if(language != null) {
                    ...
                    if(workEffortScopeDescription == null) {
                        ...
                        addExecutionError(ExecutionErrors.DuplicateWorkEffortScopeDescription.name());
                    }
                } else {
