...
import com.echothree.control.user.workeffort.remote.form.GetWorkEffortForm;
import com.echothree.control.user.workeffort.remote.result.GetWorkEffortResult;
...
public class GetWorkEffortCommand
    ...
    public GetWorkEffortCommand(UserVisitPK userVisitPK, GetWorkEffortForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(workEffort != null) {
            ...
            sendEventUsingNames(workEffort.getPrimaryKey(), EventTypes.READ.name(), null, null, getPartyPK());
        } else {
