...
public class GetWorkEffortTypeCommand
    ...
    public GetWorkEffortTypeCommand(UserVisitPK userVisitPK, GetWorkEffortTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetWorkEffortTypeResult result = WorkEffortResultFactory.getGetWorkEffortTypeResult();
        ...
        if(workEffortType != null) {
            ...
            sendEventUsingNames(workEffortType.getPrimaryKey(), EventTypes.READ.name(), null, null, getPartyPK());
        } else {
