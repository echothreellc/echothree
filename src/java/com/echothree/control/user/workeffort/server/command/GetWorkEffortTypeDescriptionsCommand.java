...
@RequestScoped
public class GetWorkEffortTypeDescriptionsCommand
        extends BaseSimpleCommand<GetWorkEffortTypeDescriptionsForm> {
    ...
    protected BaseResult execute() {
        ...
        var result = WorkEffortResultFactory.getGetWorkEffortTypeDescriptionsResult();
        ...
        if(workEffortType != null) {
            ...
            result.setWorkEffortTypeDescriptions(workEffortControl.getWorkEffortTypeDescriptionTransfers(getUserVisit(), workEffortType));
        } else {
