...
import com.echothree.control.user.workeffort.remote.form.DeleteWorkEffortScopeDescriptionForm;
...
public class DeleteWorkEffortScopeDescriptionCommand
        extends BaseSimpleCommand<DeleteWorkEffortScopeDescriptionForm> {
    ...
    /** Creates a new instance of DeleteWorkEffortScopeDescriptionCommand */
    public DeleteWorkEffortScopeDescriptionCommand(UserVisitPK userVisitPK, DeleteWorkEffortScopeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(workEffortType != null) {
            ...
            if(workEffortScope != null) {
                ...
                if(language != null) {
                    WorkEffortScopeDescription workEffortScopeDescription = workEffortControl.getWorkEffortScopeDescriptionForUpdate(workEffortScope, language);
                    
                    if(workEffortScopeDescription != null) {
                        workEffortControl.deleteWorkEffortScopeDescription(workEffortScopeDescription, getPartyPK());
                    } else {
