...
public interface GetTransactionTypeDescriptionsResult
        extends BaseResult {
    
    TransactionTypeTransfer getTransactionType();
    void setTransactionType(TransactionTypeTransfer transactionType);
    
    List<TransactionTypeDescriptionTransfer> getTransactionTypeDescriptions();
    void setTransactionTypeDescriptions(List<TransactionTypeDescriptionTransfer> transactionTypeDescriptions);
