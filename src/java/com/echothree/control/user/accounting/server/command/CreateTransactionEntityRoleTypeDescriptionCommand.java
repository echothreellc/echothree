...
import com.echothree.control.user.accounting.remote.form.CreateTransactionEntityRoleTypeDescriptionForm;
...
public class CreateTransactionEntityRoleTypeDescriptionCommand
        extends BaseSimpleCommand<CreateTransactionEntityRoleTypeDescriptionForm> {
    ...
    /** Creates a new instance of CreateTransactionEntityRoleTypeDescriptionCommand */
    public CreateTransactionEntityRoleTypeDescriptionCommand(UserVisitPK userVisitPK, CreateTransactionEntityRoleTypeDescriptionForm form) {
            ...
            if(transactionEntityRoleType != null) {
                ...
                if(language != null) {
                    ...
                    if(transactionEntityRoleTypeDescription == null) {
                        ...
                        addExecutionError(ExecutionErrors.DuplicateTransactionEntityRoleTypeDescription.name());
                    }
                } else {
