...
import com.echothree.control.user.accounting.common.form.GetGlAccountDescriptionForm;
import com.echothree.control.user.accounting.common.result.AccountingResultFactory;
import com.echothree.control.user.accounting.common.result.GetGlAccountDescriptionResult;
...
public class GetGlAccountDescriptionCommand
        extends BaseSimpleCommand<GetGlAccountDescriptionForm> {
    ...
    /** Creates a new instance of GetGlAccountDescriptionCommand */
    public GetGlAccountDescriptionCommand(UserVisitPK userVisitPK, GetGlAccountDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        var result = AccountingResultFactory.getGetGlAccountDescriptionResult();
        ...
        if(glAccount != null) {
            ...
            if(language != null) {
                ...
                if(glAccountDescription != null) {
                    ...
                    addExecutionError(ExecutionErrors.UnknownGlAccountDescription.name(), glAccountName, languageIsoName);
                }
            } else {
