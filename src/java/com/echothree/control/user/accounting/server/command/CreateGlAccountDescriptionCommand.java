...
public class CreateGlAccountDescriptionCommand
        extends BaseSimpleCommand<CreateGlAccountDescriptionForm> {
    ...
    /** Creates a new instance of CreateGlAccountDescriptionCommand */
    public CreateGlAccountDescriptionCommand(UserVisitPK userVisitPK, CreateGlAccountDescriptionForm form) {
        ...
        if(glAccount != null) {
            ...
            if(language != null) {
                ...
                if(glAccountDescription == null) {
                    ...
                    accountingControl.createGlAccountDescription(glAccount, language, description, getPartyPK());
                } else {
                    addExecutionError(ExecutionErrors.DuplicateGlAccountDescription.name());
                }
            } else {
