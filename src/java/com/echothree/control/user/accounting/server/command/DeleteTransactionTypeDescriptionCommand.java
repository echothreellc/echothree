...
public class DeleteTransactionTypeDescriptionCommand
        extends BaseSimpleCommand<DeleteTransactionTypeDescriptionForm> {
    ...
    /** Creates a new instance of DeleteTransactionTypeDescriptionCommand */
    public DeleteTransactionTypeDescriptionCommand(UserVisitPK userVisitPK, DeleteTransactionTypeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(transactionType != null) {
            ...
            if(language != null) {
                TransactionTypeDescription transactionTypeDescription = accountingControl.getTransactionTypeDescriptionForUpdate(transactionType, language);
                
                if(transactionTypeDescription != null) {
                    accountingControl.deleteTransactionTypeDescription(transactionTypeDescription, getPartyPK());
                } else {
