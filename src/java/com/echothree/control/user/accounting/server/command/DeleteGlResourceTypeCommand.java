...
public class DeleteGlResourceTypeCommand
        extends BaseSimpleCommand<DeleteGlResourceTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.GlResourceType.name(), SecurityRoles.Delete.name())
                        )))
                )));
    ...
    protected BaseResult execute() {
        ...
        if(glResourceType != null) {
            accountingControl.deleteGlResourceType(glResourceType, getPartyPK());
        } else {
