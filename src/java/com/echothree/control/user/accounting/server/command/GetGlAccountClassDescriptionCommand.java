...
import com.echothree.control.user.accounting.common.form.GetGlAccountClassDescriptionForm;
import com.echothree.control.user.accounting.common.result.AccountingResultFactory;
import com.echothree.control.user.accounting.common.result.GetGlAccountClassDescriptionResult;
...
public class GetGlAccountClassDescriptionCommand
        extends BaseSimpleCommand<GetGlAccountClassDescriptionForm> {
    ...
    /** Creates a new instance of GetGlAccountClassDescriptionCommand */
    public GetGlAccountClassDescriptionCommand(UserVisitPK userVisitPK, GetGlAccountClassDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetGlAccountClassDescriptionResult result = AccountingResultFactory.getGetGlAccountClassDescriptionResult();
        ...
        if(glAccountClass != null) {
            ...
            if(language != null) {
                ...
                if(glAccountClassDescription != null) {
                    ...
                    addExecutionError(ExecutionErrors.UnknownGlAccountClassDescription.name(), glAccountClassName, languageIsoName);
                }
            } else {
