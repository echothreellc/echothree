...
public class GetGlAccountTypeChoicesCommand
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.GlAccountType.name(), SecurityRoles.Choices.name())
                )))
        )));
    ...
    protected BaseResult execute() {
        ...
        var result = AccountingResultFactory.getGetGlAccountTypeChoicesResult();
        var defaultGlAccountTypeChoice = form.getDefaultGlAccountTypeChoice();
