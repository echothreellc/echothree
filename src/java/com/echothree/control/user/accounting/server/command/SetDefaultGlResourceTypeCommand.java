...
public class SetDefaultGlResourceTypeCommand
        extends BaseSimpleCommand<SetDefaultGlResourceTypeForm> {
    ...
    public SetDefaultGlResourceTypeCommand(UserVisitPK userVisitPK, SetDefaultGlResourceTypeForm form) {
