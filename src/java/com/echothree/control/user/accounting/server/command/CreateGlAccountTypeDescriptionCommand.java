...
public class CreateGlAccountTypeDescriptionCommand
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.GlAccountType.name(), SecurityRoles.Description.name())
                )))
        )));
    ...
    protected BaseResult execute() {
        ...
        if(glAccountType != null) {
            ...
            if(language != null) {
                var glAccountTypeDescription = accountingControl.getGlAccountTypeDescription(glAccountType, language);
