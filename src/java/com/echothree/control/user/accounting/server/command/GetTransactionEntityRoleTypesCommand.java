...
import com.echothree.control.user.accounting.remote.form.GetTransactionEntityRoleTypesForm;
import com.echothree.control.user.accounting.remote.result.AccountingResultFactory;
import com.echothree.control.user.accounting.remote.result.GetTransactionEntityRoleTypesResult;
...
public class GetTransactionEntityRoleTypesCommand
        extends BaseSimpleCommand<GetTransactionEntityRoleTypesForm> {
    ...
    public GetTransactionEntityRoleTypesCommand(UserVisitPK userVisitPK, GetTransactionEntityRoleTypesForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(transactionType != null) {
            ...
            result.setTransactionEntityRoleTypes(accountingControl.getTransactionEntityRoleTypeTransfersByTransactionType(getUserVisit(),
                    transactionType));
        } else {
