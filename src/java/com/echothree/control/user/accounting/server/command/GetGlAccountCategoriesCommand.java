...
import com.echothree.control.user.accounting.remote.form.GetGlAccountCategoriesForm;
...
public class GetGlAccountCategoriesCommand
        extends BaseSimpleCommand<GetGlAccountCategoriesForm> {
    ...
    public GetGlAccountCategoriesCommand(UserVisitPK userVisitPK, GetGlAccountCategoriesForm form) {
