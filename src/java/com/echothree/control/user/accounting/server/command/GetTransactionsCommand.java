...
import com.echothree.control.user.accounting.remote.form.GetTransactionsForm;
import com.echothree.control.user.accounting.remote.result.AccountingResultFactory;
import com.echothree.control.user.accounting.remote.result.GetTransactionsResult;
...
public class GetTransactionsCommand
        extends BaseSimpleCommand<GetTransactionsForm> {
    ...
    public GetTransactionsCommand(UserVisitPK userVisitPK, GetTransactionsForm form) {
