...
import com.echothree.control.user.accounting.remote.form.GetTransactionTypesForm;
...
public class GetTransactionTypesCommand
        extends BaseSimpleCommand<GetTransactionTypesForm> {
    ...
    public GetTransactionTypesCommand(UserVisitPK userVisitPK, GetTransactionTypesForm form) {
