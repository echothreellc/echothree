...
import com.echothree.control.user.accounting.remote.form.GetItemAccountingCategoryForm;
import com.echothree.control.user.accounting.remote.result.AccountingResultFactory;
import com.echothree.control.user.accounting.remote.result.GetItemAccountingCategoryResult;
...
public class GetItemAccountingCategoryCommand
        extends BaseSimpleCommand<GetItemAccountingCategoryForm> {
    ...
    protected BaseResult execute() {
        ...
        GetItemAccountingCategoryResult result = AccountingResultFactory.getGetItemAccountingCategoryResult();
