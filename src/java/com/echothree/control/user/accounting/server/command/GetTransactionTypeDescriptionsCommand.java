...
@Dependent
public class GetTransactionTypeDescriptionsCommand
        extends BaseSimpleCommand<GetTransactionTypeDescriptionsForm> {
    ...
    protected BaseResult execute() {
        ...
        if(transactionType != null) {
            ...
            result.setTransactionTypeDescriptions(accountingControl.getTransactionTypeDescriptionTransfersByTransactionType(getUserVisit(), transactionType));
        } else {
