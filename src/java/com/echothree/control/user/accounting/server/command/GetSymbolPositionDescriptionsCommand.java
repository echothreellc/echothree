...
import com.echothree.control.user.accounting.common.form.GetSymbolPositionDescriptionsForm;
import com.echothree.control.user.accounting.common.result.AccountingResultFactory;
import com.echothree.control.user.accounting.common.result.GetSymbolPositionDescriptionsResult;
...
public class GetSymbolPositionDescriptionsCommand
        extends BaseSimpleCommand<GetSymbolPositionDescriptionsForm> {
    ...
    protected BaseResult execute() {
        ...
        if(symbolPosition != null) {
            ...
            result.setSymbolPositionDescriptions(accountingControl.getSymbolPositionDescriptionTransfersBySymbolPosition(getUserVisit(), symbolPosition));
        } else {
