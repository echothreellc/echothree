...
public class DeleteItemAccountingCategoryDescriptionCommand
        extends BaseSimpleCommand<DeleteItemAccountingCategoryDescriptionForm> {
    ...
    /** Creates a new instance of DeleteItemAccountingCategoryDescriptionCommand */
    public DeleteItemAccountingCategoryDescriptionCommand(UserVisitPK userVisitPK, DeleteItemAccountingCategoryDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(itemAccountingCategory != null) {
            ...
            if(language != null) {
                ItemAccountingCategoryDescription itemAccountingCategoryDescription = accountingControl.getItemAccountingCategoryDescriptionForUpdate(itemAccountingCategory, language);
                
                if(itemAccountingCategoryDescription != null) {
                    accountingControl.deleteItemAccountingCategoryDescription(itemAccountingCategoryDescription, getPartyPK());
                } else {
