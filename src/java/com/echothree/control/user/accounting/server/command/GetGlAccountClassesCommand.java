...
public class GetGlAccountClassesCommand
        extends BaseSimpleCommand<GetGlAccountClassesForm> {
    ...
    public GetGlAccountClassesCommand(UserVisitPK userVisitPK, GetGlAccountClassesForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetGlAccountClassesResult result = AccountingResultFactory.getGetGlAccountClassesResult();
        
        result.setGlAccountClasses(accountingControl.getGlAccountClassTransfers(getUserVisit()));
