...
import com.echothree.control.user.accounting.remote.form.GetTransactionEntityRoleTypeDescriptionsForm;
import com.echothree.control.user.accounting.remote.result.AccountingResultFactory;
import com.echothree.control.user.accounting.remote.result.GetTransactionEntityRoleTypeDescriptionsResult;
...
public class GetTransactionEntityRoleTypeDescriptionsCommand
        extends BaseSimpleCommand<GetTransactionEntityRoleTypeDescriptionsForm> {
    ...
    public GetTransactionEntityRoleTypeDescriptionsCommand(UserVisitPK userVisitPK, GetTransactionEntityRoleTypeDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(transactionType != null) {
            ...
            if(transactionEntityRoleType != null) {
                ...
                result.setTransactionEntityRoleTypeDescriptions(accountingControl.getTransactionEntityRoleTypeDescriptionTransfersByTransactionEntityRoleType(getUserVisit(), transactionEntityRoleType));
            } else {
