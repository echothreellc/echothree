...
public class CreateGlAccountCategoryCommand
        extends BaseSimpleCommand<CreateGlAccountCategoryForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.GlAccountCategory.name(), SecurityRoles.Create.name())
                        )))
                )));
    ...
    protected BaseResult execute() {
        ...
        if(glAccountCategory == null) {
            ...
            if(parentGlAccountCategoryName == null || parentGlAccountCategory != null) {
                ...
                glAccountCategory = accountingControl.createGlAccountCategory(glAccountCategoryName, parentGlAccountCategory, isDefault, sortOrder,
                        partyPK);
