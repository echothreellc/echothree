...
import com.echothree.control.user.accounting.remote.edit.GlResourceTypeDescriptionEdit;
import com.echothree.control.user.accounting.remote.form.EditGlResourceTypeDescriptionForm;
import com.echothree.control.user.accounting.remote.result.AccountingResultFactory;
import com.echothree.control.user.accounting.remote.result.EditGlResourceTypeDescriptionResult;
import com.echothree.control.user.accounting.remote.spec.GlResourceTypeDescriptionSpec;
...
public class EditGlResourceTypeDescriptionCommand
    ...
    public EditGlResourceTypeDescriptionCommand(UserVisitPK userVisitPK, EditGlResourceTypeDescriptionForm form) {
