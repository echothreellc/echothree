...
import com.echothree.control.user.accounting.common.form.CreateGlAccountCategoryDescriptionForm;
...
public class CreateGlAccountCategoryDescriptionCommand
        extends BaseSimpleCommand<CreateGlAccountCategoryDescriptionForm> {
    ...
    /** Creates a new instance of CreateGlAccountCategoryDescriptionCommand */
    public CreateGlAccountCategoryDescriptionCommand(UserVisitPK userVisitPK, CreateGlAccountCategoryDescriptionForm form) {
        ...
        if(glAccountCategory != null) {
            ...
            if(language != null) {
                ...
                if(glAccountCategoryDescription == null) {
                    ...
                    accountingControl.createGlAccountCategoryDescription(glAccountCategory, language, description, getPartyPK());
                } else {
                    addExecutionError(ExecutionErrors.DuplicateGlAccountCategoryDescription.name());
                }
            } else {
