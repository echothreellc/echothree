...
import com.echothree.control.user.accounting.common.form.GetItemAccountingCategoryDescriptionForm;
import com.echothree.control.user.accounting.common.result.AccountingResultFactory;
import com.echothree.control.user.accounting.common.result.GetItemAccountingCategoryDescriptionResult;
...
public class GetItemAccountingCategoryDescriptionCommand
        extends BaseSimpleCommand<GetItemAccountingCategoryDescriptionForm> {
    ...
    /** Creates a new instance of GetItemAccountingCategoryDescriptionCommand */
    public GetItemAccountingCategoryDescriptionCommand(UserVisitPK userVisitPK, GetItemAccountingCategoryDescriptionForm form) {
        ...
        if(itemAccountingCategory != null) {
            ...
            if(language != null) {
                ...
                if(itemAccountingCategoryDescription != null) {
                    ...
                    addExecutionError(ExecutionErrors.UnknownItemAccountingCategoryDescription.name(), itemAccountingCategoryName, languageIsoName);
                }
            } else {
