...
import com.echothree.control.user.accounting.common.form.GetGlAccountCategoryDescriptionForm;
import com.echothree.control.user.accounting.common.result.AccountingResultFactory;
import com.echothree.control.user.accounting.common.result.GetGlAccountCategoryDescriptionResult;
...
public class GetGlAccountCategoryDescriptionCommand
        extends BaseSimpleCommand<GetGlAccountCategoryDescriptionForm> {
    ...
    /** Creates a new instance of GetGlAccountCategoryDescriptionCommand */
    public GetGlAccountCategoryDescriptionCommand(UserVisitPK userVisitPK, GetGlAccountCategoryDescriptionForm form) {
        ...
        if(glAccountCategory != null) {
            ...
            if(language != null) {
                ...
                if(glAccountCategoryDescription != null) {
                    ...
                    addExecutionError(ExecutionErrors.UnknownGlAccountCategoryDescription.name(), glAccountCategoryName, languageIsoName);
                }
            } else {
