...
import com.echothree.control.user.accounting.remote.form.GetGlResourceTypeForm;
import com.echothree.control.user.accounting.remote.result.AccountingResultFactory;
import com.echothree.control.user.accounting.remote.result.GetGlResourceTypeResult;
...
public class GetGlResourceTypeCommand
        extends BaseSimpleCommand<GetGlResourceTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.GlResourceType.name(), SecurityRoles.Review.name())
                        )))
                )));
    ...
    public GetGlResourceTypeCommand(UserVisitPK userVisitPK, GetGlResourceTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetGlResourceTypeResult result = AccountingResultFactory.getGetGlResourceTypeResult();
