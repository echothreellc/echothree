...
import com.echothree.model.control.accounting.server.logic.GlResourceTypeLogic;
...
public class GetGlResourceTypeCommand
        extends BaseSingleEntityCommand<GlResourceType, GetGlResourceTypeForm> {
    ...
    protected BaseResult getResult(GlResourceType entity) {
        ...
        if(entity != null) {
            result.setGlResourceType(accountingControl.getGlResourceTypeTransfer(getUserVisit(), entity));
        }
