...
import com.echothree.control.user.accounting.remote.form.GetItemAccountingCategoryDescriptionsForm;
import com.echothree.control.user.accounting.remote.result.AccountingResultFactory;
import com.echothree.control.user.accounting.remote.result.GetItemAccountingCategoryDescriptionsResult;
...
public class GetItemAccountingCategoryDescriptionsCommand
        extends BaseSimpleCommand<GetItemAccountingCategoryDescriptionsForm> {
    ...
    public GetItemAccountingCategoryDescriptionsCommand(UserVisitPK userVisitPK, GetItemAccountingCategoryDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(itemAccountingCategory != null) {
            ...
            result.setItemAccountingCategoryDescriptions(accountingControl.getItemAccountingCategoryDescriptionTransfersByItemAccountingCategory(getUserVisit(), itemAccountingCategory));
        } else {
