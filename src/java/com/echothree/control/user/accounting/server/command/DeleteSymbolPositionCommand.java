...
import com.echothree.control.user.accounting.common.form.DeleteSymbolPositionForm;
...
public class DeleteSymbolPositionCommand
        extends BaseSimpleCommand<DeleteSymbolPositionForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.SymbolPosition.name(), SecurityRoles.Delete.name())
                        )))
                )));
    ...
    /** Creates a new instance of DeleteSymbolPositionCommand */
    public DeleteSymbolPositionCommand(UserVisitPK userVisitPK, DeleteSymbolPositionForm form) {
