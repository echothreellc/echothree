...
import com.echothree.control.user.accounting.remote.form.GetGlAccountClassDescriptionsForm;
import com.echothree.control.user.accounting.remote.result.AccountingResultFactory;
import com.echothree.control.user.accounting.remote.result.GetGlAccountClassDescriptionsResult;
...
public class GetGlAccountClassDescriptionsCommand
        extends BaseSimpleCommand<GetGlAccountClassDescriptionsForm> {
    ...
    protected BaseResult execute() {
        ...
        if(glAccountClass != null) {
            ...
            result.setGlAccountClassDescriptions(accountingControl.getGlAccountClassDescriptionTransfersByGlAccountClass(getUserVisit(), glAccountClass));
        } else {
