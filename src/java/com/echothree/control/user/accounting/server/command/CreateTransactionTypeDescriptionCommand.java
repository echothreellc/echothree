...
public class CreateTransactionTypeDescriptionCommand
        extends BaseSimpleCommand<CreateTransactionTypeDescriptionForm> {
    ...
    /** Creates a new instance of CreateTransactionTypeDescriptionCommand */
    public CreateTransactionTypeDescriptionCommand(UserVisitPK userVisitPK, CreateTransactionTypeDescriptionForm form) {
        ...
        if(transactionType != null) {
            ...
            if(language != null) {
                ...
                if(transactionTypeDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateTransactionTypeDescription.name());
                }
            } else {
