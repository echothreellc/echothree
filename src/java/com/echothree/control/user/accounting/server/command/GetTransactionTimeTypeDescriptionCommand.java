...
import com.echothree.control.user.accounting.common.form.GetTransactionTimeTypeDescriptionForm;
...
public class GetTransactionTimeTypeDescriptionCommand
        extends BaseSimpleCommand<GetTransactionTimeTypeDescriptionForm> {
    ...
    public GetTransactionTimeTypeDescriptionCommand(UserVisitPK userVisitPK, GetTransactionTimeTypeDescriptionForm form) {
