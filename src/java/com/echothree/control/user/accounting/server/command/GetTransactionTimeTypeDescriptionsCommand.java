...
import com.echothree.control.user.accounting.common.form.GetTransactionTimeTypeDescriptionsForm;
...
public class GetTransactionTimeTypeDescriptionsCommand
        extends BaseSimpleCommand<GetTransactionTimeTypeDescriptionsForm> {
    ...
    /** Creates a new instance of GetTransactionTimeTypeDescriptionsCommand */
    public GetTransactionTimeTypeDescriptionsCommand(UserVisitPK userVisitPK, GetTransactionTimeTypeDescriptionsForm form) {
        super(userVisitPK, form, COMMAND_SECURITY_DEFINITION, FORM_FIELD_DEFINITIONS, false);
    }
    
    @Override
    protected BaseResult execute() {
        var result = AccountingResultFactory.getGetTransactionTimeTypeDescriptionsResult();
        ...
        if(transactionTimeType != null) {
            ...
            result.setTransactionTimeTypeDescriptions(transactionTimeControl.getTransactionTimeTypeDescriptionTransfersByTransactionTimeType(getUserVisit(), transactionTimeType));
        } else {
