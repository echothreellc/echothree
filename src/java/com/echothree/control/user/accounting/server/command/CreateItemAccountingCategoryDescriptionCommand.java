...
import com.echothree.control.user.accounting.common.form.CreateItemAccountingCategoryDescriptionForm;
...
public class CreateItemAccountingCategoryDescriptionCommand
        extends BaseSimpleCommand<CreateItemAccountingCategoryDescriptionForm> {
    ...
    /** Creates a new instance of CreateItemAccountingCategoryDescriptionCommand */
    public CreateItemAccountingCategoryDescriptionCommand(UserVisitPK userVisitPK, CreateItemAccountingCategoryDescriptionForm form) {
        ...
        if(itemAccountingCategory != null) {
            ...
            if(language != null) {
                ...
                if(itemAccountingCategoryDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateItemAccountingCategoryDescription.name());
                }
            } else {
