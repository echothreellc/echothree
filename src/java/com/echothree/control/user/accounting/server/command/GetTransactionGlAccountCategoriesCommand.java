...
public class GetTransactionGlAccountCategoriesCommand
        extends BaseSimpleCommand<GetTransactionGlAccountCategoriesForm> {
    ...
    protected BaseResult execute() {
        ...
        GetTransactionGlAccountCategoriesResult result = AccountingResultFactory.getGetTransactionGlAccountCategoriesResult();
        ...
        if(transactionType != null) {
            ...
            result.setTransactionGlAccountCategories(accountingControl.getTransactionGlAccountCategoryTransfersByTransactionType(getUserVisit(),
                    transactionType));
        } else {
