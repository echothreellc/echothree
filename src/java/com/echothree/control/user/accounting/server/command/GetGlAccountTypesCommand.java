...
import com.echothree.control.user.accounting.remote.form.GetGlAccountTypesForm;
import com.echothree.control.user.accounting.remote.result.AccountingResultFactory;
import com.echothree.control.user.accounting.remote.result.GetGlAccountTypesResult;
...
public class GetGlAccountTypesCommand
        extends BaseSimpleCommand<GetGlAccountTypesForm> {
    ...
    public GetGlAccountTypesCommand(UserVisitPK userVisitPK, GetGlAccountTypesForm form) {
