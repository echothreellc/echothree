...
import com.echothree.control.user.accounting.common.form.DeleteTransactionEntityRoleTypeDescriptionForm;
...
public class DeleteTransactionEntityRoleTypeDescriptionCommand
        extends BaseSimpleCommand<DeleteTransactionEntityRoleTypeDescriptionForm> {
    ...
    protected BaseResult execute() {
        ...
        if(transactionType != null) {
            ...
            if(transactionEntityRoleType != null) {
                ...
                if(language != null) {
                    TransactionEntityRoleTypeDescription transactionEntityRoleTypeDescription = accountingControl.getTransactionEntityRoleTypeDescriptionForUpdate(transactionEntityRoleType, language);

                    if(transactionEntityRoleTypeDescription != null) {
                        accountingControl.deleteTransactionEntityRoleTypeDescription(transactionEntityRoleTypeDescription, getPartyPK());
                    } else {
