...
import com.echothree.control.user.accounting.remote.form.DeleteTransactionTypeForm;
...
public class DeleteTransactionTypeCommand
        extends BaseSimpleCommand<DeleteTransactionTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.TransactionType.name(), SecurityRoles.Delete.name())
                        )))
                )));
