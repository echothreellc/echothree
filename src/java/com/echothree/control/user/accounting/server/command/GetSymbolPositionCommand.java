...
import com.echothree.control.user.accounting.remote.form.GetSymbolPositionForm;
import com.echothree.control.user.accounting.remote.result.AccountingResultFactory;
import com.echothree.control.user.accounting.remote.result.GetSymbolPositionResult;
...
public class GetSymbolPositionCommand
    ...
    public GetSymbolPositionCommand(UserVisitPK userVisitPK, GetSymbolPositionForm form) {
