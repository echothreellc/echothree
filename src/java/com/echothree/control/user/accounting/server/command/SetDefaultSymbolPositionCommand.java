...
import com.echothree.control.user.accounting.common.form.SetDefaultSymbolPositionForm;
...
@Dependent
public class SetDefaultSymbolPositionCommand
        extends BaseSimpleCommand<SetDefaultSymbolPositionForm> {
