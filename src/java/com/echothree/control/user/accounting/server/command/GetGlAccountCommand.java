...
public class GetGlAccountCommand
        extends BaseSimpleCommand<GetGlAccountForm> {
    ...
    public GetGlAccountCommand(UserVisitPK userVisitPK, GetGlAccountForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetGlAccountResult result = AccountingResultFactory.getGetGlAccountResult();
        ...
        if(glAccount != null) {
            ...
            sendEventUsingNames(glAccount.getPrimaryKey(), EventTypes.READ.name(), null, null, getPartyPK());
        } else {
