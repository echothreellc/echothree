...
import com.echothree.control.user.accounting.remote.form.GetTransactionTypeDescriptionForm;
import com.echothree.control.user.accounting.remote.result.AccountingResultFactory;
import com.echothree.control.user.accounting.remote.result.GetTransactionTypeDescriptionResult;
...
public class GetTransactionTypeDescriptionCommand
        extends BaseSimpleCommand<GetTransactionTypeDescriptionForm> {
    ...
    /** Creates a new instance of GetTransactionTypeDescriptionCommand */
    public GetTransactionTypeDescriptionCommand(UserVisitPK userVisitPK, GetTransactionTypeDescriptionForm form) {
        ...
        if(transactionType != null) {
            ...
            if(language != null) {
                ...
                if(transactionTypeDescription != null) {
                    ...
                    addExecutionError(ExecutionErrors.UnknownTransactionTypeDescription.name(), transactionTypeName, languageIsoName);
                }
            } else {
