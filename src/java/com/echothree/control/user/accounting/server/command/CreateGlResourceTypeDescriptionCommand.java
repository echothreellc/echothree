...
public class CreateGlResourceTypeDescriptionCommand
        extends BaseSimpleCommand<CreateGlResourceTypeDescriptionForm> {
    ...
    /** Creates a new instance of CreateGlResourceTypeDescriptionCommand */
    public CreateGlResourceTypeDescriptionCommand(UserVisitPK userVisitPK, CreateGlResourceTypeDescriptionForm form) {
        ...
        if(glResourceType != null) {
            ...
            if(language != null) {
                ...
                if(glResourceTypeDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateGlResourceTypeDescription.name());
                }
            } else {
