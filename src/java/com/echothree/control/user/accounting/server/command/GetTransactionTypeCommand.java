...
public class GetTransactionTypeCommand
        extends BaseSimpleCommand<GetTransactionTypeForm> {
    ...
    public GetTransactionTypeCommand(UserVisitPK userVisitPK, GetTransactionTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetTransactionTypeResult result = AccountingResultFactory.getGetTransactionTypeResult();
