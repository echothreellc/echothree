...
import com.echothree.control.user.accounting.remote.form.GetGlAccountDescriptionsForm;
import com.echothree.control.user.accounting.remote.result.AccountingResultFactory;
import com.echothree.control.user.accounting.remote.result.GetGlAccountDescriptionsResult;
...
public class GetGlAccountDescriptionsCommand
        extends BaseSimpleCommand<GetGlAccountDescriptionsForm> {
    ...
    /** Creates a new instance of GetGlAccountDescriptionsCommand */
    public GetGlAccountDescriptionsCommand(UserVisitPK userVisitPK, GetGlAccountDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(glAccount != null) {
            ...
            result.setGlAccountDescriptions(accountingControl.getGlAccountDescriptionTransfersByGlAccount(getUserVisit(), glAccount));
        } else {
