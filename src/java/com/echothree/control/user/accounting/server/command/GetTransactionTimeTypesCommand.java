...
public class GetTransactionTimeTypesCommand
        extends BasePaginatedMultipleEntitiesCommand<TransactionTimeType, GetTransactionTimeTypesForm> {
    ...
    protected Long getTotalEntities() {
        return transactionTimeControl.countTransactionTimeTypes();
    }
    ...
    protected BaseResult getResult(Collection<TransactionTimeType> entities) {
        ...
        if(entities != null) {
            if(session.hasLimit(TransactionTimeTypeFactory.class)) {
                result.setTransactionTimeTypeCount(getTotalEntities());
            }
