...
public class CreateSymbolPositionDescriptionCommand
        extends BaseSimpleCommand<CreateSymbolPositionDescriptionForm> {
    ...
    /** Creates a new instance of CreateSymbolPositionDescriptionCommand */
    public CreateSymbolPositionDescriptionCommand(UserVisitPK userVisitPK, CreateSymbolPositionDescriptionForm form) {
        ...
        if(symbolPosition != null) {
            ...
            if(language != null) {
                ...
                if(symbolPositionDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateSymbolPositionDescription.name());
                }
            } else {
