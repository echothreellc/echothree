...
import com.echothree.control.user.accounting.common.form.DeleteGlAccountCategoryForm;
...
public class DeleteGlAccountCategoryCommand
        extends BaseSimpleCommand<DeleteGlAccountCategoryForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.GlAccountCategory.name(), SecurityRoles.Delete.name())
                        )))
                )));
    ...
    public DeleteGlAccountCategoryCommand(UserVisitPK userVisitPK, DeleteGlAccountCategoryForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(glAccountCategory != null) {
            accountingControl.deleteGlAccountCategory(glAccountCategory, getPartyPK());
        } else {
