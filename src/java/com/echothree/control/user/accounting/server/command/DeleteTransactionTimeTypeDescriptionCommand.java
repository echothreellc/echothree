...
import com.echothree.control.user.accounting.common.form.DeleteTransactionTimeTypeDescriptionForm;
...
public class DeleteTransactionTimeTypeDescriptionCommand
        extends BaseSimpleCommand<DeleteTransactionTimeTypeDescriptionForm> {
    ...
    protected BaseResult execute() {
        ...
        if(transactionTimeType != null) {
            ...
            if(language != null) {
                var transactionTimeTypeDescription = transactionTimeControl.getTransactionTimeTypeDescriptionForUpdate(transactionTimeType, language);

                if(transactionTimeTypeDescription != null) {
                    transactionTimeControl.deleteTransactionTimeTypeDescription(transactionTimeTypeDescription, getPartyPK());
                } else {
