...
public class CreateGlAccountTypeCommand
        extends BaseSimpleCommand<CreateGlAccountTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.GlAccountType.name(), SecurityRoles.Create.name())
                )))
        )));
    ...
    public CreateGlAccountTypeCommand(UserVisitPK userVisitPK, CreateGlAccountTypeForm form) {
