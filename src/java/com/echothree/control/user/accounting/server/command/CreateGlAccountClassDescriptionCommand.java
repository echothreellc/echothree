...
public class CreateGlAccountClassDescriptionCommand
        extends BaseSimpleCommand<CreateGlAccountClassDescriptionForm> {
    ...
    /** Creates a new instance of CreateGlAccountClassDescriptionCommand */
    public CreateGlAccountClassDescriptionCommand(UserVisitPK userVisitPK, CreateGlAccountClassDescriptionForm form) {
        ...
        if(glAccountClass != null) {
            ...
            if(language != null) {
                ...
                if(glAccountClassDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateGlAccountClassDescription.name());
                }
            } else {
