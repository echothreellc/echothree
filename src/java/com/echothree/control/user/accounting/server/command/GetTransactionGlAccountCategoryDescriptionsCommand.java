...
import com.echothree.control.user.accounting.remote.form.GetTransactionGlAccountCategoryDescriptionsForm;
import com.echothree.control.user.accounting.remote.result.AccountingResultFactory;
import com.echothree.control.user.accounting.remote.result.GetTransactionGlAccountCategoryDescriptionsResult;
...
public class GetTransactionGlAccountCategoryDescriptionsCommand
        extends BaseSimpleCommand<GetTransactionGlAccountCategoryDescriptionsForm> {
    ...
    public GetTransactionGlAccountCategoryDescriptionsCommand(UserVisitPK userVisitPK, GetTransactionGlAccountCategoryDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(transactionType != null) {
            ...
            if(transactionGlAccountCategory != null) {
                ...
                result.setTransactionGlAccountCategoryDescriptions(accountingControl.getTransactionGlAccountCategoryDescriptionTransfersByTransactionGlAccountCategory(getUserVisit(), transactionGlAccountCategory));
            } else {
