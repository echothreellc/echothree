...
import com.echothree.control.user.accounting.remote.form.CreateTransactionTypeForm;
...
public class CreateTransactionTypeCommand
        extends BaseSimpleCommand<CreateTransactionTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.TransactionType.name(), SecurityRoles.Create.name())
                        )))
                )));
    ...
    /** Creates a new instance of CreateTransactionTypeCommand */
    public CreateTransactionTypeCommand(UserVisitPK userVisitPK, CreateTransactionTypeForm form) {
