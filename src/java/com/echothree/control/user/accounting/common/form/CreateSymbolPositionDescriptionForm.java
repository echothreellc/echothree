...
public interface CreateSymbolPositionDescriptionForm
        extends SymbolPositionDescriptionSpec, SymbolPositionDescriptionEdit {
    
    // Nothing additional beyond SymbolPositionDescriptionSpec, SymbolPositionDescriptionEdit
