...
public interface CreateGlAccountClassDescriptionForm
        extends GlAccountClassDescriptionSpec, GlAccountClassDescriptionEdit {
    
    // Nothing additional beyond GlAccountClassDescriptionSpec, GlAccountClassDescriptionEdit
