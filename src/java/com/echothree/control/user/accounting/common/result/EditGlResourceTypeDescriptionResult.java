...
public interface EditGlResourceTypeDescriptionResult 
        extends BaseEditResult<GlResourceTypeDescriptionEdit> {
    
    GlResourceTypeDescriptionTransfer getGlResourceTypeDescription();
    void setGlResourceTypeDescription(GlResourceTypeDescriptionTransfer glResourceTypeDescription);
