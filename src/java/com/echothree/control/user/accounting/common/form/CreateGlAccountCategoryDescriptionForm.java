...
public interface CreateGlAccountCategoryDescriptionForm
        extends GlAccountCategoryDescriptionSpec, GlAccountCategoryDescriptionEdit {
    
    // Nothing additional beyond GlAccountCategoryDescriptionSpec, GlAccountCategoryDescriptionEdit
