...
public interface EditGlAccountDescriptionResult 
        extends BaseEditResult<GlAccountDescriptionEdit> {
    
    GlAccountDescriptionTransfer getGlAccountDescription();
    void setGlAccountDescription(GlAccountDescriptionTransfer glAccountDescription);
