...
public interface CreateTransactionGlAccountCategoryForm
        extends TransactionTypeSpec, TransactionGlAccountCategoryEdit {
    
    // Nothing additional beyond TransactionTypeSpec, TransactionGlAccountCategoryEdit
