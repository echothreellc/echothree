...
public interface EditTransactionTimeTypeDescriptionResult
        extends BaseEditResult<TransactionTimeTypeDescriptionEdit> {

    TransactionTimeTypeDescriptionTransfer getTransactionTimeTypeDescription();
    void setTransactionTimeTypeDescription(TransactionTimeTypeDescriptionTransfer transactionTimeType);
