...
public interface CreateTransactionEntityRoleTypeForm
        extends TransactionTypeSpec, TransactionEntityRoleTypeEdit {
    
    // Nothing additional beyond TransactionTypeSpec, TransactionEntityRoleTypeEdit
