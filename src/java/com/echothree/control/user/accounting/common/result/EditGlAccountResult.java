...
public interface EditGlAccountResult
        extends GetGlAccountResult, BaseEditResult<GlAccountEdit> {
    
    // Nothing additional beyond GetGlAccountResult, BaseEditResult<GlAccountEdit>
