...
public interface EditGlResourceTypeResult
        extends GetGlResourceTypeResult, BaseEditResult<GlResourceTypeEdit> {
    
    // Nothing additional beyond GetGlResourceTypeResult, BaseEditResult<GlResourceTypeEdit>
