...
public interface EditTransactionEntityRoleTypeDescriptionForm
        extends BaseEditForm<TransactionEntityRoleTypeDescriptionSpec, TransactionEntityRoleTypeDescriptionEdit> {
