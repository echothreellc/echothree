...
public interface EditSymbolPositionResult
        extends GetSymbolPositionResult, BaseEditResult<SymbolPositionEdit> {
    
    // Nothing additional beyond GetSymbolPositionResult, BaseEditResult<SymbolPositionEdit>
