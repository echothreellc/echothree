...
public interface CreateGlResourceTypeDescriptionForm
        extends GlResourceTypeDescriptionSpec, GlResourceTypeDescriptionEdit {
    
    // Nothing additional beyond GlResourceTypeDescriptionSpec, GlResourceTypeDescriptionEdit
