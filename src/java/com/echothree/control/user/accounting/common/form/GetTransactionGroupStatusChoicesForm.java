...
public interface GetTransactionGroupStatusChoicesForm
        extends TransactionGroupSpec {
    
    String getDefaultTransactionGroupStatusChoice();
    void setDefaultTransactionGroupStatusChoice(String defaultTransactionGroupStatusChoice);
