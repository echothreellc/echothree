...
public interface CreateSelectorNodeDescriptionForm
        extends SelectorNodeDescriptionSpec, SelectorNodeDescriptionEdit {
    
    // Nothing additional beyond SelectorNodeDescriptionSpec, SelectorNodeDescriptionEdit
