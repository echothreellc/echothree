...
public interface EditSelectorDescriptionResult
        extends BaseEditResult<SelectorDescriptionEdit> {
    
    SelectorDescriptionTransfer getSelectorDescription();
    void setSelectorDescription(SelectorDescriptionTransfer selector);
