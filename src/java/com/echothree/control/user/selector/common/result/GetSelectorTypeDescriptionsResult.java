...
public interface GetSelectorTypeDescriptionsResult
        extends BaseResult {
    
    SelectorTypeTransfer getSelectorType();
    void setSelectorType(SelectorTypeTransfer selectorType);
    
    List<SelectorTypeDescriptionTransfer> getSelectorTypeDescriptions();
    void setSelectorTypeDescriptions(List<SelectorTypeDescriptionTransfer> selectorTypeDescriptions);
