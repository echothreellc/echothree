...
public interface GetSelectorNodeDescriptionsResult
        extends BaseResult {
    ...
    List<SelectorNodeDescriptionTransfer> getSelectorNodeDescriptions();
    void setSelectorNodeDescriptions(List<SelectorNodeDescriptionTransfer> selectorNodeDescriptions);
