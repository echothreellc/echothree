...
import com.echothree.control.user.selector.remote.form.DeleteSelectorTypeForm;
...
public class DeleteSelectorTypeCommand
        extends BaseSimpleCommand<DeleteSelectorTypeForm> {
    ...
    public DeleteSelectorTypeCommand(UserVisitPK userVisitPK, DeleteSelectorTypeForm form) {
