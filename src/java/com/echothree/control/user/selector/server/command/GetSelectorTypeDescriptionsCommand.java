...
import com.echothree.control.user.selector.common.form.GetSelectorTypeDescriptionsForm;
import com.echothree.control.user.selector.common.result.GetSelectorTypeDescriptionsResult;
...
public class GetSelectorTypeDescriptionsCommand
        extends BaseSimpleCommand<GetSelectorTypeDescriptionsForm> {
    ...
    public GetSelectorTypeDescriptionsCommand(UserVisitPK userVisitPK, GetSelectorTypeDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetSelectorTypeDescriptionsResult result = SelectorResultFactory.getGetSelectorTypeDescriptionsResult();
        ...
        if(selectorKind != null) {
            ...
            if(selectorType != null) {
                ...
                result.setSelectorTypeDescriptions(selectorControl.getSelectorTypeDescriptionTransfersBySelectorType(getUserVisit(), selectorType));
            } else {
