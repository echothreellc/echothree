...
import com.echothree.control.user.selector.remote.form.EditSelectorKindDescriptionForm;
import com.echothree.control.user.selector.remote.result.EditSelectorKindDescriptionResult;
...
public class EditSelectorKindDescriptionCommand
    ...
    public EditSelectorKindDescriptionCommand(UserVisitPK userVisitPK, EditSelectorKindDescriptionForm form) {
