...
import com.echothree.control.user.selector.remote.form.GetSelectorsForm;
import com.echothree.control.user.selector.remote.result.GetSelectorsResult;
...
public class GetSelectorsCommand
        extends BaseSimpleCommand<GetSelectorsForm> {
    ...
    protected BaseResult execute() {
        ...
        GetSelectorsResult result = SelectorResultFactory.getGetSelectorsResult();
        ...
        if(selectorKind != null) {
            ...
            if(selectorType != null) {
                ...
                result.setSelectors(selectorControl.getSelectorTransfersBySelectorType(getUserVisit(), selectorType));
            } else {
