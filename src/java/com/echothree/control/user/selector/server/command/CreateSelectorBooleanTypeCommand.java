...
@Dependent
public class CreateSelectorBooleanTypeCommand
        extends BaseSimpleCommand<CreateSelectorBooleanTypeForm> {
    ...
    protected BaseResult execute() {
        ...
        if(selectorBooleanType == null) {
            ...
            selectorControl.createSelectorBooleanType(selectorBooleanTypeName, isDefault, sortOrder, getPartyPK());
        } else {
            addExecutionError(ExecutionErrors.DuplicateSelectorBooleanTypeName.name(), selectorBooleanTypeName);
        }
