...
import com.echothree.control.user.selector.remote.form.DeleteSelectorTypeDescriptionForm;
...
public class DeleteSelectorTypeDescriptionCommand
    ...
    public DeleteSelectorTypeDescriptionCommand(UserVisitPK userVisitPK, DeleteSelectorTypeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(selectorKind != null) {
            ...
            if(selectorType != null) {
                ...
                if(language != null) {
                    SelectorTypeDescription selectorTypeDescription = selectorControl.getSelectorTypeDescriptionForUpdate(selectorType, language);
