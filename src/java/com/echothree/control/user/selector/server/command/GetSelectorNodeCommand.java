...
public class GetSelectorNodeCommand
    ...
    public GetSelectorNodeCommand(UserVisitPK userVisitPK, GetSelectorNodeForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetSelectorNodeResult result = SelectorResultFactory.getGetSelectorNodeResult();
