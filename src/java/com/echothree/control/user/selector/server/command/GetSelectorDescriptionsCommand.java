...
import com.echothree.control.user.selector.remote.form.GetSelectorDescriptionsForm;
import com.echothree.control.user.selector.remote.result.GetSelectorDescriptionsResult;
...
public class GetSelectorDescriptionsCommand
        extends BaseSimpleCommand<GetSelectorDescriptionsForm> {
    ...
    protected BaseResult execute() {
        ...
        GetSelectorDescriptionsResult result = SelectorResultFactory.getGetSelectorDescriptionsResult();
        ...
        if(selectorKind != null) {
            ...
            if(selectorType != null) {
                ...
                if(selector != null) {
                    ...
                    result.setSelectorDescriptions(selectorControl.getSelectorDescriptionTransfers(getUserVisit(), selector));
                } else {
