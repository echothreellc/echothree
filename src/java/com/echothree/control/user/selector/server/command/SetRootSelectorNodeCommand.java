...
import com.echothree.control.user.selector.remote.form.SetRootSelectorNodeForm;
...
public class SetRootSelectorNodeCommand
        extends BaseSimpleCommand<SetRootSelectorNodeForm> {
