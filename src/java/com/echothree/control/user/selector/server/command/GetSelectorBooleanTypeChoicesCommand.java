...
public class GetSelectorBooleanTypeChoicesCommand
        extends BaseSimpleCommand<GetSelectorBooleanTypeChoicesForm> {
    
    private final static List<FieldDefinition> FORM_FIELD_DEFINITIONS;
    
    static {
        FORM_FIELD_DEFINITIONS = Collections.unmodifiableList(Arrays.asList(
            new FieldDefinition("DefaultSelectorBooleanTypeChoice", FieldType.ENTITY_NAME, false, null, null),
