...
import com.echothree.control.user.selector.remote.form.CreateSelectorTypeDescriptionForm;
...
public class CreateSelectorTypeDescriptionCommand
        extends BaseSimpleCommand<CreateSelectorTypeDescriptionForm> {
    ...
    /** Creates a new instance of CreateSelectorTypeDescriptionCommand */
    public CreateSelectorTypeDescriptionCommand(UserVisitPK userVisitPK, CreateSelectorTypeDescriptionForm form) {
            ...
            if(selectorType != null) {
                ...
                if(language != null) {
                    ...
                    if(selectorTypeDescription == null) {
                        ...
                        addExecutionError(ExecutionErrors.DuplicateSelectorTypeDescription.name());
                    }
                } else {
                    addExecutionError(ExecutionErrors.UnknownLanguageIsoName.name(), selectorKindName, selectorTypeName, languageIsoName);
                }
            } else {
