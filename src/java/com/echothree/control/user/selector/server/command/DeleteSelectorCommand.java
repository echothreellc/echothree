...
public class DeleteSelectorCommand
        extends BaseSimpleCommand<DeleteSelectorForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(List.of(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), List.of(
                        new SecurityRoleDefinition(SecurityRoleGroups.Selector.name(), SecurityRoles.Delete.name())
                ))
        ));
    ...
    /** Creates a new instance of DeleteSelectorCommand */
    public DeleteSelectorCommand(UserVisitPK userVisitPK, DeleteSelectorForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(selectorKind != null) {
            ...
            if(selectorType != null) {
                ...
                if(selector != null) {
                    selectorControl.deleteSelector(selector, getPartyPK());
                } else {
