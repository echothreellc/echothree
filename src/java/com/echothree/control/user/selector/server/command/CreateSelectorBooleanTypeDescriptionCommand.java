...
public class CreateSelectorBooleanTypeDescriptionCommand
    ...
    public CreateSelectorBooleanTypeDescriptionCommand() {
        ...
        if(selectorBooleanType != null) {
            ...
            if(language != null) {
                ...
                if(selectorBooleanTypeDescription == null) {
                    ...
                    selectorControl.createSelectorBooleanTypeDescription(selectorBooleanType, language, description, getPartyPK());
                } else {
