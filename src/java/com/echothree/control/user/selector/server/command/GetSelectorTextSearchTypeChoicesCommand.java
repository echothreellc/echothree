...
import com.echothree.control.user.selector.remote.form.GetSelectorTextSearchTypeChoicesForm;
import com.echothree.control.user.selector.remote.result.GetSelectorTextSearchTypeChoicesResult;
...
public class GetSelectorTextSearchTypeChoicesCommand
        extends BaseSimpleCommand<GetSelectorTextSearchTypeChoicesForm> {
    
    private final static List<FieldDefinition> FORM_FIELD_DEFINITIONS;
    
    static {
        FORM_FIELD_DEFINITIONS = Collections.unmodifiableList(Arrays.asList(
            new FieldDefinition("DefaultSelectorTextSearchTypeChoice", FieldType.ENTITY_NAME, false, null, null),
