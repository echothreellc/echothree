...
import com.echothree.control.user.selector.remote.form.GetSelectorKindDescriptionForm;
import com.echothree.control.user.selector.remote.result.GetSelectorKindDescriptionResult;
...
public class GetSelectorKindDescriptionCommand
        extends BaseSimpleCommand<GetSelectorKindDescriptionForm> {
    ...
    /** Creates a new instance of GetSelectorKindDescriptionCommand */
    public GetSelectorKindDescriptionCommand(UserVisitPK userVisitPK, GetSelectorKindDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetSelectorKindDescriptionResult result = SelectorResultFactory.getGetSelectorKindDescriptionResult();
