...
public class GetPrinterGroupsCommand
        extends BaseSimpleCommand<GetPrinterGroupsForm> {
    ...
    public GetPrinterGroupsCommand(UserVisitPK userVisitPK, GetPrinterGroupsForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetPrinterGroupsResult result = PrinterResultFactory.getGetPrinterGroupsResult();

        result.setPrinterGroups(printerControl.getPrinterGroupTransfers(getUserVisit()));
