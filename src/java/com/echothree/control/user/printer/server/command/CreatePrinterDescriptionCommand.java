...
public class CreatePrinterDescriptionCommand
        extends BaseSimpleCommand<CreatePrinterDescriptionForm> {
   ...
   private final static List<FieldDefinition> FORM_FIELD_DEFINITIONS;
    ...
    /** Creates a new instance of CreatePrinterDescriptionCommand */
    public CreatePrinterDescriptionCommand(UserVisitPK userVisitPK, CreatePrinterDescriptionForm form) {
        ...
        if(printer != null) {
            ...
            if(language != null) {
                ...
                if(printerDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicatePrinterDescription.name());
                }
            } else {
