...
import com.echothree.control.user.printer.remote.form.SetPrinterStatusForm;
...
public class SetPrinterStatusCommand
        extends BaseSimpleCommand<SetPrinterStatusForm> {
    ...
    static {
        FORM_FIELD_DEFINITIONS = Collections.unmodifiableList(Arrays.asList(
                ...
                new FieldDefinition("PrinterStatusChoice", FieldType.ENTITY_NAME, true, null, null)
                ));
    }
    ...
    protected BaseResult execute() {
        ...
        if(printer != null) {
            String printerStatusChoice = form.getPrinterStatusChoice();
            
            printerControl.setPrinterStatus(this, printer, printerStatusChoice, getPartyPK());
        } else {
