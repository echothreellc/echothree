...
import com.echothree.control.user.printer.remote.form.GetPrinterGroupJobForm;
import com.echothree.control.user.printer.remote.result.GetPrinterGroupJobResult;
...
public class GetPrinterGroupJobCommand
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.PrinterGroupJob.name(), SecurityRoles.Review.name())
                        )))
                )));
    ...
    public GetPrinterGroupJobCommand(UserVisitPK userVisitPK, GetPrinterGroupJobForm form) {
