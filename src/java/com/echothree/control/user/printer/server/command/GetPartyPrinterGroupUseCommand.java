...
import com.echothree.control.user.printer.remote.form.GetPartyPrinterGroupUseForm;
import com.echothree.control.user.printer.remote.result.GetPartyPrinterGroupUseResult;
...
public class GetPartyPrinterGroupUseCommand
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.PartyPrinterGroupUse.name(), SecurityRoles.Review.name())
                        )))
                )));
    ...
    /** Creates a new instance of GetPartyPrinterGroupUseCommand */
    public GetPartyPrinterGroupUseCommand(UserVisitPK userVisitPK, GetPartyPrinterGroupUseForm form) {
