...
import com.echothree.control.user.printer.common.form.GetPrinterGroupDescriptionForm;
import com.echothree.control.user.printer.common.result.GetPrinterGroupDescriptionResult;
...
public class GetPrinterGroupDescriptionCommand
        extends BaseSimpleCommand<GetPrinterGroupDescriptionForm> {
    ...
    /** Creates a new instance of GetPrinterGroupDescriptionCommand */
    public GetPrinterGroupDescriptionCommand(UserVisitPK userVisitPK, GetPrinterGroupDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetPrinterGroupDescriptionResult result = PrinterResultFactory.getGetPrinterGroupDescriptionResult();
        ...
        if(printerGroup != null) {
            ...
            if(language != null) {
                PrinterGroupDescription printerGroupDescription = printerControl.getPrinterGroupDescription(printerGroup, language);
