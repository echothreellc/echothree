...
@Dependent
public class CreateLicenseTypeDescriptionCommand
        extends BaseSimpleCommand<CreateLicenseTypeDescriptionForm> {
        ...
        if(licenseType != null) {
            ...
            if(language != null) {
                ...
                if(licenseTypeDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateLicenseTypeDescription.name(), licenseTypeName, languageIsoName);
                }
            } else {
