...
import com.echothree.control.user.license.remote.form.GetLicenseTypeDescriptionsForm;
import com.echothree.control.user.license.remote.result.GetLicenseTypeDescriptionsResult;
...
public class GetLicenseTypeDescriptionsCommand
        extends BaseSimpleCommand<GetLicenseTypeDescriptionsForm> {
    ...
    /** Creates a new instance of GetLicenseTypeDescriptionsCommand */
    public GetLicenseTypeDescriptionsCommand(UserVisitPK userVisitPK, GetLicenseTypeDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(licenseType != null) {
            ...
            result.setLicenseTypeDescriptions(licenseControl.getLicenseTypeDescriptionTransfersByLicenseType(getUserVisit(), licenseType));
        } else {
