...
import com.echothree.control.user.license.remote.form.GetLicenseTypeForm;
import com.echothree.control.user.license.remote.result.GetLicenseTypeResult;
...
public class GetLicenseTypeCommand
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.LicenseType.name(), SecurityRoles.Review.name())
                        )))
                )));
        
        FORM_FIELD_DEFINITIONS = Collections.unmodifiableList(Arrays.asList(
                new FieldDefinition("LicenseTypeName", FieldType.ENTITY_NAME, false, null, null),
    ...
    public GetLicenseTypeCommand(UserVisitPK userVisitPK, GetLicenseTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(parameterCount == 1) {
            ...
            if(!hasExecutionErrors()) {
                ...
                sendEventUsingNames(licenseType.getPrimaryKey(), EventTypes.READ.name(), null, null, getPartyPK());
            }
        } else {
