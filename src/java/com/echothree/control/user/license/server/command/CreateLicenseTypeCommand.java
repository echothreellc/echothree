...
import com.echothree.control.user.license.common.form.CreateLicenseTypeForm;
...
public class CreateLicenseTypeCommand
        extends BaseSimpleCommand<CreateLicenseTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.LicenseType.name(), SecurityRoles.Create.name())
                        )))
                )));
    ...
    public CreateLicenseTypeCommand(UserVisitPK userVisitPK, CreateLicenseTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(licenseType == null) {
            ...
            licenseType = licenseControl.createLicenseType(licenseTypeName, isDefault, sortOrder, partyPK);
