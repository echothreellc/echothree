...
import com.echothree.control.user.license.common.form.DeleteLicenseTypeForm;
...
@RequestScoped
public class DeleteLicenseTypeCommand
        extends BaseSimpleCommand<DeleteLicenseTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.LicenseType.name(), SecurityRoles.Delete.name())
                        )))
                )));
