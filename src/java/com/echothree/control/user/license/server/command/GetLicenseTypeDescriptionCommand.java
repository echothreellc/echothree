...
import com.echothree.control.user.license.remote.form.GetLicenseTypeDescriptionForm;
import com.echothree.control.user.license.remote.result.GetLicenseTypeDescriptionResult;
...
public class GetLicenseTypeDescriptionCommand
        extends BaseSimpleCommand<GetLicenseTypeDescriptionForm> {
    ...
    public GetLicenseTypeDescriptionCommand(UserVisitPK userVisitPK, GetLicenseTypeDescriptionForm form) {
