...
public interface EditInvoiceLineTypeDescriptionResult
        extends BaseEditResult<InvoiceLineTypeDescriptionEdit> {
    
    InvoiceLineTypeDescriptionTransfer getInvoiceLineTypeDescription();
    void setInvoiceLineTypeDescription(InvoiceLineTypeDescriptionTransfer invoiceLineTypeDescription);
