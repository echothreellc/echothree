...
public interface GetInvoiceLineTypeChoicesForm
        extends InvoiceTypeSpec {
    
    String getDefaultInvoiceLineTypeChoice();
    void setDefaultInvoiceLineTypeChoice(String defaultInvoiceLineTypeChoice);
