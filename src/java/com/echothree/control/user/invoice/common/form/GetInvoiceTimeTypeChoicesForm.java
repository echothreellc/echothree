...
public interface GetInvoiceTimeTypeChoicesForm
        extends InvoiceTypeSpec {
    
    String getDefaultInvoiceTimeTypeChoice();
    void setDefaultInvoiceTimeTypeChoice(String defaultInvoiceTimeTypeChoice);
