...
public interface EditInvoiceTypeDescriptionResult
        extends BaseEditResult<InvoiceTypeDescriptionEdit> {
    
    InvoiceTypeDescriptionTransfer getInvoiceTypeDescription();
    void setInvoiceTypeDescription(InvoiceTypeDescriptionTransfer invoiceTypeDescription);
