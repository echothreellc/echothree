...
public interface EditInvoiceTimeTypeResult
        extends BaseEditResult<InvoiceTimeTypeEdit> {

    InvoiceTimeTypeTransfer getInvoiceTimeType();
    void setInvoiceTimeType(InvoiceTimeTypeTransfer invoiceTimeType);
