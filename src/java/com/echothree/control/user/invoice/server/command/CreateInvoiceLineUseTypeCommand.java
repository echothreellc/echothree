...
import com.echothree.control.user.invoice.remote.form.CreateInvoiceLineUseTypeForm;
...
public class CreateInvoiceLineUseTypeCommand
        extends BaseSimpleCommand<CreateInvoiceLineUseTypeForm> {
    ...
    public CreateInvoiceLineUseTypeCommand(UserVisitPK userVisitPK, CreateInvoiceLineUseTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(invoiceLineUseType == null) {
            ...
            addExecutionError(ExecutionErrors.DuplicateInvoiceLineUseTypeName.name(), invoiceLineUseTypeName);
        }
