...
import com.echothree.control.user.invoice.common.form.GetInvoiceTimeTypeChoicesForm;
import com.echothree.control.user.invoice.common.result.GetInvoiceTimeTypeChoicesResult;
...
public class GetInvoiceTimeTypeChoicesCommand
        extends BaseSimpleCommand<GetInvoiceTimeTypeChoicesForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.InvoiceTimeType.name(), SecurityRoles.Choices.name())
                        )))
                )));
        
        FORM_FIELD_DEFINITIONS = Collections.unmodifiableList(Arrays.asList(
                new FieldDefinition("InvoiceTypeName", FieldType.ENTITY_NAME, true, null, null),
                new FieldDefinition("DefaultInvoiceTimeTypeChoice", FieldType.ENTITY_NAME, false, null, null),
