...
public class CreateInvoiceTimeTypeCommand
        extends BaseSimpleCommand<CreateInvoiceTimeTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                    new SecurityRoleDefinition(SecurityRoleGroups.InvoiceTimeType.name(), SecurityRoles.Create.name())
                    )))
                )));
    ...
    /** Creates a new instance of CreateInvoiceTimeTypeCommand */
    public CreateInvoiceTimeTypeCommand(UserVisitPK userVisitPK, CreateInvoiceTimeTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(invoiceType != null) {
            ...
            if(invoiceTimeType == null) {
                ...
                invoiceTimeType = invoiceControl.createInvoiceTimeType(invoiceType, invoiceTimeTypeName, isDefault, sortOrder, partyPK);
