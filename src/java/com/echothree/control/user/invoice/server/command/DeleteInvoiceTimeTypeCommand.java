...
import com.echothree.control.user.invoice.common.form.DeleteInvoiceTimeTypeForm;
...
public class DeleteInvoiceTimeTypeCommand
        extends BaseSimpleCommand<DeleteInvoiceTimeTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.InvoiceTimeType.name(), SecurityRoles.Delete.name())
                        )))
                )));
    ...
    /** Creates a new instance of DeleteInvoiceTimeTypeCommand */
    public DeleteInvoiceTimeTypeCommand(UserVisitPK userVisitPK, DeleteInvoiceTimeTypeForm form) {
