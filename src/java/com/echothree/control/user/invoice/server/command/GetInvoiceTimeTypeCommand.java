...
import com.echothree.control.user.invoice.common.form.GetInvoiceTimeTypeForm;
import com.echothree.control.user.invoice.common.result.GetInvoiceTimeTypeResult;
...
public class GetInvoiceTimeTypeCommand
    ...
    protected BaseResult execute() {
        ...
        GetInvoiceTimeTypeResult result = InvoiceResultFactory.getGetInvoiceTimeTypeResult();
        ...
        if(invoiceType != null) {
            ...
            if(invoiceTimeType != null) {
                ...
                sendEventUsingNames(invoiceTimeType.getPrimaryKey(), EventTypes.READ.name(), null, null, getPartyPK());
            } else {
