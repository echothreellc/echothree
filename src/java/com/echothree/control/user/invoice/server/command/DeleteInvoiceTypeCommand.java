...
import com.echothree.control.user.invoice.common.form.DeleteInvoiceTypeForm;
...
@Dependent
public class DeleteInvoiceTypeCommand
        extends BaseSimpleCommand<DeleteInvoiceTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.InvoiceType.name(), SecurityRoles.Delete.name())
                        )))
                )));
