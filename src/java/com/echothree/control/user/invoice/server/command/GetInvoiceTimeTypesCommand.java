...
import com.echothree.control.user.invoice.common.result.GetInvoiceTimeTypesResult;
...
public class GetInvoiceTimeTypesCommand
        extends BaseSimpleCommand<GetInvoiceTimeTypesForm> {
    ...
    public GetInvoiceTimeTypesCommand(UserVisitPK userVisitPK, GetInvoiceTimeTypesForm form) {
