...
import com.echothree.control.user.invoice.remote.form.GetInvoiceTypesForm;
import com.echothree.control.user.invoice.remote.result.GetInvoiceTypesResult;
...
public class GetInvoiceTypesCommand
        extends BaseSimpleCommand<GetInvoiceTypesForm> {
    ...
    public GetInvoiceTypesCommand(UserVisitPK userVisitPK, GetInvoiceTypesForm form) {
