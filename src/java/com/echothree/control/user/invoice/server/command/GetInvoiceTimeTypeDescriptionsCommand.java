...
import com.echothree.control.user.invoice.common.form.GetInvoiceTimeTypeDescriptionsForm;
import com.echothree.control.user.invoice.common.result.GetInvoiceTimeTypeDescriptionsResult;
...
public class GetInvoiceTimeTypeDescriptionsCommand
        extends BaseSimpleCommand<GetInvoiceTimeTypeDescriptionsForm> {
    ...
    /** Creates a new instance of GetInvoiceTimeTypeDescriptionsCommand */
    public GetInvoiceTimeTypeDescriptionsCommand(UserVisitPK userVisitPK, GetInvoiceTimeTypeDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetInvoiceTimeTypeDescriptionsResult result = InvoiceResultFactory.getGetInvoiceTimeTypeDescriptionsResult();
        ...
        if(invoiceType != null) {
            ...
            if(invoiceTimeType != null) {
                ...
                result.setInvoiceTimeTypeDescriptions(invoiceControl.getInvoiceTimeTypeDescriptionTransfersByInvoiceTimeType(getUserVisit(), invoiceTimeType));
            } else {
