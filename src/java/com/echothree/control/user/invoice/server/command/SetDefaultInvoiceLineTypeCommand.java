...
import com.echothree.control.user.invoice.common.form.SetDefaultInvoiceLineTypeForm;
...
@RequestScoped
public class SetDefaultInvoiceLineTypeCommand
        extends BaseSimpleCommand<SetDefaultInvoiceLineTypeForm> {
