...
public class CreateInvoiceTypeDescriptionCommand
        extends BaseSimpleCommand<CreateInvoiceTypeDescriptionForm> {
    ...
    /** Creates a new instance of CreateInvoiceTypeDescriptionCommand */
    public CreateInvoiceTypeDescriptionCommand(UserVisitPK userVisitPK, CreateInvoiceTypeDescriptionForm form) {
        ...
        if(invoiceType != null) {
            ...
            if(language != null) {
                ...
                if(invoiceTypeDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateInvoiceTypeDescription.name());
                }
            } else {
