...
import com.echothree.control.user.invoice.common.form.SetDefaultInvoiceTimeTypeForm;
...
public class SetDefaultInvoiceTimeTypeCommand
        extends BaseSimpleCommand<SetDefaultInvoiceTimeTypeForm> {
    ...
    protected BaseResult execute() {
        ...
        if(invoiceType != null) {
            ...
            InvoiceTimeTypeDetailValue invoiceTimeTypeDetailValue = invoiceControl.getInvoiceTimeTypeDetailValueByNameForUpdate(invoiceType, invoiceTimeTypeName);
