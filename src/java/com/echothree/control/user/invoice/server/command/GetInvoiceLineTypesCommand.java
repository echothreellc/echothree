...
import com.echothree.control.user.invoice.common.result.GetInvoiceLineTypesResult;
...
public class GetInvoiceLineTypesCommand
        extends BaseSimpleCommand<GetInvoiceLineTypesForm> {
    ...
    public GetInvoiceLineTypesCommand(UserVisitPK userVisitPK, GetInvoiceLineTypesForm form) {
