...
import com.echothree.control.user.invoice.common.form.SetDefaultInvoiceTypeForm;
...
@Dependent
public class SetDefaultInvoiceTypeCommand
        extends BaseSimpleCommand<SetDefaultInvoiceTypeForm> {
