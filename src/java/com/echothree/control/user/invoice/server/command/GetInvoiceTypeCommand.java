...
import com.echothree.control.user.invoice.remote.form.GetInvoiceTypeForm;
import com.echothree.control.user.invoice.remote.result.GetInvoiceTypeResult;
...
public class GetInvoiceTypeCommand
    ...
    public GetInvoiceTypeCommand(UserVisitPK userVisitPK, GetInvoiceTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetInvoiceTypeResult result = InvoiceResultFactory.getGetInvoiceTypeResult();
        ...
        if(invoiceType != null) {
            ...
            sendEventUsingNames(invoiceType.getPrimaryKey(), EventTypes.READ.name(), null, null, getPartyPK());
        } else {
