...
import com.echothree.control.user.invoice.remote.form.CreateInvoiceTimeTypeDescriptionForm;
...
public class CreateInvoiceTimeTypeDescriptionCommand
        extends BaseSimpleCommand<CreateInvoiceTimeTypeDescriptionForm> {
            ...
            if(invoiceTimeType != null) {
                ...
                if(language != null) {
                    ...
                    if(invoiceTimeTypeDescription == null) {
                        ...
                        addExecutionError(ExecutionErrors.DuplicateInvoiceTimeTypeDescription.name(), invoiceTypeName, invoiceTimeTypeName, languageIsoName);
                    }
                } else {
