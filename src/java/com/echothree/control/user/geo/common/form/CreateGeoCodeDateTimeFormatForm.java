...
public interface CreateGeoCodeDateTimeFormatForm
        extends GeoCodeDateTimeFormatSpec, GeoCodeDateTimeFormatEdit {
    
    // Nothing additional beyond GeoCodeDateTimeFormatSpec, GeoCodeDateTimeFormatEdit
