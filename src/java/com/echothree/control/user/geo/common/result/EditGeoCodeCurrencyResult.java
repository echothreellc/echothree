...
public interface EditGeoCodeCurrencyResult
        extends BaseEditResult<GeoCodeCurrencyEdit> {
    
    GeoCodeCurrencyTransfer getGeoCodeCurrency();
    void setGeoCodeCurrency(GeoCodeCurrencyTransfer geoCodeCurrency);
