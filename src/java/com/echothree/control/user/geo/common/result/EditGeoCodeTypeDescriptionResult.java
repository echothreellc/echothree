...
public interface EditGeoCodeTypeDescriptionResult 
        extends BaseEditResult<GeoCodeTypeDescriptionEdit> {
    
    GeoCodeTypeDescriptionTransfer getGeoCodeTypeDescription();
    void setGeoCodeTypeDescription(GeoCodeTypeDescriptionTransfer geoCodeTypeDescription);
