...
public interface EditGeoCodeScopeDescriptionResult 
        extends BaseEditResult<GeoCodeScopeDescriptionEdit> {
    
    GeoCodeScopeDescriptionTransfer getGeoCodeScopeDescription();
    void setGeoCodeScopeDescription(GeoCodeScopeDescriptionTransfer geoCodeScopeDescription);
