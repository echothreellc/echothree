...
public interface CreateGeoCodeDescriptionForm
        extends GeoCodeDescriptionSpec, GeoCodeDescriptionEdit {
    
    // Nothing additional beyond GeoCodeDescriptionSpec, GeoCodeDescriptionEdit
