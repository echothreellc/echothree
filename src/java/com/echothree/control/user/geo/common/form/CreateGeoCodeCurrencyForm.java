...
public interface CreateGeoCodeCurrencyForm
        extends GeoCodeCurrencySpec, GeoCodeCurrencyEdit {
    
    // Nothing additional beyond GeoCodeCurrencySpec, GeoCodeCurrencyEdit
