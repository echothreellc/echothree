...
public interface CreateGeoCodeScopeDescriptionForm
        extends GeoCodeScopeDescriptionSpec, GeoCodeScopeDescriptionEdit {
    
    // Nothing additional beyond GeoCodeScopeDescriptionSpec, GeoCodeScopeDescriptionEdit
