...
public interface CreateGeoCodeAliasTypeResult
        extends GeoCodeAliasTypeSpec, EntityRefSpec, BaseResult {
    
    // Nothing additional beyond ItemAliasTypeSpec, EntityRefSpec, BaseResult
