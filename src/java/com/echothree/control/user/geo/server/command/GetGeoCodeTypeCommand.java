...
public class GetGeoCodeTypeCommand
        extends BaseSimpleCommand<GetGeoCodeTypeForm> {
    ...
    public GetGeoCodeTypeCommand(UserVisitPK userVisitPK, GetGeoCodeTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(geoCodeType != null) {
            ...
            sendEventUsingNames(geoCodeType.getPrimaryKey(), EventTypes.READ, null, null, getPartyPK());
        } else {
