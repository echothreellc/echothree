...
import com.echothree.control.user.geo.remote.form.GetGeoCodeTypeDescriptionsForm;
import com.echothree.control.user.geo.remote.result.GeoResultFactory;
import com.echothree.control.user.geo.remote.result.GetGeoCodeTypeDescriptionsResult;
...
public class GetGeoCodeTypeDescriptionsCommand
    ...
    public GetGeoCodeTypeDescriptionsCommand(UserVisitPK userVisitPK, GetGeoCodeTypeDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetGeoCodeTypeDescriptionsResult result = GeoResultFactory.getGetGeoCodeTypeDescriptionsResult();
