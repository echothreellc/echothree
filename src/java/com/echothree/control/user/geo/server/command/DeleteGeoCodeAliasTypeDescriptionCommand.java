...
public class DeleteGeoCodeAliasTypeDescriptionCommand
        extends BaseSimpleCommand<DeleteGeoCodeAliasTypeDescriptionForm> {
    ...
    protected BaseResult execute() {
        ...
        if(geoCodeType != null) {
            ...
            if(geoAliasType != null) {
                ...
                if(language != null) {
                    GeoCodeAliasTypeDescription geoAliasTypeDescription = geoControl.getGeoCodeAliasTypeDescriptionForUpdate(geoAliasType, language);

                    if(geoAliasTypeDescription != null) {
                        geoControl.deleteGeoCodeAliasTypeDescription(geoAliasTypeDescription, getPartyPK());
                    } else {
