...
import com.echothree.control.user.geo.remote.form.GetGeoCodeAliasTypeDescriptionForm;
import com.echothree.control.user.geo.remote.result.GeoResultFactory;
import com.echothree.control.user.geo.remote.result.GetGeoCodeAliasTypeDescriptionResult;
...
public class GetGeoCodeAliasTypeDescriptionCommand
        extends BaseSimpleCommand<GetGeoCodeAliasTypeDescriptionForm> {
    ...
    /** Creates a new instance of GetGeoCodeAliasTypeDescriptionCommand */
    public GetGeoCodeAliasTypeDescriptionCommand(UserVisitPK userVisitPK, GetGeoCodeAliasTypeDescriptionForm form) {
