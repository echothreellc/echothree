...
import com.echothree.control.user.geo.remote.form.GetGeoCodeScopeDescriptionsForm;
import com.echothree.control.user.geo.remote.result.GeoResultFactory;
import com.echothree.control.user.geo.remote.result.GetGeoCodeScopeDescriptionsResult;
...
public class GetGeoCodeScopeDescriptionsCommand
        extends BaseSimpleCommand<GetGeoCodeScopeDescriptionsForm> {
    ...
    /** Creates a new instance of GetGeoCodeScopeDescriptionsCommand */
    public GetGeoCodeScopeDescriptionsCommand(UserVisitPK userVisitPK, GetGeoCodeScopeDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(geoCodeScope != null) {
            ...
            result.setGeoCodeScopeDescriptions(geoControl.getGeoCodeScopeDescriptionTransfers(getUserVisit(), geoCodeScope));
        } else {
