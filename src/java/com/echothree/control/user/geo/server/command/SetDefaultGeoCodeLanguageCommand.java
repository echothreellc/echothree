...
import com.echothree.control.user.geo.remote.form.SetDefaultGeoCodeLanguageForm;
...
public class SetDefaultGeoCodeLanguageCommand
        extends BaseSimpleCommand<SetDefaultGeoCodeLanguageForm> {
    ...
    protected BaseResult execute() {
        ...
        if(geoCode != null) {
            ...
            if(language != null) {
                GeoCodeLanguageValue geoCodeLanguageValue = geoControl.getGeoCodeLanguageValueForUpdate(geoCode, language);
