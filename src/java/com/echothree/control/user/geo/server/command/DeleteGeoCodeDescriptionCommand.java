...
import com.echothree.control.user.geo.common.form.DeleteGeoCodeDescriptionForm;
...
public class DeleteGeoCodeDescriptionCommand
        extends BaseSimpleCommand<DeleteGeoCodeDescriptionForm> {
        ...
        if(geoCode != null) {
            ...
            if(language != null) {
                ...
                if(geoCodeDescription != null) {
                    geoControl.deleteGeoCodeDescription(geoCodeDescription, getPartyPK());
                } else {
