...
import com.echothree.control.user.geo.common.form.DeleteGeoCodeScopeForm;
...
public class DeleteGeoCodeScopeCommand
        extends BaseSimpleCommand<DeleteGeoCodeScopeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.GeoCodeScope.name(), SecurityRoles.Delete.name())
                        )))
                )));
    ...
    public DeleteGeoCodeScopeCommand(UserVisitPK userVisitPK, DeleteGeoCodeScopeForm form) {
