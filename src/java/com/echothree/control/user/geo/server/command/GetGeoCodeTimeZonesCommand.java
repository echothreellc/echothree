...
import com.echothree.control.user.geo.remote.form.GetGeoCodeTimeZonesForm;
import com.echothree.control.user.geo.remote.result.GeoResultFactory;
import com.echothree.control.user.geo.remote.result.GetGeoCodeTimeZonesResult;
...
public class GetGeoCodeTimeZonesCommand
    ...
    protected BaseResult execute() {
        ...
        int parameterCount = (geoCodeName != null? 1: 0) + (javaTimeZoneName != null? 1: 0);
