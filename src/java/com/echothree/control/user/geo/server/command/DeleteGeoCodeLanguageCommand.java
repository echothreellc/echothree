...
import com.echothree.control.user.geo.common.form.DeleteGeoCodeLanguageForm;
...
@RequestScoped
public class DeleteGeoCodeLanguageCommand
        extends BaseSimpleCommand<DeleteGeoCodeLanguageForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.GeoCodeLanguage.name(), SecurityRoles.Delete.name())
                        )))
                )));
        ...
        if(geoCode != null) {
            ...
            if(language != null) {
                ...
                if(geoCodeLanguage != null) {
                    geoControl.deleteGeoCodeLanguage(geoCodeLanguage, getPartyPK());
                } else {
