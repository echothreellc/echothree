...
import com.echothree.control.user.geo.remote.form.GetZipCodeForm;
import com.echothree.control.user.geo.remote.result.GeoResultFactory;
import com.echothree.control.user.geo.remote.result.GetZipCodeResult;
...
public class GetZipCodeCommand
        extends BaseSimpleCommand<GetZipCodeForm> {
    ...
    protected BaseResult execute() {
        GetZipCodeResult result = GeoResultFactory.getGetZipCodeResult();
