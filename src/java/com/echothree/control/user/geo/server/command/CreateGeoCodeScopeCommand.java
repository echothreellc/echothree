...
@Dependent
public class CreateGeoCodeScopeCommand
        extends BaseSimpleCommand<CreateGeoCodeScopeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.GeoCodeScope.name(), SecurityRoles.Create.name())
                        )))
                )));
        
        FORM_FIELD_DEFINITIONS = Collections.unmodifiableList(Arrays.asList(
                new FieldDefinition("GeoCodeScopeName", FieldType.ENTITY_NAME, true, null, null),
                new FieldDefinition("ParentGeoCodeScopeName", FieldType.ENTITY_NAME, false, null, null),
    ...
    protected BaseResult execute() {
        ...
        if(geoCodeScope == null) {
                ...
                geoCodeScope = geoControl.createGeoCodeScope(geoCodeScopeName, isDefault, sortOrder, partyPK);
