...
import com.echothree.control.user.geo.remote.form.GetGeoCodeAliasTypeDescriptionsForm;
import com.echothree.control.user.geo.remote.result.GeoResultFactory;
import com.echothree.control.user.geo.remote.result.GetGeoCodeAliasTypeDescriptionsResult;
...
public class GetGeoCodeAliasTypeDescriptionsCommand
        extends BaseSimpleCommand<GetGeoCodeAliasTypeDescriptionsForm> {
    ...
    protected BaseResult execute() {
        ...
        GetGeoCodeAliasTypeDescriptionsResult result = GeoResultFactory.getGetGeoCodeAliasTypeDescriptionsResult();
        ...
        if(geoCodeType != null) {
            ...
            if(geoAliasType != null) {
                ...
                result.setGeoCodeAliasTypeDescriptions(geoControl.getGeoCodeAliasTypeDescriptionTransfers(getUserVisit(), geoAliasType));
            } else {
