...
import com.echothree.control.user.geo.remote.form.CreateCityForm;
import com.echothree.control.user.geo.remote.result.CreateCityResult;
...
public class CreateCityCommand
        extends BaseSimpleCommand<CreateCityForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.City.name(), SecurityRoles.Create.name())
                        )))
                )));
    ...
    protected BaseResult execute() {
        ...
        if(geoCodeAlias == null) {
            ...
            geoControl.createGeoCodeAlias(geoCode, geoCodeAliasType, cityName, createdBy);
