...
public class CreateGeoCodeDescriptionCommand
        extends BaseSimpleCommand<CreateGeoCodeDescriptionForm> {
    ...
    /** Creates a new instance of CreateGeoCodeDescriptionCommand */
    public CreateGeoCodeDescriptionCommand(UserVisitPK userVisitPK, CreateGeoCodeDescriptionForm form) {
        ...
        if(geoCode != null) {
            ...
            if(language != null) {
                ...
                if(geoCodeDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateGeoCodeDescription.name(), geoCodeName, languageIsoName);
                }
            } else {
