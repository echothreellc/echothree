...
import com.echothree.control.user.geo.remote.form.DeleteGeoCodeAliasTypeForm;
...
public class DeleteGeoCodeAliasTypeCommand
        extends BaseSimpleCommand<DeleteGeoCodeAliasTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.GeoCodeAliasType.name(), SecurityRoles.Delete.name())
                        )))
                )));
    ...
    /** Creates a new instance of DeleteGeoCodeAliasTypeCommand */
    public DeleteGeoCodeAliasTypeCommand(UserVisitPK userVisitPK, DeleteGeoCodeAliasTypeForm form) {
