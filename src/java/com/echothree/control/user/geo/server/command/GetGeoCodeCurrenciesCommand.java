...
import com.echothree.control.user.geo.remote.form.GetGeoCodeCurrenciesForm;
import com.echothree.control.user.geo.remote.result.GeoResultFactory;
import com.echothree.control.user.geo.remote.result.GetGeoCodeCurrenciesResult;
...
public class GetGeoCodeCurrenciesCommand
    ...
    protected BaseResult execute() {
        ...
        int parameterCount = (geoCodeName != null? 1: 0) + (currencyIsoName != null? 1: 0);
