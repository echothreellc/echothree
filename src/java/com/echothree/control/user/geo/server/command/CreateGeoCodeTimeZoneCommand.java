...
public class CreateGeoCodeTimeZoneCommand
        extends BaseSimpleCommand<CreateGeoCodeTimeZoneForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.GeoCodeTimeZone.name(), SecurityRoles.Create.name())
                        )))
                )));
        ...
        if(geoCode != null) {
            ...
            if(timeZone != null) {
                ...
                if(geoCodeTimeZone == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateGeoCodeTimeZone.name(), geoCodeName, javaTimeZoneName);
                }
            } else {
