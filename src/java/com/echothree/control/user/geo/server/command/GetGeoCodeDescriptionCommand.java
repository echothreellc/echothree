...
import com.echothree.control.user.geo.remote.form.GetGeoCodeDescriptionForm;
import com.echothree.control.user.geo.remote.result.GeoResultFactory;
import com.echothree.control.user.geo.remote.result.GetGeoCodeDescriptionResult;
...
public class GetGeoCodeDescriptionCommand
        extends BaseSimpleCommand<GetGeoCodeDescriptionForm> {
    ...
    /** Creates a new instance of GetGeoCodeDescriptionCommand */
    public GetGeoCodeDescriptionCommand(UserVisitPK userVisitPK, GetGeoCodeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetGeoCodeDescriptionResult result = GeoResultFactory.getGetGeoCodeDescriptionResult();
        ...
        if(geoCode != null) {
            ...
            if(language != null) {
                GeoCodeDescription geoCodeDescription = geoControl.getGeoCodeDescriptionForUpdate(geoCode, language);
