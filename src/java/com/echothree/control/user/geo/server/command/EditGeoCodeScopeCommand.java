...
import com.echothree.control.user.geo.remote.edit.GeoCodeScopeEdit;
import com.echothree.control.user.geo.remote.edit.GeoEditFactory;
import com.echothree.control.user.geo.remote.form.EditGeoCodeScopeForm;
import com.echothree.control.user.geo.remote.result.EditGeoCodeScopeResult;
import com.echothree.control.user.geo.remote.result.GeoResultFactory;
import com.echothree.control.user.geo.remote.spec.GeoCodeScopeSpec;
...
public class EditGeoCodeScopeCommand
    ...
    public EditGeoCodeScopeCommand(UserVisitPK userVisitPK, EditGeoCodeScopeForm form) {
