...
import com.echothree.control.user.geo.common.form.GetGeoCodeDateTimeFormatForm;
...
@Dependent
public class GetGeoCodeDateTimeFormatCommand
        extends BaseSingleEntityCommand<GeoCodeDateTimeFormat, GetGeoCodeDateTimeFormatForm> {
    ...
    protected GeoCodeDateTimeFormat getEntity() {
        ...
        if(geoCode != null) {
            ...
            if(dateTimeFormat != null) {
                geoCodeDateTimeFormat = geoControl.getGeoCodeDateTimeFormatForUpdate(geoCode, dateTimeFormat);

                if(geoCodeDateTimeFormat == null) {
                    addExecutionError(ExecutionErrors.UnknownGeoCodeDateTimeFormat.name(),
                            geoCode.getLastDetail().getGeoCodeName(),
                            dateTimeFormat.getLastDetail().getDateTimeFormatName());
                }
            } else {
    ...
    @Override
    protected BaseResult getResult(GeoCodeDateTimeFormat geoCodeDateTimeFormat) {
