...
import com.echothree.control.user.geo.common.result.GetGeoCodeDateTimeFormatResult;
...
public class GetGeoCodeDateTimeFormatCommand
        extends BaseSimpleCommand<GetGeoCodeDateTimeFormatForm> {
    ...
    public GetGeoCodeDateTimeFormatCommand(UserVisitPK userVisitPK, GetGeoCodeDateTimeFormatForm form) {
