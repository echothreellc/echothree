...
public class GetGeoCodeAliasTypeCommand
    ...
    protected BaseResult execute() {
        ...
        GetGeoCodeAliasTypeResult result = GeoResultFactory.getGetGeoCodeAliasTypeResult();
        ...
        if(geoCodeType != null) {
            ...
            if(geoAliasType != null) {
                ...
                sendEventUsingNames(geoAliasType.getPrimaryKey(), EventTypes.READ, null, null, getPartyPK());
            } else {
