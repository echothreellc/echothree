...
public class CreateGeoCodeAliasTypeDescriptionCommand
        extends BaseSimpleCommand<CreateGeoCodeAliasTypeDescriptionForm> {
    ...
    /** Creates a new instance of CreateGeoCodeAliasTypeDescriptionCommand */
    public CreateGeoCodeAliasTypeDescriptionCommand(UserVisitPK userVisitPK, CreateGeoCodeAliasTypeDescriptionForm form) {
            ...
            if(geoAliasType != null) {
                ...
                if(language != null) {
                    ...
                    if(geoAliasTypeDescription == null) {
                        ...
                        addExecutionError(ExecutionErrors.DuplicateGeoCodeAliasTypeDescription.name(), geoCodeTypeName, geoAliasTypeName, languageIsoName);
                    }
                } else {
