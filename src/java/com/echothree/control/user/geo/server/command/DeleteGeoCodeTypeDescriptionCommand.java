...
public class DeleteGeoCodeTypeDescriptionCommand
        extends BaseSimpleCommand<DeleteGeoCodeTypeDescriptionForm> {
    ...
    /** Creates a new instance of DeleteGeoCodeTypeDescriptionCommand */
    public DeleteGeoCodeTypeDescriptionCommand(UserVisitPK userVisitPK, DeleteGeoCodeTypeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(geoCodeType != null) {
            ...
            if(language != null) {
                GeoCodeTypeDescription geoCodeTypeDescription = geoControl.getGeoCodeTypeDescriptionForUpdate(geoCodeType, language);
                
                if(geoCodeTypeDescription != null) {
                    geoControl.deleteGeoCodeTypeDescription(geoCodeTypeDescription, getPartyPK());
                } else {
                    addExecutionError(ExecutionErrors.UnknownGeoCodeTypeDescription.name());
                }
            } else {
