...
import com.echothree.control.user.geo.common.form.DeleteGeoCodeDateTimeFormatForm;
...
@Dependent
public class DeleteGeoCodeDateTimeFormatCommand
        extends BaseSimpleCommand<DeleteGeoCodeDateTimeFormatForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.GeoCodeDateTimeFormat.name(), SecurityRoles.Delete.name())
                        )))
                )));
