...
import com.echothree.control.user.geo.common.form.SetDefaultGeoCodeTimeZoneForm;
...
public class SetDefaultGeoCodeTimeZoneCommand
        extends BaseSimpleCommand<SetDefaultGeoCodeTimeZoneForm> {
    ...
    /** Creates a new instance of SetDefaultGeoCodeTimeZoneCommand */
    public SetDefaultGeoCodeTimeZoneCommand(UserVisitPK userVisitPK, SetDefaultGeoCodeTimeZoneForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(geoCode != null) {
            ...
            if(timeZone != null) {
                GeoCodeTimeZoneValue geoCodeTimeZoneValue = geoControl.getGeoCodeTimeZoneValueForUpdate(geoCode, timeZone);
