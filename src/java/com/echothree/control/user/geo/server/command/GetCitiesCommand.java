...
import com.echothree.control.user.geo.remote.form.GetCitiesForm;
import com.echothree.control.user.geo.remote.result.GeoResultFactory;
import com.echothree.control.user.geo.remote.result.GetCitiesResult;
...
public class GetCitiesCommand
        extends BaseSimpleCommand<GetCitiesForm> {
    ...
    protected BaseResult execute() {
        ...
        if(countryGeoCode != null) {
            ...
            if(stateGeoCode != null) {
                ...
                result.setCities(geoControl.getCityTransfersByState(getUserVisit(), stateGeoCode));
            } else {
