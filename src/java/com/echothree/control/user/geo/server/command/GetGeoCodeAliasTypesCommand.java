...
import com.echothree.control.user.geo.remote.form.GetGeoCodeAliasTypesForm;
import com.echothree.control.user.geo.remote.result.GeoResultFactory;
import com.echothree.control.user.geo.remote.result.GetGeoCodeAliasTypesResult;
...
public class GetGeoCodeAliasTypesCommand
    ...
    public GetGeoCodeAliasTypesCommand(UserVisitPK userVisitPK, GetGeoCodeAliasTypesForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetGeoCodeAliasTypesResult result = GeoResultFactory.getGetGeoCodeAliasTypesResult();
