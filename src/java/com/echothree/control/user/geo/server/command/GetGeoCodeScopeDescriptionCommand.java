...
import com.echothree.control.user.geo.remote.form.GetGeoCodeScopeDescriptionForm;
import com.echothree.control.user.geo.remote.result.GeoResultFactory;
import com.echothree.control.user.geo.remote.result.GetGeoCodeScopeDescriptionResult;
...
public class GetGeoCodeScopeDescriptionCommand
        extends BaseSimpleCommand<GetGeoCodeScopeDescriptionForm> {
    ...
    public GetGeoCodeScopeDescriptionCommand(UserVisitPK userVisitPK, GetGeoCodeScopeDescriptionForm form) {
