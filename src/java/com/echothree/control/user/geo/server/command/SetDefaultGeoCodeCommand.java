...
public class SetDefaultGeoCodeCommand
        extends BaseSimpleCommand<SetDefaultGeoCodeForm> {
    ...
    public SetDefaultGeoCodeCommand(UserVisitPK userVisitPK, SetDefaultGeoCodeForm form) {
    ...
    protected BaseResult execute() {
        ...
        GeoCodeDetailValue geoCodeDetailValue = geoControl.getGeoCodeDetailValueByNameForUpdate(geoCodeName);
