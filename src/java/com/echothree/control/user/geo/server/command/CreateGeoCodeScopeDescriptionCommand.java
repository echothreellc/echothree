...
import com.echothree.control.user.geo.remote.form.CreateGeoCodeScopeDescriptionForm;
...
public class CreateGeoCodeScopeDescriptionCommand
        extends BaseSimpleCommand<CreateGeoCodeScopeDescriptionForm> {
    ...
    /** Creates a new instance of CreateGeoCodeScopeDescriptionCommand */
    public CreateGeoCodeScopeDescriptionCommand(UserVisitPK userVisitPK, CreateGeoCodeScopeDescriptionForm form) {
        ...
        if(geoCodeScope != null) {
            ...
            if(language != null) {
                ...
                if(geoCodeScopeDescription == null) {
                    ...
                    geoControl.createGeoCodeScopeDescription(geoCodeScope, language, description, getPartyPK());
                } else {
                    addExecutionError(ExecutionErrors.DuplicateGeoCodeScopeDescription.name());
                }
            } else {
