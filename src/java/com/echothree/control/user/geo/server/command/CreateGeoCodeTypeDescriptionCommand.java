...
public class CreateGeoCodeTypeDescriptionCommand
        extends BaseSimpleCommand<CreateGeoCodeTypeDescriptionForm> {
    ...
    /** Creates a new instance of CreateGeoCodeTypeDescriptionCommand */
    public CreateGeoCodeTypeDescriptionCommand(UserVisitPK userVisitPK, CreateGeoCodeTypeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(geoCodeType != null) {
            ...
            if(language != null) {
                GeoCodeTypeDescription geoCodeTypeDescription = geoControl.getGeoCodeTypeDescription(geoCodeType, language);
                
                if(geoCodeTypeDescription == null) {
                    var description = form.getDescription();
                    
                    geoControl.createGeoCodeTypeDescription(geoCodeType, language, description, getPartyPK());
                } else {
                    addExecutionError(ExecutionErrors.DuplicateGeoCodeTypeDescription.name());
                }
            } else {
