...
import com.echothree.control.user.geo.remote.form.GetGeoCodeScopeForm;
import com.echothree.control.user.geo.remote.result.GeoResultFactory;
import com.echothree.control.user.geo.remote.result.GetGeoCodeScopeResult;
...
public class GetGeoCodeScopeCommand
        extends BaseSimpleCommand<GetGeoCodeScopeForm> {
    ...
    public GetGeoCodeScopeCommand(UserVisitPK userVisitPK, GetGeoCodeScopeForm form) {
