...
public interface EditPicklistTimeTypeDescriptionResult
        extends BaseEditResult<PicklistTimeTypeDescriptionEdit> {

    PicklistTimeTypeDescriptionTransfer getPicklistTimeTypeDescription();
    void setPicklistTimeTypeDescription(PicklistTimeTypeDescriptionTransfer picklistTimeType);
