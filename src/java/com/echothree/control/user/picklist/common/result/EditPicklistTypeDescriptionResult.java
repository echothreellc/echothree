...
public interface EditPicklistTypeDescriptionResult
        extends BaseEditResult<PicklistTypeDescriptionEdit> {

    PicklistTypeDescriptionTransfer getPicklistTypeDescription();
    void setPicklistTypeDescription(PicklistTypeDescriptionTransfer picklistType);
