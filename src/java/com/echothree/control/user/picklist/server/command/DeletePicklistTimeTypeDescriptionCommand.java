...
import com.echothree.control.user.picklist.remote.form.DeletePicklistTimeTypeDescriptionForm;
...
public class DeletePicklistTimeTypeDescriptionCommand
    ...
    public DeletePicklistTimeTypeDescriptionCommand(UserVisitPK userVisitPK, DeletePicklistTimeTypeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(picklistType != null) {
            ...
            if(picklistTimeType != null) {
                ...
                if(language != null) {
                    PicklistTimeTypeDescription picklistTimeTypeDescription = picklistControl.getPicklistTimeTypeDescriptionForUpdate(picklistTimeType, language);
