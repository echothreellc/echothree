...
import com.echothree.control.user.picklist.common.form.GetPicklistAliasTypeDescriptionsForm;
import com.echothree.control.user.picklist.common.result.GetPicklistAliasTypeDescriptionsResult;
...
public class GetPicklistAliasTypeDescriptionsCommand
        extends BaseSimpleCommand<GetPicklistAliasTypeDescriptionsForm> {
    ...
    public GetPicklistAliasTypeDescriptionsCommand(UserVisitPK userVisitPK, GetPicklistAliasTypeDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetPicklistAliasTypeDescriptionsResult result = PicklistResultFactory.getGetPicklistAliasTypeDescriptionsResult();
        ...
        if(picklistType != null) {
            ...
            if(picklistAliasType != null) {
                ...
                result.setPicklistAliasTypeDescriptions(picklistControl.getPicklistAliasTypeDescriptionTransfersByPicklistAliasType(getUserVisit(), picklistAliasType));
            } else {
