...
import com.echothree.control.user.picklist.remote.form.GetPicklistTypesForm;
import com.echothree.control.user.picklist.remote.result.GetPicklistTypesResult;
...
public class GetPicklistTypesCommand
    ...
    public GetPicklistTypesCommand(UserVisitPK userVisitPK, GetPicklistTypesForm form) {
