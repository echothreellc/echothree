...
@Dependent
public class CreatePicklistTimeTypeCommand
        extends BaseSimpleCommand<CreatePicklistTimeTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                    new SecurityRoleDefinition(SecurityRoleGroups.PicklistTimeType.name(), SecurityRoles.Create.name())
                    )))
                )));
    ...
    protected BaseResult execute() {
        ...
        if(picklistType != null) {
            ...
            if(picklistTimeType == null) {
                ...
                picklistTimeType = picklistControl.createPicklistTimeType(picklistType, picklistTimeTypeName, isDefault, sortOrder, partyPK);
