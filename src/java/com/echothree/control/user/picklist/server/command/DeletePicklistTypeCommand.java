...
import com.echothree.control.user.picklist.common.form.DeletePicklistTypeForm;
...
@RequestScoped
public class DeletePicklistTypeCommand
        extends BaseSimpleCommand<DeletePicklistTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.PicklistType.name(), SecurityRoles.Delete.name())
                        )))
                )));
