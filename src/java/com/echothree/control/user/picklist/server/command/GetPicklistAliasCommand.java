...
import com.echothree.control.user.picklist.remote.form.GetPicklistAliasForm;
import com.echothree.control.user.picklist.remote.result.GetPicklistAliasResult;
...
public class GetPicklistAliasCommand
        extends BaseSimpleCommand<GetPicklistAliasForm> {
    ...
    public GetPicklistAliasCommand(UserVisitPK userVisitPK, GetPicklistAliasForm form) {
            ...
            if(picklist != null) {
                ...
                if(picklistAliasType != null) {
                    ...
                    if(picklistAlias != null) {
                        ...
                        addExecutionError(ExecutionErrors.UnknownPicklistAlias.name(), picklistName, picklistAliasTypeName);
                    }
                } else {
