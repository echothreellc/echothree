...
import com.echothree.control.user.picklist.common.form.DeletePicklistTimeTypeForm;
...
public class DeletePicklistTimeTypeCommand
        extends BaseSimpleCommand<DeletePicklistTimeTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.PicklistTimeType.name(), SecurityRoles.Delete.name())
                        )))
                )));
    ...
    /** Creates a new instance of DeletePicklistTimeTypeCommand */
    public DeletePicklistTimeTypeCommand(UserVisitPK userVisitPK, DeletePicklistTimeTypeForm form) {
