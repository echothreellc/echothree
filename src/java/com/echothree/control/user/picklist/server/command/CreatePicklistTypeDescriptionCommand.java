...
@Dependent
public class CreatePicklistTypeDescriptionCommand
        extends BaseSimpleCommand<CreatePicklistTypeDescriptionForm> {
        ...
        if(picklistType != null) {
            ...
            if(language != null) {
                ...
                if(picklistTypeDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicatePicklistTypeDescription.name(), picklistTypeName, languageIsoName);
                }
            } else {
