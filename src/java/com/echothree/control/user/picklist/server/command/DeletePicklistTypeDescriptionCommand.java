...
import com.echothree.control.user.picklist.remote.form.DeletePicklistTypeDescriptionForm;
...
public class DeletePicklistTypeDescriptionCommand
        extends BaseSimpleCommand<DeletePicklistTypeDescriptionForm> {
    ...
    public DeletePicklistTypeDescriptionCommand(UserVisitPK userVisitPK, DeletePicklistTypeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(picklistType != null) {
            ...
            if(language != null) {
                PicklistTypeDescription picklistTypeDescription = picklistControl.getPicklistTypeDescriptionForUpdate(picklistType, language);
                
                if(picklistTypeDescription != null) {
                    picklistControl.deletePicklistTypeDescription(picklistTypeDescription, getPartyPK());
                } else {
