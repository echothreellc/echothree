...
import com.echothree.control.user.picklist.remote.form.DeletePicklistAliasForm;
...
public class DeletePicklistAliasCommand
    ...
    public DeletePicklistAliasCommand(UserVisitPK userVisitPK, DeletePicklistAliasForm form) {
