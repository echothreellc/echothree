...
import com.echothree.control.user.picklist.remote.form.GetPicklistTypeChoicesForm;
import com.echothree.control.user.picklist.remote.result.GetPicklistTypeChoicesResult;
...
public class GetPicklistTypeChoicesCommand
        extends BaseSimpleCommand<GetPicklistTypeChoicesForm> {
    ...
    static {
        ...
        FORM_FIELD_DEFINITIONS = Collections.unmodifiableList(Arrays.asList(
                new FieldDefinition("DefaultPicklistTypeChoice", FieldType.ENTITY_NAME, false, null, null),
                new FieldDefinition("AllowNullChoice", FieldType.BOOLEAN, true, null, null)
                ));
    }
    
    /** Creates a new instance of GetPicklistTypeChoicesCommand */
    public GetPicklistTypeChoicesCommand(UserVisitPK userVisitPK, GetPicklistTypeChoicesForm form) {
