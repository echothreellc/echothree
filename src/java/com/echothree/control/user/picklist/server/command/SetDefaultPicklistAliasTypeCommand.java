...
import com.echothree.control.user.picklist.remote.form.SetDefaultPicklistAliasTypeForm;
...
public class SetDefaultPicklistAliasTypeCommand
    ...
    public SetDefaultPicklistAliasTypeCommand(UserVisitPK userVisitPK, SetDefaultPicklistAliasTypeForm form) {
