...
import com.echothree.control.user.picklist.remote.form.GetPicklistAliasTypesForm;
import com.echothree.control.user.picklist.remote.result.GetPicklistAliasTypesResult;
...
public class GetPicklistAliasTypesCommand
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.PicklistAliasType.name(), SecurityRoles.List.name())
                        )))
                )));
    ...
    protected BaseResult execute() {
        ...
        GetPicklistAliasTypesResult result = PicklistResultFactory.getGetPicklistAliasTypesResult();
