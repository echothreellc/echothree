...
public class CreatePicklistAliasTypeCommand
    ...
    public CreatePicklistAliasTypeCommand(UserVisitPK userVisitPK, CreatePicklistAliasTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(picklistType != null) {
            ...
            if(picklistAliasType == null) {
                ...
                if(description != null) {
                    picklistControl.createPicklistAliasTypeDescription(picklistAliasType, getPreferredLanguage(), description, createdBy);
                }
            } else {
                addExecutionError(ExecutionErrors.DuplicatePicklistAliasTypeName.name(), picklistTypeName, picklistAliasTypeName);
            }
        } else {
