...
import com.echothree.control.user.picklist.common.form.GetPicklistTimeTypeChoicesForm;
import com.echothree.control.user.picklist.common.result.GetPicklistTimeTypeChoicesResult;
...
public class GetPicklistTimeTypeChoicesCommand
        extends BaseSimpleCommand<GetPicklistTimeTypeChoicesForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.PicklistTimeType.name(), SecurityRoles.Choices.name())
                        )))
                )));
        
        FORM_FIELD_DEFINITIONS = Collections.unmodifiableList(Arrays.asList(
                new FieldDefinition("PicklistTypeName", FieldType.ENTITY_NAME, true, null, null),
                new FieldDefinition("DefaultPicklistTimeTypeChoice", FieldType.ENTITY_NAME, false, null, null),
                new FieldDefinition("AllowNullChoice", FieldType.BOOLEAN, true, null, null)
                ));
    }
    
    /** Creates a new instance of GetPicklistTimeTypeChoicesCommand */
    public GetPicklistTimeTypeChoicesCommand(UserVisitPK userVisitPK, GetPicklistTimeTypeChoicesForm form) {
