...
import com.echothree.control.user.picklist.common.form.GetPicklistTypeForm;
import com.echothree.control.user.picklist.common.result.GetPicklistTypeResult;
...
public class GetPicklistTypeCommand
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.PicklistType.name(), SecurityRoles.Review.name())
                        )))
                )));
    ...
    protected BaseResult execute() {
        ...
        if(picklistType != null) {
            ...
            sendEventUsingNames(picklistType.getPrimaryKey(), EventTypes.READ, null, null, getPartyPK());
        } else {
