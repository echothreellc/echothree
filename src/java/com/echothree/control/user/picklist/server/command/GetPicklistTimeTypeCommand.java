...
import com.echothree.control.user.picklist.common.result.GetPicklistTimeTypeResult;
...
public class GetPicklistTimeTypeCommand
    ...
    public GetPicklistTimeTypeCommand(UserVisitPK userVisitPK, GetPicklistTimeTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetPicklistTimeTypeResult result = PicklistResultFactory.getGetPicklistTimeTypeResult();
        ...
        if(picklistType != null) {
            ...
            if(picklistTimeType != null) {
                ...
                sendEventUsingNames(picklistTimeType.getPrimaryKey(), EventTypes.READ, null, null, getPartyPK());
            } else {
