...
import com.echothree.control.user.picklist.remote.form.GetPicklistAliasTypeDescriptionForm;
import com.echothree.control.user.picklist.remote.result.GetPicklistAliasTypeDescriptionResult;
...
public class GetPicklistAliasTypeDescriptionCommand
        extends BaseSimpleCommand<GetPicklistAliasTypeDescriptionForm> {
    ...
    /** Creates a new instance of GetPicklistAliasTypeDescriptionCommand */
    public GetPicklistAliasTypeDescriptionCommand(UserVisitPK userVisitPK, GetPicklistAliasTypeDescriptionForm form) {
