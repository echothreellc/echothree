...
import com.echothree.control.user.picklist.common.form.DeletePicklistAliasTypeForm;
...
public class DeletePicklistAliasTypeCommand
        extends BaseSimpleCommand<DeletePicklistAliasTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.PicklistAliasType.name(), SecurityRoles.Delete.name())
                        )))
                )));
    ...
    /** Creates a new instance of DeletePicklistAliasTypeCommand */
    public DeletePicklistAliasTypeCommand(UserVisitPK userVisitPK, DeletePicklistAliasTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(picklistType != null) {
            ...
            PicklistAliasType picklistAliasType = picklistControl.getPicklistAliasTypeByNameForUpdate(picklistType, picklistAliasTypeName);

            if(picklistAliasType != null) {
                picklistControl.deletePicklistAliasType(picklistAliasType, getPartyPK());
            } else {
