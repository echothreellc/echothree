...
public interface GetPurchaseOrderStatusChoicesForm
        extends PurchaseOrderSpec {
    
    String getDefaultPurchaseOrderStatusChoice();
    void setDefaultPurchaseOrderStatusChoice(String defaultPurchaseOrderStatusChoice);
