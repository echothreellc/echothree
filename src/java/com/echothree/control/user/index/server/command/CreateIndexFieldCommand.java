...
import com.echothree.control.user.index.remote.form.CreateIndexFieldForm;
...
public class CreateIndexFieldCommand
        extends BaseSimpleCommand<CreateIndexFieldForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                    new SecurityRoleDefinition(SecurityRoleGroups.IndexField.name(), SecurityRoles.Create.name())
                    )))
                )));
    ...
    protected BaseResult execute() {
        ...
        if(indexType != null) {
            ...
            if(indexField == null) {
                ...
                indexField = indexControl.createIndexField(indexType, indexFieldName, isDefault, sortOrder, partyPK);

                if(description != null) {
                    indexControl.createIndexFieldDescription(indexField, getPreferredLanguage(), description, partyPK);
                }
            } else {
                addExecutionError(ExecutionErrors.DuplicateIndexFieldName.name(), indexTypeName, indexFieldName);
            }
        } else {
