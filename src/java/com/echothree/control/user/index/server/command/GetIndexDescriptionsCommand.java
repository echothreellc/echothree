...
import com.echothree.control.user.index.remote.form.GetIndexDescriptionsForm;
import com.echothree.control.user.index.remote.result.GetIndexDescriptionsResult;
...
public class GetIndexDescriptionsCommand
        extends BaseSimpleCommand<GetIndexDescriptionsForm> {
    ...
    public GetIndexDescriptionsCommand(UserVisitPK userVisitPK, GetIndexDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(index != null) {
            ...
            result.setIndexDescriptions(indexControl.getIndexDescriptionTransfersByIndex(getUserVisit(), index));
        } else {
