...
import com.echothree.control.user.index.remote.form.GetIndexForm;
import com.echothree.control.user.index.remote.result.GetIndexResult;
...
public class GetIndexCommand
    ...
    public GetIndexCommand(UserVisitPK userVisitPK, GetIndexForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(parameterCount == 1) {
            ...
            if(!hasExecutionErrors()) {
                ...
                sendEventUsingNames(index.getPrimaryKey(), EventTypes.READ.name(), null, null, getPartyPK());
            }
        } else {
