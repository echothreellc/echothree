...
import com.echothree.control.user.index.remote.form.GetIndexFieldChoicesForm;
import com.echothree.control.user.index.remote.result.GetIndexFieldChoicesResult;
...
public class GetIndexFieldChoicesCommand
    ...
    public GetIndexFieldChoicesCommand(UserVisitPK userVisitPK, GetIndexFieldChoicesForm form) {
