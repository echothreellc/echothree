...
import com.echothree.control.user.index.remote.form.GetIndexDescriptionForm;
import com.echothree.control.user.index.remote.result.GetIndexDescriptionResult;
...
public class GetIndexDescriptionCommand
        extends BaseSimpleCommand<GetIndexDescriptionForm> {
    ...
    public GetIndexDescriptionCommand(UserVisitPK userVisitPK, GetIndexDescriptionForm form) {
