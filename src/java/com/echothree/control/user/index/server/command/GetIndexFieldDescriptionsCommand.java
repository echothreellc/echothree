...
import com.echothree.control.user.index.remote.form.GetIndexFieldDescriptionsForm;
import com.echothree.control.user.index.remote.result.GetIndexFieldDescriptionsResult;
...
public class GetIndexFieldDescriptionsCommand
        extends BaseSimpleCommand<GetIndexFieldDescriptionsForm> {
    ...
    /** Creates a new instance of GetIndexFieldDescriptionsCommand */
    public GetIndexFieldDescriptionsCommand(UserVisitPK userVisitPK, GetIndexFieldDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(indexType != null) {
            ...
            if(indexField != null) {
                ...
                result.setIndexFieldDescriptions(indexControl.getIndexFieldDescriptionTransfersByIndexField(getUserVisit(), indexField));
            } else {
