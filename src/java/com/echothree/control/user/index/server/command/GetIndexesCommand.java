...
import com.echothree.control.user.index.remote.form.GetIndexesForm;
import com.echothree.control.user.index.remote.result.GetIndexesResult;
...
public class GetIndexesCommand
        extends BaseSimpleCommand<GetIndexesForm> {
    ...
    public GetIndexesCommand(UserVisitPK userVisitPK, GetIndexesForm form) {
