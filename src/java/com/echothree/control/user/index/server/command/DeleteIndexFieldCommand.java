...
import com.echothree.control.user.index.common.form.DeleteIndexFieldForm;
...
@Dependent
public class DeleteIndexFieldCommand
        extends BaseSimpleCommand<DeleteIndexFieldForm> {
