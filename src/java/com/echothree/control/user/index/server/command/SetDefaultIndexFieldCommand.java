...
import com.echothree.control.user.index.common.form.SetDefaultIndexFieldForm;
...
public class SetDefaultIndexFieldCommand
        extends BaseSimpleCommand<SetDefaultIndexFieldForm> {
    ...
    public SetDefaultIndexFieldCommand(UserVisitPK userVisitPK, SetDefaultIndexFieldForm form) {
