...
import com.echothree.control.user.index.remote.form.CreateIndexTypeDescriptionForm;
...
public class CreateIndexTypeDescriptionCommand
        extends BaseSimpleCommand<CreateIndexTypeDescriptionForm> {
    ...
    /** Creates a new instance of CreateIndexTypeDescriptionCommand */
    public CreateIndexTypeDescriptionCommand(UserVisitPK userVisitPK, CreateIndexTypeDescriptionForm form) {
        ...
        if(indexType != null) {
            ...
            if(language != null) {
                ...
                if(indexTypeDescription == null) {
                    ...
                    indexControl.createIndexTypeDescription(indexType, language, description, getPartyPK());
                } else {
                    addExecutionError(ExecutionErrors.DuplicateIndexTypeDescription.name(), indexTypeName, languageIsoName);
                }
            } else {
