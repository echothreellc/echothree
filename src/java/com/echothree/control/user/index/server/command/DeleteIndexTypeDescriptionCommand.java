...
import com.echothree.control.user.index.common.form.DeleteIndexTypeDescriptionForm;
...
public class DeleteIndexTypeDescriptionCommand
        extends BaseSimpleCommand<DeleteIndexTypeDescriptionForm> {
    ...
    /** Creates a new instance of DeleteIndexTypeDescriptionCommand */
    public DeleteIndexTypeDescriptionCommand(UserVisitPK userVisitPK, DeleteIndexTypeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(indexType != null) {
            ...
            if(language != null) {
                IndexTypeDescription indexTypeDescription = indexControl.getIndexTypeDescriptionForUpdate(indexType, language);
                
                if(indexTypeDescription != null) {
                    indexControl.deleteIndexTypeDescription(indexTypeDescription, getPartyPK());
                } else {
