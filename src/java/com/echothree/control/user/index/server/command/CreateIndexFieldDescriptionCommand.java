...
public class CreateIndexFieldDescriptionCommand
        extends BaseSimpleCommand<CreateIndexFieldDescriptionForm> {
    ...
    /** Creates a new instance of CreateIndexFieldDescriptionCommand */
    public CreateIndexFieldDescriptionCommand(UserVisitPK userVisitPK, CreateIndexFieldDescriptionForm form) {
            ...
            if(indexField != null) {
                ...
                if(language != null) {
                    ...
                    if(indexFieldDescription == null) {
                        ...
                        addExecutionError(ExecutionErrors.DuplicateIndexFieldDescription.name());
                    }
                } else {
                    addExecutionError(ExecutionErrors.UnknownLanguageIsoName.name(), indexTypeName, indexFieldName, languageIsoName);
                }
            } else {
