...
import com.echothree.control.user.index.remote.form.DeleteIndexFieldDescriptionForm;
...
public class DeleteIndexFieldDescriptionCommand
        extends BaseSimpleCommand<DeleteIndexFieldDescriptionForm> {
    ...
    /** Creates a new instance of DeleteIndexFieldDescriptionCommand */
    public DeleteIndexFieldDescriptionCommand(UserVisitPK userVisitPK, DeleteIndexFieldDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(indexType != null) {
            ...
            if(indexField != null) {
                ...
                if(language != null) {
                    IndexFieldDescription indexFieldDescription = indexControl.getIndexFieldDescriptionForUpdate(indexField, language);
                    
                    if(indexFieldDescription != null) {
                        indexControl.deleteIndexFieldDescription(indexFieldDescription, getPartyPK());
                    } else {
