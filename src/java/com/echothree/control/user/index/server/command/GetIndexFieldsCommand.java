...
import com.echothree.control.user.index.remote.form.GetIndexFieldsForm;
import com.echothree.control.user.index.remote.result.GetIndexFieldsResult;
...
public class GetIndexFieldsCommand
    ...
    public GetIndexFieldsCommand(UserVisitPK userVisitPK, GetIndexFieldsForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetIndexFieldsResult result = IndexResultFactory.getGetIndexFieldsResult();
