...
public class CreateIndexDescriptionCommand
        extends BaseSimpleCommand<CreateIndexDescriptionForm> {
    ...
    /** Creates a new instance of CreateIndexDescriptionCommand */
    public CreateIndexDescriptionCommand(UserVisitPK userVisitPK, CreateIndexDescriptionForm form) {
        ...
        if(index != null) {
            ...
            if(language != null) {
                ...
                if(indexDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateIndexDescription.name(), indexName, languageIsoName);
                }
            } else {
