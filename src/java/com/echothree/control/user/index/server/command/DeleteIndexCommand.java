...
import com.echothree.control.user.index.common.form.DeleteIndexForm;
...
public class DeleteIndexCommand
        extends BaseSimpleCommand<DeleteIndexForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.Index.name(), SecurityRoles.Delete.name())
                        )))
                )));
