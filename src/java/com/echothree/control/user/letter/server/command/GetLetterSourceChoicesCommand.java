...
import com.echothree.control.user.letter.remote.form.GetLetterSourceChoicesForm;
import com.echothree.control.user.letter.remote.result.GetLetterSourceChoicesResult;
...
public class GetLetterSourceChoicesCommand
        extends BaseSimpleCommand<GetLetterSourceChoicesForm> {
