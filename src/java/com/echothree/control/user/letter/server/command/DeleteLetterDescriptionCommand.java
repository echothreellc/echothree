...
import com.echothree.control.user.letter.common.form.DeleteLetterDescriptionForm;
...
public class DeleteLetterDescriptionCommand
        extends BaseSimpleCommand<DeleteLetterDescriptionForm> {
        ...
        if(chainKind != null) {
            ...
            if(chainType != null) {
                ...
                if(letter != null) {
                    ...
                    if(language != null) {
                        LetterDescription letterDescription = letterControl.getLetterDescriptionForUpdate(letter, language);
                        
                        if(letterDescription != null) {
                            letterControl.deleteLetterDescription(letterDescription, getPartyPK());
                        } else {
