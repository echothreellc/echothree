...
import com.echothree.control.user.letter.remote.form.GetLetterForm;
import com.echothree.control.user.letter.remote.result.GetLetterResult;
        ...
        if(chainKind != null) {
            ...
            if(chainType != null) {
                ...
                if(letter != null) {
                    ...
                    sendEventUsingNames(letter.getPrimaryKey(), EventTypes.READ.name(), null, null, getPartyPK());
                } else {
