...
import com.echothree.control.user.letter.remote.form.DeleteLetterSourceForm;
...
public class DeleteLetterSourceCommand
        extends BaseSimpleCommand<DeleteLetterSourceForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.LetterSource.name(), SecurityRoles.Delete.name())
                        )))
                )));
