...
import com.echothree.control.user.letter.remote.form.DeleteLetterSourceDescriptionForm;
...
public class DeleteLetterSourceDescriptionCommand
        extends BaseSimpleCommand<DeleteLetterSourceDescriptionForm> {
    ...
    /** Creates a new instance of DeleteLetterSourceDescriptionCommand */
    public DeleteLetterSourceDescriptionCommand(UserVisitPK userVisitPK, DeleteLetterSourceDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(letterSource != null) {
            ...
            if(language != null) {
                LetterSourceDescription letterSourceDescription = letterControl.getLetterSourceDescriptionForUpdate(letterSource, language);
                
                if(letterSourceDescription != null) {
                    letterControl.deleteLetterSourceDescription(letterSourceDescription, getPartyPK());
                } else {
