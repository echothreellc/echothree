...
import com.echothree.control.user.letter.common.form.GetLetterChoicesForm;
import com.echothree.control.user.letter.common.result.GetLetterChoicesResult;
...
public class GetLetterChoicesCommand
        extends BaseSimpleCommand<GetLetterChoicesForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.Letter.name(), SecurityRoles.Choices.name())
                        )))
                )));
        ...
        FORM_FIELD_DEFINITIONS = Collections.unmodifiableList(Arrays.asList(
                ...
                new FieldDefinition("DefaultLetterChoice", FieldType.ENTITY_NAME, false, null, null),
                new FieldDefinition("AllowNullChoice", FieldType.BOOLEAN, true, null, null)
                ));
    }
    
    /** Creates a new instance of GetLetterChoicesCommand */
    public GetLetterChoicesCommand(UserVisitPK userVisitPK, GetLetterChoicesForm form) {
