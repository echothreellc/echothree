...
import com.echothree.control.user.letter.remote.form.GetLetterDescriptionsForm;
import com.echothree.control.user.letter.remote.result.GetLetterDescriptionsResult;
...
public class GetLetterDescriptionsCommand
        extends BaseSimpleCommand<GetLetterDescriptionsForm> {
    ...
    /** Creates a new instance of GetLetterDescriptionsCommand */
    public GetLetterDescriptionsCommand(UserVisitPK userVisitPK, GetLetterDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetLetterDescriptionsResult result = LetterResultFactory.getGetLetterDescriptionsResult();
        ...
        if(chainKind != null) {
            ...
            if(chainType != null) {
                ...
                if(letter != null) {
                    ...
                    result.setLetterDescriptions(letterControl.getLetterDescriptionTransfersByLetter(getUserVisit(), letter));
                } else {
