...
import com.echothree.control.user.letter.remote.form.GetLettersForm;
import com.echothree.control.user.letter.remote.result.GetLettersResult;
...
public class GetLettersCommand
        extends BaseSimpleCommand<GetLettersForm> {
    ...
    protected BaseResult execute() {
        ...
        GetLettersResult result = LetterResultFactory.getGetLettersResult();
        ...
        if(chainKind != null) {
            ...
            if(chainType != null) {
                ...
                result.setLetters(letterControl.getLetterTransfersByChainType(userVisit, chainType));
            } else {
