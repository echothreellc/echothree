...
public interface EditOrderTimeTypeDescriptionResult
        extends BaseEditResult<OrderTimeTypeDescriptionEdit> {

    OrderTimeTypeDescriptionTransfer getOrderTimeTypeDescription();
    void setOrderTimeTypeDescription(OrderTimeTypeDescriptionTransfer orderTimeType);
