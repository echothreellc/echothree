...
public interface EditOrderTypeDescriptionResult
        extends BaseEditResult<OrderTypeDescriptionEdit> {

    OrderTypeDescriptionTransfer getOrderTypeDescription();
    void setOrderTypeDescription(OrderTypeDescriptionTransfer orderType);
