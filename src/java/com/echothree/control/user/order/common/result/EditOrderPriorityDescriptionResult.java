...
public interface EditOrderPriorityDescriptionResult
        extends BaseEditResult<OrderPriorityDescriptionEdit> {

    OrderPriorityDescriptionTransfer getOrderPriorityDescription();
    void setOrderPriorityDescription(OrderPriorityDescriptionTransfer orderPriority);
