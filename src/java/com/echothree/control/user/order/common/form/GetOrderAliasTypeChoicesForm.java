...
public interface GetOrderAliasTypeChoicesForm
        extends OrderTypeSpec {
    
    String getDefaultOrderAliasTypeChoice();
    void setDefaultOrderAliasTypeChoice(String defaultOrderAliasTypeChoice);
