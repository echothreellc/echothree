...
public interface GetOrderTypeDescriptionsResult
        extends BaseResult {
    
    OrderTypeTransfer getOrderType();
    void setOrderType(OrderTypeTransfer orderType);
    
    List<OrderTypeDescriptionTransfer> getOrderTypeDescriptions();
    void setOrderTypeDescriptions(List<OrderTypeDescriptionTransfer> orderTypeDescriptions);
