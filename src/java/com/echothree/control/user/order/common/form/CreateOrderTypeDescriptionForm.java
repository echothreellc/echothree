...
public interface CreateOrderTypeDescriptionForm
        extends OrderTypeDescriptionSpec, OrderTypeDescriptionEdit {
    
    // Nothing additional beyond OrderTypeDescriptionSpec, OrderTypeDescriptionEdit
