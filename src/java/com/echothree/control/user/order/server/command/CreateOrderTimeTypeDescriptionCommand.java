...
public class CreateOrderTimeTypeDescriptionCommand
        extends BaseSimpleCommand<CreateOrderTimeTypeDescriptionForm> {
    ...
    /** Creates a new instance of CreateOrderTimeTypeDescriptionCommand */
    public CreateOrderTimeTypeDescriptionCommand(UserVisitPK userVisitPK, CreateOrderTimeTypeDescriptionForm form) {
            ...
            if(orderTimeType != null) {
                ...
                if(language != null) {
                    ...
                    if(orderTimeTypeDescription == null) {
                        ...
                        orderControl.createOrderTimeTypeDescription(orderTimeType, language, description, getPartyPK());
                    } else {
                        addExecutionError(ExecutionErrors.DuplicateOrderTimeTypeDescription.name(), orderTypeName, orderTimeTypeName, languageIsoName);
                    }
                } else {
