...
import com.echothree.control.user.order.remote.form.GetOrderTimeTypeDescriptionsForm;
import com.echothree.control.user.order.remote.result.GetOrderTimeTypeDescriptionsResult;
...
public class GetOrderTimeTypeDescriptionsCommand
        extends BaseSimpleCommand<GetOrderTimeTypeDescriptionsForm> {
    ...
    public GetOrderTimeTypeDescriptionsCommand(UserVisitPK userVisitPK, GetOrderTimeTypeDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetOrderTimeTypeDescriptionsResult result = OrderResultFactory.getGetOrderTimeTypeDescriptionsResult();
        ...
        if(orderType != null) {
            ...
            if(orderTimeType != null) {
                ...
                result.setOrderTimeTypeDescriptions(orderControl.getOrderTimeTypeDescriptionTransfersByOrderTimeType(getUserVisit(), orderTimeType));
            } else {
