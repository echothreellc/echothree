...
public class GetOrderAdjustmentTypeDescriptionCommand
    ...
    protected BaseResult execute() {
        ...
        var result = OrderResultFactory.getGetOrderAdjustmentTypeDescriptionResult();
        ...
        if(orderType != null) {
            ...
            if(orderAdjustmentType != null) {
                ...
                if(language != null) {
                    var orderAdjustmentTypeDescription = orderAdjustmentControl.getOrderAdjustmentTypeDescription(orderAdjustmentType, language);
