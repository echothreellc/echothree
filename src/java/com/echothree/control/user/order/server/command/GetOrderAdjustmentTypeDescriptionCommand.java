...
public class GetOrderAdjustmentTypeDescriptionCommand
        extends BaseSimpleCommand<GetOrderAdjustmentTypeDescriptionForm> {
    ...
    /** Creates a new instance of GetOrderAdjustmentTypeDescriptionCommand */
    public GetOrderAdjustmentTypeDescriptionCommand(UserVisitPK userVisitPK, GetOrderAdjustmentTypeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetOrderAdjustmentTypeDescriptionResult result = OrderResultFactory.getGetOrderAdjustmentTypeDescriptionResult();
        ...
        if(orderType != null) {
            ...
            if(orderAdjustmentType != null) {
                ...
                if(language != null) {
                    OrderAdjustmentTypeDescription orderAdjustmentTypeDescription = orderControl.getOrderAdjustmentTypeDescription(orderAdjustmentType, language);
