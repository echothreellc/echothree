...
public class CreateOrderAdjustmentTypeCommand
        extends BaseSimpleCommand<CreateOrderAdjustmentTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                    new SecurityRoleDefinition(SecurityRoleGroups.OrderAdjustmentType.name(), SecurityRoles.Create.name())
                    )))
                )));
    ...
    /** Creates a new instance of CreateOrderAdjustmentTypeCommand */
    public CreateOrderAdjustmentTypeCommand(UserVisitPK userVisitPK, CreateOrderAdjustmentTypeForm form) {
