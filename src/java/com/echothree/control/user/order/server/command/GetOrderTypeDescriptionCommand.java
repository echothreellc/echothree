...
import com.echothree.control.user.order.remote.form.GetOrderTypeDescriptionForm;
import com.echothree.control.user.order.remote.result.GetOrderTypeDescriptionResult;
...
public class GetOrderTypeDescriptionCommand
        extends BaseSimpleCommand<GetOrderTypeDescriptionForm> {
    ...
    /** Creates a new instance of GetOrderTypeDescriptionCommand */
    public GetOrderTypeDescriptionCommand(UserVisitPK userVisitPK, GetOrderTypeDescriptionForm form) {
