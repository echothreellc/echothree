...
import com.echothree.control.user.order.remote.form.GetOrderPriorityDescriptionsForm;
import com.echothree.control.user.order.remote.result.GetOrderPriorityDescriptionsResult;
    ...
    protected BaseResult execute() {
        ...
        if(orderType != null) {
            ...
            if(orderPriority != null) {
                ...
                result.setOrderPriorityDescriptions(orderControl.getOrderPriorityDescriptionTransfersByOrderPriority(getUserVisit(), orderPriority));
            } else {
