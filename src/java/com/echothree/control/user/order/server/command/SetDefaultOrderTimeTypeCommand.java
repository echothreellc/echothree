...
import com.echothree.control.user.order.remote.form.SetDefaultOrderTimeTypeForm;
...
public class SetDefaultOrderTimeTypeCommand
        extends BaseSimpleCommand<SetDefaultOrderTimeTypeForm> {
    ...
    /** Creates a new instance of SetDefaultOrderTimeTypeCommand */
    public SetDefaultOrderTimeTypeCommand(UserVisitPK userVisitPK, SetDefaultOrderTimeTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(orderType != null) {
            ...
            OrderTimeTypeDetailValue orderTimeTypeDetailValue = orderControl.getOrderTimeTypeDetailValueByNameForUpdate(orderType, orderTimeTypeName);

            if(orderTimeTypeDetailValue != null) {
                orderTimeTypeDetailValue.setIsDefault(Boolean.TRUE);
                orderControl.updateOrderTimeTypeFromValue(orderTimeTypeDetailValue, getPartyPK());
            } else {
