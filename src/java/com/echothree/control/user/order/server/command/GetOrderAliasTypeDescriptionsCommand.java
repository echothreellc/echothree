...
import com.echothree.control.user.order.common.form.GetOrderAliasTypeDescriptionsForm;
import com.echothree.control.user.order.common.result.GetOrderAliasTypeDescriptionsResult;
...
public class GetOrderAliasTypeDescriptionsCommand
        extends BaseSimpleCommand<GetOrderAliasTypeDescriptionsForm> {
    ...
    /** Creates a new instance of GetOrderAliasTypeDescriptionsCommand */
    public GetOrderAliasTypeDescriptionsCommand(UserVisitPK userVisitPK, GetOrderAliasTypeDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        var result = OrderResultFactory.getGetOrderAliasTypeDescriptionsResult();
        ...
        if(orderType != null) {
            ...
            if(orderAliasType != null) {
                ...
                result.setOrderAliasTypeDescriptions(orderAliasControl.getOrderAliasTypeDescriptionTransfersByOrderAliasType(getUserVisit(), orderAliasType));
            } else {
