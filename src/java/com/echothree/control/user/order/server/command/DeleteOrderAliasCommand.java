...
import com.echothree.control.user.order.remote.form.DeleteOrderAliasForm;
...
public class DeleteOrderAliasCommand
    ...
    public DeleteOrderAliasCommand(UserVisitPK userVisitPK, DeleteOrderAliasForm form) {
        ...
        if(orderType != null) {
            ...
            if(order != null) {
                ...
                if(orderAliasType != null) {
                    OrderAlias orderAlias = orderControl.getOrderAliasForUpdate(order, orderAliasType);

                    if(orderAlias != null) {
                        orderControl.deleteOrderAlias(orderAlias, getPartyPK());
                    } else {
