...
public class CreateOrderAdjustmentTypeDescriptionCommand
        extends BaseSimpleCommand<CreateOrderAdjustmentTypeDescriptionForm> {
    ...
    /** Creates a new instance of CreateOrderAdjustmentTypeDescriptionCommand */
    public CreateOrderAdjustmentTypeDescriptionCommand(UserVisitPK userVisitPK, CreateOrderAdjustmentTypeDescriptionForm form) {
            ...
            if(orderAdjustmentType != null) {
                ...
                if(language != null) {
                    ...
                    if(orderAdjustmentTypeDescription == null) {
                        ...
                        orderControl.createOrderAdjustmentTypeDescription(orderAdjustmentType, language, description, getPartyPK());
                    } else {
                        addExecutionError(ExecutionErrors.DuplicateOrderAdjustmentTypeDescription.name(), orderTypeName, orderAdjustmentTypeName, languageIsoName);
                    }
                } else {
