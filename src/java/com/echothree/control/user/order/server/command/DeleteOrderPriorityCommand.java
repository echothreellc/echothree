...
import com.echothree.control.user.order.common.form.DeleteOrderPriorityForm;
...
public class DeleteOrderPriorityCommand
        extends BaseSimpleCommand<DeleteOrderPriorityForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.OrderPriority.name(), SecurityRoles.Delete.name())
                        )))
                )));
    ...
    public DeleteOrderPriorityCommand(UserVisitPK userVisitPK, DeleteOrderPriorityForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(orderType != null) {
            ...
            OrderPriority orderPriority = orderPriorityControl.getOrderPriorityByNameForUpdate(orderType, orderPriorityName);

            if(orderPriority != null) {
                orderPriorityControl.deleteOrderPriority(orderPriority, getPartyPK());
            } else {
