...
public class CreateOrderTimeTypeCommand
        extends BaseSimpleCommand<CreateOrderTimeTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                    new SecurityRoleDefinition(SecurityRoleGroups.OrderTimeType.name(), SecurityRoles.Create.name())
                    )))
                )));
    ...
    public CreateOrderTimeTypeCommand(UserVisitPK userVisitPK, CreateOrderTimeTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(orderType != null) {
            ...
            if(orderTimeType == null) {
                ...
                orderTimeType = orderControl.createOrderTimeType(orderType, orderTimeTypeName, isDefault, sortOrder, partyPK);
