...
import com.echothree.control.user.order.remote.form.GetOrderPrioritiesForm;
import com.echothree.control.user.order.remote.result.GetOrderPrioritiesResult;
...
public class GetOrderPrioritiesCommand
    ...
    protected BaseResult execute() {
        ...
        if(orderType != null) {
            result.setOrderPriorities(orderControl.getOrderPriorityTransfers(getUserVisit(), orderType));
        } else {
