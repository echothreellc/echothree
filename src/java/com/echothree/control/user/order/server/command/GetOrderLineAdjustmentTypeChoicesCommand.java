...
import com.echothree.control.user.order.remote.form.GetOrderLineAdjustmentTypeChoicesForm;
import com.echothree.control.user.order.remote.result.GetOrderLineAdjustmentTypeChoicesResult;
...
public class GetOrderLineAdjustmentTypeChoicesCommand
    ...
    protected BaseResult execute() {
        ...
        if(orderType != null) {
            ...
            result.setOrderLineAdjustmentTypeChoices(orderControl.getOrderLineAdjustmentTypeChoices(defaultOrderLineAdjustmentTypeChoice, getPreferredLanguage(), allowNullChoice,
                    orderType));
        } else {
