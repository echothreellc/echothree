...
import com.echothree.control.user.order.remote.form.GetOrderTimeTypeDescriptionForm;
import com.echothree.control.user.order.remote.result.GetOrderTimeTypeDescriptionResult;
...
public class GetOrderTimeTypeDescriptionCommand
        extends BaseSimpleCommand<GetOrderTimeTypeDescriptionForm> {
    ...
    /** Creates a new instance of GetOrderTimeTypeDescriptionCommand */
    public GetOrderTimeTypeDescriptionCommand(UserVisitPK userVisitPK, GetOrderTimeTypeDescriptionForm form) {
