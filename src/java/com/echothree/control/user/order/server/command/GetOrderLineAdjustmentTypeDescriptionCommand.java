...
public class GetOrderLineAdjustmentTypeDescriptionCommand
        extends BaseSimpleCommand<GetOrderLineAdjustmentTypeDescriptionForm> {
    ...
    /** Creates a new instance of GetOrderLineAdjustmentTypeDescriptionCommand */
    public GetOrderLineAdjustmentTypeDescriptionCommand(UserVisitPK userVisitPK, GetOrderLineAdjustmentTypeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        var result = OrderResultFactory.getGetOrderLineAdjustmentTypeDescriptionResult();
        ...
        if(orderType != null) {
            ...
            if(orderLineAdjustmentType != null) {
                ...
                if(language != null) {
                    var orderLineAdjustmentTypeDescription = orderLineAdjustmentControl.getOrderLineAdjustmentTypeDescription(orderLineAdjustmentType, language);
