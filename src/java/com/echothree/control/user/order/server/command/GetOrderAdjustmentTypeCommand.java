...
import com.echothree.control.user.order.remote.form.GetOrderAdjustmentTypeForm;
import com.echothree.control.user.order.remote.result.GetOrderAdjustmentTypeResult;
...
public class GetOrderAdjustmentTypeCommand
    ...
    public GetOrderAdjustmentTypeCommand(UserVisitPK userVisitPK, GetOrderAdjustmentTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(orderType != null) {
            ...
            if(orderAdjustmentType != null) {
                ...
                sendEventUsingNames(orderAdjustmentType.getPrimaryKey(), EventTypes.READ.name(), null, null, getPartyPK());
            } else {
