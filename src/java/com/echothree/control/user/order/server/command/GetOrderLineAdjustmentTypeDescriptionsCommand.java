    ...
    protected BaseResult execute() {
        ...
        if(orderType != null) {
            ...
            if(orderLineAdjustmentType != null) {
                ...
                result.setOrderLineAdjustmentTypeDescriptions(orderControl.getOrderLineAdjustmentTypeDescriptionTransfersByOrderLineAdjustmentType(getUserVisit(), orderLineAdjustmentType));
            } else {
