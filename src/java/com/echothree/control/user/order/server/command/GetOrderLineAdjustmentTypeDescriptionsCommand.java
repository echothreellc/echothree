...
import com.echothree.control.user.order.common.form.GetOrderLineAdjustmentTypeDescriptionsForm;
import com.echothree.control.user.order.common.result.GetOrderLineAdjustmentTypeDescriptionsResult;
...
public class GetOrderLineAdjustmentTypeDescriptionsCommand
        extends BaseSimpleCommand<GetOrderLineAdjustmentTypeDescriptionsForm> {
    ...
    /** Creates a new instance of GetOrderLineAdjustmentTypeDescriptionsCommand */
    public GetOrderLineAdjustmentTypeDescriptionsCommand(UserVisitPK userVisitPK, GetOrderLineAdjustmentTypeDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(orderType != null) {
            ...
            if(orderLineAdjustmentType != null) {
                ...
                result.setOrderLineAdjustmentTypeDescriptions(orderLineAdjustmentControl.getOrderLineAdjustmentTypeDescriptionTransfersByOrderLineAdjustmentType(getUserVisit(), orderLineAdjustmentType));
            } else {
