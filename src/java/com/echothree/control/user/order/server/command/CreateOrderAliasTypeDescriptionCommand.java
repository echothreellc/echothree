...
import com.echothree.control.user.order.remote.form.CreateOrderAliasTypeDescriptionForm;
...
public class CreateOrderAliasTypeDescriptionCommand
    ...
    public CreateOrderAliasTypeDescriptionCommand(UserVisitPK userVisitPK, CreateOrderAliasTypeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(orderType != null) {
            ...
            if(orderAliasType != null) {
                ...
                if(language != null) {
                    OrderAliasTypeDescription orderAliasTypeDescription = orderControl.getOrderAliasTypeDescription(orderAliasType, language);

                    if(orderAliasTypeDescription == null) {
                        String description = form.getDescription();

                        orderControl.createOrderAliasTypeDescription(orderAliasType, language, description, getPartyPK());
                    } else {
