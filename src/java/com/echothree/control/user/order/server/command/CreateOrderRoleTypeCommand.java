...
import com.echothree.control.user.order.remote.form.CreateOrderRoleTypeForm;
...
public class CreateOrderRoleTypeCommand
        extends BaseSimpleCommand<CreateOrderRoleTypeForm> {
    ...
    /** Creates a new instance of CreateOrderRoleTypeCommand */
    public CreateOrderRoleTypeCommand(UserVisitPK userVisitPK, CreateOrderRoleTypeForm form) {
