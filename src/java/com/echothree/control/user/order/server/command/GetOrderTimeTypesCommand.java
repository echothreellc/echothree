...
import com.echothree.control.user.order.remote.form.GetOrderTimeTypesForm;
import com.echothree.control.user.order.remote.result.GetOrderTimeTypesResult;
...
public class GetOrderTimeTypesCommand
    ...
    protected BaseResult execute() {
        ...
        if(orderType != null) {
            result.setOrderTimeTypes(orderControl.getOrderTimeTypeTransfers(getUserVisit(), orderType));
        } else {
