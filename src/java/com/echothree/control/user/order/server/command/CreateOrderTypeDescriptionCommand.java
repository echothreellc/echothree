...
public class CreateOrderTypeDescriptionCommand
        extends BaseSimpleCommand<CreateOrderTypeDescriptionForm> {
    ...
    /** Creates a new instance of CreateOrderTypeDescriptionCommand */
    public CreateOrderTypeDescriptionCommand(UserVisitPK userVisitPK, CreateOrderTypeDescriptionForm form) {
