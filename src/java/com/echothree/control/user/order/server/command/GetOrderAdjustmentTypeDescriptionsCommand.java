...
public class GetOrderAdjustmentTypeDescriptionsCommand
    ...
    public GetOrderAdjustmentTypeDescriptionsCommand() {
    ...
    protected BaseResult execute() {
        ...
        var result = OrderResultFactory.getGetOrderAdjustmentTypeDescriptionsResult();
        ...
        if(orderType != null) {
            ...
            if(orderAdjustmentType != null) {
                ...
                result.setOrderAdjustmentTypeDescriptions(orderAdjustmentControl.getOrderAdjustmentTypeDescriptionTransfersByOrderAdjustmentType(getUserVisit(), orderAdjustmentType));
            } else {
