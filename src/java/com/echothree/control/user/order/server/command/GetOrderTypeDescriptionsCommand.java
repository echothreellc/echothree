...
import com.echothree.control.user.order.remote.form.GetOrderTypeDescriptionsForm;
import com.echothree.control.user.order.remote.result.GetOrderTypeDescriptionsResult;
...
public class GetOrderTypeDescriptionsCommand
        extends BaseSimpleCommand<GetOrderTypeDescriptionsForm> {
