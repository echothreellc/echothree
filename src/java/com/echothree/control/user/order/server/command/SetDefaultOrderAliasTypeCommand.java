...
import com.echothree.control.user.order.remote.form.SetDefaultOrderAliasTypeForm;
...
public class SetDefaultOrderAliasTypeCommand
        extends BaseSimpleCommand<SetDefaultOrderAliasTypeForm> {
