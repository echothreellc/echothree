...
import com.echothree.control.user.order.remote.form.SetDefaultOrderLineAdjustmentTypeForm;
...
public class SetDefaultOrderLineAdjustmentTypeCommand
        extends BaseSimpleCommand<SetDefaultOrderLineAdjustmentTypeForm> {
    ...
    public SetDefaultOrderLineAdjustmentTypeCommand(UserVisitPK userVisitPK, SetDefaultOrderLineAdjustmentTypeForm form) {
