...
public class DeleteShippingMethodCommand
        extends BaseSimpleCommand<DeleteShippingMethodForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.ShippingMethod.name(), SecurityRoles.Delete.name())
                        )))
                )));
    ...
    /** Creates a new instance of DeleteShippingMethodCommand */
    public DeleteShippingMethodCommand(UserVisitPK userVisitPK, DeleteShippingMethodForm form) {
