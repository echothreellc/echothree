...
import com.echothree.control.user.shipping.remote.form.GetShippingMethodsForm;
import com.echothree.control.user.shipping.remote.result.GetShippingMethodsResult;
...
public class GetShippingMethodsCommand
        extends BaseSimpleCommand<GetShippingMethodsForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.ShippingMethod.name(), SecurityRoles.List.name())
                        )))
                )));
    ...
    public GetShippingMethodsCommand(UserVisitPK userVisitPK, GetShippingMethodsForm form) {
