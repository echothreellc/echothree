...
public class CreateShippingMethodDescriptionCommand
        extends BaseSimpleCommand<CreateShippingMethodDescriptionForm> {
    ...
    /** Creates a new instance of CreateShippingMethodDescriptionCommand */
    public CreateShippingMethodDescriptionCommand(UserVisitPK userVisitPK, CreateShippingMethodDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        var shippingMethod = shippingControl.getShippingMethodByName(shippingMethodName);
            ...
            if(shippingMethod != null) {
                ...
                if(language != null) {
                    var shippingMethodDescription = shippingControl.getShippingMethodDescription(shippingMethod, language);
                    ...
                    if(shippingMethodDescription == null) {
                        ...
                        addExecutionError(ExecutionErrors.DuplicateShippingMethodDescription.name(), shippingMethodName, languageIsoName);
                    }
                } else {
