...
public class CreateShippingMethodCarrierServiceCommand
        extends BaseSimpleCommand<CreateShippingMethodCarrierServiceForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.ShippingMethodCarrierService.name(), SecurityRoles.Create.name())
                        )))
                )));
    ...
    public CreateShippingMethodCarrierServiceCommand(UserVisitPK userVisitPK, CreateShippingMethodCarrierServiceForm form) {
            ...
            if(carrier != null) {
                ...
                if(carrierService != null) {
                    ...
                    if(shippingMethodCarrierService == null) {
                        shippingControl.createShippingMethodCarrierService(shippingMethod, carrierService, getPartyPK());
                    } else {
                        addExecutionError(ExecutionErrors.DuplicateShippingMethodCarrierService.name(), shippingMethodName, carrierName, carrierServiceName);
                    }
                } else {
