...
import com.echothree.control.user.shipping.remote.form.GetShippingMethodCarrierServiceForm;
import com.echothree.control.user.shipping.remote.result.GetShippingMethodCarrierServiceResult;
...
public class GetShippingMethodCarrierServiceCommand
    ...
    public GetShippingMethodCarrierServiceCommand(UserVisitPK userVisitPK, GetShippingMethodCarrierServiceForm form) {
