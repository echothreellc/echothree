...
import com.echothree.control.user.shipping.common.form.GetShippingMethodDescriptionForm;
import com.echothree.control.user.shipping.common.result.GetShippingMethodDescriptionResult;
...
public class GetShippingMethodDescriptionCommand
        extends BaseSimpleCommand<GetShippingMethodDescriptionForm> {
    ...
    /** Creates a new instance of GetShippingMethodDescriptionCommand */
    public GetShippingMethodDescriptionCommand(UserVisitPK userVisitPK, GetShippingMethodDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        var result = ShippingResultFactory.getGetShippingMethodDescriptionResult();
