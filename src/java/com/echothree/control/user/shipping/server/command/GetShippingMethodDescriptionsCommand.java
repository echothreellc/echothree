...
public class GetShippingMethodDescriptionsCommand
        extends BaseSimpleCommand<GetShippingMethodDescriptionsForm> {
    ...
    /** Creates a new instance of GetShippingMethodDescriptionsCommand */
    public GetShippingMethodDescriptionsCommand(UserVisitPK userVisitPK, GetShippingMethodDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(shippingMethod != null) {
            ...
            result.setShippingMethodDescriptions(shippingControl.getShippingMethodDescriptionTransfers(getUserVisit(), shippingMethod));
        } else {
