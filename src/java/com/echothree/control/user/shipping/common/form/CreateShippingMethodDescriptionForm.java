...
public interface CreateShippingMethodDescriptionForm
        extends ShippingMethodDescriptionSpec, ShippingMethodDescriptionEdit {
    
    // Nothing additional beyond ShippingMethodDescriptionSpec, ShippingMethodDescriptionEdit
