...
public interface CreateDocumentDescriptionForm
        extends DocumentDescriptionSpec, DocumentDescriptionEdit {
    
    // Nothing additional beyond DocumentDescriptionSpec, DocumentDescriptionEdit
