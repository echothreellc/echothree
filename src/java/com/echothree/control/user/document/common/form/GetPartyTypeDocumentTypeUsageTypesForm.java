...
public interface GetPartyTypeDocumentTypeUsageTypesForm
        extends PartyTypeSpec, DocumentTypeUsageTypeSpec {
    
    // Nothing additional beyond PartyTypeSpec, DocumentTypeUsageTypeSpec
