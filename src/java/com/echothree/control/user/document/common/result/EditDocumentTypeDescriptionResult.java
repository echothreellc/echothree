...
public interface EditDocumentTypeDescriptionResult
        extends BaseEditResult<DocumentTypeDescriptionEdit> {

    DocumentTypeDescriptionTransfer getDocumentTypeDescription();
    void setDocumentTypeDescription(DocumentTypeDescriptionTransfer documentType);
