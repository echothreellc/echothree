...
public interface EditDocumentTypeUsageTypeDescriptionResult
        extends BaseEditResult<DocumentTypeUsageTypeDescriptionEdit> {

    DocumentTypeUsageTypeDescriptionTransfer getDocumentTypeUsageTypeDescription();
    void setDocumentTypeUsageTypeDescription(DocumentTypeUsageTypeDescriptionTransfer documentTypeUsageType);
