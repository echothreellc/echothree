...
public interface CreateDocumentTypeDescriptionForm
        extends DocumentTypeDescriptionSpec, DocumentTypeDescriptionEdit {
    
    // Nothing additional beyond DocumentTypeDescriptionSpec, DocumentTypeDescriptionEdit
