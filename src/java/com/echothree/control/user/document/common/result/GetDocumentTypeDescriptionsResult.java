...
public interface GetDocumentTypeDescriptionsResult
        extends BaseResult {
    
    DocumentTypeTransfer getDocumentType();
    void setDocumentType(DocumentTypeTransfer documentType);
    
    List<DocumentTypeDescriptionTransfer> getDocumentTypeDescriptions();
    void setDocumentTypeDescriptions(List<DocumentTypeDescriptionTransfer> documentTypeDescriptions);
