...
public interface CreateDocumentTypeUsageForm
        extends DocumentTypeUsageSpec, DocumentTypeUsageEdit {
    
    // Nothing additional beyond DocumentTypeUsageSpec, DocumentTypeUsageEdit
