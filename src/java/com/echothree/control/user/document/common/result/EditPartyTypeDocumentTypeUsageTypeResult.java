...
public interface EditPartyTypeDocumentTypeUsageTypeResult
        extends BaseEditResult<PartyTypeDocumentTypeUsageTypeEdit> {

    PartyTypeDocumentTypeUsageTypeTransfer getPartyTypeDocumentTypeUsageType();
    void setPartyTypeDocumentTypeUsageType(PartyTypeDocumentTypeUsageTypeTransfer partyType);
