...
public interface EditDocumentTypeUsageTypeDescriptionForm
        extends BaseEditForm<DocumentTypeUsageTypeDescriptionSpec, DocumentTypeUsageTypeDescriptionEdit> {
