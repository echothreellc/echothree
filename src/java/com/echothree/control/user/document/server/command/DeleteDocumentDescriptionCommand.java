...
public class DeleteDocumentDescriptionCommand
        extends BaseSimpleCommand<DeleteDocumentDescriptionForm> {
    ...
    /** Creates a new instance of DeleteDocumentDescriptionCommand */
    public DeleteDocumentDescriptionCommand(UserVisitPK userVisitPK, DeleteDocumentDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(document != null) {
            ...
            if(language != null) {
                DocumentDescription documentDescription = documentControl.getDocumentDescriptionForUpdate(document, language);
                
                if(documentDescription != null) {
                    documentControl.deleteDocumentDescription(documentDescription, getPartyPK());
                } else {
