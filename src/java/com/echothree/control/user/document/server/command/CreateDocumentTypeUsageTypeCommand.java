...
import com.echothree.control.user.document.remote.form.CreateDocumentTypeUsageTypeForm;
...
public class CreateDocumentTypeUsageTypeCommand
        extends BaseSimpleCommand<CreateDocumentTypeUsageTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                    new SecurityRoleDefinition(SecurityRoleGroups.DocumentTypeUsageType.name(), SecurityRoles.Create.name())
                    )))
                )));
    ...
    protected BaseResult execute() {
        ...
        if(documentTypeUsageType == null) {
            ...
            documentTypeUsageType = documentControl.createDocumentTypeUsageType(documentTypeUsageTypeName, isDefault, sortOrder, partyPK);
