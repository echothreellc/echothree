...
import com.echothree.control.user.document.remote.form.GetDocumentTypeUsageTypeDescriptionsForm;
import com.echothree.control.user.document.remote.result.DocumentResultFactory;
import com.echothree.control.user.document.remote.result.GetDocumentTypeUsageTypeDescriptionsResult;
...
public class GetDocumentTypeUsageTypeDescriptionsCommand
    ...
    public GetDocumentTypeUsageTypeDescriptionsCommand(UserVisitPK userVisitPK, GetDocumentTypeUsageTypeDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetDocumentTypeUsageTypeDescriptionsResult result = DocumentResultFactory.getGetDocumentTypeUsageTypeDescriptionsResult();
