...
public class GetDocumentTypeCommand
        extends BaseSimpleCommand<GetDocumentTypeForm> {
    ...
    public GetDocumentTypeCommand(UserVisitPK userVisitPK, GetDocumentTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(documentType != null) {
            ...
            sendEventUsingNames(documentType.getPrimaryKey(), EventTypes.READ.name(), null, null, getPartyPK());
        } else {
