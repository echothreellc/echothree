...
import com.echothree.control.user.document.common.form.SetDefaultDocumentTypeUsageForm;
...
public class SetDefaultDocumentTypeUsageCommand
        extends BaseSimpleCommand<SetDefaultDocumentTypeUsageForm> {
    ...
    static {
        ...
        FORM_FIELD_DEFINITIONS = Collections.unmodifiableList(Arrays.asList(
                new FieldDefinition("DocumentTypeUsageName", FieldType.ENTITY_NAME, true, null, null),
                new FieldDefinition("DocumentTypeName", FieldType.ENTITY_NAME, true, null, null)
                ));
    }
    
    /** Creates a new instance of SetDefaultDocumentTypeUsageCommand */
    public SetDefaultDocumentTypeUsageCommand(UserVisitPK userVisitPK, SetDefaultDocumentTypeUsageForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(documentTypeUsageType != null) {
            ...
            if(documentType != null) {
                DocumentTypeUsageValue documentTypeUsageValue = documentControl.getDocumentTypeUsageValueForUpdate(documentTypeUsageType, documentType);

                if(documentTypeUsageValue != null) {
                    documentTypeUsageValue.setIsDefault(Boolean.TRUE);
