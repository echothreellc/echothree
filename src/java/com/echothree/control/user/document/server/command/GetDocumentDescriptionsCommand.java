...
public class GetDocumentDescriptionsCommand
        extends BaseSimpleCommand<GetDocumentDescriptionsForm> {
    ...
    public GetDocumentDescriptionsCommand(UserVisitPK userVisitPK, GetDocumentDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(document != null) {
            ...
            result.setDocumentDescriptions(documentControl.getDocumentDescriptionTransfersByDocument(getUserVisit(), document));
        } else {
