...
import com.echothree.control.user.document.remote.form.DeleteDocumentTypeUsageForm;
...
public class DeleteDocumentTypeUsageCommand
    ...
    public DeleteDocumentTypeUsageCommand(UserVisitPK userVisitPK, DeleteDocumentTypeUsageForm form) {
