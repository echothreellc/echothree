...
import com.echothree.control.user.document.common.result.GetDocumentTypeUsageTypeResult;
...
public class GetDocumentTypeUsageTypeCommand
    ...
    protected BaseResult execute() {
        ...
        if(documentTypeUsageType != null) {
            ...
            sendEventUsingNames(documentTypeUsageType.getPrimaryKey(), EventTypes.READ, null, null, getPartyPK());
        } else {
