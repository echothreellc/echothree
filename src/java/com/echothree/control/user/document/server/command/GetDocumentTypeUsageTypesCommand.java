...
import com.echothree.control.user.document.common.result.GetDocumentTypeUsageTypesResult;
...
public class GetDocumentTypeUsageTypesCommand
        extends BaseSimpleCommand<GetDocumentTypeUsageTypesForm> {
    ...
    public GetDocumentTypeUsageTypesCommand(UserVisitPK userVisitPK, GetDocumentTypeUsageTypesForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetDocumentTypeUsageTypesResult result = DocumentResultFactory.getGetDocumentTypeUsageTypesResult();
