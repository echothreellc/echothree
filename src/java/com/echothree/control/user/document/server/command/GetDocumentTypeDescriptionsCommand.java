...
import com.echothree.control.user.document.common.form.GetDocumentTypeDescriptionsForm;
import com.echothree.control.user.document.common.result.DocumentResultFactory;
import com.echothree.control.user.document.common.result.GetDocumentTypeDescriptionsResult;
...
public class GetDocumentTypeDescriptionsCommand
        extends BaseSimpleCommand<GetDocumentTypeDescriptionsForm> {
    ...
    /** Creates a new instance of GetDocumentTypeDescriptionsCommand */
    public GetDocumentTypeDescriptionsCommand(UserVisitPK userVisitPK, GetDocumentTypeDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(documentType != null) {
            ...
            result.setDocumentTypeDescriptions(documentControl.getDocumentTypeDescriptionTransfersByDocumentType(getUserVisit(), documentType));
        } else {
