...
import com.echothree.control.user.document.remote.form.DeleteDocumentTypeUsageTypeDescriptionForm;
...
public class DeleteDocumentTypeUsageTypeDescriptionCommand
        extends BaseSimpleCommand<DeleteDocumentTypeUsageTypeDescriptionForm> {
    ...
    /** Creates a new instance of DeleteDocumentTypeUsageTypeDescriptionCommand */
    public DeleteDocumentTypeUsageTypeDescriptionCommand(UserVisitPK userVisitPK, DeleteDocumentTypeUsageTypeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(documentTypeUsageType != null) {
            ...
            if(language != null) {
                DocumentTypeUsageTypeDescription documentTypeUsageTypeDescription = documentControl.getDocumentTypeUsageTypeDescriptionForUpdate(documentTypeUsageType, language);
                
                if(documentTypeUsageTypeDescription != null) {
                    documentControl.deleteDocumentTypeUsageTypeDescription(documentTypeUsageTypeDescription, getPartyPK());
                } else {
