...
import com.echothree.control.user.document.remote.form.GetPartyDocumentsForm;
import com.echothree.control.user.document.remote.result.DocumentResultFactory;
import com.echothree.control.user.document.remote.result.GetPartyDocumentsResult;
...
public class GetPartyDocumentsCommand
    ...
    public GetPartyDocumentsCommand(UserVisitPK userVisitPK, GetPartyDocumentsForm form) {
