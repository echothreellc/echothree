...
import com.echothree.control.user.document.remote.form.GetDocumentTypeUsagesForm;
import com.echothree.control.user.document.remote.result.DocumentResultFactory;
import com.echothree.control.user.document.remote.result.GetDocumentTypeUsagesResult;
...
public class GetDocumentTypeUsagesCommand
        extends BaseSimpleCommand<GetDocumentTypeUsagesForm> {
    ...
    public GetDocumentTypeUsagesCommand(UserVisitPK userVisitPK, GetDocumentTypeUsagesForm form) {
        ...
        if(parameterCount == 1) {
            ...
            if(documentTypeUsageTypeName != null) {
                ...
                if(documentTypeUsageType != null) {
                    ...
                    result.setDocumentTypeUsages(documentControl.getDocumentTypeUsageTransfersByDocumentTypeUsageType(userVisit, documentTypeUsageType));
                } else {
                ...
                if(documentType != null) {
                    ...
                    result.setDocumentTypeUsages(documentControl.getDocumentTypeUsageTransfersByDocumentType(userVisit, documentType));
                } else {
