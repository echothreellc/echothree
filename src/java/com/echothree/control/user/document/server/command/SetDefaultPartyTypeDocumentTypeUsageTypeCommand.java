...
import com.echothree.control.user.document.remote.form.SetDefaultPartyTypeDocumentTypeUsageTypeForm;
...
public class SetDefaultPartyTypeDocumentTypeUsageTypeCommand
    ...
    public SetDefaultPartyTypeDocumentTypeUsageTypeCommand(UserVisitPK userVisitPK, SetDefaultPartyTypeDocumentTypeUsageTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(partyType != null) {
            ...
            if(documentTypeUsageType != null) {
                PartyTypeDocumentTypeUsageTypeValue partyTypeDocumentTypeUsageTypeValue = documentControl.getPartyTypeDocumentTypeUsageTypeValueForUpdate(partyType, documentTypeUsageType);
