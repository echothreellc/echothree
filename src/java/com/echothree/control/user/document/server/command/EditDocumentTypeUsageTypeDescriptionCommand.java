...
import com.echothree.control.user.document.remote.edit.DocumentTypeUsageTypeDescriptionEdit;
import com.echothree.control.user.document.remote.form.EditDocumentTypeUsageTypeDescriptionForm;
import com.echothree.control.user.document.remote.result.DocumentResultFactory;
import com.echothree.control.user.document.remote.result.EditDocumentTypeUsageTypeDescriptionResult;
import com.echothree.control.user.document.remote.spec.DocumentTypeUsageTypeDescriptionSpec;
...
public class EditDocumentTypeUsageTypeDescriptionCommand
    ...
    public EditDocumentTypeUsageTypeDescriptionCommand(UserVisitPK userVisitPK, EditDocumentTypeUsageTypeDescriptionForm form) {
