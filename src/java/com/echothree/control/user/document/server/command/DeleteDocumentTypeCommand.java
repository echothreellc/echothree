...
import com.echothree.control.user.document.common.form.DeleteDocumentTypeForm;
...
public class DeleteDocumentTypeCommand
        extends BaseSimpleCommand<DeleteDocumentTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.DocumentType.name(), SecurityRoles.Delete.name())
                        )))
                )));
    ...
    public DeleteDocumentTypeCommand(UserVisitPK userVisitPK, DeleteDocumentTypeForm form) {
