...
@Dependent
public class CreateDocumentDescriptionCommand
        extends BaseSimpleCommand<CreateDocumentDescriptionForm> {
        ...
        if(document != null) {
            ...
            if(language != null) {
                ...
                if(documentDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateDocumentDescription.name(), documentName, languageIsoName);
                }
            } else {
