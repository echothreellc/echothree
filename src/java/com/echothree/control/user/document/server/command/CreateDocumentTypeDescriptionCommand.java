...
import com.echothree.control.user.document.remote.form.CreateDocumentTypeDescriptionForm;
...
public class CreateDocumentTypeDescriptionCommand
        extends BaseSimpleCommand<CreateDocumentTypeDescriptionForm> {
    ...
    /** Creates a new instance of CreateDocumentTypeDescriptionCommand */
    public CreateDocumentTypeDescriptionCommand(UserVisitPK userVisitPK, CreateDocumentTypeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(documentType != null) {
            ...
            if(language != null) {
                DocumentTypeDescription documentTypeDescription = documentControl.getDocumentTypeDescription(documentType, language);
                
                if(documentTypeDescription == null) {
                    String description = form.getDescription();
                    
                    documentControl.createDocumentTypeDescription(documentType, language, description, getPartyPK());
                } else {
                    addExecutionError(ExecutionErrors.DuplicateDocumentTypeDescription.name(), documentTypeName, languageIsoName);
                }
            } else {
