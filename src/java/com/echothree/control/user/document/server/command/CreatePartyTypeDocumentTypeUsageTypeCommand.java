...
public class CreatePartyTypeDocumentTypeUsageTypeCommand
        extends BaseSimpleCommand<CreatePartyTypeDocumentTypeUsageTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.PartyTypeDocumentTypeUsageType.name(), SecurityRoles.Create.name())
                        )))
                )));
        ...
        if(partyType != null) {
            ...
            if(documentTypeUsageType != null) {
                ...
                if(partyTypeDocumentTypeUsageType == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicatePartyTypeDocumentTypeUsageType.name(), partyTypeName, documentTypeUsageTypeName);
                }
            } else {
