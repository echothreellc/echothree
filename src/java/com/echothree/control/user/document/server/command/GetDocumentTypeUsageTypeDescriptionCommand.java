...
import com.echothree.control.user.document.common.form.GetDocumentTypeUsageTypeDescriptionForm;
import com.echothree.control.user.document.common.result.DocumentResultFactory;
import com.echothree.control.user.document.common.result.GetDocumentTypeUsageTypeDescriptionResult;
...
public class GetDocumentTypeUsageTypeDescriptionCommand
        extends BaseSimpleCommand<GetDocumentTypeUsageTypeDescriptionForm> {
    ...
    /** Creates a new instance of GetDocumentTypeUsageTypeDescriptionCommand */
    public GetDocumentTypeUsageTypeDescriptionCommand(UserVisitPK userVisitPK, GetDocumentTypeUsageTypeDescriptionForm form) {
