...
@Dependent
public class CreateInventoryCostingMethodCommand
        extends BaseSimpleCommand<CreateInventoryCostingMethodForm> {
    ...
    /** Creates a new instance of CreateInventoryCostingMethodCommand */
    public CreateInventoryCostingMethodCommand() {
        super(COMMAND_SECURITY_DEFINITION, FORM_FIELD_DEFINITIONS, false);
    }

    @Override
    protected BaseResult execute() {
        var result = InventoryResultFactory.getCreateInventoryCostingMethodResult();
        ...
        var inventoryCostingMethod = inventoryCostingMethodLogic.createInventoryCostingMethod(this,
                inventoryCostingMethodName, isDefault, sortOrder, getPreferredLanguage(), description, partyPK);

        if(inventoryCostingMethod != null) {
            result.setEntityRef(inventoryCostingMethod.getPrimaryKey().getEntityRef());
            result.setInventoryCostingMethodName(inventoryCostingMethod.getLastDetail().getInventoryCostingMethodName());
        }
