...
import com.echothree.control.user.inventory.remote.form.GetAllocationPriorityDescriptionForm;
import com.echothree.control.user.inventory.remote.result.GetAllocationPriorityDescriptionResult;
...
public class GetAllocationPriorityDescriptionCommand
        extends BaseSimpleCommand<GetAllocationPriorityDescriptionForm> {
    ...
    /** Creates a new instance of GetAllocationPriorityDescriptionCommand */
    public GetAllocationPriorityDescriptionCommand(UserVisitPK userVisitPK, GetAllocationPriorityDescriptionForm form) {
