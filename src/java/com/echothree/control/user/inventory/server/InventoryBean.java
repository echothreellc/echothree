...
import com.echothree.control.user.inventory.remote.form.*;
...
public class InventoryBean
    ...
    @Override
    public CommandResult createLotType(UserVisitPK userVisitPK, CreateLotTypeForm form) {
        return new CreateLotTypeCommand(userVisitPK, form).run();
    }

    @Override
    public CommandResult getLotTypeChoices(UserVisitPK userVisitPK, GetLotTypeChoicesForm form) {
        return new GetLotTypeChoicesCommand(userVisitPK, form).run();
    }

    @Override
    public CommandResult getLotType(UserVisitPK userVisitPK, GetLotTypeForm form) {
        return new GetLotTypeCommand(userVisitPK, form).run();
    }

    @Override
    public CommandResult getLotTypes(UserVisitPK userVisitPK, GetLotTypesForm form) {
        return new GetLotTypesCommand(userVisitPK, form).run();
    }

    @Override
    public CommandResult setDefaultLotType(UserVisitPK userVisitPK, SetDefaultLotTypeForm form) {
        return new SetDefaultLotTypeCommand(userVisitPK, form).run();
    }

    @Override
    public CommandResult editLotType(UserVisitPK userVisitPK, EditLotTypeForm form) {
        return new EditLotTypeCommand(userVisitPK, form).run();
    }

    @Override
    public CommandResult deleteLotType(UserVisitPK userVisitPK, DeleteLotTypeForm form) {
        return new DeleteLotTypeCommand(userVisitPK, form).run();
    }
    ...
    @Override
    public CommandResult createLotTypeDescription(UserVisitPK userVisitPK, CreateLotTypeDescriptionForm form) {
        return new CreateLotTypeDescriptionCommand(userVisitPK, form).run();
    }

    @Override
    public CommandResult getLotTypeDescription(UserVisitPK userVisitPK, GetLotTypeDescriptionForm form) {
        return new GetLotTypeDescriptionCommand(userVisitPK, form).run();
    }

    @Override
    public CommandResult getLotTypeDescriptions(UserVisitPK userVisitPK, GetLotTypeDescriptionsForm form) {
        return new GetLotTypeDescriptionsCommand(userVisitPK, form).run();
    }

    @Override
    public CommandResult editLotTypeDescription(UserVisitPK userVisitPK, EditLotTypeDescriptionForm form) {
        return new EditLotTypeDescriptionCommand(userVisitPK, form).run();
    }

    @Override
    public CommandResult deleteLotTypeDescription(UserVisitPK userVisitPK, DeleteLotTypeDescriptionForm form) {
        return new DeleteLotTypeDescriptionCommand(userVisitPK, form).run();
    }
