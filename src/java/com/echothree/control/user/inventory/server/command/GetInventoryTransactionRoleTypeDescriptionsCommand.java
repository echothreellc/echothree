...
import com.echothree.control.user.inventory.common.form.GetInventoryTransactionRoleTypeDescriptionsForm;
...
@Dependent
public class GetInventoryTransactionRoleTypeDescriptionsCommand
        extends BasePaginatedMultipleEntitiesCommand<InventoryTransactionRoleTypeDescription,
                GetInventoryTransactionRoleTypeDescriptionsForm> {
    ...
    /** Creates a new instance of GetInventoryTransactionRoleTypeDescriptionsCommand */
    public GetInventoryTransactionRoleTypeDescriptionsCommand() {
    ...
    protected void handleForm() {
        ...
        if(!hasExecutionErrors()) {
            ...
            inventoryTransactionRoleType = inventoryTransactionRoleTypeLogic.getInventoryTransactionRoleTypeByName(this,
    ...
    protected Long getTotalEntities() {
        return hasExecutionErrors() ? null
                : inventoryTransactionRoleControl.countInventoryTransactionRoleTypeDescriptionsByInventoryTransactionRoleType(
                        inventoryTransactionRoleType);
    }

    @Override
    protected Collection<InventoryTransactionRoleTypeDescription> getEntities() {
        return hasExecutionErrors() ? null
                : inventoryTransactionRoleControl.getInventoryTransactionRoleTypeDescriptionsByInventoryTransactionRoleType(
                        inventoryTransactionRoleType);
    }

    @Override
    protected BaseResult getResult(Collection<InventoryTransactionRoleTypeDescription> entities) {
        var result = InventoryResultFactory.getGetInventoryTransactionRoleTypeDescriptionsResult();

        if(entities != null) {
            var userVisit = getUserVisit();

            result.setInventoryTransactionRoleType(
                    inventoryTransactionRoleControl.getInventoryTransactionRoleTypeTransfer(userVisit, inventoryTransactionRoleType));

            if(session.hasLimit(InventoryTransactionRoleTypeDescriptionFactory.class)) {
                result.setInventoryTransactionRoleTypeDescriptionCount(getTotalEntities());
            }

            result.setInventoryTransactionRoleTypeDescriptions(
                    inventoryTransactionRoleControl.getInventoryTransactionRoleTypeDescriptionTransfers(userVisit, entities));
        }
