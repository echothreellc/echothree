...
import com.echothree.control.user.inventory.common.form.GetInventoryAdjustmentTypesForm;
...
public class GetInventoryAdjustmentTypesCommand
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(List.of(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), List.of(
                        new SecurityRoleDefinition(SecurityRoleGroups.InventoryAdjustmentType.name(), SecurityRoles.List.name())
                ))
        ));
    ...
    @Override
    protected BaseResult getResult(Collection<InventoryAdjustmentType> entities) {
        ...
        if(entities != null) {
            ...
            result.setInventoryAdjustmentTypes(inventoryAdjustmentTypeControl.getInventoryAdjustmentTypeTransfers(getUserVisit(), entities));
        }
