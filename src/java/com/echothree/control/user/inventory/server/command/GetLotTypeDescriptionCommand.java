...
import com.echothree.control.user.inventory.common.form.GetLotTypeDescriptionForm;
import com.echothree.control.user.inventory.common.result.GetLotTypeDescriptionResult;
...
public class GetLotTypeDescriptionCommand
        extends BaseSimpleCommand<GetLotTypeDescriptionForm> {
    ...
    /** Creates a new instance of GetLotTypeDescriptionCommand */
    public GetLotTypeDescriptionCommand(UserVisitPK userVisitPK, GetLotTypeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetLotTypeDescriptionResult result = InventoryResultFactory.getGetLotTypeDescriptionResult();
        ...
        if(lotType != null) {
            ...
            if(language != null) {
                LotTypeDescription lotTypeDescription = inventoryControl.getLotTypeDescription(lotType, language);
