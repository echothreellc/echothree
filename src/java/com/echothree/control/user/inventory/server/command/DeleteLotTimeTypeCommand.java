...
import com.echothree.control.user.inventory.remote.form.DeleteLotTimeTypeForm;
...
public class DeleteLotTimeTypeCommand
        extends BaseSimpleCommand<DeleteLotTimeTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.LotTimeType.name(), SecurityRoles.Delete.name())
                        )))
                )));
    ...
    protected BaseResult execute() {
        ...
        if(lotType != null) {
            ...
            LotTimeType lotTimeType = inventoryControl.getLotTimeTypeByNameForUpdate(lotType, lotTimeTypeName);
