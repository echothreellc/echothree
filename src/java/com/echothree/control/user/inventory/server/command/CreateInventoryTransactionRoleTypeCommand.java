...
@Dependent
public class CreateInventoryTransactionRoleTypeCommand
        extends BaseSimpleCommand<CreateInventoryTransactionRoleTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(List.of(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), List.of(
                        new SecurityRoleDefinition(SecurityRoleGroups.InventoryTransactionRoleType.name(), SecurityRoles.Create.name())
                ))
        ));
    ...
    /** Creates a new instance of CreateInventoryTransactionRoleTypeCommand */
    public CreateInventoryTransactionRoleTypeCommand() {
        super(COMMAND_SECURITY_DEFINITION, FORM_FIELD_DEFINITIONS, false);
    }
    
    @Override
    protected BaseResult execute() {
        var result = InventoryResultFactory.getCreateInventoryTransactionRoleTypeResult();
        ...
        if(!hasExecutionErrors()) {
            ...
            inventoryTransactionRoleType = inventoryTransactionRoleTypeLogic.createInventoryTransactionRoleType(this, inventoryTransactionType,
                    inventoryTransactionRoleTypeName, isDefault, sortOrder, getPreferredLanguage(), description, partyPK);
        }

        if(inventoryTransactionRoleType != null) {
            result.setEntityRef(inventoryTransactionRoleType.getPrimaryKey().getEntityRef());
            result.setInventoryTransactionTypeName(inventoryTransactionType.getLastDetail().getInventoryTransactionTypeName());
            result.setInventoryTransactionRoleTypeName(inventoryTransactionRoleType.getLastDetail().getInventoryTransactionRoleTypeName());
        }
