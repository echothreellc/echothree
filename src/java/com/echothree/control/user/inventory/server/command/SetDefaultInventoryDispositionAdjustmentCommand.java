...
import com.echothree.control.user.inventory.common.form.SetDefaultInventoryDispositionAdjustmentForm;
...
@Dependent
public class SetDefaultInventoryDispositionAdjustmentCommand
        extends BaseSimpleCommand<SetDefaultInventoryDispositionAdjustmentForm> {
    ...
    /** Creates a new instance of SetDefaultInventoryDispositionAdjustmentCommand */
    public SetDefaultInventoryDispositionAdjustmentCommand() {
        super(COMMAND_SECURITY_DEFINITION, FORM_FIELD_DEFINITIONS, false);
    }
    
    @Override
    protected BaseResult execute() {
        var inventoryDispositionAdjustment = inventoryDispositionAdjustmentLogic.getInventoryDispositionAdjustmentByNameForUpdate(this,
                form.getInventoryTransactionTypeName(), form.getInventoryDispositionName(),
                form.getInventoryDispositionAdjustmentName());

        if(!hasExecutionErrors()) {
            var inventoryDispositionAdjustmentDetailValue = inventoryDispositionAdjustmentControl
                    .getInventoryDispositionAdjustmentDetailValueForUpdate(inventoryDispositionAdjustment);

            inventoryDispositionAdjustmentDetailValue.setIsDefault(true);
            inventoryDispositionAdjustmentControl.updateInventoryDispositionAdjustmentFromValue(
                    inventoryDispositionAdjustmentDetailValue, getPartyPK());
        }
