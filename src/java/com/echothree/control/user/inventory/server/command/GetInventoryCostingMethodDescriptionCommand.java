...
import com.echothree.control.user.inventory.common.form.GetInventoryCostingMethodDescriptionForm;
...
@Dependent
public class GetInventoryCostingMethodDescriptionCommand
        extends BaseSimpleCommand<GetInventoryCostingMethodDescriptionForm> {
    ...
    /** Creates a new instance of GetInventoryCostingMethodDescriptionCommand */
    public GetInventoryCostingMethodDescriptionCommand() {
        super(COMMAND_SECURITY_DEFINITION, FORM_FIELD_DEFINITIONS, true);
    }

    @Override
    protected BaseResult execute() {
        var result = InventoryResultFactory.getGetInventoryCostingMethodDescriptionResult();
        ...
        if(inventoryCostingMethod != null) {
            ...
            if(language != null) {
                var inventoryCostingMethodDescription = inventoryCostingMethodControl.getInventoryCostingMethodDescription(inventoryCostingMethod, language);
