...
import com.echothree.control.user.inventory.remote.form.DeleteAllocationPriorityForm;
...
public class DeleteAllocationPriorityCommand
    ...
    public DeleteAllocationPriorityCommand(UserVisitPK userVisitPK, DeleteAllocationPriorityForm form) {
