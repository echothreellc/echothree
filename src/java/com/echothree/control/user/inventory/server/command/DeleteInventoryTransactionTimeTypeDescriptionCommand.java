...
import com.echothree.control.user.inventory.common.form.DeleteInventoryTransactionTimeTypeDescriptionForm;
...
@Dependent
public class DeleteInventoryTransactionTimeTypeDescriptionCommand
        extends BaseSimpleCommand<DeleteInventoryTransactionTimeTypeDescriptionForm> {
    ...
    /** Creates a new instance of DeleteInventoryTransactionTimeTypeDescriptionCommand */
    public DeleteInventoryTransactionTimeTypeDescriptionCommand() {
            ...
            if(!hasExecutionErrors()) {
                ...
                if(!hasExecutionErrors()) {
                    ...
                    if(inventoryTransactionTimeTypeDescription != null) {
                        inventoryTransactionTimeControl.deleteInventoryTransactionTimeTypeDescription(inventoryTransactionTimeTypeDescription,
                                getPartyPK());
                    } else {
