...
import com.echothree.control.user.inventory.common.form.GetInventoryCostingMethodDescriptionsForm;
...
@Dependent
public class GetInventoryCostingMethodDescriptionsCommand
        extends BaseSimpleCommand<GetInventoryCostingMethodDescriptionsForm> {
    ...
    /** Creates a new instance of GetInventoryCostingMethodDescriptionsCommand */
    public GetInventoryCostingMethodDescriptionsCommand() {
        super(COMMAND_SECURITY_DEFINITION, FORM_FIELD_DEFINITIONS, false);
    }

    @Override
    protected BaseResult execute() {
        var result = InventoryResultFactory.getGetInventoryCostingMethodDescriptionsResult();
        ...
        if(inventoryCostingMethod != null) {
            ...
            result.setInventoryCostingMethodDescriptions(inventoryCostingMethodControl.getInventoryCostingMethodDescriptionTransfersByInventoryCostingMethod(getUserVisit(), inventoryCostingMethod));
        } else {
