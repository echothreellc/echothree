...
import com.echothree.control.user.inventory.common.form.GetInventoryLocationForm;
...
@Dependent
public class GetInventoryLocationCommand
        extends BaseSingleEntityCommand<InventoryLocation, GetInventoryLocationForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(List.of(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), List.of(
                        new SecurityRoleDefinition(SecurityRoleGroups.InventoryLocation.name(), SecurityRoles.Review.name())
                ))
        ));
    ...
    /** Creates a new instance of GetInventoryLocationCommand */
    public GetInventoryLocationCommand() {
        super(COMMAND_SECURITY_DEFINITION, FORM_FIELD_DEFINITIONS, true);
    }

    @Override
    protected InventoryLocation getEntity() {
    ...
    @Override
    protected BaseResult getResult(InventoryLocation inventoryLocation) {
        var result = InventoryResultFactory.getGetInventoryLocationResult();

        if(inventoryLocation != null) {
            result.setInventoryLocation(inventoryLocationControl.getInventoryLocationTransfer(getUserVisit(), inventoryLocation));
        }
