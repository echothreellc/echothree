...
import com.echothree.control.user.inventory.common.form.GetInventoryDispositionDescriptionForm;
...
@Dependent
public class GetInventoryDispositionDescriptionCommand
        extends BaseSingleEntityCommand<InventoryDispositionDescription, GetInventoryDispositionDescriptionForm> {
    ...
    /** Creates a new instance of GetInventoryDispositionDescriptionCommand */
    public GetInventoryDispositionDescriptionCommand() {
        super(COMMAND_SECURITY_DEFINITION, FORM_FIELD_DEFINITIONS, true);
    }
    
    @Override
    protected InventoryDispositionDescription getEntity() {
        ...
        if(!hasExecutionErrors()) {
            ...
            if(!hasExecutionErrors()) {
                ...
                if(!hasExecutionErrors()) {
                    inventoryDispositionDescription = inventoryDispositionControl.getInventoryDispositionDescription(
    ...
    @Override
    protected BaseResult getResult(InventoryDispositionDescription inventoryDispositionDescription) {
        var result = InventoryResultFactory.getGetInventoryDispositionDescriptionResult();
