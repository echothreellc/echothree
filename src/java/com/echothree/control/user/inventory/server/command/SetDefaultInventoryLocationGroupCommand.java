...
public class SetDefaultInventoryLocationGroupCommand
    ...
    protected BaseResult execute() {
        ...
        if(warehouse != null) {
            ...
            var inventoryLocationGroupDetailValue = inventoryLocationGroupControl.getInventoryLocationGroupDetailValueByNameForUpdate(warehouseParty, inventoryLocationGroupName);

            if(inventoryLocationGroupDetailValue != null) {
                inventoryLocationGroupDetailValue.setIsDefault(true);
                inventoryLocationGroupControl.updateInventoryLocationGroupFromValue(inventoryLocationGroupDetailValue, getPartyPK());
            } else {
