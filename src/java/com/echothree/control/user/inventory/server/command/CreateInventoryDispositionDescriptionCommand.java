...
import com.echothree.control.user.inventory.common.form.CreateInventoryDispositionDescriptionForm;
...
@Dependent
public class CreateInventoryDispositionDescriptionCommand
        extends BaseSimpleCommand<CreateInventoryDispositionDescriptionForm> {
    ...
    /** Creates a new instance of CreateInventoryDispositionDescriptionCommand */
    public CreateInventoryDispositionDescriptionCommand() {
            ...
            if(!hasExecutionErrors()) {
                ...
                if(!hasExecutionErrors()) {
                    ...
                    if(inventoryDispositionDescription == null) {
                        ...
                        inventoryDispositionControl.createInventoryDispositionDescription(inventoryDisposition, language,
                                description, getPartyPK());
                    } else {
                        addExecutionError(ExecutionErrors.DuplicateInventoryDispositionDescription.name(), inventoryTransactionTypeName,
