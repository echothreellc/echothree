...
import com.echothree.control.user.inventory.remote.form.DeleteInventoryLocationGroupDescriptionForm;
...
public class DeleteInventoryLocationGroupDescriptionCommand
        extends BaseSimpleCommand<DeleteInventoryLocationGroupDescriptionForm> {
    ...
    protected BaseResult execute() {
        ...
        if(warehouse != null) {
            ...
            if(inventoryLocationGroup != null) {
                ...
                if(language != null) {
                    InventoryLocationGroupDescription inventoryLocationGroupDescription = inventoryControl.getInventoryLocationGroupDescriptionForUpdate(inventoryLocationGroup, language);
