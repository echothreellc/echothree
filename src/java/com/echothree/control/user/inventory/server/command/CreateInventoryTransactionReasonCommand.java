...
@Dependent
public class CreateInventoryTransactionReasonCommand
        extends BaseSimpleCommand<CreateInventoryTransactionReasonForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(List.of(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), List.of(
                        new SecurityRoleDefinition(SecurityRoleGroups.InventoryTransactionReason.name(), SecurityRoles.Create.name())
                ))
        ));
    ...
    /** Creates a new instance of CreateInventoryTransactionReasonCommand */
    public CreateInventoryTransactionReasonCommand() {
        super(COMMAND_SECURITY_DEFINITION, FORM_FIELD_DEFINITIONS, false);
    }
    
    @Override
    protected BaseResult execute() {
        var result = InventoryResultFactory.getCreateInventoryTransactionReasonResult();
        ...
        if(!hasExecutionErrors()) {
            ...
            if(!hasExecutionErrors()) {
                ...
                inventoryTransactionReason = inventoryTransactionReasonLogic.createInventoryTransactionReason(this, inventoryTransactionType,
                        inventoryTransactionReasonName, inventoryDisposition, isDefault, sortOrder, getPreferredLanguage(), description, partyPK);
            }
        }

        if(inventoryTransactionReason != null) {
            result.setEntityRef(inventoryTransactionReason.getPrimaryKey().getEntityRef());
            result.setInventoryTransactionTypeName(inventoryTransactionType.getLastDetail().getInventoryTransactionTypeName());
            result.setInventoryTransactionReasonName(inventoryTransactionReason.getLastDetail().getInventoryTransactionReasonName());
        }
