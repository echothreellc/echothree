...
import com.echothree.control.user.inventory.common.form.DeleteLotTypeDescriptionForm;
...
public class DeleteLotTypeDescriptionCommand
        extends BaseSimpleCommand<DeleteLotTypeDescriptionForm> {
    ...
    /** Creates a new instance of DeleteLotTypeDescriptionCommand */
    public DeleteLotTypeDescriptionCommand(UserVisitPK userVisitPK, DeleteLotTypeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(lotType != null) {
            ...
            if(language != null) {
                LotTypeDescription lotTypeDescription = inventoryControl.getLotTypeDescriptionForUpdate(lotType, language);
                
                if(lotTypeDescription != null) {
                    inventoryControl.deleteLotTypeDescription(lotTypeDescription, getPartyPK());
                } else {
