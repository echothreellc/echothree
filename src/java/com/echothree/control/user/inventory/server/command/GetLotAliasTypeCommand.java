...
import com.echothree.control.user.inventory.common.form.GetLotAliasTypeForm;
...
public class GetLotAliasTypeCommand
    ...
    public GetLotAliasTypeCommand(UserVisitPK userVisitPK, GetLotAliasTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(lotAliasType != null) {
            ...
            sendEventUsingNames(lotAliasType.getPrimaryKey(), EventTypes.READ, null, null, getPartyPK());
        } else {
