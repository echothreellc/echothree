...
import com.echothree.control.user.inventory.common.form.GetInventoryAdjustmentTypeDescriptionForm;
...
public class GetInventoryAdjustmentTypeDescriptionCommand
        extends BaseSimpleCommand<GetInventoryAdjustmentTypeDescriptionForm> {
    ...
    /** Creates a new instance of GetInventoryAdjustmentTypeDescriptionCommand */
    public GetInventoryAdjustmentTypeDescriptionCommand() {
    ...
    protected BaseResult execute() {
        ...
        var result = InventoryResultFactory.getGetInventoryAdjustmentTypeDescriptionResult();
        ...
        if(inventoryAdjustmentType != null) {
            ...
            if(language != null) {
                var inventoryAdjustmentTypeDescription = inventoryAdjustmentTypeControl.getInventoryAdjustmentTypeDescription(inventoryAdjustmentType, language);
