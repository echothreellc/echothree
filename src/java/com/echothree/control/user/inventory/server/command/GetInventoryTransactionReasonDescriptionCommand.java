...
import com.echothree.control.user.inventory.common.form.GetInventoryTransactionReasonDescriptionForm;
...
@Dependent
public class GetInventoryTransactionReasonDescriptionCommand
        extends BaseSingleEntityCommand<InventoryTransactionReasonDescription, GetInventoryTransactionReasonDescriptionForm> {
    ...
    /** Creates a new instance of GetInventoryTransactionReasonDescriptionCommand */
    public GetInventoryTransactionReasonDescriptionCommand() {
        super(COMMAND_SECURITY_DEFINITION, FORM_FIELD_DEFINITIONS, true);
    }
    
    @Override
    protected InventoryTransactionReasonDescription getEntity() {
        ...
        if(!hasExecutionErrors()) {
            ...
            if(!hasExecutionErrors()) {
                ...
                if(!hasExecutionErrors()) {
                    inventoryTransactionReasonDescription = inventoryTransactionReasonControl.getInventoryTransactionReasonDescription(
    ...
    @Override
    protected BaseResult getResult(InventoryTransactionReasonDescription inventoryTransactionReasonDescription) {
        var result = InventoryResultFactory.getGetInventoryTransactionReasonDescriptionResult();
