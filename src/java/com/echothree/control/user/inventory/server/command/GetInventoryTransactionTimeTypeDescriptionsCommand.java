...
import com.echothree.control.user.inventory.common.form.GetInventoryTransactionTimeTypeDescriptionsForm;
...
@Dependent
public class GetInventoryTransactionTimeTypeDescriptionsCommand
        extends BasePaginatedMultipleEntitiesCommand<InventoryTransactionTimeTypeDescription,
                GetInventoryTransactionTimeTypeDescriptionsForm> {
    ...
    /** Creates a new instance of GetInventoryTransactionTimeTypeDescriptionsCommand */
    public GetInventoryTransactionTimeTypeDescriptionsCommand() {
    ...
    protected void handleForm() {
        ...
        if(!hasExecutionErrors()) {
            ...
            inventoryTransactionTimeType = inventoryTransactionTimeTypeLogic.getInventoryTransactionTimeTypeByName(this,
    ...
    protected Long getTotalEntities() {
        return hasExecutionErrors() ? null
                : inventoryTransactionTimeControl.countInventoryTransactionTimeTypeDescriptionsByInventoryTransactionTimeType(
                        inventoryTransactionTimeType);
    }

    @Override
    protected Collection<InventoryTransactionTimeTypeDescription> getEntities() {
        return hasExecutionErrors() ? null
                : inventoryTransactionTimeControl.getInventoryTransactionTimeTypeDescriptionsByInventoryTransactionTimeType(
                        inventoryTransactionTimeType);
    }

    @Override
    protected BaseResult getResult(Collection<InventoryTransactionTimeTypeDescription> entities) {
        var result = InventoryResultFactory.getGetInventoryTransactionTimeTypeDescriptionsResult();

        if(entities != null) {
            var userVisit = getUserVisit();

            result.setInventoryTransactionTimeType(
                    inventoryTransactionTimeControl.getInventoryTransactionTimeTypeTransfer(userVisit, inventoryTransactionTimeType));

            if(session.hasLimit(InventoryTransactionTimeTypeDescriptionFactory.class)) {
                result.setInventoryTransactionTimeTypeDescriptionCount(getTotalEntities());
            }

            result.setInventoryTransactionTimeTypeDescriptions(
                    inventoryTransactionTimeControl.getInventoryTransactionTimeTypeDescriptionTransfers(userVisit, entities));
        }
