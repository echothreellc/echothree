...
public class DeleteLotAliasTypeDescriptionCommand
        extends BaseSimpleCommand<DeleteLotAliasTypeDescriptionForm> {
    ...
    /** Creates a new instance of DeleteLotAliasTypeDescriptionCommand */
    public DeleteLotAliasTypeDescriptionCommand(UserVisitPK userVisitPK, DeleteLotAliasTypeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(lotAliasType != null) {
            ...
            if(language != null) {
                var lotAliasTypeDescription = lotAliasControl.getLotAliasTypeDescriptionForUpdate(lotAliasType, language);
