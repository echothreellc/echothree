...
import com.echothree.control.user.inventory.common.form.CreateInventoryTransactionRoleTypeDescriptionForm;
...
@Dependent
public class CreateInventoryTransactionRoleTypeDescriptionCommand
        extends BaseSimpleCommand<CreateInventoryTransactionRoleTypeDescriptionForm> {
    ...
    /** Creates a new instance of CreateInventoryTransactionRoleTypeDescriptionCommand */
    public CreateInventoryTransactionRoleTypeDescriptionCommand() {
            ...
            if(!hasExecutionErrors()) {
                ...
                if(!hasExecutionErrors()) {
                    ...
                    if(inventoryTransactionRoleTypeDescription == null) {
                        ...
                        inventoryTransactionRoleControl.createInventoryTransactionRoleTypeDescription(inventoryTransactionRoleType, language,
                                description, getPartyPK());
                    } else {
                        addExecutionError(ExecutionErrors.DuplicateInventoryTransactionRoleTypeDescription.name(), inventoryTransactionTypeName,
