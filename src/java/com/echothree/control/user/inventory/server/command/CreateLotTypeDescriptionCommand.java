...
public class CreateLotTypeDescriptionCommand
        extends BaseSimpleCommand<CreateLotTypeDescriptionForm> {
    ...
    /** Creates a new instance of CreateLotTypeDescriptionCommand */
    public CreateLotTypeDescriptionCommand(UserVisitPK userVisitPK, CreateLotTypeDescriptionForm form) {
        ...
        if(lotType != null) {
            ...
            if(language != null) {
                ...
                if(lotTypeDescription == null) {
                    ...
                    inventoryControl.createLotTypeDescription(lotType, language, description, getPartyPK());
                } else {
                    addExecutionError(ExecutionErrors.DuplicateLotTypeDescription.name(), lotTypeName, languageIsoName);
                }
            } else {
