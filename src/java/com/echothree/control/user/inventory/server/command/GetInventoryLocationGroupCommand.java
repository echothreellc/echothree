...
public class GetInventoryLocationGroupCommand
        extends BaseSimpleCommand<GetInventoryLocationGroupForm> {
    ...
    public GetInventoryLocationGroupCommand(UserVisitPK userVisitPK, GetInventoryLocationGroupForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(warehouse != null) {
            ...
            if(inventoryLocationGroup != null) {
                ...
                sendEventUsingNames(inventoryLocationGroup.getPrimaryKey(), EventTypes.READ, null, null, getPartyPK());
            } else {
