...
import com.echothree.control.user.inventory.common.form.GetInventoryTransactionTimeTypeDescriptionForm;
...
@Dependent
public class GetInventoryTransactionTimeTypeDescriptionCommand
        extends BaseSingleEntityCommand<InventoryTransactionTimeTypeDescription, GetInventoryTransactionTimeTypeDescriptionForm> {
    ...
    /** Creates a new instance of GetInventoryTransactionTimeTypeDescriptionCommand */
    public GetInventoryTransactionTimeTypeDescriptionCommand() {
        super(COMMAND_SECURITY_DEFINITION, FORM_FIELD_DEFINITIONS, true);
    }
    
    @Override
    protected InventoryTransactionTimeTypeDescription getEntity() {
        ...
        if(!hasExecutionErrors()) {
            ...
            if(!hasExecutionErrors()) {
                ...
                if(!hasExecutionErrors()) {
                    inventoryTransactionTimeTypeDescription = inventoryTransactionTimeControl.getInventoryTransactionTimeTypeDescription(
    ...
    @Override
    protected BaseResult getResult(InventoryTransactionTimeTypeDescription inventoryTransactionTimeTypeDescription) {
        var result = InventoryResultFactory.getGetInventoryTransactionTimeTypeDescriptionResult();
