...
import com.echothree.control.user.inventory.remote.form.GetInventoryLocationGroupsForm;
import com.echothree.control.user.inventory.remote.result.GetInventoryLocationGroupsResult;
...
public class GetInventoryLocationGroupsCommand
        extends BaseSimpleCommand<GetInventoryLocationGroupsForm> {
    ...
    public GetInventoryLocationGroupsCommand(UserVisitPK userVisitPK, GetInventoryLocationGroupsForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(warehouse != null) {
            ...
            result.setInventoryLocationGroups(inventoryControl.getInventoryLocationGroupTransfersByWarehouseParty(getUserVisit(), warehouseParty));
        } else {
