...
import com.echothree.control.user.inventory.common.form.DeleteInventoryCostingMethodDescriptionForm;
...
@Dependent
public class DeleteInventoryCostingMethodDescriptionCommand
        extends BaseSimpleCommand<DeleteInventoryCostingMethodDescriptionForm> {
    ...
    /** Creates a new instance of DeleteInventoryCostingMethodDescriptionCommand */
    public DeleteInventoryCostingMethodDescriptionCommand() {
    ...
    protected BaseResult execute() {
        ...
        if(inventoryCostingMethod != null) {
            ...
            if(language != null) {
                var inventoryCostingMethodDescription = inventoryCostingMethodControl.getInventoryCostingMethodDescriptionForUpdate(inventoryCostingMethod, language);

                if(inventoryCostingMethodDescription != null) {
                    inventoryCostingMethodControl.deleteInventoryCostingMethodDescription(inventoryCostingMethodDescription, getPartyPK());
                } else {
