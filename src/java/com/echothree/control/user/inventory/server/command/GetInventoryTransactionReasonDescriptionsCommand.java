...
import com.echothree.control.user.inventory.common.form.GetInventoryTransactionReasonDescriptionsForm;
...
@Dependent
public class GetInventoryTransactionReasonDescriptionsCommand
        extends BasePaginatedMultipleEntitiesCommand<InventoryTransactionReasonDescription,
                GetInventoryTransactionReasonDescriptionsForm> {
    ...
    /** Creates a new instance of GetInventoryTransactionReasonDescriptionsCommand */
    public GetInventoryTransactionReasonDescriptionsCommand() {
    ...
    protected void handleForm() {
        ...
        if(!hasExecutionErrors()) {
            ...
            inventoryTransactionReason = inventoryTransactionReasonLogic.getInventoryTransactionReasonByName(this,
    ...
    protected Long getTotalEntities() {
        return hasExecutionErrors() ? null
                : inventoryTransactionReasonControl.countInventoryTransactionReasonDescriptionsByInventoryTransactionReason(
                        inventoryTransactionReason);
    }

    @Override
    protected Collection<InventoryTransactionReasonDescription> getEntities() {
        return hasExecutionErrors() ? null
                : inventoryTransactionReasonControl.getInventoryTransactionReasonDescriptionsByInventoryTransactionReason(
                        inventoryTransactionReason);
    }

    @Override
    protected BaseResult getResult(Collection<InventoryTransactionReasonDescription> entities) {
        var result = InventoryResultFactory.getGetInventoryTransactionReasonDescriptionsResult();

        if(entities != null) {
            var userVisit = getUserVisit();

            result.setInventoryTransactionReason(
                    inventoryTransactionReasonControl.getInventoryTransactionReasonTransfer(userVisit, inventoryTransactionReason));

            if(session.hasLimit(InventoryTransactionReasonDescriptionFactory.class)) {
                result.setInventoryTransactionReasonDescriptionCount(getTotalEntities());
            }

            result.setInventoryTransactionReasonDescriptions(
                    inventoryTransactionReasonControl.getInventoryTransactionReasonDescriptionTransfers(userVisit, entities));
        }
