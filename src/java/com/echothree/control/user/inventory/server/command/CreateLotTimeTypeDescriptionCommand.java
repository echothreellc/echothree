...
public class CreateLotTimeTypeDescriptionCommand
        extends BaseSimpleCommand<CreateLotTimeTypeDescriptionForm> {
            ...
            if(lotTimeType != null) {
                ...
                if(language != null) {
                    ...
                    if(lotTimeTypeDescription == null) {
                        ...
                        addExecutionError(ExecutionErrors.DuplicateLotTimeTypeDescription.name(), lotTypeName, lotTimeTypeName, languageIsoName);
                    }
                } else {
