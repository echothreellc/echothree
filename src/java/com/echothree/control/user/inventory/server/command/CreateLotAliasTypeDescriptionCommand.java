...
public class CreateLotAliasTypeDescriptionCommand
        extends BaseSimpleCommand<CreateLotAliasTypeDescriptionForm> {
    ...
    /** Creates a new instance of CreateLotAliasTypeDescriptionCommand */
    public CreateLotAliasTypeDescriptionCommand(UserVisitPK userVisitPK, CreateLotAliasTypeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(lotAliasType != null) {
            ...
            if(language != null) {
                var lotAliasTypeDescription = lotAliasControl.getLotAliasTypeDescription(lotAliasType, language);
