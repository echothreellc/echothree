...
import com.echothree.control.user.inventory.remote.form.SetDefaultLotTypeForm;
...
public class SetDefaultLotTypeCommand
        extends BaseSimpleCommand<SetDefaultLotTypeForm> {
    ...
    /** Creates a new instance of SetDefaultLotTypeCommand */
    public SetDefaultLotTypeCommand(UserVisitPK userVisitPK, SetDefaultLotTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(lotTypeDetailValue != null) {
            lotTypeDetailValue.setIsDefault(Boolean.TRUE);
            inventoryControl.updateLotTypeFromValue(lotTypeDetailValue, getPartyPK());
        } else {
