...
import com.echothree.control.user.inventory.common.form.GetLotTimeTypeForm;
import com.echothree.control.user.inventory.common.result.GetLotTimeTypeResult;
...
public class GetLotTimeTypeCommand
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.LotTimeType.name(), SecurityRoles.Review.name())
                        )))
                )));
    ...
    public GetLotTimeTypeCommand(UserVisitPK userVisitPK, GetLotTimeTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(lotTimeType != null) {
            ...
            sendEventUsingNames(lotTimeType.getPrimaryKey(), EventTypes.READ, null, null, getPartyPK());
        } else {
