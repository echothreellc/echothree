...
public interface InventoryCostingPoolSpec
        extends CompanySpec, PartySpec, ItemSpec, InventoryConditionSpec {

    // Nothing additional beyond CompanySpec, PartySpec, ItemSpec, InventoryConditionSpec
