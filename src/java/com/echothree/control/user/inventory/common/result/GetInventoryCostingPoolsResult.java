...
public interface GetInventoryCostingPoolsResult
        extends BaseResult {
    ...
    Long getInventoryCostingPoolCount();
    void setInventoryCostingPoolCount(Long inventoryCostingPoolCount);

    List<InventoryCostingPoolTransfer> getInventoryCostingPools();
    void setInventoryCostingPools(List<InventoryCostingPoolTransfer> inventoryCostingPools);
