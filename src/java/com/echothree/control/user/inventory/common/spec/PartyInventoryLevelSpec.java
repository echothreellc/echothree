...
public interface PartyInventoryLevelSpec
        extends PartySpec, CompanySpec, WarehouseSpec, ItemSpec, InventoryConditionSpec {
    
    // Nothing additional beyond PartySpec, CompanySpec, WarehouseSpec, ItemSpec, InventoryConditionSpec
