...
public interface CreateInventoryTransactionTypeResult
        extends InventoryTransactionTypeSpec, EntityRefSpec, BaseResult {
    
    // Nothing additional beyond InventoryTransactionTypeSpec, EntityRefSpec, BaseResult
