...
public interface GetInventoryLocationsResult
        extends BaseResult {

    LocationTransfer getLocation();
    void setLocation(LocationTransfer location);

    PartyTransfer getOwnerParty();
    void setOwnerParty(PartyTransfer ownerParty);
    ...
    Long getInventoryLocationCount();
    void setInventoryLocationCount(Long inventoryLocationCount);

    List<InventoryLocationTransfer> getInventoryLocations();
    void setInventoryLocations(List<InventoryLocationTransfer> inventoryLocations);
