...
public interface CreateLotAliasTypeDescriptionForm
        extends LotAliasTypeDescriptionSpec, LotAliasTypeDescriptionEdit {
    
    // Nothing additional beyond LotAliasTypeDescriptionSpec, LotAliasTypeDescriptionEdit
