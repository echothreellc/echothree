...
public interface EditInventoryTransactionReasonResult
        extends BaseEditResult<InventoryTransactionReasonEdit> {

    InventoryTransactionReasonTransfer getInventoryTransactionReason();
    void setInventoryTransactionReason(InventoryTransactionReasonTransfer inventoryTransactionReason);
