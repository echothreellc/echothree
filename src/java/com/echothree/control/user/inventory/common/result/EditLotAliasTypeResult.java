...
public interface EditLotAliasTypeResult
        extends BaseEditResult<LotAliasTypeEdit> {
    
    LotAliasTypeTransfer getLotAliasType();
    void setLotAliasType(LotAliasTypeTransfer lotAliasType);
