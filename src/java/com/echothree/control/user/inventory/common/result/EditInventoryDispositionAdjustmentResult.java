...
public interface EditInventoryDispositionAdjustmentResult
        extends BaseEditResult<InventoryDispositionAdjustmentEdit> {

    InventoryDispositionAdjustmentTransfer getInventoryDispositionAdjustment();
    void setInventoryDispositionAdjustment(InventoryDispositionAdjustmentTransfer inventoryDispositionAdjustment);
