...
public interface GetInventoryLocationBucketsResult
        extends BaseResult {
    ...
    Long getInventoryLocationBucketCount();
    void setInventoryLocationBucketCount(Long inventoryLocationBucketCount);

    List<InventoryLocationBucketTransfer> getInventoryLocationBuckets();
    void setInventoryLocationBuckets(List<InventoryLocationBucketTransfer> inventoryLocationBuckets);
