...
public interface EditInventoryDispositionDescriptionResult
        extends BaseEditResult<InventoryDispositionDescriptionEdit> {

    InventoryDispositionDescriptionTransfer getInventoryDispositionDescription();
    void setInventoryDispositionDescription(InventoryDispositionDescriptionTransfer inventoryDisposition);
