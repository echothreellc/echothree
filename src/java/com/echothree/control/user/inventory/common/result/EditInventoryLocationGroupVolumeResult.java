...
public interface EditInventoryLocationGroupVolumeResult
        extends BaseEditResult<InventoryLocationGroupVolumeEdit> {
    
    InventoryLocationGroupVolumeTransfer getInventoryLocationGroupVolume();
    void setInventoryLocationGroupVolume(InventoryLocationGroupVolumeTransfer inventoryLocationGroupVolume);
