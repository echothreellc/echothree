...
public interface EditInventoryCostingMethodDescriptionResult
        extends BaseEditResult<InventoryCostingMethodDescriptionEdit> {

    InventoryCostingMethodDescriptionTransfer getInventoryCostingMethodDescription();
    void setInventoryCostingMethodDescription(InventoryCostingMethodDescriptionTransfer inventoryCostingMethod);
