...
public interface GetInventoryLocationGroupChoicesForm
        extends WarehouseSpec {
    
    String getDefaultInventoryLocationGroupChoice();
    void setDefaultInventoryLocationGroupChoice(String defaultInventoryLocationGroupChoice);
