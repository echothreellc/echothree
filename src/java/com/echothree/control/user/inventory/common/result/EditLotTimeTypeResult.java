...
public interface EditLotTimeTypeResult
        extends BaseEditResult<LotTimeTypeEdit> {

    LotTimeTypeTransfer getLotTimeType();
    void setLotTimeType(LotTimeTypeTransfer lotTimeType);
