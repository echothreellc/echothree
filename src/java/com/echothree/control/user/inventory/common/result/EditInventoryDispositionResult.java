...
public interface EditInventoryDispositionResult
        extends BaseEditResult<InventoryDispositionEdit> {

    InventoryDispositionTransfer getInventoryDisposition();
    void setInventoryDisposition(InventoryDispositionTransfer inventoryDisposition);
