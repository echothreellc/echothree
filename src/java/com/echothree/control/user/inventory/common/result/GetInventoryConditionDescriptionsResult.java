...
public interface GetInventoryConditionDescriptionsResult
        extends BaseResult {
    
    InventoryConditionTransfer getInventoryCondition();
    void setInventoryCondition(InventoryConditionTransfer inventoryCondition);
    
    List<InventoryConditionDescriptionTransfer> getInventoryConditionDescriptions();
    void setInventoryConditionDescriptions(List<InventoryConditionDescriptionTransfer> inventoryConditionDescriptions);
