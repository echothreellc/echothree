...
public interface CreateInventoryConditionResult
        extends InventoryConditionSpec, EntityRefSpec, BaseResult {
    
    // Nothing additional beyond InventoryConditionSpec, EntityRefSpec, BaseResult
