...
public interface GetInventoryBucketTypeDescriptionsResult
        extends BaseResult {
    ...
    List<InventoryBucketTypeDescriptionTransfer> getInventoryBucketTypeDescriptions();
    void setInventoryBucketTypeDescriptions(List<InventoryBucketTypeDescriptionTransfer> inventoryBucketTypeDescriptions);
