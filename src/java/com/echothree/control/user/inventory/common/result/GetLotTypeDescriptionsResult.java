...
public interface GetLotTypeDescriptionsResult
        extends BaseResult {
    
    LotTypeTransfer getLotType();
    void setLotType(LotTypeTransfer lotType);
    
    List<LotTypeDescriptionTransfer> getLotTypeDescriptions();
    void setLotTypeDescriptions(List<LotTypeDescriptionTransfer> lotTypeDescriptions);
