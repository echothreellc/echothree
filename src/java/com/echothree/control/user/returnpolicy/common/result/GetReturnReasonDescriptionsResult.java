...
public interface GetReturnReasonDescriptionsResult
        extends BaseResult {
    
    ReturnReasonTransfer getReturnReason();
    void setReturnReason(ReturnReasonTransfer returnReason);
    
    List<ReturnReasonDescriptionTransfer> getReturnReasonDescriptions();
    void setReturnReasonDescriptions(List<ReturnReasonDescriptionTransfer> returnReasonDescriptions);
