...
public interface CreateReturnPolicyTranslationForm
        extends ReturnPolicyTranslationSpec, ReturnPolicyTranslationEdit {
    
    // Nothing additional beyond ReturnPolicyTranslationSpec, ReturnPolicyTranslationEdit
