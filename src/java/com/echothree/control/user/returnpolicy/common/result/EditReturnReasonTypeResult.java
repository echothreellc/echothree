...
public interface EditReturnReasonTypeResult
        extends BaseEditResult<ReturnReasonTypeEdit> {
    
    ReturnReasonTypeTransfer getReturnReasonType();
    void setReturnReasonType(ReturnReasonTypeTransfer returnReasonType);
