...
public interface EditReturnReasonDescriptionResult
        extends BaseEditResult<ReturnReasonDescriptionEdit> {
    
    ReturnReasonDescriptionTransfer getReturnReasonDescription();
    void setReturnReasonDescription(ReturnReasonDescriptionTransfer returnReasonDescription);
