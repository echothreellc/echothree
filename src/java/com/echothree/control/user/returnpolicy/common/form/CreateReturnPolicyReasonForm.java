...
public interface CreateReturnPolicyReasonForm
        extends ReturnPolicyReasonSpec, ReturnPolicyReasonEdit {
    
    // Nothing additional beyond ReturnPolicyReasonSpec, ReturnPolicyReasonEdit
