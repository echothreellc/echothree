...
public interface EditReturnPolicyTranslationResult
        extends BaseEditResult<ReturnPolicyTranslationEdit> {
    
    ReturnPolicyTranslationTransfer getReturnPolicyTranslation();
    void setReturnPolicyTranslation(ReturnPolicyTranslationTransfer returnPolicyTranslation);
