...
public class CreateReturnKindDescriptionCommand
        extends BaseSimpleCommand<CreateReturnKindDescriptionForm> {
    ...
    /** Creates a new instance of CreateReturnKindDescriptionCommand */
    public CreateReturnKindDescriptionCommand(UserVisitPK userVisitPK, CreateReturnKindDescriptionForm form) {
        ...
        if(returnKind != null) {
            ...
            if(language != null) {
                ...
                if(returnKindDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateReturnKindDescription.name());
                }
            } else {
