...
import com.echothree.control.user.returnpolicy.remote.form.DeleteReturnTypeForm;
...
public class DeleteReturnTypeCommand
        extends BaseSimpleCommand<DeleteReturnTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                    new SecurityRoleDefinition(SecurityRoleGroups.ReturnType.name(), SecurityRoles.Delete.name())
                    )))
                )));
