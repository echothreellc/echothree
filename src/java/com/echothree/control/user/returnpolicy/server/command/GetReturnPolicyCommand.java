...
import com.echothree.control.user.returnpolicy.remote.form.GetReturnPolicyForm;
import com.echothree.control.user.returnpolicy.remote.result.GetReturnPolicyResult;
...
public class GetReturnPolicyCommand
        extends BaseSimpleCommand<GetReturnPolicyForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                    new SecurityRoleDefinition(SecurityRoleGroups.ReturnPolicy.name(), SecurityRoles.Review.name())
                    )))
                )));
    ...
    public GetReturnPolicyCommand(UserVisitPK userVisitPK, GetReturnPolicyForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetReturnPolicyResult result = ReturnPolicyResultFactory.getGetReturnPolicyResult();
