...
public class CreateReturnTypeDescriptionCommand
        extends BaseSimpleCommand<CreateReturnTypeDescriptionForm> {
            ...
            if(returnType != null) {
                ...
                if(language != null) {
                    ...
                    if(returnTypeDescription == null) {
                        ...
                        addExecutionError(ExecutionErrors.DuplicateReturnTypeDescription.name());
                    }
                } else {
                    addExecutionError(ExecutionErrors.UnknownLanguageIsoName.name(), returnKindName, returnTypeName, languageIsoName);
                }
            } else {
