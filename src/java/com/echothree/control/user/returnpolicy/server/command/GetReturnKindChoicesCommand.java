...
import com.echothree.control.user.returnpolicy.remote.form.GetReturnKindChoicesForm;
import com.echothree.control.user.returnpolicy.remote.result.GetReturnKindChoicesResult;
...
public class GetReturnKindChoicesCommand
        extends BaseSimpleCommand<GetReturnKindChoicesForm> {
    ...
    static {
        ...
        FORM_FIELD_DEFINITIONS = Collections.unmodifiableList(Arrays.asList(
                new FieldDefinition("DefaultReturnKindChoice", FieldType.ENTITY_NAME, false, null, null),
