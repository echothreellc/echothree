...
import com.echothree.control.user.returnpolicy.common.form.DeleteReturnReasonTypeForm;
...
public class DeleteReturnReasonTypeCommand
        extends BaseSimpleCommand<DeleteReturnReasonTypeForm> {
    ...
    /** Creates a new instance of DeleteReturnReasonTypeCommand */
    public DeleteReturnReasonTypeCommand(UserVisitPK userVisitPK, DeleteReturnReasonTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(returnKind != null) {
            ...
            if(returnReason != null) {
                ...
                if(returnType != null) {
                    ReturnReasonType returnReasonType = returnPolicyControl.getReturnReasonTypeForUpdate(returnReason, returnType);
                    
                    if(returnReasonType != null) {
                        returnPolicyControl.deleteReturnReasonType(returnReasonType, getPartyPK());
                    } else {
