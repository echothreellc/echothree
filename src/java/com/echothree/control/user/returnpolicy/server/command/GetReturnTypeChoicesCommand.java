...
import com.echothree.control.user.returnpolicy.remote.form.GetReturnTypeChoicesForm;
import com.echothree.control.user.returnpolicy.remote.result.GetReturnTypeChoicesResult;
...
public class GetReturnTypeChoicesCommand
        extends BaseSimpleCommand<GetReturnTypeChoicesForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                    new SecurityRoleDefinition(SecurityRoleGroups.ReturnType.name(), SecurityRoles.Choices.name())
                    )))
                )));

        FORM_FIELD_DEFINITIONS = Collections.unmodifiableList(Arrays.asList(
                new FieldDefinition("ReturnKindName", FieldType.ENTITY_NAME, true, null, null),
                new FieldDefinition("DefaultReturnTypeChoice", FieldType.ENTITY_NAME, false, null, null),
                new FieldDefinition("AllowNullChoice", FieldType.BOOLEAN, true, null, null)
                ));
    }
    
    /** Creates a new instance of GetReturnTypeChoicesCommand */
    public GetReturnTypeChoicesCommand(UserVisitPK userVisitPK, GetReturnTypeChoicesForm form) {
