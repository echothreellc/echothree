...
public class CreateReturnReasonCommand
        extends BaseSimpleCommand<CreateReturnReasonForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                    new SecurityRoleDefinition(SecurityRoleGroups.ReturnReason.name(), SecurityRoles.Create.name())
                    )))
                )));
    ...
    /** Creates a new instance of CreateReturnReasonCommand */
    public CreateReturnReasonCommand(UserVisitPK userVisitPK, CreateReturnReasonForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(returnKind != null) {
            ...
            if(returnReason == null) {
                ...
                returnReason = returnPolicyControl.createReturnReason(returnKind, returnReasonName, isDefault, sortOrder, partyPK);
