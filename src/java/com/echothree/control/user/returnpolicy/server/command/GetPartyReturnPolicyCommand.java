...
import com.echothree.control.user.returnpolicy.remote.form.GetPartyReturnPolicyForm;
import com.echothree.control.user.returnpolicy.remote.result.GetPartyReturnPolicyResult;
...
public class GetPartyReturnPolicyCommand
        extends BaseSimpleCommand<GetPartyReturnPolicyForm> {
    ...
    public GetPartyReturnPolicyCommand(UserVisitPK userVisitPK, GetPartyReturnPolicyForm form) {
