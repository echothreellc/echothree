...
import com.echothree.control.user.returnpolicy.remote.form.CreateReturnKindForm;
...
public class CreateReturnKindCommand
        extends BaseSimpleCommand<CreateReturnKindForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                    new SecurityRoleDefinition(SecurityRoleGroups.ReturnKind.name(), SecurityRoles.Create.name())
                    )))
                )));
    ...
    public CreateReturnKindCommand(UserVisitPK userVisitPK, CreateReturnKindForm form) {
