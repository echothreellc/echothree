...
@Dependent
public class CreateReturnReasonTypeCommand
        extends BaseSimpleCommand<CreateReturnReasonTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                    new SecurityRoleDefinition(SecurityRoleGroups.ReturnReasonType.name(), SecurityRoles.Create.name())
                    )))
                )));
            ...
            if(returnReason != null) {
                ...
                if(returnType != null) {
                    ...
                    if(returnReasonType == null) {
                        ...
                        addExecutionError(ExecutionErrors.DuplicateReturnReasonType.name());
                    }
                } else {
