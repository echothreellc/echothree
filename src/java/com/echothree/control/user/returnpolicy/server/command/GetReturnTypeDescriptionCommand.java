...
import com.echothree.control.user.returnpolicy.remote.form.GetReturnTypeDescriptionForm;
import com.echothree.control.user.returnpolicy.remote.result.GetReturnTypeDescriptionResult;
...
public class GetReturnTypeDescriptionCommand
        extends BaseSimpleCommand<GetReturnTypeDescriptionForm> {
    ...
    /** Creates a new instance of GetReturnTypeDescriptionCommand */
    public GetReturnTypeDescriptionCommand(UserVisitPK userVisitPK, GetReturnTypeDescriptionForm form) {
