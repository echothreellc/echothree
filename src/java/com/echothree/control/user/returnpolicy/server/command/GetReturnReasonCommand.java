...
public class GetReturnReasonCommand
    ...
    public GetReturnReasonCommand(UserVisitPK userVisitPK, GetReturnReasonForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(returnKind != null) {
            ...
            if(returnReason != null) {
                ...
                sendEventUsingNames(returnReason.getPrimaryKey(), EventTypes.READ, null, null, getPartyPK());
            } else {
