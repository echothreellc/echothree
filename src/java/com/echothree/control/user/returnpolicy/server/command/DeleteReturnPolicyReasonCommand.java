...
import com.echothree.control.user.returnpolicy.common.form.DeleteReturnPolicyReasonForm;
...
public class DeleteReturnPolicyReasonCommand
        extends BaseSimpleCommand<DeleteReturnPolicyReasonForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                    new SecurityRoleDefinition(SecurityRoleGroups.ReturnPolicyReason.name(), SecurityRoles.Delete.name())
                    )))
                )));
    ...
    /** Creates a new instance of DeleteReturnPolicyReasonCommand */
    public DeleteReturnPolicyReasonCommand(UserVisitPK userVisitPK, DeleteReturnPolicyReasonForm form) {
        ...
        if(returnKind != null) {
            ...
            if(returnPolicy != null) {
                ...
                if(returnReason != null) {
                    ReturnPolicyReason returnPolicyReason = returnPolicyControl.getReturnPolicyReasonForUpdate(returnPolicy,
                            returnReason);
                    
                    if(returnPolicyReason != null) {
                        returnPolicyControl.deleteReturnPolicyReason(returnPolicyReason, getPartyPK());
                    } else {
