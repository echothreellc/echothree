    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                    new SecurityRoleDefinition(SecurityRoleGroups.ReturnTypeShippingMethod.name(), SecurityRoles.Create.name())
                    )))
                )));
                    ...
                    if(shipmentType != null) {
                        ...
                        if(shipmentTypeShippingMethod != null) {
                            ...
                            if(returnTypeShippingMethod == null) {
                                ...
                                addExecutionError(ExecutionErrors.DuplicateReturnTypeShippingMethod.name());
                            }
                        } else {
