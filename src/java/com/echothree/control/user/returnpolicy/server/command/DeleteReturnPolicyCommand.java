...
import com.echothree.control.user.returnpolicy.common.form.DeleteReturnPolicyForm;
...
public class DeleteReturnPolicyCommand
        extends BaseSimpleCommand<DeleteReturnPolicyForm> {
    ...
    /** Creates a new instance of DeleteReturnPolicyCommand */
    public DeleteReturnPolicyCommand(UserVisitPK userVisitPK, DeleteReturnPolicyForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(returnKind != null) {
            ...
            ReturnPolicy returnPolicy = returnPolicyControl.getReturnPolicyByNameForUpdate(returnKind, returnPolicyName);
            
            if(returnPolicy != null) {
                ReturnPolicyLogic returnPolicyLogic = ReturnPolicyLogic.getInstance();

                returnPolicyLogic.checkDeleteReturnPolicy(this, returnPolicy);

                if(!hasExecutionErrors()) {
                    returnPolicyLogic.deleteReturnPolicy(returnPolicy, getPartyPK());
                }
            } else {
