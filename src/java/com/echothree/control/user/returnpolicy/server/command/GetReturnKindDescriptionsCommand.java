...
public class GetReturnKindDescriptionsCommand
        extends BaseSimpleCommand<GetReturnKindDescriptionsForm> {
    ...
    /** Creates a new instance of GetReturnKindDescriptionsCommand */
    public GetReturnKindDescriptionsCommand(UserVisitPK userVisitPK, GetReturnKindDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(returnKind != null) {
            ...
            result.setReturnKindDescriptions(returnPolicyControl.getReturnKindDescriptionTransfersByReturnKind(getUserVisit(), returnKind));
        } else {
