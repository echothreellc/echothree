...
public class CreateReturnReasonDescriptionCommand
        extends BaseSimpleCommand<CreateReturnReasonDescriptionForm> {
    ...
    /** Creates a new instance of CreateReturnReasonDescriptionCommand */
    public CreateReturnReasonDescriptionCommand(UserVisitPK userVisitPK, CreateReturnReasonDescriptionForm form) {
            ...
            if(returnReason != null) {
                ...
                if(language != null) {
                    ...
                    if(returnReasonDescription == null) {
                        ...
                        addExecutionError(ExecutionErrors.DuplicateReturnReasonDescription.name());
                    }
                } else {
