...
import com.echothree.control.user.returnpolicy.remote.form.GetReturnReasonTypesForm;
import com.echothree.control.user.returnpolicy.remote.result.GetReturnReasonTypesResult;
...
public class GetReturnReasonTypesCommand
    ...
    protected BaseResult execute() {
        ...
        int parameterCount = (returnReasonName != null? 1: 0) + (returnTypeName != null? 1: 0);
