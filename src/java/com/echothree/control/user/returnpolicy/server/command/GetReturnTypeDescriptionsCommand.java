...
import com.echothree.control.user.returnpolicy.remote.form.GetReturnTypeDescriptionsForm;
import com.echothree.control.user.returnpolicy.remote.result.GetReturnTypeDescriptionsResult;
...
public class GetReturnTypeDescriptionsCommand
        extends BaseSimpleCommand<GetReturnTypeDescriptionsForm> {
    ...
    /** Creates a new instance of GetReturnTypeDescriptionsCommand */
    public GetReturnTypeDescriptionsCommand(UserVisitPK userVisitPK, GetReturnTypeDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(returnKind != null) {
            ...
            if(returnType != null) {
                ...
                result.setReturnTypeDescriptions(returnPolicyControl.getReturnTypeDescriptionTransfersByReturnType(getUserVisit(), returnType));
            } else {
