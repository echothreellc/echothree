...
public class GetReturnTypeCommand
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                    new SecurityRoleDefinition(SecurityRoleGroups.ReturnType.name(), SecurityRoles.Review.name())
                    )))
                )));
    ...
    public GetReturnTypeCommand(UserVisitPK userVisitPK, GetReturnTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(returnKind != null) {
            ...
            if(returnType != null) {
                ...
                sendEventUsingNames(returnType.getPrimaryKey(), EventTypes.READ, null, null, getPartyPK());
            } else {
