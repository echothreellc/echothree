...
public class DeleteReturnTypeDescriptionCommand
        extends BaseSimpleCommand<DeleteReturnTypeDescriptionForm> {
    ...
    /** Creates a new instance of DeleteReturnTypeDescriptionCommand */
    public DeleteReturnTypeDescriptionCommand(UserVisitPK userVisitPK, DeleteReturnTypeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(returnKind != null) {
            ...
            if(returnType != null) {
                ...
                if(language != null) {
                    ReturnTypeDescription returnTypeDescription = returnPolicyControl.getReturnTypeDescriptionForUpdate(returnType, language);
                    
                    if(returnTypeDescription != null) {
                        returnPolicyControl.deleteReturnTypeDescription(returnTypeDescription, getPartyPK());
                    } else {
