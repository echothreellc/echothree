...
public class GetReturnReasonDescriptionsCommand
        extends BaseSimpleCommand<GetReturnReasonDescriptionsForm> {
    ...
    /** Creates a new instance of GetReturnReasonDescriptionsCommand */
    public GetReturnReasonDescriptionsCommand(UserVisitPK userVisitPK, GetReturnReasonDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        var result = ReturnPolicyResultFactory.getGetReturnReasonDescriptionsResult();
        ...
        if(returnKind != null) {
            ...
            if(returnReason != null) {
                ...
                result.setReturnReasonDescriptions(returnPolicyControl.getReturnReasonDescriptionTransfersByReturnReason(getUserVisit(), returnReason));
            } else {
