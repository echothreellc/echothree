...
import com.echothree.control.user.returnpolicy.remote.form.DeletePartyReturnPolicyForm;
        ...
        if(party != null) {
            ...
            if(returnKind != null) {
                ...
                if(returnPolicy != null) {
                    PartyReturnPolicy partyReturnPolicy = returnPolicyControl.getPartyReturnPolicyForUpdate(party, returnPolicy);
