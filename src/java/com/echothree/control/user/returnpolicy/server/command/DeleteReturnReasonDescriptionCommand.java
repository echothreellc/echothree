...
import com.echothree.control.user.returnpolicy.common.form.DeleteReturnReasonDescriptionForm;
...
public class DeleteReturnReasonDescriptionCommand
        extends BaseSimpleCommand<DeleteReturnReasonDescriptionForm> {
    ...
    /** Creates a new instance of DeleteReturnReasonDescriptionCommand */
    public DeleteReturnReasonDescriptionCommand(UserVisitPK userVisitPK, DeleteReturnReasonDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(returnKind != null) {
            ...
            if(returnReason != null) {
                ...
                if(language != null) {
                    ReturnReasonDescription returnReasonDescription = returnPolicyControl.getReturnReasonDescriptionForUpdate(returnReason, language);
                    
                    if(returnReasonDescription != null) {
                        returnPolicyControl.deleteReturnReasonDescription(returnReasonDescription, getPartyPK());
                    } else {
