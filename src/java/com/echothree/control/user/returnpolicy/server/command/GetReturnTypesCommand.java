...
import com.echothree.control.user.returnpolicy.remote.form.GetReturnTypesForm;
import com.echothree.control.user.returnpolicy.remote.result.GetReturnTypesResult;
...
public class GetReturnTypesCommand
        extends BaseSimpleCommand<GetReturnTypesForm> {
    ...
    protected BaseResult execute() {
        ...
        GetReturnTypesResult result = ReturnPolicyResultFactory.getGetReturnTypesResult();
        ...
        if(returnKind != null) {
            ...
            result.setReturnTypes(returnPolicyControl.getReturnTypeTransfersByReturnKind(getUserVisit(), returnKind));
        } else {
