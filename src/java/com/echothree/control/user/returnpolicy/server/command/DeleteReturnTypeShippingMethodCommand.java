...
@Dependent
public class DeleteReturnTypeShippingMethodCommand
        extends BaseSimpleCommand<DeleteReturnTypeShippingMethodForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                    new SecurityRoleDefinition(SecurityRoleGroups.ReturnTypeShippingMethod.name(), SecurityRoles.Delete.name())
                    )))
                )));
            ...
            if(returnType != null) {
                ...
                if(shippingMethod != null) {
                    ...
                    if(returnTypeShippingMethod != null) {
                        returnPolicyControl.deleteReturnTypeShippingMethod(returnTypeShippingMethod, getPartyPK());
                    } else {
