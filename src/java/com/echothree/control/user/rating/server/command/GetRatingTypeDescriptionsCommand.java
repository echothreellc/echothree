...
public class GetRatingTypeDescriptionsCommand
        extends BaseSimpleCommand<GetRatingTypeDescriptionsForm> {
    ...
    /** Creates a new instance of GetRatingTypeDescriptionsCommand */
    public GetRatingTypeDescriptionsCommand(UserVisitPK userVisitPK, GetRatingTypeDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetRatingTypeDescriptionsResult result = RatingResultFactory.getGetRatingTypeDescriptionsResult();
        ...
        if(componentVendor != null) {
            ...
            if(entityType != null) {
                ...
                if(ratingType != null) {
                    ...
                    result.setRatingTypeDescriptions(ratingControl.getRatingTypeDescriptionTransfers(getUserVisit(), ratingType));
                } else {
