...
public class CreateRatingTypeListItemDescriptionCommand
        extends BaseSimpleCommand<CreateRatingTypeListItemDescriptionForm> {
                    ...
                    if(ratingTypeListItem != null) {
                        ...
                        if(language != null) {
                            ...
                            if(ratingTypeListItemDescription == null) {
                                ...
                                addExecutionError(ExecutionErrors.DuplicateRatingTypeListItemDescription.name());
                            }
                        } else {
