...
public interface EditRatingTypeDescriptionResult
        extends BaseEditResult<RatingTypeDescriptionEdit> {
    
    RatingTypeDescriptionTransfer getRatingTypeDescription();
    void setRatingTypeDescription(RatingTypeDescriptionTransfer ratingTypeDescription);
