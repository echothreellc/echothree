...
public interface GetRatingTypeDescriptionsResult
        extends BaseResult {
    
    RatingTypeTransfer getRatingType();
    void setRatingType(RatingTypeTransfer ratingType);
    
    List<RatingTypeDescriptionTransfer> getRatingTypeDescriptions();
    void setRatingTypeDescriptions(List<RatingTypeDescriptionTransfer> ratingTypeDescriptions);
