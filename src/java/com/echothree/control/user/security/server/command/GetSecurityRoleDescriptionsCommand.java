...
import com.echothree.control.user.security.remote.form.GetSecurityRoleDescriptionsForm;
import com.echothree.control.user.security.remote.result.GetSecurityRoleDescriptionsResult;
...
public class GetSecurityRoleDescriptionsCommand
    ...
    public GetSecurityRoleDescriptionsCommand(UserVisitPK userVisitPK, GetSecurityRoleDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetSecurityRoleDescriptionsResult result = SecurityResultFactory.getGetSecurityRoleDescriptionsResult();
