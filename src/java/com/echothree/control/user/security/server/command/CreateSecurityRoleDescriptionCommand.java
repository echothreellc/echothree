...
@Dependent
public class CreateSecurityRoleDescriptionCommand
        extends BaseSimpleCommand<CreateSecurityRoleDescriptionForm> {
            ...
            if(securityRole != null) {
                ...
                if(language != null) {
                    ...
                    if(securityRoleDescription == null) {
                        ...
                        addExecutionError(ExecutionErrors.DuplicateSecurityRoleDescription.name(), securityRoleGroupName, securityRoleName, languageIsoName);
                    }
                } else {
