...
import com.echothree.control.user.security.remote.form.GetSecurityRoleGroupChoicesForm;
import com.echothree.control.user.security.remote.result.GetSecurityRoleGroupChoicesResult;
...
public class GetSecurityRoleGroupChoicesCommand
        extends BaseSimpleCommand<GetSecurityRoleGroupChoicesForm> {
    ...
    /** Creates a new instance of GetSecurityRoleGroupChoicesCommand */
    public GetSecurityRoleGroupChoicesCommand(UserVisitPK userVisitPK, GetSecurityRoleGroupChoicesForm form) {
    ...
    protected BaseResult execute() {
        ...
        result.setSecurityRoleGroupChoices(securityControl.getSecurityRoleGroupChoices(defaultSecurityRoleGroupChoice, getPreferredLanguage(), allowNullChoice));
