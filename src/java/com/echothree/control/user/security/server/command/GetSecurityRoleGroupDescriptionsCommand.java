...
import com.echothree.control.user.security.remote.form.GetSecurityRoleGroupDescriptionsForm;
import com.echothree.control.user.security.remote.result.GetSecurityRoleGroupDescriptionsResult;
...
public class GetSecurityRoleGroupDescriptionsCommand
        extends BaseSimpleCommand<GetSecurityRoleGroupDescriptionsForm> {
    ...
    public GetSecurityRoleGroupDescriptionsCommand(UserVisitPK userVisitPK, GetSecurityRoleGroupDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetSecurityRoleGroupDescriptionsResult result = SecurityResultFactory.getGetSecurityRoleGroupDescriptionsResult();
        ...
        if(securityRoleGroup != null) {
            ...
            result.setSecurityRoleGroupDescriptions(securityControl.getSecurityRoleGroupDescriptionTransfersBySecurityRoleGroup(getUserVisit(), securityRoleGroup));
        } else {
