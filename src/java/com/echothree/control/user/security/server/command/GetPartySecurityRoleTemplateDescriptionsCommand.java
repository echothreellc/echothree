...
public class GetPartySecurityRoleTemplateDescriptionsCommand
        extends BaseSimpleCommand<GetPartySecurityRoleTemplateDescriptionsForm> {
    ...
    /** Creates a new instance of GetPartySecurityRoleTemplateDescriptionsCommand */
    public GetPartySecurityRoleTemplateDescriptionsCommand(UserVisitPK userVisitPK, GetPartySecurityRoleTemplateDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(partySecurityRoleTemplate != null) {
            ...
            result.setPartySecurityRoleTemplateDescriptions(securityControl.getPartySecurityRoleTemplateDescriptionTransfersByPartySecurityRoleTemplate(getUserVisit(),
