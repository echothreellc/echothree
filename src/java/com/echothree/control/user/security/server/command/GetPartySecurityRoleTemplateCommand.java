...
public class GetPartySecurityRoleTemplateCommand
    ...
    public GetPartySecurityRoleTemplateCommand(UserVisitPK userVisitPK, GetPartySecurityRoleTemplateForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetPartySecurityRoleTemplateResult result = SecurityResultFactory.getGetPartySecurityRoleTemplateResult();
