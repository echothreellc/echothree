...
public class DeletePartySecurityRoleTemplateDescriptionCommand
        extends BaseSimpleCommand<DeletePartySecurityRoleTemplateDescriptionForm> {
    ...
    /** Creates a new instance of DeletePartySecurityRoleTemplateDescriptionCommand */
    public DeletePartySecurityRoleTemplateDescriptionCommand(UserVisitPK userVisitPK, DeletePartySecurityRoleTemplateDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(partySecurityRoleTemplate != null) {
            ...
            if(language != null) {
                PartySecurityRoleTemplateDescription partySecurityRoleTemplateDescription = securityControl.getPartySecurityRoleTemplateDescriptionForUpdate(partySecurityRoleTemplate, language);
                
                if(partySecurityRoleTemplateDescription != null) {
                    securityControl.deletePartySecurityRoleTemplateDescription(partySecurityRoleTemplateDescription, getPartyPK());
                } else {
