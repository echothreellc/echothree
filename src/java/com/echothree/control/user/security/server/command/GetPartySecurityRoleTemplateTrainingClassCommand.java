...
import com.echothree.control.user.security.remote.form.GetPartySecurityRoleTemplateTrainingClassForm;
import com.echothree.control.user.security.remote.result.GetPartySecurityRoleTemplateTrainingClassResult;
...
public class GetPartySecurityRoleTemplateTrainingClassCommand
    ...
    public GetPartySecurityRoleTemplateTrainingClassCommand(UserVisitPK userVisitPK, GetPartySecurityRoleTemplateTrainingClassForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetPartySecurityRoleTemplateTrainingClassResult result = SecurityResultFactory.getGetPartySecurityRoleTemplateTrainingClassResult();
        ...
        if(partySecurityRoleTemplate != null) {
            ...
            if(trainingClass != null) {
                PartySecurityRoleTemplateTrainingClass partySecurityRoleTemplateTrainingClass = securityControl.getPartySecurityRoleTemplateTrainingClass(partySecurityRoleTemplate,
                        trainingClass);
