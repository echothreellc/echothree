...
import com.echothree.control.user.security.remote.form.GetPartySecurityRoleTemplateRoleForm;
import com.echothree.control.user.security.remote.result.GetPartySecurityRoleTemplateRoleResult;
...
public class GetPartySecurityRoleTemplateRoleCommand
    ...
    public GetPartySecurityRoleTemplateRoleCommand(UserVisitPK userVisitPK, GetPartySecurityRoleTemplateRoleForm form) {
