...
public class GetSecurityRoleDescriptionCommand
        extends BaseSimpleCommand<GetSecurityRoleDescriptionForm> {
    ...
    public GetSecurityRoleDescriptionCommand(UserVisitPK userVisitPK, GetSecurityRoleDescriptionForm form) {
