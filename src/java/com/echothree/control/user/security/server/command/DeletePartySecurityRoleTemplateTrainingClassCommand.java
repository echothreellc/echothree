...
public class DeletePartySecurityRoleTemplateTrainingClassCommand
        extends BaseSimpleCommand<DeletePartySecurityRoleTemplateTrainingClassForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.PartySecurityRoleTemplateTrainingClass.name(), SecurityRoles.Delete.name())
                        )))
                )));
    ...
    public DeletePartySecurityRoleTemplateTrainingClassCommand(UserVisitPK userVisitPK, DeletePartySecurityRoleTemplateTrainingClassForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(partySecurityRoleTemplate != null) {
            ...
            if(trainingClass != null) {
                PartySecurityRoleTemplateTrainingClass partySecurityRoleTemplateTrainingClass = securityControl.getPartySecurityRoleTemplateTrainingClassForUpdate(partySecurityRoleTemplate, trainingClass);
