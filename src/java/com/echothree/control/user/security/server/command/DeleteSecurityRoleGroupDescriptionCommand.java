...
import com.echothree.control.user.security.common.form.DeleteSecurityRoleGroupDescriptionForm;
...
public class DeleteSecurityRoleGroupDescriptionCommand
        extends BaseSimpleCommand<DeleteSecurityRoleGroupDescriptionForm> {
    ...
    /** Creates a new instance of DeleteSecurityRoleGroupDescriptionCommand */
    public DeleteSecurityRoleGroupDescriptionCommand(UserVisitPK userVisitPK, DeleteSecurityRoleGroupDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(securityRoleGroup != null) {
            ...
            if(language != null) {
                SecurityRoleGroupDescription securityRoleGroupDescription = securityControl.getSecurityRoleGroupDescriptionForUpdate(securityRoleGroup, language);
                
                if(securityRoleGroupDescription != null) {
                    securityControl.deleteSecurityRoleGroupDescription(securityRoleGroupDescription, getPartyPK());
                } else {
