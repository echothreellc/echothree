...
import com.echothree.control.user.security.remote.form.CreateSecurityRoleForm;
...
public class CreateSecurityRoleCommand
        extends BaseSimpleCommand<CreateSecurityRoleForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.SecurityRole.name(), SecurityRoles.Create.name())
                        )))
                )));
    ...
    public CreateSecurityRoleCommand(UserVisitPK userVisitPK, CreateSecurityRoleForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(securityRoleGroup != null) {
            ...
            if(securityRole == null) {
                ...
                securityRole = securityControl.createSecurityRole(securityRoleGroup, securityRoleName, isDefault, sortOrder, partyPK);
                
                if(description != null) {
                    securityControl.createSecurityRoleDescription(securityRole, getPreferredLanguage(), description, partyPK);
                }
            } else {
                addExecutionError(ExecutionErrors.DuplicateSecurityRoleName.name(), securityRoleGroupName, securityRoleName);
            }
        } else {
