...
import com.echothree.control.user.security.remote.form.SetDefaultSecurityRoleForm;
...
public class SetDefaultSecurityRoleCommand
        extends BaseSimpleCommand<SetDefaultSecurityRoleForm> {
