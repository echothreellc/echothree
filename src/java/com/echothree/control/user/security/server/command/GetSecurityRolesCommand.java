...
public class GetSecurityRolesCommand
        extends BaseMultipleEntitiesCommand<SecurityRole, GetSecurityRolesForm> {
    ...
    protected Collection<SecurityRole> getEntities() {
        ...
        securityRoleGroup = SecurityRoleGroupLogic.getInstance().getSecurityRoleGroupByName(this, form.getSecurityRoleGroupName());
