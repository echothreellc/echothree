...
public class GetSecurityRolesCommand
        extends BaseSimpleCommand<GetSecurityRolesForm> {
    ...
    public GetSecurityRolesCommand(UserVisitPK userVisitPK, GetSecurityRolesForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetSecurityRolesResult result = SecurityResultFactory.getGetSecurityRolesResult();
        ...
        if(securityRoleGroup != null) {
            ...
            result.setSecurityRoles(securityControl.getSecurityRoleTransfersBySecurityRoleGroup(getUserVisit(), securityRoleGroup));
        } else {
