...
public class CreatePartySecurityRoleTemplateCommand
        extends BaseSimpleCommand<CreatePartySecurityRoleTemplateForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.PartySecurityRoleTemplate.name(), SecurityRoles.Create.name())
                        )))
                )));
    ...
    /** Creates a new instance of CreatePartySecurityRoleTemplateCommand */
    public CreatePartySecurityRoleTemplateCommand(UserVisitPK userVisitPK, CreatePartySecurityRoleTemplateForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(partySecurityRoleTemplate == null) {
            ...
            if(description != null) {
                securityControl.createPartySecurityRoleTemplateDescription(partySecurityRoleTemplate, getPreferredLanguage(),
