...
public class DeleteSecurityRoleDescriptionCommand
        extends BaseSimpleCommand<DeleteSecurityRoleDescriptionForm> {
    ...
    /** Creates a new instance of DeleteSecurityRoleDescriptionCommand */
    public DeleteSecurityRoleDescriptionCommand(UserVisitPK userVisitPK, DeleteSecurityRoleDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(securityRoleGroup != null) {
            ...
            if(securityRole != null) {
                ...
                if(language != null) {
                    SecurityRoleDescription securityRoleDescription = securityControl.getSecurityRoleDescriptionForUpdate(securityRole, language);
                    
                    if(securityRoleDescription != null) {
                        securityControl.deleteSecurityRoleDescription(securityRoleDescription, getPartyPK());
                    } else {
