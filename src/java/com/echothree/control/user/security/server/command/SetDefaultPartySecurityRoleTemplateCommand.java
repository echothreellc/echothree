...
import com.echothree.control.user.security.remote.form.SetDefaultPartySecurityRoleTemplateForm;
...
public class SetDefaultPartySecurityRoleTemplateCommand
        extends BaseSimpleCommand<SetDefaultPartySecurityRoleTemplateForm> {
    ...
    protected BaseResult execute() {
        ...
        PartySecurityRoleTemplateDetailValue partySecurityRoleTemplateDetailValue = securityControl.getPartySecurityRoleTemplateDetailValueByNameForUpdate(partySecurityRoleTemplateName);
