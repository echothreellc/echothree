...
import com.echothree.control.user.security.remote.form.CreateSecurityRoleGroupDescriptionForm;
...
public class CreateSecurityRoleGroupDescriptionCommand
        extends BaseSimpleCommand<CreateSecurityRoleGroupDescriptionForm> {
    ...
    /** Creates a new instance of CreateSecurityRoleGroupDescriptionCommand */
    public CreateSecurityRoleGroupDescriptionCommand(UserVisitPK userVisitPK, CreateSecurityRoleGroupDescriptionForm form) {
        ...
        if(securityRoleGroup != null) {
            ...
            if(language != null) {
                ...
                if(securityRoleGroupDescription == null) {
                    ...
                    securityControl.createSecurityRoleGroupDescription(securityRoleGroup, language, description, getPartyPK());
                } else {
                    addExecutionError(ExecutionErrors.DuplicateSecurityRoleGroupDescription.name(), securityRoleGroupName, languageIsoName);
                }
            } else {
