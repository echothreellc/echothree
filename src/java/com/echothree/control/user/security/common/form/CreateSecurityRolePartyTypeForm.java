...
public interface CreateSecurityRolePartyTypeForm
        extends SecurityRolePartyTypeSpec, SecurityRolePartyTypeEdit {
    
    // Nothing additional beyond SecurityRolePartyTypeSpec, SecurityRolePartyTypeEdit
