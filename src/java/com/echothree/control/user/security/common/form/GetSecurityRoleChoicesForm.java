...
public interface GetSecurityRoleChoicesForm
        extends SecurityRoleGroupSpec, WorkflowSpec {
    
    String getDefaultSecurityRoleChoice();
    void setDefaultSecurityRoleChoice(String defaultSecurityRoleChoice);
