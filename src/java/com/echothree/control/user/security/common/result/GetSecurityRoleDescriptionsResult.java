...
public interface GetSecurityRoleDescriptionsResult
        extends BaseResult {
    
    SecurityRoleTransfer getSecurityRole();
    void setSecurityRole(SecurityRoleTransfer securityRole);
    
    List<SecurityRoleDescriptionTransfer> getSecurityRoleDescriptions();
    void setSecurityRoleDescriptions(List<SecurityRoleDescriptionTransfer> securityRoleDescriptions);
