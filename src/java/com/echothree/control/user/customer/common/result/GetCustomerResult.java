...
public interface GetCustomerResult
    ...
    CustomerTransfer getCustomer();
    void setCustomer(CustomerTransfer customer);
    
    List<WishlistTransfer> getWishlists();
    void setWishlists(List<WishlistTransfer> wishlists);
