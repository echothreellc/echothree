...
public interface GetCustomerTypeDescriptionsResult
        extends BaseResult {
    
    CustomerTypeTransfer getCustomerType();
    void setCustomerType(CustomerTypeTransfer customerType);
    
    List<CustomerTypeDescriptionTransfer> getCustomerTypeDescriptions();
    void setCustomerTypeDescriptions(List<CustomerTypeDescriptionTransfer> customerTypeDescriptions);
