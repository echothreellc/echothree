...
public interface CreateCustomerTypeShippingMethodForm
        extends CustomerTypeShippingMethodSpec, CustomerTypeShippingMethodEdit {
    
    // Nothing additional beyond CustomerTypeShippingMethodSpec, CustomerTypeShippingMethodEdit
