...
public class GetCustomersCommand
        extends BaseMultipleEntitiesCommand<Customer, GetCustomersForm> {
    ...
    public GetCustomersCommand(UserVisitPK userVisitPK, GetCustomersForm form) {
    ...
    protected BaseResult getTransfers(Collection<Customer> entities) {
        ...
        if(entities != null) {
            ...
            if(session.hasLimit(CustomerFactory.class)) {
                result.setCustomerCount(customerControl.countCustomers());
            }
