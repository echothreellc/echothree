...
public class CustomerBean
    ...
    @Override
    public CommandResult<GetCustomersResult> getCustomers(UserVisitPK userVisitPK, GetCustomersForm form) {
        return CDI.current().select(GetCustomersCommand.class).get().run(userVisitPK, form);
    }

    @Override
    public CommandResult<GetCustomerResult> getCustomer(UserVisitPK userVisitPK, GetCustomerForm form) {
        return CDI.current().select(GetCustomerCommand.class).get().run(userVisitPK, form);
    }

    @Override
    public CommandResult<EditCustomerResult> editCustomer(UserVisitPK userVisitPK, EditCustomerForm form) {
        return CDI.current().select(EditCustomerCommand.class).get().run(userVisitPK, form);
    }
    
    @Override
    public CommandResult<GetCustomerStatusChoicesResult> getCustomerStatusChoices(UserVisitPK userVisitPK, GetCustomerStatusChoicesForm form) {
    ...
    @Override
    public CommandResult<GetCustomerCreditStatusChoicesResult> getCustomerCreditStatusChoices(UserVisitPK userVisitPK, GetCustomerCreditStatusChoicesForm form) {
    ...
    @Override
    public CommandResult<GetCustomerTypesResult> getCustomerTypes(UserVisitPK userVisitPK, GetCustomerTypesForm form) {
        return CDI.current().select(GetCustomerTypesCommand.class).get().run(userVisitPK, form);
    }
    
    @Override
    public CommandResult<GetCustomerTypeResult> getCustomerType(UserVisitPK userVisitPK, GetCustomerTypeForm form) {
        return CDI.current().select(GetCustomerTypeCommand.class).get().run(userVisitPK, form);
    }
    
    @Override
    public CommandResult<GetCustomerTypeChoicesResult> getCustomerTypeChoices(UserVisitPK userVisitPK, GetCustomerTypeChoicesForm form) {
    ...
    @Override
    public CommandResult<EditCustomerTypeResult> editCustomerType(UserVisitPK userVisitPK, EditCustomerTypeForm form) {
    ...
    @Override
    public CommandResult<GetCustomerTypeDescriptionsResult> getCustomerTypeDescriptions(UserVisitPK userVisitPK, GetCustomerTypeDescriptionsForm form) {
        return CDI.current().select(GetCustomerTypeDescriptionsCommand.class).get().run(userVisitPK, form);
    }
    
    @Override
    public CommandResult<EditCustomerTypeDescriptionResult> editCustomerTypeDescription(UserVisitPK userVisitPK, EditCustomerTypeDescriptionForm form) {
    ...
    @Override
    public CommandResult<GetCustomerTypePaymentMethodResult> getCustomerTypePaymentMethod(UserVisitPK userVisitPK, GetCustomerTypePaymentMethodForm form) {
        return CDI.current().select(GetCustomerTypePaymentMethodCommand.class).get().run(userVisitPK, form);
    }
    
    @Override
    public CommandResult<GetCustomerTypePaymentMethodsResult> getCustomerTypePaymentMethods(UserVisitPK userVisitPK, GetCustomerTypePaymentMethodsForm form) {
    ...
    @Override
    public CommandResult<GetCustomerTypeShippingMethodResult> getCustomerTypeShippingMethod(UserVisitPK userVisitPK, GetCustomerTypeShippingMethodForm form) {
        return CDI.current().select(GetCustomerTypeShippingMethodCommand.class).get().run(userVisitPK, form);
    }
    
    @Override
    public CommandResult<GetCustomerTypeShippingMethodsResult> getCustomerTypeShippingMethods(UserVisitPK userVisitPK, GetCustomerTypeShippingMethodsForm form) {
