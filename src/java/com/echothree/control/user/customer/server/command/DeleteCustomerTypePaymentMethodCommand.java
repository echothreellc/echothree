...
public class DeleteCustomerTypePaymentMethodCommand
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(List.of(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), List.of(
                        new SecurityRoleDefinition(SecurityRoleGroups.CustomerTypePaymentMethod.name(), SecurityRoles.Delete.name())
                ))
        ));
    ...
    protected BaseResult execute() {
        ...
        if(!hasExecutionErrors()) {
            ...
            if(!hasExecutionErrors()) {
                var customerTypePaymentMethod = customerControl.getCustomerTypePaymentMethodForUpdate(customerType,
                        paymentMethod);
