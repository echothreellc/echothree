...
public class DeleteCustomerTypeShippingMethodCommand
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(List.of(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), List.of(
                        new SecurityRoleDefinition(SecurityRoleGroups.CustomerTypeShippingMethod.name(), SecurityRoles.Delete.name())
                ))
        ));
    ...
    public DeleteCustomerTypeShippingMethodCommand() {
    ...
    protected BaseResult execute() {
        ...
        if(!hasExecutionErrors()) {
            ...
            if(!hasExecutionErrors()) {
                var customerTypeShippingMethod = customerControl.getCustomerTypeShippingMethodForUpdate(customerType,
                        shippingMethod);
