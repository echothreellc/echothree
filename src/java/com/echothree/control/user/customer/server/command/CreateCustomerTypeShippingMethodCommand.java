    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(List.of(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), List.of(
                        new SecurityRoleDefinition(SecurityRoleGroups.CustomerTypeShippingMethod.name(), SecurityRoles.Create.name())
                ))
        ));
        ...
        if(!hasExecutionErrors()) {
            ...
            if(!hasExecutionErrors()) {
                ...
                if(customerTypeShippingMethod == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateCustomerTypeShippingMethod.name(), customerTypeName, shippingMethodName);
                }
            }
        }
