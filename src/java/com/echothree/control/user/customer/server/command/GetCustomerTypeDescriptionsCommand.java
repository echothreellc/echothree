...
public class GetCustomerTypeDescriptionsCommand
        extends BaseSimpleCommand<GetCustomerTypeDescriptionsForm> {
    ...
    /** Creates a new instance of GetCustomerTypeDescriptionsCommand */
    public GetCustomerTypeDescriptionsCommand(UserVisitPK userVisitPK, GetCustomerTypeDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(customerType != null) {
            ...
            result.setCustomerTypeDescriptions(customerControl.getCustomerTypeDescriptionTransfers(getUserVisit(), customerType));
        } else {
