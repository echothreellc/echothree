...
public class CreateCustomerTypeDescriptionCommand
        extends BaseSimpleCommand<CreateCustomerTypeDescriptionForm> {
    ...
    /** Creates a new instance of CreateCustomerTypeDescriptionCommand */
    public CreateCustomerTypeDescriptionCommand(UserVisitPK userVisitPK, CreateCustomerTypeDescriptionForm form) {
        ...
        if(customerType != null) {
            ...
            if(language != null) {
                ...
                if(customerTypeDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateCustomerTypeDescription.name());
                }
            } else {
