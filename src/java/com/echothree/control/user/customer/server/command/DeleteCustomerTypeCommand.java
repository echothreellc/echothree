...
import com.echothree.control.user.customer.remote.form.DeleteCustomerTypeForm;
...
public class DeleteCustomerTypeCommand
        extends BaseSimpleCommand<DeleteCustomerTypeForm> {
    ...
    public DeleteCustomerTypeCommand(UserVisitPK userVisitPK, DeleteCustomerTypeForm form) {
