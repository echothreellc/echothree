...
public interface EditCustomerTypeDescriptionResult
        extends BaseEditResult<CustomerTypeDescriptionEdit> {
    
    CustomerTypeDescriptionTransfer getCustomerTypeDescription();
    void setCustomerTypeDescription(CustomerTypeDescriptionTransfer customerTypeDescription);
