...
public interface CreateCancellationPolicyReasonForm
        extends CancellationPolicyReasonSpec, CancellationPolicyReasonEdit {
    
    // Nothing additional beyond CancellationPolicyReasonSpec, CancellationPolicyReasonEdit
