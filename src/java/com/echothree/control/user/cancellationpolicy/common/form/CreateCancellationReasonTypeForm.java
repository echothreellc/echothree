...
public interface CreateCancellationReasonTypeForm
        extends CancellationReasonTypeSpec, CancellationReasonTypeEdit {
    
    // Nothing additional beyond CancellationReasonTypeSpec, CancellationReasonTypeEdit
