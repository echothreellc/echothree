...
public interface EditCancellationTypeDescriptionResult
        extends BaseEditResult<CancellationTypeDescriptionEdit> {
    
    CancellationTypeDescriptionTransfer getCancellationTypeDescription();
    void setCancellationTypeDescription(CancellationTypeDescriptionTransfer cancellationTypeDescription);
