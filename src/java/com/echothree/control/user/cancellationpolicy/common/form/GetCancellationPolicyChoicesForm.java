...
public interface GetCancellationPolicyChoicesForm
        extends CancellationKindSpec {
    
    String getDefaultCancellationPolicyChoice();
    void setDefaultCancellationPolicyChoice(String defaultCancellationPolicyChoice);
