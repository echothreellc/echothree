...
public interface DeleteCancellationKindDescriptionForm
        extends CancellationKindDescriptionSpec {
    
    // Nothing additional beyond CancellationKindDescriptionSpec
