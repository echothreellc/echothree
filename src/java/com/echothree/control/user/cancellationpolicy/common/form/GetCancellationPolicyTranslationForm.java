...
public interface GetCancellationPolicyTranslationForm
        extends CancellationPolicyTranslationSpec {
    
    // Nothing additional beyond CancellationPolicyTranslationSpec
