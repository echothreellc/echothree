...
public interface DeleteCancellationReasonDescriptionForm
        extends CancellationReasonDescriptionSpec {
    
    // Nothing additional beyond CancellationReasonDescriptionSpec
