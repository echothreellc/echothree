...
public interface GetCancellationKindDescriptionsResult
        extends BaseResult {
    
    CancellationKindTransfer getCancellationKind();
    void setCancellationKind(CancellationKindTransfer cancellationKind);
    
    List<CancellationKindDescriptionTransfer> getCancellationKindDescriptions();
    void setCancellationKindDescriptions(List<CancellationKindDescriptionTransfer> cancellationKindDescriptions);
