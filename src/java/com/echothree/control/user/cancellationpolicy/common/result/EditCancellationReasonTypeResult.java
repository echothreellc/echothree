...
public interface EditCancellationReasonTypeResult
        extends BaseEditResult<CancellationReasonTypeEdit> {
    
    CancellationReasonTypeTransfer getCancellationReasonType();
    void setCancellationReasonType(CancellationReasonTypeTransfer cancellationReasonType);
