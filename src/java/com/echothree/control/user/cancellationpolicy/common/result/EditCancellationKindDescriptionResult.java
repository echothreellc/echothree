...
public interface EditCancellationKindDescriptionResult
        extends BaseEditResult<CancellationKindDescriptionEdit> {
    
    CancellationKindDescriptionTransfer getCancellationKindDescription();
    void setCancellationKindDescription(CancellationKindDescriptionTransfer cancellationKindDescription);
