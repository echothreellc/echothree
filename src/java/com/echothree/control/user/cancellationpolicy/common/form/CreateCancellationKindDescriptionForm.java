...
public interface CreateCancellationKindDescriptionForm
        extends CancellationKindDescriptionSpec, CancellationKindDescriptionEdit {
    
    // Nothing additional beyond CancellationKindDescriptionSpec, CancellationKindDescriptionEdit
