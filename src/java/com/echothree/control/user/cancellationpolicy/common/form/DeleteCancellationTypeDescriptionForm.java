...
public interface DeleteCancellationTypeDescriptionForm
        extends CancellationTypeDescriptionSpec {
    
    // Nothing additional beyond CancellationTypeDescriptionSpec
