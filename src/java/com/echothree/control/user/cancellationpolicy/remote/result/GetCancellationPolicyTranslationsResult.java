...
public interface GetCancellationPolicyTranslationsResult
        extends BaseResult {
    
    CancellationPolicyTransfer getCancellationPolicy();
    void setCancellationPolicy(CancellationPolicyTransfer cancellationPolicy);
    
    List<CancellationPolicyTranslationTransfer> getCancellationPolicyTranslations();
    void setCancellationPolicyTranslations(List<CancellationPolicyTranslationTransfer> cancellationPolicyTranslations);
