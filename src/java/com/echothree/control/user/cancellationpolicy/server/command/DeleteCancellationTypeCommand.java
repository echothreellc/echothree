...
public class DeleteCancellationTypeCommand
        extends BaseSimpleCommand<DeleteCancellationTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.CancellationType.name(), SecurityRoles.Delete.name())
                        )))
                )));
    ...
    /** Creates a new instance of DeleteCancellationTypeCommand */
    public DeleteCancellationTypeCommand(UserVisitPK userVisitPK, DeleteCancellationTypeForm form) {
