...
public class GetCancellationTypeDescriptionsCommand
    ...
    public GetCancellationTypeDescriptionsCommand(UserVisitPK userVisitPK, GetCancellationTypeDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetCancellationTypeDescriptionsResult result = CancellationPolicyResultFactory.getGetCancellationTypeDescriptionsResult();
