...
import com.echothree.control.user.cancellationpolicy.remote.edit.CancellationKindDescriptionEdit;
import com.echothree.control.user.cancellationpolicy.remote.edit.CancellationPolicyEditFactory;
import com.echothree.control.user.cancellationpolicy.remote.form.EditCancellationKindDescriptionForm;
import com.echothree.control.user.cancellationpolicy.remote.result.CancellationPolicyResultFactory;
import com.echothree.control.user.cancellationpolicy.remote.result.EditCancellationKindDescriptionResult;
import com.echothree.control.user.cancellationpolicy.remote.spec.CancellationKindDescriptionSpec;
...
public class EditCancellationKindDescriptionCommand
    ...
    public EditCancellationKindDescriptionCommand(UserVisitPK userVisitPK, EditCancellationKindDescriptionForm form) {
