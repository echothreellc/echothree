...
public class CreateCancellationReasonCommand
        extends BaseSimpleCommand<CreateCancellationReasonForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.CancellationReason.name(), SecurityRoles.Create.name())
                        )))
                )));
    ...
    protected BaseResult execute() {
        ...
        if(cancellationKind != null) {
            ...
            if(cancellationReason == null) {
                ...
                cancellationReason = cancellationPolicyControl.createCancellationReason(cancellationKind, cancellationReasonName, isDefault, sortOrder, partyPK);
