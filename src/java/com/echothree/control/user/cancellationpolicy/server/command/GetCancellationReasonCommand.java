...
public class GetCancellationReasonCommand
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.CancellationReason.name(), SecurityRoles.Review.name())
                        )))
                )));
    ...
    public GetCancellationReasonCommand(UserVisitPK userVisitPK, GetCancellationReasonForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetCancellationReasonResult result = CancellationPolicyResultFactory.getGetCancellationReasonResult();
