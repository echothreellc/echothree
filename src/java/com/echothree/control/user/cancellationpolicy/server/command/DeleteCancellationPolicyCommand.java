...
import com.echothree.control.user.cancellationpolicy.common.form.DeleteCancellationPolicyForm;
...
public class DeleteCancellationPolicyCommand
        extends BaseSimpleCommand<DeleteCancellationPolicyForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.CancellationPolicy.name(), SecurityRoles.Delete.name())
                        )))
                )));
    ...
    public DeleteCancellationPolicyCommand(UserVisitPK userVisitPK, DeleteCancellationPolicyForm form) {
