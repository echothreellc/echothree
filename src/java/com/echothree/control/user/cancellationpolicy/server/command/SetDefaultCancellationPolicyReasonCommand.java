...
import com.echothree.control.user.cancellationpolicy.remote.form.SetDefaultCancellationPolicyReasonForm;
...
public class SetDefaultCancellationPolicyReasonCommand
    ...
    public SetDefaultCancellationPolicyReasonCommand(UserVisitPK userVisitPK, SetDefaultCancellationPolicyReasonForm form) {
        ...
        if(cancellationKind != null) {
            ...
            if(cancellationPolicy != null) {
                ...
                if(cancellationReason != null) {
                    CancellationPolicyReasonValue cancellationPolicyReasonValue = cancellationPolicyControl.getCancellationPolicyReasonValueForUpdate(cancellationPolicy,
                            cancellationReason);
