...
public class EditCancellationKindCommand
        extends BaseAbstractEditCommand<CancellationKindSpec, CancellationKindEdit, EditCancellationKindResult, CancellationKind, CancellationKind> {
    ...
    @Override
    public EditCancellationKindResult getResult() {
        return CancellationPolicyResultFactory.getEditCancellationKindResult();
    }

    @Override
    public CancellationKindEdit getEdit() {
        return CancellationPolicyEditFactory.getCancellationKindEdit();
    }

    @Override
    public CancellationKind getEntity(EditCancellationKindResult result) {
        return cancellationKindLogic.getCancellationKindByName(this, spec.getCancellationKindName(), editModeToEntityPermission(editMode));
    }

    @Override
    public CancellationKind getLockEntity(CancellationKind cancellationKind) {
        return cancellationKind;
    }

    @Override
    public void fillInResult(EditCancellationKindResult result, CancellationKind cancellationKind) {
        result.setCancellationKind(cancellationPolicyControl.getCancellationKindTransfer(getUserVisit(), cancellationKind));
    }

    @Override
    public void doLock(CancellationKindEdit edit, CancellationKind cancellationKind) {
    ...
    SequenceType cancellationSequenceType;

    @Override
    public void canUpdate(CancellationKind cancellationKind) {
        var cancellationKindName = edit.getCancellationKindName();
    ...
    @Override
    public void doUpdate(CancellationKind cancellationKind) {
