...
import com.echothree.control.user.cancellationpolicy.common.form.GetCancellationKindDescriptionsForm;
import com.echothree.control.user.cancellationpolicy.common.result.CancellationPolicyResultFactory;
import com.echothree.control.user.cancellationpolicy.common.result.GetCancellationKindDescriptionsResult;
...
public class GetCancellationKindDescriptionsCommand
        extends BaseSimpleCommand<GetCancellationKindDescriptionsForm> {
    ...
    public GetCancellationKindDescriptionsCommand(UserVisitPK userVisitPK, GetCancellationKindDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetCancellationKindDescriptionsResult result = CancellationPolicyResultFactory.getGetCancellationKindDescriptionsResult();
        ...
        if(cancellationKind != null) {
            ...
            result.setCancellationKindDescriptions(cancellationPolicyControl.getCancellationKindDescriptionTransfersByCancellationKind(getUserVisit(), cancellationKind));
        } else {
