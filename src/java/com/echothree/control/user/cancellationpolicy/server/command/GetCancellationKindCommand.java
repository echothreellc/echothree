...
import com.echothree.control.user.cancellationpolicy.remote.form.GetCancellationKindForm;
import com.echothree.control.user.cancellationpolicy.remote.result.CancellationPolicyResultFactory;
import com.echothree.control.user.cancellationpolicy.remote.result.GetCancellationKindResult;
...
public class GetCancellationKindCommand
        extends BaseSimpleCommand<GetCancellationKindForm> {
    ...
    protected BaseResult execute() {
        ...
        GetCancellationKindResult result = CancellationPolicyResultFactory.getGetCancellationKindResult();
