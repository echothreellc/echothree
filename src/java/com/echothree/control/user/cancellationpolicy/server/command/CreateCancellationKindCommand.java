...
public class CreateCancellationKindCommand
        extends BaseSimpleCommand<CreateCancellationKindForm> {
    ...
    static {
        ...
        FORM_FIELD_DEFINITIONS = Collections.unmodifiableList(Arrays.asList(
                ...
                new FieldDefinition("CancellationSequenceTypeName", FieldType.ENTITY_NAME, true, null, null),
    ...
    public CreateCancellationKindCommand(UserVisitPK userVisitPK, CreateCancellationKindForm form) {
