...
public class CreateCancellationKindDescriptionCommand
        extends BaseSimpleCommand<CreateCancellationKindDescriptionForm> {
        ...
        if(cancellationKind != null) {
            ...
            if(language != null) {
                ...
                if(cancellationKindDescription == null) {
                    ...
                    cancellationPolicyControl.createCancellationKindDescription(cancellationKind, language, description, getPartyPK());
                } else {
                    addExecutionError(ExecutionErrors.DuplicateCancellationKindDescription.name());
                }
            } else {
