...
import com.echothree.control.user.cancellationpolicy.remote.form.CreateCancellationReasonDescriptionForm;
...
public class CreateCancellationReasonDescriptionCommand
        extends BaseSimpleCommand<CreateCancellationReasonDescriptionForm> {
    ...
    /** Creates a new instance of CreateCancellationReasonDescriptionCommand */
    public CreateCancellationReasonDescriptionCommand(UserVisitPK userVisitPK, CreateCancellationReasonDescriptionForm form) {
            ...
            if(cancellationReason != null) {
                ...
                if(language != null) {
                    ...
                    if(cancellationReasonDescription == null) {
                        ...
                        addExecutionError(ExecutionErrors.DuplicateCancellationReasonDescription.name());
                    }
                } else {
