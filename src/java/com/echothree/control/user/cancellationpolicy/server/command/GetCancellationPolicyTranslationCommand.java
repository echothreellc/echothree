...
public class GetCancellationPolicyTranslationCommand
        extends BaseSimpleCommand<GetCancellationPolicyTranslationForm> {
    ...
    /** Creates a new instance of GetCancellationPolicyTranslationCommand */
    public GetCancellationPolicyTranslationCommand(UserVisitPK userVisitPK, GetCancellationPolicyTranslationForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetCancellationPolicyTranslationResult result = CancellationPolicyResultFactory.getGetCancellationPolicyTranslationResult();
