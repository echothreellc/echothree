...
import com.echothree.control.user.cancellationpolicy.common.form.SetDefaultCancellationReasonForm;
...
public class SetDefaultCancellationReasonCommand
        extends BaseSimpleCommand<SetDefaultCancellationReasonForm> {
    ...
    /** Creates a new instance of SetDefaultCancellationReasonCommand */
    public SetDefaultCancellationReasonCommand(UserVisitPK userVisitPK, SetDefaultCancellationReasonForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(cancellationKind != null) {
            ...
            if(cancellationReasonDetailValue != null) {
                ...
                cancellationPolicyControl.updateCancellationReasonFromValue(cancellationReasonDetailValue, getPartyPK());
            } else {
