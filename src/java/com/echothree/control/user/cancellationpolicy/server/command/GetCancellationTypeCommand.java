...
public class GetCancellationTypeCommand
    ...
    public GetCancellationTypeCommand(UserVisitPK userVisitPK, GetCancellationTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetCancellationTypeResult result = CancellationPolicyResultFactory.getGetCancellationTypeResult();
