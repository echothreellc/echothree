...
import com.echothree.control.user.cancellationpolicy.remote.form.GetCancellationPolicyTranslationsForm;
import com.echothree.control.user.cancellationpolicy.remote.result.CancellationPolicyResultFactory;
import com.echothree.control.user.cancellationpolicy.remote.result.GetCancellationPolicyTranslationsResult;
...
public class GetCancellationPolicyTranslationsCommand
        extends BaseSimpleCommand<GetCancellationPolicyTranslationsForm> {
    ...
    protected BaseResult execute() {
        ...
        if(cancellationKind != null) {
            ...
            if(cancellationPolicy != null) {
                ...
                result.setCancellationPolicyTranslations(cancellationPolicyControl.getCancellationPolicyTranslationTransfers(getUserVisit(), cancellationPolicy));
            } else {
