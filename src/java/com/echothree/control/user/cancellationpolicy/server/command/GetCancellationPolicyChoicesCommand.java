...
public class GetCancellationPolicyChoicesCommand
        extends BaseSimpleCommand<GetCancellationPolicyChoicesForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.CancellationPolicy.name(), SecurityRoles.Choices.name())
                        )))
                )));
        
        FORM_FIELD_DEFINITIONS = Collections.unmodifiableList(Arrays.asList(
                new FieldDefinition("CancellationKindName", FieldType.ENTITY_NAME, true, null, null),
                new FieldDefinition("DefaultCancellationPolicyChoice", FieldType.ENTITY_NAME, false, null, null),
                new FieldDefinition("AllowNullChoice", FieldType.BOOLEAN, true, null, null)
                ));
    }
    
    /** Creates a new instance of GetCancellationPolicyChoicesCommand */
    public GetCancellationPolicyChoicesCommand(UserVisitPK userVisitPK, GetCancellationPolicyChoicesForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetCancellationPolicyChoicesResult result = CancellationPolicyResultFactory.getGetCancellationPolicyChoicesResult();
        ...
        if(cancellationKind != null) {
            String defaultCancellationPolicyChoice = form.getDefaultCancellationPolicyChoice();
            boolean allowNullChoice = Boolean.parseBoolean(form.getAllowNullChoice());
            
            result.setCancellationPolicyChoices(cancellationPolicyControl.getCancellationPolicyChoices(defaultCancellationPolicyChoice, getPreferredLanguage(),
