...
import com.echothree.control.user.cancellationpolicy.remote.form.CreateCancellationPolicyReasonForm;
...
public class CreateCancellationPolicyReasonCommand
        extends BaseSimpleCommand<CreateCancellationPolicyReasonForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.CancellationPolicyReason.name(), SecurityRoles.Create.name())
                        )))
                )));
    ...
    /** Creates a new instance of CreateCancellationPolicyReasonCommand */
    public CreateCancellationPolicyReasonCommand(UserVisitPK userVisitPK, CreateCancellationPolicyReasonForm form) {
        ...
        if(cancellationKind != null) {
            ...
            if(cancellationPolicy != null) {
                ...
                if(cancellationReason != null) {
                    CancellationPolicyReason cancellationPolicyReason = cancellationPolicyControl.getCancellationPolicyReason(cancellationPolicy, cancellationReason);
                    
                    if(cancellationPolicyReason == null) {
                        Boolean isDefault = Boolean.valueOf(form.getIsDefault());
                        Integer sortOrder = Integer.valueOf(form.getSortOrder());
                        
                        cancellationPolicyControl.createCancellationPolicyReason(cancellationPolicy, cancellationReason, isDefault, sortOrder, getPartyPK());
                    } else {
