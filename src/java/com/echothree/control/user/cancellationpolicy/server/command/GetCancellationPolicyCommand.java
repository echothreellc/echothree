...
public class GetCancellationPolicyCommand
        extends BaseSimpleCommand<GetCancellationPolicyForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.CancellationPolicy.name(), SecurityRoles.Review.name())
                        )))
                )));
    ...
    public GetCancellationPolicyCommand(UserVisitPK userVisitPK, GetCancellationPolicyForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetCancellationPolicyResult result = CancellationPolicyResultFactory.getGetCancellationPolicyResult();
