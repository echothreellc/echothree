...
import com.echothree.control.user.cancellationpolicy.common.form.CreateCancellationTypeDescriptionForm;
...
public class CreateCancellationTypeDescriptionCommand
        extends BaseSimpleCommand<CreateCancellationTypeDescriptionForm> {
    ...
    /** Creates a new instance of CreateCancellationTypeDescriptionCommand */
    public CreateCancellationTypeDescriptionCommand(UserVisitPK userVisitPK, CreateCancellationTypeDescriptionForm form) {
            ...
            if(cancellationType != null) {
                ...
                if(language != null) {
                    ...
                    if(cancellationTypeDescription == null) {
                        ...
                        addExecutionError(ExecutionErrors.DuplicateCancellationTypeDescription.name());
                    }
                } else {
