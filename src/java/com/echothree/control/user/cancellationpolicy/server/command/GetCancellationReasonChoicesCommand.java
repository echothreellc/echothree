...
import com.echothree.control.user.cancellationpolicy.remote.form.GetCancellationReasonChoicesForm;
import com.echothree.control.user.cancellationpolicy.remote.result.CancellationPolicyResultFactory;
import com.echothree.control.user.cancellationpolicy.remote.result.GetCancellationReasonChoicesResult;
...
public class GetCancellationReasonChoicesCommand
    ...
    public GetCancellationReasonChoicesCommand(UserVisitPK userVisitPK, GetCancellationReasonChoicesForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetCancellationReasonChoicesResult result = CancellationPolicyResultFactory.getGetCancellationReasonChoicesResult();
        ...
        if(cancellationKind != null) {
            String defaultCancellationReasonChoice = form.getDefaultCancellationReasonChoice();
