...
import com.echothree.control.user.cancellationpolicy.remote.form.GetCancellationKindChoicesForm;
import com.echothree.control.user.cancellationpolicy.remote.result.CancellationPolicyResultFactory;
import com.echothree.control.user.cancellationpolicy.remote.result.GetCancellationKindChoicesResult;
...
public class GetCancellationKindChoicesCommand
        extends BaseSimpleCommand<GetCancellationKindChoicesForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.CancellationKind.name(), SecurityRoles.Choices.name())
                        )))
                )));
        
        FORM_FIELD_DEFINITIONS = Collections.unmodifiableList(Arrays.asList(
                new FieldDefinition("DefaultCancellationKindChoice", FieldType.ENTITY_NAME, false, null, null),
