...
public class GetCancellationReasonDescriptionsCommand
        extends BaseSimpleCommand<GetCancellationReasonDescriptionsForm> {
    ...
    public GetCancellationReasonDescriptionsCommand(UserVisitPK userVisitPK, GetCancellationReasonDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetCancellationReasonDescriptionsResult result = CancellationPolicyResultFactory.getGetCancellationReasonDescriptionsResult();
