...
import com.echothree.control.user.contactlist.remote.form.GetContactListDescriptionForm;
import com.echothree.control.user.contactlist.remote.result.ContactListResultFactory;
import com.echothree.control.user.contactlist.remote.result.GetContactListDescriptionResult;
...
public class GetContactListDescriptionCommand
        extends BaseSimpleCommand<GetContactListDescriptionForm> {
    ...
    /** Creates a new instance of GetContactListDescriptionCommand */
    public GetContactListDescriptionCommand(UserVisitPK userVisitPK, GetContactListDescriptionForm form) {
