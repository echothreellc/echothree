...
import com.echothree.control.user.contactlist.remote.form.CreateContactListTypeDescriptionForm;
...
public class CreateContactListTypeDescriptionCommand
        extends BaseSimpleCommand<CreateContactListTypeDescriptionForm> {
    ...
    /** Creates a new instance of CreateContactListTypeDescriptionCommand */
    public CreateContactListTypeDescriptionCommand(UserVisitPK userVisitPK, CreateContactListTypeDescriptionForm form) {
        ...
        if(contactListType != null) {
            ...
            if(language != null) {
                ...
                if(contactListTypeDescription == null) {
                    ...
                    contactListControl.createContactListTypeDescription(contactListType, language, description, getPartyPK());
                } else {
                    addExecutionError(ExecutionErrors.DuplicateContactListTypeDescription.name());
                }
            } else {
