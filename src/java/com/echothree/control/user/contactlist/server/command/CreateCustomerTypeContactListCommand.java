...
public class CreateCustomerTypeContactListCommand
        extends BaseSimpleCommand<CreateCustomerTypeContactListForm> {
    ...
    public CreateCustomerTypeContactListCommand(UserVisitPK userVisitPK, CreateCustomerTypeContactListForm form) {
        ...
        if(customerType != null) {
            ...
            if(contactList != null) {
                ...
                if(customerTypeContactList == null) {
                    ...
                    contactListControl.createCustomerTypeContactList(customerType, contactList, addWhenCreated, getPartyPK());
                } else {
                    addExecutionError(ExecutionErrors.DuplicateCustomerTypeContactList.name(), customerTypeName, contactListName);
                }
            } else {
