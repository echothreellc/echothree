...
public class GetContactListGroupCommand
    ...
    public GetContactListGroupCommand(UserVisitPK userVisitPK, GetContactListGroupForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetContactListGroupResult result = ContactListResultFactory.getGetContactListGroupResult();
        ...
        if(contactListGroup != null) {
            ...
            sendEventUsingNames(contactListGroup.getPrimaryKey(), EventTypes.READ, null, null, getPartyPK());
        } else {
