...
import com.echothree.control.user.contactlist.remote.form.GetContactListTypeDescriptionForm;
import com.echothree.control.user.contactlist.remote.result.ContactListResultFactory;
import com.echothree.control.user.contactlist.remote.result.GetContactListTypeDescriptionResult;
...
public class GetContactListTypeDescriptionCommand
        extends BaseSimpleCommand<GetContactListTypeDescriptionForm> {
    ...
    /** Creates a new instance of GetContactListTypeDescriptionCommand */
    public GetContactListTypeDescriptionCommand(UserVisitPK userVisitPK, GetContactListTypeDescriptionForm form) {
