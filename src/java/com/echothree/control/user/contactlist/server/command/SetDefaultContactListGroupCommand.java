...
import com.echothree.control.user.contactlist.remote.form.SetDefaultContactListGroupForm;
...
public class SetDefaultContactListGroupCommand
        extends BaseSimpleCommand<SetDefaultContactListGroupForm> {
    ...
    public SetDefaultContactListGroupCommand(UserVisitPK userVisitPK, SetDefaultContactListGroupForm form) {
