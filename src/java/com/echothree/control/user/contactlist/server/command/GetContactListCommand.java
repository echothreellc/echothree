...
public class GetContactListCommand
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                    new SecurityRoleDefinition(SecurityRoleGroups.ContactList.name(), SecurityRoles.Review.name())
                    )))
                )));
    ...
    public GetContactListCommand(UserVisitPK userVisitPK, GetContactListForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(contactList != null) {
            ...
            sendEventUsingNames(contactList.getPrimaryKey(), EventTypes.READ.name(), null, null, getPartyPK());
        } else {
