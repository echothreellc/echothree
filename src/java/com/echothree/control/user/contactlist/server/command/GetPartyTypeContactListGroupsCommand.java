...
public class GetPartyTypeContactListGroupsCommand
        extends BaseSimpleCommand<GetPartyTypeContactListGroupsForm> {
    ...
    public GetPartyTypeContactListGroupsCommand(UserVisitPK userVisitPK, GetPartyTypeContactListGroupsForm form) {
        ...
        if(parameterCount == 1) {
            ...
            if(partyTypeName != null) {
                ...
                if(partyType != null) {
                    ...
                    result.setPartyTypeContactListGroups(contactListControl.getPartyTypeContactListGroupTransfersByPartyType(userVisit, partyType));
                } else {
