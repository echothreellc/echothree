...
import com.echothree.control.user.contactlist.common.form.SetDefaultContactListTypeForm;
...
public class SetDefaultContactListTypeCommand
        extends BaseSimpleCommand<SetDefaultContactListTypeForm> {
    ...
    protected BaseResult execute() {
        ...
        ContactListTypeDetailValue contactListTypeDetailValue = contactListControl.getContactListTypeDetailValueByNameForUpdate(contactListTypeName);
        
        if(contactListTypeDetailValue != null) {
            contactListTypeDetailValue.setIsDefault(Boolean.TRUE);
            contactListControl.updateContactListTypeFromValue(contactListTypeDetailValue, getPartyPK());
        } else {
