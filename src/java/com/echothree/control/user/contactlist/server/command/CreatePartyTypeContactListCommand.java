...
public class CreatePartyTypeContactListCommand
        extends BaseSimpleCommand<CreatePartyTypeContactListForm> {
    ...
    /** Creates a new instance of CreatePartyTypeContactListCommand */
    public CreatePartyTypeContactListCommand(UserVisitPK userVisitPK, CreatePartyTypeContactListForm form) {
        ...
        if(partyType != null) {
            ...
            if(contactList != null) {
                ...
                if(partyTypeContactList == null) {
                    ...
                    contactListControl.createPartyTypeContactList(partyType, contactList, addWhenCreated, getPartyPK());
                } else {
                    addExecutionError(ExecutionErrors.DuplicatePartyTypeContactList.name(), partyTypeName, contactListName);
                }
            } else {
