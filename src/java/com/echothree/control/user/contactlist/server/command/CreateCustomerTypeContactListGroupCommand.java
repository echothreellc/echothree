...
public class CreateCustomerTypeContactListGroupCommand
        extends BaseSimpleCommand<CreateCustomerTypeContactListGroupForm> {
    ...
    /** Creates a new instance of CreateCustomerTypeContactListGroupCommand */
    public CreateCustomerTypeContactListGroupCommand(UserVisitPK userVisitPK, CreateCustomerTypeContactListGroupForm form) {
        ...
        if(customerType != null) {
            ...
            if(contactListGroup != null) {
                ...
                if(customerTypeContactListGroup == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateCustomerTypeContactListGroup.name(), customerTypeName, contactListGroupName);
                }
            } else {
