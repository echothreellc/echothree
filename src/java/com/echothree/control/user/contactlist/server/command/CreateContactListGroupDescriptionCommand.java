...
@Dependent
public class CreateContactListGroupDescriptionCommand
        extends BaseSimpleCommand<CreateContactListGroupDescriptionForm> {
        ...
        if(contactListGroup != null) {
            ...
            if(language != null) {
                ...
                if(contactListGroupDescription == null) {
                    ...
                    contactListControl.createContactListGroupDescription(contactListGroup, language, description, getPartyPK());
                } else {
                    addExecutionError(ExecutionErrors.DuplicateContactListGroupDescription.name());
                }
            } else {
