...
import com.echothree.control.user.contactlist.remote.form.DeletePartyTypeContactListForm;
...
public class DeletePartyTypeContactListCommand
        extends BaseSimpleCommand<DeletePartyTypeContactListForm> {
    ...
    /** Creates a new instance of DeletePartyTypeContactListCommand */
    public DeletePartyTypeContactListCommand(UserVisitPK userVisitPK, DeletePartyTypeContactListForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(partyType != null) {
            ...
            if(contactList != null) {
                PartyTypeContactList partyTypeContactList = contactListControl.getPartyTypeContactListForUpdate(partyType, contactList);
                
                if(partyTypeContactList != null) {
                    contactListControl.deletePartyTypeContactList(partyTypeContactList, getPartyPK());
                } else {
