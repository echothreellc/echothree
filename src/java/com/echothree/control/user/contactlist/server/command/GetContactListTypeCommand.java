...
import com.echothree.control.user.contactlist.remote.form.GetContactListTypeForm;
import com.echothree.control.user.contactlist.remote.result.ContactListResultFactory;
import com.echothree.control.user.contactlist.remote.result.GetContactListTypeResult;
...
public class GetContactListTypeCommand
        extends BaseSimpleCommand<GetContactListTypeForm> {
    ...
    public GetContactListTypeCommand(UserVisitPK userVisitPK, GetContactListTypeForm form) {
