...
import com.echothree.control.user.contactlist.remote.form.GetCustomerTypeContactListsForm;
import com.echothree.control.user.contactlist.remote.result.ContactListResultFactory;
import com.echothree.control.user.contactlist.remote.result.GetCustomerTypeContactListsResult;
...
public class GetCustomerTypeContactListsCommand
    ...
    protected BaseResult execute() {
        ...
        int parameterCount = (customerTypeName != null? 1: 0) + (contactListName != null? 1: 0);
