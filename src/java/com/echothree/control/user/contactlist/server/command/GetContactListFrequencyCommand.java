...
public class GetContactListFrequencyCommand
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                    new SecurityRoleDefinition(SecurityRoleGroups.ContactListFrequency.name(), SecurityRoles.Review.name())
                    )))
                )));
    ...
    public GetContactListFrequencyCommand(UserVisitPK userVisitPK, GetContactListFrequencyForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetContactListFrequencyResult result = ContactListResultFactory.getGetContactListFrequencyResult();
