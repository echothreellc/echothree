...
@Dependent
public class CreateContactListFrequencyDescriptionCommand
        extends BaseSimpleCommand<CreateContactListFrequencyDescriptionForm> {
        ...
        if(contactListFrequency != null) {
            ...
            if(language != null) {
                ...
                if(contactListFrequencyDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateContactListFrequencyDescription.name());
                }
            } else {
