...
import com.echothree.control.user.contactlist.remote.form.DeleteContactListTypeDescriptionForm;
...
public class DeleteContactListTypeDescriptionCommand
        extends BaseSimpleCommand<DeleteContactListTypeDescriptionForm> {
    ...
    /** Creates a new instance of DeleteContactListTypeDescriptionCommand */
    public DeleteContactListTypeDescriptionCommand(UserVisitPK userVisitPK, DeleteContactListTypeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(contactListType != null) {
            ...
            if(language != null) {
                ContactListTypeDescription contactListTypeDescription = contactListControl.getContactListTypeDescriptionForUpdate(contactListType, language);
                
                if(contactListTypeDescription != null) {
                    contactListControl.deleteContactListTypeDescription(contactListTypeDescription, getPartyPK());
                } else {
