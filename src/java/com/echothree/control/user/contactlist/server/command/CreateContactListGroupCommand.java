...
public class CreateContactListGroupCommand
        extends BaseSimpleCommand<CreateContactListGroupForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                    new SecurityRoleDefinition(SecurityRoleGroups.ContactListGroup.name(), SecurityRoles.Create.name())
                    )))
                )));
    ...
    /** Creates a new instance of CreateContactListGroupCommand */
    public CreateContactListGroupCommand(UserVisitPK userVisitPK, CreateContactListGroupForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(contactListGroup == null) {
            ...
            contactListGroup = contactListControl.createContactListGroup(contactListGroupName, isDefault, sortOrder, partyPK);
