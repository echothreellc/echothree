...
public class CreateContactListDescriptionCommand
        extends BaseSimpleCommand<CreateContactListDescriptionForm> {
    ...
    /** Creates a new instance of CreateContactListDescriptionCommand */
    public CreateContactListDescriptionCommand(UserVisitPK userVisitPK, CreateContactListDescriptionForm form) {
        ...
        if(contactList != null) {
            ...
            if(language != null) {
                ...
                if(contactListDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateContactListDescription.name());
                }
            } else {
