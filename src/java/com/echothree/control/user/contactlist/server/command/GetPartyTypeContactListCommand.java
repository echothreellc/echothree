...
import com.echothree.control.user.contactlist.remote.form.GetPartyTypeContactListForm;
import com.echothree.control.user.contactlist.remote.result.ContactListResultFactory;
import com.echothree.control.user.contactlist.remote.result.GetPartyTypeContactListResult;
...
public class GetPartyTypeContactListCommand
    ...
    public GetPartyTypeContactListCommand(UserVisitPK userVisitPK, GetPartyTypeContactListForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(partyType != null) {
            ...
            if(contactList != null) {
                PartyTypeContactList partyTypeContactList = contactListControl.getPartyTypeContactList(partyType, contactList);
