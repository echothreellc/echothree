...
import com.echothree.control.user.contactlist.common.form.DeleteContactListDescriptionForm;
...
public class DeleteContactListDescriptionCommand
        extends BaseSimpleCommand<DeleteContactListDescriptionForm> {
    ...
    /** Creates a new instance of DeleteContactListDescriptionCommand */
    public DeleteContactListDescriptionCommand(UserVisitPK userVisitPK, DeleteContactListDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(contactList != null) {
            ...
            if(language != null) {
                ContactListDescription contactListDescription = contactListControl.getContactListDescriptionForUpdate(contactList, language);
                
                if(contactListDescription != null) {
                    contactListControl.deleteContactListDescription(contactListDescription, getPartyPK());
                } else {
