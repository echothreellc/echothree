...
import com.echothree.control.user.contactlist.remote.form.DeleteContactListGroupForm;
...
public class DeleteContactListGroupCommand
        extends BaseSimpleCommand<DeleteContactListGroupForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                    new SecurityRoleDefinition(SecurityRoleGroups.ContactListGroup.name(), SecurityRoles.Delete.name())
                    )))
                )));
    ...
    /** Creates a new instance of DeleteContactListGroupCommand */
    public DeleteContactListGroupCommand(UserVisitPK userVisitPK, DeleteContactListGroupForm form) {
