...
public interface SetPartyContactListStatusForm
        extends PartyContactListSpec {
    
    String getPartyContactListStatusChoice();
    void setPartyContactListStatusChoice(String customerCreditStatusChoice);
