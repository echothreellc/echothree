...
public interface EditContactListDescriptionResult
        extends BaseEditResult<ContactListDescriptionEdit> {
    
    ContactListDescriptionTransfer getContactListDescription();
    void setContactListDescription(ContactListDescriptionTransfer contactListDescription);
