...
public interface CreatePartyTypeContactListForm
        extends PartyTypeContactListSpec, PartyTypeContactListEdit {
    
    // Nothing additional beyond PartyTypeContactListSpec, PartyTypeContactListEdit
