...
public interface CreateContactListGroupDescriptionForm
        extends ContactListGroupDescriptionSpec, ContactListGroupDescriptionEdit {
    
    // Nothing additional beyond ContactListGroupDescriptionSpec, ContactListGroupDescriptionEdit
