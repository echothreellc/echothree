...
public interface CreateContactListTypeDescriptionForm
        extends ContactListTypeDescriptionSpec, ContactListTypeDescriptionEdit {
    
    // Nothing additional beyond ContactListTypeDescriptionSpec, ContactListTypeDescriptionEdit
