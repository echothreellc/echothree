...
public interface CreateContactListResult
        extends ContactListSpec, EntityRefSpec, BaseResult {
    
    // Nothing additional beyond ContactListSpec, EntityRefSpec, BaseResult
