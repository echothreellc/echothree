...
public interface CreateContactListGroupResult
        extends ContactListGroupSpec, EntityRefSpec, BaseResult {
    
    // Nothing additional beyond ContactListGroupSpec, EntityRefSpec, BaseResult
