...
public interface GetContactListGroupDescriptionsResult
        extends BaseResult {
    
    ContactListGroupTransfer getContactListGroup();
    void setContactListGroup(ContactListGroupTransfer contactListGroup);
    
    List<ContactListGroupDescriptionTransfer> getContactListGroupDescriptions();
    void setContactListGroupDescriptions(List<ContactListGroupDescriptionTransfer> contactListGroupDescriptions);
