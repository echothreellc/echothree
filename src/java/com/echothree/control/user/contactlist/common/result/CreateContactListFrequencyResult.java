...
public interface CreateContactListFrequencyResult
        extends ContactListFrequencySpec, EntityRefSpec, BaseResult {
    
    // Nothing additional beyond ContactListFrequencySpec, EntityRefSpec, BaseResult
