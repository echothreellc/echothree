...
public interface CreateContactListDescriptionForm
        extends ContactListDescriptionSpec, ContactListDescriptionEdit {
    
    // Nothing additional beyond ContactListDescriptionSpec, ContactListDescriptionEdit
