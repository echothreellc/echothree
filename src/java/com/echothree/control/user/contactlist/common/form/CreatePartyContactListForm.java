...
public interface CreatePartyContactListForm
        extends PartyContactListSpec, PartyContactListEdit {
    
    // Nothing additional beyond PartyContactListSpec, PartyContactListEdit
