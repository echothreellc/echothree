...
public interface EditPartyTypeContactListGroupResult
        extends BaseEditResult<PartyTypeContactListGroupEdit> {
    
    PartyTypeContactListGroupTransfer getPartyTypeContactListGroup();
    void setPartyTypeContactListGroup(PartyTypeContactListGroupTransfer partyTypeContactListGroup);
