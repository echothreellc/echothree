...
public interface CreateCustomerTypeContactListForm
        extends CustomerTypeContactListSpec, CustomerTypeContactListEdit {
    
    // Nothing additional beyond CustomerTypeContactListSpec, CustomerTypeContactListEdit
