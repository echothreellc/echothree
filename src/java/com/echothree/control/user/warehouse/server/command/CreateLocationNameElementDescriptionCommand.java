...
public class CreateLocationNameElementDescriptionCommand
        extends BaseSimpleCommand<CreateLocationNameElementDescriptionForm> {
    ...
    /** Creates a new instance of CreateLocationNameElementDescriptionCommand */
    public CreateLocationNameElementDescriptionCommand(UserVisitPK userVisitPK, CreateLocationNameElementDescriptionForm form) {
        ...
        if(warehouse != null) {
            ...
            if(locationType != null) {
                ...
                if(locationNameElement != null) {
                    ...
                    if(language != null) {
                        var locationNameElementDescription = warehouseControl.getLocationNameElementDescription(locationNameElement, language);
                        ...
                        if(locationNameElementDescription == null) {
                            ...
                            addExecutionError(ExecutionErrors.DuplicateLocationNameElementDescription.name());
                        }
                    } else {
