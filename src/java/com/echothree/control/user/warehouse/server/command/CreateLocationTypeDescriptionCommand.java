...
public class CreateLocationTypeDescriptionCommand
        extends BaseSimpleCommand<CreateLocationTypeDescriptionForm> {
    ...
    /** Creates a new instance of CreateLocationTypeDescriptionCommand */
    public CreateLocationTypeDescriptionCommand(UserVisitPK userVisitPK, CreateLocationTypeDescriptionForm form) {
            ...
            if(locationType != null) {
                ...
                if(language != null) {
                    ...
                    if(locationTypeDescription == null) {
                        ...
                        warehouseControl.createLocationTypeDescription(locationType, language, description, getPartyPK());
                    } else {
                        addExecutionError(ExecutionErrors.DuplicateLocationTypeDescription.name());
                    }
                } else {
