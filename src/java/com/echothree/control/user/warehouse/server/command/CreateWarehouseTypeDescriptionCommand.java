...
@Dependent
public class CreateWarehouseTypeDescriptionCommand
        extends BaseSimpleCommand<CreateWarehouseTypeDescriptionForm> {
        ...
        if(warehouseType != null) {
            ...
            if(language != null) {
                ...
                if(warehouseTypeDescription == null) {
                    ...
                    warehouseControl.createWarehouseTypeDescription(warehouseType, language, description, getPartyPK());
                } else {
                    addExecutionError(ExecutionErrors.DuplicateWarehouseTypeDescription.name());
                }
            } else {
