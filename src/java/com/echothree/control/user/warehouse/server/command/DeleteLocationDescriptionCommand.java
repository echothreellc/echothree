...
public class DeleteLocationDescriptionCommand
        extends BaseSimpleCommand<DeleteLocationDescriptionForm> {
    ...
    /** Creates a new instance of DeleteLocationDescriptionCommand */
    public DeleteLocationDescriptionCommand(UserVisitPK userVisitPK, DeleteLocationDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(warehouse != null) {
            ...
            if(location != null) {
                ...
                if(language != null) {
                    LocationDescription locationDescription = warehouseControl.getLocationDescriptionForUpdate(location, language);
                    
                    if(locationDescription != null) {
                        warehouseControl.deleteLocationDescription(locationDescription, getPartyPK());
                    } else {
