...
public class CreateLocationCapacityCommand
        extends BaseSimpleCommand<CreateLocationCapacityForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(List.of(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), List.of(
                        new SecurityRoleDefinition(SecurityRoleGroups.LocationCapacity.name(), SecurityRoles.Create.name())
                ))
        ));
                ...
                if(unitOfMeasureKind != null) {
                    ...
                    if(unitOfMeasureType != null) {
                        ...
                        if(locationCapacity == null) {
                            ...
                            addExecutionError(ExecutionErrors.DuplicateLocationCapacity.name());
                        }
                    } else {
