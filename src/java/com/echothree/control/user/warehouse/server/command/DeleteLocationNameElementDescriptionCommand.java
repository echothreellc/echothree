...
public class DeleteLocationNameElementDescriptionCommand
    ...
    public DeleteLocationNameElementDescriptionCommand() {
        ...
        if(warehouse != null) {
            ...
            if(locationType != null) {
                ...
                if(locationNameElement != null) {
                    ...
                    if(language != null) {
                        var locationNameElementDescription = warehouseControl.getLocationNameElementDescriptionForUpdate(locationNameElement, language);
