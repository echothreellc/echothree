...
public class GetLocationTypeCommand
    ...
    public GetLocationTypeCommand(UserVisitPK userVisitPK, GetLocationTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetLocationTypeResult result = WarehouseResultFactory.getGetLocationTypeResult();
        ...
        if(warehouse != null) {
            ...
            if(locationType != null) {
                ...
                sendEventUsingNames(locationType.getPrimaryKey(), EventTypes.READ.name(), null, null, getPartyPK());
            } else {
