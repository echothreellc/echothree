...
public class DeleteLocationCommand
        extends BaseSimpleCommand<DeleteLocationForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(List.of(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), List.of(
                        new SecurityRoleDefinition(SecurityRoleGroups.Location.name(), SecurityRoles.Delete.name())
                ))
        ));
    ...
    /** Creates a new instance of DeleteLocationCommand */
    public DeleteLocationCommand(UserVisitPK userVisitPK, DeleteLocationForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(warehouse != null) {
            ...
            if(location != null) {
                ...
                warehouseControl.deleteLocation(location, getPartyPK());
            } else {
