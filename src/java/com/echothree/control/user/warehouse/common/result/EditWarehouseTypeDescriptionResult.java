...
public interface EditWarehouseTypeDescriptionResult
        extends BaseEditResult<WarehouseTypeDescriptionEdit> {
    
    WarehouseTypeDescriptionTransfer getWarehouseTypeDescription();
    void setWarehouseTypeDescription(WarehouseTypeDescriptionTransfer warehouseTypeDescription);
