...
public interface CreateWarehouseTypeDescriptionForm
        extends WarehouseTypeDescriptionSpec, WarehouseTypeDescriptionEdit {
    
    // Nothing additional beyond WarehouseTypeDescriptionSpec, WarehouseTypeDescriptionEdit
