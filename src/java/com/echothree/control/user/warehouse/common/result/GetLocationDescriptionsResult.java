...
public interface GetLocationDescriptionsResult
        extends BaseResult {
    ...
    List<LocationDescriptionTransfer> getLocationDescriptions();
    void setLocationDescriptions(List<LocationDescriptionTransfer> locationDescriptions);
