...
public interface CreateLocationNameElementForm
        extends LocationNameElementSpec, LocationNameElementEdit {
    
    // Nothing additional beyond LocationNameElementSpec, LocationNameElementEdit
