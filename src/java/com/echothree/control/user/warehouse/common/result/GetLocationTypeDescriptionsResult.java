...
public interface GetLocationTypeDescriptionsResult
        extends BaseResult {
    ...
    List<LocationTypeDescriptionTransfer> getLocationTypeDescriptions();
    void setLocationTypeDescriptions(List<LocationTypeDescriptionTransfer> locationTypeDescriptions);
