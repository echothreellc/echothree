...
public interface EditLocationTypeDescriptionResult
        extends BaseEditResult<LocationTypeDescriptionEdit> {
    
    LocationTypeDescriptionTransfer getLocationTypeDescription();
    void setLocationTypeDescription(LocationTypeDescriptionTransfer locationTypeDescription);
