...
import com.echothree.control.user.warehouse.common.spec.LocationUseTypeSpec;

public interface LocationEdit
        extends LocationSpec, LocationTypeSpec, LocationUseTypeSpec, InventoryLocationGroupSpec,
