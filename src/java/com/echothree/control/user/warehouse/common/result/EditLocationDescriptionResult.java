...
public interface EditLocationDescriptionResult
        extends BaseEditResult<LocationDescriptionEdit> {
    
    LocationDescriptionTransfer getLocationDescription();
    void setLocationDescription(LocationDescriptionTransfer locationDescription);
