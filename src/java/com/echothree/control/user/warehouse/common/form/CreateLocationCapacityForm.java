...
public interface CreateLocationCapacityForm
        extends LocationCapacitySpec, LocationCapacityEdit {
    
    // Nothing additional beyond LocationCapacitySpec, LocationCapacityEdit
