...
public class SetSalesOrderBatchStatusCommand
        extends BaseSimpleCommand<SetSalesOrderBatchStatusForm> {
    ...
    public SetSalesOrderBatchStatusCommand(UserVisitPK userVisitPK, SetSalesOrderBatchStatusForm form) {
