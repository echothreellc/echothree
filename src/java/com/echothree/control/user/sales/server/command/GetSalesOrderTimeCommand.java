...
import com.echothree.control.user.sales.remote.form.GetSalesOrderTimeForm;
import com.echothree.control.user.sales.remote.result.GetSalesOrderTimeResult;
...
public class GetSalesOrderTimeCommand
    ...
    public GetSalesOrderTimeCommand(UserVisitPK userVisitPK, GetSalesOrderTimeForm form) {
        super(userVisitPK, form, null, FORM_FIELD_DEFINITIONS, false);
    }
    
    @Override
    protected BaseResult execute() {
        GetSalesOrderTimeResult result = SalesResultFactory.getGetSalesOrderTimeResult();
