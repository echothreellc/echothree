...
import com.echothree.control.user.sales.remote.form.GetSalesOrderTimesForm;
import com.echothree.control.user.sales.remote.result.GetSalesOrderTimesResult;
...
public class GetSalesOrderTimesCommand
    ...
    protected BaseResult execute() {
        GetSalesOrderTimesResult result = SalesResultFactory.getGetSalesOrderTimesResult();
