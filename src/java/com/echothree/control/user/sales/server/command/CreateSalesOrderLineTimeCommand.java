...
import com.echothree.control.user.sales.common.form.CreateSalesOrderLineTimeForm;
...
public class CreateSalesOrderLineTimeCommand
        extends BaseSimpleCommand<CreateSalesOrderLineTimeForm> {
    ...
    /** Creates a new instance of CreateSalesOrderLineTimeCommand */
    public CreateSalesOrderLineTimeCommand(UserVisitPK userVisitPK, CreateSalesOrderLineTimeForm form) {
    ...
    protected BaseResult execute() {
        ...
        SalesOrderLineTimeLogic.getInstance().createOrderLineTime(this, orderName, orderLineSequence, orderTimeTypeName, time, getPartyPK());
