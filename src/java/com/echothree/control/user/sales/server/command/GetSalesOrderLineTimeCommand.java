...
import com.echothree.control.user.sales.remote.form.GetSalesOrderLineTimeForm;
import com.echothree.control.user.sales.remote.result.GetSalesOrderLineTimeResult;
...
public class GetSalesOrderLineTimeCommand
    ...
    public GetSalesOrderLineTimeCommand(UserVisitPK userVisitPK, GetSalesOrderLineTimeForm form) {
        super(userVisitPK, form, null, FORM_FIELD_DEFINITIONS, false);
    }
    
    @Override
    protected BaseResult execute() {
        GetSalesOrderLineTimeResult result = SalesResultFactory.getGetSalesOrderLineTimeResult();
