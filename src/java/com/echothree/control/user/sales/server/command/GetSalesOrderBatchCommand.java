...
public class GetSalesOrderBatchCommand
        extends BaseSimpleCommand<GetSalesOrderBatchForm> {
    ...
    public GetSalesOrderBatchCommand(UserVisitPK userVisitPK, GetSalesOrderBatchForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(batch != null) {
            ...
            sendEventUsingNames(batch.getPrimaryKey(), EventTypes.READ, null, null, getPartyPK());
        }
