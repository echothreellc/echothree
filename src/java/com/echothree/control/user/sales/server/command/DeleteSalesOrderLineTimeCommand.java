...
import com.echothree.control.user.sales.common.form.DeleteSalesOrderLineTimeForm;
...
public class DeleteSalesOrderLineTimeCommand
        extends BaseSimpleCommand<DeleteSalesOrderLineTimeForm> {
    ...
    /** Creates a new instance of DeleteSalesOrderLineTimeCommand */
    public DeleteSalesOrderLineTimeCommand(UserVisitPK userVisitPK, DeleteSalesOrderLineTimeForm form) {
    ...
    protected BaseResult execute() {
        ...
        SalesOrderLineTimeLogic.getInstance().deleteOrderLineTime(this, orderName, orderLineSequence, orderTimeTypeName, getPartyPK());
