...
public interface GetSalesOrderBatchStatusChoicesForm
        extends SalesOrderBatchSpec {
    
    String getDefaultSalesOrderBatchStatusChoice();
    void setDefaultSalesOrderBatchStatusChoice(String defaultSalesOrderBatchStatusChoice);
