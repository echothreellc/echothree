...
public interface EditSalesOrderShipmentGroupResult
        extends BaseEditResult<SalesOrderShipmentGroupEdit> {
    
    OrderShipmentGroupTransfer getOrderShipmentGroup();
    void setOrderShipmentGroup(OrderShipmentGroupTransfer orderShipmentGroup);
