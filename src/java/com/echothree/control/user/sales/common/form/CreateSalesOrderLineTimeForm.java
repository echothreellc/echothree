...
public interface CreateSalesOrderLineTimeForm
        extends SalesOrderLineTimeSpec, SalesOrderLineTimeEdit {
    
    // Nothing additional beyond SalesOrderLineTimeSpec, SalesOrderLineTimeEdit
