...
public interface EditSalesOrderLineTimeResult
        extends BaseEditResult<SalesOrderLineTimeEdit> {
    
    OrderLineTimeTransfer getOrderLineTime();
    void setOrderLineTime(OrderLineTimeTransfer orderLineTime);
