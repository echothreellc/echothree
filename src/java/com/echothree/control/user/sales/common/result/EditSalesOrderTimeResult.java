...
public interface EditSalesOrderTimeResult
        extends BaseEditResult<SalesOrderTimeEdit> {
    
    OrderTimeTransfer getOrderTime();
    void setOrderTime(OrderTimeTransfer orderTime);
