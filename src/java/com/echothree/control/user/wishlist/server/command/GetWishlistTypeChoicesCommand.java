...
import com.echothree.control.user.wishlist.remote.form.GetWishlistTypeChoicesForm;
import com.echothree.control.user.wishlist.remote.result.GetWishlistTypeChoicesResult;
...
public class GetWishlistTypeChoicesCommand
        extends BaseSimpleCommand<GetWishlistTypeChoicesForm> {
    
    private final static List<FieldDefinition> FORM_FIELD_DEFINITIONS;
    
    static {
        FORM_FIELD_DEFINITIONS = Collections.unmodifiableList(Arrays.asList(
            new FieldDefinition("DefaultWishlistTypeChoice", FieldType.ENTITY_NAME, false, null, null),
            new FieldDefinition("AllowNullChoice", FieldType.BOOLEAN, true, null, null)
        ));
    }
    
    /** Creates a new instance of GetWishlistTypeChoicesCommand */
    public GetWishlistTypeChoicesCommand(UserVisitPK userVisitPK, GetWishlistTypeChoicesForm form) {
