...
import com.echothree.control.user.wishlist.remote.form.SetDefaultWishlistTypeForm;
...
public class SetDefaultWishlistTypeCommand
        extends BaseSimpleCommand<SetDefaultWishlistTypeForm> {
    ...
    /** Creates a new instance of SetDefaultWishlistTypeCommand */
    public SetDefaultWishlistTypeCommand(UserVisitPK userVisitPK, SetDefaultWishlistTypeForm form) {
