...
public interface GetWishlistTypeDescriptionsResult
        extends BaseResult {
    
    WishlistTypeTransfer getWishlistType();
    void setWishlistType(WishlistTypeTransfer wishlistType);
    
    List<WishlistTypeDescriptionTransfer> getWishlistTypeDescriptions();
    void setWishlistTypeDescriptions(List<WishlistTypeDescriptionTransfer> wishlistTypeDescriptions);
