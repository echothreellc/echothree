...
public class DeleteEntityNameAttributeCommand
        extends BaseSimpleCommand<DeleteEntityNameAttributeForm> {
    ...
    public DeleteEntityNameAttributeCommand(UserVisitPK userVisitPK, DeleteEntityNameAttributeForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(entityInstance != null) {
            ...
            if(entityAttribute != null) {
                EntityNameAttribute entityNameAttribute = coreControl.getEntityNameAttributeForUpdate(entityAttribute, entityInstance);
                
                if(entityNameAttribute != null) {
                    coreControl.deleteEntityNameAttribute(entityNameAttribute, getPartyPK());
                } else {
