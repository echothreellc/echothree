...
import com.echothree.control.user.core.remote.form.DeleteCommandMessageTypeForm;
...
public class DeleteCommandMessageTypeCommand
        extends BaseSimpleCommand<DeleteCommandMessageTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.CommandMessageType.name(), SecurityRoles.Delete.name())
                        )))
                )));
