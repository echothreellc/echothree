...
public class GetProtocolChoicesCommand
        extends BaseSimpleCommand<GetProtocolChoicesForm> {
    ...
    public GetProtocolChoicesCommand(UserVisitPK userVisitPK, GetProtocolChoicesForm form) {
    ...
    protected BaseResult execute() {
        ...
        result.setProtocolChoices(serverControl.getProtocolChoices(defaultProtocolChoice, getPreferredLanguage(),
                allowNullChoice));
