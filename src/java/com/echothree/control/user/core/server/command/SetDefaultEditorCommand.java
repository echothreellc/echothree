...
import com.echothree.control.user.core.remote.form.SetDefaultEditorForm;
...
public class SetDefaultEditorCommand
        extends BaseSimpleCommand<SetDefaultEditorForm> {
    ...
    protected BaseResult execute() {
        ...
        if(editorDetailValue != null) {
            ...
            coreControl.updateEditorFromValue(editorDetailValue, getPartyPK());
        } else {
