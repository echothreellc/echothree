...
import com.echothree.control.user.core.remote.form.GetFontStyleDescriptionsForm;
import com.echothree.control.user.core.remote.result.CoreResultFactory;
import com.echothree.control.user.core.remote.result.GetFontStyleDescriptionsResult;
...
public class GetFontStyleDescriptionsCommand
        extends BaseSimpleCommand<GetFontStyleDescriptionsForm> {
    ...
    public GetFontStyleDescriptionsCommand(UserVisitPK userVisitPK, GetFontStyleDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(fontStyle != null) {
            ...
            result.setFontStyleDescriptions(coreControl.getFontStyleDescriptionTransfersByFontStyle(getUserVisit(), fontStyle));
        } else {
