...
import com.echothree.control.user.core.remote.form.DeleteEntityListItemDescriptionForm;
...
public class DeleteEntityListItemDescriptionCommand
        extends BaseSimpleCommand<DeleteEntityListItemDescriptionForm> {
    ...
    /** Creates a new instance of DeleteEntityListItemDescriptionCommand */
    public DeleteEntityListItemDescriptionCommand(UserVisitPK userVisitPK, DeleteEntityListItemDescriptionForm form) {
            ...
            if(entityType != null) {
                ...
                if(entityAttribute != null) {
                    ...
                    if(entityListItem != null) {
                        ...
                        addExecutionError(ExecutionErrors.UnknownEntityListItemName.name(), componentVendorName, entityTypeName, entityAttributeName,
                                entityListItemName);
                    }
                } else {
