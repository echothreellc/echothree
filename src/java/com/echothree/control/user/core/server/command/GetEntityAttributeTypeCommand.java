...
import com.echothree.control.user.core.remote.result.GetEntityAttributeTypeResult;
...
public class GetEntityAttributeTypeCommand
    ...
    public GetEntityAttributeTypeCommand(UserVisitPK userVisitPK, GetEntityAttributeTypeForm form) {
