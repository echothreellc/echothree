...
import com.echothree.control.user.core.remote.form.GetAppearanceTextTransformationsForm;
import com.echothree.control.user.core.remote.result.CoreResultFactory;
import com.echothree.control.user.core.remote.result.GetAppearanceTextTransformationsResult;
...
public class GetAppearanceTextTransformationsCommand
        extends BaseSimpleCommand<GetAppearanceTextTransformationsForm> {
    ...
    public GetAppearanceTextTransformationsCommand(UserVisitPK userVisitPK, GetAppearanceTextTransformationsForm form) {
