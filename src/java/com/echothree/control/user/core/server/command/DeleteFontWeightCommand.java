...
public class DeleteFontWeightCommand
        extends BaseSimpleCommand<DeleteFontWeightForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.FontWeight.name(), SecurityRoles.Delete.name())
                        )))
                )));
    ...
    protected BaseResult execute() {
        ...
        var fontWeight = fontControl.getFontWeightByNameForUpdate(fontWeightName);
        
        if(fontWeight != null) {
            fontControl.deleteFontWeight(fontWeight, getPartyPK());
        } else {
