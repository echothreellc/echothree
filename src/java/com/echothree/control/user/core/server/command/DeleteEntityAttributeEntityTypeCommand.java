...
import com.echothree.control.user.core.remote.form.DeleteEntityAttributeEntityTypeForm;
...
public class DeleteEntityAttributeEntityTypeCommand
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.EntityAttributeEntityType.name(), SecurityRoles.Delete.name())
                        )))
                )));
    ...
    /** Creates a new instance of DeleteEntityAttributeEntityTypeCommand */
    public DeleteEntityAttributeEntityTypeCommand(UserVisitPK userVisitPK, DeleteEntityAttributeEntityTypeForm form) {
                ...
                if(entityAttribute != null) {
                    ...
                    if(allowedComponentVendor != null) {
                        ...
                        if(allowedEntityType != null) {
                            EntityAttributeEntityType entityAttributeEntityType = coreControl.getEntityAttributeEntityTypeForUpdate(entityAttribute, allowedEntityType);

                            if(entityAttributeEntityType != null) {
                                coreControl.deleteEntityAttributeEntityType(entityAttributeEntityType, getPartyPK());
                            } else {
                                addExecutionError(ExecutionErrors.UnknownEntityAttributeEntityType.name(), componentVendorName, entityTypeName, entityAttributeName,
                                        allowedComponentVendorName, allowedEntityTypeName);
                            }
                        } else {
