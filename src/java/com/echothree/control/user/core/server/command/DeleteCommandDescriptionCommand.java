...
import com.echothree.control.user.core.remote.form.DeleteCommandDescriptionForm;
...
public class DeleteCommandDescriptionCommand
    ...
    public DeleteCommandDescriptionCommand(UserVisitPK userVisitPK, DeleteCommandDescriptionForm form) {
