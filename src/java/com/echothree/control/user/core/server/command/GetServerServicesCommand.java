...
import com.echothree.control.user.core.remote.form.GetServerServicesForm;
import com.echothree.control.user.core.remote.result.CoreResultFactory;
import com.echothree.control.user.core.remote.result.GetServerServicesResult;
...
public class GetServerServicesCommand
    ...
    protected BaseResult execute() {
        ...
        GetServerServicesResult result = CoreResultFactory.getGetServerServicesResult();
        ...
        if(server != null) {
            ...
            result.setServerServices(coreControl.getServerServiceTransfersByServer(getUserVisit(), server));
        } else {
