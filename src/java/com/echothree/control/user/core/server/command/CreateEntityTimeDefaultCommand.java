...
import com.echothree.control.user.core.common.form.CreateEntityTimeDefaultForm;
...
@Dependent
public class CreateEntityTimeDefaultCommand
        extends BaseSimpleCommand<CreateEntityTimeDefaultForm> {
    ...
    protected BaseResult execute() {
        ...
        if(!hasExecutionErrors()) {
            ...
            entityAttributeLogic.createEntityTimeDefault(this, entityAttribute,
