...
import com.echothree.control.user.core.remote.form.SetDefaultTextDecorationForm;
...
public class SetDefaultTextDecorationCommand
    ...
    protected BaseResult execute() {
        ...
        if(textDecorationDetailValue != null) {
            ...
            coreControl.updateTextDecorationFromValue(textDecorationDetailValue, getPartyPK());
        } else {
