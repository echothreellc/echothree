...
public class DeleteTextDecorationDescriptionCommand
        extends BaseSimpleCommand<DeleteTextDecorationDescriptionForm> {
    ...
    /** Creates a new instance of DeleteTextDecorationDescriptionCommand */
    public DeleteTextDecorationDescriptionCommand(UserVisitPK userVisitPK, DeleteTextDecorationDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(textDecoration != null) {
            ...
            if(language != null) {
                var textDecorationDescription = textControl.getTextDecorationDescriptionForUpdate(textDecoration, language);
                
                if(textDecorationDescription != null) {
                    textControl.deleteTextDecorationDescription(textDecorationDescription, getPartyPK());
                } else {
