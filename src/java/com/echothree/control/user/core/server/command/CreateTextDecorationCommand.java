...
import com.echothree.control.user.core.remote.form.CreateTextDecorationForm;
...
public class CreateTextDecorationCommand
        extends BaseSimpleCommand<CreateTextDecorationForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.TextDecoration.name(), SecurityRoles.Create.name())
                        )))
                )));
    ...
    /** Creates a new instance of CreateTextDecorationCommand */
    public CreateTextDecorationCommand(UserVisitPK userVisitPK, CreateTextDecorationForm form) {
