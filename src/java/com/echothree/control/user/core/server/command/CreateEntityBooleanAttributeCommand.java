...
public class CreateEntityBooleanAttributeCommand
        extends BaseSimpleCommand<CreateEntityBooleanAttributeForm> {
    ...
    public CreateEntityBooleanAttributeCommand(UserVisitPK userVisitPK, CreateEntityBooleanAttributeForm form) {
