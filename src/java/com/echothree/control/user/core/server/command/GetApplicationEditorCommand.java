...
public class GetApplicationEditorCommand
        extends BaseSingleEntityCommand<ApplicationEditor, GetApplicationEditorForm> {
    ...
    @Override
    protected ApplicationEditor getEntity() {
        ...
        if(!hasExecutionErrors()) {
            ...
            if(!hasExecutionErrors()) {
                applicationEditor = applicationLogic.getApplicationEditor(this, application, editor);
    ...
    @Override
    protected BaseResult getResult(ApplicationEditor applicationEditor) {
