...
public class GetServiceCommand
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.Service.name(), SecurityRoles.Review.name())
                        )))
                )));
    ...
    public GetServiceCommand(UserVisitPK userVisitPK, GetServiceForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(service != null) {
            ...
            sendEventUsingNames(service.getPrimaryKey(), EventTypes.READ.name(), null, null, getPartyPK());
        } else {
