...
import com.echothree.control.user.core.remote.form.DeleteEntityListItemAttributeForm;
...
public class DeleteEntityListItemAttributeCommand
        extends BaseSimpleCommand<DeleteEntityListItemAttributeForm> {
    ...
    /** Creates a new instance of DeleteEntityListItemAttributeCommand */
    public DeleteEntityListItemAttributeCommand(UserVisitPK userVisitPK, DeleteEntityListItemAttributeForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(entityInstance != null) {
            ...
            if(entityAttribute != null) {
                EntityListItemAttribute entityListItemAttribute = coreControl.getEntityListItemAttributeForUpdate(entityAttribute, entityInstance);
                
                if(entityListItemAttribute != null) {
                    coreControl.deleteEntityListItemAttribute(entityListItemAttribute, getPartyPK());
                } else {
