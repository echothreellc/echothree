...
public class DeleteEditorDescriptionCommand
        extends BaseSimpleCommand<DeleteEditorDescriptionForm> {
    ...
    /** Creates a new instance of DeleteEditorDescriptionCommand */
    public DeleteEditorDescriptionCommand(UserVisitPK userVisitPK, DeleteEditorDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(editor != null) {
            ...
            if(language != null) {
                var editorDescription = editorControl.getEditorDescriptionForUpdate(editor, language);
                
                if(editorDescription != null) {
                    editorControl.deleteEditorDescription(editorDescription, getPartyPK());
                } else {
