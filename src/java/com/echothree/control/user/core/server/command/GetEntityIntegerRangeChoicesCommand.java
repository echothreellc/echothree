...
import com.echothree.control.user.core.remote.form.GetEntityIntegerRangeChoicesForm;
import com.echothree.control.user.core.remote.result.CoreResultFactory;
import com.echothree.control.user.core.remote.result.GetEntityIntegerRangeChoicesResult;
...
public class GetEntityIntegerRangeChoicesCommand
        extends BaseSimpleCommand<GetEntityIntegerRangeChoicesForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.EntityIntegerRange.name(), SecurityRoles.Choices.name())
                        )))
                )));
    ...
    /** Creates a new instance of GetEntityIntegerRangeChoicesCommand */
    public GetEntityIntegerRangeChoicesCommand(UserVisitPK userVisitPK, GetEntityIntegerRangeChoicesForm form) {
