...
import com.echothree.control.user.core.remote.form.GetFontStyleDescriptionForm;
import com.echothree.control.user.core.remote.result.CoreResultFactory;
import com.echothree.control.user.core.remote.result.GetFontStyleDescriptionResult;
...
public class GetFontStyleDescriptionCommand
        extends BaseSimpleCommand<GetFontStyleDescriptionForm> {
    ...
    /** Creates a new instance of GetFontStyleDescriptionCommand */
    public GetFontStyleDescriptionCommand(UserVisitPK userVisitPK, GetFontStyleDescriptionForm form) {
