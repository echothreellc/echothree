...
import com.echothree.control.user.core.remote.form.DeleteTextTransformationDescriptionForm;
...
public class DeleteTextTransformationDescriptionCommand
        extends BaseSimpleCommand<DeleteTextTransformationDescriptionForm> {
    ...
    protected BaseResult execute() {
        ...
        if(textTransformation != null) {
            ...
            if(language != null) {
                TextTransformationDescription textTransformationDescription = coreControl.getTextTransformationDescriptionForUpdate(textTransformation, language);
