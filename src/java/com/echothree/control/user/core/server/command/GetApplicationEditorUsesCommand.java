...
import com.echothree.control.user.core.remote.form.GetApplicationEditorUsesForm;
import com.echothree.control.user.core.remote.result.CoreResultFactory;
import com.echothree.control.user.core.remote.result.GetApplicationEditorUsesResult;
...
public class GetApplicationEditorUsesCommand
        extends BaseSimpleCommand<GetApplicationEditorUsesForm> {
    ...
    public GetApplicationEditorUsesCommand(UserVisitPK userVisitPK, GetApplicationEditorUsesForm form) {
