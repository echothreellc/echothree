...
import com.echothree.control.user.core.remote.form.GetServerDescriptionsForm;
import com.echothree.control.user.core.remote.result.CoreResultFactory;
import com.echothree.control.user.core.remote.result.GetServerDescriptionsResult;
...
public class GetServerDescriptionsCommand
        extends BaseSimpleCommand<GetServerDescriptionsForm> {
    ...
    /** Creates a new instance of GetServerDescriptionsCommand */
    public GetServerDescriptionsCommand(UserVisitPK userVisitPK, GetServerDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(server != null) {
            ...
            result.setServerDescriptions(coreControl.getServerDescriptionTransfersByServer(getUserVisit(), server));
        } else {
