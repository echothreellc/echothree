...
import com.echothree.control.user.core.remote.form.SetDefaultApplicationForm;
...
public class SetDefaultApplicationCommand
        extends BaseSimpleCommand<SetDefaultApplicationForm> {
    ...
    /** Creates a new instance of SetDefaultApplicationCommand */
    public SetDefaultApplicationCommand(UserVisitPK userVisitPK, SetDefaultApplicationForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(applicationDetailValue != null) {
            ...
            coreControl.updateApplicationFromValue(applicationDetailValue, getPartyPK());
        } else {
