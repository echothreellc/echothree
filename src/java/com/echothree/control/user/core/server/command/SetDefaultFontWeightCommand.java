...
import com.echothree.control.user.core.remote.form.SetDefaultFontWeightForm;
...
public class SetDefaultFontWeightCommand
        extends BaseSimpleCommand<SetDefaultFontWeightForm> {
    ...
    protected BaseResult execute() {
        ...
        if(fontWeightDetailValue != null) {
            ...
            coreControl.updateFontWeightFromValue(fontWeightDetailValue, getPartyPK());
        } else {
