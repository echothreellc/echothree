...
import com.echothree.control.user.core.remote.edit.ColorDescriptionEdit;
import com.echothree.control.user.core.remote.edit.CoreEditFactory;
import com.echothree.control.user.core.remote.form.EditColorDescriptionForm;
import com.echothree.control.user.core.remote.result.CoreResultFactory;
import com.echothree.control.user.core.remote.result.EditColorDescriptionResult;
import com.echothree.control.user.core.remote.spec.ColorDescriptionSpec;
...
public class EditColorDescriptionCommand
    ...
    public EditColorDescriptionCommand(UserVisitPK userVisitPK, EditColorDescriptionForm form) {
        ...
        if(color != null) {
            ...
            if(language != null) {
                if(editMode.equals(EditMode.LOCK) || editMode.equals(EditMode.ABANDON)) {
                    colorDescription = coreControl.getColorDescription(color, language);
                } else { // EditMode.UPDATE
                    colorDescription = coreControl.getColorDescriptionForUpdate(color, language);
                }
