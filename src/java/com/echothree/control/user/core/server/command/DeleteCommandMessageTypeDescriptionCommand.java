...
public class DeleteCommandMessageTypeDescriptionCommand
        extends BaseSimpleCommand<DeleteCommandMessageTypeDescriptionForm> {
    ...
    /** Creates a new instance of DeleteCommandMessageTypeDescriptionCommand */
    public DeleteCommandMessageTypeDescriptionCommand(UserVisitPK userVisitPK, DeleteCommandMessageTypeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(commandMessageType != null) {
            ...
            if(language != null) {
                var commandMessageTypeDescription = commandControl.getCommandMessageTypeDescriptionForUpdate(commandMessageType, language);
                
                if(commandMessageTypeDescription != null) {
                    commandControl.deleteCommandMessageTypeDescription(commandMessageTypeDescription, getPartyPK());
                } else {
