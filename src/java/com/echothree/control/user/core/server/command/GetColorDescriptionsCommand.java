...
import com.echothree.control.user.core.remote.form.GetColorDescriptionsForm;
import com.echothree.control.user.core.remote.result.CoreResultFactory;
import com.echothree.control.user.core.remote.result.GetColorDescriptionsResult;
...
public class GetColorDescriptionsCommand
        extends BaseSimpleCommand<GetColorDescriptionsForm> {
    ...
    /** Creates a new instance of GetColorDescriptionsCommand */
    public GetColorDescriptionsCommand(UserVisitPK userVisitPK, GetColorDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(color != null) {
            ...
            result.setColorDescriptions(coreControl.getColorDescriptionTransfersByColor(getUserVisit(), color));
        } else {
