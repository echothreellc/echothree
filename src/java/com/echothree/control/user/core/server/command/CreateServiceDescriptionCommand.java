...
public class CreateServiceDescriptionCommand
        extends BaseSimpleCommand<CreateServiceDescriptionForm> {
    ...
    /** Creates a new instance of CreateServiceDescriptionCommand */
    public CreateServiceDescriptionCommand(UserVisitPK userVisitPK, CreateServiceDescriptionForm form) {
        ...
        if(service != null) {
            ...
            if(language != null) {
                ...
                if(serviceDescription == null) {
                    ...
                    serverControl.createServiceDescription(service, language, description, getPartyPK());
                } else {
                    addExecutionError(ExecutionErrors.DuplicateServiceDescription.name());
                }
            } else {
