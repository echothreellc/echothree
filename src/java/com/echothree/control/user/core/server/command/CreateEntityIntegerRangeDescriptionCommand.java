...
public class CreateEntityIntegerRangeDescriptionCommand
        extends BaseSimpleCommand<CreateEntityIntegerRangeDescriptionForm> {
    ...
    /** Creates a new instance of CreateEntityIntegerRangeDescriptionCommand */
    public CreateEntityIntegerRangeDescriptionCommand(UserVisitPK userVisitPK, CreateEntityIntegerRangeDescriptionForm form) {
                    ...
                    if(entityIntegerRange != null) {
                        ...
                        if(language != null) {
                            ...
                            if(entityIntegerRangeDescription == null) {
                                ...
                                addExecutionError(ExecutionErrors.DuplicateEntityIntegerRangeDescription.name(), componentVendorName, entityTypeName,
                                        entityAttributeName, entityIntegerRangeName, languageIsoName);
                            }
                        } else {
