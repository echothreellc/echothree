...
public class CreateEntityAttributeGroupDescriptionCommand
        extends BaseSimpleCommand<CreateEntityAttributeGroupDescriptionForm> {
    ...
    /** Creates a new instance of CreateEntityAttributeGroupDescriptionCommand */
    public CreateEntityAttributeGroupDescriptionCommand(UserVisitPK userVisitPK, CreateEntityAttributeGroupDescriptionForm form) {
        ...
        if(entityAttributeGroup != null) {
            ...
            if(language != null) {
                ...
                if(entityAttributeGroupDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateEntityAttributeGroupDescription.name(), entityAttributeGroupName, languageIsoName);
                }
            } else {
