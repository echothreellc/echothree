...
import com.echothree.control.user.core.remote.form.GetProtocolDescriptionsForm;
import com.echothree.control.user.core.remote.result.CoreResultFactory;
import com.echothree.control.user.core.remote.result.GetProtocolDescriptionsResult;
...
public class GetProtocolDescriptionsCommand
        extends BaseSimpleCommand<GetProtocolDescriptionsForm> {
    ...
    public GetProtocolDescriptionsCommand(UserVisitPK userVisitPK, GetProtocolDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetProtocolDescriptionsResult result = CoreResultFactory.getGetProtocolDescriptionsResult();
        ...
        if(protocol != null) {
            ...
            result.setProtocolDescriptions(coreControl.getProtocolDescriptionTransfersByProtocol(getUserVisit(), protocol));
        } else {
