...
import com.echothree.control.user.core.remote.form.GetAppearanceTextDecorationsForm;
import com.echothree.control.user.core.remote.result.CoreResultFactory;
import com.echothree.control.user.core.remote.result.GetAppearanceTextDecorationsResult;
...
public class GetAppearanceTextDecorationsCommand
        extends BaseSimpleCommand<GetAppearanceTextDecorationsForm> {
    ...
    public GetAppearanceTextDecorationsCommand(UserVisitPK userVisitPK, GetAppearanceTextDecorationsForm form) {
