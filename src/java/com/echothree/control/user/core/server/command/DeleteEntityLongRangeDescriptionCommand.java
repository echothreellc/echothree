...
import com.echothree.control.user.core.remote.form.DeleteEntityLongRangeDescriptionForm;
...
public class DeleteEntityLongRangeDescriptionCommand
        extends BaseSimpleCommand<DeleteEntityLongRangeDescriptionForm> {
    ...
    /** Creates a new instance of DeleteEntityLongRangeDescriptionCommand */
    public DeleteEntityLongRangeDescriptionCommand(UserVisitPK userVisitPK, DeleteEntityLongRangeDescriptionForm form) {
            ...
            if(entityType != null) {
                ...
                if(entityAttribute != null) {
                    ...
                    if(entityLongRange != null) {
                        ...
                        addExecutionError(ExecutionErrors.UnknownEntityLongRangeName.name(), componentVendorName, entityTypeName, entityAttributeName,
                                entityLongRangeName);
                    }
                } else {
