...
import com.echothree.control.user.core.remote.form.DeleteFontStyleDescriptionForm;
...
public class DeleteFontStyleDescriptionCommand
        extends BaseSimpleCommand<DeleteFontStyleDescriptionForm> {
