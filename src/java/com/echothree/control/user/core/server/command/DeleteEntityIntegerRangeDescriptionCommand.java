...
import com.echothree.control.user.core.remote.form.DeleteEntityIntegerRangeDescriptionForm;
...
public class DeleteEntityIntegerRangeDescriptionCommand
        extends BaseSimpleCommand<DeleteEntityIntegerRangeDescriptionForm> {
            ...
            if(entityType != null) {
                ...
                if(entityAttribute != null) {
                    ...
                    if(entityIntegerRange != null) {
                        ...
                        if(language != null) {
                            EntityIntegerRangeDescription entityIntegerRangeDescription = coreControl.getEntityIntegerRangeDescriptionForUpdate(entityIntegerRange, language);
                            
                            if(entityIntegerRangeDescription != null) {
                                coreControl.deleteEntityIntegerRangeDescription(entityIntegerRangeDescription, getPartyPK());
                            } else {
