...
public class GetTextTransformationChoicesCommand
        extends BaseSimpleCommand<GetTextTransformationChoicesForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.TextTransformation.name(), SecurityRoles.Choices.name())
                        )))
                )));
        
        FORM_FIELD_DEFINITIONS = Collections.unmodifiableList(Arrays.asList(
                new FieldDefinition("DefaultTextTransformationChoice", FieldType.ENTITY_NAME, false, null, null),
    ...
    protected BaseResult execute() {
        ...
        result.setTextTransformationChoices(textControl.getTextTransformationChoices(defaultTextTransformationChoice, getPreferredLanguage(), allowNullChoice));
