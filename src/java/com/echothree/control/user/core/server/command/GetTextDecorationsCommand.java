...
import com.echothree.control.user.core.remote.result.GetTextDecorationsResult;
...
public class GetTextDecorationsCommand
        extends BaseMultipleEntitiesCommand<TextDecoration, GetTextDecorationsForm> {
    ...
    public GetTextDecorationsCommand(UserVisitPK userVisitPK, GetTextDecorationsForm form) {
