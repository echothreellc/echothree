...
public class CreateEntityAliasTypeDescriptionCommand
        extends BaseSimpleCommand<CreateEntityAliasTypeDescriptionForm> {
    ...
    /** Creates a new instance of CreateEntityAliasTypeDescriptionCommand */
    public CreateEntityAliasTypeDescriptionCommand(UserVisitPK userVisitPK, CreateEntityAliasTypeDescriptionForm form) {
        ...
        if(componentVendor != null) {
            ...
            if(entityType != null) {
                ...
                if(entityAliasType != null) {
                    ...
                    if(language != null) {
                        EntityAliasTypeDescription entityAliasTypeDescription = coreControl.getEntityAliasTypeDescription(entityAliasType, language);
