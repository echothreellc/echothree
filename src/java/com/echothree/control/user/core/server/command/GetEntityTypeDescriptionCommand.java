...
import com.echothree.control.user.core.remote.form.GetEntityTypeDescriptionForm;
import com.echothree.control.user.core.remote.result.CoreResultFactory;
import com.echothree.control.user.core.remote.result.GetEntityTypeDescriptionResult;
...
public class GetEntityTypeDescriptionCommand
    ...
    /** Creates a new instance of GetEntityTypeDescriptionCommand */
    public GetEntityTypeDescriptionCommand(UserVisitPK userVisitPK, GetEntityTypeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetEntityTypeDescriptionResult result = CoreResultFactory.getGetEntityTypeDescriptionResult();
