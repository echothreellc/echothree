...
public class GetCommandMessageTypeDescriptionsCommand
    ...
    protected BaseResult execute() {
        ...
        var result = CoreResultFactory.getGetCommandMessageTypeDescriptionsResult();
        ...
        if(commandMessageType != null) {
            ...
            result.setCommandMessageTypeDescriptions(commandControl.getCommandMessageTypeDescriptionTransfers(getUserVisit(), commandMessageType));
        } else {
