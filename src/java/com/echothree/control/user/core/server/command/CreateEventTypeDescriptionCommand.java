...
import com.echothree.control.user.core.remote.form.CreateEventTypeDescriptionForm;
...
public class CreateEventTypeDescriptionCommand
        extends BaseSimpleCommand<CreateEventTypeDescriptionForm> {
    ...
    protected BaseResult execute() {
        ...
        if(eventType != null) {
            ...
            addExecutionError(ExecutionErrors.UnknownEventTypeName.name(), eventTypeName);
        }
