...
import com.echothree.control.user.core.remote.form.GetCommandDescriptionsForm;
import com.echothree.control.user.core.remote.result.CoreResultFactory;
import com.echothree.control.user.core.remote.result.GetCommandDescriptionsResult;
...
public class GetCommandDescriptionsCommand
        extends BaseSimpleCommand<GetCommandDescriptionsForm> {
    ...
    /** Creates a new instance of GetCommandDescriptionsCommand */
    public GetCommandDescriptionsCommand(UserVisitPK userVisitPK, GetCommandDescriptionsForm form) {
