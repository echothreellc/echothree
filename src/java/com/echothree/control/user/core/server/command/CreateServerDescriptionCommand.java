...
public class CreateServerDescriptionCommand
        extends BaseSimpleCommand<CreateServerDescriptionForm> {
    ...
    /** Creates a new instance of CreateServerDescriptionCommand */
    public CreateServerDescriptionCommand(UserVisitPK userVisitPK, CreateServerDescriptionForm form) {
        ...
        if(server != null) {
            ...
            if(language != null) {
                ...
                if(serverDescription == null) {
                    ...
                    serverControl.createServerDescription(server, language, description, getPartyPK());
                } else {
                    addExecutionError(ExecutionErrors.DuplicateServerDescription.name());
                }
            } else {
