...
public class GetCommandMessageCommand
    ...
    public GetCommandMessageCommand(UserVisitPK userVisitPK, GetCommandMessageForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(commandMessageType != null) {
            ...
            if(commandMessage != null) {
                ...
                sendEventUsingNames(commandMessage.getPrimaryKey(), EventTypes.READ.name(), null, null, getPartyPK());
            } else {
