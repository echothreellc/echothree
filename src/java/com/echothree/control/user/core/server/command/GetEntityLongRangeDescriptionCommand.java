...
import com.echothree.control.user.core.remote.form.GetEntityLongRangeDescriptionForm;
import com.echothree.control.user.core.remote.result.CoreResultFactory;
import com.echothree.control.user.core.remote.result.GetEntityLongRangeDescriptionResult;
...
public class GetEntityLongRangeDescriptionCommand
        extends BaseSimpleCommand<GetEntityLongRangeDescriptionForm> {
    ...
    /** Creates a new instance of GetEntityLongRangeDescriptionCommand */
    public GetEntityLongRangeDescriptionCommand(UserVisitPK userVisitPK, GetEntityLongRangeDescriptionForm form) {
