...
import com.echothree.control.user.core.remote.form.GetTextDecorationDescriptionForm;
import com.echothree.control.user.core.remote.result.CoreResultFactory;
import com.echothree.control.user.core.remote.result.GetTextDecorationDescriptionResult;
...
public class GetTextDecorationDescriptionCommand
        extends BaseSimpleCommand<GetTextDecorationDescriptionForm> {
    ...
    public GetTextDecorationDescriptionCommand(UserVisitPK userVisitPK, GetTextDecorationDescriptionForm form) {
