...
public class GetCommandMessageTypeCommand
        extends BaseSimpleCommand<GetCommandMessageTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.CommandMessageType.name(), SecurityRoles.Review.name())
                        )))
                )));
    ...
    public GetCommandMessageTypeCommand(UserVisitPK userVisitPK, GetCommandMessageTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetCommandMessageTypeResult result = CoreResultFactory.getGetCommandMessageTypeResult();
        ...
        if(commandMessageType != null) {
            ...
            sendEventUsingNames(commandMessageType.getPrimaryKey(), EventTypes.READ.name(), null, null, getPartyPK());
        } else {
