...
public class GetCommandMessageTypeCommand
        extends BaseSingleEntityCommand<CommandMessageType, GetCommandMessageTypeForm> {
    ...
    @Override
    protected CommandMessageType getEntity() {
    ...
    @Override
    protected BaseResult getResult(CommandMessageType commandMessageType) {
