...
public class GetApplicationEditorChoicesCommand
        extends BaseSimpleCommand<GetApplicationEditorChoicesForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.ApplicationEditor.name(), SecurityRoles.Choices.name())
                        )))
                )));
    ...
    /** Creates a new instance of GetApplicationEditorChoicesCommand */
    public GetApplicationEditorChoicesCommand(UserVisitPK userVisitPK, GetApplicationEditorChoicesForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(!hasExecutionErrors()) {
            ...
            result.setApplicationEditorChoices(applicationControl.getApplicationEditorChoices(defaultEditorChoice, getPreferredLanguage(), allowNullChoice, application));
        }
