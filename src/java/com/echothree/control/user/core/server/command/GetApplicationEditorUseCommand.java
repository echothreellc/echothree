...
@Dependent
public class GetApplicationEditorUseCommand
        extends BaseSingleEntityCommand<ApplicationEditorUse, GetApplicationEditorUseForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(List.of(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), List.of(
                        new SecurityRoleDefinition(SecurityRoleGroups.ApplicationEditorUse.name(), SecurityRoles.Review.name())
                ))
        ));
    ...
    @Override
    protected ApplicationEditorUse getEntity() {
        ...
        if(!hasExecutionErrors()) {
            ...
            applicationEditorUse = applicationLogic.getApplicationEditorUseByName(this, application, applicationEditorUseName);
        }
    ...
    @Override
    protected BaseResult getResult(ApplicationEditorUse applicationEditorUse) {
        var result = CoreResultFactory.getGetApplicationEditorUseResult();
