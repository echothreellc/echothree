...
public class GetApplicationEditorUseCommand
        extends BaseSimpleCommand<GetApplicationEditorUseForm> {
    ...
    protected BaseResult execute() {
        GetApplicationEditorUseResult result = CoreResultFactory.getGetApplicationEditorUseResult();
        ...
        if(!hasExecutionErrors()) {
            ...
            if(applicationEditorUse != null) {
                ...
                sendEventUsingNames(applicationEditorUse.getPrimaryKey(), EventTypes.READ.name(), null, null, getPartyPK());
            } else {
