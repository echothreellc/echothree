...
import com.echothree.control.user.core.remote.form.CreateCommandMessageTranslationForm;
...
public class CreateCommandMessageTranslationCommand
        extends BaseSimpleCommand<CreateCommandMessageTranslationForm> {
    ...
    public CreateCommandMessageTranslationCommand(UserVisitPK userVisitPK, CreateCommandMessageTranslationForm form) {
