...
import com.echothree.control.user.core.remote.form.DeleteAppearanceDescriptionForm;
...
public class DeleteAppearanceDescriptionCommand
        extends BaseSimpleCommand<DeleteAppearanceDescriptionForm> {
    ...
    protected BaseResult execute() {
        ...
        if(appearance != null) {
            ...
            if(language != null) {
                AppearanceDescription appearanceDescription = coreControl.getAppearanceDescriptionForUpdate(appearance, language);
