...
import com.echothree.control.user.core.remote.form.GetEntityAttributeGroupDescriptionsForm;
import com.echothree.control.user.core.remote.result.CoreResultFactory;
import com.echothree.control.user.core.remote.result.GetEntityAttributeGroupDescriptionsResult;
...
public class GetEntityAttributeGroupDescriptionsCommand
        extends BaseSimpleCommand<GetEntityAttributeGroupDescriptionsForm> {
    ...
    /** Creates a new instance of GetEntityAttributeGroupDescriptionsCommand */
    public GetEntityAttributeGroupDescriptionsCommand(UserVisitPK userVisitPK, GetEntityAttributeGroupDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(entityAttributeGroup != null) {
            ...
            result.setEntityAttributeGroupDescriptions(coreControl.getEntityAttributeGroupDescriptionTransfers(getUserVisit(), entityAttributeGroup, null));
        } else {
