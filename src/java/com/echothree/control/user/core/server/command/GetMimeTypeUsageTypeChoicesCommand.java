...
public class GetMimeTypeUsageTypeChoicesCommand
        extends BaseSimpleCommand<GetMimeTypeUsageTypeChoicesForm> {
    
    private final static List<FieldDefinition> FORM_FIELD_DEFINITIONS;
    
    static {
        FORM_FIELD_DEFINITIONS = Collections.unmodifiableList(Arrays.asList(
                new FieldDefinition("DefaultMimeTypeUsageTypeChoice", FieldType.ENTITY_NAME, false, null, null),
