...
import com.echothree.control.user.core.remote.form.DeleteProtocolForm;
...
public class DeleteProtocolCommand
        extends BaseSimpleCommand<DeleteProtocolForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.Protocol.name(), SecurityRoles.Delete.name())
                        )))
                )));
