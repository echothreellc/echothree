...
public class DeleteColorDescriptionCommand
        extends BaseSimpleCommand<DeleteColorDescriptionForm> {
    ...
    /** Creates a new instance of DeleteColorDescriptionCommand */
    public DeleteColorDescriptionCommand(UserVisitPK userVisitPK, DeleteColorDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(color != null) {
            ...
            if(language != null) {
                var colorDescription = colorControl.getColorDescriptionForUpdate(color, language);
                
                if(colorDescription != null) {
                    colorControl.deleteColorDescription(colorDescription, getPartyPK());
                } else {
