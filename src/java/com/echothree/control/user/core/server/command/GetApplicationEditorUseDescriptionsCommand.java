...
import com.echothree.control.user.core.remote.form.GetApplicationEditorUseDescriptionsForm;
import com.echothree.control.user.core.remote.result.CoreResultFactory;
import com.echothree.control.user.core.remote.result.GetApplicationEditorUseDescriptionsResult;
...
public class GetApplicationEditorUseDescriptionsCommand
    ...
    public GetApplicationEditorUseDescriptionsCommand(UserVisitPK userVisitPK, GetApplicationEditorUseDescriptionsForm form) {
        super(userVisitPK, form, COMMAND_SECURITY_DEFINITION, FORM_FIELD_DEFINITIONS, false);
    }
    
    @Override
    protected BaseResult execute() {
        GetApplicationEditorUseDescriptionsResult result = CoreResultFactory.getGetApplicationEditorUseDescriptionsResult();
        ...
        if(!hasExecutionErrors()) {
            ...
            if(applicationEditorUse != null) {
                ...
                result.setApplicationEditorUseDescriptions(coreControl.getApplicationEditorUseDescriptionTransfersByApplicationEditorUse(getUserVisit(), applicationEditorUse));
            } else {
