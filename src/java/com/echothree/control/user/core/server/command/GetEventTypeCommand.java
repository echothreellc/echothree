...
public class GetEventTypeCommand
        extends BaseSingleEntityCommand<EventType, GetEventTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(List.of(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), List.of(
                        new SecurityRoleDefinition(SecurityRoleGroups.EventType.name(), SecurityRoles.Review.name())
                ))
        ));
        
        FORM_FIELD_DEFINITIONS = List.of(
                new FieldDefinition("EventTypeName", FieldType.ENTITY_NAME, false, null, null),
    ...
    @Override
    protected BaseResult getResult(EventType eventType) {
        var result = CoreResultFactory.getGetEventTypeResult();

        if(eventType != null) {
            result.setEventType(eventControl.getEventTypeTransfer(getUserVisit(), eventType));
        }
