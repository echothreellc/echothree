...
public class DeleteServerCommand
        extends BaseSimpleCommand<DeleteServerForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.Server.name(), SecurityRoles.Delete.name())
                        )))
                )));
    ...
    /** Creates a new instance of DeleteServerCommand */
    public DeleteServerCommand(UserVisitPK userVisitPK, DeleteServerForm form) {
    ...
    protected BaseResult execute() {
        ...
        var server = serverControl.getServerByNameForUpdate(serverName);
        
        if(server != null) {
            serverControl.deleteServer(server, getPartyPK());
        } else {
