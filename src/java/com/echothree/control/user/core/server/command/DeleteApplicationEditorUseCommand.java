...
import com.echothree.control.user.core.remote.form.DeleteApplicationEditorUseForm;
...
public class DeleteApplicationEditorUseCommand
        extends BaseSimpleCommand<DeleteApplicationEditorUseForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.ApplicationEditorUse.name(), SecurityRoles.Delete.name())
                        )))
                )));
