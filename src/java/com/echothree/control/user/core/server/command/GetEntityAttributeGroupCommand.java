...
public class GetEntityAttributeGroupCommand
        extends BaseSimpleCommand<GetEntityAttributeGroupForm> {
    ...
    protected BaseResult execute() {
        ...
        GetEntityAttributeGroupResult result = CoreResultFactory.getGetEntityAttributeGroupResult();
        ...
        if(entityAttributeGroup != null) {
            ...
            sendEventUsingNames(entityAttributeGroup.getPrimaryKey(), EventTypes.READ.name(), null, null, getPartyPK());
        } else {
