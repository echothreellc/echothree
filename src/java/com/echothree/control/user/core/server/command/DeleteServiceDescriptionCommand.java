...
import com.echothree.control.user.core.remote.form.DeleteServiceDescriptionForm;
...
public class DeleteServiceDescriptionCommand
        extends BaseSimpleCommand<DeleteServiceDescriptionForm> {
    ...
    public DeleteServiceDescriptionCommand(UserVisitPK userVisitPK, DeleteServiceDescriptionForm form) {
