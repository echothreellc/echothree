...
public class GetTextDecorationCommand
    ...
    protected TextDecoration getEntity() {
        ...
        var parameterCount = (textDecorationName == null ? 0 : 1) + entityInstanceLogic.countPossibleEntitySpecs(form);
        ...
        if(parameterCount == 1) {
            if(textDecorationName == null) {
                ...
                textDecoration = textLogic.getTextDecorationByName(this, textDecorationName);
            }
