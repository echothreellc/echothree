...
import com.echothree.control.user.core.remote.form.GetFontWeightDescriptionsForm;
import com.echothree.control.user.core.remote.result.CoreResultFactory;
import com.echothree.control.user.core.remote.result.GetFontWeightDescriptionsResult;
...
public class GetFontWeightDescriptionsCommand
        extends BaseSimpleCommand<GetFontWeightDescriptionsForm> {
    ...
    protected BaseResult execute() {
        ...
        GetFontWeightDescriptionsResult result = CoreResultFactory.getGetFontWeightDescriptionsResult();
