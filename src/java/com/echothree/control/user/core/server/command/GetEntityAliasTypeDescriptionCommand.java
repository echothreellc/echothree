...
public class GetEntityAliasTypeDescriptionCommand
    ...
    public GetEntityAliasTypeDescriptionCommand(UserVisitPK userVisitPK, GetEntityAliasTypeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetEntityAliasTypeDescriptionResult result = CoreResultFactory.getGetEntityAliasTypeDescriptionResult();
