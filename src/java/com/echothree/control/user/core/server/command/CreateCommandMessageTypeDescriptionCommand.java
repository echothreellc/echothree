...
public class CreateCommandMessageTypeDescriptionCommand
        extends BaseSimpleCommand<CreateCommandMessageTypeDescriptionForm> {
    ...
    /** Creates a new instance of CreateCommandMessageTypeDescriptionCommand */
    public CreateCommandMessageTypeDescriptionCommand(UserVisitPK userVisitPK, CreateCommandMessageTypeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(commandMessageType != null) {
            ...
            if(language != null) {
                var commandMessageTypeDescription = coreControl.getCommandMessageTypeDescription(commandMessageType, language);
                ...
                if(commandMessageTypeDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateCommandMessageTypeDescription.name());
                }
            } else {
