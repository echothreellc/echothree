...
import com.echothree.control.user.core.remote.form.GetAppearanceDescriptionForm;
import com.echothree.control.user.core.remote.result.CoreResultFactory;
import com.echothree.control.user.core.remote.result.GetAppearanceDescriptionResult;
...
public class GetAppearanceDescriptionCommand
        extends BaseSimpleCommand<GetAppearanceDescriptionForm> {
    ...
    /** Creates a new instance of GetAppearanceDescriptionCommand */
    public GetAppearanceDescriptionCommand(UserVisitPK userVisitPK, GetAppearanceDescriptionForm form) {
