...
public class CreateMimeTypeUsageTypeCommand
        extends BaseSimpleCommand<CreateMimeTypeUsageTypeForm> {
    ...
    public CreateMimeTypeUsageTypeCommand(UserVisitPK userVisitPK, CreateMimeTypeUsageTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(mimeTypeUsageType == null) {
            ...
            mimeTypeControl.createMimeTypeUsageType(mimeTypeUsageTypeName, isDefault, sortOrder);
        } else {
            addExecutionError(ExecutionErrors.DuplicateMimeTypeUsageTypeName.name(), mimeTypeUsageTypeName);
        }
