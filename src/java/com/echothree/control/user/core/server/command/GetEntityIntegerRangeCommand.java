...
import com.echothree.control.user.core.remote.form.GetEntityIntegerRangeForm;
import com.echothree.control.user.core.remote.result.CoreResultFactory;
import com.echothree.control.user.core.remote.result.GetEntityIntegerRangeResult;
...
public class GetEntityIntegerRangeCommand
        extends BaseSimpleCommand<GetEntityIntegerRangeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.EntityIntegerRange.name(), SecurityRoles.Review.name())
                        )))
                )));
    ...
    public GetEntityIntegerRangeCommand(UserVisitPK userVisitPK, GetEntityIntegerRangeForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetEntityIntegerRangeResult result = CoreResultFactory.getGetEntityIntegerRangeResult();
