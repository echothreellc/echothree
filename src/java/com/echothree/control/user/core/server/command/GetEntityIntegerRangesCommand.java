...
import com.echothree.control.user.core.remote.form.GetEntityIntegerRangesForm;
import com.echothree.control.user.core.remote.result.CoreResultFactory;
import com.echothree.control.user.core.remote.result.GetEntityIntegerRangesResult;
...
public class GetEntityIntegerRangesCommand
        extends BaseSimpleCommand<GetEntityIntegerRangesForm> {
    ...
    protected BaseResult execute() {
        ...
        GetEntityIntegerRangesResult result = CoreResultFactory.getGetEntityIntegerRangesResult();
            ...
            if(entityType != null) {
                ...
                if(entityAttribute != null) {
                    ...
                    if(entityAttributeTypeName.equals(EntityAttributeTypes.INTEGER.name())) {
                        ...
                        result.setEntityIntegerRanges(coreControl.getEntityIntegerRangeTransfersByEntityAttribute(getUserVisit(), entityAttribute, null));
                    } else {
