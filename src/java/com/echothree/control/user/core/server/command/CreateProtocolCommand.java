...
import com.echothree.control.user.core.remote.form.CreateProtocolForm;
...
public class CreateProtocolCommand
        extends BaseSimpleCommand<CreateProtocolForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.Protocol.name(), SecurityRoles.Create.name())
                        )))
                )));
    ...
    protected BaseResult execute() {
        ...
        if(protocol == null) {
            ...
            protocol = coreControl.createProtocol(protocolName, isDefault, sortOrder, partyPK);
