...
import com.echothree.control.user.core.remote.form.CreateTextTransformationForm;
...
public class CreateTextTransformationCommand
        extends BaseSimpleCommand<CreateTextTransformationForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.TextTransformation.name(), SecurityRoles.Create.name())
                        )))
                )));
    ...
    public CreateTextTransformationCommand(UserVisitPK userVisitPK, CreateTextTransformationForm form) {
