...
import com.echothree.control.user.core.remote.form.GetPartyEntityTypesForm;
import com.echothree.control.user.core.remote.result.CoreResultFactory;
import com.echothree.control.user.core.remote.result.GetPartyEntityTypesResult;
...
public class GetPartyEntityTypesCommand
    ...
    protected BaseResult execute() {
        ...
        GetPartyEntityTypesResult result = CoreResultFactory.getGetPartyEntityTypesResult();
        ...
        if(party != null) {
            ...
            result.setPartyEntityTypes(coreControl.getPartyEntityTypeTransfersByParty(getUserVisit(), party));
        } else {
