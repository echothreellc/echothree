...
import com.echothree.control.user.core.common.result.GetFontWeightDescriptionResult;
...
public class GetFontWeightDescriptionCommand
        extends BaseSimpleCommand<GetFontWeightDescriptionForm> {
    ...
    /** Creates a new instance of GetFontWeightDescriptionCommand */
    public GetFontWeightDescriptionCommand(UserVisitPK userVisitPK, GetFontWeightDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        var result = CoreResultFactory.getGetFontWeightDescriptionResult();
        ...
        if(fontWeight != null) {
            ...
            if(language != null) {
                var fontWeightDescription = coreControl.getFontWeightDescription(fontWeight, language);
