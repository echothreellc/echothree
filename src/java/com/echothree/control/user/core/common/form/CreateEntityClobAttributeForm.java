...
public interface CreateEntityClobAttributeForm
        extends EntityClobAttributeSpec, EntityClobAttributeEdit {
    
    // Nothing additional beyond EntityClobAttributeSpec, EntityClobAttributeEdit
