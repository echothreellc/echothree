...
public interface GetCommandMessageTypeDescriptionsResult
        extends BaseResult {
    
    CommandMessageTypeTransfer getCommandMessageType();
    void setCommandMessageType(CommandMessageTypeTransfer commandMessageType);
    
    List<CommandMessageTypeDescriptionTransfer> getCommandMessageTypeDescriptions();
    void setCommandMessageTypeDescriptions(List<CommandMessageTypeDescriptionTransfer> commandMessageTypeDescriptions);
