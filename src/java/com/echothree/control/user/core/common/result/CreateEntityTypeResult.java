...
public interface CreateEntityTypeResult
        extends EntityRefSpec, EntityTypeSpec, BaseResult {

    // Nothing additional beyond EntityRefSpec, EntityTypeSpec, BaseResult
