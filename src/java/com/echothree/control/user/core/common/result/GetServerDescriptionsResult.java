...
public interface GetServerDescriptionsResult
        extends BaseResult {
    
    ServerTransfer getServer();
    void setServer(ServerTransfer server);
    
    List<ServerDescriptionTransfer> getServerDescriptions();
    void setServerDescriptions(List<ServerDescriptionTransfer> serverDescriptions);
