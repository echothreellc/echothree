...
public interface CreateEntityAttributeGroupResult
        extends EntityAttributeGroupSpec, EntityRefSpec, BaseResult {
    
    // Nothing additional beyond EntityAttributeGroupSpec, EntityRefSpec, BaseResult
