...
public interface CreateMimeTypeDescriptionForm
        extends MimeTypeDescriptionSpec, MimeTypeDescriptionEdit {
    
    // Nothing additional beyond MimeTypeDescriptionSpec, MimeTypeDescriptionEdit
