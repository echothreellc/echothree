...
public interface EditEntityListItemAttributeResult
        extends BaseEditResult<EntityListItemAttributeEdit> {
    
    EntityListItemAttributeTransfer getEntityListItemAttribute();
    void setEntityListItemAttribute(EntityListItemAttributeTransfer entityListItemAttribute);
