...
public interface EditEntityAttributeDescriptionResult
        extends BaseEditResult<EntityAttributeDescriptionEdit> {
    
    EntityAttributeDescriptionTransfer getEntityAttributeDescription();
    void setEntityAttributeDescription(EntityAttributeDescriptionTransfer entityAttributeDescription);
