...
public interface CreateEntityLongAttributeForm
        extends EntityLongAttributeSpec, EntityLongAttributeEdit {
    
    // Nothing additional beyond EntityLongAttributeSpec, EntityLongAttributeEdit
