...
public interface CreateServiceDescriptionForm
        extends ServiceDescriptionSpec, ServiceDescriptionEdit {
    
    // Nothing additional beyond ServiceDescriptionSpec, ServiceDescriptionEdit
