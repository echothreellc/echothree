...
public interface EditEntityStringAttributeResult
        extends BaseEditResult<EntityStringAttributeEdit> {
    
    EntityStringAttributeTransfer getEntityStringAttribute();
    void setEntityStringAttribute(EntityStringAttributeTransfer entityStringAttribute);
