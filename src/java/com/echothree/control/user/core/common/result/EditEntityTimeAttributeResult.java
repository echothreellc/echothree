...
public interface EditEntityTimeAttributeResult
        extends BaseEditResult<EntityTimeAttributeEdit> {
    
    EntityTimeAttributeTransfer getEntityTimeAttribute();
    void setEntityTimeAttribute(EntityTimeAttributeTransfer entityTimeAttribute);
