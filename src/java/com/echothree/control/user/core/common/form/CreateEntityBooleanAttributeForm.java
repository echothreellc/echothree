...
public interface CreateEntityBooleanAttributeForm
        extends EntityBooleanAttributeSpec, EntityBooleanAttributeEdit {
    
    // Nothing additional beyond EntityBooleanAttributeSpec, EntityBooleanAttributeEdit
