...
public interface EditEntityBooleanDefaultResult
        extends BaseEditResult<EntityBooleanDefaultEdit> {
    
    EntityBooleanDefaultTransfer getEntityBooleanDefault();
    void setEntityBooleanDefault(EntityBooleanDefaultTransfer entityBooleanDefault);
