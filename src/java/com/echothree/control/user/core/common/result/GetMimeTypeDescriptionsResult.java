...
public interface GetMimeTypeDescriptionsResult
        extends BaseResult {
    
    MimeTypeTransfer getMimeType();
    void setMimeType(MimeTypeTransfer mimeType);
    
    List<MimeTypeDescriptionTransfer> getMimeTypeDescriptions();
    void setMimeTypeDescriptions(List<MimeTypeDescriptionTransfer> mimeTypeDescriptions);
