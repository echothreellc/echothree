...
public interface CreateEntityAliasTypeForm
        extends EntityTypeUniversalSpec, EntityAliasTypeEdit {
    
    // Nothing additional beyond EntityTypeUniversalSpec, EntityAliasTypeEdit
