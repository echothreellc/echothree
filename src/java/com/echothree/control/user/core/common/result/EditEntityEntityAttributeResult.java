...
public interface EditEntityEntityAttributeResult
        extends BaseEditResult<EntityEntityAttributeEdit> {
    
    EntityEntityAttributeTransfer getEntityEntityAttribute();
    void setEntityEntityAttribute(EntityEntityAttributeTransfer entityEntityAttribute);
