...
public interface EditEntityAliasResult
        extends BaseEditResult<EntityAliasEdit> {
    
    EntityAliasTransfer getEntityAlias();
    void setEntityAlias(EntityAliasTransfer entityAlias);
