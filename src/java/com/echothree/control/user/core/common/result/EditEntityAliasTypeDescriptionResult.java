...
public interface EditEntityAliasTypeDescriptionResult
        extends BaseEditResult<EntityAliasTypeDescriptionEdit> {
    
    EntityAliasTypeDescriptionTransfer getEntityAliasTypeDescription();
    void setEntityAliasTypeDescription(EntityAliasTypeDescriptionTransfer entityAliasTypeDescription);
