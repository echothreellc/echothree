...
public interface GetApplicationEditorUseChoicesForm
        extends ApplicationSpec {
    
    String getDefaultApplicationEditorUseChoice();
    void setDefaultApplicationEditorUseChoice(String defaultApplicationEditorUseChoice);
