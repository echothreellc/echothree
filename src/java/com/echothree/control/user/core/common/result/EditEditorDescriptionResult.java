...
public interface EditEditorDescriptionResult
        extends BaseEditResult<EditorDescriptionEdit> {
    
    EditorDescriptionTransfer getEditorDescription();
    void setEditorDescription(EditorDescriptionTransfer editorDescription);
