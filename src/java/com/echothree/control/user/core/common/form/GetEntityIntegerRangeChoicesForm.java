...
public interface GetEntityIntegerRangeChoicesForm
        extends EntityRefSpec, EntityAttributeSpec {
    
    String getDefaultEntityIntegerRangeChoice();
    void setDefaultEntityIntegerRangeChoice(String defaultEntityIntegerRangeChoice);
