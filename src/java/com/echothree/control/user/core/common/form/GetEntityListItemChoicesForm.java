...
public interface GetEntityListItemChoicesForm
        extends EntityRefSpec, EntityAttributeSpec {
    
    String getDefaultEntityListItemChoice();
    void setDefaultEntityListItemChoice(String defaultEntityListItemChoice);
