...
public interface CreateAppearanceResult
        extends AppearanceSpec, EntityRefSpec, BaseResult {
    
    // Nothing additional beyond AppearanceSpec, EntityRefSpec, BaseResult
