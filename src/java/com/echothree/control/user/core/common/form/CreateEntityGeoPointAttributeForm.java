...
public interface CreateEntityGeoPointAttributeForm
        extends EntityGeoPointAttributeSpec, EntityGeoPointAttributeEdit {
    
    // Nothing additional beyond EntityGeoPointAttributeSpec, EntityGeoPointAttributeEdit
