...
public interface EditEntityGeoPointAttributeResult
        extends BaseEditResult<EntityGeoPointAttributeEdit> {
    
    EntityGeoPointAttributeTransfer getEntityGeoPointAttribute();
    void setEntityGeoPointAttribute(EntityGeoPointAttributeTransfer entityGeoPointAttribute);
