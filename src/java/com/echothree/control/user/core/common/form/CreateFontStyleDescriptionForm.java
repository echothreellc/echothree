...
public interface CreateFontStyleDescriptionForm
        extends FontStyleDescriptionSpec, FontStyleDescriptionEdit {
    
    // Nothing additional beyond FontStyleDescriptionSpec, FontStyleDescriptionEdit
