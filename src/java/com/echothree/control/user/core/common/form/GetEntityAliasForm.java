...
public interface GetEntityAliasForm
        extends EntityAliasTypeUniversalSpec, EntityAliasEdit {
    
    // Nothing additional beyond EntityAliasTypeUniversalSpec, EntityAliasEdit
