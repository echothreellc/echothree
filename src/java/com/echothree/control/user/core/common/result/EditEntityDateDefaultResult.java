...
public interface EditEntityDateDefaultResult
        extends BaseEditResult<EntityDateDefaultEdit> {
    
    EntityDateDefaultTransfer getEntityDateDefault();
    void setEntityDateDefault(EntityDateDefaultTransfer entityDateDefault);
