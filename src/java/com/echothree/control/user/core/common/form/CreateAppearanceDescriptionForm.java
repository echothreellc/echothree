...
public interface CreateAppearanceDescriptionForm
        extends AppearanceDescriptionSpec, AppearanceDescriptionEdit {
    
    // Nothing additional beyond AppearanceDescriptionSpec, AppearanceDescriptionEdit
