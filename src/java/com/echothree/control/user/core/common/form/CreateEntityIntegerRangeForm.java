...
public interface CreateEntityIntegerRangeForm
        extends EntityIntegerRangeSpec, EntityIntegerRangeEdit {
    
    // Nothing additional beyond EntityIntegerRangeSpec, EntityIntegerRangeEdit
