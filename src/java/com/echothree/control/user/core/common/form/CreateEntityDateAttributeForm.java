...
public interface CreateEntityDateAttributeForm
        extends EntityDateAttributeSpec, EntityDateAttributeEdit {
    
    // Nothing additional beyond EntityDateAttributeSpec, EntityDateAttributeEdit
