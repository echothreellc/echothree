...
public class GetTaxDescriptionsCommand
        extends BaseSimpleCommand<GetTaxDescriptionsForm> {
    ...
    public GetTaxDescriptionsCommand(UserVisitPK userVisitPK, GetTaxDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(tax != null) {
            ...
            result.setTaxDescriptions(taxControl.getTaxDescriptionTransfersByTax(getUserVisit(), tax));
        } else {
