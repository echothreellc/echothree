...
public class CreateTaxClassificationCommand
        extends BaseSimpleCommand<CreateTaxClassificationForm> {
    ...
    /** Creates a new instance of CreateTaxClassificationCommand */
    public CreateTaxClassificationCommand(UserVisitPK userVisitPK, CreateTaxClassificationForm form) {
        ...
        if(geoCode != null) {
            ...
            if(taxClassification == null) {
                ...
                if(!hasExecutionErrors()) {
                    ...
                    if(description != null) {
                        taxControl.createTaxClassificationTranslation(taxClassification, getPreferredLanguage(), description,
                                overviewMimeType, overview, partyPK);
                    }
                }
            } else {
                addExecutionError(ExecutionErrors.DuplicateTaxClassificationName.name(), countryName, taxClassificationName);
            }
        } else {
