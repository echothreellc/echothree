...
import com.echothree.control.user.tax.common.form.GetTaxClassificationTranslationsForm;
import com.echothree.control.user.tax.common.result.GetTaxClassificationTranslationsResult;
...
public class GetTaxClassificationTranslationsCommand
        extends BaseSimpleCommand<GetTaxClassificationTranslationsForm> {
    ...
    public GetTaxClassificationTranslationsCommand(UserVisitPK userVisitPK, GetTaxClassificationTranslationsForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(geoCode != null) {
            ...
            if(taxClassification != null) {
                ...
                result.setTaxClassificationTranslations(taxControl.getTaxClassificationTranslationTransfersByTaxClassification(getUserVisit(), taxClassification));
            } else {
