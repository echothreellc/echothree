...
import com.echothree.control.user.tax.remote.form.DeleteTaxForm;
...
public class DeleteTaxCommand
        extends BaseSimpleCommand<DeleteTaxForm> {
    ...
    /** Creates a new instance of DeleteTaxCommand */
    public DeleteTaxCommand(UserVisitPK userVisitPK, DeleteTaxForm form) {
