...
public class CreateGeoCodeTaxCommand
        extends BaseSimpleCommand<CreateGeoCodeTaxForm> {
    ...
    protected BaseResult execute() {
        ...
        if(tax != null) {
            ...
            if(geoCode != null) {
                GeoCodeTax geoCodeTax = taxControl.getGeoCodeTax(geoCode, tax);
                
                if(geoCodeTax == null) {
                    taxControl.createGeoCodeTax(geoCode, tax, getPartyPK());
                } else {
                    addExecutionError(ExecutionErrors.DuplicateGeoCodeTax.name());
                }
            } else {
