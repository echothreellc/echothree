...
@Dependent
public class GetItemTaxClassificationCommand
        extends BaseSingleEntityCommand<ItemTaxClassification, GetItemTaxClassificationForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(List.of(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), List.of(
                        new SecurityRoleDefinition(SecurityRoleGroups.ItemTaxClassification.name(), SecurityRoles.Review.name())
                ))
        ));
    ...
    @Override
    protected ItemTaxClassification getEntity() {
    ...
    @Override
    protected BaseResult getResult(ItemTaxClassification itemTaxClassification) {
        var result = TaxResultFactory.getGetItemTaxClassificationResult();
