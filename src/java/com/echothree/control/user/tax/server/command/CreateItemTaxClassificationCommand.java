...
import com.echothree.control.user.tax.remote.form.CreateItemTaxClassificationForm;
...
public class CreateItemTaxClassificationCommand
    ...
    public CreateItemTaxClassificationCommand(UserVisitPK userVisitPK, CreateItemTaxClassificationForm form) {
        ...
        if(item != null) {
            ...
            if(countryGeoCode != null) {
                ...
                if(itemTaxClassification == null) {
                    String harmonizedTariffScheduleCodeName = form.getTaxClassificationName();
                    TaxClassification harmonizedTariffScheduleCode = taxControl.getTaxClassificationByName(countryGeoCode, harmonizedTariffScheduleCodeName);
