...
import com.echothree.control.user.tax.remote.form.CreateTaxDescriptionForm;
...
public class CreateTaxDescriptionCommand
    ...
    public CreateTaxDescriptionCommand(UserVisitPK userVisitPK, CreateTaxDescriptionForm form) {
