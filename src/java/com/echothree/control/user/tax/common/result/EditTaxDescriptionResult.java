...
public interface EditTaxDescriptionResult
        extends BaseEditResult<TaxDescriptionEdit> {
    
    TaxDescriptionTransfer getTaxDescription();
    void setTaxDescription(TaxDescriptionTransfer taxDescription);
