...
public interface GetTaxClassificationChoicesForm
        extends CountrySpec {
    
    String getDefaultTaxClassificationChoice();
    void setDefaultTaxClassificationChoice(String defaultTaxClassificationChoice);
