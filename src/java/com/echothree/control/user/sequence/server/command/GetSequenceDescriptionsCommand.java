...
public class GetSequenceDescriptionsCommand
    ...
    public GetSequenceDescriptionsCommand(UserVisitPK userVisitPK, GetSequenceDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetSequenceDescriptionsResult result = SequenceResultFactory.getGetSequenceDescriptionsResult();
