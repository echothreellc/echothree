...
public class CreateSequenceDescriptionCommand
        extends BaseSimpleCommand<CreateSequenceDescriptionForm> {
    ...
    /** Creates a new instance of CreateSequenceDescriptionCommand */
    public CreateSequenceDescriptionCommand(UserVisitPK userVisitPK, CreateSequenceDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(sequenceType != null) {
            ...
            if(sequence != null) {
                ...
                if(language != null) {
                    var sequenceDescription = sequenceControl.getSequenceDescription(sequence, language);
                    ...
                    if(sequenceDescription == null) {
                        ...
                        addExecutionError(ExecutionErrors.DuplicateSequenceDescription.name());
                    }
                } else {
