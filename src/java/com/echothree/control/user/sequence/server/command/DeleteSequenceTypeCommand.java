...
import com.echothree.control.user.sequence.common.form.DeleteSequenceTypeForm;
...
public class DeleteSequenceTypeCommand
        extends BaseSimpleCommand<DeleteSequenceTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                    new SecurityRoleDefinition(SecurityRoleGroups.SequenceType.name(), SecurityRoles.Delete.name())
                    )))
                )));
    ...
    /** Creates a new instance of DeleteSequenceTypeCommand */
    public DeleteSequenceTypeCommand(UserVisitPK userVisitPK, DeleteSequenceTypeForm form) {
