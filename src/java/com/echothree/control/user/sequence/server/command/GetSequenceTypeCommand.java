...
import com.echothree.control.user.sequence.remote.form.GetSequenceTypeForm;
import com.echothree.control.user.sequence.remote.result.GetSequenceTypeResult;
...
public class GetSequenceTypeCommand
        extends BaseSimpleCommand<GetSequenceTypeForm> {
    ...
    protected BaseResult execute() {
        ...
        GetSequenceTypeResult result = SequenceResultFactory.getGetSequenceTypeResult();
