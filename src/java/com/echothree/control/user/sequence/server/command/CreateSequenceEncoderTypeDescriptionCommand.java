...
public class CreateSequenceEncoderTypeDescriptionCommand
        extends BaseSimpleCommand<CreateSequenceEncoderTypeDescriptionForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                    new SecurityRoleDefinition(SecurityRoleGroups.SequenceEncoderType.name(), SecurityRoles.Description.name())
                    )))
                )));
    ...
    /** Creates a new instance of CreateSequenceEncoderTypeDescriptionCommand */
    public CreateSequenceEncoderTypeDescriptionCommand(UserVisitPK userVisitPK, CreateSequenceEncoderTypeDescriptionForm form) {
        ...
        if(sequenceEncoderType != null) {
            ...
            if(language != null) {
                ...
                if(sequenceEncoderTypeDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateSequenceEncoderTypeDescription.name());
                }
            } else {
