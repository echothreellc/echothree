...
import com.echothree.control.user.sequence.common.form.CreateSequenceChecksumTypeForm;
...
public class CreateSequenceChecksumTypeCommand
        extends BaseSimpleCommand<CreateSequenceChecksumTypeForm> {
    ...
    public CreateSequenceChecksumTypeCommand(UserVisitPK userVisitPK, CreateSequenceChecksumTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(sequenceChecksumType == null) {
            ...
            addExecutionError(ExecutionErrors.DuplicateSequenceChecksumTypeName.name(), sequenceChecksumTypeName);
        }
