...
public class DeleteSequenceTypeDescriptionCommand
        extends BaseSimpleCommand<DeleteSequenceTypeDescriptionForm> {
    ...
    /** Creates a new instance of DeleteSequenceTypeDescriptionCommand */
    public DeleteSequenceTypeDescriptionCommand(UserVisitPK userVisitPK, DeleteSequenceTypeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(sequenceType != null) {
            ...
            if(language != null) {
                SequenceTypeDescription sequenceTypeDescription = sequenceControl.getSequenceTypeDescriptionForUpdate(sequenceType, language);
                
                if(sequenceTypeDescription != null) {
                    sequenceControl.deleteSequenceTypeDescription(sequenceTypeDescription, getPartyPK());
                } else {
                    addExecutionError(ExecutionErrors.UnknownSequenceTypeDescription.name());
                }
            } else {
