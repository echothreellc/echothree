...
import com.echothree.control.user.sequence.common.form.DeleteSequenceForm;
...
public class DeleteSequenceCommand
        extends BaseSimpleCommand<DeleteSequenceForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                    new SecurityRoleDefinition(SecurityRoleGroups.Sequence.name(), SecurityRoles.Delete.name())
                    )))
                )));
    ...
    protected BaseResult execute() {
        ...
        if(sequenceType != null) {
            ...
            Sequence sequence = sequenceControl.getSequenceByNameForUpdate(sequenceType, sequenceName);
            
            if(sequence != null) {
                sequenceControl.deleteSequence(sequence, getPartyPK());
            } else {
