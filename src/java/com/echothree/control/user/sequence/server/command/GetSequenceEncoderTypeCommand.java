...
import com.echothree.model.control.sequence.server.logic.SequenceEncoderTypeLogic;
...
public class GetSequenceEncoderTypeCommand
        extends BaseSingleEntityCommand<SequenceEncoderType, GetSequenceEncoderTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.SequenceEncoderType.name(), SecurityRoles.Review.name())
                )))
        )));
    ...
    public GetSequenceEncoderTypeCommand(UserVisitPK userVisitPK, GetSequenceEncoderTypeForm form) {
    ...
    protected BaseResult getTransfer(SequenceEncoderType sequenceEncoderType) {
        ...
        if(sequenceEncoderType != null) {
            result.setSequenceEncoderType(sequenceControl.getSequenceEncoderTypeTransfer(getUserVisit(), sequenceEncoderType));
        }
