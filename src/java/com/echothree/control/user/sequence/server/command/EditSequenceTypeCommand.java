...
import com.echothree.control.user.sequence.remote.edit.SequenceTypeEdit;
import com.echothree.control.user.sequence.remote.form.EditSequenceTypeForm;
import com.echothree.control.user.sequence.remote.result.EditSequenceTypeResult;
import com.echothree.control.user.sequence.remote.result.SequenceResultFactory;
import com.echothree.control.user.sequence.remote.spec.SequenceTypeSpec;
...
public class EditSequenceTypeCommand
    ...
    public EditSequenceTypeCommand(UserVisitPK userVisitPK, EditSequenceTypeForm form) {
