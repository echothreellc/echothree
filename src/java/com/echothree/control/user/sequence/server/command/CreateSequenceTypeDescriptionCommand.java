...
public class CreateSequenceTypeDescriptionCommand
        extends BaseSimpleCommand<CreateSequenceTypeDescriptionForm> {
    ...
    /** Creates a new instance of CreateSequenceTypeDescriptionCommand */
    public CreateSequenceTypeDescriptionCommand(UserVisitPK userVisitPK, CreateSequenceTypeDescriptionForm form) {
        ...
        if(sequenceType != null) {
            ...
            if(language != null) {
                ...
                if(sequenceTypeDescription == null) {
                    ...
                    sequenceControl.createSequenceTypeDescription(sequenceType, language, description, getPartyPK());
                } else {
                    addExecutionError(ExecutionErrors.DuplicateSequenceTypeDescription.name());
                }
            } else {
