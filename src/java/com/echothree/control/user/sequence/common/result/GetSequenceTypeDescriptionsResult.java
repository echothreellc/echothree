...
public interface GetSequenceTypeDescriptionsResult
        extends BaseResult {
    
    SequenceTypeTransfer getSequenceType();
    void setSequenceType(SequenceTypeTransfer sequenceType);
    
    List<SequenceTypeDescriptionTransfer> getSequenceTypeDescriptions();
    void setSequenceTypeDescriptions(List<SequenceTypeDescriptionTransfer> sequenceTypeDescriptions);
