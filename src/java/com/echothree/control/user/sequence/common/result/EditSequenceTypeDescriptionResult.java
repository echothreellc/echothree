...
public interface EditSequenceTypeDescriptionResult
        extends BaseEditResult<SequenceTypeDescriptionEdit> {
    
    SequenceTypeDescriptionTransfer getSequenceTypeDescription();
    void setSequenceTypeDescription(SequenceTypeDescriptionTransfer sequenceTypeDescription);
