...
public interface EditSequenceDescriptionResult
        extends BaseEditResult<SequenceDescriptionEdit> {
    
    SequenceDescriptionTransfer getSequenceDescription();
    void setSequenceDescription(SequenceDescriptionTransfer sequenceDescription);
