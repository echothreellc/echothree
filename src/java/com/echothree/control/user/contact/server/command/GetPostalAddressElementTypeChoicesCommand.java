...
public class GetPostalAddressElementTypeChoicesCommand
        extends BaseSimpleCommand<GetPostalAddressElementTypeChoicesForm> {

    private final static List<FieldDefinition> FORM_FIELD_DEFINITIONS;

    static {
        FORM_FIELD_DEFINITIONS = Collections.unmodifiableList(Arrays.asList(
                new FieldDefinition("DefaultPostalAddressElementTypeChoice", FieldType.ENTITY_NAME, false, null, null),
                new FieldDefinition("AllowNullChoice", FieldType.BOOLEAN, true, null, null)
                ));
    }
    
    /** Creates a new instance of GetPostalAddressElementTypeChoicesCommand */
    public GetPostalAddressElementTypeChoicesCommand(UserVisitPK userVisitPK, GetPostalAddressElementTypeChoicesForm form) {
