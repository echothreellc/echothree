...
public class GetPostalAddressLinesCommand
        extends BaseSimpleCommand<GetPostalAddressLinesForm> {
    ...
    protected BaseResult execute() {
        ...
        GetPostalAddressLinesResult result = ContactResultFactory.getGetPostalAddressLinesResult();
        ...
        if(postalAddressFormat != null) {
            ...
            result.setPostalAddressLines(contactControl.getPostalAddressLineTransfersByPostalAddressFormat(getUserVisit(), postalAddressFormat));
        } else {
