...
public class CreatePartyContactMechanismRelationshipCommand
        extends BaseSimpleCommand<CreatePartyContactMechanismRelationshipForm> {
                        ...
                        if(toPartyContactMechanism != null) {
                            if(!fromPartyContactMechanism.equals(toPartyContactMechanism)) {
                                ...
                                if(partyContactMechanismRelationship == null) {
                                    ...
                                    addExecutionError(ExecutionErrors.DuplicatePartyContactMechanismRelationship.name(), partyName, fromContactMechanismName, toContactMechanismName);
                                }
                            } else {
                                addExecutionError(ExecutionErrors.InvalidToPartyContactMechanism.name(), partyName, toContactMechanismName);
                            }
                        } else {
