...
public class CreatePostalAddressElementTypeCommand
        extends BaseSimpleCommand<CreatePostalAddressElementTypeForm> {
    ...
    public CreatePostalAddressElementTypeCommand(UserVisitPK userVisitPK, CreatePostalAddressElementTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(postalAddressElementType == null) {
            ...
            contactControl.createPostalAddressElementType(postalAddressElementTypeName, isDefault, sortOrder);
        } else {
            addExecutionError(ExecutionErrors.DuplicatePostalAddressElementTypeName.name(), postalAddressElementTypeName);
        }
