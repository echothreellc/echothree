...
import com.echothree.control.user.contact.remote.form.CreateContactMechanismAliasTypeDescriptionForm;
...
public class CreateContactMechanismAliasTypeDescriptionCommand
        extends BaseSimpleCommand<CreateContactMechanismAliasTypeDescriptionForm> {
        ...
        if(contactMechanismAliasType != null) {
            ...
            if(language != null) {
                ...
                if(contactMechanismAliasTypeDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateContactMechanismAliasTypeDescription.name(), contactMechanismAliasTypeName, languageIsoName);
                }
            } else {
