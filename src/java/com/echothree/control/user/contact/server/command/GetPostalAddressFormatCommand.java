...
public class GetPostalAddressFormatCommand
        extends BaseSingleEntityCommand<PostalAddressFormat, GetPostalAddressFormatForm> {
    ...
    public GetPostalAddressFormatCommand() {
        super(null, FORM_FIELD_DEFINITIONS, true);
    }

    @Override
    protected PostalAddressFormat getEntity() {
    ...
    @Override
    protected BaseResult getResult(PostalAddressFormat postalAddressFormat) {
