...
import com.echothree.control.user.contact.remote.form.GetPostalAddressFormatForm;
import com.echothree.control.user.contact.remote.result.ContactResultFactory;
import com.echothree.control.user.contact.remote.result.GetPostalAddressFormatResult;
...
public class GetPostalAddressFormatCommand
    ...
    protected BaseResult execute() {
        ...
        GetPostalAddressFormatResult result = ContactResultFactory.getGetPostalAddressFormatResult();
