...
import com.echothree.control.user.contact.remote.form.GetTelephoneStatusChoicesForm;
import com.echothree.control.user.contact.remote.result.ContactResultFactory;
import com.echothree.control.user.contact.remote.result.GetTelephoneStatusChoicesResult;
...
public class GetTelephoneStatusChoicesCommand
        extends BaseSimpleCommand<GetTelephoneStatusChoicesForm> {
    ...
    static {
        FORM_FIELD_DEFINITIONS = Collections.unmodifiableList(Arrays.asList(
                ...
                new FieldDefinition("DefaultTelephoneStatusChoice", FieldType.ENTITY_NAME, false, null, null),
                new FieldDefinition("AllowNullChoice", FieldType.BOOLEAN, true, null, null)));
    }

    /** Creates a new instance of GetTelephoneStatusChoicesCommand */
    public GetTelephoneStatusChoicesCommand(UserVisitPK userVisitPK, GetTelephoneStatusChoicesForm form) {
