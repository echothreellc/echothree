...
public interface CreatePostalAddressLineForm
        extends PostalAddressLineSpec, PostalAddressLineEdit {
    
    // Nothing additional beyond PostalAddressLineSpec, PostalAddressLineEdit
