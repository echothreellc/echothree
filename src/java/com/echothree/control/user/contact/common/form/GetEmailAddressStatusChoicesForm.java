...
public interface GetEmailAddressStatusChoicesForm
        extends ContactMechanismSpec {
    
    String getDefaultEmailAddressStatusChoice();
    void setDefaultEmailAddressStatusChoice(String defaultEmailAddressStatusChoice);
