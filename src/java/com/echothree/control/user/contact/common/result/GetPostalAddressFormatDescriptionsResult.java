...
public interface GetPostalAddressFormatDescriptionsResult
        extends BaseResult {
    ...
    List<PostalAddressFormatDescriptionTransfer> getPostalAddressFormatDescriptions();
    void setPostalAddressFormatDescriptions(List<PostalAddressFormatDescriptionTransfer> postalAddressFormatDescriptions);
