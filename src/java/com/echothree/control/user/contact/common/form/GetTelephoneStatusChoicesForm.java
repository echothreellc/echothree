...
public interface GetTelephoneStatusChoicesForm
        extends ContactMechanismSpec {
    
    String getDefaultTelephoneStatusChoice();
    void setDefaultTelephoneStatusChoice(String defaultTelephoneStatusChoice);
