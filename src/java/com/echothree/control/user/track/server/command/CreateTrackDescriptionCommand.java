...
import com.echothree.control.user.track.common.form.CreateTrackDescriptionForm;
...
public class CreateTrackDescriptionCommand
        extends BaseSimpleCommand<CreateTrackDescriptionForm> {
    ...
    /** Creates a new instance of CreateTrackDescriptionCommand */
    public CreateTrackDescriptionCommand(UserVisitPK userVisitPK, CreateTrackDescriptionForm form) {
        ...
        if(track != null) {
            ...
            if(language != null) {
                ...
                if(trackDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateTrackDescription.name(), trackName, languageIsoName);
                }
            } else {
