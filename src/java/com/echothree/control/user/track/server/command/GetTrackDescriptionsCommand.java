...
import com.echothree.control.user.track.remote.form.GetTrackDescriptionsForm;
import com.echothree.control.user.track.remote.result.GetTrackDescriptionsResult;
...
public class GetTrackDescriptionsCommand
        extends BaseSimpleCommand<GetTrackDescriptionsForm> {
    ...
    protected BaseResult execute() {
        ...
        if(track != null) {
            ...
            result.setTrackDescriptions(trackControl.getTrackDescriptionTransfersByTrack(getUserVisit(), track));
        } else {
