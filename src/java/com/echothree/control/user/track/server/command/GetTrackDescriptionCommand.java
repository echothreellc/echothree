...
import com.echothree.control.user.track.remote.form.GetTrackDescriptionForm;
import com.echothree.control.user.track.remote.result.GetTrackDescriptionResult;
...
public class GetTrackDescriptionCommand
        extends BaseSimpleCommand<GetTrackDescriptionForm> {
    ...
    public GetTrackDescriptionCommand(UserVisitPK userVisitPK, GetTrackDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetTrackDescriptionResult result = TrackResultFactory.getGetTrackDescriptionResult();
