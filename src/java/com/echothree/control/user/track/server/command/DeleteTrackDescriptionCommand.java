...
import com.echothree.control.user.track.remote.form.DeleteTrackDescriptionForm;
...
public class DeleteTrackDescriptionCommand
        extends BaseSimpleCommand<DeleteTrackDescriptionForm> {
    ...
    protected BaseResult execute() {
        ...
        if(track != null) {
            ...
            if(language != null) {
                TrackDescription trackDescription = trackControl.getTrackDescriptionForUpdate(track, language);
                
                if(trackDescription != null) {
                    trackControl.deleteTrackDescription(trackDescription, getPartyPK());
                } else {
