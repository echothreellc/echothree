...
import com.echothree.control.user.track.remote.form.GetTrackChoicesForm;
import com.echothree.control.user.track.remote.result.GetTrackChoicesResult;
...
public class GetTrackChoicesCommand
        extends BaseSimpleCommand<GetTrackChoicesForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.Track.name(), SecurityRoles.Choices.name())
                        )))
                )));
        
        FORM_FIELD_DEFINITIONS = Collections.unmodifiableList(Arrays.asList(
                new FieldDefinition("DefaultTrackChoice", FieldType.ENTITY_NAME, false, null, null),
