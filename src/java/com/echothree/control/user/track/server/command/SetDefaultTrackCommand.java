...
import com.echothree.control.user.track.common.form.SetDefaultTrackForm;
...
public class SetDefaultTrackCommand
        extends BaseSimpleCommand<SetDefaultTrackForm> {
