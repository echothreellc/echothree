...
import com.echothree.control.user.track.remote.form.GetTrackStatusChoicesForm;
import com.echothree.control.user.track.remote.result.GetTrackStatusChoicesResult;
...
public class GetTrackStatusChoicesCommand
        extends BaseSimpleCommand<GetTrackStatusChoicesForm> {
    ...
    public GetTrackStatusChoicesCommand(UserVisitPK userVisitPK, GetTrackStatusChoicesForm form) {
