...
import com.echothree.control.user.track.common.form.DeleteTrackForm;
...
public class DeleteTrackCommand
        extends BaseSimpleCommand<DeleteTrackForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.Track.name(), SecurityRoles.Delete.name())
                        )))
                )));
    ...
    /** Creates a new instance of DeleteTrackCommand */
    public DeleteTrackCommand(UserVisitPK userVisitPK, DeleteTrackForm form) {
