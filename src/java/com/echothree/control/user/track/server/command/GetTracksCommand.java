...
import com.echothree.control.user.track.remote.form.GetTracksForm;
import com.echothree.control.user.track.remote.result.GetTracksResult;
...
public class GetTracksCommand
        extends BaseSimpleCommand<GetTracksForm> {
