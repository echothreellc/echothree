...
public interface CreatePaymentMethodTypePartyTypeResult
        extends PaymentMethodTypePartyTypeSpec, EntityRefSpec, BaseResult {
    
    // Nothing additional beyond PaymentMethodTypePartyTypeSpec, EntityRefSpec, BaseResult
