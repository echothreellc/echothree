...
public interface CreatePaymentMethodTypeResult
        extends PaymentMethodTypeSpec, EntityRefSpec, BaseResult {
    
    // Nothing additional beyond PaymentMethodTypeSpec, EntityRefSpec, BaseResult
