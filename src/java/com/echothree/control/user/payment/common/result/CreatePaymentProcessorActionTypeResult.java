...
public interface CreatePaymentProcessorActionTypeResult
        extends PaymentProcessorActionTypeSpec, EntityRefSpec, BaseResult {
    
    // Nothing additional beyond PaymentProcessorActionTypeSpec, EntityRefSpec, BaseResult
