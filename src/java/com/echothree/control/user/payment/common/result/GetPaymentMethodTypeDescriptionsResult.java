...
public interface GetPaymentMethodTypeDescriptionsResult
        extends BaseResult {
    
    PaymentMethodTypeTransfer getPaymentMethodType();
    void setPaymentMethodType(PaymentMethodTypeTransfer paymentMethodType);
    
    List<PaymentMethodTypeDescriptionTransfer> getPaymentMethodTypeDescriptions();
    void setPaymentMethodTypeDescriptions(List<PaymentMethodTypeDescriptionTransfer> paymentMethodTypeDescriptions);
