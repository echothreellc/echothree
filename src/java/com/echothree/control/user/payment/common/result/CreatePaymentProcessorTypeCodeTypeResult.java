...
public interface CreatePaymentProcessorTypeCodeTypeResult
        extends PaymentProcessorTypeCodeTypeSpec, EntityRefSpec, BaseResult {
    
    // Nothing additional beyond PaymentProcessorTypeCodeTypeSpec, EntityRefSpec, BaseResult
