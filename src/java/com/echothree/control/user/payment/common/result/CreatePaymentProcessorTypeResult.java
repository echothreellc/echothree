...
public interface CreatePaymentProcessorTypeResult
        extends PaymentProcessorTypeSpec, EntityRefSpec, BaseResult {
    
    // Nothing additional beyond PaymentProcessorTypeSpec, EntityRefSpec, BaseResult
