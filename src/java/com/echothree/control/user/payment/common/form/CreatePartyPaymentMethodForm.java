...
public interface CreatePartyPaymentMethodForm
        extends PartySpec, PaymentMethodSpec, PartyPaymentMethodEdit {
    
    // Nothing additional beyond PartyPaymentMethodEdit
