...
public interface EditPaymentMethodTypeDescriptionResult 
        extends BaseEditResult<PaymentMethodTypeDescriptionEdit> {
    
    PaymentMethodTypeDescriptionTransfer getPaymentMethodTypeDescription();
    void setPaymentMethodTypeDescription(PaymentMethodTypeDescriptionTransfer paymentMethodTypeDescription);
