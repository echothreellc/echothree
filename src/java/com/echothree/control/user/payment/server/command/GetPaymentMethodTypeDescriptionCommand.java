...
import com.echothree.control.user.payment.common.form.GetPaymentMethodTypeDescriptionForm;
import com.echothree.control.user.payment.common.result.PaymentResultFactory;
import com.echothree.control.user.payment.common.result.GetPaymentMethodTypeDescriptionResult;
...
public class GetPaymentMethodTypeDescriptionCommand
        extends BaseSimpleCommand<GetPaymentMethodTypeDescriptionForm> {
    ...
    /** Creates a new instance of GetPaymentMethodTypeDescriptionCommand */
    public GetPaymentMethodTypeDescriptionCommand(UserVisitPK userVisitPK, GetPaymentMethodTypeDescriptionForm form) {
        ...
        if(paymentMethodType != null) {
            ...
            if(language != null) {
                ...
                if(paymentMethodTypeDescription != null) {
                    ...
                    addExecutionError(ExecutionErrors.UnknownPaymentMethodTypeDescription.name(), paymentMethodTypeName, languageIsoName);
                }
            } else {
