...
public class DeletePaymentProcessorTypeCommand
        extends BaseSimpleCommand<DeletePaymentProcessorTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.PaymentProcessorType.name(), SecurityRoles.Delete.name())
                        )))
                )));
    ...
    public DeletePaymentProcessorTypeCommand(UserVisitPK userVisitPK, DeletePaymentProcessorTypeForm form) {
