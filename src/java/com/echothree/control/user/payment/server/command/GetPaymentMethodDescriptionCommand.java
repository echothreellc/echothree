...
public class GetPaymentMethodDescriptionCommand
        extends BaseSimpleCommand<GetPaymentMethodDescriptionForm> {
    ...
    public GetPaymentMethodDescriptionCommand(UserVisitPK userVisitPK, GetPaymentMethodDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(paymentMethod != null) {
            ...
            if(language != null) {
                var paymentMethodDescription = paymentMethodControl.getPaymentMethodDescription(paymentMethod, language);
