...
import com.echothree.control.user.payment.remote.form.CreatePaymentMethodTypeForm;
...
public class CreatePaymentMethodTypeCommand
        extends BaseSimpleCommand<CreatePaymentMethodTypeForm> {
    ...
    public CreatePaymentMethodTypeCommand(UserVisitPK userVisitPK, CreatePaymentMethodTypeForm form) {
