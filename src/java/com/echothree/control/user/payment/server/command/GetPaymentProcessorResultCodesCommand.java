...
public class GetPaymentProcessorResultCodesCommand
    ...
    public GetPaymentProcessorResultCodesCommand(UserVisitPK userVisitPK, GetPaymentProcessorResultCodesForm form) {
    ...
    @Override
    protected BaseResult getTransfers(Collection<PaymentProcessorResultCode> entities) {
