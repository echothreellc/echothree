...
import com.echothree.control.user.payment.common.form.GetPaymentProcessorTransactionForm;
import com.echothree.control.user.payment.common.result.GetPaymentProcessorTransactionResult;
...
public class GetPaymentProcessorTransactionCommand
        extends BaseSingleEntityCommand<PaymentProcessorTransaction, GetPaymentProcessorTransactionForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.PaymentProcessorTransaction.name(), SecurityRoles.Review.name())
                )))
        )));

        FORM_FIELD_DEFINITIONS = Collections.unmodifiableList(Arrays.asList(
                new FieldDefinition("PaymentProcessorTransactionName", FieldType.ENTITY_NAME, false, null, null),
    ...
    /** Creates a new instance of GetPaymentProcessorTransactionCommand */
    public GetPaymentProcessorTransactionCommand(UserVisitPK userVisitPK, GetPaymentProcessorTransactionForm form) {
    ...
    protected PaymentProcessorTransaction getEntity() {
        ...
        if(paymentProcessorTransaction != null) {
            sendEventUsingNames(paymentProcessorTransaction.getPrimaryKey(), EventTypes.READ, null, null, getPartyPK());
        }
