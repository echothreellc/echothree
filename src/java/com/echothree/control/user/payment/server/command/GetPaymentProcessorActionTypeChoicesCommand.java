...
import com.echothree.control.user.payment.common.form.GetPaymentProcessorActionTypeChoicesForm;
...
@Dependent
public class GetPaymentProcessorActionTypeChoicesCommand
        extends BaseSimpleCommand<GetPaymentProcessorActionTypeChoicesForm> {
    ...
    protected BaseResult execute() {
        ...
        result.setPaymentProcessorActionTypeChoices(paymentProcessorActionTypeControl.getPaymentProcessorActionTypeChoices(defaultPaymentProcessorActionTypeChoice,
