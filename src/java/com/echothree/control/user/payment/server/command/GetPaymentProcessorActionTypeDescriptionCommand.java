...
import com.echothree.control.user.payment.common.form.GetPaymentProcessorActionTypeDescriptionForm;
import com.echothree.control.user.payment.common.result.PaymentResultFactory;
import com.echothree.control.user.payment.common.result.GetPaymentProcessorActionTypeDescriptionResult;
...
public class GetPaymentProcessorActionTypeDescriptionCommand
        extends BaseSimpleCommand<GetPaymentProcessorActionTypeDescriptionForm> {
    ...
    /** Creates a new instance of GetPaymentProcessorActionTypeDescriptionCommand */
    public GetPaymentProcessorActionTypeDescriptionCommand(UserVisitPK userVisitPK, GetPaymentProcessorActionTypeDescriptionForm form) {
        ...
        if(paymentProcessorActionType != null) {
            ...
            if(language != null) {
                ...
                if(paymentProcessorActionTypeDescription != null) {
                    ...
                    addExecutionError(ExecutionErrors.UnknownPaymentProcessorActionTypeDescription.name(), paymentProcessorActionTypeName, languageIsoName);
                }
            } else {
