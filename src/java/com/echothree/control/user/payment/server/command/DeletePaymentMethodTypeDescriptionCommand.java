...
import com.echothree.control.user.payment.common.form.DeletePaymentMethodTypeDescriptionForm;
...
public class DeletePaymentMethodTypeDescriptionCommand
        extends BaseSimpleCommand<DeletePaymentMethodTypeDescriptionForm> {
    ...
    /** Creates a new instance of DeletePaymentMethodTypeDescriptionCommand */
    public DeletePaymentMethodTypeDescriptionCommand(UserVisitPK userVisitPK, DeletePaymentMethodTypeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(paymentMethodType != null) {
            ...
            if(language != null) {
                PaymentMethodTypeDescription paymentMethodTypeDescription = paymentMethodTypeControl.getPaymentMethodTypeDescriptionForUpdate(paymentMethodType, language);
                
                if(paymentMethodTypeDescription != null) {
                    paymentMethodTypeControl.deletePaymentMethodTypeDescription(paymentMethodTypeDescription, getPartyPK());
                } else {
