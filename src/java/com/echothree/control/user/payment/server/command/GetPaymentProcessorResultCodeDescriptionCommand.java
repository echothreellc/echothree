...
import com.echothree.control.user.payment.common.form.GetPaymentProcessorResultCodeDescriptionForm;
import com.echothree.control.user.payment.common.result.PaymentResultFactory;
import com.echothree.control.user.payment.common.result.GetPaymentProcessorResultCodeDescriptionResult;
...
public class GetPaymentProcessorResultCodeDescriptionCommand
        extends BaseSimpleCommand<GetPaymentProcessorResultCodeDescriptionForm> {
        ...
        if(paymentProcessorResultCode != null) {
            ...
            if(language != null) {
                ...
                if(paymentProcessorResultCodeDescription != null) {
                    ...
                    addExecutionError(ExecutionErrors.UnknownPaymentProcessorResultCodeDescription.name(), paymentProcessorResultCodeName, languageIsoName);
                }
            } else {
