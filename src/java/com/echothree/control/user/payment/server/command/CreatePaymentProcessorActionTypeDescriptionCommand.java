...
import com.echothree.control.user.payment.common.form.CreatePaymentProcessorActionTypeDescriptionForm;
...
public class CreatePaymentProcessorActionTypeDescriptionCommand
        extends BaseSimpleCommand<CreatePaymentProcessorActionTypeDescriptionForm> {
    ...
    /** Creates a new instance of CreatePaymentProcessorActionTypeDescriptionCommand */
    public CreatePaymentProcessorActionTypeDescriptionCommand(UserVisitPK userVisitPK, CreatePaymentProcessorActionTypeDescriptionForm form) {
        ...
        if(paymentProcessorActionType != null) {
            ...
            if(language != null) {
                ...
                if(paymentProcessorActionTypeDescription == null) {
                    ...
                    paymentProcessorActionTypeControl.createPaymentProcessorActionTypeDescription(paymentProcessorActionType, language, description, getPartyPK());
                } else {
                    addExecutionError(ExecutionErrors.DuplicatePaymentProcessorActionTypeDescription.name());
                }
            } else {
