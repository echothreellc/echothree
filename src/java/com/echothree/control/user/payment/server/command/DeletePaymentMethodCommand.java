...
import com.echothree.control.user.payment.remote.form.DeletePaymentMethodForm;
...
public class DeletePaymentMethodCommand
    ...
    public DeletePaymentMethodCommand(UserVisitPK userVisitPK, DeletePaymentMethodForm form) {
