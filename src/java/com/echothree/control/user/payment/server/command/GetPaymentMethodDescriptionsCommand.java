...
import com.echothree.control.user.payment.remote.form.GetPaymentMethodDescriptionsForm;
import com.echothree.control.user.payment.remote.result.GetPaymentMethodDescriptionsResult;
...
public class GetPaymentMethodDescriptionsCommand
        extends BaseSimpleCommand<GetPaymentMethodDescriptionsForm> {
    ...
    /** Creates a new instance of GetPaymentMethodDescriptionsCommand */
    public GetPaymentMethodDescriptionsCommand(UserVisitPK userVisitPK, GetPaymentMethodDescriptionsForm form) {
