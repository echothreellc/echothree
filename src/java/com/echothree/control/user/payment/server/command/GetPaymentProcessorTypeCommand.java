...
import com.echothree.control.user.payment.remote.form.GetPaymentProcessorTypeForm;
import com.echothree.control.user.payment.remote.result.GetPaymentProcessorTypeResult;
...
public class GetPaymentProcessorTypeCommand
        extends BaseSimpleCommand<GetPaymentProcessorTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.PaymentProcessorType.name(), SecurityRoles.Review.name())
                        )))
                )));
    ...
    public GetPaymentProcessorTypeCommand(UserVisitPK userVisitPK, GetPaymentProcessorTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(paymentProcessorType != null) {
            result.setPaymentProcessorType(paymentControl.getPaymentProcessorTypeTransfer(getUserVisit(), paymentProcessorType));
        } else {
