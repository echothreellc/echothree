...
import com.echothree.control.user.payment.remote.form.DeletePaymentProcessorForm;
...
public class DeletePaymentProcessorCommand
        extends BaseSimpleCommand<DeletePaymentProcessorForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.PaymentProcessor.name(), SecurityRoles.Delete.name())
                        )))
                )));
    ...
    public DeletePaymentProcessorCommand(UserVisitPK userVisitPK, DeletePaymentProcessorForm form) {
