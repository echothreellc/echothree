...
public class CreatePaymentProcessorDescriptionCommand
        extends BaseSimpleCommand<CreatePaymentProcessorDescriptionForm> {
    ...
    public CreatePaymentProcessorDescriptionCommand(UserVisitPK userVisitPK, CreatePaymentProcessorDescriptionForm form) {
