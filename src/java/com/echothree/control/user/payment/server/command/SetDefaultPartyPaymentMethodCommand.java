...
import com.echothree.control.user.payment.remote.form.SetDefaultPartyPaymentMethodForm;
...
public class SetDefaultPartyPaymentMethodCommand
    ...
    public SetDefaultPartyPaymentMethodCommand(UserVisitPK userVisitPK, SetDefaultPartyPaymentMethodForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(partyPaymentMethodDetailValue != null) {
            ...
            paymentControl.updatePartyPaymentMethodFromValue(partyPaymentMethodDetailValue, getPartyPK());
        } else {
