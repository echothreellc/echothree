...
public class DeletePaymentProcessorActionTypeCommand
        extends BaseSimpleCommand<DeletePaymentProcessorActionTypeForm> {
    ...
    public DeletePaymentProcessorActionTypeCommand(UserVisitPK userVisitPK, DeletePaymentProcessorActionTypeForm form) {
