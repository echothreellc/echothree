...
public class GetPaymentProcessorDescriptionsCommand
        extends BaseSimpleCommand<GetPaymentProcessorDescriptionsForm> {
    ...
    public GetPaymentProcessorDescriptionsCommand(UserVisitPK userVisitPK, GetPaymentProcessorDescriptionsForm form) {
