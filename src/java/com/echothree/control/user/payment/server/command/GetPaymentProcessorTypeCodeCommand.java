...
public class GetPaymentProcessorTypeCodeCommand
    ...
    public GetPaymentProcessorTypeCodeCommand(UserVisitPK userVisitPK, GetPaymentProcessorTypeCodeForm form) {
    ...
    protected PaymentProcessorTypeCode getEntity() {
        ...
        if(paymentProcessorTypeCode != null) {
            sendEventUsingNames(paymentProcessorTypeCode.getPrimaryKey(), EventTypes.READ, null, null, getPartyPK());
        }
