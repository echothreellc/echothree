...
public class GetPaymentProcessorDescriptionCommand
        extends BaseSimpleCommand<GetPaymentProcessorDescriptionForm> {
    ...
    /** Creates a new instance of GetPaymentProcessorDescriptionCommand */
    public GetPaymentProcessorDescriptionCommand(UserVisitPK userVisitPK, GetPaymentProcessorDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        var result = PaymentResultFactory.getGetPaymentProcessorDescriptionResult();
        ...
        if(paymentProcessor != null) {
            ...
            if(language != null) {
                var paymentProcessorDescription = paymentProcessorControl.getPaymentProcessorDescription(paymentProcessor, language);
