...
import com.echothree.control.user.payment.common.form.CreatePaymentProcessorResultCodeDescriptionForm;
...
public class CreatePaymentProcessorResultCodeDescriptionCommand
        extends BaseSimpleCommand<CreatePaymentProcessorResultCodeDescriptionForm> {
    ...
    /** Creates a new instance of CreatePaymentProcessorResultCodeDescriptionCommand */
    public CreatePaymentProcessorResultCodeDescriptionCommand(UserVisitPK userVisitPK, CreatePaymentProcessorResultCodeDescriptionForm form) {
        ...
        if(paymentProcessorResultCode != null) {
            ...
            if(language != null) {
                ...
                if(paymentProcessorResultCodeDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicatePaymentProcessorResultCodeDescription.name());
                }
            } else {
