...
import com.echothree.control.user.comment.remote.form.DeleteCommentUsageForm;
...
public class DeleteCommentUsageCommand
    ...
    public DeleteCommentUsageCommand(UserVisitPK userVisitPK, DeleteCommentUsageForm form) {
