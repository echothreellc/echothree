...
public class DeleteCommentTypeDescriptionCommand
    ...
    public DeleteCommentTypeDescriptionCommand(UserVisitPK userVisitPK, DeleteCommentTypeDescriptionForm form) {
        ...
        if(componentVendor != null) {
            ...
            if(entityType != null) {
                ...
                if(commentType != null) {
                    ...
                    if(language != null) {
                        CommentTypeDescription commentTypeDescription = commentControl.getCommentTypeDescriptionForUpdate(commentType, language);
