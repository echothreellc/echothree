...
public class GetCommentTypeDescriptionsCommand
        extends BaseSimpleCommand<GetCommentTypeDescriptionsForm> {
    ...
    /** Creates a new instance of GetCommentTypeDescriptionsCommand */
    public GetCommentTypeDescriptionsCommand(UserVisitPK userVisitPK, GetCommentTypeDescriptionsForm form) {
        ...
        if(componentVendor != null) {
            ...
            if(entityType != null) {
                ...
                if(commentType != null) {
                    ...
                    result.setCommentTypeDescriptions(commentControl.getCommentTypeDescriptionTransfers(getUserVisit(), commentType));
                } else {
