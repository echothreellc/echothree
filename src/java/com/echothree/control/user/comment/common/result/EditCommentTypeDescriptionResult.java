...
public interface EditCommentTypeDescriptionResult
        extends BaseEditResult<CommentTypeDescriptionEdit> {
    
    CommentTypeDescriptionTransfer getCommentTypeDescription();
    void setCommentTypeDescription(CommentTypeDescriptionTransfer commentTypeDescription);
