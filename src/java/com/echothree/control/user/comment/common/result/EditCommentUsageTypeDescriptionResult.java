...
public interface EditCommentUsageTypeDescriptionResult
        extends BaseEditResult<CommentUsageTypeDescriptionEdit> {
    
    CommentUsageTypeDescriptionTransfer getCommentUsageTypeDescription();
    void setCommentUsageTypeDescription(CommentUsageTypeDescriptionTransfer commentUsageTypeDescription);
