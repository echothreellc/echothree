...
public interface CreateCommentForm
        extends EntityRefSpec, CommentTypeSpec, CommentEdit {
    
    String getCommentedByUsername();
    void setCommentedByUsername(String commentedByUsername);
