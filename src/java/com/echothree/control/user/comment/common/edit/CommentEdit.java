...
public interface CommentEdit
        extends BaseEdit, LanguageSpec, MimeTypeSpec {
    
    String getDescription();
    void setDescription(String description);
    
    ByteArray getBlobComment();
    void setBlobComment(ByteArray blobComment);
    
    String getClobComment();
    void setClobComment(String clobComment);
    
    String getStringComment();
    void setStringComment(String stringComment);
