...
public class CreateUserLoginPasswordEncoderTypeCommand
        extends BaseSimpleCommand<CreateUserLoginPasswordEncoderTypeForm> {
    ...
    public CreateUserLoginPasswordEncoderTypeCommand(UserVisitPK userVisitPK, CreateUserLoginPasswordEncoderTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        } // TODO: error, duplicate userLoginPasswordEncoderTypeName
