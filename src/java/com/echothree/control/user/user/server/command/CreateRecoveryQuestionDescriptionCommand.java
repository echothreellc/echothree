...
@Dependent
public class CreateRecoveryQuestionDescriptionCommand
        extends BaseSimpleCommand<CreateRecoveryQuestionDescriptionForm> {
        ...
        if(recoveryQuestion != null) {
            ...
            if(language != null) {
                ...
                if(recoveryQuestionDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateRecoveryQuestionDescription.name());
                }
            } else {
