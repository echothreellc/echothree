...
import com.echothree.control.user.user.remote.form.SetUserVisitGroupStatusForm;
...
public class SetUserVisitGroupStatusCommand
    ...
    public SetUserVisitGroupStatusCommand(UserVisitPK userVisitPK, SetUserVisitGroupStatusForm form) {
