...
import com.echothree.control.user.user.remote.form.GetUserVisitGroupsForm;
import com.echothree.control.user.user.remote.result.GetUserVisitGroupsResult;
...
public class GetUserVisitGroupsCommand
        extends BaseSimpleCommand<GetUserVisitGroupsForm> {
