...
public class GetUserLoginCommand
    ...
    protected UserLogin getEntity() {
        ...
        var parameterCount = (username == null ? 0 : 1) + (partyName == null ? 0 : 1) + entityInstanceLogic.countPossibleEntitySpecs(form);
        ...
        if(parameterCount == 1) {
            ...
            if(username != null) {
                var foundByUsernameUserLogin = userLoginLogic.getUserLoginByUsername(this, username);
