...
public interface EditRecoveryQuestionDescriptionResult
        extends BaseEditResult<RecoveryQuestionDescriptionEdit> {
    
    RecoveryQuestionDescriptionTransfer getRecoveryQuestionDescription();
    void setRecoveryQuestionDescription(RecoveryQuestionDescriptionTransfer recoveryQuestionDescription);
