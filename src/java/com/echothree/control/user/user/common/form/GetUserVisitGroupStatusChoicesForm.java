...
public interface GetUserVisitGroupStatusChoicesForm
        extends UserVisitGroupSpec {
    
    String getDefaultUserVisitGroupStatusChoice();
    void setDefaultUserVisitGroupStatusChoice(String defaultUserVisitGroupStatusChoice);
