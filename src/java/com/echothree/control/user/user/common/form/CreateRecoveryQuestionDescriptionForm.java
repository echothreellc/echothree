...
public interface CreateRecoveryQuestionDescriptionForm
        extends RecoveryQuestionDescriptionSpec, RecoveryQuestionDescriptionEdit {
    
    // Nothing additional beyond RecoveryQuestionDescriptionSpec, RecoveryQuestionDescriptionEdit
