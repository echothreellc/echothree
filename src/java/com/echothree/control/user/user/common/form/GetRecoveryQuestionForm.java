...
import com.echothree.control.user.user.common.spec.RecoveryQuestionUniversalSpec;
...
public interface GetRecoveryQuestionForm
        extends RecoveryQuestionUniversalSpec, UserLoginSpec, PartySpec, EmployeeSpec, CustomerSpec, VendorSpec {
    
    // Nothing additional beyond RecoveryQuestionUniversalSpec, UserLoginSpec, PartySpec, EmployeeSpec, CustomerSpec, VendorSpec
