...
public class CreatePeriodKindDescriptionCommand
        extends BaseSimpleCommand<CreatePeriodKindDescriptionForm> {
    ...
    /** Creates a new instance of CreatePeriodKindDescriptionCommand */
    public CreatePeriodKindDescriptionCommand(UserVisitPK userVisitPK, CreatePeriodKindDescriptionForm form) {
        ...
        if(periodKind != null) {
            ...
            if(language != null) {
                ...
                if(periodKindDescription == null) {
                    ...
                    periodControl.createPeriodKindDescription(periodKind, language, description, getPartyPK());
                } else {
                    addExecutionError(ExecutionErrors.DuplicatePeriodKindDescription.name());
                }
            } else {
