...
import com.echothree.control.user.period.common.form.SetFiscalPeriodStatusForm;
...
public class SetFiscalPeriodStatusCommand
        extends BaseSimpleCommand<SetFiscalPeriodStatusForm> {
    ...
    static {
        ...
        FORM_FIELD_DEFINITIONS = Collections.unmodifiableList(Arrays.asList(
            new FieldDefinition("FiscalPeriodName", FieldType.ENTITY_NAME, true, null, null),
