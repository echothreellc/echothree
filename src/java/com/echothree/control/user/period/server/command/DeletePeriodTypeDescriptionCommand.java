...
import com.echothree.control.user.period.common.form.DeletePeriodTypeDescriptionForm;
...
public class DeletePeriodTypeDescriptionCommand
        extends BaseSimpleCommand<DeletePeriodTypeDescriptionForm> {
    ...
    /** Creates a new instance of DeletePeriodTypeDescriptionCommand */
    public DeletePeriodTypeDescriptionCommand(UserVisitPK userVisitPK, DeletePeriodTypeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(periodKind != null) {
            ...
            if(periodType != null) {
                ...
                if(language != null) {
                    PeriodTypeDescription periodTypeDescription = periodControl.getPeriodTypeDescriptionForUpdate(periodType, language);
                    
                    if(periodTypeDescription != null) {
                        periodControl.deletePeriodTypeDescription(periodTypeDescription, getPartyPK());
                    } else {
