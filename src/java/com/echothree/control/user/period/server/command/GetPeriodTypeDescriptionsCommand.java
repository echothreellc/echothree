...
import com.echothree.control.user.period.remote.form.GetPeriodTypeDescriptionsForm;
import com.echothree.control.user.period.remote.result.GetPeriodTypeDescriptionsResult;
...
public class GetPeriodTypeDescriptionsCommand
    ...
    public GetPeriodTypeDescriptionsCommand(UserVisitPK userVisitPK, GetPeriodTypeDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetPeriodTypeDescriptionsResult result = PeriodResultFactory.getGetPeriodTypeDescriptionsResult();
