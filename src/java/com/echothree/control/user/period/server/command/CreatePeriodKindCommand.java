...
@Dependent
public class CreatePeriodKindCommand
        extends BaseSimpleCommand<CreatePeriodKindForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                    new SecurityRoleDefinition(SecurityRoleGroups.PeriodKind.name(), SecurityRoles.Create.name())
                    )))
                )));
            ...
            if(periodKind == null) {
                ...
                if(workflowName == null || workflow != null) {
                    ...
                    if(workflowEntranceName == null || workflowEntrance != null) {
                        ...
                        periodKind = periodControl.createPeriodKind(periodKindName, workflowEntrance, isDefault, sortOrder, partyPK);
