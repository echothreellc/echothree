...
import com.echothree.control.user.period.remote.form.DeletePeriodTypeForm;
...
public class DeletePeriodTypeCommand
    ...
    public DeletePeriodTypeCommand(UserVisitPK userVisitPK, DeletePeriodTypeForm form) {
