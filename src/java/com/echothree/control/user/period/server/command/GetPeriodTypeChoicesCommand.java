...
import com.echothree.control.user.period.remote.form.GetPeriodTypeChoicesForm;
import com.echothree.control.user.period.remote.result.GetPeriodTypeChoicesResult;
...
public class GetPeriodTypeChoicesCommand
    ...
    public GetPeriodTypeChoicesCommand(UserVisitPK userVisitPK, GetPeriodTypeChoicesForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetPeriodTypeChoicesResult result = PeriodResultFactory.getGetPeriodTypeChoicesResult();
        String periodKindName = form.getPeriodKindName();
        PeriodKind periodKind = periodControl.getPeriodKindByName(periodKindName);
        
        if(periodKind != null) {
            String defaultPeriodTypeChoice = form.getDefaultPeriodTypeChoice();
