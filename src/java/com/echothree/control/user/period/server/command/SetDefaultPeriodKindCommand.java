...
import com.echothree.control.user.period.common.form.SetDefaultPeriodKindForm;
...
@Dependent
public class SetDefaultPeriodKindCommand
        extends BaseSimpleCommand<SetDefaultPeriodKindForm> {
