...
import com.echothree.control.user.period.remote.form.GetPeriodTypeForm;
import com.echothree.control.user.period.remote.result.GetPeriodTypeResult;
...
public class GetPeriodTypeCommand
    ...
    public GetPeriodTypeCommand(UserVisitPK userVisitPK, GetPeriodTypeForm form) {
