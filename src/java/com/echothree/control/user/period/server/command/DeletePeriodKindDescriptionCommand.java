...
import com.echothree.control.user.period.common.form.DeletePeriodKindDescriptionForm;
...
public class DeletePeriodKindDescriptionCommand
        extends BaseSimpleCommand<DeletePeriodKindDescriptionForm> {
        ...
        if(periodKind != null) {
            ...
            if(language != null) {
                ...
                if(periodKindDescription != null) {
                    periodControl.deletePeriodKindDescription(periodKindDescription, getPartyPK());
                } else {
