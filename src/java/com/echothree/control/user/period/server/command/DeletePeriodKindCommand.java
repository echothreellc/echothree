...
import com.echothree.control.user.period.common.form.DeletePeriodKindForm;
...
public class DeletePeriodKindCommand
        extends BaseSimpleCommand<DeletePeriodKindForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                    new SecurityRoleDefinition(SecurityRoleGroups.PeriodKind.name(), SecurityRoles.Delete.name())
                    )))
                )));
    ...
    public DeletePeriodKindCommand(UserVisitPK userVisitPK, DeletePeriodKindForm form) {
