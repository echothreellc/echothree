...
import com.echothree.control.user.period.remote.form.GetPeriodKindForm;
import com.echothree.control.user.period.remote.result.GetPeriodKindResult;
...
public class GetPeriodKindCommand
    ...
    public GetPeriodKindCommand(UserVisitPK userVisitPK, GetPeriodKindForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetPeriodKindResult result = PeriodResultFactory.getGetPeriodKindResult();
