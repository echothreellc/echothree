...
public class GetPeriodKindCommand
        extends BaseSingleEntityCommand<PeriodKind, GetPeriodKindForm> {
    ...
    static {
        ...
        FORM_FIELD_DEFINITIONS = List.of(
                new FieldDefinition("PeriodKindName", FieldType.ENTITY_NAME, false, null, null),
    ...
    @Override
    protected PeriodKind getEntity() {
        var periodKind = periodKindLogic.getPeriodKindByUniversalSpec(this, form, true);
    ...
    @Override
    protected BaseResult getResult(PeriodKind periodKind) {
