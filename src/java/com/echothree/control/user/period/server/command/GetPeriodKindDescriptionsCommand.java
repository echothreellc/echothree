...
import com.echothree.control.user.period.common.form.GetPeriodKindDescriptionsForm;
import com.echothree.control.user.period.common.result.GetPeriodKindDescriptionsResult;
...
public class GetPeriodKindDescriptionsCommand
        extends BaseSimpleCommand<GetPeriodKindDescriptionsForm> {
    ...
    /** Creates a new instance of GetPeriodKindDescriptionsCommand */
    public GetPeriodKindDescriptionsCommand(UserVisitPK userVisitPK, GetPeriodKindDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetPeriodKindDescriptionsResult result = PeriodResultFactory.getGetPeriodKindDescriptionsResult();
        ...
        if(periodKind != null) {
            ...
            result.setPeriodKindDescriptions(periodControl.getPeriodKindDescriptionTransfersByPeriodKind(getUserVisit(), periodKind));
        } else {
