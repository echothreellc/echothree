...
public interface CreatePeriodKindDescriptionForm
        extends PeriodKindDescriptionSpec, PeriodKindDescriptionEdit {
    
    // Nothing additional beyond PeriodKindDescriptionSpec, PeriodKindDescriptionEdit
