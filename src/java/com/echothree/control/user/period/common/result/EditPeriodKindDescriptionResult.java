...
public interface EditPeriodKindDescriptionResult
        extends BaseEditResult<PeriodKindDescriptionEdit> {
    
    PeriodKindDescriptionTransfer getPeriodKindDescription();
    void setPeriodKindDescription(PeriodKindDescriptionTransfer periodKindDescription);
