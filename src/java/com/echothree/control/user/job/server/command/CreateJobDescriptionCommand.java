...
@Dependent
public class CreateJobDescriptionCommand
        extends BaseSimpleCommand<CreateJobDescriptionForm> {
        ...
        if(job != null) {
            ...
            if(language != null) {
                ...
                if(jobDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateJobDescription.name());
                }
            } else {
