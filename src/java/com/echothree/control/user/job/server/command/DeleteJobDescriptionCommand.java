...
public class DeleteJobDescriptionCommand
        extends BaseSimpleCommand<DeleteJobDescriptionForm> {
    ...
    /** Creates a new instance of DeleteJobDescriptionCommand */
    public DeleteJobDescriptionCommand(UserVisitPK userVisitPK, DeleteJobDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(job != null) {
            ...
            if(language != null) {
                JobDescription jobDescription = jobControl.getJobDescriptionForUpdate(job, language);
                
                if(jobDescription != null) {
                    jobControl.deleteJobDescription(jobDescription, getPartyPK());
                } else {
