...
import com.echothree.control.user.job.remote.form.GetJobForm;
import com.echothree.control.user.job.remote.result.GetJobResult;
...
public class GetJobCommand
        extends BaseSimpleCommand<GetJobForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.Job.name(), SecurityRoles.Review.name())
                        )))
                )));
