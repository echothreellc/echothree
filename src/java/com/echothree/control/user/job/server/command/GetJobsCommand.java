...
import com.echothree.control.user.job.remote.form.GetJobsForm;
...
public class GetJobsCommand
        extends BaseSimpleCommand<GetJobsForm> {
    ...
    public GetJobsCommand(UserVisitPK userVisitPK, GetJobsForm form) {
