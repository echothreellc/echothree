...
public interface CreatePartyCreditLimitForm
        extends PartyCreditLimitSpec, PartyCreditLimitEdit {
    
    // Nothing additional beyond PartyCreditLimitSpec, PartyCreditLimitEdit
