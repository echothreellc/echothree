...
public interface CreateTermDescriptionForm
        extends TermDescriptionSpec, TermDescriptionEdit {
    
    // Nothing additional beyond TermDescriptionSpec, TermDescriptionEdit
