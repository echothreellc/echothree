...
public interface CreateCustomerTypeCreditLimitForm
        extends CustomerTypeCreditLimitSpec, CustomerTypeCreditLimitEdit {
    
    // Nothing additional beyond CustomerTypeCreditLimitSpec, CustomerTypeCreditLimitEdit
