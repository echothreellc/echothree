...
public interface EditTermDescriptionResult
        extends BaseEditResult<TermDescriptionEdit> {
    
    TermDescriptionTransfer getTermDescription();
    void setTermDescription(TermDescriptionTransfer termDescription);
