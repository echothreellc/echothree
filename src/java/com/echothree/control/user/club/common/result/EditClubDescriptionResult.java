...
public interface EditClubDescriptionResult
        extends BaseEditResult<ClubDescriptionEdit> {
    
    ClubDescriptionTransfer getClubDescription();
    void setClubDescription(ClubDescriptionTransfer clubDescription);
