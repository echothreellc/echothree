...
import com.echothree.control.user.club.remote.form.CreateClubItemTypeForm;
...
public class CreateClubItemTypeCommand
    ...
    public CreateClubItemTypeCommand(UserVisitPK userVisitPK, CreateClubItemTypeForm form) {
