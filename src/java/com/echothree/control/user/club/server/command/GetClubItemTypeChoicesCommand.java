...
import com.echothree.control.user.club.remote.form.GetClubItemTypeChoicesForm;
import com.echothree.control.user.club.remote.result.ClubResultFactory;
import com.echothree.control.user.club.remote.result.GetClubItemTypeChoicesResult;
...
public class GetClubItemTypeChoicesCommand
        extends BaseSimpleCommand<GetClubItemTypeChoicesForm> {
    
    private final static List<FieldDefinition> FORM_FIELD_DEFINITIONS;
    
    static {
        FORM_FIELD_DEFINITIONS = Collections.unmodifiableList(Arrays.asList(
            new FieldDefinition("DefaultClubItemTypeChoice", FieldType.ENTITY_NAME, false, null, null),
            new FieldDefinition("AllowNullChoice", FieldType.BOOLEAN, true, null, null)
        ));
    }
    
    /** Creates a new instance of GetClubItemTypeChoicesCommand */
    public GetClubItemTypeChoicesCommand(UserVisitPK userVisitPK, GetClubItemTypeChoicesForm form) {
