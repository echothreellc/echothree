...
import com.echothree.control.user.employee.remote.form.GetEmployeeTypeDescriptionsForm;
import com.echothree.control.user.employee.remote.result.EmployeeResultFactory;
import com.echothree.control.user.employee.remote.result.GetEmployeeTypeDescriptionsResult;
...
public class GetEmployeeTypeDescriptionsCommand
        extends BaseSimpleCommand<GetEmployeeTypeDescriptionsForm> {
    ...
    /** Creates a new instance of GetEmployeeTypeDescriptionsCommand */
    public GetEmployeeTypeDescriptionsCommand(UserVisitPK userVisitPK, GetEmployeeTypeDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(employeeType != null) {
            ...
            result.setEmployeeTypeDescriptions(employeeControl.getEmployeeTypeDescriptionTransfers(getUserVisit(), employeeType));
        } else {
