...
public class GetResponsibilityTypeChoicesCommand
        extends BaseSimpleCommand<GetResponsibilityTypeChoicesForm> {
    
    private final static List<FieldDefinition> FORM_FIELD_DEFINITIONS;
    
    static {
        FORM_FIELD_DEFINITIONS = Collections.unmodifiableList(Arrays.asList(
            new FieldDefinition("DefaultResponsibilityTypeChoice", FieldType.ENTITY_NAME, false, null, null),
