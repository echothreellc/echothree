...
import com.echothree.control.user.employee.remote.form.GetLeaveReasonDescriptionsForm;
import com.echothree.control.user.employee.remote.result.EmployeeResultFactory;
import com.echothree.control.user.employee.remote.result.GetLeaveReasonDescriptionsResult;
...
public class GetLeaveReasonDescriptionsCommand
        extends BaseSimpleCommand<GetLeaveReasonDescriptionsForm> {
   ...
   private final static List<FieldDefinition> FORM_FIELD_DEFINITIONS;
    ...
    /** Creates a new instance of GetLeaveReasonDescriptionsCommand */
    public GetLeaveReasonDescriptionsCommand(UserVisitPK userVisitPK, GetLeaveReasonDescriptionsForm form) {
   ...
   @Override
    protected BaseResult execute() {
        ...
        if(leaveReason != null) {
            ...
            result.setLeaveReasonDescriptions(employeeControl.getLeaveReasonDescriptionTransfersByLeaveReason(getUserVisit(), leaveReason));
        } else {
