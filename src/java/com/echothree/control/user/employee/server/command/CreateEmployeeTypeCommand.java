...
public class CreateEmployeeTypeCommand
        extends BaseSimpleCommand<CreateEmployeeTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.EmployeeType.name(), SecurityRoles.Create.name())
                        )))
                )));
    ...
    public CreateEmployeeTypeCommand(UserVisitPK userVisitPK, CreateEmployeeTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(employeeType == null) {
            ...
            employeeType = employeeControl.createEmployeeType(employeeTypeName, isDefault, sortOrder, partyPK);
