...
import com.echothree.control.user.employee.common.form.SetDefaultTerminationTypeForm;
...
public class SetDefaultTerminationTypeCommand
        extends BaseSimpleCommand<SetDefaultTerminationTypeForm> {
    ...
    protected BaseResult execute() {
        ...
        TerminationTypeDetailValue terminationTypeDetailValue = employeeControl.getTerminationTypeDetailValueByNameForUpdate(terminationTypeName);
