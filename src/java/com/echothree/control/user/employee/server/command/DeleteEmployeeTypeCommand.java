...
import com.echothree.control.user.employee.common.form.DeleteEmployeeTypeForm;
...
public class DeleteEmployeeTypeCommand
        extends BaseSimpleCommand<DeleteEmployeeTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.EmployeeType.name(), SecurityRoles.Delete.name())
                        )))
                )));
    ...
    /** Creates a new instance of DeleteEmployeeTypeCommand */
    public DeleteEmployeeTypeCommand(UserVisitPK userVisitPK, DeleteEmployeeTypeForm form) {
