...
import com.echothree.control.user.employee.remote.edit.EmployeeTypeDescriptionEdit;
import com.echothree.control.user.employee.remote.form.EditEmployeeTypeDescriptionForm;
import com.echothree.control.user.employee.remote.result.EditEmployeeTypeDescriptionResult;
import com.echothree.control.user.employee.remote.result.EmployeeResultFactory;
import com.echothree.control.user.employee.remote.spec.EmployeeTypeDescriptionSpec;
...
public class EditEmployeeTypeDescriptionCommand
    ...
    public EditEmployeeTypeDescriptionCommand(UserVisitPK userVisitPK, EditEmployeeTypeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        EditEmployeeTypeDescriptionResult result = EmployeeResultFactory.getEditEmployeeTypeDescriptionResult();
                ...
                if(editMode.equals(EditMode.LOCK)) {
                    ...
                    if(employeeTypeDescription != null) {
                        ...
                        if(lockEntity(employeeType)) {
                            EmployeeTypeDescriptionEdit edit = EmployeeEditFactory.getEmployeeTypeDescriptionEdit();
                    ...
                    EmployeeTypeDescriptionValue employeeTypeDescriptionValue = employeeControl.getEmployeeTypeDescriptionValueForUpdate(employeeType, language);
