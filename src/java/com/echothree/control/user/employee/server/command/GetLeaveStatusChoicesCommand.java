...
import com.echothree.control.user.employee.remote.form.GetLeaveStatusChoicesForm;
import com.echothree.control.user.employee.remote.result.EmployeeResultFactory;
import com.echothree.control.user.employee.remote.result.GetLeaveStatusChoicesResult;
...
public class GetLeaveStatusChoicesCommand
        extends BaseSimpleCommand<GetLeaveStatusChoicesForm> {
    ...
    static {
        ...
        FORM_FIELD_DEFINITIONS = Collections.unmodifiableList(Arrays.asList(
                ...
                new FieldDefinition("DefaultLeaveStatusChoice", FieldType.ENTITY_NAME, false, null, null),
                new FieldDefinition("AllowNullChoice", FieldType.BOOLEAN, true, null, null)
                ));
    }
    
    /** Creates a new instance of GetLeaveStatusChoicesCommand */
    public GetLeaveStatusChoicesCommand(UserVisitPK userVisitPK, GetLeaveStatusChoicesForm form) {
