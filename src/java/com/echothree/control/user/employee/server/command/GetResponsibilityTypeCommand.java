...
import com.echothree.control.user.employee.remote.form.GetResponsibilityTypeForm;
import com.echothree.control.user.employee.remote.result.EmployeeResultFactory;
import com.echothree.control.user.employee.remote.result.GetResponsibilityTypeResult;
...
public class GetResponsibilityTypeCommand
    ...
    public GetResponsibilityTypeCommand(UserVisitPK userVisitPK, GetResponsibilityTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetResponsibilityTypeResult result = EmployeeResultFactory.getGetResponsibilityTypeResult();
        ...
        if(responsibilityType != null) {
            ...
            sendEventUsingNames(responsibilityType.getPrimaryKey(), EventTypes.READ.name(), null, null, getPartyPK());
        } else {
