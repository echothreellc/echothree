...
public class GetTerminationTypeCommand
        extends BaseSingleEntityCommand<TerminationType, GetTerminationTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(List.of(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), List.of(
                        new SecurityRoleDefinition(SecurityRoleGroups.TerminationType.name(), SecurityRoles.Review.name())
                ))
        ));
    ...
    public GetTerminationTypeCommand() {
        super(COMMAND_SECURITY_DEFINITION, FORM_FIELD_DEFINITIONS, true);
    }
    
    @Override
    protected TerminationType getEntity() {
        ...
        if(terminationType != null) {
            sendEvent(terminationType.getPrimaryKey(), EventTypes.READ, null, null, getPartyPK());
        } else {
    ...
    @Override
    protected BaseResult getResult(TerminationType terminationType) {
