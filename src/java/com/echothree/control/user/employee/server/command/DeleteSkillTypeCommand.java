...
import com.echothree.control.user.employee.remote.form.DeleteSkillTypeForm;
...
public class DeleteSkillTypeCommand
        extends BaseSimpleCommand<DeleteSkillTypeForm> {
    ...
    /** Creates a new instance of DeleteSkillTypeCommand */
    public DeleteSkillTypeCommand(UserVisitPK userVisitPK, DeleteSkillTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(skillType != null) {
            employeeControl.deleteSkillType(skillType, getPartyPK());
        } else {
