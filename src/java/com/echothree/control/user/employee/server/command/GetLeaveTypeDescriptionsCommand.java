...
import com.echothree.control.user.employee.remote.form.GetLeaveTypeDescriptionsForm;
import com.echothree.control.user.employee.remote.result.EmployeeResultFactory;
import com.echothree.control.user.employee.remote.result.GetLeaveTypeDescriptionsResult;
   ...
   @Override
    protected BaseResult execute() {
        ...
        if(leaveType != null) {
            ...
            result.setLeaveTypeDescriptions(employeeControl.getLeaveTypeDescriptionTransfersByLeaveType(getUserVisit(), leaveType));
        } else {
