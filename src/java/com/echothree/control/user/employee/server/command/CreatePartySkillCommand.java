...
import com.echothree.control.user.employee.remote.form.CreatePartySkillForm;
...
public class CreatePartySkillCommand
        extends BaseSimpleCommand<CreatePartySkillForm> {
    ...
    /** Creates a new instance of CreatePartySkillCommand */
    public CreatePartySkillCommand(UserVisitPK userVisitPK, CreatePartySkillForm form) {
        ...
        if(party != null) {
            ...
            if(skillType != null) {
                ...
                if(partySkill == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicatePartySkill.name());
                }
            } else {
