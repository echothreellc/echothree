...
public class DeleteTerminationReasonDescriptionCommand
        extends BaseSimpleCommand<DeleteTerminationReasonDescriptionForm> {
    ...
    public DeleteTerminationReasonDescriptionCommand(UserVisitPK userVisitPK, DeleteTerminationReasonDescriptionForm form) {
