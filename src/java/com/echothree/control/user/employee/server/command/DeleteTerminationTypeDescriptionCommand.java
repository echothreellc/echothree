...
import com.echothree.control.user.employee.common.form.DeleteTerminationTypeDescriptionForm;
...
public class DeleteTerminationTypeDescriptionCommand
        extends BaseSimpleCommand<DeleteTerminationTypeDescriptionForm> {
    ...
    /** Creates a new instance of DeleteTerminationTypeDescriptionCommand */
    public DeleteTerminationTypeDescriptionCommand(UserVisitPK userVisitPK, DeleteTerminationTypeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(terminationType != null) {
            ...
            if(language != null) {
                TerminationTypeDescription terminationTypeDescription = employeeControl.getTerminationTypeDescriptionForUpdate(terminationType, language);
                
                if(terminationTypeDescription != null) {
                    employeeControl.deleteTerminationTypeDescription(terminationTypeDescription, getPartyPK());
                } else {
