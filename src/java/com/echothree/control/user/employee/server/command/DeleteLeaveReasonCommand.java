...
public class DeleteLeaveReasonCommand
        extends BaseSimpleCommand<DeleteLeaveReasonForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(List.of(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), List.of(
                        new SecurityRoleDefinition(SecurityRoleGroups.LeaveReason.name(), SecurityRoles.Delete.name())
                ))
        ));
    ...
    public DeleteLeaveReasonCommand(UserVisitPK userVisitPK, DeleteLeaveReasonForm form) {
