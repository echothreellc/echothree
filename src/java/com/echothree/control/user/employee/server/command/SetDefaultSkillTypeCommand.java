...
import com.echothree.control.user.employee.common.form.SetDefaultSkillTypeForm;
...
public class SetDefaultSkillTypeCommand
        extends BaseSimpleCommand<SetDefaultSkillTypeForm> {
    ...
    public SetDefaultSkillTypeCommand(UserVisitPK userVisitPK, SetDefaultSkillTypeForm form) {
