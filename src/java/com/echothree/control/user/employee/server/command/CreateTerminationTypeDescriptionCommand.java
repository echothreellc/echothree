...
@RequestScoped
public class CreateTerminationTypeDescriptionCommand
        extends BaseSimpleCommand<CreateTerminationTypeDescriptionForm> {
        ...
        if(terminationType != null) {
            ...
            if(language != null) {
                ...
                if(terminationTypeDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateTerminationTypeDescription.name());
                }
            } else {
