...
public class GetTerminationReasonCommand
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(List.of(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), List.of(
                        new SecurityRoleDefinition(SecurityRoleGroups.TerminationReason.name(), SecurityRoles.Review.name())
                ))
        ));
    ...
    protected BaseResult execute() {
        ...
        GetTerminationReasonResult result = EmployeeResultFactory.getGetTerminationReasonResult();
