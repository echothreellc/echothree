...
public class GetSkillTypeChoicesCommand
        extends BaseSimpleCommand<GetSkillTypeChoicesForm> {
    
    private final static List<FieldDefinition> FORM_FIELD_DEFINITIONS;
    
    static {
        FORM_FIELD_DEFINITIONS = Collections.unmodifiableList(Arrays.asList(
            new FieldDefinition("DefaultSkillTypeChoice", FieldType.ENTITY_NAME, false, null, null),
            new FieldDefinition("AllowNullChoice", FieldType.BOOLEAN, true, null, null)
        ));
    }
    
    /** Creates a new instance of GetSkillTypeChoicesCommand */
    public GetSkillTypeChoicesCommand(UserVisitPK userVisitPK, GetSkillTypeChoicesForm form) {
    ...
    protected BaseResult execute() {
        ...
        result.setSkillTypeChoices(employeeControl.getSkillTypeChoices(defaultSkillTypeChoice,
