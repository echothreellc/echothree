...
import com.echothree.control.user.employee.remote.form.GetSkillTypesForm;
...
public class GetSkillTypesCommand
        extends BaseSimpleCommand<GetSkillTypesForm> {
    ...
    public GetSkillTypesCommand(UserVisitPK userVisitPK, GetSkillTypesForm form) {
