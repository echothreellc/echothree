...
public class CreateEmployeeTypeDescriptionCommand
        extends BaseSimpleCommand<CreateEmployeeTypeDescriptionForm> {
    ...
    /** Creates a new instance of CreateEmployeeTypeDescriptionCommand */
    public CreateEmployeeTypeDescriptionCommand(UserVisitPK userVisitPK, CreateEmployeeTypeDescriptionForm form) {
        ...
        if(employeeType != null) {
            ...
            if(language != null) {
                ...
                if(employeeTypeDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateEmployeeTypeDescription.name());
                }
            } else {
