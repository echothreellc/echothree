...
import com.echothree.control.user.employee.remote.form.GetLeaveReasonDescriptionForm;
import com.echothree.control.user.employee.remote.result.EmployeeResultFactory;
import com.echothree.control.user.employee.remote.result.GetLeaveReasonDescriptionResult;
...
public class GetLeaveReasonDescriptionCommand
        extends BaseSimpleCommand<GetLeaveReasonDescriptionForm> {
    ...
    /** Creates a new instance of GetLeaveReasonDescriptionCommand */
    public GetLeaveReasonDescriptionCommand(UserVisitPK userVisitPK, GetLeaveReasonDescriptionForm form) {
