...
public class GetTerminationReasonDescriptionsCommand
        extends BaseSimpleCommand<GetTerminationReasonDescriptionsForm> {
    ...
    /** Creates a new instance of GetTerminationReasonDescriptionsCommand */
    public GetTerminationReasonDescriptionsCommand(UserVisitPK userVisitPK, GetTerminationReasonDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        var result = EmployeeResultFactory.getGetTerminationReasonDescriptionsResult();
        ...
        if(terminationReason != null) {
            ...
            result.setTerminationReasonDescriptions(employeeControl.getTerminationReasonDescriptionTransfers(getUserVisit(), terminationReason));
        } else {
