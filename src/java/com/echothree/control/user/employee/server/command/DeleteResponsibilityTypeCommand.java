...
public class DeleteResponsibilityTypeCommand
        extends BaseSimpleCommand<DeleteResponsibilityTypeForm> {
    ...
    /** Creates a new instance of DeleteResponsibilityTypeCommand */
    public DeleteResponsibilityTypeCommand(UserVisitPK userVisitPK, DeleteResponsibilityTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(responsibilityType != null) {
            employeeControl.deleteResponsibilityType(responsibilityType, getPartyPK());
        } else {
