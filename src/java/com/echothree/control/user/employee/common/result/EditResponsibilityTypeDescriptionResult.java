...
public interface EditResponsibilityTypeDescriptionResult
        extends BaseEditResult<ResponsibilityTypeDescriptionEdit> {
    
    ResponsibilityTypeDescriptionTransfer getResponsibilityTypeDescription();
    void setResponsibilityTypeDescription(ResponsibilityTypeDescriptionTransfer responsibilityTypeDescription);
