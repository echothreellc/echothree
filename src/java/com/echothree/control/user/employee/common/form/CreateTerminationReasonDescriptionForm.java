...
public interface CreateTerminationReasonDescriptionForm
        extends TerminationReasonDescriptionSpec, TerminationReasonDescriptionEdit {
    
    // Nothing additional beyond TerminationReasonDescriptionSpec, TerminationReasonDescriptionEdit
