...
public interface EditTerminationTypeDescriptionResult
        extends BaseEditResult<TerminationTypeDescriptionEdit> {
    
    TerminationTypeDescriptionTransfer getTerminationTypeDescription();
    void setTerminationTypeDescription(TerminationTypeDescriptionTransfer terminationTypeDescription);
