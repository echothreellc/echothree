...
public interface CreateLeaveReasonDescriptionForm
        extends LeaveReasonDescriptionSpec, LeaveReasonDescriptionEdit {
    
    // Nothing additional beyond LeaveReasonDescriptionSpec, LeaveReasonDescriptionEdit
