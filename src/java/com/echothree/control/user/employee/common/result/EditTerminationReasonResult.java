...
public interface EditTerminationReasonResult
        extends BaseEditResult<TerminationReasonEdit> {
    
    TerminationReasonTransfer getTerminationReason();
    void setTerminationReason(TerminationReasonTransfer terminationReason);
