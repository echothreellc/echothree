...
public interface EditEmploymentResult
        extends GetEmploymentResult, BaseEditResult<EmploymentEdit> {
    
    // Nothing additional beyond GetEmploymentResult, BaseEditResult<EmploymentEdit>
