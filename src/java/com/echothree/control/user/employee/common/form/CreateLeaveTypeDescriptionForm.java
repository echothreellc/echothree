...
public interface CreateLeaveTypeDescriptionForm
        extends LeaveTypeDescriptionSpec, LeaveTypeDescriptionEdit {
    
    // Nothing additional beyond LeaveTypeDescriptionSpec, LeaveTypeDescriptionEdit
