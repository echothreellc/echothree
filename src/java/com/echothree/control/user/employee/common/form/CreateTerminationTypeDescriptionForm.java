...
public interface CreateTerminationTypeDescriptionForm
        extends TerminationTypeDescriptionSpec, TerminationTypeDescriptionEdit {
    
    // Nothing additional beyond TerminationTypeDescriptionSpec, TerminationTypeDescriptionEdit
