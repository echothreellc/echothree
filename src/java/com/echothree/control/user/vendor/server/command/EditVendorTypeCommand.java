...
public class EditVendorTypeCommand
        extends BaseAbstractEditCommand<VendorTypeUniversalSpec, VendorTypeEdit, EditVendorTypeResult, VendorType, VendorType> {
    ...
    protected EditVendorTypeResult getResult() {
        return VendorResultFactory.getEditVendorTypeResult();
    }

    @Override
    protected VendorTypeEdit getEdit() {
        return VendorEditFactory.getVendorTypeEdit();
    }

    @Override
    protected VendorType getEntity(EditVendorTypeResult result) {
        return vendorTypeLogic.getVendorTypeByUniversalSpec(this, spec, false, editModeToEntityPermission(editMode));
    }

    @Override
    protected VendorType getLockEntity(VendorType vendorType) {
        return vendorType;
    }

    @Override
    protected void fillInResult(EditVendorTypeResult result, VendorType vendorType) {
        result.setVendorType(vendorControl.getVendorTypeTransfer(getUserVisit(), vendorType));
    }

    @Override
    protected void doLock(VendorTypeEdit edit, VendorType vendorType) {
    ...
    Term defaultTerm;
    FreeOnBoard defaultFreeOnBoard;
    CancellationPolicy defaultCancellationPolicy;
    ReturnPolicy defaultReturnPolicy;
    GlAccount defaultApGlAccount;

    @Override
    protected void canUpdate(VendorType vendorType) {
            ...
            if(!hasExecutionErrors()) {
                ...
                if(defaultCancellationPolicyName == null || defaultCancellationPolicy != null) {
                    ...
                    if(defaultReturnPolicyName == null || defaultReturnPolicy != null) {
                        ...
                        defaultApGlAccount = defaultApGlAccountName == null ? null : accountingControl.getGlAccountByName(defaultApGlAccountName);
    ...
    @Override
    protected void doUpdate(VendorType vendorType) {
        ...
        vendorTypeLogic.updateVendorTypeFromValue(this, vendorTypeDetailValue, partyPK);
        ...
        } else if(vendorTypeDescription != null) {
            if(description == null) {
