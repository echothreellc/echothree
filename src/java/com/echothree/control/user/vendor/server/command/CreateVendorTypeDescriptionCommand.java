...
@RequestScoped
public class CreateVendorTypeDescriptionCommand
        extends BaseSimpleCommand<CreateVendorTypeDescriptionForm> {
        ...
        if(vendorType != null) {
            ...
            if(language != null) {
                ...
                if(vendorTypeDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateVendorTypeDescription.name());
                }
            } else {
