...
import com.echothree.control.user.vendor.common.form.DeleteVendorTypeForm;
...
public class DeleteVendorTypeCommand
        extends BaseSimpleCommand<DeleteVendorTypeForm> {
    ...
    public DeleteVendorTypeCommand(UserVisitPK userVisitPK, DeleteVendorTypeForm form) {
