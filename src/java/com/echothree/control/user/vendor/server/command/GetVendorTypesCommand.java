...
import com.echothree.control.user.vendor.remote.form.GetVendorTypesForm;
...
public class GetVendorTypesCommand
        extends BaseSimpleCommand<GetVendorTypesForm> {
    ...
    public GetVendorTypesCommand(UserVisitPK userVisitPK, GetVendorTypesForm form) {
