...
public class GetItemPurchasingCategoryDescriptionCommand
        extends BaseSimpleCommand<GetItemPurchasingCategoryDescriptionForm> {
    ...
    public GetItemPurchasingCategoryDescriptionCommand(UserVisitPK userVisitPK, GetItemPurchasingCategoryDescriptionForm form) {
