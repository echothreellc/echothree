...
public class GetItemPurchasingCategoryDescriptionsCommand
        extends BaseSimpleCommand<GetItemPurchasingCategoryDescriptionsForm> {
    ...
    public GetItemPurchasingCategoryDescriptionsCommand(UserVisitPK userVisitPK, GetItemPurchasingCategoryDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetItemPurchasingCategoryDescriptionsResult result = VendorResultFactory.getGetItemPurchasingCategoryDescriptionsResult();
        ...
        if(itemPurchasingCategory != null) {
            ...
            result.setItemPurchasingCategoryDescriptions(vendorControl.getItemPurchasingCategoryDescriptionTransfersByItemPurchasingCategory(getUserVisit(), itemPurchasingCategory));
        } else {
