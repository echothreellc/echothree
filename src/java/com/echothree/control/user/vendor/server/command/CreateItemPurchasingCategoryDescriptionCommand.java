...
public class CreateItemPurchasingCategoryDescriptionCommand
        extends BaseSimpleCommand<CreateItemPurchasingCategoryDescriptionForm> {
    ...
    /** Creates a new instance of CreateItemPurchasingCategoryDescriptionCommand */
    public CreateItemPurchasingCategoryDescriptionCommand(UserVisitPK userVisitPK, CreateItemPurchasingCategoryDescriptionForm form) {
        ...
        if(itemPurchasingCategory != null) {
            ...
            if(language != null) {
                ...
                if(itemPurchasingCategoryDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateItemPurchasingCategoryDescription.name());
                }
            } else {
