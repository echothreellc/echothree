...
import com.echothree.control.user.vendor.remote.form.GetVendorTypeDescriptionsForm;
import com.echothree.control.user.vendor.remote.result.GetVendorTypeDescriptionsResult;
...
public class GetVendorTypeDescriptionsCommand
        extends BaseSimpleCommand<GetVendorTypeDescriptionsForm> {
    ...
    public GetVendorTypeDescriptionsCommand(UserVisitPK userVisitPK, GetVendorTypeDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(vendorType != null) {
            ...
            result.setVendorTypeDescriptions(vendorControl.getVendorTypeDescriptionTransfers(getUserVisit(), vendorType));
        } else {
