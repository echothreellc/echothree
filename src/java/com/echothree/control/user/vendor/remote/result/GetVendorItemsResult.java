...
public interface GetVendorItemsResult
        extends BaseResult {
    ...
    Long getVendorItemCount();
    void setVendorItemCount(Long vendorItemCount);
    
    List<VendorItemTransfer> getVendorItems();
    void setVendorItems(List<VendorItemTransfer> vendorItems);
