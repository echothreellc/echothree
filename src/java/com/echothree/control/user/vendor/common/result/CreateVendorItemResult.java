...
public interface CreateVendorItemResult
        extends VendorItemSpec, EntityRefSpec, BaseResult {
    
    // Nothing additional beyond VendorItemSpec, EntityRefSpec, BaseResult
