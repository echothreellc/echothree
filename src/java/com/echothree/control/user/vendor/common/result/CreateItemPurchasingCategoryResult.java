...
public interface CreateItemPurchasingCategoryResult
        extends ItemPurchasingCategorySpec, EntityRefSpec, BaseResult {
    
    // Nothing additional beyond ItemPurchasingCategorySpec, EntityRefSpec, BaseResult
