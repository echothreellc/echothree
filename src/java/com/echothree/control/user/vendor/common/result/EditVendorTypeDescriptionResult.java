...
public interface EditVendorTypeDescriptionResult
        extends BaseEditResult<VendorTypeDescriptionEdit> {
    
    VendorTypeDescriptionTransfer getVendorTypeDescription();
    void setVendorTypeDescription(VendorTypeDescriptionTransfer vendorTypeDescription);
