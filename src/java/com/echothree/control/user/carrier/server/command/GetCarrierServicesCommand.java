...
import com.echothree.control.user.carrier.remote.form.GetCarrierServicesForm;
import com.echothree.control.user.carrier.remote.result.CarrierResultFactory;
import com.echothree.control.user.carrier.remote.result.GetCarrierServicesResult;
...
public class GetCarrierServicesCommand
        extends BaseSimpleCommand<GetCarrierServicesForm> {
    ...
    public GetCarrierServicesCommand(UserVisitPK userVisitPK, GetCarrierServicesForm form) {
