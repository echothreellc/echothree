...
public class DeleteCarrierOptionDescriptionCommand
        extends BaseSimpleCommand<DeleteCarrierOptionDescriptionForm> {
    ...
    /** Creates a new instance of DeleteCarrierOptionDescriptionCommand */
    public DeleteCarrierOptionDescriptionCommand(UserVisitPK userVisitPK, DeleteCarrierOptionDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(carrier != null) {
            ...
            if(carrierOption != null) {
                ...
                if(language != null) {
                    CarrierOptionDescription carrierOptionDescription = carrierControl.getCarrierOptionDescriptionForUpdate(carrierOption, language);
                    
                    if(carrierOptionDescription != null) {
                        carrierControl.deleteCarrierOptionDescription(carrierOptionDescription, getPartyPK());
                    } else {
