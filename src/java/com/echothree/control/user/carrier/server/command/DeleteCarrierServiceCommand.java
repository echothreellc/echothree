...
import com.echothree.control.user.carrier.remote.form.DeleteCarrierServiceForm;
...
public class DeleteCarrierServiceCommand
        extends BaseSimpleCommand<DeleteCarrierServiceForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.CarrierService.name(), SecurityRoles.Delete.name())
                        )))
                )));
    ...
    /** Creates a new instance of DeleteCarrierServiceCommand */
    public DeleteCarrierServiceCommand(UserVisitPK userVisitPK, DeleteCarrierServiceForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(carrier != null) {
            ...
            if(carrierService != null) {
                carrierControl.deleteCarrierService(carrierService, getPartyPK());
            } else {
