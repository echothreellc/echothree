...
import com.echothree.control.user.carrier.remote.form.SetDefaultCarrierServiceForm;
...
public class SetDefaultCarrierServiceCommand
        extends BaseSimpleCommand<SetDefaultCarrierServiceForm> {
    ...
    /** Creates a new instance of SetDefaultCarrierServiceCommand */
    public SetDefaultCarrierServiceCommand(UserVisitPK userVisitPK, SetDefaultCarrierServiceForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(carrier != null) {
            ...
            CarrierServiceDetailValue carrierServiceDetailValue = carrierControl.getCarrierServiceDetailValueByNameForUpdate(carrierParty, carrierServiceName);
            
            if(carrierServiceDetailValue != null) {
                carrierServiceDetailValue.setIsDefault(Boolean.TRUE);
                carrierControl.updateCarrierServiceFromValue(carrierServiceDetailValue, getPartyPK());
            } else {
