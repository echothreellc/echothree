...
import com.echothree.control.user.carrier.remote.form.DeleteCarrierTypeDescriptionForm;
...
public class DeleteCarrierTypeDescriptionCommand
        extends BaseSimpleCommand<DeleteCarrierTypeDescriptionForm> {
    ...
    /** Creates a new instance of DeleteCarrierTypeDescriptionCommand */
    public DeleteCarrierTypeDescriptionCommand(UserVisitPK userVisitPK, DeleteCarrierTypeDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(carrierType != null) {
            ...
            if(language != null) {
                CarrierTypeDescription carrierTypeDescription = carrierControl.getCarrierTypeDescriptionForUpdate(carrierType, language);
                
                if(carrierTypeDescription != null) {
                    carrierControl.deleteCarrierTypeDescription(carrierTypeDescription, getPartyPK());
                } else {
