...
import com.echothree.control.user.carrier.remote.form.GetCarrierOptionsForm;
import com.echothree.control.user.carrier.remote.result.CarrierResultFactory;
import com.echothree.control.user.carrier.remote.result.GetCarrierOptionsResult;
...
public class GetCarrierOptionsCommand
        extends BaseSimpleCommand<GetCarrierOptionsForm> {
    ...
    public GetCarrierOptionsCommand(UserVisitPK userVisitPK, GetCarrierOptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetCarrierOptionsResult result = CarrierResultFactory.getGetCarrierOptionsResult();
        ...
        if(carrier != null) {
            ...
            result.setCarrierOptions(carrierControl.getCarrierOptionTransfers(getUserVisit(), carrierParty));
        } else {
