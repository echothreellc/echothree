...
import com.echothree.control.user.carrier.remote.form.GetCarrierOptionForm;
import com.echothree.control.user.carrier.remote.result.CarrierResultFactory;
import com.echothree.control.user.carrier.remote.result.GetCarrierOptionResult;
...
public class GetCarrierOptionCommand
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.CarrierOption.name(), SecurityRoles.Review.name())
                        )))
                )));
    ...
    /** Creates a new instance of GetCarrierOptionCommand */
    public GetCarrierOptionCommand(UserVisitPK userVisitPK, GetCarrierOptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetCarrierOptionResult result = CarrierResultFactory.getGetCarrierOptionResult();
