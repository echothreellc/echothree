...
import com.echothree.control.user.carrier.remote.form.GetCarrierOptionDescriptionsForm;
import com.echothree.control.user.carrier.remote.result.CarrierResultFactory;
import com.echothree.control.user.carrier.remote.result.GetCarrierOptionDescriptionsResult;
...
public class GetCarrierOptionDescriptionsCommand
        extends BaseSimpleCommand<GetCarrierOptionDescriptionsForm> {
    ...
    /** Creates a new instance of GetCarrierOptionDescriptionsCommand */
    public GetCarrierOptionDescriptionsCommand(UserVisitPK userVisitPK, GetCarrierOptionDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(carrier != null) {
            ...
            if(carrierOption != null) {
                ...
                result.setCarrierOptionDescriptions(carrierControl.getCarrierOptionDescriptionTransfers(getUserVisit(), carrierOption));
            } else {
