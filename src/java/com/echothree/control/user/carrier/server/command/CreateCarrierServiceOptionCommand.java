...
public class CreateCarrierServiceOptionCommand
    ...
    public CreateCarrierServiceOptionCommand(UserVisitPK userVisitPK, CreateCarrierServiceOptionForm form) {
                ...
                if(carrierOption != null) {
                    ...
                    if(carrierServiceOption == null) {
                        ...
                        if(selectorKind != null) {
                            SelectorType selectorType = selectorControl.getSelectorTypeByName(selectorKind, SelectorConstants.SelectorType_CARRIER_SERVICE_OPTION);
                            ...
                            if(selectorType != null) {
                                ...
                                if(recommendedGeoCodeSelectorName == null || recommendedGeoCodeSelector != null) {
                                    ...
                                    if(requiredGeoCodeSelectorName == null || requiredGeoCodeSelector != null) {
                                        ...
                                        if(selectorKind != null) {
                                            selectorType = selectorControl.getSelectorTypeByName(selectorKind, SelectorConstants.SelectorType_CARRIER_SERVICE_OPTION);
                                                    ...
                                                    if(requiredItemSelectorName == null || requiredItemSelector != null) {
                                                        ...
                                                        if(selectorKind != null) {
                                                            ...
                                                            if(selectorType != null) {
                                                                        ...
                                                                        if(selectorKind != null) {
                                                                            ...
                                                                            if(selectorType != null) {
                                                                                ...
                                                                                addExecutionError(ExecutionErrors.UnknownSelectorTypeName.name(),
                                                                                        ...
                                                                                        SelectorConstants.SelectorType_CARRIER_SERVICE_OPTION);
                                                                            }
                                                                        } else {
                                                                ...
                                                                addExecutionError(ExecutionErrors.UnknownSelectorTypeName.name(),
                                                                        SelectorConstants.SelectorKind_ORDER,
                                                                        SelectorConstants.SelectorType_CARRIER_SERVICE_OPTION);
                                                            }
                                                        } else {
