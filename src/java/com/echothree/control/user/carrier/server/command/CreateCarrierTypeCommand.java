...
public class CreateCarrierTypeCommand
        extends BaseSimpleCommand<CreateCarrierTypeForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.CarrierType.name(), SecurityRoles.Create.name())
                        )))
                )));
    ...
    /** Creates a new instance of CreateCarrierTypeCommand */
    public CreateCarrierTypeCommand(UserVisitPK userVisitPK, CreateCarrierTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(carrierType == null) {
            ...
            carrierType = carrierControl.createCarrierType(carrierTypeName, isDefault, sortOrder, getPartyPK());
