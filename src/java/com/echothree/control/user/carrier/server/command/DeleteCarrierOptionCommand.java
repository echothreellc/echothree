...
public class DeleteCarrierOptionCommand
        extends BaseSimpleCommand<DeleteCarrierOptionForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.CarrierOption.name(), SecurityRoles.Delete.name())
                        )))
                )));
    ...
    /** Creates a new instance of DeleteCarrierOptionCommand */
    public DeleteCarrierOptionCommand(UserVisitPK userVisitPK, DeleteCarrierOptionForm form) {
