...
import com.echothree.control.user.carrier.common.form.GetCarrierTypeForm;
import com.echothree.control.user.carrier.common.result.CarrierResultFactory;
import com.echothree.control.user.carrier.common.result.GetCarrierTypeResult;
...
public class GetCarrierTypeCommand
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.CarrierType.name(), SecurityRoles.Review.name())
                        )))
                )));
    ...
    /** Creates a new instance of GetCarrierTypeCommand */
    public GetCarrierTypeCommand(UserVisitPK userVisitPK, GetCarrierTypeForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetCarrierTypeResult result = CarrierResultFactory.getGetCarrierTypeResult();
        ...
        if(carrierType != null) {
            ...
            sendEventUsingNames(carrierType.getPrimaryKey(), EventTypes.READ.name(), null, null, getPartyPK());
        } else {
