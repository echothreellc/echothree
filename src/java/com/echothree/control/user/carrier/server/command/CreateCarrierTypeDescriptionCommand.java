...
public class CreateCarrierTypeDescriptionCommand
        extends BaseSimpleCommand<CreateCarrierTypeDescriptionForm> {
    ...
    /** Creates a new instance of CreateCarrierTypeDescriptionCommand */
    public CreateCarrierTypeDescriptionCommand(UserVisitPK userVisitPK, CreateCarrierTypeDescriptionForm form) {
        ...
        if(carrierType != null) {
            ...
            if(language != null) {
                ...
                if(carrierTypeDescription == null) {
                    ...
                    addExecutionError(ExecutionErrors.DuplicateCarrierTypeDescription.name(), carrierTypeName, languageIsoName);
                }
            } else {
