...
public class DeletePartyCarrierCommand
        extends BaseSimpleCommand<DeletePartyCarrierForm> {
    ...
    public DeletePartyCarrierCommand(UserVisitPK userVisitPK, DeletePartyCarrierForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(party != null) {
            ...
            if(carrier != null) {
                PartyCarrier partyCarrier = carrierControl.getPartyCarrierForUpdate(party, carrier.getParty());
                
                if(partyCarrier != null) {
                    carrierControl.deletePartyCarrier(partyCarrier, getPartyPK());
                } else {
