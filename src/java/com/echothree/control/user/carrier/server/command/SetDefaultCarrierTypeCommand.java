...
import com.echothree.control.user.carrier.common.form.SetDefaultCarrierTypeForm;
...
@Dependent
public class SetDefaultCarrierTypeCommand
        extends BaseSimpleCommand<SetDefaultCarrierTypeForm> {
