...
public class DeleteCarrierServiceDescriptionCommand
        extends BaseSimpleCommand<DeleteCarrierServiceDescriptionForm> {
    ...
    /** Creates a new instance of DeleteCarrierServiceDescriptionCommand */
    public DeleteCarrierServiceDescriptionCommand(UserVisitPK userVisitPK, DeleteCarrierServiceDescriptionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(carrier != null) {
            ...
            if(carrierService != null) {
                ...
                if(language != null) {
                    CarrierServiceDescription carrierServiceDescription = carrierControl.getCarrierServiceDescriptionForUpdate(carrierService, language);
                    
                    if(carrierServiceDescription != null) {
                        carrierControl.deleteCarrierServiceDescription(carrierServiceDescription, getPartyPK());
                    } else {
