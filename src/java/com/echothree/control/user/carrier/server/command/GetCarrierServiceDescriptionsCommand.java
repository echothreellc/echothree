...
public class GetCarrierServiceDescriptionsCommand
        extends BaseSimpleCommand<GetCarrierServiceDescriptionsForm> {
    ...
    public GetCarrierServiceDescriptionsCommand(UserVisitPK userVisitPK, GetCarrierServiceDescriptionsForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetCarrierServiceDescriptionsResult result = CarrierResultFactory.getGetCarrierServiceDescriptionsResult();
        ...
        if(carrier != null) {
            ...
            if(carrierService != null) {
                ...
                result.setCarrierServiceDescriptions(carrierControl.getCarrierServiceDescriptionTransfers(getUserVisit(), carrierService));
            } else {
