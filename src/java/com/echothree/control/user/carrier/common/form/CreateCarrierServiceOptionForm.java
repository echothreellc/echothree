...
public interface CreateCarrierServiceOptionForm
        extends CarrierServiceOptionSpec, CarrierServiceOptionEdit {
    
    // Nothing additional beyond CarrierServiceOptionSpec, CarrierServiceOptionEdit
