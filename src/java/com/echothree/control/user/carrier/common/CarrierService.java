...
public interface CarrierService
    ...
    CommandResult<GetCarrierTypeChoicesResult> getCarrierTypeChoices(UserVisitPK userVisitPK, GetCarrierTypeChoicesForm form);
    ...
    CommandResult<GetCarriersResult> getCarriers(UserVisitPK userVisitPK, GetCarriersForm form);
    ...
    CommandResult<GetCarrierServicesResult> getCarrierServices(UserVisitPK userVisitPK, GetCarrierServicesForm form);
    ...
    CommandResult<GetCarrierServiceDescriptionsResult> getCarrierServiceDescriptions(UserVisitPK userVisitPK, GetCarrierServiceDescriptionsForm form);
    ...
    CommandResult<GetCarrierOptionsResult> getCarrierOptions(UserVisitPK userVisitPK, GetCarrierOptionsForm form);
    ...
    CommandResult<GetCarrierOptionDescriptionsResult> getCarrierOptionDescriptions(UserVisitPK userVisitPK, GetCarrierOptionDescriptionsForm form);
    ...
    CommandResult<GetCarrierServiceOptionsResult> getCarrierServiceOptions(UserVisitPK userVisitPK, GetCarrierServiceOptionsForm form);
    ...
    CommandResult<GetPartyCarrierAccountsResult> getPartyCarrierAccounts(UserVisitPK userVisitPK, GetPartyCarrierAccountsForm form);
