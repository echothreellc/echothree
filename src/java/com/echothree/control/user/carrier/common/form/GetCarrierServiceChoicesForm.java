...
public interface GetCarrierServiceChoicesForm
        extends CarrierSpec {
    
    String getDefaultCarrierServiceChoice();
    void setDefaultCarrierServiceChoice(String defaultCarrierServiceChoice);
