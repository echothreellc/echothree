...
public interface CreateCarrierOptionDescriptionForm
        extends CarrierOptionDescriptionSpec, CarrierOptionDescriptionEdit {
    
    // Nothing additional beyond CarrierOptionDescriptionSpec, CarrierOptionDescriptionEdit
