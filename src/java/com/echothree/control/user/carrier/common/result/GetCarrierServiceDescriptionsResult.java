...
public interface GetCarrierServiceDescriptionsResult
        extends BaseResult {
    
    CarrierServiceTransfer getCarrierService();
    void setCarrierService(CarrierServiceTransfer carrierService);
    
    List<CarrierServiceDescriptionTransfer> getCarrierServiceDescriptions();
    void setCarrierServiceDescriptions(List<CarrierServiceDescriptionTransfer> carrierServiceDescriptions);
