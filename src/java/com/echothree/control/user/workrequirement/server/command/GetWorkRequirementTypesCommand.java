...
import com.echothree.control.user.workrequirement.remote.form.GetWorkRequirementTypesForm;
import com.echothree.control.user.workrequirement.remote.result.GetWorkRequirementTypesResult;
...
public class GetWorkRequirementTypesCommand
    ...
    public GetWorkRequirementTypesCommand(UserVisitPK userVisitPK, GetWorkRequirementTypesForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetWorkRequirementTypesResult result = WorkRequirementResultFactory.getGetWorkRequirementTypesResult();
