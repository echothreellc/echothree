...
public class GetWorkRequirementScopeCommand
        extends BaseSingleEntityCommand<WorkRequirementScope, GetWorkRequirementScopeForm> {
    ...
    @Override
    protected WorkRequirementScope getEntity() {
        ...
        if(workEffortType != null) {
            ...
            if(workEffortScope != null) {
                ...
                if(workRequirementType != null) {
                    workRequirementScope = workRequirementControl.getWorkRequirementScope(workEffortScope, workRequirementType);

                    if(workRequirementScope != null) {
                        sendEvent(workRequirementScope.getPrimaryKey(), EventTypes.READ, null, null, getPartyPK());
                    } else {
    ...
    @Override
    protected BaseResult getResult(WorkRequirementScope workRequirementScope) {
