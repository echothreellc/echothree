...
public class DeleteWorkRequirementTypeCommand
        extends BaseSimpleCommand<DeleteWorkRequirementTypeForm> {
    ...
    public DeleteWorkRequirementTypeCommand(UserVisitPK userVisitPK, DeleteWorkRequirementTypeForm form) {
