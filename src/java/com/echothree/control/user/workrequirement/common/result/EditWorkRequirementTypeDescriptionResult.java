...
public interface EditWorkRequirementTypeDescriptionResult
        extends BaseEditResult<WorkRequirementTypeDescriptionEdit> {
    
    WorkRequirementTypeDescriptionTransfer getWorkRequirementTypeDescription();
    void setWorkRequirementTypeDescription(WorkRequirementTypeDescriptionTransfer workRequirementTypeDescription);
