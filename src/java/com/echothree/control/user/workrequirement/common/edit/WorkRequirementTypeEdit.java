...
package com.echothree.control.user.workrequirement.common.edit;

import com.echothree.control.user.workflow.common.spec.WorkflowStepSpec;

public interface WorkRequirementTypeEdit
        extends WorkflowStepSpec, WorkRequirementTypeDescriptionEdit {
    
    String getWorkRequirementTypeName();
    void setWorkRequirementTypeName(String workRequirementTypeName);
    
    String getWorkRequirementSequenceName();
    void setWorkRequirementSequenceName(String workRequirementSequenceName);
    ...
    String getAllowReassignment();
    void setAllowReassignment(String allowReassignment);
