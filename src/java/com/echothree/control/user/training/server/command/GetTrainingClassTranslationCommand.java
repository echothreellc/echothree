...
import com.echothree.control.user.training.remote.form.GetTrainingClassTranslationForm;
import com.echothree.control.user.training.remote.result.GetTrainingClassTranslationResult;
...
public class GetTrainingClassTranslationCommand
        extends BaseSimpleCommand<GetTrainingClassTranslationForm> {
    ...
    protected BaseResult execute() {
        ...
        GetTrainingClassTranslationResult result = TrainingResultFactory.getGetTrainingClassTranslationResult();
