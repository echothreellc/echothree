...
import com.echothree.control.user.training.remote.form.GetPartyTrainingClassForm;
import com.echothree.control.user.training.remote.result.GetPartyTrainingClassResult;
...
public class GetPartyTrainingClassCommand
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.PartyTrainingClass.name(), SecurityRoles.Review.name())
                        )))
                )));
    ...
    public GetPartyTrainingClassCommand(UserVisitPK userVisitPK, GetPartyTrainingClassForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetPartyTrainingClassResult result = TrainingResultFactory.getGetPartyTrainingClassResult();
