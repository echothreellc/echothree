...
public class GetTrainingClassTranslationsCommand
        extends BaseSimpleCommand<GetTrainingClassTranslationsForm> {
    ...
    /** Creates a new instance of GetTrainingClassTranslationsCommand */
    public GetTrainingClassTranslationsCommand(UserVisitPK userVisitPK, GetTrainingClassTranslationsForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(trainingClass != null) {
            ...
            result.setTrainingClassTranslations(trainingControl.getTrainingClassTranslationTransfers(getUserVisit(), trainingClass));
        } else {
