...
import com.echothree.control.user.training.remote.form.GetTrainingClassPagesForm;
import com.echothree.control.user.training.remote.result.GetTrainingClassPagesResult;
...
public class GetTrainingClassPagesCommand
    ...
    public GetTrainingClassPagesCommand(UserVisitPK userVisitPK, GetTrainingClassPagesForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetTrainingClassPagesResult result = TrainingResultFactory.getGetTrainingClassPagesResult();
