...
public class GetTrainingClassAnswerTranslationsCommand
        extends BaseSimpleCommand<GetTrainingClassAnswerTranslationsForm> {
    ...
    /** Creates a new instance of GetTrainingClassAnswerTranslationsCommand */
    public GetTrainingClassAnswerTranslationsCommand(UserVisitPK userVisitPK, GetTrainingClassAnswerTranslationsForm form) {
            ...
            if(trainingClassSection != null) {
                ...
                if(trainingClassQuestion != null) {
                    ...
                    if(trainingClassAnswer != null) {
                        ...
                        result.setTrainingClassAnswerTranslations(trainingControl.getTrainingClassAnswerTranslationTransfers(getUserVisit(), trainingClassAnswer));
                    } else {
