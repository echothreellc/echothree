...
import com.echothree.control.user.training.remote.form.GetTrainingClassSectionsForm;
import com.echothree.control.user.training.remote.result.GetTrainingClassSectionsResult;
...
public class GetTrainingClassSectionsCommand
    ...
    public GetTrainingClassSectionsCommand(UserVisitPK userVisitPK, GetTrainingClassSectionsForm form) {
