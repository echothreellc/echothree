...
public class DeleteTrainingClassPageCommand
        extends BaseSimpleCommand<DeleteTrainingClassPageForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.TrainingClassPage.name(), SecurityRoles.Delete.name())
                        )))
                )));
    ...
    /** Creates a new instance of DeleteTrainingClassPageCommand */
    public DeleteTrainingClassPageCommand(UserVisitPK userVisitPK, DeleteTrainingClassPageForm form) {
