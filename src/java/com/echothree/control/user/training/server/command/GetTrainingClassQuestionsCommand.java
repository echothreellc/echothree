...
import com.echothree.control.user.training.remote.form.GetTrainingClassQuestionsForm;
import com.echothree.control.user.training.remote.result.GetTrainingClassQuestionsResult;
...
public class GetTrainingClassQuestionsCommand
        extends BaseSimpleCommand<GetTrainingClassQuestionsForm> {
    ...
    public GetTrainingClassQuestionsCommand(UserVisitPK userVisitPK, GetTrainingClassQuestionsForm form) {
