...
import com.echothree.control.user.training.common.form.DeleteTrainingClassForm;
...
public class DeleteTrainingClassCommand
        extends BaseSimpleCommand<DeleteTrainingClassForm> {
    ...
    public DeleteTrainingClassCommand(UserVisitPK userVisitPK, DeleteTrainingClassForm form) {
