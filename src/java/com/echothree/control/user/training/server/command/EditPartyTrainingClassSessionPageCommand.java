...
import com.echothree.control.user.training.remote.edit.PartyTrainingClassSessionPageEdit;
import com.echothree.control.user.training.remote.edit.TrainingEditFactory;
import com.echothree.control.user.training.remote.form.EditPartyTrainingClassSessionPageForm;
import com.echothree.control.user.training.remote.result.EditPartyTrainingClassSessionPageResult;
import com.echothree.control.user.training.remote.result.TrainingResultFactory;
import com.echothree.control.user.training.remote.spec.PartyTrainingClassSessionPageSpec;
...
public class EditPartyTrainingClassSessionPageCommand
    ...
    public EditPartyTrainingClassSessionPageCommand(UserVisitPK userVisitPK, EditPartyTrainingClassSessionPageForm form) {
