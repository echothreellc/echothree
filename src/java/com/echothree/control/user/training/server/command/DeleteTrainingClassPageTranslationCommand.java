...
public class DeleteTrainingClassPageTranslationCommand
        extends BaseSimpleCommand<DeleteTrainingClassPageTranslationForm> {
    ...
    /** Creates a new instance of DeleteTrainingClassPageTranslationCommand */
    public DeleteTrainingClassPageTranslationCommand(UserVisitPK userVisitPK, DeleteTrainingClassPageTranslationForm form) {
                ...
                if(trainingClassPage != null) {
                    ...
                    if(language != null) {
                        ...
                        if(trainingClassPageTranslation != null) {
                            trainingControl.deleteTrainingClassPageTranslation(trainingClassPageTranslation, getPartyPK());
                        } else {
