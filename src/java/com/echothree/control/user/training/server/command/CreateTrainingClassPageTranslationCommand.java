...
import com.echothree.control.user.training.remote.form.CreateTrainingClassPageTranslationForm;
...
public class CreateTrainingClassPageTranslationCommand
    ...
    public CreateTrainingClassPageTranslationCommand(UserVisitPK userVisitPK, CreateTrainingClassPageTranslationForm form) {
                ...
                if(trainingClassPage != null) {
                    ...
                    if(language != null) {
                        ...
                        if(trainingClassPageTranslation == null) {
                            ...
                            String pageMimeTypeName = form.getPageMimeTypeName();
                            String page = form.getPage();

                            MimeType pageMimeType = mimeTypeLogic.checkMimeType(this, pageMimeTypeName, page, MimeTypeUsageTypes.TEXT.name(),
