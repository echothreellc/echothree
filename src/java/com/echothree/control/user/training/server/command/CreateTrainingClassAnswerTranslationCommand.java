...
public class CreateTrainingClassAnswerTranslationCommand
        extends BaseSimpleCommand<CreateTrainingClassAnswerTranslationForm> {
    ...
    public CreateTrainingClassAnswerTranslationCommand(UserVisitPK userVisitPK, CreateTrainingClassAnswerTranslationForm form) {
                        ...
                        if(language != null) {
                            ...
                            if(trainingClassAnswerTranslation == null) {
                                ...
                                if(!hasExecutionErrors()) {
                                    ...
                                    if(!hasExecutionErrors()) {
                                        trainingControl.createTrainingClassAnswerTranslation(trainingClassAnswer, language, answerMimeType, answer,
                                                selectedMimeType, selected, getPartyPK());
                                    }
                                }
                            } else {
                                addExecutionError(ExecutionErrors.DuplicateTrainingClassAnswerTranslation.name(), trainingClassName, trainingClassSectionName,
