...
import com.echothree.control.user.training.remote.form.GetTrainingClassSectionTranslationsForm;
import com.echothree.control.user.training.remote.result.GetTrainingClassSectionTranslationsResult;
...
public class GetTrainingClassSectionTranslationsCommand
        extends BaseSimpleCommand<GetTrainingClassSectionTranslationsForm> {
    ...
    /** Creates a new instance of GetTrainingClassSectionTranslationsCommand */
    public GetTrainingClassSectionTranslationsCommand(UserVisitPK userVisitPK, GetTrainingClassSectionTranslationsForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(trainingClass != null) {
            ...
            if(trainingClassSection != null) {
                ...
                result.setTrainingClassSectionTranslations(trainingControl.getTrainingClassSectionTranslationTransfers(getUserVisit(), trainingClassSection));
            } else {
