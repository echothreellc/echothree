...
import com.echothree.control.user.training.common.form.DeleteTrainingClassSectionTranslationForm;
...
public class DeleteTrainingClassSectionTranslationCommand
        extends BaseSimpleCommand<DeleteTrainingClassSectionTranslationForm> {
    ...
    /** Creates a new instance of DeleteTrainingClassSectionTranslationCommand */
    public DeleteTrainingClassSectionTranslationCommand(UserVisitPK userVisitPK, DeleteTrainingClassSectionTranslationForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(trainingClass != null) {
            ...
            if(trainingClassSection != null) {
                ...
                if(language != null) {
                    TrainingClassSectionTranslation trainingClassSectionTranslation = trainingControl.getTrainingClassSectionTranslationForUpdate(trainingClassSection, language);

                    if(trainingClassSectionTranslation != null) {
                        trainingControl.deleteTrainingClassSectionTranslation(trainingClassSectionTranslation, getPartyPK());
                    } else {
