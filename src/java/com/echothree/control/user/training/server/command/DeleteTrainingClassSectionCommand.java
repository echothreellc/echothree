...
public class DeleteTrainingClassSectionCommand
        extends BaseSimpleCommand<DeleteTrainingClassSectionForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyTypes.EMPLOYEE.name(), Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.TrainingClassSection.name(), SecurityRoles.Delete.name())
                        )))
                )));
    ...
    /** Creates a new instance of DeleteTrainingClassSectionCommand */
    public DeleteTrainingClassSectionCommand(UserVisitPK userVisitPK, DeleteTrainingClassSectionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(trainingClass != null) {
            ...
            TrainingClassSection trainingClassSection = trainingControl.getTrainingClassSectionByNameForUpdate(trainingClass, trainingClassSectionName);

            if(trainingClassSection != null) {
                trainingControl.deleteTrainingClassSection(trainingClassSection, getPartyPK());
            } else {
