...
import com.echothree.control.user.training.remote.form.DeletePartyTrainingClassForm;
...
public class DeletePartyTrainingClassCommand
        extends BaseSimpleCommand<DeletePartyTrainingClassForm> {
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.PartyTrainingClass.name(), SecurityRoles.Delete.name())
                        )))
                )));
    ...
    protected BaseResult execute() {
        ...
        if(partyTrainingClass != null) {
            PartyTrainingClassLogic.getInstance().deletePartyTrainingClass(partyTrainingClass, getPartyPK());
        } else {
