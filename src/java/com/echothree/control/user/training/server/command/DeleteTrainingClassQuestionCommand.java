...
import com.echothree.control.user.training.remote.form.DeleteTrainingClassQuestionForm;
...
public class DeleteTrainingClassQuestionCommand
        extends BaseSimpleCommand<DeleteTrainingClassQuestionForm> {
    ...
    /** Creates a new instance of DeleteTrainingClassQuestionCommand */
    public DeleteTrainingClassQuestionCommand(UserVisitPK userVisitPK, DeleteTrainingClassQuestionForm form) {
    ...
    protected BaseResult execute() {
        ...
        if(trainingClass != null) {
            ...
            if(trainingClassSection != null) {
                ...
                TrainingClassQuestion trainingClassQuestion = trainingControl.getTrainingClassQuestionByNameForUpdate(trainingClassSection,
                        trainingClassQuestionName);

                if(trainingClassQuestion != null) {
                    trainingControl.deleteTrainingClassQuestion(trainingClassQuestion, getPartyPK());
                } else {
