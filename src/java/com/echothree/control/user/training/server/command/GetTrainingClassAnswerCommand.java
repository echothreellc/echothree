...
public class GetTrainingClassAnswerCommand
    ...
    static {
        COMMAND_SECURITY_DEFINITION = new CommandSecurityDefinition(Collections.unmodifiableList(Arrays.asList(
                ...
                new PartyTypeDefinition(PartyConstants.PartyType_EMPLOYEE, Collections.unmodifiableList(Arrays.asList(
                        new SecurityRoleDefinition(SecurityRoleGroups.TrainingClassAnswer.name(), SecurityRoles.Review.name())
                        )))
                )));
    ...
    public GetTrainingClassAnswerCommand(UserVisitPK userVisitPK, GetTrainingClassAnswerForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetTrainingClassAnswerResult result = TrainingResultFactory.getGetTrainingClassAnswerResult();
            ...
            if(trainingClassSection != null) {
                ...
                if(trainingClassQuestion != null) {
                    ...
                    if(trainingClassAnswer != null) {
                        ...
                        sendEventUsingNames(trainingClassAnswer.getPrimaryKey(), EventTypes.READ.name(), null, null, getPartyPK());
                    } else {
