...
import com.echothree.control.user.training.remote.form.GetTrainingClassPageTranslationsForm;
import com.echothree.control.user.training.remote.result.GetTrainingClassPageTranslationsResult;
...
public class GetTrainingClassPageTranslationsCommand
        extends BaseSimpleCommand<GetTrainingClassPageTranslationsForm> {
    ...
    public GetTrainingClassPageTranslationsCommand(UserVisitPK userVisitPK, GetTrainingClassPageTranslationsForm form) {
        ...
        if(trainingClass != null) {
            ...
            if(trainingClassSection != null) {
                ...
                if(trainingClassPage != null) {
                    ...
                    result.setTrainingClassPageTranslations(trainingControl.getTrainingClassPageTranslationTransfers(getUserVisit(), trainingClassPage));
                } else {
