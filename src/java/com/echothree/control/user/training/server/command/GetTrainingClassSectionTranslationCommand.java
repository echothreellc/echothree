...
import com.echothree.control.user.training.remote.form.GetTrainingClassSectionTranslationForm;
import com.echothree.control.user.training.remote.result.GetTrainingClassSectionTranslationResult;
...
public class GetTrainingClassSectionTranslationCommand
        extends BaseSimpleCommand<GetTrainingClassSectionTranslationForm> {
    ...
    /** Creates a new instance of GetTrainingClassSectionTranslationCommand */
    public GetTrainingClassSectionTranslationCommand(UserVisitPK userVisitPK, GetTrainingClassSectionTranslationForm form) {
