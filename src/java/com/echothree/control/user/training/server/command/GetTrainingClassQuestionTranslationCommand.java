...
public class GetTrainingClassQuestionTranslationCommand
        extends BaseSimpleCommand<GetTrainingClassQuestionTranslationForm> {
    ...
    /** Creates a new instance of GetTrainingClassQuestionTranslationCommand */
    public GetTrainingClassQuestionTranslationCommand(UserVisitPK userVisitPK, GetTrainingClassQuestionTranslationForm form) {
    ...
    protected BaseResult execute() {
        ...
        GetTrainingClassQuestionTranslationResult result = TrainingResultFactory.getGetTrainingClassQuestionTranslationResult();
        ...
        if(trainingClass != null) {
            ...
            if(trainingClassSection != null) {
                ...
                if(trainingClassQuestion != null) {
                    ...
                    if(language != null) {
                        TrainingClassQuestionTranslation trainingClassQuestionTranslation = trainingControl.getTrainingClassQuestionTranslation(trainingClassQuestion,
                                language);

                        if(trainingClassQuestionTranslation != null) {
                            result.setTrainingClassQuestionTranslation(trainingControl.getTrainingClassQuestionTranslationTransfer(getUserVisit(),
                                    trainingClassQuestionTranslation));
                        } else {
