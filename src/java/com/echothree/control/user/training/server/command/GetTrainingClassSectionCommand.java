...
public class GetTrainingClassSectionCommand
    ...
    public GetTrainingClassSectionCommand(UserVisitPK userVisitPK, GetTrainingClassSectionForm form) {
            ...
            if(trainingClassSection != null) {
                ...
                if(!hasExecutionErrors()) {
                    ...
                    if(!hasExecutionErrors()) {
                        ...
                        sendEventUsingNames(trainingClassSection.getPrimaryKey(), EventTypes.READ.name(), null, null, partyPK);
