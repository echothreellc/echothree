...
public interface CreateTrainingClassPageForm
        extends TrainingClassSectionSpec, TrainingClassPageEdit {
    
    // Nothing additional beyond TrainingClassSectionSpec, TrainingClassPageEdit
