...
public interface CreateTrainingClassPageTranslationForm
        extends TrainingClassPageTranslationSpec, TrainingClassPageTranslationEdit {
    
    // Nothing additional beyond TrainingClassPageTranslationSpec, TrainingClassPageTranslationEdit
