...
public interface CreateTrainingClassAnswerForm
        extends TrainingClassQuestionSpec, TrainingClassAnswerEdit {
    
    // Nothing additional beyond TrainingClassQuestionSpec, TrainingClassAnswerEdit
