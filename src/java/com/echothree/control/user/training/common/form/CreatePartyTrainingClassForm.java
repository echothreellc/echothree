...
public interface CreatePartyTrainingClassForm
        extends PartySpec, TrainingClassSpec, PartyTrainingClassEdit {
    
    // Nothing additional beyond PartySpec, TrainingClassSpec, PartyTrainingClassEdit
