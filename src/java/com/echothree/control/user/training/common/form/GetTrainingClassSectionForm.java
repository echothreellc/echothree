...
public interface GetTrainingClassSectionForm
        extends TrainingClassSectionSpec, PartyTrainingClassSpec {
    
    // Nothing additional beyond TrainingClassSectionSpec, PartyTrainingClassSpec
