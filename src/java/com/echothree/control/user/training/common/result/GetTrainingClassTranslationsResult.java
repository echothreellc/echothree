...
public interface GetTrainingClassTranslationsResult
        extends BaseResult {
    
    TrainingClassTransfer getTrainingClass();
    void setTrainingClass(TrainingClassTransfer trainingClass);
    
    List<TrainingClassTranslationTransfer> getTrainingClassTranslations();
    void setTrainingClassTranslations(List<TrainingClassTranslationTransfer> trainingClassTranslations);
