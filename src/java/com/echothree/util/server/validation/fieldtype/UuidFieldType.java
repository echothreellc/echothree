...
public class UuidFieldType
    ...
    private static final long defaultMaximumLength = 36;
    private static final Long defaultMaximumLengthLong = defaultMaximumLength;
    
    /** Creates a new instance of UuidFieldType */
    public UuidFieldType(Validator validator, BaseForm baseForm, Messages validationMessages, String fieldValue, String []splitFieldName, FieldDefinition fieldDefinition) {
