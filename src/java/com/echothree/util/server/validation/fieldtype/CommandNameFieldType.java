...
public class CommandNameFieldType
    ...
    private static final long defaultMaximumLength = 80;
    private static final Long defaultMaximumLengthLong = defaultMaximumLength;
    
    /** Creates a new instance of CommandNameFieldType */
    public CommandNameFieldType(Validator validator, BaseForm baseForm, Messages validationMessages, String fieldValue, String []splitFieldName, FieldDefinition fieldDefinition) {
