...
public class UpperLetter2FieldType
        extends BaseFieldType {
    
    /** Creates a new instance of UpperLetter2FieldType */
    public UpperLetter2FieldType(Validator validator, BaseForm baseForm, Messages validationMessages, String fieldValue, String[] splitFieldName, FieldDefinition fieldDefinition) {
    ...
    public String validate() {
        ...
        Matcher m = Patterns.UpperLetter2.matcher(fieldValue);
        if(!m.matches()) {
