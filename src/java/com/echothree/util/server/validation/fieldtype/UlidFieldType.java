...
public class UlidFieldType
    ...
    private static final long defaultMaximumLength = 26;
    private static final Long defaultMaximumLengthLong = defaultMaximumLength;
    
    /** Creates a new instance of GuidFieldType */
    public UlidFieldType(Validator validator, BaseForm baseForm, Messages validationMessages, String fieldValue, String []splitFieldName, FieldDefinition fieldDefinition) {
    ...
    public String validate() {
        ...
        try {
            com.echothree.util.server.ulid.ULID.fromString(fieldValue);
