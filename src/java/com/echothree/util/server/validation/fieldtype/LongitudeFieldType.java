...
public class LongitudeFieldType
        extends BaseDegreeFieldType {
    
    /** Creates a new instance of LongitudeFieldType */
    public LongitudeFieldType(Validator validator, BaseForm baseForm, Messages validationMessages, String fieldValue,
    ...
    public String validate() {
        ...
        if(!hadErrors) {
            hadErrors = !isValidSignedInteger(-180000000L, 180000000L);
        }
