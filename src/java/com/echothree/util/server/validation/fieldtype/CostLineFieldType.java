...
public class CostLineFieldType
        extends BaseCurrencyFieldType {
    
    /** Creates a new instance of CostLineFieldType */
    public CostLineFieldType(Validator validator, BaseForm baseForm, Messages validationMessages, String fieldValue,
    ...
    public String validate() {
        ...
        if(currency == null) {
            ...
            fieldValue = DecimalUtils.getInstance().parse(currency.getMinusSign(), currency.getFractionSeparator(),
                    currency.getCostLineFractionDigits(), fieldValue);
        }
