...
public class TimeZoneNameFieldType
    ...
    /** Creates a new instance of TimeZoneNameFieldType */
    public TimeZoneNameFieldType(Validator validator, BaseForm baseForm, Messages validationMessages, String fieldValue, String []splitFieldName, FieldDefinition fieldDefinition) {
    ...
    public String validate() {
        ...
        Matcher m = Patterns.TimeZoneName.matcher(fieldValue);
        if(!m.matches()) {
