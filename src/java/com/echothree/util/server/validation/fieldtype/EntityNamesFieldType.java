...
public class EntityNamesFieldType
    ...
    public EntityNamesFieldType(Validator validator, BaseForm baseForm, Messages validationMessages, String fieldValue, String []splitFieldName, FieldDefinition fieldDefinition) {
    ...
    public String validate() {
        ...
        Matcher m = Patterns.EntityNames.matcher(fieldValue);
        if(!m.matches()) {
