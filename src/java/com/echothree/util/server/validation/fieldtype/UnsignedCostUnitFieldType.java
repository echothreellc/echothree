...
public class UnsignedCostUnitFieldType
        extends BaseCurrencyFieldType {
    
    /** Creates a new instance of UnsignedCostUnitFieldType */
    public UnsignedCostUnitFieldType(Validator validator, BaseForm baseForm, Messages validationMessages, String fieldValue,
    ...
    public String validate() {
        ...
        if(currency == null) {
            ...
            fieldValue = DecimalUtils.getInstance().parse(null, currency.getFractionSeparator(), currency.getCostUnitFractionDigits(),
                    fieldValue);
        }
