...
public class UpperLetter3FieldType
        extends BaseFieldType {
    
    /** Creates a new instance of UpperLetter3FieldType */
    public UpperLetter3FieldType(Validator validator, BaseForm baseForm, Messages validationMessages, String fieldValue, String[] splitFieldName, FieldDefinition fieldDefinition) {
    ...
    public String validate() {
        ...
        Matcher m = Patterns.UpperLetter3.matcher(fieldValue);
        if(!m.matches()) {
