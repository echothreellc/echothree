...
public class UnsignedPriceLineFieldType
        extends BaseCurrencyFieldType {
    
    /** Creates a new instance of UnsignedPriceLineFieldType */
    public UnsignedPriceLineFieldType(Validator validator, BaseForm baseForm, Messages validationMessages, String fieldValue,
    ...
    public String validate() {
        ...
        if(currency == null) {
            ...
            fieldValue = DecimalUtils.getInstance().parse(null, currency.getFractionSeparator(), currency.getPriceLineFractionDigits(),
                    fieldValue);
        }
