...
public class EntityTypeNameFieldType
    ...
    private static final long defaultMaximumLength = 64;
    private static final Long defaultMaximumLengthLong = defaultMaximumLength;
    
    /** Creates a new instance of EntityTypeNameFieldType */
    public EntityTypeNameFieldType(Validator validator, BaseForm baseForm, Messages validationMessages, String fieldValue, String []splitFieldName, FieldDefinition fieldDefinition) {
