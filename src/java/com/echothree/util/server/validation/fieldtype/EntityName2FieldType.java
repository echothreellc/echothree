...
public class EntityName2FieldType
        extends BaseFieldType {
    
    private static final long defaultMinimumLength = 3;
    private static final Long defaultMinimumLengthLong = defaultMinimumLength;
    
    private static final long defaultMaximumLength = 81;
    private static final Long defaultMaximumLengthLong = defaultMaximumLength;
    
    /** Creates a new instance of EntityName2FieldType */
    public EntityName2FieldType(Validator validator, BaseForm baseForm, Messages validationMessages, String fieldValue, String []splitFieldName, FieldDefinition fieldDefinition) {
    ...
    public String validate() {
        ...
        Matcher m = Patterns.EntityName2.matcher(fieldValue);
        if(!m.matches()) {
