...
public class MimeTypeFieldType
    ...
    /** Creates a new instance of MimeTypeFieldType */
    public MimeTypeFieldType(Validator validator, BaseForm baseForm, Messages validationMessages, String fieldValue, String []splitFieldName, FieldDefinition fieldDefinition) {
    ...
    public String validate() {
        ...
        Matcher m = Patterns.MimeType.matcher(fieldValue);
        if(!m.matches()) {
