...
public class RegularExpressionFieldType
    ...
    private static final long defaultMaximumLength = 128;
    private static final Long defaultMaximumLengthLong = defaultMaximumLength;
    
    /** Creates a new instance of RegularExpressionFieldType */
    public RegularExpressionFieldType(Validator validator, BaseForm baseForm, Messages validationMessages, String fieldValue, String []splitFieldName, FieldDefinition fieldDefinition) {
