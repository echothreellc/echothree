...
public class YearFieldType
        extends BaseFieldType {
    
    /** Creates a new instance of YearFieldType */
    public YearFieldType(Validator validator, BaseForm baseForm, Messages validationMessages, String fieldValue, String[] splitFieldName, FieldDefinition fieldDefinition) {
    ...
    public String validate() {
        ...
        Matcher m = Patterns.Year.matcher(fieldValue);
        if(!m.matches()) {
