...
import com.echothree.control.user.warehouse.common.form.DeleteLocationDescriptionForm;
...
@SproutAction(
    path = "/Warehouse/Location/DescriptionDelete",
...
public class DescriptionDeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            DeleteLocationDescriptionForm commandForm = WarehouseUtil.getHome().getDeleteLocationDescriptionForm();
            
            commandForm.setWarehouseName(warehouseName);
            commandForm.setLocationName(locationName);
            commandForm.setLanguageIsoName(languageIsoName);
            
            WarehouseUtil.getHome().deleteLocationDescription(getUserVisitPK(request), commandForm);
