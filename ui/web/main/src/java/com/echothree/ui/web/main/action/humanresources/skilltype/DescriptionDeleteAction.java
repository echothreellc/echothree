...
import com.echothree.control.user.employee.remote.form.DeleteSkillTypeDescriptionForm;
...
@SproutAction(
    path = "/HumanResources/SkillType/DescriptionDelete",
...
public class DescriptionDeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            DeleteSkillTypeDescriptionForm commandForm = EmployeeUtil.getHome().getDeleteSkillTypeDescriptionForm();
            
            commandForm.setSkillTypeName(skillTypeName);
            commandForm.setLanguageIsoName(languageIsoName);
            
            EmployeeUtil.getHome().deleteSkillTypeDescription(getUserVisitPK(request), commandForm);
