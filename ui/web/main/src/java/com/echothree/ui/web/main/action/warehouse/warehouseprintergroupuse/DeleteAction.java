...
@SproutAction(
    path = "/Warehouse/WarehousePrinterGroupUse/Delete",
    mappingClass = SecureActionMapping.class,
    name = "WarehousePrinterGroupUseDelete",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Warehouse/WarehousePrinterGroupUse/Main", redirect = true),
        @SproutForward(name = "Form", path = "/warehouse/warehouseprintergroupuse/delete.jsp")
    }
)
public class DeleteAction
    ...
    public void setupTransfer(DeleteActionForm actionForm, HttpServletRequest request)
        ...
        BaseWarehousePrinterGroupUseAction.setupPartyPrinterGroupUseTransfer(request, actionForm.getPartyName(), actionForm.getPrinterGroupUseTypeName());
