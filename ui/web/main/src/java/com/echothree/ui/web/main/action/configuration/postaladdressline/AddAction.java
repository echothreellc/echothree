...
@SproutAction(
    path = "/Configuration/PostalAddressLine/Add",
    mappingClass = SecureActionMapping.class,
    name = "PostalAddressLineAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Configuration/PostalAddressLine/Main", redirect = true),
        @SproutForward(name = "Form", path = "/configuration/postaladdressline/add.jsp")
    }
)
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    ...
                    commandForm.setPostalAddressLineSortOrder(actionForm.getPostalAddressLineSortOrder());
