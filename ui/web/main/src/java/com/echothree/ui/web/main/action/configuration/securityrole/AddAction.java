...
@SproutAction(
    path = "/Configuration/SecurityRole/Add",
    mappingClass = SecureActionMapping.class,
    name = "SecurityRoleAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Configuration/SecurityRole/Main", redirect = true),
        @SproutForward(name = "Form", path = "/configuration/securityrole/add.jsp")
    }
)
public class AddAction
    ...
    public CommandResult doAdd(AddActionForm actionForm, HttpServletRequest request)
        ...
        return SecurityUtil.getHome().createSecurityRole(getUserVisitPK(request), commandForm);
    }
