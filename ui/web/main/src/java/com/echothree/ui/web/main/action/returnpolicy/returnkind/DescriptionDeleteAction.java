...
@SproutAction(
    path = "/ReturnPolicy/ReturnKind/DescriptionDelete",
...
public class DescriptionDeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            DeleteReturnKindDescriptionForm commandForm = ReturnPolicyUtil.getHome().getDeleteReturnKindDescriptionForm();
            
            commandForm.setReturnKindName(returnKindName);
            commandForm.setLanguageIsoName(languageIsoName);
            
            ReturnPolicyUtil.getHome().deleteReturnKindDescription(getUserVisitPK(request), commandForm);
