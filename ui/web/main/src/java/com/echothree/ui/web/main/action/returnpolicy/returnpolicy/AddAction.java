    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    var commandForm = ReturnPolicyUtil.getHome().getCreateReturnPolicyForm();
                    ...
                    var commandResult = ReturnPolicyUtil.getHome().createReturnPolicy(getUserVisitPK(request), commandForm);
