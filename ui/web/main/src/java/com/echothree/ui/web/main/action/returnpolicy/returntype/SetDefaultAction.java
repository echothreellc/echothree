...
import com.echothree.control.user.returnpolicy.remote.form.SetDefaultReturnTypeForm;
...
@SproutAction(
    path = "/ReturnPolicy/ReturnType/SetDefault",
...
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            SetDefaultReturnTypeForm commandForm = ReturnPolicyUtil.getHome().getSetDefaultReturnTypeForm();
            ...
            ReturnPolicyUtil.getHome().setDefaultReturnType(getUserVisitPK(request), commandForm);
