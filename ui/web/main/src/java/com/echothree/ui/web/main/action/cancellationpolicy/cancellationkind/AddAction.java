...
import com.echothree.control.user.cancellationpolicy.remote.form.CreateCancellationKindForm;
...
@SproutAction(
    path = "/CancellationPolicy/CancellationKind/Add",
    mappingClass = SecureActionMapping.class,
    name = "CancellationKindAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/CancellationPolicy/CancellationKind/Main", redirect = true),
        @SproutForward(name = "Form", path = "/cancellationpolicy/cancellationkind/add.jsp")
    }
)
