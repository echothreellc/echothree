...
@SproutAction(
    path = "/Purchasing/VendorContactMechanism/ContactPostalAddressStatus",
    mappingClass = SecureActionMapping.class,
    name = "VendorContactPostalAddressStatus",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Purchasing/VendorContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/purchasing/vendorcontactmechanism/contactPostalAddressStatus.jsp")
    }
)
public class ContactPostalAddressStatusAction
        extends BaseVendorContactMechanismAction<ContactPostalAddressStatusActionForm> {
