...
import com.echothree.control.user.offer.remote.form.SetDefaultUseTypeForm;
...
@SproutAction(
    path = "/Advertising/UseType/SetDefault",
...
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            SetDefaultUseTypeForm commandForm = OfferUtil.getHome().getSetDefaultUseTypeForm();
            String useTypeName = request.getParameter(ParameterConstants.USE_TYPE_NAME);
            
            commandForm.setUseTypeName(useTypeName);
            
            OfferUtil.getHome().setDefaultUseType(getUserVisitPK(request), commandForm);
