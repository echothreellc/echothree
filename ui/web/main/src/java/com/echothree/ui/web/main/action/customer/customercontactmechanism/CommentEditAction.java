...
@SproutAction(
    path = "/Customer/CustomerContactMechanism/CommentEdit",
    mappingClass = SecureActionMapping.class,
    name = "CustomerContactMechanismCommentEdit",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Customer/CustomerContactMechanism/Review", redirect = true),
        @SproutForward(name = "Form", path = "/customer/customercontactmechanism/commentEdit.jsp")
    }
)
