...
import com.echothree.control.user.queue.remote.form.GetQueueTypeForm;
import com.echothree.control.user.queue.remote.result.GetQueueTypeResult;
...
@SproutAction(
    path = "/Core/QueueType/Review",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/core/queuetype/review.jsp")
    }
)
public class ReviewAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        if(queueType == null) {
            ...
            request.setAttribute(AttributeConstants.QUEUE_TYPE, queueType);
