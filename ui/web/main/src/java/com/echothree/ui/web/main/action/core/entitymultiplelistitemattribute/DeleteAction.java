...
import com.echothree.control.user.core.remote.form.DeleteEntityMultipleListItemAttributeForm;
...
@SproutAction(
    path = "/Core/EntityMultipleListItemAttribute/Delete",
...
public class DeleteAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            CoreUtil.getHome().deleteEntityMultipleListItemAttribute(getUserVisitPK(request), commandForm);
