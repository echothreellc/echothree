...
@SproutAction(
    path = "/Customer/CustomerContactMechanism/ContactPostalAddressEdit",
    mappingClass = SecureActionMapping.class,
    name = "CustomerContactPostalAddressEdit",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Customer/CustomerContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/customer/customercontactmechanism/contactPostalAddressEdit.jsp")
    }
)
public class ContactPostalAddressEditAction
        extends BaseCustomerContactMechanismAction<ContactPostalAddressEditActionForm> {
