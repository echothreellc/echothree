...
@SproutAction(
    path = "/ReturnPolicy/ReturnPolicy/Edit",
    ...
    forwards = {
        ...
        @SproutForward(name = "Form", path = "/returnpolicy/returnpolicy/edit.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(originalReturnPolicyName == null)
                    originalReturnPolicyName = actionForm.getOriginalReturnPolicyName();
                ...
                if(wasPost(request)) {
                    ...
                    edit.setReturnPolicyName(actionForm.getReturnPolicyName());
                    ...
                    if(result != null) {
                        ...
                        if(edit != null) {
                            ...
                            actionForm.setOriginalReturnPolicyName(edit.getReturnPolicyName());
                            actionForm.setReturnPolicyName(edit.getReturnPolicyName());
