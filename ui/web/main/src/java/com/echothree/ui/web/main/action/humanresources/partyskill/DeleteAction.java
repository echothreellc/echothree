...
import com.echothree.control.user.employee.remote.form.DeletePartySkillForm;
...
@SproutAction(
    path = "/HumanResources/PartySkill/Delete",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/HumanResources/PartySkill/Main", redirect = true)
    }
)
public class DeleteAction
    ...
    throws Exception {
        ...
        String skillTypeName = request.getParameter(ParameterConstants.SKILL_TYPE_NAME);
            ...
            EmployeeUtil.getHome().deletePartySkill(getUserVisitPK(request), commandForm);
