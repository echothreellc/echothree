...
import com.echothree.control.user.printer.common.form.DeletePrinterGroupUseTypeForm;
...
@SproutAction(
    path = "/Configuration/PrinterGroupUseType/Delete",
    mappingClass = SecureActionMapping.class,
    name = "PrinterGroupUseTypeDelete",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Configuration/PrinterGroupUseType/Main", redirect = true),
        @SproutForward(name = "Form", path = "/configuration/printergroupusetype/delete.jsp")
    }
)
public class DeleteAction
    ...
    public String getEntityTypeName() {
        return EntityTypes.PrinterGroupUseType.name();
    }
    ...
    public CommandResult doDelete(DeleteActionForm actionForm, HttpServletRequest request)
        ...
        return PrinterUtil.getHome().deletePrinterGroupUseType(getUserVisitPK(request), commandForm);
    }
