...
@SproutAction(
    path = "/Customer/CustomerContactMechanism/ContactTelephoneEdit",
    mappingClass = SecureActionMapping.class,
    name = "CustomerContactTelephoneEdit",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Customer/CustomerContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/customer/customercontactmechanism/contactTelephoneEdit.jsp")
    }
)
public class ContactTelephoneEditAction
        extends BaseCustomerContactMechanismAction<ContactTelephoneEditActionForm> {
