...
import com.echothree.control.user.accounting.remote.form.GetGlResourceTypeDescriptionsForm;
import com.echothree.control.user.accounting.remote.result.GetGlResourceTypeDescriptionsResult;
...
@SproutAction(
    path = "/Accounting/GlResourceType/Description",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/accounting/glresourcetype/description.jsp")
    }
)
public class DescriptionAction
    ...
    throws Exception {
        ...
        try {
            ...
            request.setAttribute(AttributeConstants.GL_RESOURCE_TYPE_DESCRIPTIONS, result.getGlResourceTypeDescriptions());
