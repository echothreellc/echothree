...
import com.echothree.control.user.payment.remote.form.DeletePaymentMethodDescriptionForm;
...
@SproutAction(
    path = "/Payment/PaymentMethod/DescriptionDelete",
    mappingClass = SecureActionMapping.class,
    name = "PaymentMethodDescriptionDelete",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Payment/PaymentMethod/Description", redirect = true),
        @SproutForward(name = "Form", path = "/payment/paymentmethod/descriptionDelete.jsp")
    }
)
public class DescriptionDeleteAction
    ...
    public String getEntityTypeName() {
        return EntityTypes.PaymentMethodDescription.name();
    }
    ...
    public CommandResult doDelete(DescriptionDeleteActionForm actionForm, HttpServletRequest request)
        ...
        return PaymentUtil.getHome().deletePaymentMethodDescription(getUserVisitPK(request), commandForm);
    }
