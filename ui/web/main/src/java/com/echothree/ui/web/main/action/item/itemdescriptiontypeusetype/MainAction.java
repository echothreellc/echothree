...
import com.echothree.control.user.item.common.result.GetItemDescriptionTypeUseTypesResult;
...
@SproutAction(
    path = "/Item/ItemDescriptionTypeUseType/Main",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/item/itemdescriptiontypeusetype/main.jsp")
    }
)
