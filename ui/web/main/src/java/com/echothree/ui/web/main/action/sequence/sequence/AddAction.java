...
@SproutAction(
    ...
    forwards = {
        ...
        @SproutForward(name = "Form", path = "/sequence/sequence/add.jsp")
    }
)
public class AddAction
    ...
    public ActionForward executeAction(ActionMapping mapping, AddActionForm actionForm, HttpServletRequest request, HttpServletResponse response)
        ...
        if(wasPost(request)) {
            ...
            commandForm.setSequenceName(actionForm.getSequenceName());
            commandForm.setMask(actionForm.getMask());
