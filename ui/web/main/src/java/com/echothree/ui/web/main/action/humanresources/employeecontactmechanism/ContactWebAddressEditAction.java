...
@SproutAction(
    path = "/HumanResources/EmployeeContactMechanism/ContactWebAddressEdit",
    mappingClass = SecureActionMapping.class,
    name = "EmployeeContactWebAddressEdit",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/HumanResources/EmployeeContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/humanresources/employeecontactmechanism/contactWebAddressEdit.jsp")
    }
)
public class ContactWebAddressEditAction
        extends BaseEmployeeContactMechanismAction<ContactWebAddressEditActionForm> {
