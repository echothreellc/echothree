...
import com.echothree.control.user.item.remote.form.CreateItemHarmonizedTariffScheduleCodeForm;
...
@SproutAction(
    path = "/Item/ItemHarmonizedTariffScheduleCode/Add",
    mappingClass = SecureActionMapping.class,
    name = "ItemHarmonizedTariffScheduleCodeAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Item/ItemHarmonizedTariffScheduleCode/Main", redirect = true),
        @SproutForward(name = "Form", path = "/item/itemharmonizedtariffschedulecode/add.jsp")
    }
)
