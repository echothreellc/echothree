...
import com.echothree.control.user.filter.remote.edit.FilterAdjustmentDescriptionEdit;
import com.echothree.control.user.filter.remote.form.EditFilterAdjustmentDescriptionForm;
import com.echothree.control.user.filter.remote.result.EditFilterAdjustmentDescriptionResult;
import com.echothree.control.user.filter.remote.spec.FilterAdjustmentDescriptionSpec;
...
@SproutAction(
    path = "/Filter/FilterAdjustment/DescriptionEdit",
    mappingClass = SecureActionMapping.class,
    name = "FilterAdjustmentDescriptionEdit",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Filter/FilterAdjustment/Description", redirect = true),
        @SproutForward(name = "Form", path = "/filter/filteradjustment/descriptionEdit.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                EditFilterAdjustmentDescriptionForm commandForm = FilterUtil.getHome().getEditFilterAdjustmentDescriptionForm();
                FilterAdjustmentDescriptionSpec spec = FilterUtil.getHome().getFilterAdjustmentDescriptionSpec();
                ...
                if(wasPost(request)) {
                    FilterAdjustmentDescriptionEdit edit = FilterUtil.getHome().getFilterAdjustmentDescriptionEdit();
                    
                    commandForm.setEditMode(EditMode.UPDATE);
                    commandForm.setEdit(edit);
                    edit.setDescription(actionForm.getDescription());
                    
                    CommandResult commandResult = FilterUtil.getHome().editFilterAdjustmentDescription(getUserVisitPK(request), commandForm);
                    
                    if(commandResult.hasErrors()) {
                        ExecutionResult executionResult = commandResult.getExecutionResult();
                        
                        if(executionResult != null) {
                            EditFilterAdjustmentDescriptionResult result = (EditFilterAdjustmentDescriptionResult)executionResult.getResult();
                    ...
                    if(result != null) {
                        FilterAdjustmentDescriptionEdit edit = result.getEdit();
