...
@SproutAction(
    path = "/Accounting/CompanyContactMechanism/PartyContactMechanismRelationshipAdd",
    mappingClass = SecureActionMapping.class,
    name = "CompanyPartyContactMechanismRelationshipAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Accounting/CompanyContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/accounting/companycontactmechanism/partyContactMechanismRelationshipAdd.jsp")
    }
)
public class PartyContactMechanismRelationshipAddAction
        extends BaseCompanyContactMechanismAction<PartyContactMechanismRelationshipAddActionForm> {
