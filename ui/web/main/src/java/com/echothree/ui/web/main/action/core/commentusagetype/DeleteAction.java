...
import com.echothree.control.user.comment.remote.form.DeleteCommentUsageTypeForm;
...
@SproutAction(
    path = "/Core/CommentUsageType/Delete",
...
public class DeleteAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            DeleteCommentUsageTypeForm commandForm = CommentUtil.getHome().getDeleteCommentUsageTypeForm();
            ...
            CommentUtil.getHome().deleteCommentUsageType(getUserVisitPK(request), commandForm);
