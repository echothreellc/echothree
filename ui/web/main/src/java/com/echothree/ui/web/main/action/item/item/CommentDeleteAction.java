...
@SproutAction(
    path = "/Item/Item/CommentDelete",
    mappingClass = SecureActionMapping.class,
    name = "ItemCommentDelete",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Item/Item/Review", redirect = true),
        @SproutForward(name = "Form", path = "/item/item/commentDelete.jsp")
    }
)
public class CommentDeleteAction
    ...
    public void setupItemTransfer(CommentDeleteActionForm actionForm, HttpServletRequest request)
