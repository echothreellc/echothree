...
import com.echothree.control.user.vendor.common.form.DeleteItemPurchasingCategoryDescriptionForm;
...
@SproutAction(
    path = "/Purchasing/ItemPurchasingCategory/DescriptionDelete",
...
public class DescriptionDeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            DeleteItemPurchasingCategoryDescriptionForm commandForm = VendorUtil.getHome().getDeleteItemPurchasingCategoryDescriptionForm();
            
            commandForm.setItemPurchasingCategoryName(itemPurchasingCategoryName);
            commandForm.setLanguageIsoName(languageIsoName);
            
            VendorUtil.getHome().deleteItemPurchasingCategoryDescription(getUserVisitPK(request), commandForm);
