...
package com.echothree.ui.web.main.action.core.entityentityattribute;

import com.echothree.control.user.core.common.CoreUtil;
import com.echothree.control.user.core.remote.form.CreateEntityEntityAttributeForm;
...
@SproutAction(
    path = "/Core/EntityEntityAttribute/Add",
    mappingClass = SecureActionMapping.class,
    name = "EntityEntityAttributeAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Form", path = "/core/entityentityattribute/add.jsp")
    }
)
public class AddAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(wasPost(request)) {
                CreateEntityEntityAttributeForm commandForm = CoreUtil.getHome().getCreateEntityEntityAttributeForm();
                ...
                CommandResult commandResult = CoreUtil.getHome().createEntityEntityAttribute(getUserVisitPK(request), commandForm);
