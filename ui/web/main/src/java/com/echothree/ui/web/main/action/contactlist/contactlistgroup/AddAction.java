...
@SproutAction(
    path = "/ContactList/ContactListGroup/Add",
    mappingClass = SecureActionMapping.class,
    name = "ContactListGroupAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/ContactList/ContactListGroup/Main", redirect = true),
        @SproutForward(name = "Form", path = "/contactlist/contactlistgroup/add.jsp")
    }
)
public class AddAction
    ...
    public CommandResult doAdd(AddActionForm actionForm, HttpServletRequest request)
        ...
        return ContactListUtil.getHome().createContactListGroup(getUserVisitPK(request), commandForm);
    }
