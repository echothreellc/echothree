...
import com.echothree.control.user.search.remote.form.GetSearchTypesForm;
import com.echothree.control.user.search.remote.result.GetSearchTypesResult;
...
@SproutAction(
    path = "/Configuration/SearchType/Main",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/configuration/searchtype/main.jsp")
    }
)
