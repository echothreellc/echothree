...
@SproutAction(
    path = "/Configuration/PrinterGroupUseType/Add",
    mappingClass = SecureActionMapping.class,
    name = "PrinterGroupUseTypeAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Configuration/PrinterGroupUseType/Main", redirect = true),
        @SproutForward(name = "Form", path = "/configuration/printergroupusetype/add.jsp")
    }
)
public class AddAction
    ...
    public CommandResult doAdd(AddActionForm actionForm, HttpServletRequest request)
            throws NamingException {
        CreatePrinterGroupUseTypeForm commandForm = PrinterUtil.getHome().getCreatePrinterGroupUseTypeForm();
        ...
        return PrinterUtil.getHome().createPrinterGroupUseType(getUserVisitPK(request), commandForm);
    }
