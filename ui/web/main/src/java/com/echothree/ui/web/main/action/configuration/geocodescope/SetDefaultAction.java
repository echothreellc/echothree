...
import com.echothree.control.user.geo.remote.form.SetDefaultGeoCodeScopeForm;
...
@SproutAction(
    path = "/Configuration/GeoCodeScope/SetDefault",
...
public class SetDefaultAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        GeoUtil.getHome().setDefaultGeoCodeScope(getUserVisitPK(request), commandForm);
