...
import com.echothree.control.user.contact.remote.edit.ContactTelephoneEdit;
import com.echothree.control.user.contact.remote.form.EditContactTelephoneForm;
import com.echothree.control.user.contact.remote.result.EditContactTelephoneResult;
...
@SproutAction(
    path = "/Accounting/DepartmentContactMechanism/ContactTelephoneEdit",
    mappingClass = SecureActionMapping.class,
    name = "DepartmentContactTelephoneEdit",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Accounting/DepartmentContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/accounting/departmentcontactmechanism/contactTelephoneEdit.jsp")
    }
)
public class ContactTelephoneEditAction
        extends BaseDepartmentContactMechanismAction<ContactTelephoneEditActionForm> {
