...
import com.echothree.control.user.carrier.remote.form.DeleteCarrierOptionDescriptionForm;
...
@SproutAction(
    path = "/Shipping/CarrierOption/DescriptionDelete",
...
public class DescriptionDeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            CarrierUtil.getHome().deleteCarrierOptionDescription(getUserVisitPK(request), commandForm);
