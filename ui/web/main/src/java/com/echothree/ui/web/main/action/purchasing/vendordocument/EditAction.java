...
@SproutAction(
    path = "/Purchasing/VendorDocument/Edit",
    mappingClass = SecureActionMapping.class,
    name = "VendorDocumentEdit",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Purchasing/VendorDocument/Main", redirect = true),
        @SproutForward(name = "Form", path = "/purchasing/vendordocument/edit.jsp")
    }
)
public class EditAction
    ...
    private PartyDocumentTransfer getPartyDocumentTransfer(EditActionForm actionForm, HttpServletRequest request)
            throws NamingException {
        return BaseVendorDocumentAction.setupPartyDocumentTransfer(request, actionForm.getDocumentName(), null);
    }

    private PartyDocumentTransfer getPartyDocumentTransfer(DocumentSpec spec, HttpServletRequest request)
            throws NamingException {
        return BaseVendorDocumentAction.setupPartyDocumentTransfer(request, spec.getDocumentName(), null);
    }
