...
import com.echothree.control.user.item.remote.form.CreateItemDescriptionTypeUseForm;
...
@SproutAction(
    path = "/Item/ItemDescriptionTypeUse/Add",
    mappingClass = SecureActionMapping.class,
    name = "ItemDescriptionTypeUseAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Item/ItemDescriptionTypeUse/Main", redirect = true),
        @SproutForward(name = "Form", path = "/item/itemdescriptiontypeuse/add.jsp")
    }
)
public class AddAction
    ...
    public CommandResult doAdd(AddActionForm actionForm, HttpServletRequest request)
            throws NamingException {
        CreateItemDescriptionTypeUseForm commandForm = ItemUtil.getHome().getCreateItemDescriptionTypeUseForm();

        commandForm.setItemDescriptionTypeName(actionForm.getItemDescriptionTypeName());
        commandForm.setItemDescriptionTypeUseTypeName(actionForm.getItemDescriptionTypeUseTypeChoice());

        return ItemUtil.getHome().createItemDescriptionTypeUse(getUserVisitPK(request), commandForm);
    }
