...
import com.echothree.control.user.user.remote.form.DeleteRecoveryQuestionDescriptionForm;
...
@SproutAction(
    path = "/Configuration/RecoveryQuestion/DescriptionDelete",
...
public class DescriptionDeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            DeleteRecoveryQuestionDescriptionForm commandForm = UserUtil.getHome().getDeleteRecoveryQuestionDescriptionForm();
            
            commandForm.setRecoveryQuestionName(recoveryQuestionName);
            commandForm.setLanguageIsoName(languageIsoName);
            
            UserUtil.getHome().deleteRecoveryQuestionDescription(getUserVisitPK(request), commandForm);
