...
import com.echothree.control.user.core.remote.form.DeleteCommandMessageForm;
...
@SproutAction(
    path = "/Core/CommandMessage/Delete",
    ...
    forwards = {
        ...
        @SproutForward(name = "Form", path = "/core/commandmessage/delete.jsp")
    }
)
public class DeleteAction
    ...
    public String getEntityTypeName() {
        return EntityTypes.CommandMessage.name();
    }
    ...
    public CommandResult doDelete(DeleteActionForm actionForm, HttpServletRequest request)
        ...
        return CoreUtil.getHome().deleteCommandMessage(getUserVisitPK(request), commandForm);
    }
