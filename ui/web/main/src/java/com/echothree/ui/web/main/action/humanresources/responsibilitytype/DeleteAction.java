...
import com.echothree.control.user.employee.remote.form.DeleteResponsibilityTypeForm;
...
@SproutAction(
    path = "/HumanResources/ResponsibilityType/Delete",
...
public class DeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            EmployeeUtil.getHome().deleteResponsibilityType(getUserVisitPK(request), commandForm);
