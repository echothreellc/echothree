...
import com.echothree.control.user.vendor.remote.form.GetVendorTypeForm;
import com.echothree.control.user.vendor.remote.result.GetVendorTypeResult;
...
@SproutAction(
    path = "/Purchasing/VendorType/Review",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/purchasing/vendortype/review.jsp")
    }
)
