...
import com.echothree.control.user.carrier.common.form.DeleteCarrierOptionForm;
...
@SproutAction(
    path = "/Shipping/CarrierOption/Delete",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Shipping/CarrierOption/Main", redirect = true)
    }
)
public class DeleteAction
    ...
    throws Exception {
        ...
        try {
            DeleteCarrierOptionForm commandForm = CarrierUtil.getHome().getDeleteCarrierOptionForm();
            ...
            CarrierUtil.getHome().deleteCarrierOption(getUserVisitPK(request), commandForm);
