...
import com.echothree.control.user.item.remote.form.CreateItemUnitLimitForm;
...
@SproutAction(
    path = "/Item/ItemUnitLimit/Add",
    mappingClass = SecureActionMapping.class,
    name = "ItemUnitLimitAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Item/ItemUnitLimit/Main", redirect = true),
        @SproutForward(name = "Form", path = "/item/itemunitlimit/add.jsp")
    }
)
