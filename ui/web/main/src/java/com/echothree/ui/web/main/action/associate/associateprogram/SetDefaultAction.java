...
import com.echothree.control.user.associate.remote.form.SetDefaultAssociateProgramForm;
...
@SproutAction(
    path = "/Associate/AssociateProgram/SetDefault",
...
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            ...
            AssociateUtil.getHome().setDefaultAssociateProgram(getUserVisitPK(request), commandForm);
