...
@SproutAction(
    path = "/Configuration/WorkflowEntrance/Add",
    mappingClass = SecureActionMapping.class,
    name = "WorkflowEntranceAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Configuration/WorkflowEntrance/Main", redirect = true),
        @SproutForward(name = "Form", path = "/configuration/workflowentrance/add.jsp")
    }
)
public class AddAction
    ...
    public CommandResult doAdd(AddActionForm actionForm, HttpServletRequest request)
            throws NamingException {
        CreateWorkflowEntranceForm commandForm = WorkflowUtil.getHome().getCreateWorkflowEntranceForm();
        ...
        return WorkflowUtil.getHome().createWorkflowEntrance(getUserVisitPK(request), commandForm);
    }
