...
import com.echothree.control.user.core.remote.form.CreateCommandMessageTypeDescriptionForm;
import com.echothree.control.user.core.remote.form.GetCommandMessageTypeForm;
import com.echothree.control.user.core.remote.result.GetCommandMessageTypeResult;
...
@SproutAction(
    path = "/Core/CommandMessageType/DescriptionAdd",
    mappingClass = SecureActionMapping.class,
    name = "CommandMessageTypeDescriptionAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Core/CommandMessageType/Description", redirect = true),
        @SproutForward(name = "Form", path = "/core/commandmessagetype/descriptionAdd.jsp")
    }
)
public class DescriptionAddAction
    ...
    public CommandResult doAdd(DescriptionAddActionForm actionForm, HttpServletRequest request)
        ...
        return CoreUtil.getHome().createCommandMessageTypeDescription(getUserVisitPK(request), commandForm);
    }
