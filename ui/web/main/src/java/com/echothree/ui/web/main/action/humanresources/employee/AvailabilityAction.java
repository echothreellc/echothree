...
@SproutAction(
    path = "/HumanResources/Employee/Availability",
    mappingClass = SecureActionMapping.class,
    name = "HREmployeeAvailability",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/HumanResources/Employee/Result", redirect = true),
        @SproutForward(name = "Form", path = "/humanresources/employee/availability.jsp")
    }
)
public class AvailabilityAction
        extends MainBaseAction<AvailabilityActionForm> {
