...
import com.echothree.control.user.core.remote.form.DeleteEntityClobAttributeForm;
...
@SproutAction(
    path = "/Core/EntityClobAttribute/Delete",
...
public class DeleteAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            DeleteEntityClobAttributeForm commandForm = CoreUtil.getHome().getDeleteEntityClobAttributeForm();
            
            commandForm.setEntityRef(entityRef);
            commandForm.setEntityAttributeName(entityAttributeName);
            commandForm.setLanguageIsoName(languageIsoName);
            
            CoreUtil.getHome().deleteEntityClobAttribute(getUserVisitPK(request), commandForm);
