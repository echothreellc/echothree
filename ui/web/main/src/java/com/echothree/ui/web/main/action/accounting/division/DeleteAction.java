...
@SproutAction(
    path = "/Accounting/Division/Delete",
...
public class DeleteAction
    ...
    throws Exception {
        ...
        try {
            DeleteDivisionForm commandForm = PartyUtil.getHome().getDeleteDivisionForm();
            ...
            PartyUtil.getHome().deleteDivision(getUserVisitPK(request), commandForm);
