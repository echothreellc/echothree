    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    var commandForm = ContentUtil.getHome().getCreateContentCollectionDescriptionForm();
                    ...
                    var commandResult = ContentUtil.getHome().createContentCollectionDescription(getUserVisitPK(request), commandForm);
