...
@SproutAction(
    path = "/Advertising/OfferNameElement/DescriptionDelete",
...
public class DescriptionDeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            DeleteOfferNameElementDescriptionForm commandForm = OfferUtil.getHome().getDeleteOfferNameElementDescriptionForm();
            
            commandForm.setOfferNameElementName(offerNameElementName);
            commandForm.setLanguageIsoName(languageIsoName);
            
            OfferUtil.getHome().deleteOfferNameElementDescription(getUserVisitPK(request), commandForm);
