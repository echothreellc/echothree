...
import com.echothree.control.user.contactlist.remote.form.CreateContactListDescriptionForm;
...
@SproutAction(
    path = "/ContactList/ContactList/DescriptionAdd",
    mappingClass = SecureActionMapping.class,
    name = "ContactListDescriptionAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/ContactList/ContactList/Description", redirect = true),
        @SproutForward(name = "Form", path = "/contactlist/contactlist/descriptionAdd.jsp")
    }
)
public class DescriptionAddAction
    ...
    public CommandResult doAdd(DescriptionAddActionForm actionForm, HttpServletRequest request)
        ...
        return ContactListUtil.getHome().createContactListDescription(getUserVisitPK(request), commandForm);
    }
