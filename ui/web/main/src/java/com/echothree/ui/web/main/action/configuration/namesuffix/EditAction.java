...
import com.echothree.control.user.party.remote.edit.NameSuffixEdit;
import com.echothree.control.user.party.remote.form.EditNameSuffixForm;
import com.echothree.control.user.party.remote.result.EditNameSuffixResult;
import com.echothree.control.user.party.remote.spec.NameSuffixSpec;
...
@SproutAction(
    path = "/Configuration/NameSuffix/Edit",
    ...
    forwards = {
        @SproutForward(name = "Display", path = "/action/Configuration/NameSuffix/Main", redirect = true),
        @SproutForward(name = "Form", path = "/configuration/namesuffix/edit.jsp")
    }
)
