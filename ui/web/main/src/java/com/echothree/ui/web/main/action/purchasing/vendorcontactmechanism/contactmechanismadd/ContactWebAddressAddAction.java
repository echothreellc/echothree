...
@SproutAction(
    path = "/Purchasing/VendorContactMechanism/ContactMechanismAdd/ContactWebAddressAdd",
    mappingClass = SecureActionMapping.class,
    name = "VendorContactWebAddressAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Purchasing/VendorContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/purchasing/vendorcontactmechanism/contactmechanismadd/contactWebAddressAdd.jsp")
    }
)
public class ContactWebAddressAddAction
        extends BaseVendorContactMechanismAction<ContactWebAddressAddActionForm> {
