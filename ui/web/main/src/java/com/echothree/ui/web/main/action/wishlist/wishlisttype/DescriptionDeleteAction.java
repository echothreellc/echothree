...
import com.echothree.control.user.wishlist.remote.form.DeleteWishlistTypeDescriptionForm;
...
@SproutAction(
    path = "/Wishlist/WishlistType/DescriptionDelete",
...
public class DescriptionDeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            WishlistUtil.getHome().deleteWishlistTypeDescription(getUserVisitPK(request), commandForm);
