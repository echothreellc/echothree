...
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            var entityIntegerRangeName = request.getParameter(ParameterConstants.ENTITY_INTEGER_RANGE_NAME);
            var commandForm = CoreUtil.getHome().getSetDefaultEntityIntegerRangeForm();
