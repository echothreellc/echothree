...
@SproutAction(
    path = "/Subscription/SubscriptionType/DescriptionDelete",
...
public class DescriptionDeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            DeleteSubscriptionTypeDescriptionForm commandForm = SubscriptionUtil.getHome().getDeleteSubscriptionTypeDescriptionForm();
            ...
            SubscriptionUtil.getHome().deleteSubscriptionTypeDescription(getUserVisitPK(request), commandForm);
