...
import com.echothree.control.user.filter.remote.form.CreateFilterStepDestinationForm;
...
@SproutAction(
    path = "/Filter/FilterStepDestination/Add",
    mappingClass = SecureActionMapping.class,
    name = "FilterStepDestinationAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Filter/FilterStepDestination/Main", redirect = true),
        @SproutForward(name = "Form", path = "/filter/filterstepdestination/add.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreateFilterStepDestinationForm commandForm = FilterUtil.getHome().getCreateFilterStepDestinationForm();
                    ...
                    commandForm.setFromFilterStepName(filterStepName);
                    commandForm.setToFilterStepName(actionForm.getToFilterStepChoice());
                    
                    CommandResult commandResult = FilterUtil.getHome().createFilterStepDestination(getUserVisitPK(request), commandForm);
