...
@SproutAction(
    path = "/Accounting/DivisionContactMechanism/ContactEmailAddressEdit",
    mappingClass = SecureActionMapping.class,
    name = "DivisionContactEmailAddressEdit",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Accounting/DivisionContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/accounting/divisioncontactmechanism/contactEmailAddressEdit.jsp")
    }
)
public class ContactEmailAddressEditAction
        extends BaseDivisionContactMechanismAction<ContactEmailAddressEditActionForm> {
