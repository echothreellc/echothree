...
import com.echothree.control.user.accounting.remote.form.GetCurrencyForm;
import com.echothree.control.user.accounting.remote.result.GetCurrencyResult;
...
@SproutAction(
    path = "/Accounting/Currency/Review",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/accounting/currency/review.jsp")
    }
)
