...
import com.echothree.control.user.workrequirement.remote.form.DeleteWorkRequirementTypeDescriptionForm;
...
@SproutAction(
    path = "/Configuration/WorkRequirementType/DescriptionDelete",
...
public class DescriptionDeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            DeleteWorkRequirementTypeDescriptionForm commandForm = WorkRequirementUtil.getHome().getDeleteWorkRequirementTypeDescriptionForm();
            ...
            WorkRequirementUtil.getHome().deleteWorkRequirementTypeDescription(getUserVisitPK(request), commandForm);
