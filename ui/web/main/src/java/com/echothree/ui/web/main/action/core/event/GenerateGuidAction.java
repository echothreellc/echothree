...
import com.echothree.control.user.core.remote.form.GenerateGuidForm;
import com.echothree.control.user.core.remote.result.GenerateGuidResult;
...
public class GenerateGuidAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        if(forwardKey != null) {
            ...
            parameters.put(ParameterConstants.GUID, guid);
