...
@SproutAction(
    path = "/Warehouse/WarehouseContactMechanism/PartyContactMechanismRelationshipDelete",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Review", path = "/action/Warehouse/WarehouseContactMechanism/Main", redirect = true)
    }
)
