...
import com.echothree.control.user.core.remote.form.EditEntityLongAttributeForm;
import com.echothree.control.user.core.remote.result.EditEntityLongAttributeResult;
...
@SproutAction(
    path = "/Core/EntityLongAttribute/Edit",
    mappingClass = SecureActionMapping.class,
    name = "EntityLongAttributeEdit",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Form", path = "/core/entitylongattribute/edit.jsp")
    }
)
                ...
                if(wasPost(request)) {
                    ...
                    if(result != null) {
                        ...
                        if(edit != null) {
                            ...
                            actionForm.setLongAttribute(edit.getLongAttribute());
                        }
