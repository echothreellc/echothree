...
@SproutAction(
    path = "/HumanResources/EmployeeDocument/DescriptionAdd",
    mappingClass = SecureActionMapping.class,
    name = "EmployeeDocumentDescriptionAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/HumanResources/EmployeeDocument/Description", redirect = true),
        @SproutForward(name = "Form", path = "/humanresources/employeedocument/descriptionAdd.jsp")
    }
)
