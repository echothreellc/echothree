...
@SproutAction(
    path = "/Item/ItemDescriptionTypeUseType/Review",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/item/itemdescriptiontypeusetype/review.jsp")
    }
)
public class ReviewAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        if(itemDescriptionTypeUseType == null) {
            ...
            request.setAttribute(AttributeConstants.ITEM_DESCRIPTION_TYPE_USE_TYPE, itemDescriptionTypeUseType);
