...
@SproutAction(
    path = "/Filter/FilterAdjustmentAmount/Add",
    mappingClass = SecureActionMapping.class,
    name = "FilterAdjustmentAmountAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Filter/FilterAdjustmentAmount/Main", redirect = true),
        @SproutForward(name = "Form", path = "/filter/filteradjustmentamount/add.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreateFilterAdjustmentAmountForm commandForm = FilterUtil.getHome().getCreateFilterAdjustmentAmountForm();
                    ...
                    commandForm.setAmount(addActionForm.getAmount());
                    
                    CommandResult commandResult = FilterUtil.getHome().createFilterAdjustmentAmount(getUserVisitPK(request), commandForm);
