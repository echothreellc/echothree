...
@SproutForm(name="TerminationTypeEdit")
public class EditActionForm
        extends BaseActionForm {
    
    private String originalTerminationTypeName;
    private String terminationTypeName;
    private Boolean isDefault;
    private String sortOrder;
    private String description;
    
    public String getOriginalTerminationTypeName() {
        return originalTerminationTypeName;
    }
    
    public void setOriginalTerminationTypeName(String originalTerminationTypeName) {
        this.originalTerminationTypeName = originalTerminationTypeName;
    }
