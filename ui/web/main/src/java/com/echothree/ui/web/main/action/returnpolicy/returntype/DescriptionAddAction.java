    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    var commandForm = ReturnPolicyUtil.getHome().getCreateReturnTypeDescriptionForm();
                    ...
                    var commandResult = ReturnPolicyUtil.getHome().createReturnTypeDescription(getUserVisitPK(request), commandForm);
