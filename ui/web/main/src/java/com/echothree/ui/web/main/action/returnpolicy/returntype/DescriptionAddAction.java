...
import com.echothree.control.user.returnpolicy.remote.form.CreateReturnTypeDescriptionForm;
...
@SproutAction(
    path = "/ReturnPolicy/ReturnType/DescriptionAdd",
    mappingClass = SecureActionMapping.class,
    name = "ReturnTypeDescriptionAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/ReturnPolicy/ReturnType/Description", redirect = true),
        @SproutForward(name = "Form", path = "/returnpolicy/returntype/descriptionAdd.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreateReturnTypeDescriptionForm commandForm = ReturnPolicyUtil.getHome().getCreateReturnTypeDescriptionForm();
                    ...
                    CommandResult commandResult = ReturnPolicyUtil.getHome().createReturnTypeDescription(getUserVisitPK(request), commandForm);
