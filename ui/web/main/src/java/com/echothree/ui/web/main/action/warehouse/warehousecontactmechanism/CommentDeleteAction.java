...
@SproutAction(
    path = "/Warehouse/WarehouseContactMechanism/CommentDelete",
    mappingClass = SecureActionMapping.class,
    name = "WarehouseContactMechanismCommentDelete",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Warehouse/WarehouseContactMechanism/Review", redirect = true),
        @SproutForward(name = "Form", path = "/warehouse/warehousecontactmechanism/commentDelete.jsp")
    }
)
