...
import com.echothree.control.user.communication.remote.form.GetCommunicationSourcesForm;
import com.echothree.control.user.communication.remote.result.GetCommunicationSourcesResult;
...
@SproutAction(
    path = "/Configuration/CommunicationSource/Main",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/configuration/communicationsource/main.jsp")
    }
)
