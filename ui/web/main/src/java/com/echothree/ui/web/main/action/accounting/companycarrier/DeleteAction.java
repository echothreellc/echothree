...
@SproutAction(
    path = "/Accounting/CompanyCarrier/Delete",
    mappingClass = SecureActionMapping.class,
    name = "CompanyCarrierDelete",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Accounting/CompanyCarrier/Main", redirect = true),
        @SproutForward(name = "Form", path = "/accounting/companycarrier/delete.jsp")
    }
)
public class DeleteAction
    ...
    public void setupTransfer(DeleteActionForm actionForm, HttpServletRequest request)
        ...
        BaseCompanyCarrierAction.setupPartyCarrierTransfer(request, actionForm.getPartyName(), actionForm.getCarrierName());
