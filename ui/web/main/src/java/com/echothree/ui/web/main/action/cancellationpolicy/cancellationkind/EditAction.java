...
@SproutAction(
    path = "/CancellationPolicy/CancellationKind/Edit",
    mappingClass = SecureActionMapping.class,
    name = "CancellationKindEdit",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/CancellationPolicy/CancellationKind/Main", redirect = true),
        @SproutForward(name = "Form", path = "/cancellationpolicy/cancellationkind/edit.jsp")
    }
)
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    ...
                    edit.setCancellationKindName(actionForm.getCancellationKindName());
                    edit.setCancellationSequenceTypeName(actionForm.getCancellationSequenceTypeChoice());
                    ...
                    if(result != null) {
                        ...
                        if(edit != null) {
                            ...
                            actionForm.setCancellationKindName(edit.getCancellationKindName());
                            actionForm.setCancellationSequenceTypeChoice(edit.getCancellationSequenceTypeName());
