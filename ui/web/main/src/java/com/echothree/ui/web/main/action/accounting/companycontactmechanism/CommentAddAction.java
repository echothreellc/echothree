...
@SproutAction(
    path = "/Accounting/CompanyContactMechanism/CommentAdd",
    mappingClass = SecureActionMapping.class,
    name = "CompanyContactMechanismCommentAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Accounting/CompanyContactMechanism/Review", redirect = true),
        @SproutForward(name = "Form", path = "/accounting/companycontactmechanism/commentAdd.jsp")
    }
)
