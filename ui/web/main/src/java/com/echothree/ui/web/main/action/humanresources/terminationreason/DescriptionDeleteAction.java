...
import com.echothree.control.user.employee.common.form.DeleteTerminationReasonDescriptionForm;
...
@SproutAction(
    path = "/HumanResources/TerminationReason/DescriptionDelete",
...
public class DescriptionDeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            DeleteTerminationReasonDescriptionForm commandForm = EmployeeUtil.getHome().getDeleteTerminationReasonDescriptionForm();
            
            commandForm.setTerminationReasonName(terminationReasonName);
            commandForm.setLanguageIsoName(languageIsoName);
            
            EmployeeUtil.getHome().deleteTerminationReasonDescription(getUserVisitPK(request), commandForm);
