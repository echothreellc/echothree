...
import com.echothree.control.user.contactlist.remote.form.GetContactListTypesForm;
import com.echothree.control.user.contactlist.remote.result.GetContactListTypesResult;
...
@SproutAction(
    path = "/ContactList/ContactListType/Main",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/contactlist/contactlisttype/main.jsp")
    }
)
