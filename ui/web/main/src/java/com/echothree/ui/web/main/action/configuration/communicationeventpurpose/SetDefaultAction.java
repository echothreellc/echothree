...
import com.echothree.control.user.communication.remote.form.SetDefaultCommunicationEventPurposeForm;
...
@SproutAction(
    path = "/Configuration/CommunicationEventPurpose/SetDefault",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Configuration/CommunicationEventPurpose/Main", redirect = true)
    }
)
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            ...
            CommunicationUtil.getHome().setDefaultCommunicationEventPurpose(getUserVisitPK(request), commandForm);
