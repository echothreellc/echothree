...
import com.echothree.control.user.core.remote.result.GetServicesResult;
...
@SproutAction(
    path = "/Configuration/Service/Main",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/configuration/service/main.jsp")
    }
)
