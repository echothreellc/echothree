...
@SproutAction(
    path = "/Purchasing/VendorContactMechanism/Delete",
    mappingClass = SecureActionMapping.class,
    name = "VendorContactMechanismDelete",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Purchasing/VendorContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/purchasing/vendorcontactmechanism/delete.jsp")
    }
)
public class DeleteAction
    ...
    public void setupTransfer(DeleteActionForm actionForm, HttpServletRequest request)
        ...
        BaseVendorContactMechanismAction.setupPartyContactMechanismTransfer(request, actionForm.getPartyName(), actionForm.getContactMechanismName());
