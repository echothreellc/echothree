...
@SproutAction(
    path = "/Configuration/GeoCodeAliasType/Review",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/configuration/geocodealiastype/review.jsp")
    }
)
public class ReviewAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        if(geoCodeAliasType == null) {
            ...
            request.setAttribute(AttributeConstants.GEO_CODE_ALIAS_TYPE, geoCodeAliasType);
