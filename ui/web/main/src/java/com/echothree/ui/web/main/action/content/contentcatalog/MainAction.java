...
@SproutAction(
    path = "/Content/ContentCatalog/Main",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/content/contentcatalog/main.jsp")
    }
)
public class MainAction
    ...
    throws Exception {
        ...
        try {
            ...
            request.setAttribute(AttributeConstants.CONTENT_CATALOGS, result.getContentCatalogs());
