...
import com.echothree.control.user.club.remote.form.CreateClubDescriptionForm;
...
@SproutAction(
    path = "/Club/Club/DescriptionAdd",
    mappingClass = SecureActionMapping.class,
    name = "ClubDescriptionAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Club/Club/Description", redirect = true),
        @SproutForward(name = "Form", path = "/club/club/descriptionAdd.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreateClubDescriptionForm commandForm = ClubUtil.getHome().getCreateClubDescriptionForm();
                    ...
                    CommandResult commandResult = ClubUtil.getHome().createClubDescription(getUserVisitPK(request), commandForm);
