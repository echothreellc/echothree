...
import com.echothree.control.user.vendor.remote.form.GetItemPurchasingCategoryDescriptionsForm;
import com.echothree.control.user.vendor.remote.result.GetItemPurchasingCategoryDescriptionsResult;
...
@SproutAction(
    path = "/Purchasing/ItemPurchasingCategory/Description",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/purchasing/itempurchasingcategory/description.jsp")
    }
)
public class DescriptionAction
    ...
    throws Exception {
        ...
        try {
            ...
            request.setAttribute(AttributeConstants.ITEM_PURCHASING_CATEGORY_DESCRIPTIONS, result.getItemPurchasingCategoryDescriptions());
