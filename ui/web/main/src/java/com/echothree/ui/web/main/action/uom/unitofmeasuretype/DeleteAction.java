...
@SproutAction(
    path = "/UnitOfMeasure/UnitOfMeasureType/Delete",
...
public class DeleteAction
    ...
    throws Exception {
        ...
        try {
            DeleteUnitOfMeasureTypeForm commandForm = UomUtil.getHome().getDeleteUnitOfMeasureTypeForm();
            ...
            UomUtil.getHome().deleteUnitOfMeasureType(getUserVisitPK(request), commandForm);
