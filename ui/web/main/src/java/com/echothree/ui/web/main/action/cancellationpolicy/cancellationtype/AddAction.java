    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    var commandForm = CancellationPolicyUtil.getHome().getCreateCancellationTypeForm();
                    ...
                    var commandResult = CancellationPolicyUtil.getHome().createCancellationType(getUserVisitPK(request), commandForm);
