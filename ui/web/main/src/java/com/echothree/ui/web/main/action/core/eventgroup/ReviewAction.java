...
import com.echothree.control.user.core.remote.form.GetEventGroupForm;
import com.echothree.control.user.core.remote.result.GetEventGroupResult;
...
@SproutAction(
    path = "/Core/EventGroup/Review",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/core/eventgroup/review.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            ...
            if(eventGroup == null) {
                ...
                request.setAttribute(AttributeConstants.EVENT_GROUP, eventGroup);
