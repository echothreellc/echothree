...
import com.echothree.control.user.item.remote.form.GetItemPackCheckRequirementsForm;
import com.echothree.control.user.item.remote.result.GetItemPackCheckRequirementsResult;
...
@SproutAction(
    path = "/Item/ItemPackCheckRequirement/Main",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/item/itempackcheckrequirement/main.jsp")
    }
)
