...
import com.echothree.control.user.filter.remote.edit.FilterEdit;
import com.echothree.control.user.filter.remote.form.EditFilterForm;
import com.echothree.control.user.filter.remote.result.EditFilterResult;
import com.echothree.control.user.filter.remote.spec.FilterSpec;
...
public class EditAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        String originalFilterName = request.getParameter(ParameterConstants.ORIGINAL_FILTER_NAME);
        
        try {
            if(forwardKey == null) {
                EditActionForm actionForm = (EditActionForm)form;
                EditFilterForm commandForm = FilterUtil.getHome().getEditFilterForm();
                FilterSpec spec = FilterUtil.getHome().getFilterSpec();
                ...
                if(wasPost(request)) {
                    FilterEdit edit = FilterUtil.getHome().getFilterEdit();
                    ...
                    CommandResult commandResult = FilterUtil.getHome().editFilter(getUserVisitPK(request), commandForm);
                    
                    if(commandResult.hasErrors()) {
                        ExecutionResult executionResult = commandResult.getExecutionResult();
                        
                        if(executionResult != null) {
                            EditFilterResult result = (EditFilterResult)executionResult.getResult();
                    ...
                    if(result != null) {
                        FilterEdit edit = result.getEdit();
