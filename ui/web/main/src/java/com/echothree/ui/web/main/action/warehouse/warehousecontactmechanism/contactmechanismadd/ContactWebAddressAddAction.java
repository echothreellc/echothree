...
@SproutAction(
    path = "/Warehouse/WarehouseContactMechanism/ContactMechanismAdd/ContactWebAddressAdd",
    mappingClass = SecureActionMapping.class,
    name = "WarehouseContactWebAddressAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Warehouse/WarehouseContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/warehouse/warehousecontactmechanism/contactmechanismadd/contactWebAddressAdd.jsp")
    }
)
public class ContactWebAddressAddAction
        extends BaseWarehouseContactMechanismAction<ContactWebAddressAddActionForm> {
