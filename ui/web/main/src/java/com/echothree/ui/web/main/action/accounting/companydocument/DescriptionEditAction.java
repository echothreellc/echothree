...
@SproutAction(
    path = "/Accounting/CompanyDocument/DescriptionEdit",
    mappingClass = SecureActionMapping.class,
    name = "CompanyDocumentDescriptionEdit",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Accounting/CompanyDocument/Description", redirect = true),
        @SproutForward(name = "Form", path = "/accounting/companydocument/descriptionEdit.jsp")
    }
)
