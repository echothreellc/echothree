...
import com.echothree.control.user.search.remote.form.GetSearchKindDescriptionsForm;
import com.echothree.control.user.search.remote.result.GetSearchKindDescriptionsResult;
...
@SproutAction(
    path = "/Configuration/SearchKind/Description",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/configuration/searchkind/description.jsp")
    }
)
