...
import com.echothree.control.user.selector.remote.form.GetSelectorNodeDescriptionsForm;
import com.echothree.control.user.selector.remote.result.GetSelectorNodeDescriptionsResult;
...
@SproutAction(
    path = "/Selector/SelectorNode/Description",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/selector/selectornode/description.jsp")
    }
)
public class DescriptionAction
    ...
    throws Exception {
        ...
        try {
            ...
            request.setAttribute("selectorNode", result.getSelectorNode());
            request.setAttribute("selectorNodeDescriptions", result.getSelectorNodeDescriptions());
