...
@SproutAction(
    path = "/Configuration/GeoCodeLanguage/Delete",
...
public class DeleteAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            DeleteGeoCodeLanguageForm commandForm = GeoUtil.getHome().getDeleteGeoCodeLanguageForm();
            String languageIsoName = request.getParameter(ParameterConstants.LANGUAGE_ISO_NAME);
            
            commandForm.setGeoCodeName(geoCodeName);
            commandForm.setLanguageIsoName(languageIsoName);
            
            GeoUtil.getHome().deleteGeoCodeLanguage(getUserVisitPK(request), commandForm);
