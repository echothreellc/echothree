...
@SproutAction(
    path = "/Configuration/Scale/DescriptionDelete",
...
public class DescriptionDeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            DeleteScaleDescriptionForm commandForm = ScaleUtil.getHome().getDeleteScaleDescriptionForm();
            
            commandForm.setScaleName(scaleName);
            commandForm.setLanguageIsoName(languageIsoName);
            
            ScaleUtil.getHome().deleteScaleDescription(getUserVisitPK(request), commandForm);
