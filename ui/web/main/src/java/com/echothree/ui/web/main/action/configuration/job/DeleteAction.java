...
import com.echothree.control.user.job.remote.form.DeleteJobForm;
...
@SproutAction(
    path = "/Configuration/Job/Delete",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Configuration/Job/Main", redirect = true)
    }
)
public class DeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            JobUtil.getHome().deleteJob(getUserVisitPK(request), commandForm);
