...
import com.echothree.control.user.printer.remote.form.CreatePrinterGroupForm;
...
@SproutAction(
    path = "/Configuration/PrinterGroup/Add",
    mappingClass = SecureActionMapping.class,
    name = "PrinterGroupAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Configuration/PrinterGroup/Main", redirect = true),
        @SproutForward(name = "Form", path = "/configuration/printergroup/add.jsp")
    }
)
public class AddAction
    ...
    public CommandResult doAdd(AddActionForm actionForm, HttpServletRequest request)
        ...
        commandForm.setKeepPrintedJobsTimeUnitOfMeasureTypeName(actionForm.getKeepPrintedJobsTimeUnitOfMeasureTypeChoice());
        commandForm.setIsDefault(actionForm.getIsDefault().toString());
        commandForm.setSortOrder(actionForm.getSortOrder());
        commandForm.setDescription(actionForm.getDescription());

        return PrinterUtil.getHome().createPrinterGroup(getUserVisitPK(request), commandForm);
    }
