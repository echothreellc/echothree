...
@SproutAction(
    path = "/Shipping/CarrierContactMechanism/ContactMechanismAdd/Step2",
    mappingClass = SecureActionMapping.class,
    name = "CarrierContactMechanismAddStep2",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "POSTAL_ADDRESS", path = "/action/Shipping/CarrierContactMechanism/ContactMechanismAdd/ContactPostalAddressAdd", redirect = true),
        @SproutForward(name = "TELECOM_ADDRESS", path = "/action/Shipping/CarrierContactMechanism/ContactMechanismAdd/ContactTelephoneAdd", redirect = true),
        @SproutForward(name = "Form", path = "/shipping/carriercontactmechanism/contactmechanismadd/step2.jsp")
    }
)
public class Step2Action
        extends BaseCarrierContactMechanismAction<Step2ActionForm> {
