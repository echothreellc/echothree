...
@SproutAction(
    path = "/Item/ItemUnitLimit/Delete",
    mappingClass = SecureActionMapping.class,
    name = "ItemUnitLimitDelete",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Item/ItemUnitLimit/Main", redirect = true),
        @SproutForward(name = "Form", path = "/item/itemunitlimit/delete.jsp")
    }
)
public class DeleteAction
    ...
    public String getEntityTypeName(final DeleteActionForm actionForm) {
        return EntityTypes.ItemUnitLimit.name();
    }
    ...
    public CommandResult doDelete(DeleteActionForm actionForm, HttpServletRequest request)
        ...
        return ItemUtil.getHome().deleteItemUnitLimit(getUserVisitPK(request), commandForm);
    }
