    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                var commandForm = CommentUtil.getHome().getEditCommentUsageTypeForm();
                var spec = CommentUtil.getHome().getCommentUsageTypeSpec();
                var originalCommentUsageTypeName = request.getParameter(ParameterConstants.ORIGINAL_COMMENT_USAGE_TYPE_NAME);
                ...
                if(wasPost(request)) {
                    var edit = CommentUtil.getHome().getCommentUsageTypeEdit();
                    ...
                    var commandResult = CommentUtil.getHome().editCommentUsageType(getUserVisitPK(request), commandForm);
                    
                    if(commandResult.hasErrors()) {
                        var executionResult = commandResult.getExecutionResult();
                        
                        if(executionResult != null) {
                            var result = (EditCommentUsageTypeResult)executionResult.getResult();
