...
@SproutAction(
    path = "/Accounting/CompanyContactMechanism/ContactWebAddressEdit",
    mappingClass = SecureActionMapping.class,
    name = "CompanyContactWebAddressEdit",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Accounting/CompanyContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/accounting/companycontactmechanism/contactWebAddressEdit.jsp")
    }
)
public class ContactWebAddressEditAction
        extends BaseCompanyContactMechanismAction<ContactWebAddressEditActionForm> {
