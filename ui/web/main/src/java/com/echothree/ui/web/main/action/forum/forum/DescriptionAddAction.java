    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    var commandForm = ForumUtil.getHome().getCreateForumDescriptionForm();
                    ...
                    var commandResult = ForumUtil.getHome().createForumDescription(getUserVisitPK(request), commandForm);
