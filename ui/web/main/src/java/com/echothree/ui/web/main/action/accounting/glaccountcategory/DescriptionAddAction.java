...
@SproutAction(
    path = "/Accounting/GlAccountCategory/DescriptionAdd",
    mappingClass = SecureActionMapping.class,
    name = "GlAccountCategoryDescriptionAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Accounting/GlAccountCategory/Description", redirect = true),
        @SproutForward(name = "Form", path = "/accounting/glaccountcategory/descriptionAdd.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreateGlAccountCategoryDescriptionForm commandForm = AccountingUtil.getHome().getCreateGlAccountCategoryDescriptionForm();
                    ...
                    CommandResult commandResult = AccountingUtil.getHome().createGlAccountCategoryDescription(getUserVisitPK(request), commandForm);
