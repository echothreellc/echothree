    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    var commandForm = AccountingUtil.getHome().getCreateGlAccountCategoryDescriptionForm();
                    ...
                    var commandResult = AccountingUtil.getHome().createGlAccountCategoryDescription(getUserVisitPK(request), commandForm);
