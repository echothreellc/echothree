...
import com.echothree.control.user.core.remote.form.CreateEntityTypeForm;
import com.echothree.control.user.core.remote.form.GetComponentVendorForm;
import com.echothree.control.user.core.remote.result.GetComponentVendorResult;
...
public class AddAction
    ...
    public CommandResult doAdd(AddActionForm actionForm, HttpServletRequest request)
            throws NamingException {
        CreateEntityTypeForm commandForm = CoreUtil.getHome().getCreateEntityTypeForm();
