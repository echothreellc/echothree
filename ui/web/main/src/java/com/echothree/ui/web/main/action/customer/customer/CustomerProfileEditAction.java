...
@SproutAction(
    path = "/Customer/Customer/CustomerProfileEdit",
    ...
    forwards = {
        ...
        @SproutForward(name = "Form", path = "/customer/customer/customerProfileEdit.jsp")
    }
)
public class CustomerProfileEditAction
        extends MainBaseAction<CustomerProfileEditActionForm> {
