...
import com.echothree.control.user.scale.remote.form.CreatePartyScaleUseForm;
...
@SproutAction(
    path = "/HumanResources/EmployeeScaleUse/Add",
    ...
    forwards = {
        ...
        @SproutForward(name = "Form", path = "/humanresources/employeescaleuse/add.jsp")
    }
)
