...
@SproutAction(
    path = "/Customer/CustomerContactMechanism/PartyContactMechanismRelationshipDelete",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Review", path = "/action/Customer/CustomerContactMechanism/Main", redirect = true)
    }
)
