...
@SproutForm(name="CommentTypeAdd")
public class AddActionForm
        extends BaseActionForm {
    
    private SequenceChoicesBean commentSequenceChoices;
    ...
    private String commentSequenceChoice;
    ...
    public void setupCommentSequenceChoices() {
        if(commentSequenceChoices == null) {
            try {
                ...
                form.setSequenceTypeName(SequenceConstants.SequenceType_COMMENT);
    ...
    public List<LabelValueBean> getCommentSequenceChoices() {
        ...
        if(commentSequenceChoices != null)
            choices = convertChoices(commentSequenceChoices);
        
        return choices;
    }
    
    public void setCommentSequenceChoice(String commentSequenceChoice) {
