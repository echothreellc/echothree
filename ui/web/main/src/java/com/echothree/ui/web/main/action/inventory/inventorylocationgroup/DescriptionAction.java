...
import com.echothree.control.user.inventory.remote.form.GetInventoryLocationGroupDescriptionsForm;
import com.echothree.control.user.inventory.remote.result.GetInventoryLocationGroupDescriptionsResult;
...
@SproutAction(
    path = "/Inventory/InventoryLocationGroup/Description",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/inventory/inventorylocationgroup/description.jsp")
    }
)
public class DescriptionAction
    ...
    throws Exception {
        ...
        try {
            ...
            request.setAttribute("inventoryLocationGroupDescriptions", result.getInventoryLocationGroupDescriptions());
