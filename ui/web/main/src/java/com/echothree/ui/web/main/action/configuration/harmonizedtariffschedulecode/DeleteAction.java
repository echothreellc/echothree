...
import com.echothree.control.user.item.remote.form.GetHarmonizedTariffScheduleCodeForm;
import com.echothree.control.user.item.remote.result.GetHarmonizedTariffScheduleCodeResult;
...
public class DeleteAction
    ...
    public CommandResult doDelete(DeleteActionForm actionForm, HttpServletRequest request)
            throws NamingException {
        DeleteHarmonizedTariffScheduleCodeForm commandForm = ItemUtil.getHome().getDeleteHarmonizedTariffScheduleCodeForm();
