...
import com.echothree.control.user.item.common.form.GetHarmonizedTariffScheduleCodeUseTypeDescriptionsForm;
import com.echothree.control.user.item.common.result.GetHarmonizedTariffScheduleCodeUseTypeDescriptionsResult;
...
@SproutAction(
    path = "/Item/HarmonizedTariffScheduleCodeUseType/Description",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/item/harmonizedtariffschedulecodeusetype/description.jsp")
    }
)
