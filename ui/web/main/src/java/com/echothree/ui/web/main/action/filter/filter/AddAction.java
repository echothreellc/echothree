...
@SproutAction(
    ...
    forwards = {
        ...
        @SproutForward(name = "Form", path = "/filter/filter/add.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreateFilterForm commandForm = FilterUtil.getHome().getCreateFilterForm();
                    ...
                    commandForm.setInitialFilterAdjustmentName(actionForm.getInitialFilterAdjustmentChoice());
                    commandForm.setFilterItemSelectorName(actionForm.getFilterItemSelectorChoice());
                    commandForm.setIsDefault(actionForm.getIsDefault().toString());
                    commandForm.setSortOrder(actionForm.getSortOrder());
                    commandForm.setDescription(actionForm.getDescription());
                    
                    CommandResult commandResult = FilterUtil.getHome().createFilter(getUserVisitPK(request), commandForm);
