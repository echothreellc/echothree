...
public abstract class BaseEmployeeDocumentAction<A
        extends ActionForm>
    ...
    public static EmployeeTransfer setupEmployee(HttpServletRequest request)
            throws NamingException {
        return setupEmployee(request, request.getParameter(ParameterConstants.PARTY_NAME));
    }
