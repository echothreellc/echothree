...
import com.echothree.control.user.contactlist.remote.form.DeleteContactListForm;
import com.echothree.control.user.contactlist.remote.form.GetContactListForm;
import com.echothree.control.user.contactlist.remote.result.GetContactListResult;
...
@SproutAction(
    path = "/ContactList/ContactList/Delete",
    mappingClass = SecureActionMapping.class,
    name = "ContactListDelete",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/ContactList/ContactList/Main", redirect = true),
        @SproutForward(name = "Form", path = "/contactlist/contactlist/delete.jsp")
    }
)
public class DeleteAction
    ...
    public String getEntityTypeName() {
        return EntityTypes.ContactList.name();
    }
    ...
    public CommandResult doDelete(DeleteActionForm actionForm, HttpServletRequest request)
            throws NamingException {
        DeleteContactListForm commandForm = ContactListUtil.getHome().getDeleteContactListForm();

        commandForm.setContactListName(actionForm.getContactListName());

        return ContactListUtil.getHome().deleteContactList(getUserVisitPK(request), commandForm);
    }
