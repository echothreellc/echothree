...
import com.echothree.control.user.core.remote.form.GetApplicationEditorForm;
import com.echothree.control.user.core.remote.result.GetApplicationEditorResult;
...
@SproutAction(
    path = "/Core/ApplicationEditor/Review",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/core/applicationeditor/review.jsp")
    }
)
public class ReviewAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        if(applicationEditor == null) {
            ...
            request.setAttribute(AttributeConstants.APPLICATION_EDITOR, applicationEditor);
