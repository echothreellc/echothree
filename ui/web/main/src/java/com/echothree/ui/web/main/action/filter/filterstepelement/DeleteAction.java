...
@SproutAction(
    path = "/Filter/FilterStepElement/Delete",
...
public class DeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            DeleteFilterStepElementForm commandForm = FilterUtil.getHome().getDeleteFilterStepElementForm();
            ...
            FilterUtil.getHome().deleteFilterStepElement(getUserVisitPK(request), commandForm);
