...
@SproutAction(
    path = "/Core/EntityAttributeGroup/Add",
    mappingClass = SecureActionMapping.class,
    name = "EntityAttributeGroupAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Core/EntityAttributeGroup/Main", redirect = true),
        @SproutForward(name = "Form", path = "/core/entityattributegroup/add.jsp")
    }
)
public class AddAction
    ...
    public CommandResult doAdd(AddActionForm actionForm, HttpServletRequest request)
        ...
        return CoreUtil.getHome().createEntityAttributeGroup(getUserVisitPK(request), commandForm);
    }
