...
@SproutAction(
    path = "/Forum/ForumGroup/Description",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/forum/forumgroup/description.jsp")
    }
)
public class DescriptionAction
    ...
    throws Exception {
        ...
        try {
            ...
            request.setAttribute(AttributeConstants.FORUM_GROUP_DESCRIPTIONS, result.getForumGroupDescriptions());
