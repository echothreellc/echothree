...
@SproutAction(
    path = "/Configuration/GeoCodeLanguage/SetDefault",
...
public class SetDefaultAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            SetDefaultGeoCodeLanguageForm commandForm = GeoUtil.getHome().getSetDefaultGeoCodeLanguageForm();
            String languageIsoName = request.getParameter(ParameterConstants.LANGUAGE_ISO_NAME);
            
            commandForm.setGeoCodeName(geoCodeName);
            commandForm.setLanguageIsoName(languageIsoName);
            
            GeoUtil.getHome().setDefaultGeoCodeLanguage(getUserVisitPK(request), commandForm);
