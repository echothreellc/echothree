...
@SproutAction(
    path = "/ReturnPolicy/ReturnPolicy/TranslationDelete",
...
public class TranslationDeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            DeleteReturnPolicyTranslationForm commandForm = ReturnPolicyUtil.getHome().getDeleteReturnPolicyTranslationForm();
            
            commandForm.setReturnKindName(returnKindName);
            commandForm.setReturnPolicyName(returnPolicyName);
            commandForm.setLanguageIsoName(languageIsoName);
            
            ReturnPolicyUtil.getHome().deleteReturnPolicyTranslation(getUserVisitPK(request), commandForm);
