...
@SproutAction(
    path = "/HumanResources/PartyResponsibility/Add",
    mappingClass = SecureActionMapping.class,
    name = "PartyResponsibilityAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/HumanResources/PartyResponsibility/Main", redirect = true),
        @SproutForward(name = "Form", path = "/humanresources/partyresponsibility/add.jsp")
    }
)
