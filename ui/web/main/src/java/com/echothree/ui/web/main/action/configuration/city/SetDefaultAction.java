...
@SproutAction(
    path = "/Configuration/City/SetDefault",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Configuration/City/Main", redirect = true)
    }
)
public class SetDefaultAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String cityName = request.getParameter(ParameterConstants.CITY_NAME);
            
            commandForm.setGeoCodeName(cityName);
