...
@SproutAction(
    path = "/HumanResources/EmployeeContactMechanism/ContactPostalAddressStatus",
    mappingClass = SecureActionMapping.class,
    name = "EmployeeContactPostalAddressStatus",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/HumanResources/EmployeeContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/humanresources/employeecontactmechanism/contactPostalAddressStatus.jsp")
    }
)
public class ContactPostalAddressStatusAction
        extends BaseEmployeeContactMechanismAction<ContactPostalAddressStatusActionForm> {
