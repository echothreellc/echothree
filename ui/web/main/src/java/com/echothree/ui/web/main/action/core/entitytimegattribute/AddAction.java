...
@SproutAction(
    path = "/Core/EntityTimeAttribute/Add",
    mappingClass = SecureActionMapping.class,
    name = "EntityTimeAttributeAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Form", path = "/core/entitytimeattribute/add.jsp")
    }
)
public class AddAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(wasPost(request)) {
                CreateEntityTimeAttributeForm commandForm = CoreUtil.getHome().getCreateEntityTimeAttributeForm();
                ...
                commandForm.setTimeAttribute(actionForm.getTimeAttribute());
                
                CommandResult commandResult = CoreUtil.getHome().createEntityTimeAttribute(getUserVisitPK(request), commandForm);
