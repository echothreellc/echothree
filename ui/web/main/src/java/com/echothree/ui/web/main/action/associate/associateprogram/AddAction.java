...
@SproutAction(
    path = "/Associate/AssociateProgram/Add",
    mappingClass = SecureActionMapping.class,
    name = "AssociateProgramAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Associate/AssociateProgram/Main", redirect = true),
        @SproutForward(name = "Form", path = "/associate/associateprogram/add.jsp")
    }
)
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    ...
                    commandForm.setAssociatePartyContactMechanismSequenceName(actionForm.getAssociatePartyContactMechanismSequenceChoice());
                    commandForm.setAssociateReferralSequenceName(actionForm.getAssociateReferralSequenceChoice());
                    commandForm.setItemIndirectSalePercent(actionForm.getItemIndirectSalePercent());
                    commandForm.setItemDirectSalePercent(actionForm.getItemDirectSalePercent());
