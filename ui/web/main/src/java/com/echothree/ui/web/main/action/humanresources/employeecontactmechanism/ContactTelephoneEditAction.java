...
@SproutAction(
    path = "/HumanResources/EmployeeContactMechanism/ContactTelephoneEdit",
    mappingClass = SecureActionMapping.class,
    name = "EmployeeContactTelephoneEdit",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/HumanResources/EmployeeContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/humanresources/employeecontactmechanism/contactTelephoneEdit.jsp")
    }
)
public class ContactTelephoneEditAction
        extends BaseEmployeeContactMechanismAction<ContactTelephoneEditActionForm> {
