...
@SproutAction(
    path = "/Configuration/CommunicationEventPurpose/DescriptionAdd",
    mappingClass = SecureActionMapping.class,
    name = "CommunicationEventPurposeDescriptionAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Configuration/CommunicationEventPurpose/Description", redirect = true),
        @SproutForward(name = "Form", path = "/configuration/communicationeventpurpose/descriptionAdd.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreateCommunicationEventPurposeDescriptionForm commandForm = CommunicationUtil.getHome().getCreateCommunicationEventPurposeDescriptionForm();
                    ...
                    CommandResult commandResult = CommunicationUtil.getHome().createCommunicationEventPurposeDescription(getUserVisitPK(request), commandForm);
        ...
        if(forwardKey.equals(ForwardConstants.FORM)) {
            ...
            parameters.put(ParameterConstants.COMMUNICATION_EVENT_PURPOSE_NAME, communicationEventPurposeName);
