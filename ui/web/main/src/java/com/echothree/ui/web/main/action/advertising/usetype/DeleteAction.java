...
import com.echothree.control.user.offer.remote.form.DeleteUseTypeForm;
...
@SproutAction(
    path = "/Advertising/UseType/Delete",
...
public class DeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            OfferUtil.getHome().deleteUseType(getUserVisitPK(request), commandForm);
