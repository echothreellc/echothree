...
@SproutAction(
    path = "/Configuration/WorkEffortType/Delete",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Configuration/WorkEffortType/Main", redirect = true)
    }
)
public class DeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            WorkEffortUtil.getHome().deleteWorkEffortType(getUserVisitPK(request), commandForm);
