...
import com.echothree.control.user.contact.remote.result.GetPostalAddressFormatsResult;
...
@SproutAction(
    path = "/Configuration/PostalAddressFormat/Main",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/configuration/postaladdressformat/main.jsp")
    }
)
