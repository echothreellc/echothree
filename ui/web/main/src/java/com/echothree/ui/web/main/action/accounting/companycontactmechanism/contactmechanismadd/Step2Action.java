...
@SproutAction(
    path = "/Accounting/CompanyContactMechanism/ContactMechanismAdd/Step2",
    mappingClass = SecureActionMapping.class,
    name = "CompanyContactMechanismAddStep2",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "POSTAL_ADDRESS", path = "/action/Accounting/CompanyContactMechanism/ContactMechanismAdd/ContactPostalAddressAdd", redirect = true),
        @SproutForward(name = "TELECOM_ADDRESS", path = "/action/Accounting/CompanyContactMechanism/ContactMechanismAdd/ContactTelephoneAdd", redirect = true),
        @SproutForward(name = "Form", path = "/accounting/companycontactmechanism/contactmechanismadd/step2.jsp")
    }
)
public class Step2Action
        extends BaseCompanyContactMechanismAction<Step2ActionForm> {
