...
import com.echothree.control.user.core.remote.form.CreateColorDescriptionForm;
import com.echothree.control.user.core.remote.form.GetColorForm;
import com.echothree.control.user.core.remote.result.GetColorResult;
...
@SproutAction(
    path = "/Core/Color/DescriptionAdd",
    mappingClass = SecureActionMapping.class,
    name = "ColorDescriptionAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Core/Color/Description", redirect = true),
        @SproutForward(name = "Form", path = "/core/color/descriptionAdd.jsp")
    }
)
public class DescriptionAddAction
    ...
    public CommandResult doAdd(DescriptionAddActionForm actionForm, HttpServletRequest request)
        ...
        return CoreUtil.getHome().createColorDescription(getUserVisitPK(request), commandForm);
    }
