...
import com.echothree.control.user.accounting.remote.form.DeleteGlAccountCategoryDescriptionForm;
...
@SproutAction(
    path = "/Accounting/GlAccountCategory/DescriptionDelete",
...
public class DescriptionDeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            DeleteGlAccountCategoryDescriptionForm commandForm = AccountingUtil.getHome().getDeleteGlAccountCategoryDescriptionForm();
            
            commandForm.setGlAccountCategoryName(glAccountCategoryName);
            commandForm.setLanguageIsoName(languageIsoName);
            
            AccountingUtil.getHome().deleteGlAccountCategoryDescription(getUserVisitPK(request), commandForm);
