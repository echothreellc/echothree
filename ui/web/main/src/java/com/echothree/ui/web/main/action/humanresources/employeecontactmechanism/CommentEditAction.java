...
@SproutAction(
    path = "/HumanResources/EmployeeContactMechanism/CommentEdit",
    mappingClass = SecureActionMapping.class,
    name = "EmployeeContactMechanismCommentEdit",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/HumanResources/EmployeeContactMechanism/Review", redirect = true),
        @SproutForward(name = "Form", path = "/humanresources/employeecontactmechanism/commentEdit.jsp")
    }
)
