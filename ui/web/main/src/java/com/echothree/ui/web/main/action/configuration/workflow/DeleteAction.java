...
@SproutAction(
    path = "/Configuration/Workflow/Delete",
    ...
    forwards = {
        @SproutForward(name = "Display", path = "/action/Configuration/Workflow/Main", redirect = true),
        @SproutForward(name = "Form", path = "/configuration/workflow/delete.jsp")
    }
)
public class DeleteAction
    ...
    public String getEntityTypeName() {
        return EntityTypes.Workflow.name();
    }
    ...
    public CommandResult doDelete(DeleteActionForm actionForm, HttpServletRequest request)
        ...
        return WorkflowUtil.getHome().deleteWorkflow(getUserVisitPK(request), commandForm);
    }
