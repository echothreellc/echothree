...
@SproutForm(name="CommunicationEventPurposeEdit")
public class EditActionForm
        extends BaseActionForm {
    
    private String originalCommunicationEventPurposeName;
    private String communicationEventPurposeName;
    private Boolean isDefault;
    private String sortOrder;
    private String description;
    
    public String getOriginalCommunicationEventPurposeName() {
        return originalCommunicationEventPurposeName;
    }
    
    public void setOriginalCommunicationEventPurposeName(String originalCommunicationEventPurposeName) {
        this.originalCommunicationEventPurposeName = originalCommunicationEventPurposeName;
    }
