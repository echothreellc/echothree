...
import com.echothree.control.user.returnpolicy.remote.form.GetReturnPolicyTranslationsForm;
import com.echothree.control.user.returnpolicy.remote.result.GetReturnPolicyTranslationsResult;
...
@SproutAction(
    path = "/ReturnPolicy/ReturnPolicy/Translation",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/returnpolicy/returnpolicy/translation.jsp")
    }
)
