...
@SproutAction(
    path = "/Configuration/PrinterGroupJob/Delete",
...
public class DeleteAction
    ...
    throws Exception {
        ...
        try {
            DeletePrinterGroupJobForm commandForm = PrinterUtil.getHome().getDeletePrinterGroupJobForm();
            ...
            PrinterUtil.getHome().deletePrinterGroupJob(getUserVisitPK(request), commandForm);
