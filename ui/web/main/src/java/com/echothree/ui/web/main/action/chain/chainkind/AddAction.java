...
@SproutAction(
    ...
    forwards = {
        ...
        @SproutForward(name = "Form", path = "/chain/chainkind/add.jsp")
    }
)
public class AddAction
    ...
    public CommandResult doAdd(AddActionForm actionForm, HttpServletRequest request)
        ...
        return ChainUtil.getHome().createChainKind(getUserVisitPK(request), commandForm);
    }
