...
import com.echothree.control.user.party.common.form.DeleteDateTimeFormatDescriptionForm;
...
@SproutAction(
    path = "/Configuration/DateTimeFormat/DescriptionDelete",
...
public class DescriptionDeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            DeleteDateTimeFormatDescriptionForm commandForm = PartyUtil.getHome().getDeleteDateTimeFormatDescriptionForm();
            
            commandForm.setDateTimeFormatName(dateTimeFormatName);
            commandForm.setLanguageIsoName(languageIsoName);
            
            PartyUtil.getHome().deleteDateTimeFormatDescription(getUserVisitPK(request), commandForm);
