...
import com.echothree.control.user.selector.remote.form.GetSelectorTypesForm;
import com.echothree.control.user.selector.remote.result.GetSelectorTypesResult;
...
@SproutAction(
    path = "/Selector/SelectorType/Main",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/selector/selectortype/main.jsp")
    }
)
