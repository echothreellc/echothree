...
@SproutAction(
    path = "/Item/RelatedItemType/Add",
    mappingClass = SecureActionMapping.class,
    name = "RelatedItemTypeAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Item/RelatedItemType/Main", redirect = true),
        @SproutForward(name = "Form", path = "/item/relateditemtype/add.jsp")
    }
)
public class AddAction
    ...
    public CommandResult doAdd(AddActionForm actionForm, HttpServletRequest request)
            throws NamingException {
        CreateRelatedItemTypeForm commandForm = ItemUtil.getHome().getCreateRelatedItemTypeForm();
        ...
        return ItemUtil.getHome().createRelatedItemType(getUserVisitPK(request), commandForm);
    }
