...
@SproutAction(
    path = "/Inventory/InventoryLocationGroup/SetDefault",
...
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            SetDefaultInventoryLocationGroupForm commandForm = InventoryUtil.getHome().getSetDefaultInventoryLocationGroupForm();
            ...
            InventoryUtil.getHome().setDefaultInventoryLocationGroup(getUserVisitPK(request), commandForm);
