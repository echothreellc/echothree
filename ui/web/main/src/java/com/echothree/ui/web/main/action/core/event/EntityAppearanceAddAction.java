...
@SproutAction(
    path = "/Core/Event/EntityAppearanceAdd",
    mappingClass = SecureActionMapping.class,
    name = "EntityAppearanceAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Core/Event/Main", redirect = true),
        @SproutForward(name = "Form", path = "/core/event/entityAppearanceAdd.jsp")
    }
)
public class EntityAppearanceAddAction
        extends MainBaseAction<EntityAppearanceAddActionForm> {
