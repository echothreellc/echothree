...
@SproutAction(
    path = "/Configuration/WorkflowEntranceSecurityRole/Add",
    mappingClass = SecureActionMapping.class,
    name = "WorkflowEntranceSecurityRoleAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Configuration/WorkflowEntranceSecurityRole/Main", redirect = true),
        @SproutForward(name = "Form", path = "/configuration/workflowentrancesecurityrole/add.jsp")
    }
)
public class AddAction
    ...
    public CommandResult doAdd(AddActionForm actionForm, HttpServletRequest request)
            throws NamingException {
        CreateWorkflowEntranceSecurityRoleForm commandForm = WorkflowUtil.getHome().getCreateWorkflowEntranceSecurityRoleForm();
        ...
        return WorkflowUtil.getHome().createWorkflowEntranceSecurityRole(getUserVisitPK(request), commandForm);
    }
