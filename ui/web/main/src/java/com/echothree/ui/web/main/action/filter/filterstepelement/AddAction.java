...
import com.echothree.control.user.filter.remote.form.CreateFilterStepElementForm;
...
@SproutAction(
    path = "/Filter/FilterStepElement/Add",
    mappingClass = SecureActionMapping.class,
    name = "FilterStepElementAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Filter/FilterStepElement/Main", redirect = true),
        @SproutForward(name = "Form", path = "/filter/filterstepelement/add.jsp")
    }
)
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    ...
                    commandForm.setFilterStepElementName(actionForm.getFilterStepElementName());
