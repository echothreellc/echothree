...
import com.echothree.control.user.document.remote.form.GetDocumentDescriptionsForm;
import com.echothree.control.user.document.remote.result.GetDocumentDescriptionsResult;
...
@SproutAction(
    path = "/HumanResources/EmployeeDocument/Description",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/humanresources/employeedocument/description.jsp")
    }
)
public class DescriptionAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        if(!commandResult.hasErrors()) {
            ...
            request.setAttribute(AttributeConstants.DOCUMENT_DESCRIPTIONS, result.getDocumentDescriptions());
            BaseEmployeeDocumentAction.setupEmployee(request);
