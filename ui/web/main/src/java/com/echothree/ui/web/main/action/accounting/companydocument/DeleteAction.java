...
import com.echothree.control.user.document.remote.form.DeletePartyDocumentForm;
...
@SproutAction(
    path = "/Accounting/CompanyDocument/Delete",
    ...
    forwards = {
        ...
        @SproutForward(name = "Form", path = "/accounting/companydocument/delete.jsp")
    }
)
