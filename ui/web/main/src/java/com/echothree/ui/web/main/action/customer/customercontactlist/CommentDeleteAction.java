...
@SproutAction(
    path = "/Customer/CustomerContactList/CommentDelete",
    mappingClass = SecureActionMapping.class,
    name = "CustomerContactListCommentDelete",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Customer/CustomerContactList/Review", redirect = true),
        @SproutForward(name = "Form", path = "/customer/customercontactlist/commentDelete.jsp")
    }
)
