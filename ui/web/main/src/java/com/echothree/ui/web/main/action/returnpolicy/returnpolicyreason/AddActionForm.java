...
import com.echothree.control.user.returnpolicy.remote.form.GetReturnReasonChoicesForm;
import com.echothree.control.user.returnpolicy.remote.result.GetReturnReasonChoicesResult;
    ...
    private void setupReturnReasonChoices() {
        if(returnReasonChoices == null) {
            try {
                ...
                ne.printStackTrace();
                // failed, returnReasonChoices remains null, no default
            }
        }
    }
