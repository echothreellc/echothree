...
@SproutAction(
    path = "/ContactList/ContactList/Review",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/contactlist/contactlist/review.jsp")
    }
)
public class ReviewAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        ContactListTransfer contactList = null;
        ...
        if(contactList == null) {
            ...
            request.setAttribute(AttributeConstants.CONTACT_LIST, contactList);
