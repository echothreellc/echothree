...
@SproutAction(
    path = "/Configuration/PartyTypeAuditPolicy/Add",
    mappingClass = SecureActionMapping.class,
    name = "PartyTypeAuditPolicyAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Configuration/PartyType/Main", redirect = true),
        @SproutForward(name = "Form", path = "/configuration/partytypeauditpolicy/add.jsp")
    }
)
public class AddAction
    ...
    public ActionForward executeAction(ActionMapping mapping, AddActionForm actionForm, HttpServletRequest request, HttpServletResponse response)
        ...
        if(wasPost(request)) {
            ...
            commandForm.setAuditCommands(actionForm.getAuditCommands().toString());
