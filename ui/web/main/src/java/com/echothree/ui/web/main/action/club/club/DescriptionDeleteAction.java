...
import com.echothree.control.user.club.remote.form.DeleteClubDescriptionForm;
...
@SproutAction(
    path = "/Club/Club/DescriptionDelete",
...
public class DescriptionDeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            DeleteClubDescriptionForm commandForm = ClubUtil.getHome().getDeleteClubDescriptionForm();
            
            commandForm.setClubName(clubName);
            commandForm.setLanguageIsoName(languageIsoName);
            
            ClubUtil.getHome().deleteClubDescription(getUserVisitPK(request), commandForm);
