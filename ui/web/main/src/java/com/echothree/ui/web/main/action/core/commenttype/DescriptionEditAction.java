...
import com.echothree.control.user.comment.remote.form.EditCommentTypeDescriptionForm;
import com.echothree.control.user.comment.remote.result.EditCommentTypeDescriptionResult;
...
@SproutAction(
    path = "/Core/CommentType/DescriptionEdit",
    mappingClass = SecureActionMapping.class,
    name = "CommentTypeDescriptionEdit",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Core/CommentType/Description", redirect = true),
        @SproutForward(name = "Form", path = "/core/commenttype/descriptionEdit.jsp")
    }
)
