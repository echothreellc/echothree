...
import com.echothree.control.user.content.remote.edit.ContentSectionDescriptionEdit;
import com.echothree.control.user.content.remote.form.EditContentSectionDescriptionForm;
import com.echothree.control.user.content.remote.result.EditContentSectionDescriptionResult;
import com.echothree.control.user.content.remote.spec.ContentSectionDescriptionSpec;
...
@SproutAction(
    path = "/Content/ContentSection/DescriptionEdit",
    mappingClass = SecureActionMapping.class,
    name = "ContentSectionDescriptionEdit",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Content/ContentSection/Description", redirect = true),
        @SproutForward(name = "Form", path = "/content/contentsection/descriptionEdit.jsp")
    }
)
