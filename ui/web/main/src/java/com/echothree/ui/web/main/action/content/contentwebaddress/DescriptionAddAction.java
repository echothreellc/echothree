...
import com.echothree.control.user.content.remote.form.CreateContentWebAddressDescriptionForm;
...
@SproutAction(
    path = "/Content/ContentWebAddress/DescriptionAdd",
    mappingClass = SecureActionMapping.class,
    name = "ContentWebAddressDescriptionAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Content/ContentWebAddress/Description", redirect = true),
        @SproutForward(name = "Form", path = "/content/contentwebaddress/descriptionAdd.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreateContentWebAddressDescriptionForm commandForm = ContentUtil.getHome().getCreateContentWebAddressDescriptionForm();
                    ...
                    CommandResult commandResult = ContentUtil.getHome().createContentWebAddressDescription(getUserVisitPK(request), commandForm);
