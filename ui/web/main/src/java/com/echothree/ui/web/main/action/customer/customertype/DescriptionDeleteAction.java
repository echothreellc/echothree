...
import com.echothree.control.user.customer.remote.form.DeleteCustomerTypeDescriptionForm;
...
@SproutAction(
    path = "/Customer/CustomerType/DescriptionDelete",
...
public class DescriptionDeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            DeleteCustomerTypeDescriptionForm commandForm = CustomerUtil.getHome().getDeleteCustomerTypeDescriptionForm();
            
            commandForm.setCustomerTypeName(customerTypeName);
            commandForm.setLanguageIsoName(languageIsoName);
            
            CustomerUtil.getHome().deleteCustomerTypeDescription(getUserVisitPK(request), commandForm);
