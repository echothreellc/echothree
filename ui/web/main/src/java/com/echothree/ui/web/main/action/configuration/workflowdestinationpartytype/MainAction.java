...
@SproutAction(
    path = "/Configuration/WorkflowDestinationPartyType/Main",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/configuration/workflowdestinationpartytype/main.jsp")
    }
)
public class MainAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        if(workflowDestination == null) {
            ...
            request.setAttribute(AttributeConstants.WORKFLOW_DESTINATION_PARTY_TYPES, result.getWorkflowDestinationPartyTypes());
