...
import com.echothree.control.user.employee.remote.form.SetDefaultResponsibilityTypeForm;
...
@SproutAction(
    path = "/HumanResources/ResponsibilityType/SetDefault",
...
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            SetDefaultResponsibilityTypeForm commandForm = EmployeeUtil.getHome().getSetDefaultResponsibilityTypeForm();
            ...
            EmployeeUtil.getHome().setDefaultResponsibilityType(getUserVisitPK(request), commandForm);
