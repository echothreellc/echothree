...
import com.echothree.control.user.content.remote.result.GetContentWebAddressesResult;
...
@SproutAction(
    path = "/Content/ContentWebAddress/Main",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/content/contentwebaddress/main.jsp")
    }
)
