...
import com.echothree.control.user.filter.remote.form.DeleteFilterForm;
...
public class DeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            DeleteFilterForm commandForm = FilterUtil.getHome().getDeleteFilterForm();
            ...
            FilterUtil.getHome().deleteFilter(getUserVisitPK(request), commandForm);
