...
@SproutAction(
    path = "/Accounting/DepartmentContactMechanism/ContactMechanismAdd/Step2",
    mappingClass = SecureActionMapping.class,
    name = "DepartmentContactMechanismAddStep2",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "POSTAL_ADDRESS", path = "/action/Accounting/DepartmentContactMechanism/ContactMechanismAdd/ContactPostalAddressAdd", redirect = true),
        @SproutForward(name = "TELECOM_ADDRESS", path = "/action/Accounting/DepartmentContactMechanism/ContactMechanismAdd/ContactTelephoneAdd", redirect = true),
        @SproutForward(name = "Form", path = "/accounting/departmentcontactmechanism/contactmechanismadd/step2.jsp")
    }
)
public class Step2Action
        extends BaseDepartmentContactMechanismAction<Step2ActionForm> {
