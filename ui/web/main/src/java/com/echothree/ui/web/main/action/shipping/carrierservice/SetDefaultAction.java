...
@SproutAction(
    path = "/Shipping/CarrierService/SetDefault",
...
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            SetDefaultCarrierServiceForm commandForm = CarrierUtil.getHome().getSetDefaultCarrierServiceForm();
            ...
            CarrierUtil.getHome().setDefaultCarrierService(getUserVisitPK(request), commandForm);
