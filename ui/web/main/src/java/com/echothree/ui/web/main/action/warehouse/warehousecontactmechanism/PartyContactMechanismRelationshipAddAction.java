...
@SproutAction(
    path = "/Warehouse/WarehouseContactMechanism/PartyContactMechanismRelationshipAdd",
    mappingClass = SecureActionMapping.class,
    name = "WarehousePartyContactMechanismRelationshipAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Warehouse/WarehouseContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/warehouse/warehousecontactmechanism/partyContactMechanismRelationshipAdd.jsp")
    }
)
public class PartyContactMechanismRelationshipAddAction
        extends BaseWarehouseContactMechanismAction<PartyContactMechanismRelationshipAddActionForm> {
