...
import com.echothree.control.user.cancellationpolicy.common.form.DeleteCancellationReasonDescriptionForm;
...
@SproutAction(
    path = "/CancellationPolicy/CancellationReason/DescriptionDelete",
...
public class DescriptionDeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            DeleteCancellationReasonDescriptionForm commandForm = CancellationPolicyUtil.getHome().getDeleteCancellationReasonDescriptionForm();
            ...
            CancellationPolicyUtil.getHome().deleteCancellationReasonDescription(getUserVisitPK(request), commandForm);
