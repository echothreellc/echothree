...
@SproutAction(
    path = "/Core/EntityMultipleListItemAttribute/Add",
    mappingClass = SecureActionMapping.class,
    name = "EntityMultipleListItemAttributeAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Form", path = "/core/entitymultiplelistitemattribute/add.jsp")
    }
)
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(wasPost(request)) {
                ...
                commandForm.setEntityListItemName(actionForm.getEntityListItemChoice());
                
                CommandResult commandResult = CoreUtil.getHome().createEntityMultipleListItemAttribute(getUserVisitPK(request), commandForm);
