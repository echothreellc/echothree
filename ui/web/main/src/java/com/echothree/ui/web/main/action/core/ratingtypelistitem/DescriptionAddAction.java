...
import com.echothree.control.user.rating.remote.form.CreateRatingTypeListItemDescriptionForm;
...
@SproutAction(
    path = "/Core/RatingTypeListItem/DescriptionAdd",
    mappingClass = SecureActionMapping.class,
    name = "CoreRatingTypeListItemDescriptionAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Core/RatingTypeListItem/Description", redirect = true),
        @SproutForward(name = "Form", path = "/core/ratingtypelistitem/descriptionAdd.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreateRatingTypeListItemDescriptionForm commandForm = RatingUtil.getHome().getCreateRatingTypeListItemDescriptionForm();
                    ...
                    CommandResult commandResult = RatingUtil.getHome().createRatingTypeListItemDescription(getUserVisitPK(request), commandForm);
