...
import com.echothree.control.user.rating.remote.form.DeleteRatingTypeListItemForm;
...
@SproutAction(
    path = "/Core/RatingTypeListItem/Delete",
...
public class DeleteAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            DeleteRatingTypeListItemForm commandForm = RatingUtil.getHome().getDeleteRatingTypeListItemForm();
            ...
            RatingUtil.getHome().deleteRatingTypeListItem(getUserVisitPK(request), commandForm);
