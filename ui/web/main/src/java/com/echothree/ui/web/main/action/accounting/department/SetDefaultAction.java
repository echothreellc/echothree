...
import com.echothree.control.user.party.common.form.SetDefaultDepartmentForm;
...
@SproutAction(
    path = "/Accounting/Department/SetDefault",
...
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            SetDefaultDepartmentForm commandForm = PartyUtil.getHome().getSetDefaultDepartmentForm();
            ...
            PartyUtil.getHome().setDefaultDepartment(getUserVisitPK(request), commandForm);
