...
@SproutAction(
    path = "/Purchasing/VendorContactMechanism/ContactPostalAddressEdit",
    mappingClass = SecureActionMapping.class,
    name = "VendorContactPostalAddressEdit",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Purchasing/VendorContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/purchasing/vendorcontactmechanism/contactPostalAddressEdit.jsp")
    }
)
public class ContactPostalAddressEditAction
        extends BaseVendorContactMechanismAction<ContactPostalAddressEditActionForm> {
