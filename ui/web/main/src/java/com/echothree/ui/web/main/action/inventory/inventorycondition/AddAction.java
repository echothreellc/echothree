...
import com.echothree.control.user.inventory.remote.form.CreateInventoryConditionForm;
...
@SproutAction(
    path = "/Inventory/InventoryCondition/Add",
    mappingClass = SecureActionMapping.class,
    name = "InventoryConditionAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Inventory/InventoryCondition/Main", redirect = true),
        @SproutForward(name = "Form", path = "/inventory/inventorycondition/add.jsp")
    }
)
