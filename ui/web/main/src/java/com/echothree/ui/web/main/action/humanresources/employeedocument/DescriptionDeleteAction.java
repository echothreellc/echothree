...
import com.echothree.control.user.document.remote.form.DeleteDocumentDescriptionForm;
import com.echothree.control.user.document.remote.form.GetDocumentDescriptionForm;
import com.echothree.control.user.document.remote.result.GetDocumentDescriptionResult;
...
@SproutAction(
    path = "/HumanResources/EmployeeDocument/DescriptionDelete",
    mappingClass = SecureActionMapping.class,
    name = "EmployeeDocumentDescriptionDelete",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/HumanResources/EmployeeDocument/Description", redirect = true),
        @SproutForward(name = "Form", path = "/humanresources/employeedocument/descriptionDelete.jsp")
    }
)
