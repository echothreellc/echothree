...
@SproutAction(
    path = "/Accounting/DivisionContactMechanism/CommentDelete",
    mappingClass = SecureActionMapping.class,
    name = "DivisionContactMechanismCommentDelete",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Accounting/DivisionContactMechanism/Review", redirect = true),
        @SproutForward(name = "Form", path = "/accounting/divisioncontactmechanism/commentDelete.jsp")
    }
)
public class CommentDeleteAction
    ...
    public void setupTransfer(CommentDeleteActionForm actionForm, HttpServletRequest request)
            throws NamingException {
        BaseDivisionContactMechanismAction.setupContactMechanismTransfer(request, actionForm.getContactMechanismName());
        setupCommentTransfer(actionForm, request);
        BaseDivisionContactMechanismAction.setupDivision(request, actionForm.getPartyName());
    }
