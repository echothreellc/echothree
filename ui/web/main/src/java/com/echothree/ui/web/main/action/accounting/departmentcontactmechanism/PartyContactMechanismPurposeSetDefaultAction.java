...
@SproutAction(
    path = "/Accounting/DepartmentContactMechanism/PartyContactMechanismPurposeSetDefault",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Review", path = "/action/Accounting/DepartmentContactMechanism/Main", redirect = true)
    }
)
