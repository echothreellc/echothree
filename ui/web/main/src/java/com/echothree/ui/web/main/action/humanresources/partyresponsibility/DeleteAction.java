...
@SproutAction(
    path = "/HumanResources/PartyResponsibility/Delete",
...
public class DeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            DeletePartyResponsibilityForm commandForm = EmployeeUtil.getHome().getDeletePartyResponsibilityForm();
            
            commandForm.setPartyName(partyName);
            commandForm.setResponsibilityTypeName(responsibilityTypeName);
            
            EmployeeUtil.getHome().deletePartyResponsibility(getUserVisitPK(request), commandForm);
