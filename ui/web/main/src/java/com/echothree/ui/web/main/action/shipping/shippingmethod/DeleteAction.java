...
import com.echothree.control.user.shipping.common.form.DeleteShippingMethodForm;
...
@SproutAction(
    path = "/Shipping/ShippingMethod/Delete",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Shipping/ShippingMethod/Main", redirect = true)
    }
)
public class DeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            ShippingUtil.getHome().deleteShippingMethod(getUserVisitPK(request), commandForm);
