...
import com.echothree.control.user.party.remote.form.CreateDateTimeFormatDescriptionForm;
...
@SproutAction(
    path = "/Configuration/DateTimeFormat/DescriptionAdd",
    mappingClass = SecureActionMapping.class,
    name = "DateTimeFormatDescriptionAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Configuration/DateTimeFormat/Description", redirect = true),
        @SproutForward(name = "Form", path = "/configuration/datetimeformat/descriptionAdd.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreateDateTimeFormatDescriptionForm commandForm = PartyUtil.getHome().getCreateDateTimeFormatDescriptionForm();
                    ...
                    CommandResult commandResult = PartyUtil.getHome().createDateTimeFormatDescription(getUserVisitPK(request), commandForm);
