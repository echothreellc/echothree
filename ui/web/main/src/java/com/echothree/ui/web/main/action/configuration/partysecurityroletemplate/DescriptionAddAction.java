...
@SproutAction(
    path = "/Configuration/PartySecurityRoleTemplate/DescriptionAdd",
    mappingClass = SecureActionMapping.class,
    name = "PartySecurityRoleTemplateDescriptionAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Configuration/PartySecurityRoleTemplate/Description", redirect = true),
        @SproutForward(name = "Form", path = "/configuration/partysecurityroletemplate/descriptionAdd.jsp")
    }
)
