...
import com.echothree.control.user.printer.remote.form.EditPrinterForm;
import com.echothree.control.user.printer.remote.result.EditPrinterResult;
...
@SproutAction(
    path = "/Configuration/Printer/Edit",
    ...
    forwards = {
        ...
        @SproutForward(name = "Form", path = "/configuration/printer/edit.jsp")
    }
)
        ...
        try {
            if(forwardKey == null) {
                ...
                if(originalPrinterName == null)
                    originalPrinterName = actionForm.getOriginalPrinterName();
                ...
                if(wasPost(request)) {
                    ...
                    edit.setPrinterName(actionForm.getPrinterName());
                    ...
                    if(result != null) {
                        ...
                        if(edit != null) {
                            ...
                            actionForm.setPrinterName(edit.getPrinterName());
