...
package com.echothree.ui.web.main.action.core.entitylongattribute;
...
@SproutAction(
    path = "/Core/EntityLongAttribute/Add",
    mappingClass = SecureActionMapping.class,
    name = "EntityLongAttributeAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Form", path = "/core/entitylongattribute/add.jsp")
    }
)
public class AddAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(wasPost(request)) {
                CreateEntityLongAttributeForm commandForm = CoreUtil.getHome().getCreateEntityLongAttributeForm();
                ...
                commandForm.setLongAttribute(actionForm.getLongAttribute());
                
                CommandResult commandResult = CoreUtil.getHome().createEntityLongAttribute(getUserVisitPK(request), commandForm);
