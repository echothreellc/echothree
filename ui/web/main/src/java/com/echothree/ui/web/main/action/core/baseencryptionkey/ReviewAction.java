...
@SproutAction(
    path = "/Core/BaseEncryptionKey/Review",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/core/baseencryptionkey/review.jsp")
    }
)
public class ReviewAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        if(baseEncryptionKey == null) {
            ...
            request.setAttribute(AttributeConstants.BASE_ENCRYPTION_KEY, result.getBaseEncryptionKey());
