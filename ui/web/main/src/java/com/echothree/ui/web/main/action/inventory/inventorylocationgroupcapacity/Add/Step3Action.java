...
@SproutAction(
    path = "/Inventory/InventoryLocationGroupCapacity/Add/Step3",
    mappingClass = SecureActionMapping.class,
    name = "InventoryLocationGroupCapacityAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Inventory/InventoryLocationGroupCapacity/Main", redirect = true),
        @SproutForward(name = "Form", path = "/inventory/inventorylocationgroupcapacity/add/step3.jsp")
    }
)
