...
@SproutAction(
    path = "/Forum/Forum/DescriptionDelete",
...
public class DescriptionDeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            DeleteForumDescriptionForm commandForm = ForumUtil.getHome().getDeleteForumDescriptionForm();
            
            commandForm.setForumName(forumName);
            commandForm.setLanguageIsoName(languageIsoName);
            
            ForumUtil.getHome().deleteForumDescription(getUserVisitPK(request), commandForm);
