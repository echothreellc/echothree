...
import com.echothree.control.user.printer.remote.edit.PrinterDescriptionEdit;
import com.echothree.control.user.printer.remote.form.EditPrinterDescriptionForm;
import com.echothree.control.user.printer.remote.result.EditPrinterDescriptionResult;
import com.echothree.control.user.printer.remote.spec.PrinterDescriptionSpec;
...
@SproutAction(
    path = "/Configuration/Printer/DescriptionEdit",
    mappingClass = SecureActionMapping.class,
    name = "PrinterDescriptionEdit",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Configuration/Printer/Description", redirect = true),
        @SproutForward(name = "Form", path = "/configuration/printer/descriptionEdit.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                spec.setPrinterName(printerName);
        ...
        if(forwardKey.equals(ForwardConstants.FORM)) {
            ...
            parameters.put(ParameterConstants.PRINTER_NAME, printerName);
