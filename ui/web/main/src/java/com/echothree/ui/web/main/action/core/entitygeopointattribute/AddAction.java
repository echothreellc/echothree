...
@SproutAction(
    path = "/Core/EntityGeoPointAttribute/Add",
    mappingClass = SecureActionMapping.class,
    name = "EntityGeoPointAttributeAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Form", path = "/core/entitygeopointattribute/add.jsp")
    }
)
public class AddAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(wasPost(request)) {
                CreateEntityGeoPointAttributeForm commandForm = CoreUtil.getHome().getCreateEntityGeoPointAttributeForm();
                ...
                commandForm.setLatitude(actionForm.getLatitude());
                commandForm.setLongitude(actionForm.getLongitude());
                commandForm.setElevation(actionForm.getElevation());
                commandForm.setElevationUnitOfMeasureTypeName(actionForm.getElevationUnitOfMeasureTypeChoice());
                commandForm.setAltitude(actionForm.getAltitude());
                commandForm.setAltitudeUnitOfMeasureTypeName(actionForm.getAltitudeUnitOfMeasureTypeChoice());
                
                CommandResult commandResult = CoreUtil.getHome().createEntityGeoPointAttribute(getUserVisitPK(request), commandForm);
