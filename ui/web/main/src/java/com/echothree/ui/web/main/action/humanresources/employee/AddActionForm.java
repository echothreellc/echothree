...
@SproutForm(name="HumanResourcesEmployeeAdd")
public class AddActionForm
        extends BasePersonWithLoginActionForm {
    
    private EmployeeTypeChoicesBean employeeTypeChoices;
    private PartySecurityRoleTemplateChoicesBean partySecurityRoleTemplateChoices;
    
    private String employeeTypeChoice;
    private String partySecurityRoleTemplateChoice;
        ...
        if(employeeTypeChoices == null) {
            try {
                ...
                if(employeeTypeChoice == null) {
                    employeeTypeChoice = employeeTypeChoices.getDefaultValue();
                }
            } catch (NamingException ne) {
                // failed, employeeTypeChoices remains null, no default
            }
        }
    }
        ...
        if(partySecurityRoleTemplateChoices == null) {
            try {
                ...
                if(partySecurityRoleTemplateChoice == null)
                    partySecurityRoleTemplateChoice = partySecurityRoleTemplateChoices.getDefaultValue();
            } catch (NamingException ne) {
                // failed, partySecurityRoleTemplateChoices remains null, no default
            }
        }
    }
    
    public List<LabelValueBean> getEmployeeTypeChoices() {
        List<LabelValueBean> choices = null;
        
        setupEmployeeTypeChoices();
        if(employeeTypeChoices != null) {
            choices = convertChoices(employeeTypeChoices);
        }
        
        return choices;
    }
    
    public void setEmployeeTypeChoice(String employeeTypeChoice) {
        this.employeeTypeChoice = employeeTypeChoice;
    }
    
    public String getEmployeeTypeChoice() {
        setupEmployeeTypeChoices();
        
        return employeeTypeChoice;
    }
    
    public List<LabelValueBean> getPartySecurityRoleTemplateChoices() {
        List<LabelValueBean> choices = null;
        
        setupPartySecurityRoleTemplateChoices();
        if(partySecurityRoleTemplateChoices != null) {
            choices = convertChoices(partySecurityRoleTemplateChoices);
        }
        
        return choices;
    }
    
    public void setPartySecurityRoleTemplateChoice(String partySecurityRoleTemplateChoice) {
        this.partySecurityRoleTemplateChoice = partySecurityRoleTemplateChoice;
    }
    
    public String getPartySecurityRoleTemplateChoice() {
        setupPartySecurityRoleTemplateChoices();
        
        return partySecurityRoleTemplateChoice;
    }
