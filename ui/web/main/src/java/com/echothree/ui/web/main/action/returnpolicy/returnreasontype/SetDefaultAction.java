...
import com.echothree.control.user.returnpolicy.remote.form.SetDefaultReturnReasonTypeForm;
...
@SproutAction(
    path = "/ReturnPolicy/ReturnReasonType/SetDefault",
...
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            ...
            ReturnPolicyUtil.getHome().setDefaultReturnReasonType(getUserVisitPK(request), commandForm);
