...
import com.echothree.control.user.core.remote.form.GetMimeTypeForm;
import com.echothree.control.user.core.remote.result.GetMimeTypeResult;
...
@SproutAction(
    path = "/Core/MimeType/DescriptionAdd",
    mappingClass = SecureActionMapping.class,
    name = "MimeTypeDescriptionAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Core/MimeType/Description", redirect = true),
        @SproutForward(name = "Form", path = "/core/mimetype/descriptionAdd.jsp")
    }
)
public class DescriptionAddAction
    ...
    public CommandResult doAdd(DescriptionAddActionForm actionForm, HttpServletRequest request)
        ...
        return CoreUtil.getHome().createMimeTypeDescription(getUserVisitPK(request), commandForm);
    }
