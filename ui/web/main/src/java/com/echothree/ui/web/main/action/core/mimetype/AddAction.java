...
import com.echothree.control.user.core.remote.form.CreateMimeTypeForm;
...
@SproutAction(
    ...
    forwards = {
        ...
        @SproutForward(name = "Form", path = "/core/mimetype/add.jsp")
    }
)
public class AddAction
    ...
    public CommandResult doAdd(AddActionForm actionForm, HttpServletRequest request)
        ...
        return CoreUtil.getHome().createMimeType(getUserVisitPK(request), commandForm);
    }
