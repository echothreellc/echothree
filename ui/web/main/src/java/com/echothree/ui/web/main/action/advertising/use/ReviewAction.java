...
import com.echothree.control.user.offer.remote.form.GetUseForm;
import com.echothree.control.user.offer.remote.result.GetUseResult;
import com.echothree.model.control.offer.remote.transfer.UseNameElementTransfer;
...
@SproutAction(
    path = "/Advertising/Use/Review",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/advertising/use/review.jsp")
    }
)
