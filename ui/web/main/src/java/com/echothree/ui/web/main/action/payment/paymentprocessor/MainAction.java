...
import com.echothree.control.user.payment.remote.result.GetPaymentProcessorsResult;
...
@SproutAction(
    path = "/Payment/PaymentProcessor/Main",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/payment/paymentprocessor/main.jsp")
    }
)
