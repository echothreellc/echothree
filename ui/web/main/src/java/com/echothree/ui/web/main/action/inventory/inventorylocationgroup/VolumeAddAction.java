...
public class VolumeAddAction
    ...
    public ActionForward executeAction(ActionMapping mapping, VolumeAddActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        if(wasPost(request)) {
            CreateInventoryLocationGroupVolumeForm commandForm = InventoryUtil.getHome().getCreateInventoryLocationGroupVolumeForm();
            ...
            CommandResult commandResult = InventoryUtil.getHome().createInventoryLocationGroupVolume(getUserVisitPK(request), commandForm);
