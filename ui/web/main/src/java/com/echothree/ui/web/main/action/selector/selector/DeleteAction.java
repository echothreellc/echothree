...
public class DeleteAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            DeleteSelectorForm commandForm = SelectorUtil.getHome().getDeleteSelectorForm();
            ...
            SelectorUtil.getHome().deleteSelector(getUserVisitPK(request), commandForm);
        ...
        if(forwardKey.equals(ForwardConstants.DISPLAY)) {
            customActionForward.setParameters(new HashMap<String, String>(2) {{
