...
@SproutAction(
    path = "/Core/TagScopeEntityType/Main",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/core/tagscopeentitytype/main.jsp")
    }
)
public class MainAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        if(tagScope == null) {
            ...
            request.setAttribute(AttributeConstants.TAG_SCOPE_ENTITY_TYPES, new ListWrapper<>(result.getTagScopeEntityTypes()));
