...
import com.echothree.control.user.job.remote.form.GetJobDescriptionsForm;
import com.echothree.control.user.job.remote.result.GetJobDescriptionsResult;
...
@SproutAction(
    path = "/Configuration/Job/Description",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/configuration/job/description.jsp")
    }
)
public class DescriptionAction
    ...
    throws Exception {
        ...
        try {
            ...
            request.setAttribute(AttributeConstants.JOB_DESCRIPTIONS, result.getJobDescriptions());
