...
import com.echothree.control.user.offer.remote.form.CreateOfferNameElementForm;
...
@SproutAction(
    path = "/Advertising/OfferNameElement/Add",
    mappingClass = SecureActionMapping.class,
    name = "OfferNameElementAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Advertising/OfferNameElement/Main", redirect = true),
        @SproutForward(name = "Form", path = "/advertising/offernameelement/add.jsp")
    }
)
