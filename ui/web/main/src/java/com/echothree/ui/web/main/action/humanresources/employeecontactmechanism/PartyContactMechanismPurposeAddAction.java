...
@SproutAction(
    path = "/HumanResources/EmployeeContactMechanism/PartyContactMechanismPurposeAdd",
    mappingClass = SecureActionMapping.class,
    name = "EmployeePartyContactMechanismPurposeAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/HumanResources/EmployeeContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/humanresources/employeecontactmechanism/partyContactMechanismPurposeAdd.jsp")
    }
)
public class PartyContactMechanismPurposeAddAction
        extends BaseEmployeeContactMechanismAction<PartyContactMechanismPurposeAddActionForm> {
