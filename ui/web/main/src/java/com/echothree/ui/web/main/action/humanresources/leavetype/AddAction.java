...
@SproutAction(
    path = "/HumanResources/LeaveType/Add",
    ...
    forwards = {
        ...
        @SproutForward(name = "Form", path = "/humanresources/leavetype/add.jsp")
    }
)
public class AddAction
    ...
    public CommandResult doAdd(AddActionForm actionForm, HttpServletRequest request)
            throws NamingException {
        CreateLeaveTypeForm commandForm = EmployeeUtil.getHome().getCreateLeaveTypeForm();
        ...
        return EmployeeUtil.getHome().createLeaveType(getUserVisitPK(request), commandForm);
    }
