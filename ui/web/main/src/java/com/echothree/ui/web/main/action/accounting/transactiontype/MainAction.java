...
import com.echothree.control.user.accounting.remote.result.GetTransactionTypesResult;
...
@SproutAction(
    path = "/Accounting/TransactionType/Main",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/accounting/transactiontype/main.jsp")
    }
)
