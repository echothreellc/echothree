...
import com.echothree.control.user.geo.remote.form.GetGeoCodeDescriptionsForm;
import com.echothree.control.user.geo.remote.result.GetGeoCodeDescriptionsResult;
...
@SproutAction(
    path = "/Configuration/GeoCode/Description",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/configuration/geocode/description.jsp")
    }
)
