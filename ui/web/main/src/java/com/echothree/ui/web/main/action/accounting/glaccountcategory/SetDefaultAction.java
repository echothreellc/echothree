...
import com.echothree.control.user.accounting.remote.form.SetDefaultGlAccountCategoryForm;
...
@SproutAction(
    path = "/Accounting/GlAccountCategory/SetDefault",
...
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            ...
            AccountingUtil.getHome().setDefaultGlAccountCategory(getUserVisitPK(request), commandForm);
