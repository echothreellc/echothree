...
@SproutAction(
    path = "/Customer/CustomerDocument/DescriptionAdd",
    mappingClass = SecureActionMapping.class,
    name = "CustomerDocumentDescriptionAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Customer/CustomerDocument/Description", redirect = true),
        @SproutForward(name = "Form", path = "/customer/customerdocument/descriptionAdd.jsp")
    }
)
public class DescriptionAddAction
    ...
    public void setupTransfer(DescriptionAddActionForm actionForm, HttpServletRequest request)
        ...
        BaseCustomerDocumentAction.setupPartyDocumentTransfer(request, actionForm.getDocumentName(), null);
    }
