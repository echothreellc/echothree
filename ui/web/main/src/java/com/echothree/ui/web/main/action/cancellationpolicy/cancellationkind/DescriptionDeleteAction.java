...
@SproutAction(
    path = "/CancellationPolicy/CancellationKind/DescriptionDelete",
...
public class DescriptionDeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            DeleteCancellationKindDescriptionForm commandForm = CancellationPolicyUtil.getHome().getDeleteCancellationKindDescriptionForm();
            
            commandForm.setCancellationKindName(cancellationKindName);
            commandForm.setLanguageIsoName(languageIsoName);
            
            CancellationPolicyUtil.getHome().deleteCancellationKindDescription(getUserVisitPK(request), commandForm);
