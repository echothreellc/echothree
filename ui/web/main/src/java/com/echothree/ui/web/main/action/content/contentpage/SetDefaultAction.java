...
@SproutAction(
    path = "/Content/ContentPage/SetDefault",
...
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            ...
            setDefaultContentPageForm.setContentPageName(contentPageName);
            
            ContentUtil.getHome().setDefaultContentPage(getUserVisitPK(request), setDefaultContentPageForm);
