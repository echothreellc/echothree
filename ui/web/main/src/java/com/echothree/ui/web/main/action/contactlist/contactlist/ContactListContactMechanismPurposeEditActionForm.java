...
@SproutForm(name="ContactListContactMechanismPurposeEdit")
public class ContactListContactMechanismPurposeEditActionForm
        extends ContactListContactMechanismPurposeAddActionForm {
