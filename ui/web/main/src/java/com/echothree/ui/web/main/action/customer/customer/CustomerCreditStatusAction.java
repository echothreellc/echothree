...
@SproutAction(
    path = "/Customer/Customer/CustomerCreditStatus",
    ...
    forwards = {
        ...
        @SproutForward(name = "Form", path = "/customer/customer/customerCreditStatus.jsp")
    }
)
public class CustomerCreditStatusAction
    ...
    throws Exception {
        ...
        try {
            ...
            if(wasPost(request)) {
                ...
                actionForm.setupCustomerCreditStatusChoices();
                forwardKey = ForwardConstants.FORM;
            }
