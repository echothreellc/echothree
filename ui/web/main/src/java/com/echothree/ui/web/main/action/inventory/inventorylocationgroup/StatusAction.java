...
import com.echothree.control.user.inventory.remote.form.SetInventoryLocationGroupStatusForm;
...
@SproutAction(
    path = "/Inventory/InventoryLocationGroup/Status",
    mappingClass = SecureActionMapping.class,
    name = "InventoryLocationGroupStatus",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Inventory/InventoryLocationGroup/Main", redirect = true),
        @SproutForward(name = "Form", path = "/inventory/inventorylocationgroup/status.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            ...
            if(wasPost(request)) {
                ...
                actionForm.setupInventoryLocationGroupStatusChoices();
                forwardKey = ForwardConstants.FORM;
            }
