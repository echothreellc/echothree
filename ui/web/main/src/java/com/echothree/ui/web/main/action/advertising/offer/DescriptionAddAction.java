...
@SproutAction(
    path = "/Advertising/Offer/DescriptionAdd",
    mappingClass = SecureActionMapping.class,
    name = "OfferDescriptionAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Advertising/Offer/Description", redirect = true),
        @SproutForward(name = "Form", path = "/advertising/offer/descriptionAdd.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreateOfferDescriptionForm commandForm = OfferUtil.getHome().getCreateOfferDescriptionForm();
                    ...
                    CommandResult commandResult = OfferUtil.getHome().createOfferDescription(getUserVisitPK(request), commandForm);
