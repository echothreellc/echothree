    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                var commandForm = OfferUtil.getHome().getEditUseTypeDescriptionForm();
                var spec = OfferUtil.getHome().getUseTypeDescriptionSpec();
                ...
                if(wasPost(request)) {
                    var edit = OfferUtil.getHome().getUseTypeDescriptionEdit();
                    
                    commandForm.setEditMode(EditMode.UPDATE);
                    commandForm.setEdit(edit);
                    edit.setDescription(actionForm.getDescription());

                    var commandResult = OfferUtil.getHome().editUseTypeDescription(getUserVisitPK(request), commandForm);
                    
                    if(commandResult.hasErrors()) {
                        var executionResult = commandResult.getExecutionResult();
                        
                        if(executionResult != null) {
                            var result = (EditUseTypeDescriptionResult)executionResult.getResult();
