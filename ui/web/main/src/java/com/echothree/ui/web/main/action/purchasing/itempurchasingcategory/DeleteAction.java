...
import com.echothree.control.user.vendor.remote.form.DeleteItemPurchasingCategoryForm;
...
@SproutAction(
    path = "/Purchasing/ItemPurchasingCategory/Delete",
...
public class DeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            VendorUtil.getHome().deleteItemPurchasingCategory(getUserVisitPK(request), commandForm);
