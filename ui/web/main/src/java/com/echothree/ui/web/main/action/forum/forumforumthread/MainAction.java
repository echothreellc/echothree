...
import com.echothree.control.user.forum.remote.form.GetForumForumThreadsForm;
import com.echothree.control.user.forum.remote.result.GetForumForumThreadsResult;
...
@SproutAction(
    path = "/Forum/ForumForumThread/Main",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/forum/forumforumthread/main.jsp")
    }
)
