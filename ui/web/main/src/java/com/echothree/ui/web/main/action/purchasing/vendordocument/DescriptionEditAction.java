...
@SproutAction(
    path = "/Purchasing/VendorDocument/DescriptionEdit",
    mappingClass = SecureActionMapping.class,
    name = "VendorDocumentDescriptionEdit",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Purchasing/VendorDocument/Description", redirect = true),
        @SproutForward(name = "Form", path = "/purchasing/vendordocument/descriptionEdit.jsp")
    }
)
