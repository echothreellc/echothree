...
@SproutAction(
    path = "/Accounting/GlAccountCategory/Delete",
...
public class DeleteAction
    ...
    throws Exception {
        ...
        try {
            DeleteGlAccountCategoryForm commandForm = AccountingUtil.getHome().getDeleteGlAccountCategoryForm();
            ...
            AccountingUtil.getHome().deleteGlAccountCategory(getUserVisitPK(request), commandForm);
