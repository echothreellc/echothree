...
import com.echothree.control.user.contactlist.remote.form.DeletePartyContactListForm;
...
@SproutAction(
    path = "/Customer/CustomerContactList/Delete",
    mappingClass = SecureActionMapping.class,
    name = "CustomerContactListDelete",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Customer/CustomerContactList/Main", redirect = true),
        @SproutForward(name = "Form", path = "/customer/customercontactlist/delete.jsp")
    }
)
public class DeleteAction
    ...
    public String getEntityTypeName() {
        return EntityTypes.PartyContactList.name();
    }
    ...
    public void setupTransfer(DeleteActionForm actionForm, HttpServletRequest request)
        ...
        CustomerContactListUtil.getInstance().setupPartyContactListTransfer(request, actionForm.getPartyName(), actionForm.getContactListName());
    ...
    public CommandResult doDelete(DeleteActionForm actionForm, HttpServletRequest request)
        ...
        return ContactListUtil.getHome().deletePartyContactList(getUserVisitPK(request), commandForm);
    }
