...
@SproutAction(
    path = "/HumanResources/EmployeeContactMechanism/ContactMechanismAdd/ContactPostalAddressAdd",
    mappingClass = SecureActionMapping.class,
    name = "EmployeeContactPostalAddressAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/HumanResources/EmployeeContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/humanresources/employeecontactmechanism/contactmechanismadd/contactPostalAddressAdd.jsp")
    }
)
public class ContactPostalAddressAddAction
        extends BaseEmployeeContactMechanismAction<ContactPostalAddressAddActionForm> {
