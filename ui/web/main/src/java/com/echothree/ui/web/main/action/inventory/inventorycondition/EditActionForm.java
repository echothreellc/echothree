...
@SproutForm(name="InventoryConditionEdit")
public class EditActionForm
        extends BaseActionForm {
    
    private String originalInventoryConditionName;
    private String inventoryConditionName;
    private Boolean isDefault;
    private String sortOrder;
    private String description;
    
    public String getOriginalInventoryConditionName() {
        return originalInventoryConditionName;
    }
    
    public void setOriginalInventoryConditionName(String originalInventoryConditionName) {
        this.originalInventoryConditionName = originalInventoryConditionName;
    }
