...
@SproutAction(
    path = "/Warehouse/Location/VolumeAdd",
    mappingClass = SecureActionMapping.class,
    name = "LocationVolumeAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Warehouse/Location/Main", redirect = true),
        @SproutForward(name = "Form", path = "/warehouse/location/volumeAdd.jsp")
    }
)
public class VolumeAddAction
    ...
    public ActionForward executeAction(ActionMapping mapping, VolumeAddActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        if(wasPost(request)) {
            ...
            commandForm.setLocationName(form.getLocationName());
