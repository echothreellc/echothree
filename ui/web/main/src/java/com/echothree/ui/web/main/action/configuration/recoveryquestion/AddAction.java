...
import com.echothree.control.user.user.remote.form.CreateRecoveryQuestionForm;
...
@SproutAction(
    path = "/Configuration/RecoveryQuestion/Add",
    mappingClass = SecureActionMapping.class,
    name = "RecoveryQuestionAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Configuration/RecoveryQuestion/Main", redirect = true),
        @SproutForward(name = "Form", path = "/configuration/recoveryquestion/add.jsp")
    }
)
