...
@SproutAction(
    path = "/Purchasing/VendorContactMechanism/ContactMechanismAdd/ContactTelephoneAdd",
    mappingClass = SecureActionMapping.class,
    name = "VendorContactTelephoneAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Purchasing/VendorContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/purchasing/vendorcontactmechanism/contactmechanismadd/contactTelephoneAdd.jsp")
    }
)
public class ContactTelephoneAddAction
        extends BaseVendorContactMechanismAction<ContactTelephoneAddActionForm> {
