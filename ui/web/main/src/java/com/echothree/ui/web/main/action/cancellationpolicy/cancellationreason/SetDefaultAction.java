...
@SproutAction(
    path = "/CancellationPolicy/CancellationReason/SetDefault",
...
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            SetDefaultCancellationReasonForm commandForm = CancellationPolicyUtil.getHome().getSetDefaultCancellationReasonForm();
            ...
            CancellationPolicyUtil.getHome().setDefaultCancellationReason(getUserVisitPK(request), commandForm);
