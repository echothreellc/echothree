...
@SproutAction(
    path = "/CancellationPolicy/CancellationType/DescriptionDelete",
...
public class DescriptionDeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            DeleteCancellationTypeDescriptionForm commandForm = CancellationPolicyUtil.getHome().getDeleteCancellationTypeDescriptionForm();
            ...
            CancellationPolicyUtil.getHome().deleteCancellationTypeDescription(getUserVisitPK(request), commandForm);
