    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    var commandForm = CommentUtil.getHome().getCreateCommentTypeDescriptionForm();
                    ...
                    var commandResult = CommentUtil.getHome().createCommentTypeDescription(getUserVisitPK(request), commandForm);
