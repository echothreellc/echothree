...
@SproutAction(
    path = "/Core/CommentType/DescriptionAdd",
    mappingClass = SecureActionMapping.class,
    name = "CoreCommentTypeDescriptionAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Core/CommentType/Description", redirect = true),
        @SproutForward(name = "Form", path = "/core/commenttype/descriptionAdd.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreateCommentTypeDescriptionForm commandForm = CommentUtil.getHome().getCreateCommentTypeDescriptionForm();
                    ...
                    CommandResult commandResult = CommentUtil.getHome().createCommentTypeDescription(getUserVisitPK(request), commandForm);
