...
import com.echothree.control.user.security.remote.form.DeletePartySecurityRoleTemplateForm;
...
@SproutAction(
    path = "/Configuration/PartySecurityRoleTemplate/Delete",
...
public class DeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            SecurityUtil.getHome().deletePartySecurityRoleTemplate(getUserVisitPK(request), commandForm);
