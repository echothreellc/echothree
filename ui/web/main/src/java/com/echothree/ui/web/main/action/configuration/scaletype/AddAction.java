...
import com.echothree.control.user.scale.remote.form.CreateScaleTypeForm;
...
@SproutAction(
    path = "/Configuration/ScaleType/Add",
    ...
    forwards = {
        ...
        @SproutForward(name = "Form", path = "/configuration/scaletype/add.jsp")
    }
)
public class AddAction
    ...
    public CommandResult doAdd(AddActionForm actionForm, HttpServletRequest request)
        ...
        return ScaleUtil.getHome().createScaleType(getUserVisitPK(request), commandForm);
    }
