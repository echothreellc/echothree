...
@SproutAction(
    path = "/Accounting/TransactionEntityRoleType/Review",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/accounting/transactionentityroletype/review.jsp")
    }
)
public class ReviewAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        if(transactionEntityRoleType == null) {
            ...
            request.setAttribute(AttributeConstants.TRANSACTION_ENTITY_ROLE_TYPE, transactionEntityRoleType);
