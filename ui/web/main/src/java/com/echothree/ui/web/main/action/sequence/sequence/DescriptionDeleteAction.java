...
@SproutAction(
    path = "/Sequence/Sequence/DescriptionDelete",
...
public class DescriptionDeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            DeleteSequenceDescriptionForm commandForm = SequenceUtil.getHome().getDeleteSequenceDescriptionForm();
            
            commandForm.setSequenceTypeName(sequenceTypeName);
            commandForm.setSequenceName(sequenceName);
            commandForm.setLanguageIsoName(languageIsoName);
            
            SequenceUtil.getHome().deleteSequenceDescription(getUserVisitPK(request), commandForm);
