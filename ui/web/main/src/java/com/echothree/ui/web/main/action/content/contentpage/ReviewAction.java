...
@SproutAction(
    path = "/Content/ContentPage/Review",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/content/contentpage/review.jsp")
    }
)
public class ReviewAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        commandForm.setContentPageName(request.getParameter(ParameterConstants.CONTENT_PAGE_NAME));
        ...
        options.add(ContentOptions.ContentPageIncludeEntityAttributeGroups);
        ...
        if(contentPage == null) {
            ...
            request.setAttribute(AttributeConstants.CONTENT_PAGE, contentPage);
