...
import com.echothree.control.user.employee.remote.form.CreateLeaveReasonForm;
...
@SproutAction(
    path = "/HumanResources/LeaveReason/Add",
    ...
    forwards = {
        ...
        @SproutForward(name = "Form", path = "/humanresources/leavereason/add.jsp")
    }
)
public class AddAction
    ...
    public CommandResult doAdd(AddActionForm actionForm, HttpServletRequest request)
        ...
        return EmployeeUtil.getHome().createLeaveReason(getUserVisitPK(request), commandForm);
    }
