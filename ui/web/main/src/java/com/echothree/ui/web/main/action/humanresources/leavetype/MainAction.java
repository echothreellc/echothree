...
import com.echothree.control.user.employee.remote.form.GetLeaveTypesForm;
import com.echothree.control.user.employee.remote.result.GetLeaveTypesResult;
...
@SproutAction(
    path = "/HumanResources/LeaveType/Main",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/humanresources/leavetype/main.jsp")
    }
)
