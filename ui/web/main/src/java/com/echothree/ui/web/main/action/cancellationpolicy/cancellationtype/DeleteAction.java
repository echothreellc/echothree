...
import com.echothree.control.user.cancellationpolicy.common.form.DeleteCancellationTypeForm;
...
@SproutAction(
    path = "/CancellationPolicy/CancellationType/Delete",
...
public class DeleteAction
    ...
    throws Exception {
        ...
        try {
            DeleteCancellationTypeForm commandForm = CancellationPolicyUtil.getHome().getDeleteCancellationTypeForm();
            ...
            CancellationPolicyUtil.getHome().deleteCancellationType(getUserVisitPK(request), commandForm);
