...
import com.echothree.ui.web.main.action.humanresources.employeecontactmechanism.BaseEmployeeContactMechanismAction;
...
@SproutAction(
    path = "/HumanResources/EmployeeContactMechanism/ContactMechanismAdd/ContactEmailAddressAdd",
    mappingClass = SecureActionMapping.class,
    name = "EmployeeContactEmailAddressAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/HumanResources/EmployeeContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/humanresources/employeecontactmechanism/contactmechanismadd/contactEmailAddressAdd.jsp")
    }
)
public class ContactEmailAddressAddAction
        extends BaseEmployeeContactMechanismAction<ContactEmailAddressAddActionForm> {
