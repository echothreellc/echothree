...
import com.echothree.control.user.training.remote.form.SetDefaultTrainingClassForm;
...
@SproutAction(
    path = "/HumanResources/TrainingClass/SetDefault",
...
public class SetDefaultAction
    ...
    throws Exception {
        ...
        TrainingUtil.getHome().setDefaultTrainingClass(getUserVisitPK(request), commandForm);
