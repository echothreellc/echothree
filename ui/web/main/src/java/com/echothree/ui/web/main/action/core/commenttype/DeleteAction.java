...
import com.echothree.control.user.comment.remote.form.DeleteCommentTypeForm;
...
public class DeleteAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            DeleteCommentTypeForm commandForm = CommentUtil.getHome().getDeleteCommentTypeForm();
            
            commandForm.setComponentVendorName(componentVendorName);
            commandForm.setEntityTypeName(entityTypeName);
            commandForm.setCommentTypeName(commentTypeName);
            
            CommentUtil.getHome().deleteCommentType(getUserVisitPK(request), commandForm);
