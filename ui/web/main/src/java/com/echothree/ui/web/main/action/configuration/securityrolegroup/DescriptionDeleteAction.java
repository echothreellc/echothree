...
@SproutAction(
    path = "/Configuration/SecurityRoleGroup/DescriptionDelete",
    mappingClass = SecureActionMapping.class,
    name = "SecurityRoleGroupDescriptionDelete",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Configuration/SecurityRoleGroup/Description", redirect = true),
        @SproutForward(name = "Form", path = "/configuration/securityrolegroup/descriptionDelete.jsp")
    }
)
public class DescriptionDeleteAction
    ...
    public String getEntityTypeName() {
        return EntityTypes.SecurityRoleGroupDescription.name();
    }
    ...
    public CommandResult doDelete(DescriptionDeleteActionForm actionForm, HttpServletRequest request)
        ...
        return SecurityUtil.getHome().deleteSecurityRoleGroupDescription(getUserVisitPK(request), commandForm);
    }
