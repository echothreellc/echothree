...
@SproutAction(
    path = "/Accounting/Department/Delete",
...
public class DeleteAction
    ...
    throws Exception {
        ...
        try {
            DeleteDepartmentForm commandForm = PartyUtil.getHome().getDeleteDepartmentForm();
            ...
            PartyUtil.getHome().deleteDepartment(getUserVisitPK(request), commandForm);
