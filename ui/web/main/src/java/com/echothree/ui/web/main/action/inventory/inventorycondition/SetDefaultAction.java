...
import com.echothree.control.user.inventory.remote.form.SetDefaultInventoryConditionForm;
...
@SproutAction(
    path = "/Inventory/InventoryCondition/SetDefault",
...
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            ...
            InventoryUtil.getHome().setDefaultInventoryCondition(getUserVisitPK(request), commandForm);
