...
@SproutAction(
    path = "/HumanResources/EmployeeType/DescriptionEdit",
    mappingClass = SecureActionMapping.class,
    name = "EmployeeTypeDescriptionEdit",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/HumanResources/EmployeeType/Description", redirect = true),
        @SproutForward(name = "Form", path = "/humanresources/employeetype/descriptionEdit.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                spec.setEmployeeTypeName(employeeTypeName);
        ...
        if(forwardKey.equals(ForwardConstants.FORM)) {
            ...
            parameters.put(ParameterConstants.EMPLOYEE_TYPE_NAME, employeeTypeName);
