    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    var commandForm = RatingUtil.getHome().getCreateRatingTypeListItemForm();
                    ...
                    var commandResult = RatingUtil.getHome().createRatingTypeListItem(getUserVisitPK(request), commandForm);
