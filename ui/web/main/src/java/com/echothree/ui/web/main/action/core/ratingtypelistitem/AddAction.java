...
@SproutAction(
    path = "/Core/RatingTypeListItem/Add",
    mappingClass = SecureActionMapping.class,
    name = "RatingTypeListItemAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Core/RatingTypeListItem/Main", redirect = true),
        @SproutForward(name = "Form", path = "/core/ratingtypelistitem/add.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreateRatingTypeListItemForm commandForm = RatingUtil.getHome().getCreateRatingTypeListItemForm();
                    ...
                    commandForm.setRatingTypeListItemName(actionForm.getRatingTypeListItemName());
                    commandForm.setIsDefault(actionForm.getIsDefault().toString());
                    commandForm.setSortOrder(actionForm.getSortOrder());
                    commandForm.setDescription(actionForm.getDescription());
                    
                    CommandResult commandResult = RatingUtil.getHome().createRatingTypeListItem(getUserVisitPK(request), commandForm);
