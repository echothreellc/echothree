...
import com.echothree.control.user.cancellationpolicy.remote.form.DeleteCancellationReasonForm;
...
@SproutAction(
    path = "/CancellationPolicy/CancellationReason/Delete",
...
public class DeleteAction
    ...
    throws Exception {
        ...
        try {
            DeleteCancellationReasonForm commandForm = CancellationPolicyUtil.getHome().getDeleteCancellationReasonForm();
            ...
            CancellationPolicyUtil.getHome().deleteCancellationReason(getUserVisitPK(request), commandForm);
