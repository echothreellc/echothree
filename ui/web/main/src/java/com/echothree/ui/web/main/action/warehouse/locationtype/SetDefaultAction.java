...
import com.echothree.control.user.warehouse.common.form.SetDefaultLocationTypeForm;
...
@SproutAction(
    path = "/Warehouse/LocationType/SetDefault",
...
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            SetDefaultLocationTypeForm commandForm = WarehouseUtil.getHome().getSetDefaultLocationTypeForm();
            ...
            WarehouseUtil.getHome().setDefaultLocationType(getUserVisitPK(request), commandForm);
