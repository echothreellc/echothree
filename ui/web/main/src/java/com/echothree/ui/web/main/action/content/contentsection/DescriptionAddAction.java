    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    var commandForm = ContentUtil.getHome().getCreateContentSectionDescriptionForm();
                    ...
                    var commandResult = ContentUtil.getHome().createContentSectionDescription(getUserVisitPK(request), commandForm);
