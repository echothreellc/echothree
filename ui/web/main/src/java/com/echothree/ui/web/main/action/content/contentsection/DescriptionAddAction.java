...
@SproutAction(
    path = "/Content/ContentSection/DescriptionAdd",
    mappingClass = SecureActionMapping.class,
    name = "ContentSectionDescriptionAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Content/ContentSection/Description", redirect = true),
        @SproutForward(name = "Form", path = "/content/contentsection/descriptionAdd.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreateContentSectionDescriptionForm commandForm = ContentUtil.getHome().getCreateContentSectionDescriptionForm();
                    ...
                    CommandResult commandResult = ContentUtil.getHome().createContentSectionDescription(getUserVisitPK(request), commandForm);
