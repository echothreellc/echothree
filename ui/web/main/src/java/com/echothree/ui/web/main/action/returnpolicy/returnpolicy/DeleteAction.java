...
@SproutAction(
    path = "/ReturnPolicy/ReturnPolicy/Delete",
...
public class DeleteAction
    ...
    throws Exception {
        ...
        try {
            DeleteReturnPolicyForm commandForm = ReturnPolicyUtil.getHome().getDeleteReturnPolicyForm();
            ...
            ReturnPolicyUtil.getHome().deleteReturnPolicy(getUserVisitPK(request), commandForm);
