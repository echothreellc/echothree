...
@SproutAction(
    path = "/Content/ContentWebAddress/Delete",
    mappingClass = SecureActionMapping.class,
    name = "ContentWebAddressDelete",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Content/ContentWebAddress/Main", redirect = true),
        @SproutForward(name = "Form", path = "/content/contentwebaddress/delete.jsp")
    }
)
public class DeleteAction
    ...
    public String getEntityTypeName() {
        return EntityTypes.ContentWebAddress.name();
    }
    ...
    public CommandResult doDelete(DeleteActionForm actionForm, HttpServletRequest request)
        ...
        return ContentUtil.getHome().deleteContentWebAddress(getUserVisitPK(request), commandForm);
    }
