...
import com.echothree.control.user.associate.remote.form.DeleteAssociateProgramDescriptionForm;
...
@SproutAction(
    path = "/Associate/AssociateProgram/DescriptionDelete",
...
public class DescriptionDeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            DeleteAssociateProgramDescriptionForm commandForm = AssociateUtil.getHome().getDeleteAssociateProgramDescriptionForm();
            
            commandForm.setAssociateProgramName(associateProgramName);
            commandForm.setLanguageIsoName(languageIsoName);
            
            AssociateUtil.getHome().deleteAssociateProgramDescription(getUserVisitPK(request), commandForm);
