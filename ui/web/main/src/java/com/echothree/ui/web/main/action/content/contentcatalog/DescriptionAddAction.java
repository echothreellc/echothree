...
import com.echothree.control.user.content.remote.form.CreateContentCatalogDescriptionForm;
...
@SproutAction(
    path = "/Content/ContentCatalog/DescriptionAdd",
    mappingClass = SecureActionMapping.class,
    name = "ContentCatalogDescriptionAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Content/ContentCatalog/Description", redirect = true),
        @SproutForward(name = "Form", path = "/content/contentcatalog/descriptionAdd.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreateContentCatalogDescriptionForm commandForm = ContentUtil.getHome().getCreateContentCatalogDescriptionForm();
                    ...
                    CommandResult commandResult = ContentUtil.getHome().createContentCatalogDescription(getUserVisitPK(request), commandForm);
