    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    var commandForm = ContentUtil.getHome().getCreateContentCatalogDescriptionForm();
                    ...
                    var commandResult = ContentUtil.getHome().createContentCatalogDescription(getUserVisitPK(request), commandForm);
