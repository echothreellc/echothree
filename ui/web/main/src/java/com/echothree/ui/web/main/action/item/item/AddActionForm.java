...
import com.echothree.control.user.accounting.remote.form.GetItemAccountingCategoryChoicesForm;
import com.echothree.control.user.accounting.remote.result.GetItemAccountingCategoryChoicesResult;
...
import com.echothree.control.user.item.remote.form.GetItemCategoryChoicesForm;
import com.echothree.control.user.item.remote.form.GetItemDeliveryTypeChoicesForm;
import com.echothree.control.user.item.remote.form.GetItemInventoryTypeChoicesForm;
import com.echothree.control.user.item.remote.form.GetItemPriceTypeChoicesForm;
import com.echothree.control.user.item.remote.form.GetItemStatusChoicesForm;
import com.echothree.control.user.item.remote.form.GetItemTypeChoicesForm;
import com.echothree.control.user.item.remote.form.GetItemUseTypeChoicesForm;
import com.echothree.control.user.item.remote.result.GetItemCategoryChoicesResult;
import com.echothree.control.user.item.remote.result.GetItemDeliveryTypeChoicesResult;
import com.echothree.control.user.item.remote.result.GetItemInventoryTypeChoicesResult;
import com.echothree.control.user.item.remote.result.GetItemPriceTypeChoicesResult;
import com.echothree.control.user.item.remote.result.GetItemStatusChoicesResult;
import com.echothree.control.user.item.remote.result.GetItemTypeChoicesResult;
import com.echothree.control.user.item.remote.result.GetItemUseTypeChoicesResult;
...
import com.echothree.control.user.uom.remote.form.GetUnitOfMeasureKindChoicesForm;
import com.echothree.control.user.uom.remote.result.GetUnitOfMeasureKindChoicesResult;
import com.echothree.control.user.vendor.common.VendorUtil;
import com.echothree.control.user.vendor.remote.form.GetItemPurchasingCategoryChoicesForm;
import com.echothree.control.user.vendor.remote.result.GetItemPurchasingCategoryChoicesResult;
import com.echothree.model.control.accounting.remote.choice.ItemAccountingCategoryChoicesBean;
...
import com.echothree.model.control.item.remote.choice.ItemCategoryChoicesBean;
import com.echothree.model.control.item.remote.choice.ItemDeliveryTypeChoicesBean;
import com.echothree.model.control.item.remote.choice.ItemInventoryTypeChoicesBean;
import com.echothree.model.control.item.remote.choice.ItemPriceTypeChoicesBean;
import com.echothree.model.control.item.remote.choice.ItemStatusChoicesBean;
import com.echothree.model.control.item.remote.choice.ItemTypeChoicesBean;
import com.echothree.model.control.item.remote.choice.ItemUseTypeChoicesBean;
...
import com.echothree.model.control.uom.remote.choice.UnitOfMeasureKindChoicesBean;
import com.echothree.model.control.vendor.remote.choice.ItemPurchasingCategoryChoicesBean;
