...
import com.echothree.control.user.core.remote.form.GetEntityAttributeDescriptionsForm;
import com.echothree.control.user.core.remote.result.GetEntityAttributeDescriptionsResult;
...
@SproutAction(
    path = "/Core/EntityAttribute/Description",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/core/entityattribute/description.jsp")
    }
)
