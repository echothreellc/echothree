    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    var commandForm = RatingUtil.getHome().getCreateRatingTypeDescriptionForm();
                    ...
                    var commandResult = RatingUtil.getHome().createRatingTypeDescription(getUserVisitPK(request), commandForm);
