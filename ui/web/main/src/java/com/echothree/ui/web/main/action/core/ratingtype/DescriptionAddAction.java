...
@SproutAction(
    path = "/Core/RatingType/DescriptionAdd",
    mappingClass = SecureActionMapping.class,
    name = "CoreRatingTypeDescriptionAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Core/RatingType/Description", redirect = true),
        @SproutForward(name = "Form", path = "/core/ratingtype/descriptionAdd.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreateRatingTypeDescriptionForm commandForm = RatingUtil.getHome().getCreateRatingTypeDescriptionForm();
                    ...
                    CommandResult commandResult = RatingUtil.getHome().createRatingTypeDescription(getUserVisitPK(request), commandForm);
