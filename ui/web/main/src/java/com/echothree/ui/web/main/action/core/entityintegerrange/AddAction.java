...
import com.echothree.control.user.core.remote.form.GetEntityAttributeForm;
import com.echothree.control.user.core.remote.result.GetEntityAttributeResult;
...
@SproutAction(
    path = "/Core/EntityIntegerRange/Add",
    mappingClass = SecureActionMapping.class,
    name = "EntityIntegerRangeAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Core/EntityIntegerRange/Main", redirect = true),
        @SproutForward(name = "Form", path = "/core/entityintegerrange/add.jsp")
    }
)
public class AddAction
    ...
    public CommandResult doAdd(AddActionForm actionForm, HttpServletRequest request)
            throws NamingException {
        CreateEntityIntegerRangeForm commandForm = CoreUtil.getHome().getCreateEntityIntegerRangeForm();

        commandForm.setComponentVendorName(actionForm.getComponentVendorName());
        commandForm.setEntityTypeName(actionForm.getEntityTypeName());
        commandForm.setEntityAttributeName(actionForm.getEntityAttributeName());
        commandForm.setEntityIntegerRangeName(actionForm.getEntityIntegerRangeName());
        commandForm.setMinimumIntegerValue(actionForm.getMinimumIntegerValue());
        commandForm.setMaximumIntegerValue(actionForm.getMaximumIntegerValue());
        commandForm.setIsDefault(actionForm.getIsDefault().toString());
        commandForm.setSortOrder(actionForm.getSortOrder());
        commandForm.setDescription(actionForm.getDescription());

        return CoreUtil.getHome().createEntityIntegerRange(getUserVisitPK(request), commandForm);
    }
