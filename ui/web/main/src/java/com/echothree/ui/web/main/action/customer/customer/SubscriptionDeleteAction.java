...
@SproutAction(
    path = "/Customer/Customer/SubscriptionDelete",
...
public class SubscriptionDeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            DeleteSubscriptionForm commandForm = SubscriptionUtil.getHome().getDeleteSubscriptionForm();
            
            commandForm.setSubscriptionName(subscriptionName);
            
            SubscriptionUtil.getHome().deleteSubscription(getUserVisitPK(request), commandForm);
