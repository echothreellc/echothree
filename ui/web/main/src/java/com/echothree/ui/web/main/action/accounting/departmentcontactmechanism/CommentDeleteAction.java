...
@SproutAction(
    path = "/Accounting/DepartmentContactMechanism/CommentDelete",
    mappingClass = SecureActionMapping.class,
    name = "DepartmentContactMechanismCommentDelete",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Accounting/DepartmentContactMechanism/Review", redirect = true),
        @SproutForward(name = "Form", path = "/accounting/departmentcontactmechanism/commentDelete.jsp")
    }
)
