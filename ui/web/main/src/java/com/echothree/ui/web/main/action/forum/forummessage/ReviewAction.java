...
@SproutAction(
    path = "/Forum/ForumMessage/Review",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/forum/forummessage/review.jsp")
    }
)
public class ReviewAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        options.add(ForumOptions.ForumMessageIncludeEntityAttributeGroups);
        options.add(ForumOptions.ForumMessageIncludeTagScopes);
