...
@SproutAction(
    path = "/Configuration/WorkflowStep/DescriptionAdd",
    mappingClass = SecureActionMapping.class,
    name = "WorkflowStepDescriptionAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Configuration/WorkflowStep/Description", redirect = true),
        @SproutForward(name = "Form", path = "/configuration/workflowstep/descriptionAdd.jsp")
    }
)
