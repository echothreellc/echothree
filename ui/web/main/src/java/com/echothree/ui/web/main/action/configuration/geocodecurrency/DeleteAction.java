...
@SproutAction(
    path = "/Configuration/GeoCodeCurrency/Delete",
...
public class DeleteAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            DeleteGeoCodeCurrencyForm commandForm = GeoUtil.getHome().getDeleteGeoCodeCurrencyForm();
            ...
            GeoUtil.getHome().deleteGeoCodeCurrency(getUserVisitPK(request), commandForm);
