    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                var commandForm = ForumUtil.getHome().getEditForumDescriptionForm();
                var spec = ForumUtil.getHome().getForumDescriptionSpec();
                ...
                if(wasPost(request)) {
                    var edit = ForumUtil.getHome().getForumDescriptionEdit();
                    
                    commandForm.setEditMode(EditMode.UPDATE);
                    commandForm.setEdit(edit);
                    edit.setDescription(actionForm.getDescription());

                    var commandResult = ForumUtil.getHome().editForumDescription(getUserVisitPK(request), commandForm);
                    
                    if(commandResult.hasErrors()) {
                        var executionResult = commandResult.getExecutionResult();
                        
                        if(executionResult != null) {
                            var result = (EditForumDescriptionResult)executionResult.getResult();
