...
@SproutAction(
    path = "/Accounting/DivisionContactMechanism/ContactMechanismAdd/ContactEmailAddressAdd",
    mappingClass = SecureActionMapping.class,
    name = "DivisionContactEmailAddressAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Accounting/DivisionContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/accounting/divisioncontactmechanism/contactmechanismadd/contactEmailAddressAdd.jsp")
    }
)
public class ContactEmailAddressAddAction
        extends BaseDivisionContactMechanismAction<ContactEmailAddressAddActionForm> {
