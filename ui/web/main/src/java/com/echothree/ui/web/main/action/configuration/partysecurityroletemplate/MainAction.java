...
import com.echothree.control.user.security.remote.result.GetPartySecurityRoleTemplatesResult;
...
@SproutAction(
    path = "/Configuration/PartySecurityRoleTemplate/Main",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/configuration/partysecurityroletemplate/main.jsp")
    }
)
