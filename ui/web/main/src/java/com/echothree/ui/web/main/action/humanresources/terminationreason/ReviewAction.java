...
import com.echothree.control.user.employee.remote.form.GetTerminationReasonForm;
import com.echothree.control.user.employee.remote.result.GetTerminationReasonResult;
...
@SproutAction(
    path = "/HumanResources/TerminationReason/Review",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/humanresources/terminationreason/review.jsp")
    }
)
