...
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            var entityLongRangeName = request.getParameter(ParameterConstants.ENTITY_LONG_RANGE_NAME);
            var commandForm = CoreUtil.getHome().getSetDefaultEntityLongRangeForm();
