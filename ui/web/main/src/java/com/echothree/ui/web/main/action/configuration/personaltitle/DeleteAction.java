...
import com.echothree.control.user.party.remote.form.DeletePersonalTitleForm;
...
@SproutAction(
    path = "/Configuration/PersonalTitle/Delete",
...
public class DeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            PartyUtil.getHome().deletePersonalTitle(getUserVisitPK(request), commandForm);
