...
import com.echothree.control.user.party.remote.form.GetTimeZoneForm;
import com.echothree.control.user.party.remote.result.GetTimeZoneResult;
...
@SproutAction(
    path = "/Configuration/TimeZone/Review",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/configuration/timezone/review.jsp")
    }
)
