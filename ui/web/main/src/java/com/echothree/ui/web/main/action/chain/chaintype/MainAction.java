...
import com.echothree.control.user.chain.remote.form.GetChainTypesForm;
import com.echothree.control.user.chain.remote.result.GetChainTypesResult;
...
@SproutAction(
    path = "/Chain/ChainType/Main",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/chain/chaintype/main.jsp")
    }
)
