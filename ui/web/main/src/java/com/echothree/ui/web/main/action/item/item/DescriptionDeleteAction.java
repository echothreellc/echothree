...
import com.echothree.control.user.item.common.form.DeleteItemDescriptionForm;
...
@SproutAction(
    path = "/Item/Item/DescriptionDelete",
    mappingClass = SecureActionMapping.class,
    name = "ItemDescriptionDelete",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Item/Item/Description", redirect = true),
        @SproutForward(name = "Form", path = "/item/item/descriptionDelete.jsp")
    }
)
public class DescriptionDeleteAction
    ...
    public String getEntityTypeName() {
        return EntityTypes.ItemDescription.name();
    }
    ...
    public CommandResult doDelete(DescriptionDeleteActionForm actionForm, HttpServletRequest request)
            throws NamingException {
        DeleteItemDescriptionForm commandForm = ItemUtil.getHome().getDeleteItemDescriptionForm();

        commandForm.setItemDescriptionTypeName(actionForm.getItemDescriptionTypeName());
        commandForm.setItemName(actionForm.getItemName());
        commandForm.setLanguageIsoName(actionForm.getLanguageIsoName());

        return ItemUtil.getHome().deleteItemDescription(getUserVisitPK(request), commandForm);
    }
