...
import com.echothree.control.user.contact.remote.form.DeletePartyContactMechanismRelationshipForm;
...
@SproutAction(
    path = "/HumanResources/EmployeeContactMechanism/PartyContactMechanismRelationshipDelete",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Review", path = "/action/HumanResources/EmployeeContactMechanism/Main", redirect = true)
    }
)
public class PartyContactMechanismRelationshipDeleteAction
