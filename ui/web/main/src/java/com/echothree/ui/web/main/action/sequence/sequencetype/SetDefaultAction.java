...
import com.echothree.control.user.sequence.common.form.SetDefaultSequenceTypeForm;
...
@SproutAction(
    path = "/Sequence/SequenceType/SetDefault",
...
public class SetDefaultAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            SequenceUtil.getHome().setDefaultSequenceType(getUserVisitPK(request), commandForm);
