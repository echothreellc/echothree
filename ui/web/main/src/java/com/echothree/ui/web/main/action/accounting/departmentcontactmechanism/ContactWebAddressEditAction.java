...
@SproutAction(
    path = "/Accounting/DepartmentContactMechanism/ContactWebAddressEdit",
    mappingClass = SecureActionMapping.class,
    name = "DepartmentContactWebAddressEdit",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Accounting/DepartmentContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/accounting/departmentcontactmechanism/contactWebAddressEdit.jsp")
    }
)
public class ContactWebAddressEditAction
        extends BaseDepartmentContactMechanismAction<ContactWebAddressEditActionForm> {
