...
@SproutAction(
    path = "/UnitOfMeasure/UnitOfMeasureKind/DescriptionDelete",
...
public class DescriptionDeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            UomUtil.getHome().deleteUnitOfMeasureKindDescription(getUserVisitPK(request), deleteUnitOfMeasureKindDescriptionForm);
