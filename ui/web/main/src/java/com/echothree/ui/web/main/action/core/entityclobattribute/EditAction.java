...
import com.echothree.control.user.core.remote.form.EditEntityClobAttributeForm;
import com.echothree.control.user.core.remote.result.EditEntityClobAttributeResult;
...
@SproutAction(
    path = "/Core/EntityClobAttribute/Edit",
    mappingClass = SecureActionMapping.class,
    name = "EntityClobAttributeEdit",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Form", path = "/core/entityclobattribute/edit.jsp")
    }
)
                ...
                if(wasPost(request)) {
                    ...
                    if(result != null) {
                        ...
                        if(edit != null) {
                            ...
                            actionForm.setClobAttribute(edit.getClobAttribute());
                        }
