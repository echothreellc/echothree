...
import com.echothree.control.user.comment.remote.form.GetCommentTypeForm;
import com.echothree.control.user.comment.remote.result.GetCommentTypeResult;
...
@SproutAction(
    path = "/Core/CommentType/Review",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/core/commenttype/review.jsp")
    }
)
public class ReviewAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        if(commentType == null) {
            ...
            request.setAttribute(AttributeConstants.COMMENT_TYPE, commentType);
