...
@SproutAction(
    path = "/ReturnPolicy/ReturnType/DescriptionDelete",
...
public class DescriptionDeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            DeleteReturnTypeDescriptionForm commandForm = ReturnPolicyUtil.getHome().getDeleteReturnTypeDescriptionForm();
            
            commandForm.setReturnKindName(returnKindName);
            commandForm.setReturnTypeName(returnTypeName);
            commandForm.setLanguageIsoName(languageIsoName);
            
            ReturnPolicyUtil.getHome().deleteReturnTypeDescription(getUserVisitPK(request), commandForm);
