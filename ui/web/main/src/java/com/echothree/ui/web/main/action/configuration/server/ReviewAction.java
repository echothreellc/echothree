...
import com.echothree.control.user.core.remote.form.GetServerForm;
import com.echothree.control.user.core.remote.result.GetServerResult;
...
@SproutAction(
    path = "/Configuration/Server/Review",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/configuration/server/review.jsp")
    }
)
public class ReviewAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        if(server == null) {
            ...
            request.setAttribute(AttributeConstants.SERVER, server);
