...
@SproutAction(
    path = "/Purchasing/VendorContactMechanism/CommentDelete",
    mappingClass = SecureActionMapping.class,
    name = "VendorContactMechanismCommentDelete",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Purchasing/VendorContactMechanism/Review", redirect = true),
        @SproutForward(name = "Form", path = "/purchasing/vendorcontactmechanism/commentDelete.jsp")
    }
)
