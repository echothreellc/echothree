...
@SproutAction(
    path = "/Advertising/UseNameElement/Edit",
    mappingClass = SecureActionMapping.class,
    name = "UseNameElementEdit",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Advertising/UseNameElement/Main", redirect = true),
        @SproutForward(name = "Form", path = "/advertising/usenameelement/edit.jsp")
    }
)
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    ...
                    edit.setUseNameElementName(actionForm.getUseNameElementName());
                    ...
                    if(result != null) {
                        ...
                        if(edit != null) {
                            ...
                            actionForm.setUseNameElementName(edit.getUseNameElementName());
