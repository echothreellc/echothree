...
import com.echothree.control.user.filter.remote.form.CreateFilterAdjustmentFixedAmountForm;
...
@SproutAction(
    path = "/Filter/FilterAdjustmentFixedAmount/Add",
    mappingClass = SecureActionMapping.class,
    name = "FilterAdjustmentFixedAmountAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Filter/FilterAdjustmentFixedAmount/Main", redirect = true),
        @SproutForward(name = "Form", path = "/filter/filteradjustmentfixedamount/add.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreateFilterAdjustmentFixedAmountForm commandForm = FilterUtil.getHome().getCreateFilterAdjustmentFixedAmountForm();
                    ...
                    commandForm.setUnitAmount(addActionForm.getUnitAmount());
                    
                    CommandResult commandResult = FilterUtil.getHome().createFilterAdjustmentFixedAmount(getUserVisitPK(request), commandForm);
