...
import com.echothree.control.user.payment.remote.result.GetPaymentProcessorTypesResult;
...
@SproutAction(
    path = "/Payment/PaymentProcessor/Add/Step1",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/payment/paymentprocessor/add/step1.jsp")
    }
)
