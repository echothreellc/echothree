...
import com.echothree.control.user.party.remote.edit.PersonalTitleEdit;
import com.echothree.control.user.party.remote.form.EditPersonalTitleForm;
import com.echothree.control.user.party.remote.result.EditPersonalTitleResult;
import com.echothree.control.user.party.remote.spec.PersonalTitleSpec;
...
@SproutAction(
    path = "/Configuration/PersonalTitle/Edit",
    mappingClass = SecureActionMapping.class,
    name = "PersonalTitleEdit",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Configuration/PersonalTitle/Main", redirect = true),
        @SproutForward(name = "Form", path = "/configuration/personaltitle/edit.jsp")
    }
)
