...
import com.echothree.control.user.core.remote.form.DeleteEntityStringAttributeForm;
...
@SproutAction(
    path = "/Core/EntityStringAttribute/Delete",
...
public class DeleteAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            DeleteEntityStringAttributeForm commandForm = CoreUtil.getHome().getDeleteEntityStringAttributeForm();
            
            commandForm.setEntityRef(entityRef);
            commandForm.setEntityAttributeName(entityAttributeName);
            commandForm.setLanguageIsoName(languageIsoName);
            
            CoreUtil.getHome().deleteEntityStringAttribute(getUserVisitPK(request), commandForm);
