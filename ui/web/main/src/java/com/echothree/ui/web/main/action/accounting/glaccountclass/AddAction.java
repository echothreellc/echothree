...
import com.echothree.control.user.accounting.remote.form.CreateGlAccountClassForm;
...
@SproutAction(
    path = "/Accounting/GlAccountClass/Add",
    mappingClass = SecureActionMapping.class,
    name = "GlAccountClassAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Accounting/GlAccountClass/Main", redirect = true),
        @SproutForward(name = "Form", path = "/accounting/glaccountclass/add.jsp")
    }
)
