...
@SproutAction(
    path = "/Advertising/Use/DescriptionDelete",
...
public class DescriptionDeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            DeleteUseDescriptionForm commandForm = OfferUtil.getHome().getDeleteUseDescriptionForm();
            
            commandForm.setUseName(useName);
            commandForm.setLanguageIsoName(languageIsoName);
            
            OfferUtil.getHome().deleteUseDescription(getUserVisitPK(request), commandForm);
