...
@SproutAction(
    path = "/Item/ItemVolumeType/Add",
    mappingClass = SecureActionMapping.class,
    name = "ItemVolumeTypeAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Item/ItemVolumeType/Main", redirect = true),
        @SproutForward(name = "Form", path = "/item/itemvolumetype/add.jsp")
    }
)
public class AddAction
    ...
    public CommandResult doAdd(AddActionForm actionForm, HttpServletRequest request)
        ...
        return ItemUtil.getHome().createItemVolumeType(getUserVisitPK(request), commandForm);
    }
