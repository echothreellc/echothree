...
import com.echothree.control.user.printer.remote.form.SetDefaultPrinterGroupForm;
...
@SproutAction(
    path = "/Configuration/PrinterGroup/SetDefault",
...
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            ...
            PrinterUtil.getHome().setDefaultPrinterGroup(getUserVisitPK(request), commandForm);
