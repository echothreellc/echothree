...
package com.echothree.ui.web.main.action.configuration.zipcode;

import com.echothree.control.user.geo.common.GeoUtil;
import com.echothree.control.user.geo.remote.form.GetZipCodesForm;
import com.echothree.control.user.geo.remote.result.GetZipCodesResult;
...
@SproutAction(
    path = "/Configuration/ZipCode/Main",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/configuration/zipcode/main.jsp")
    }
)
