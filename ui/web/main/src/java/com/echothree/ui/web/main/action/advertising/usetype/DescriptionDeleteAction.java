...
@SproutAction(
    path = "/Advertising/UseType/DescriptionDelete",
...
public class DescriptionDeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            DeleteUseTypeDescriptionForm commandForm = OfferUtil.getHome().getDeleteUseTypeDescriptionForm();
            
            commandForm.setUseTypeName(useTypeName);
            commandForm.setLanguageIsoName(languageIsoName);
            
            OfferUtil.getHome().deleteUseTypeDescription(getUserVisitPK(request), commandForm);
