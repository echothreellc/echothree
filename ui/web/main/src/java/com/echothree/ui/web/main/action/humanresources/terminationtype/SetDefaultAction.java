...
@SproutAction(
    path = "/HumanResources/TerminationType/SetDefault",
...
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            SetDefaultTerminationTypeForm commandForm = EmployeeUtil.getHome().getSetDefaultTerminationTypeForm();
            ...
            EmployeeUtil.getHome().setDefaultTerminationType(getUserVisitPK(request), commandForm);
