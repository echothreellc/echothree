...
import com.echothree.control.user.tax.remote.form.GetGeoCodeTaxesForm;
import com.echothree.control.user.tax.remote.result.GetGeoCodeTaxesResult;
...
@SproutAction(
    path = "/Accounting/GeoCodeTax/Main",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/accounting/geocodetax/main.jsp")
    }
)
