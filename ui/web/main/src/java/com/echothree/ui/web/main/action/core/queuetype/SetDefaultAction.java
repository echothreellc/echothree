...
import com.echothree.control.user.queue.remote.form.SetDefaultQueueTypeForm;
...
@SproutAction(
    path = "/Core/QueueType/SetDefault",
...
public class SetDefaultAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        QueueUtil.getHome().setDefaultQueueType(getUserVisitPK(request), commandForm);
