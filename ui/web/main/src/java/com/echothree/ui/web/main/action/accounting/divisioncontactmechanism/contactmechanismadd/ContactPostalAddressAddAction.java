...
@SproutAction(
    path = "/Accounting/DivisionContactMechanism/ContactMechanismAdd/ContactPostalAddressAdd",
    mappingClass = SecureActionMapping.class,
    name = "DivisionContactPostalAddressAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Accounting/DivisionContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/accounting/divisioncontactmechanism/contactmechanismadd/contactPostalAddressAdd.jsp")
    }
)
public class ContactPostalAddressAddAction
        extends BaseDivisionContactMechanismAction<ContactPostalAddressAddActionForm> {
