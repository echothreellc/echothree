...
@SproutAction(
    path = "/Shipping/CarrierContactMechanism/ContactPostalAddressStatus",
    mappingClass = SecureActionMapping.class,
    name = "CarrierContactPostalAddressStatus",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Shipping/CarrierContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/shipping/carriercontactmechanism/contactPostalAddressStatus.jsp")
    }
)
public class ContactPostalAddressStatusAction
        extends BaseCarrierContactMechanismAction<ContactPostalAddressStatusActionForm> {
