...
import com.echothree.control.user.contactlist.remote.form.GetContactListTypeDescriptionsForm;
import com.echothree.control.user.contactlist.remote.result.GetContactListTypeDescriptionsResult;
...
@SproutAction(
    path = "/ContactList/ContactListType/Description",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/contactlist/contactlisttype/description.jsp")
    }
)
