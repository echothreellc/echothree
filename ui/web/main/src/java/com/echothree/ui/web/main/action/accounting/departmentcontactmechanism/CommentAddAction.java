...
@SproutAction(
    path = "/Accounting/DepartmentContactMechanism/CommentAdd",
    mappingClass = SecureActionMapping.class,
    name = "DepartmentContactMechanismCommentAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Accounting/DepartmentContactMechanism/Review", redirect = true),
        @SproutForward(name = "Form", path = "/accounting/departmentcontactmechanism/commentAdd.jsp")
    }
)
