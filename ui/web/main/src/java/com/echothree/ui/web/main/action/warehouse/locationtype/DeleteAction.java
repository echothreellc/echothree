...
import com.echothree.control.user.warehouse.remote.form.DeleteLocationTypeForm;
...
public class DeleteAction
    ...
    throws Exception {
        ...
        try {
            DeleteLocationTypeForm commandForm = WarehouseUtil.getHome().getDeleteLocationTypeForm();
            ...
            WarehouseUtil.getHome().deleteLocationType(getUserVisitPK(request), commandForm);
