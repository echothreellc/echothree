...
@SproutAction(
    path = "/Accounting/DivisionContactMechanism/CommentAdd",
    mappingClass = SecureActionMapping.class,
    name = "DivisionContactMechanismCommentAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Accounting/DivisionContactMechanism/Review", redirect = true),
        @SproutForward(name = "Form", path = "/accounting/divisioncontactmechanism/commentAdd.jsp")
    }
)
