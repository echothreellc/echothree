...
import com.echothree.control.user.party.remote.form.GetTimeZoneDescriptionsForm;
import com.echothree.control.user.party.remote.result.GetTimeZoneDescriptionsResult;
...
@SproutAction(
    path = "/Configuration/TimeZone/Description",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/configuration/timezone/description.jsp")
    }
)
public class DescriptionAction
    ...
    throws Exception {
        ...
        try {
            ...
            request.setAttribute(AttributeConstants.TIME_ZONE_DESCRIPTIONS, result.getTimeZoneDescriptions());
