...
@SproutAction(
    path = "/Configuration/CommunicationEventPurpose/Add",
    mappingClass = SecureActionMapping.class,
    name = "CommunicationEventPurposeAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Configuration/CommunicationEventPurpose/Main", redirect = true),
        @SproutForward(name = "Form", path = "/configuration/communicationeventpurpose/add.jsp")
    }
)
