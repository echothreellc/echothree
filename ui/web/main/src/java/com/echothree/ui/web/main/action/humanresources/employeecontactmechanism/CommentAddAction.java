...
@SproutAction(
    path = "/HumanResources/EmployeeContactMechanism/CommentAdd",
    mappingClass = SecureActionMapping.class,
    name = "EmployeeContactMechanismCommentAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/HumanResources/EmployeeContactMechanism/Review", redirect = true),
        @SproutForward(name = "Form", path = "/humanresources/employeecontactmechanism/commentAdd.jsp")
    }
)
