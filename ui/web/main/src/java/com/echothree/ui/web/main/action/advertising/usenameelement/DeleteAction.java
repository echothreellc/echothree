...
import com.echothree.control.user.offer.remote.form.DeleteUseNameElementForm;
...
@SproutAction(
    path = "/Advertising/UseNameElement/Delete",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Advertising/UseNameElement/Main", redirect = true)
    }
)
public class DeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            OfferUtil.getHome().deleteUseNameElement(getUserVisitPK(request), commandForm);
