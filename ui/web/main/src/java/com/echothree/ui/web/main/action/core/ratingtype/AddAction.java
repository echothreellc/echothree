...
import com.echothree.control.user.rating.remote.form.CreateRatingTypeForm;
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreateRatingTypeForm commandForm = RatingUtil.getHome().getCreateRatingTypeForm();
                    ...
                    CommandResult commandResult = RatingUtil.getHome().createRatingType(getUserVisitPK(request), commandForm);
