...
@SproutAction(
    path = "/Core/EntityAliasType/Add",
    mappingClass = SecureActionMapping.class,
    name = "EntityAliasTypeAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Core/EntityAliasType/Main", redirect = true),
        @SproutForward(name = "Form", path = "/core/entityaliastype/add.jsp")
    }
)
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    ...
                    var commandResult = CoreUtil.getHome().createEntityAliasType(getUserVisitPK(request), commandForm);
