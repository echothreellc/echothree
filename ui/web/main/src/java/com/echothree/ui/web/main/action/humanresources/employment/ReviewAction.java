...
import com.echothree.control.user.employee.remote.form.GetEmploymentForm;
import com.echothree.control.user.employee.remote.result.GetEmploymentResult;
...
@SproutAction(
    path = "/HumanResources/Employment/Review",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/humanresources/employment/review.jsp")
    }
)
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        if(employment == null) {
            ...
            request.setAttribute(AttributeConstants.EMPLOYEE, EmployeeUtils.getInstance().getEmployee(getUserVisitPK(request),
                    employment.getParty().getPartyName(), null));
