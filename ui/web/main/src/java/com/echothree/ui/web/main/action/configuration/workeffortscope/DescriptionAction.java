...
import com.echothree.control.user.workeffort.remote.form.GetWorkEffortScopeDescriptionsForm;
import com.echothree.control.user.workeffort.remote.result.GetWorkEffortScopeDescriptionsResult;
...
@SproutAction(
    path = "/Configuration/WorkEffortScope/Description",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/configuration/workeffortscope/description.jsp")
    }
)
public class DescriptionAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        if(workEffortScope == null) {
            ...
            request.setAttribute(AttributeConstants.WORK_EFFORT_SCOPE_DESCRIPTIONS, result.getWorkEffortScopeDescriptions());
            forwardKey = ForwardConstants.DISPLAY;
        }
