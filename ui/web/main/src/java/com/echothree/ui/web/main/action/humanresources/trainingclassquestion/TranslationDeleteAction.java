...
import com.echothree.control.user.training.remote.form.DeleteTrainingClassQuestionTranslationForm;
import com.echothree.control.user.training.remote.form.GetTrainingClassQuestionTranslationForm;
import com.echothree.control.user.training.remote.result.GetTrainingClassQuestionTranslationResult;
...
@SproutAction(
    path = "/HumanResources/TrainingClassQuestion/TranslationDelete",
    mappingClass = SecureActionMapping.class,
    name = "TrainingClassQuestionTranslationDelete",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/HumanResources/TrainingClassQuestion/Translation", redirect = true),
        @SproutForward(name = "Form", path = "/humanresources/trainingclassquestion/translationDelete.jsp")
    }
)
public class TranslationDeleteAction
    ...
    public String getEntityTypeName() {
        return EntityTypes.TrainingClassQuestionTranslation.name();
    }
    ...
    public void setupTransfer(TranslationDeleteActionForm actionForm, HttpServletRequest request)
        ...
        GetTrainingClassQuestionTranslationForm commandForm = TrainingUtil.getHome().getGetTrainingClassQuestionTranslationForm();
        ...
        CommandResult commandResult = TrainingUtil.getHome().getTrainingClassQuestionTranslation(getUserVisitPK(request), commandForm);
        if(!commandResult.hasErrors()) {
            ExecutionResult executionResult = commandResult.getExecutionResult();
            GetTrainingClassQuestionTranslationResult result = (GetTrainingClassQuestionTranslationResult)executionResult.getResult();
    ...
    public CommandResult doDelete(TranslationDeleteActionForm actionForm, HttpServletRequest request)
            throws NamingException {
        DeleteTrainingClassQuestionTranslationForm commandForm = TrainingUtil.getHome().getDeleteTrainingClassQuestionTranslationForm();
        ...
        return TrainingUtil.getHome().deleteTrainingClassQuestionTranslation(getUserVisitPK(request), commandForm);
    }
