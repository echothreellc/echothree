...
@SproutAction(
    path = "/Customer/CustomerContactMechanism/ContactTelephoneStatus",
    mappingClass = SecureActionMapping.class,
    name = "CustomerContactTelephoneStatus",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Customer/CustomerContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/customer/customercontactmechanism/contactTelephoneStatus.jsp")
    }
)
public class ContactTelephoneStatusAction
        extends BaseCustomerContactMechanismAction<ContactTelephoneStatusActionForm> {
