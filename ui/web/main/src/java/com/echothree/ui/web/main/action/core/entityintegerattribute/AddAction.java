...
@SproutAction(
    path = "/Core/EntityIntegerAttribute/Add",
    mappingClass = SecureActionMapping.class,
    name = "EntityIntegerAttributeAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Form", path = "/core/entityintegerattribute/add.jsp")
    }
)
public class AddAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(wasPost(request)) {
                CreateEntityIntegerAttributeForm commandForm = CoreUtil.getHome().getCreateEntityIntegerAttributeForm();
                ...
                commandForm.setIntegerAttribute(actionForm.getIntegerAttribute());
                
                CommandResult commandResult = CoreUtil.getHome().createEntityIntegerAttribute(getUserVisitPK(request), commandForm);
