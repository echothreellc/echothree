...
import com.echothree.control.user.filter.remote.form.CreateFilterDescriptionForm;
...
@SproutAction(
    path = "/Filter/Filter/DescriptionAdd",
    mappingClass = SecureActionMapping.class,
    name = "FilterDescriptionAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Filter/Filter/Description", redirect = true),
        @SproutForward(name = "Form", path = "/filter/filter/descriptionAdd.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreateFilterDescriptionForm createFilterDescriptionForm = FilterUtil.getHome().getCreateFilterDescriptionForm();
                    ...
                    createFilterDescriptionForm.setFilterKindName(filterKindName);
                    createFilterDescriptionForm.setFilterTypeName(filterTypeName);
                    createFilterDescriptionForm.setFilterName(filterName);
                    createFilterDescriptionForm.setLanguageIsoName(descriptionAddActionForm.getLanguageChoice());
                    createFilterDescriptionForm.setDescription(descriptionAddActionForm.getDescription());
                    
                    CommandResult commandResult = FilterUtil.getHome().createFilterDescription(getUserVisitPK(request), createFilterDescriptionForm);
