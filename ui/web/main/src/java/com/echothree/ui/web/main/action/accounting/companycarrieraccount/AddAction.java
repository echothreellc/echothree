...
import com.echothree.control.user.carrier.remote.form.CreatePartyCarrierAccountForm;
...
@SproutAction(
    path = "/Accounting/CompanyCarrierAccount/Add",
    mappingClass = SecureActionMapping.class,
    name = "CompanyCarrierAccountAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Accounting/CompanyCarrierAccount/Main", redirect = true),
        @SproutForward(name = "Form", path = "/accounting/companycarrieraccount/add.jsp")
    }
)
