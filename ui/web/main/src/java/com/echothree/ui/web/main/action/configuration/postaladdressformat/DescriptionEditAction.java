...
import com.echothree.control.user.contact.remote.edit.PostalAddressFormatDescriptionEdit;
import com.echothree.control.user.contact.remote.form.EditPostalAddressFormatDescriptionForm;
import com.echothree.control.user.contact.remote.result.EditPostalAddressFormatDescriptionResult;
import com.echothree.control.user.contact.remote.spec.PostalAddressFormatDescriptionSpec;
...
@SproutAction(
    path = "/Configuration/PostalAddressFormat/DescriptionEdit",
    mappingClass = SecureActionMapping.class,
    name = "PostalAddressFormatDescriptionEdit",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Configuration/PostalAddressFormat/Description", redirect = true),
        @SproutForward(name = "Form", path = "/configuration/postaladdressformat/descriptionEdit.jsp")
    }
)
