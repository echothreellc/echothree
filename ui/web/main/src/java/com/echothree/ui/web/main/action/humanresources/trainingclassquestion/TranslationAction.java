...
@SproutAction(
    path = "/HumanResources/TrainingClassQuestion/Translation",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/humanresources/trainingclassquestion/translation.jsp")
    }
)
public class TranslationAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        if(trainingClassQuestion == null) {
            ...
            request.setAttribute(AttributeConstants.TRAINING_CLASS_QUESTION, trainingClassQuestion);
            request.setAttribute(AttributeConstants.TRAINING_CLASS_QUESTION_TRANSLATIONS, result.getTrainingClassQuestionTranslations());
            forwardKey = ForwardConstants.DISPLAY;
        }
