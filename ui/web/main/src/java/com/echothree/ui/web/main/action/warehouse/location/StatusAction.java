...
import com.echothree.control.user.warehouse.remote.form.SetLocationStatusForm;
...
@SproutAction(
    path = "/Warehouse/Location/Status",
    ...
    forwards = {
        ...
        @SproutForward(name = "Form", path = "/warehouse/location/status.jsp")
    }
)
public class StatusAction
    ...
    throws Exception {
        ...
        try {
            ...
            SetLocationStatusForm commandForm = WarehouseUtil.getHome().getSetLocationStatusForm();
            ...
            if(wasPost(request)) {
                ...
                commandForm.setLocationStatusChoice(actionForm.getLocationStatusChoice());
                
                CommandResult commandResult = WarehouseUtil.getHome().setLocationStatus(getUserVisitPK(request), commandForm);
                ...
                actionForm.setupLocationStatusChoices();
                forwardKey = ForwardConstants.FORM;
            }
