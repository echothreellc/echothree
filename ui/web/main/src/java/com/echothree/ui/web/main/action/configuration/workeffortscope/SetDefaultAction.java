...
@SproutAction(
    path = "/Configuration/WorkEffortScope/SetDefault",
...
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            SetDefaultWorkEffortScopeForm commandForm = WorkEffortUtil.getHome().getSetDefaultWorkEffortScopeForm();
            ...
            WorkEffortUtil.getHome().setDefaultWorkEffortScope(getUserVisitPK(request), commandForm);
