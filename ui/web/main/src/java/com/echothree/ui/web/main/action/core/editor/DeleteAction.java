...
import com.echothree.control.user.core.remote.form.DeleteEditorForm;
import com.echothree.control.user.core.remote.form.GetEditorForm;
import com.echothree.control.user.core.remote.result.GetEditorResult;
...
public class DeleteAction
    ...
    public CommandResult doDelete(DeleteActionForm actionForm, HttpServletRequest request)
            throws NamingException {
        DeleteEditorForm commandForm = CoreUtil.getHome().getDeleteEditorForm();
