...
import com.echothree.control.user.inventory.remote.form.DeleteInventoryConditionUseForm;
...
@SproutAction(
    path = "/Inventory/InventoryConditionUse/Delete",
...
public class DeleteAction
    ...
    throws Exception {
        ...
        try {
            DeleteInventoryConditionUseForm commandForm = InventoryUtil.getHome().getDeleteInventoryConditionUseForm();
            ...
            InventoryUtil.getHome().deleteInventoryConditionUse(getUserVisitPK(request), commandForm);
