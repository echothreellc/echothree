...
import com.echothree.control.user.customer.remote.form.SetDefaultCustomerTypePaymentMethodForm;
...
@SproutAction(
    path = "/Customer/CustomerTypePaymentMethod/SetDefault",
...
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            ...
            CustomerUtil.getHome().setDefaultCustomerTypePaymentMethod(getUserVisitPK(request), commandForm);
