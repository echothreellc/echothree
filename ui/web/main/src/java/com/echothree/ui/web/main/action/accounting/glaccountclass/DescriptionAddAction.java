    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    var commandForm = AccountingUtil.getHome().getCreateGlAccountClassDescriptionForm();
                    ...
                    var commandResult = AccountingUtil.getHome().createGlAccountClassDescription(getUserVisitPK(request), commandForm);
