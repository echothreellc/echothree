...
@SproutAction(
    path = "/Accounting/GlAccountClass/DescriptionAdd",
    mappingClass = SecureActionMapping.class,
    name = "GlAccountClassDescriptionAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Accounting/GlAccountClass/Description", redirect = true),
        @SproutForward(name = "Form", path = "/accounting/glaccountclass/descriptionAdd.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreateGlAccountClassDescriptionForm commandForm = AccountingUtil.getHome().getCreateGlAccountClassDescriptionForm();
                    ...
                    CommandResult commandResult = AccountingUtil.getHome().createGlAccountClassDescription(getUserVisitPK(request), commandForm);
