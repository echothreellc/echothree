...
@SproutAction(
    path = "/Item/ItemDescriptionType/DescriptionAdd",
    mappingClass = SecureActionMapping.class,
    name = "ItemDescriptionTypeDescriptionAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Item/ItemDescriptionType/Description", redirect = true),
        @SproutForward(name = "Form", path = "/item/itemdescriptiontype/descriptionAdd.jsp")
    }
)
public class DescriptionAddAction
    ...
    public CommandResult doAdd(DescriptionAddActionForm actionForm, HttpServletRequest request)
            throws NamingException {
        CreateItemDescriptionTypeDescriptionForm commandForm = ItemUtil.getHome().getCreateItemDescriptionTypeDescriptionForm();

        commandForm.setItemDescriptionTypeName( actionForm.getItemDescriptionTypeName());
        commandForm.setLanguageIsoName(actionForm.getLanguageChoice());
        commandForm.setDescription(actionForm.getDescription());

        return ItemUtil.getHome().createItemDescriptionTypeDescription(getUserVisitPK(request), commandForm);
    }
