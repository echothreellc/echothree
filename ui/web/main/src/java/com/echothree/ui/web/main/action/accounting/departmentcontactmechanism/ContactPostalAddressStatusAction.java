...
import com.echothree.control.user.contact.remote.form.SetPostalAddressStatusForm;
...
@SproutAction(
    path = "/Accounting/DepartmentContactMechanism/ContactPostalAddressStatus",
    mappingClass = SecureActionMapping.class,
    name = "DepartmentContactPostalAddressStatus",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Accounting/DepartmentContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/accounting/departmentcontactmechanism/contactPostalAddressStatus.jsp")
    }
)
public class ContactPostalAddressStatusAction
        extends BaseDepartmentContactMechanismAction<ContactPostalAddressStatusActionForm> {
