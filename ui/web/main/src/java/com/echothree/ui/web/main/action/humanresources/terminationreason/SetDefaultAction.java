...
import com.echothree.control.user.employee.common.form.SetDefaultTerminationReasonForm;
...
@SproutAction(
    path = "/HumanResources/TerminationReason/SetDefault",
...
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            ...
            EmployeeUtil.getHome().setDefaultTerminationReason(getUserVisitPK(request), commandForm);
