...
import com.echothree.control.user.user.remote.form.SetDefaultRecoveryQuestionForm;
...
@SproutAction(
    path = "/Configuration/RecoveryQuestion/SetDefault",
...
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            ...
            UserUtil.getHome().setDefaultRecoveryQuestion(getUserVisitPK(request), commandForm);
