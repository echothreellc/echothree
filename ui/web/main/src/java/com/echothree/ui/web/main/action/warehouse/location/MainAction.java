...
import com.echothree.control.user.warehouse.remote.form.GetLocationsForm;
import com.echothree.control.user.warehouse.remote.result.GetLocationsResult;
...
@SproutAction(
    path = "/Warehouse/Location/Main",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/warehouse/location/main.jsp")
    }
)
