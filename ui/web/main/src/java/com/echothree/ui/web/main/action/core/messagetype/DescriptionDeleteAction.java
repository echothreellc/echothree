...
import com.echothree.control.user.message.remote.form.DeleteMessageTypeDescriptionForm;
...
@SproutAction(
    path = "/Core/MessageType/DescriptionDelete",
...
public class DescriptionDeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            DeleteMessageTypeDescriptionForm commandForm = MessageUtil.getHome().getDeleteMessageTypeDescriptionForm();
            ...
            MessageUtil.getHome().deleteMessageTypeDescription(getUserVisitPK(request), commandForm);
