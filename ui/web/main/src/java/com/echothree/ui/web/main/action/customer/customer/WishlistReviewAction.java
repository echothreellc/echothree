...
import com.echothree.control.user.wishlist.remote.form.GetWishlistLinesForm;
import com.echothree.control.user.wishlist.remote.result.GetWishlistLinesResult;
...
@SproutAction(
    path = "/Customer/Customer/WishlistReview",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/customer/customer/wishlistReview.jsp")
    }
)
public class WishlistReviewAction
    ...
    throws Exception {
        ...
        try {
            ...
            request.setAttribute(AttributeConstants.WISHLIST_NAME, wishlistName);
