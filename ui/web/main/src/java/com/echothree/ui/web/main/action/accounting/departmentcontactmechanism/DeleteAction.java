...
@SproutAction(
    path = "/Accounting/DepartmentContactMechanism/Delete",
    mappingClass = SecureActionMapping.class,
    name = "DepartmentContactMechanismDelete",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Accounting/DepartmentContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/accounting/departmentcontactmechanism/delete.jsp")
    }
)
public class DeleteAction
    ...
    public void setupTransfer(DeleteActionForm actionForm, HttpServletRequest request)
        ...
        BaseDepartmentContactMechanismAction.setupPartyContactMechanismTransfer(request, actionForm.getPartyName(), actionForm.getContactMechanismName());
