...
import com.echothree.control.user.offer.remote.form.GetOfferCustomerTypesForm;
import com.echothree.control.user.offer.remote.result.GetOfferCustomerTypesResult;
...
@SproutAction(
    path = "/Advertising/OfferCustomerType/Main",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/advertising/offercustomertype/main.jsp")
    }
)
