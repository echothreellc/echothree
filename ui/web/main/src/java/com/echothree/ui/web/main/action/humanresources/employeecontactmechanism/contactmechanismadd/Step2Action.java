...
@SproutAction(
    path = "/HumanResources/EmployeeContactMechanism/ContactMechanismAdd/Step2",
    mappingClass = SecureActionMapping.class,
    name = "EmployeeContactMechanismAddStep2",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "POSTAL_ADDRESS", path = "/action/HumanResources/EmployeeContactMechanism/ContactMechanismAdd/ContactPostalAddressAdd", redirect = true),
        @SproutForward(name = "TELECOM_ADDRESS", path = "/action/HumanResources/EmployeeContactMechanism/ContactMechanismAdd/ContactTelephoneAdd", redirect = true),
        @SproutForward(name = "Form", path = "/humanresources/employeecontactmechanism/contactmechanismadd/step2.jsp")
    }
)
public class Step2Action
        extends BaseEmployeeContactMechanismAction<Step2ActionForm> {
