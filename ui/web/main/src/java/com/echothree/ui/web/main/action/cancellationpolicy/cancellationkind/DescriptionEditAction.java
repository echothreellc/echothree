    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                var commandForm = CancellationPolicyUtil.getHome().getEditCancellationKindDescriptionForm();
                var spec = CancellationPolicyUtil.getHome().getCancellationKindDescriptionSpec();
                ...
                if(wasPost(request)) {
                    var edit = CancellationPolicyUtil.getHome().getCancellationKindDescriptionEdit();
                    
                    commandForm.setEditMode(EditMode.UPDATE);
                    commandForm.setEdit(edit);
                    edit.setDescription(actionForm.getDescription());

                    var commandResult = CancellationPolicyUtil.getHome().editCancellationKindDescription(getUserVisitPK(request), commandForm);
                    
                    if(commandResult.hasErrors()) {
                        var executionResult = commandResult.getExecutionResult();
                        
                        if(executionResult != null) {
                            var result = (EditCancellationKindDescriptionResult)executionResult.getResult();
