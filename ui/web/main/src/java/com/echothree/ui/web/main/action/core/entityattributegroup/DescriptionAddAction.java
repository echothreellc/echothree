...
import com.echothree.control.user.core.remote.form.CreateEntityAttributeGroupDescriptionForm;
import com.echothree.control.user.core.remote.form.GetEntityAttributeGroupForm;
import com.echothree.control.user.core.remote.result.GetEntityAttributeGroupResult;
...
@SproutAction(
    path = "/Core/EntityAttributeGroup/DescriptionAdd",
    mappingClass = SecureActionMapping.class,
    name = "EntityAttributeGroupDescriptionAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Core/EntityAttributeGroup/Description", redirect = true),
        @SproutForward(name = "Form", path = "/core/entityattributegroup/descriptionAdd.jsp")
    }
)
public class DescriptionAddAction
    ...
    public CommandResult doAdd(DescriptionAddActionForm actionForm, HttpServletRequest request)
        ...
        return CoreUtil.getHome().createEntityAttributeGroupDescription(getUserVisitPK(request), commandForm);
    }
