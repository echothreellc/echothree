...
@SproutAction(
    path = "/Inventory/InventoryConditionUse/SetDefault",
...
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            SetDefaultInventoryConditionUseForm commandForm = InventoryUtil.getHome().getSetDefaultInventoryConditionUseForm();
            ...
            InventoryUtil.getHome().setDefaultInventoryConditionUse(getUserVisitPK(request), commandForm);
