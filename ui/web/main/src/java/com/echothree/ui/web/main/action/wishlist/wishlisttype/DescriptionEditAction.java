    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                var commandForm = WishlistUtil.getHome().getEditWishlistTypeDescriptionForm();
                var spec = WishlistUtil.getHome().getWishlistTypeDescriptionSpec();
                ...
                if(wasPost(request)) {
                    var edit = WishlistUtil.getHome().getWishlistTypeDescriptionEdit();
                    
                    commandForm.setEditMode(EditMode.UPDATE);
                    commandForm.setEdit(edit);
                    edit.setDescription(actionForm.getDescription());

                    var commandResult = WishlistUtil.getHome().editWishlistTypeDescription(getUserVisitPK(request), commandForm);
                    
                    if(commandResult.hasErrors()) {
                        var executionResult = commandResult.getExecutionResult();
                        
                        if(executionResult != null) {
                            var result = (EditWishlistTypeDescriptionResult)executionResult.getResult();
