...
@SproutAction(
    path = "/HumanResources/EmployeeContactMechanism/ContactMechanismAdd/ContactWebAddressAdd",
    mappingClass = SecureActionMapping.class,
    name = "EmployeeContactWebAddressAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/HumanResources/EmployeeContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/humanresources/employeecontactmechanism/contactmechanismadd/contactWebAddressAdd.jsp")
    }
)
public class ContactWebAddressAddAction
        extends BaseEmployeeContactMechanismAction<ContactWebAddressAddActionForm> {
