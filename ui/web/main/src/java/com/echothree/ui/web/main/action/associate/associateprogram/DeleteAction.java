...
import com.echothree.control.user.associate.remote.form.DeleteAssociateProgramForm;
...
@SproutAction(
    path = "/Associate/AssociateProgram/Delete",
...
public class DeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            AssociateUtil.getHome().deleteAssociateProgram(getUserVisitPK(request), commandForm);
