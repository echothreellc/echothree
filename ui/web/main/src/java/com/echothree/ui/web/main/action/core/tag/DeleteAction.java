...
import com.echothree.control.user.tag.remote.form.DeleteTagForm;
import com.echothree.control.user.tag.remote.form.GetTagForm;
import com.echothree.control.user.tag.remote.result.GetTagResult;
...
@SproutAction(
    ...
    forwards = {
        ...
        @SproutForward(name = "Form", path = "/core/tag/delete.jsp")
    }
)
public class DeleteAction
    ...
    public CommandResult doDelete(DeleteActionForm actionForm, HttpServletRequest request)
        ...
        return TagUtil.getHome().deleteTag(getUserVisitPK(request), commandForm);
    }
