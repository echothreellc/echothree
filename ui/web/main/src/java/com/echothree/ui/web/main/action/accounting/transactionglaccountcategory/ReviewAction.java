...
@SproutAction(
    path = "/Accounting/TransactionGlAccountCategory/Review",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/accounting/transactionglaccountcategory/review.jsp")
    }
)
public class ReviewAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        if(transactionGlAccountCategory == null) {
            ...
            request.setAttribute(AttributeConstants.TRANSACTION_GL_ACCOUNT_CATEGORY, transactionGlAccountCategory);
