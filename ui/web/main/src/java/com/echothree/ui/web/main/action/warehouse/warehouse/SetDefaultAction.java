...
import com.echothree.control.user.warehouse.remote.form.SetDefaultWarehouseForm;
...
@SproutAction(
    path = "/Warehouse/Warehouse/SetDefault",
...
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            ...
            WarehouseUtil.getHome().setDefaultWarehouse(getUserVisitPK(request), commandForm);
