...
import com.echothree.control.user.core.remote.form.GetApplicationEditorChoicesForm;
import com.echothree.control.user.core.remote.result.GetApplicationEditorChoicesResult;
    ...
    private void setupDefaultApplicationEditorChoices() {
        if(defaultApplicationEditorChoices == null) {
            try {
                ...
                ne.printStackTrace();
                // failed, defaultApplicationDefaultApplicationEditorChoices remains null, no default
            }
        }
    }
