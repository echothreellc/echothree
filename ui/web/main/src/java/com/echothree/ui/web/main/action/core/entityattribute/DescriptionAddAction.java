    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    var commandForm = CoreUtil.getHome().getCreateEntityAttributeDescriptionForm();
                    ...
                    var commandResult = CoreUtil.getHome().createEntityAttributeDescription(getUserVisitPK(request), commandForm);
