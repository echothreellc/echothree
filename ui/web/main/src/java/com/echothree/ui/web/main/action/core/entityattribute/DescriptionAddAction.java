...
@SproutAction(
    path = "/Core/EntityAttribute/DescriptionAdd",
    mappingClass = SecureActionMapping.class,
    name = "CoreEntityAttributeDescriptionAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Core/EntityAttribute/Description", redirect = true),
        @SproutForward(name = "Form", path = "/core/entityattribute/descriptionAdd.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreateEntityAttributeDescriptionForm commandForm = CoreUtil.getHome().getCreateEntityAttributeDescriptionForm();
                    ...
                    CommandResult commandResult = CoreUtil.getHome().createEntityAttributeDescription(getUserVisitPK(request), commandForm);
