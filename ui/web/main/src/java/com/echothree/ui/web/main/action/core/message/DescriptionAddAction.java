...
@SproutAction(
    path = "/Core/Message/DescriptionAdd",
    mappingClass = SecureActionMapping.class,
    name = "CoreMessageDescriptionAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Core/Message/Description", redirect = true),
        @SproutForward(name = "Form", path = "/core/message/descriptionAdd.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreateMessageDescriptionForm commandForm = MessageUtil.getHome().getCreateMessageDescriptionForm();
                    ...
                    CommandResult commandResult = MessageUtil.getHome().createMessageDescription(getUserVisitPK(request), commandForm);
