...
@SproutAction(
    path = "/Accounting/CompanyContactMechanism/ContactTelephoneEdit",
    mappingClass = SecureActionMapping.class,
    name = "CompanyContactTelephoneEdit",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Accounting/CompanyContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/accounting/companycontactmechanism/contactTelephoneEdit.jsp")
    }
)
public class ContactTelephoneEditAction
        extends BaseCompanyContactMechanismAction<ContactTelephoneEditActionForm> {
