...
@SproutAction(
    path = "/Accounting/GlAccount/DescriptionAdd",
    mappingClass = SecureActionMapping.class,
    name = "GlAccountDescriptionAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Accounting/GlAccount/Description", redirect = true),
        @SproutForward(name = "Form", path = "/accounting/glaccount/descriptionAdd.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreateGlAccountDescriptionForm commandForm = AccountingUtil.getHome().getCreateGlAccountDescriptionForm();
                    ...
                    CommandResult commandResult = AccountingUtil.getHome().createGlAccountDescription(getUserVisitPK(request), commandForm);
