...
@SproutAction(
    path = "/Advertising/OfferNameElement/DescriptionAdd",
    mappingClass = SecureActionMapping.class,
    name = "OfferNameElementDescriptionAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Advertising/OfferNameElement/Description", redirect = true),
        @SproutForward(name = "Form", path = "/advertising/offernameelement/descriptionAdd.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreateOfferNameElementDescriptionForm commandForm = OfferUtil.getHome().getCreateOfferNameElementDescriptionForm();
                    ...
                    CommandResult commandResult = OfferUtil.getHome().createOfferNameElementDescription(getUserVisitPK(request), commandForm);
