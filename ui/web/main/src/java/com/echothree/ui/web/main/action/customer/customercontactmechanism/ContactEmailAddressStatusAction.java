...
import com.echothree.control.user.contact.remote.form.SetEmailAddressStatusForm;
...
@SproutAction(
    path = "/Customer/CustomerContactMechanism/ContactEmailAddressStatus",
    mappingClass = SecureActionMapping.class,
    name = "CustomerContactEmailAddressStatus",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Customer/CustomerContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/customer/customercontactmechanism/contactEmailAddressStatus.jsp")
    }
)
public class ContactEmailAddressStatusAction
        extends BaseCustomerContactMechanismAction<ContactEmailAddressStatusActionForm> {
