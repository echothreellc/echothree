...
import com.echothree.ui.web.main.action.purchasing.vendorcontactmechanism.BaseVendorContactMechanismAction;
...
@SproutAction(
    path = "/Purchasing/VendorContactMechanism/ContactMechanismAdd/Step2",
    mappingClass = SecureActionMapping.class,
    name = "VendorContactMechanismAddStep2",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "POSTAL_ADDRESS", path = "/action/Purchasing/VendorContactMechanism/ContactMechanismAdd/ContactPostalAddressAdd", redirect = true),
        @SproutForward(name = "TELECOM_ADDRESS", path = "/action/Purchasing/VendorContactMechanism/ContactMechanismAdd/ContactTelephoneAdd", redirect = true),
        @SproutForward(name = "Form", path = "/purchasing/vendorcontactmechanism/contactmechanismadd/step2.jsp")
    }
)
public class Step2Action
        extends BaseVendorContactMechanismAction<Step2ActionForm> {
