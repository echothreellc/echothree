...
@SproutAction(
    path = "/Configuration/WorkflowEntrance/DescriptionDelete",
...
public class DescriptionDeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            DeleteWorkflowEntranceDescriptionForm commandForm = WorkflowUtil.getHome().getDeleteWorkflowEntranceDescriptionForm();
            
            commandForm.setWorkflowName(workflowName);
            commandForm.setWorkflowEntranceName(workflowEntranceName);
            commandForm.setLanguageIsoName(languageIsoName);
            
            WorkflowUtil.getHome().deleteWorkflowEntranceDescription(getUserVisitPK(request), commandForm);
