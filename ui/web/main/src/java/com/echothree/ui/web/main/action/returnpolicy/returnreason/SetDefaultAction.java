...
@SproutAction(
    path = "/ReturnPolicy/ReturnReason/SetDefault",
...
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            SetDefaultReturnReasonForm commandForm = ReturnPolicyUtil.getHome().getSetDefaultReturnReasonForm();
            ...
            ReturnPolicyUtil.getHome().setDefaultReturnReason(getUserVisitPK(request), commandForm);
