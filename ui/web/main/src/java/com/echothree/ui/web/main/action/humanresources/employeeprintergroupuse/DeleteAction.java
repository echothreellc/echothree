...
@SproutAction(
    path = "/HumanResources/EmployeePrinterGroupUse/Delete",
    ...
    forwards = {
        ...
        @SproutForward(name = "Form", path = "/humanresources/employeeprintergroupuse/delete.jsp")
    }
)
public class DeleteAction
    ...
    public void setupTransfer(DeleteActionForm actionForm, HttpServletRequest request)
        ...
        BaseEmployeePrinterGroupUseAction.setupPartyPrinterGroupUseTransfer(request, actionForm.getPartyName(), actionForm.getPrinterGroupUseTypeName());
