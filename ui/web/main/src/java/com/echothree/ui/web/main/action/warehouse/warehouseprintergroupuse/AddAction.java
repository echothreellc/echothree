...
@SproutAction(
    path = "/Warehouse/WarehousePrinterGroupUse/Add",
    mappingClass = SecureActionMapping.class,
    name = "WarehousePrinterGroupUseAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Warehouse/WarehousePrinterGroupUse/Main", redirect = true),
        @SproutForward(name = "Form", path = "/warehouse/warehouseprintergroupuse/add.jsp")
    }
)
public class AddAction
    ...
    public void setupTransfer(AddActionForm actionForm, HttpServletRequest request)
        ...
        BaseWarehousePrinterGroupUseAction.setupWarehouse(request, actionForm.getPartyName());
    }
    ...
    public CommandResult doAdd(AddActionForm actionForm, HttpServletRequest request)
        ...
        return PrinterUtil.getHome().createPartyPrinterGroupUse(getUserVisitPK(request), commandForm);
    }
