    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    var commandForm = EmployeeUtil.getHome().getCreateSkillTypeDescriptionForm();
                    ...
                    var commandResult = EmployeeUtil.getHome().createSkillTypeDescription(getUserVisitPK(request), commandForm);
