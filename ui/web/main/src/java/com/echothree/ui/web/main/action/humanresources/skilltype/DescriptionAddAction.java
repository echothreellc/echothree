...
@SproutAction(
    path = "/HumanResources/SkillType/DescriptionAdd",
    mappingClass = SecureActionMapping.class,
    name = "SkillTypeDescriptionAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/HumanResources/SkillType/Description", redirect = true),
        @SproutForward(name = "Form", path = "/humanresources/skilltype/descriptionAdd.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreateSkillTypeDescriptionForm commandForm = EmployeeUtil.getHome().getCreateSkillTypeDescriptionForm();
                    ...
                    CommandResult commandResult = EmployeeUtil.getHome().createSkillTypeDescription(getUserVisitPK(request), commandForm);
