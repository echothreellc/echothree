...
@SproutAction(
    path = "/Shipping/Carrier/SetDefault",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Shipping/Carrier/Main", redirect = true)
    }
)
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            ...
            CarrierUtil.getHome().setDefaultCarrier(getUserVisitPK(request), commandForm);
