...
@SproutAction(
    path = "/Item/ItemUnitOfMeasureType/Delete",
    mappingClass = SecureActionMapping.class,
    name = "ItemUnitOfMeasureTypeDelete",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Item/ItemUnitOfMeasureType/Main", redirect = true),
        @SproutForward(name = "Form", path = "/item/itemunitofmeasuretype/delete.jsp")
    }
)
public class DeleteAction
    ...
    public String getEntityTypeName(final DeleteActionForm actionForm) {
        return EntityTypes.ItemUnitOfMeasureType.name();
    }
    ...
    public CommandResult doDelete(DeleteActionForm actionForm, HttpServletRequest request)
        ...
        return ItemUtil.getHome().deleteItemUnitOfMeasureType(getUserVisitPK(request), commandForm);
    }
