...
import com.echothree.control.user.content.remote.form.CreateContentForumForm;
...
@SproutAction(
    path = "/Content/ContentForum/Add",
    mappingClass = SecureActionMapping.class,
    name = "ContentForumAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Content/ContentForum/Main", redirect = true),
        @SproutForward(name = "Form", path = "/content/contentforum/add.jsp")
    }
)
