...
import com.echothree.control.user.item.common.form.GetHarmonizedTariffScheduleCodeUnitDescriptionForm;
import com.echothree.control.user.item.common.result.GetHarmonizedTariffScheduleCodeUnitDescriptionResult;
...
@SproutAction(
    path = "/Item/HarmonizedTariffScheduleCodeUnit/DescriptionDelete",
    mappingClass = SecureActionMapping.class,
    name = "HarmonizedTariffScheduleCodeUnitDescriptionDelete",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Item/HarmonizedTariffScheduleCodeUnit/Description", redirect = true),
        @SproutForward(name = "Form", path = "/item/harmonizedtariffschedulecodeunit/descriptionDelete.jsp")
    }
)
public class DescriptionDeleteAction
    ...
    public String getEntityTypeName() {
        return EntityTypes.HarmonizedTariffScheduleCodeUnitDescription.name();
    }
    ...
    public CommandResult doDelete(DescriptionDeleteActionForm actionForm, HttpServletRequest request)
        ...
        return ItemUtil.getHome().deleteHarmonizedTariffScheduleCodeUnitDescription(getUserVisitPK(request), commandForm);
    }
