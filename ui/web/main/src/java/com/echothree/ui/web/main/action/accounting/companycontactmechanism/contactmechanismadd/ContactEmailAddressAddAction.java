...
@SproutAction(
    path = "/Accounting/CompanyContactMechanism/ContactMechanismAdd/ContactEmailAddressAdd",
    mappingClass = SecureActionMapping.class,
    name = "CompanyContactEmailAddressAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Accounting/CompanyContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/accounting/companycontactmechanism/contactmechanismadd/contactEmailAddressAdd.jsp")
    }
)
public class ContactEmailAddressAddAction
        extends BaseCompanyContactMechanismAction<ContactEmailAddressAddActionForm> {
