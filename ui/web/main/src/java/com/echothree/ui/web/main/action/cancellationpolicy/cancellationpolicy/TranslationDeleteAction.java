...
@SproutAction(
    path = "/CancellationPolicy/CancellationPolicy/TranslationDelete",
...
public class TranslationDeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            DeleteCancellationPolicyTranslationForm commandForm = CancellationPolicyUtil.getHome().getDeleteCancellationPolicyTranslationForm();
            ...
            CancellationPolicyUtil.getHome().deleteCancellationPolicyTranslation(getUserVisitPK(request), commandForm);
