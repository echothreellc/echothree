...
@SproutAction(
    path = "/Customer/CustomerContactList/Add",
    mappingClass = SecureActionMapping.class,
    name = "CustomerContactListAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Customer/CustomerContactList/Main", redirect = true),
        @SproutForward(name = "Form", path = "/customer/customercontactlist/add.jsp")
    }
)
public class AddAction
    ...
    public CommandResult doAdd(AddActionForm actionForm, HttpServletRequest request)
        ...
        commandForm.setPreferredContactMechanismPurposeName(actionForm.getPreferredContactMechanismPurposeChoice());

        return ContactListUtil.getHome().createPartyContactList(getUserVisitPK(request), commandForm);
    }
