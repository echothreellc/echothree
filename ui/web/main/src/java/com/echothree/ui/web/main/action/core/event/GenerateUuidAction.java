...
import com.echothree.control.user.core.common.result.GenerateUuidResult;
...
public class GenerateUuidAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        var commandForm = CoreUtil.getHome().getGenerateUuidForm();
        var entityRef = request.getParameter(ParameterConstants.ENTITY_REF);
        var uuid = request.getParameter(ParameterConstants.UUID);
        ...
        var commandResult = CoreUtil.getHome().generateUuid(getUserVisitPK(request), commandForm);

        if(!commandResult.hasErrors()) {
            var executionResult = commandResult.getExecutionResult();
            var result = (GenerateUuidResult)executionResult.getResult();
        ...
        if(forwardKey != null) {
            ...
            parameters.put(ParameterConstants.UUID, uuid);
