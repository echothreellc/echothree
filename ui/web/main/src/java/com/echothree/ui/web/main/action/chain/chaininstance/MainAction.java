...
import com.echothree.control.user.chain.remote.form.GetChainInstancesForm;
import com.echothree.control.user.chain.remote.result.GetChainInstancesResult;
...
@SproutAction(
    path = "/Chain/ChainInstance/Main",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/chain/chaininstance/main.jsp")
    }
)
