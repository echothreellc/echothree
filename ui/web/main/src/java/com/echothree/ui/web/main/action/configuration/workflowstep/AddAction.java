...
import com.echothree.control.user.workflow.remote.form.GetWorkflowForm;
import com.echothree.control.user.workflow.remote.result.GetWorkflowResult;
...
public class AddAction
    ...
    public CommandResult doAdd(AddActionForm actionForm, HttpServletRequest request)
            throws NamingException {
        CreateWorkflowStepForm commandForm = WorkflowUtil.getHome().getCreateWorkflowStepForm();
