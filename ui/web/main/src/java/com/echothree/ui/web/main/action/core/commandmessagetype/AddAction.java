...
@SproutAction(
    path = "/Core/CommandMessageType/Add",
    mappingClass = SecureActionMapping.class,
    name = "CommandMessageTypeAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Core/CommandMessageType/Main", redirect = true),
        @SproutForward(name = "Form", path = "/core/commandmessagetype/add.jsp")
    }
)
public class AddAction
    ...
    public CommandResult doAdd(AddActionForm actionForm, HttpServletRequest request)
        ...
        return CoreUtil.getHome().createCommandMessageType(getUserVisitPK(request), commandForm);
    }
