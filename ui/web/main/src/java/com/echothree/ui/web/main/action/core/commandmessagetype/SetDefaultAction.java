...
import com.echothree.control.user.core.remote.form.SetDefaultCommandMessageTypeForm;
...
@SproutAction(
    path = "/Core/CommandMessageType/SetDefault",
...
public class SetDefaultAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        CoreUtil.getHome().setDefaultCommandMessageType(getUserVisitPK(request), commandForm);
