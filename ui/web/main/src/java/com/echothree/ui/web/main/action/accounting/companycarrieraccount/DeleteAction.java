...
import com.echothree.control.user.carrier.remote.form.DeletePartyCarrierAccountForm;
...
@SproutAction(
    path = "/Accounting/CompanyCarrierAccount/Delete",
    mappingClass = SecureActionMapping.class,
    name = "CompanyCarrierAccountDelete",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Accounting/CompanyCarrierAccount/Main", redirect = true),
        @SproutForward(name = "Form", path = "/accounting/companycarrieraccount/delete.jsp")
    }
)
public class DeleteAction
    ...
    public void setupTransfer(DeleteActionForm actionForm, HttpServletRequest request)
        ...
        BaseCompanyCarrierAccountAction.setupPartyCarrierAccountTransfer(request, actionForm.getPartyName(), actionForm.getCarrierName());
