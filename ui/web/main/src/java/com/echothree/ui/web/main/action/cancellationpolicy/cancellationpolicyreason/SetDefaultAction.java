...
@SproutAction(
    path = "/CancellationPolicy/CancellationPolicyReason/SetDefault",
...
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            SetDefaultCancellationPolicyReasonForm commandForm = CancellationPolicyUtil.getHome().getSetDefaultCancellationPolicyReasonForm();
            ...
            CancellationPolicyUtil.getHome().setDefaultCancellationPolicyReason(getUserVisitPK(request), commandForm);
