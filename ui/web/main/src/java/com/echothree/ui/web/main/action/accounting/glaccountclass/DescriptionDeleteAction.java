...
import com.echothree.control.user.accounting.common.form.DeleteGlAccountClassDescriptionForm;
...
@SproutAction(
    path = "/Accounting/GlAccountClass/DescriptionDelete",
...
public class DescriptionDeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            DeleteGlAccountClassDescriptionForm commandForm = AccountingUtil.getHome().getDeleteGlAccountClassDescriptionForm();
            
            commandForm.setGlAccountClassName(glAccountClassName);
            commandForm.setLanguageIsoName(languageIsoName);
            
            AccountingUtil.getHome().deleteGlAccountClassDescription(getUserVisitPK(request), commandForm);
