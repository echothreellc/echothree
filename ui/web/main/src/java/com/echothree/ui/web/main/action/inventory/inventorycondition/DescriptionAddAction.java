...
@SproutAction(
    path = "/Inventory/InventoryCondition/DescriptionAdd",
    mappingClass = SecureActionMapping.class,
    name = "InventoryConditionDescriptionAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Inventory/InventoryCondition/Description", redirect = true),
        @SproutForward(name = "Form", path = "/inventory/inventorycondition/descriptionAdd.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreateInventoryConditionDescriptionForm commandForm = InventoryUtil.getHome().getCreateInventoryConditionDescriptionForm();
                    ...
                    CommandResult commandResult = InventoryUtil.getHome().createInventoryConditionDescription(getUserVisitPK(request), commandForm);
