...
@SproutAction(
    path = "/Selector/SelectorNode/Add/WorkflowStepStep3",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/selector/selectornode/add/workflowStepStep3.jsp")
    }
)
public class WorkflowStepStep3Action
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute(AttributeConstants.WORKFLOW_STEPS, result.getWorkflowSteps());
