...
@SproutForm(name="ColorEdit")
public class EditActionForm
        extends AddActionForm {
    
    private String originalColorName;
    
    public String getOriginalColorName() {
        return originalColorName;
    }
    
    public void setOriginalColorName(String originalColorName) {
        this.originalColorName = originalColorName;
    }
