...
import com.echothree.control.user.item.remote.form.GetItemAliasTypeDescriptionsForm;
import com.echothree.control.user.item.remote.result.GetItemAliasTypeDescriptionsResult;
...
@SproutAction(
    path = "/Item/ItemAliasType/Description",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/item/itemaliastype/description.jsp")
    }
)
