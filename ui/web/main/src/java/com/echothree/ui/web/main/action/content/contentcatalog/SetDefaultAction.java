...
@SproutAction(
    path = "/Content/ContentCatalog/SetDefault",
...
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            ...
            SetDefaultContentCatalogForm commandForm = ContentUtil.getHome().getSetDefaultContentCatalogForm();
            
            commandForm.setContentCollectionName(contentCollectionName);
            commandForm.setContentCatalogName(contentCatalogName);
            
            ContentUtil.getHome().setDefaultContentCatalog(getUserVisitPK(request), commandForm);
