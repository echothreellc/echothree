...
import com.echothree.control.user.offer.remote.form.GetOfferItemForm;
import com.echothree.control.user.offer.remote.result.GetOfferItemResult;
...
@SproutAction(
    path = "/Advertising/OfferItem/Review",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/advertising/offeritem/review.jsp")
    }
)
