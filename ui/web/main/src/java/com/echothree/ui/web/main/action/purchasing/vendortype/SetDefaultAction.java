...
import com.echothree.control.user.vendor.common.form.SetDefaultVendorTypeForm;
...
@SproutAction(
    path = "/Purchasing/VendorType/SetDefault",
...
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            ...
            VendorUtil.getHome().setDefaultVendorType(getUserVisitPK(request), commandForm);
