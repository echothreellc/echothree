...
@SproutAction(
    path = "/Core/EntityGeoPointAttribute/Delete",
...
public class DeleteAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            DeleteEntityGeoPointAttributeForm commandForm = CoreUtil.getHome().getDeleteEntityGeoPointAttributeForm();
            
            commandForm.setEntityRef(entityRef);
            commandForm.setEntityAttributeName(entityAttributeName);
            
            CoreUtil.getHome().deleteEntityGeoPointAttribute(getUserVisitPK(request), commandForm);
