...
import com.echothree.control.user.content.remote.form.GetContentCategoriesForm;
import com.echothree.control.user.content.remote.result.GetContentCategoriesResult;
...
@SproutAction(
    path = "/Content/ContentCategory/Main",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/content/contentcategory/main.jsp")
    }
)
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        if(!commandResult.hasErrors()) {
            ...
            if(contentCategoryCount != null) {
                request.setAttribute(AttributeConstants.CONTENT_CATEGORY_COUNT, contentCategoryCount.intValue());
            }

            request.setAttribute(AttributeConstants.PARENT_CONTENT_CATEGORY, result.getParentContentCategory());
            request.setAttribute(AttributeConstants.CONTENT_CATEGORIES, new ListWrapper<>(result.getContentCategories()));
