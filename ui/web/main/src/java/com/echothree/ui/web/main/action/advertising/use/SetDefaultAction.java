...
import com.echothree.control.user.offer.remote.form.SetDefaultUseForm;
...
@SproutAction(
    path = "/Advertising/Use/SetDefault",
...
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            ...
            OfferUtil.getHome().setDefaultUse(getUserVisitPK(request), commandForm);
