...
import com.echothree.control.user.item.remote.form.SetDefaultItemImageTypeForm;
...
@SproutAction(
    path = "/Item/ItemImageType/SetDefault",
...
public class SetDefaultAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        ItemUtil.getHome().setDefaultItemImageType(getUserVisitPK(request), commandForm);
