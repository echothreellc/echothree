...
package com.echothree.ui.web.main.action.humanresources.employeedocument.add;
...
import com.echothree.control.user.document.remote.form.GetDocumentTypeForm;
import com.echothree.control.user.document.remote.result.GetDocumentTypeResult;
...
@SproutAction(
    path = "/HumanResources/EmployeeDocument/Add/Step3",
    mappingClass = SecureActionMapping.class,
    name = "EmployeeDocumentAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/HumanResources/EmployeeDocument/Main", redirect = true),
        @SproutForward(name = "Form", path = "/humanresources/employeedocument/add/step3.jsp")
    }
)
public class Step3Action
    ...
    private void setupEmployeeTransfer(Step3ActionForm actionForm, HttpServletRequest request)
            throws NamingException {
    ...
    public void setupTransfer(Step3ActionForm actionForm, HttpServletRequest request)
            throws NamingException {
        setupEmployeeTransfer(actionForm, request);
