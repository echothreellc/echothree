...
import com.echothree.control.user.forum.remote.form.GetForumMimeTypesForm;
import com.echothree.control.user.forum.remote.result.GetForumMimeTypesResult;
...
@SproutAction(
    path = "/Forum/ForumMimeType/Main",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/forum/forummimetype/main.jsp")
    }
)
