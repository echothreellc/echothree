...
import com.echothree.control.user.scale.remote.form.SetDefaultScaleForm;
...
@SproutAction(
    path = "/Configuration/Scale/SetDefault",
...
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            ...
            ScaleUtil.getHome().setDefaultScale(getUserVisitPK(request), commandForm);
