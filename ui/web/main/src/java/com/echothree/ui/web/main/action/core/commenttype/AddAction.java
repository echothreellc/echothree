...
import com.echothree.control.user.comment.remote.form.CreateCommentTypeForm;
...
@SproutAction(
    ...
    forwards = {
        ...
        @SproutForward(name = "Form", path = "/core/commenttype/add.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreateCommentTypeForm commandForm = CommentUtil.getHome().getCreateCommentTypeForm();
                    ...
                    commandForm.setCommentSequenceName(actionForm.getCommentSequenceChoice());
                    commandForm.setMimeTypeUsageTypeName(actionForm.getMimeTypeUsageTypeChoice());
                    commandForm.setSortOrder(actionForm.getSortOrder());
                    commandForm.setDescription(actionForm.getDescription());
                    
                    CommandResult commandResult = CommentUtil.getHome().createCommentType(getUserVisitPK(request), commandForm);
