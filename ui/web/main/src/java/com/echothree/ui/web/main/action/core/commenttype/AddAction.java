    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    var commandForm = CommentUtil.getHome().getCreateCommentTypeForm();
                    ...
                    var commandResult = CommentUtil.getHome().createCommentType(getUserVisitPK(request), commandForm);
