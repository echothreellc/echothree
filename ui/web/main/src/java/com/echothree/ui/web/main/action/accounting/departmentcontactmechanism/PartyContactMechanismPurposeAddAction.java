...
@SproutAction(
    path = "/Accounting/DepartmentContactMechanism/PartyContactMechanismPurposeAdd",
    mappingClass = SecureActionMapping.class,
    name = "DepartmentPartyContactMechanismPurposeAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Accounting/DepartmentContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/accounting/departmentcontactmechanism/partyContactMechanismPurposeAdd.jsp")
    }
)
public class PartyContactMechanismPurposeAddAction
        extends BaseDepartmentContactMechanismAction<PartyContactMechanismPurposeAddActionForm> {
