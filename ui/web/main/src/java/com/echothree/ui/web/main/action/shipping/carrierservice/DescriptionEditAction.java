...
import com.echothree.control.user.carrier.remote.form.EditCarrierServiceDescriptionForm;
import com.echothree.control.user.carrier.remote.result.EditCarrierServiceDescriptionResult;
...
@SproutAction(
    path = "/Shipping/CarrierService/DescriptionEdit",
    mappingClass = SecureActionMapping.class,
    name = "CarrierServiceDescriptionEdit",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Shipping/CarrierService/Description", redirect = true),
        @SproutForward(name = "Form", path = "/shipping/carrierservice/descriptionEdit.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                spec.setCarrierServiceName(carrierServiceName);
