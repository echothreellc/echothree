    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreateCommentUsageTypeForm commandForm = CommentUtil.getHome().getCreateCommentUsageTypeForm();
                    ...
                    CommandResult commandResult = CommentUtil.getHome().createCommentUsageType(getUserVisitPK(request), commandForm);
