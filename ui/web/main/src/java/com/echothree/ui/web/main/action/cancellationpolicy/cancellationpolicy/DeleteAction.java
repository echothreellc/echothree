...
@SproutAction(
    path = "/CancellationPolicy/CancellationPolicy/Delete",
...
public class DeleteAction
    ...
    throws Exception {
        ...
        try {
            DeleteCancellationPolicyForm commandForm = CancellationPolicyUtil.getHome().getDeleteCancellationPolicyForm();
            ...
            CancellationPolicyUtil.getHome().deleteCancellationPolicy(getUserVisitPK(request), commandForm);
