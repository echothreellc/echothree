    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    var commandForm = PrinterUtil.getHome().getCreatePrinterGroupDescriptionForm();
                    ...
                    var commandResult = PrinterUtil.getHome().createPrinterGroupDescription(getUserVisitPK(request), commandForm);
