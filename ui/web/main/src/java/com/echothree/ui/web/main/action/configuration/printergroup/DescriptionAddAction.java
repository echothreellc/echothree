...
@SproutAction(
    path = "/Configuration/PrinterGroup/DescriptionAdd",
    mappingClass = SecureActionMapping.class,
    name = "PrinterGroupDescriptionAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Configuration/PrinterGroup/Description", redirect = true),
        @SproutForward(name = "Form", path = "/configuration/printergroup/descriptionAdd.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreatePrinterGroupDescriptionForm commandForm = PrinterUtil.getHome().getCreatePrinterGroupDescriptionForm();
                    ...
                    CommandResult commandResult = PrinterUtil.getHome().createPrinterGroupDescription(getUserVisitPK(request), commandForm);
