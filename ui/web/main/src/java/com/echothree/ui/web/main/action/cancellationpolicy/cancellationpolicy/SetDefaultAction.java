...
import com.echothree.control.user.cancellationpolicy.common.form.SetDefaultCancellationPolicyForm;
...
@SproutAction(
    path = "/CancellationPolicy/CancellationPolicy/SetDefault",
...
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            SetDefaultCancellationPolicyForm commandForm = CancellationPolicyUtil.getHome().getSetDefaultCancellationPolicyForm();
            ...
            CancellationPolicyUtil.getHome().setDefaultCancellationPolicy(getUserVisitPK(request), commandForm);
