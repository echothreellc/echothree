...
import com.echothree.control.user.payment.remote.form.SetDefaultPaymentMethodForm;
...
@SproutAction(
    path = "/Payment/PaymentMethod/SetDefault",
...
public class SetDefaultAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        PaymentUtil.getHome().setDefaultPaymentMethod(getUserVisitPK(request), commandForm);
