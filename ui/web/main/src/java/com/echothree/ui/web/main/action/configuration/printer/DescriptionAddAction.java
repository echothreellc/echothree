...
import com.echothree.control.user.printer.remote.form.CreatePrinterDescriptionForm;
...
@SproutAction(
    path = "/Configuration/Printer/DescriptionAdd",
    mappingClass = SecureActionMapping.class,
    name = "PrinterDescriptionAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Configuration/Printer/Description", redirect = true),
        @SproutForward(name = "Form", path = "/configuration/printer/descriptionAdd.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreatePrinterDescriptionForm commandForm = PrinterUtil.getHome().getCreatePrinterDescriptionForm();
                    ...
                    CommandResult commandResult = PrinterUtil.getHome().createPrinterDescription(getUserVisitPK(request), commandForm);
