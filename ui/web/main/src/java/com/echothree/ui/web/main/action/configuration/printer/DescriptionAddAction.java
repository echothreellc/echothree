    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    var commandForm = PrinterUtil.getHome().getCreatePrinterDescriptionForm();
                    ...
                    var commandResult = PrinterUtil.getHome().createPrinterDescription(getUserVisitPK(request), commandForm);
