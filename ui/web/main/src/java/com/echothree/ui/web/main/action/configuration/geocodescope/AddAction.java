...
@SproutAction(
    path = "/Configuration/GeoCodeScope/Add",
    mappingClass = SecureActionMapping.class,
    name = "GeoCodeScopeAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Configuration/GeoCodeScope/Main", redirect = true),
        @SproutForward(name = "Form", path = "/configuration/geocodescope/add.jsp")
    }
)
public class AddAction
    ...
    public CommandResult doAdd(AddActionForm actionForm, HttpServletRequest request)
        ...
        return GeoUtil.getHome().createGeoCodeScope(getUserVisitPK(request), commandForm);
    }
