...
import com.echothree.control.user.term.remote.form.DeleteTermForm;
...
public class DeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            TermUtil.getHome().deleteTerm(getUserVisitPK(request), commandForm);
