...
@SproutAction(
    path = "/Accounting/CompanyContactMechanism/ContactPostalAddressStatus",
    mappingClass = SecureActionMapping.class,
    name = "CompanyContactPostalAddressStatus",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Accounting/CompanyContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/accounting/companycontactmechanism/contactPostalAddressStatus.jsp")
    }
)
public class ContactPostalAddressStatusAction
        extends BaseCompanyContactMechanismAction<ContactPostalAddressStatusActionForm> {
