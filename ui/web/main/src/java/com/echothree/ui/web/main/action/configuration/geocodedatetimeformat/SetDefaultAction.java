...
@SproutAction(
    path = "/Configuration/GeoCodeDateTimeFormat/SetDefault",
...
public class SetDefaultAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            SetDefaultGeoCodeDateTimeFormatForm commandForm = GeoUtil.getHome().getSetDefaultGeoCodeDateTimeFormatForm();
            ...
            GeoUtil.getHome().setDefaultGeoCodeDateTimeFormat(getUserVisitPK(request), commandForm);
