...
import com.echothree.control.user.uom.remote.form.SetDefaultUnitOfMeasureKindForm;
...
@SproutAction(
    path = "/UnitOfMeasure/UnitOfMeasureKind/SetDefault",
...
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            ...
            SetDefaultUnitOfMeasureKindForm commandForm = UomUtil.getHome().getSetDefaultUnitOfMeasureKindForm();
            
            commandForm.setUnitOfMeasureKindName(unitOfMeasureKindName);
            
            UomUtil.getHome().setDefaultUnitOfMeasureKind(getUserVisitPK(request), commandForm);
