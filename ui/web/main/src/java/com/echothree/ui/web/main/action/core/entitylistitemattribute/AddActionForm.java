...
import com.echothree.control.user.core.remote.form.GetEntityListItemChoicesForm;
import com.echothree.control.user.core.remote.result.GetEntityListItemChoicesResult;
...
@SproutForm(name="EntityListItemAttributeAdd")
