...
import com.echothree.control.user.party.remote.form.SetDefaultNameSuffixForm;
...
@SproutAction(
    path = "/Configuration/NameSuffix/SetDefault",
...
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            ...
            PartyUtil.getHome().setDefaultNameSuffix(getUserVisitPK(request), commandForm);
