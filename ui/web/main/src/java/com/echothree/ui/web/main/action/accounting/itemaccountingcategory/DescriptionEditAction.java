...
@SproutAction(
    path = "/Accounting/ItemAccountingCategory/DescriptionEdit",
    mappingClass = SecureActionMapping.class,
    name = "ItemAccountingCategoryDescriptionEdit",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Accounting/ItemAccountingCategory/Description", redirect = true),
        @SproutForward(name = "Form", path = "/accounting/itemaccountingcategory/descriptionEdit.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                spec.setItemAccountingCategoryName(itemAccountingCategoryName);
