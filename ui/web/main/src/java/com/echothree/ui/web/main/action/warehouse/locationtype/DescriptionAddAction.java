...
@SproutAction(
    path = "/Warehouse/LocationType/DescriptionAdd",
    mappingClass = SecureActionMapping.class,
    name = "LocationTypeDescriptionAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Warehouse/LocationType/Description", redirect = true),
        @SproutForward(name = "Form", path = "/warehouse/locationtype/descriptionAdd.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreateLocationTypeDescriptionForm commandForm = WarehouseUtil.getHome().getCreateLocationTypeDescriptionForm();
                    ...
                    CommandResult commandResult = WarehouseUtil.getHome().createLocationTypeDescription(getUserVisitPK(request), commandForm);
