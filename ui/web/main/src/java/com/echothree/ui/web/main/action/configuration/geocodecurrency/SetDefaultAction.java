...
import com.echothree.control.user.geo.remote.form.SetDefaultGeoCodeCurrencyForm;
...
@SproutAction(
    path = "/Configuration/GeoCodeCurrency/SetDefault",
...
public class SetDefaultAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            SetDefaultGeoCodeCurrencyForm commandForm = GeoUtil.getHome().getSetDefaultGeoCodeCurrencyForm();
            ...
            GeoUtil.getHome().setDefaultGeoCodeCurrency(getUserVisitPK(request), commandForm);
