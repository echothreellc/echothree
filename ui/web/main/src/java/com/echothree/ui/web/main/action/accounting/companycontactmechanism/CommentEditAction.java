...
@SproutAction(
    path = "/Accounting/CompanyContactMechanism/CommentEdit",
    mappingClass = SecureActionMapping.class,
    name = "CompanyContactMechanismCommentEdit",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Accounting/CompanyContactMechanism/Review", redirect = true),
        @SproutForward(name = "Form", path = "/accounting/companycontactmechanism/commentEdit.jsp")
    }
)
