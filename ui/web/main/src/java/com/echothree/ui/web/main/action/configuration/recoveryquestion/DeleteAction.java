...
import com.echothree.control.user.user.remote.form.DeleteRecoveryQuestionForm;
...
@SproutAction(
    path = "/Configuration/RecoveryQuestion/Delete",
...
public class DeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            UserUtil.getHome().deleteRecoveryQuestion(getUserVisitPK(request), commandForm);
