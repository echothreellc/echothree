...
import com.echothree.control.user.filter.remote.form.DeleteFilterAdjustmentForm;
...
@SproutAction(
    path = "/Filter/FilterAdjustment/Delete",
...
public class DeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            FilterUtil.getHome().deleteFilterAdjustment(getUserVisitPK(request), deleteFilterAdjustmentForm);
