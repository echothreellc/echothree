...
import com.echothree.control.user.core.remote.form.GetMimeTypeUsagesForm;
import com.echothree.control.user.core.remote.result.GetMimeTypeUsagesResult;
...
@SproutAction(
    path = "/Core/MimeTypeUsage/Main",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/core/mimetypeusage/main.jsp")
    }
)
