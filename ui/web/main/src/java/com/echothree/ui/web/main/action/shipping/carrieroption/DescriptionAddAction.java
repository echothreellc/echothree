...
import com.echothree.control.user.carrier.remote.form.CreateCarrierOptionDescriptionForm;
...
@SproutAction(
    path = "/Shipping/CarrierOption/DescriptionAdd",
    mappingClass = SecureActionMapping.class,
    name = "CarrierOptionDescriptionAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Shipping/CarrierOption/Description", redirect = true),
        @SproutForward(name = "Form", path = "/shipping/carrieroption/descriptionAdd.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreateCarrierOptionDescriptionForm commandForm = CarrierUtil.getHome().getCreateCarrierOptionDescriptionForm();
                    ...
                    CommandResult commandResult = CarrierUtil.getHome().createCarrierOptionDescription(getUserVisitPK(request), commandForm);
