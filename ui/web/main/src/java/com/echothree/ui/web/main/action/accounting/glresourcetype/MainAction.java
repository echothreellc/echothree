...
import com.echothree.control.user.accounting.remote.result.GetGlResourceTypesResult;
...
@SproutAction(
    path = "/Accounting/GlResourceType/Main",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/accounting/glresourcetype/main.jsp")
    }
)
