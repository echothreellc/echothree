...
import com.echothree.control.user.core.remote.form.GetProtocolChoicesForm;
import com.echothree.control.user.core.remote.result.GetProtocolChoicesResult;
...
@SproutForm(name="ServiceAdd")
public class AddActionForm
        extends BaseActionForm {
    
    private ProtocolChoicesBean protocolChoices;

    private String serviceName;
    private String port;
    private String protocolChoice;
   ...
   public void setServiceName(String serviceName) {
    ...
    public List<LabelValueBean> getProtocolChoices() {
        ...
        setupProtocolChoices();
        if(protocolChoices != null) {
            choices = convertChoices(protocolChoices);
        }
