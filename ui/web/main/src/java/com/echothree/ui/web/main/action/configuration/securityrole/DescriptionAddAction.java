...
import com.echothree.control.user.security.remote.form.GetSecurityRoleForm;
import com.echothree.control.user.security.remote.result.GetSecurityRoleResult;
...
public class DescriptionAddAction
    ...
    public CommandResult doAdd(DescriptionAddActionForm actionForm, HttpServletRequest request)
            throws NamingException {
        CreateSecurityRoleDescriptionForm commandForm = SecurityUtil.getHome().getCreateSecurityRoleDescriptionForm();
