    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    var commandForm = InventoryUtil.getHome().getCreateInventoryLocationGroupDescriptionForm();
                    ...
                    var commandResult = InventoryUtil.getHome().createInventoryLocationGroupDescription(getUserVisitPK(request), commandForm);
