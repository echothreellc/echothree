...
@SproutAction(
    path = "/Inventory/InventoryLocationGroup/DescriptionAdd",
    mappingClass = SecureActionMapping.class,
    name = "InventoryLocationGroupDescriptionAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Inventory/InventoryLocationGroup/Description", redirect = true),
        @SproutForward(name = "Form", path = "/inventory/inventorylocationgroup/descriptionAdd.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreateInventoryLocationGroupDescriptionForm commandForm = InventoryUtil.getHome().getCreateInventoryLocationGroupDescriptionForm();
                    ...
                    CommandResult commandResult = InventoryUtil.getHome().createInventoryLocationGroupDescription(getUserVisitPK(request), commandForm);
