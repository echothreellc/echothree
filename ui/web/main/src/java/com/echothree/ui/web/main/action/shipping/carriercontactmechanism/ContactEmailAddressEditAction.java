...
@SproutAction(
    path = "/Shipping/CarrierContactMechanism/ContactEmailAddressEdit",
    mappingClass = SecureActionMapping.class,
    name = "CarrierContactEmailAddressEdit",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Shipping/CarrierContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/shipping/carriercontactmechanism/contactEmailAddressEdit.jsp")
    }
)
public class ContactEmailAddressEditAction
        extends BaseCarrierContactMechanismAction<ContactEmailAddressEditActionForm> {
