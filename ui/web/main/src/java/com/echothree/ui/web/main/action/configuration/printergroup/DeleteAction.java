...
import com.echothree.control.user.printer.remote.form.DeletePrinterGroupForm;
...
@SproutAction(
    path = "/Configuration/PrinterGroup/Delete",
...
public class DeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            PrinterUtil.getHome().deletePrinterGroup(getUserVisitPK(request), commandForm);
