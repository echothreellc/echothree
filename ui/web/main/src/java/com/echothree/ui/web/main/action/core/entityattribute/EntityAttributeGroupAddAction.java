...
@SproutAction(
    path = "/Core/EntityAttribute/EntityAttributeGroupAdd",
    mappingClass = SecureActionMapping.class,
    name = "EntityAttributeEntityAttributeGroupAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Core/EntityAttribute/EntityAttributeGroup", redirect = true),
        @SproutForward(name = "Form", path = "/core/entityattribute/entityAttributeGroupAdd.jsp")
    }
)
public class EntityAttributeGroupAddAction
