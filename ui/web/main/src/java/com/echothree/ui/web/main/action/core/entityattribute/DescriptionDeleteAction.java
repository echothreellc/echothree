...
import com.echothree.control.user.core.remote.form.DeleteEntityAttributeDescriptionForm;
import com.echothree.control.user.core.remote.form.GetEntityAttributeDescriptionForm;
import com.echothree.control.user.core.remote.result.GetEntityAttributeDescriptionResult;
...
@SproutAction(
    path = "/Core/EntityAttribute/DescriptionDelete",
    mappingClass = SecureActionMapping.class,
    name = "EntityAttributeDescriptionDelete",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Core/EntityAttribute/Description", redirect = true),
        @SproutForward(name = "Form", path = "/core/entityattribute/descriptionDelete.jsp")
    }
)
public class DescriptionDeleteAction
    ...
    public String getEntityTypeName() {
        return EntityTypes.EntityAttributeDescription.name();
    }
    ...
    public void setupTransfer(DescriptionDeleteActionForm actionForm, HttpServletRequest request)
        ...
        GetEntityAttributeDescriptionForm commandForm = CoreUtil.getHome().getGetEntityAttributeDescriptionForm();
        ...
        CommandResult commandResult = CoreUtil.getHome().getEntityAttributeDescription(getUserVisitPK(request), commandForm);
        if(!commandResult.hasErrors()) {
            ExecutionResult executionResult = commandResult.getExecutionResult();
            GetEntityAttributeDescriptionResult result = (GetEntityAttributeDescriptionResult)executionResult.getResult();

            request.setAttribute(AttributeConstants.ENTITY_ATTRIBUTE_DESCRIPTION, result.getEntityAttributeDescription());
        }
    }
    ...
    public CommandResult doDelete(DescriptionDeleteActionForm actionForm, HttpServletRequest request)
            throws NamingException {
        DeleteEntityAttributeDescriptionForm commandForm = CoreUtil.getHome().getDeleteEntityAttributeDescriptionForm();
        ...
        return CoreUtil.getHome().deleteEntityAttributeDescription(getUserVisitPK(request), commandForm);
    }
