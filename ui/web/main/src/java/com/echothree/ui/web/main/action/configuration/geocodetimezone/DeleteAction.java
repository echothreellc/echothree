...
import com.echothree.control.user.geo.common.form.DeleteGeoCodeTimeZoneForm;
...
@SproutAction(
    path = "/Configuration/GeoCodeTimeZone/Delete",
...
public class DeleteAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            DeleteGeoCodeTimeZoneForm commandForm = GeoUtil.getHome().getDeleteGeoCodeTimeZoneForm();
            ...
            GeoUtil.getHome().deleteGeoCodeTimeZone(getUserVisitPK(request), commandForm);
