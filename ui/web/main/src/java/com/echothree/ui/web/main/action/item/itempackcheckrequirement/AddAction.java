...
import com.echothree.control.user.item.remote.form.CreateItemPackCheckRequirementForm;
...
@SproutAction(
    path = "/Item/ItemPackCheckRequirement/Add",
    mappingClass = SecureActionMapping.class,
    name = "ItemPackCheckRequirementAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Item/ItemPackCheckRequirement/Main", redirect = true),
        @SproutForward(name = "Form", path = "/item/itempackcheckrequirement/add.jsp")
    }
)
public class AddAction
    ...
    public ActionForward executeAction(ActionMapping mapping, AddActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        if(wasPost(request)) {
            CreateItemPackCheckRequirementForm commandForm = ItemUtil.getHome().getCreateItemPackCheckRequirementForm();
            ...
            CommandResult commandResult = ItemUtil.getHome().createItemPackCheckRequirement(getUserVisitPK(request), commandForm);
