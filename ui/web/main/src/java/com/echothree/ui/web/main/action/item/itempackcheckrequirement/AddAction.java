...
public class AddAction
    ...
    public ActionForward executeAction(ActionMapping mapping, AddActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        if(wasPost(request)) {
            var commandForm = ItemUtil.getHome().getCreateItemPackCheckRequirementForm();
            ...
            var commandResult = ItemUtil.getHome().createItemPackCheckRequirement(getUserVisitPK(request), commandForm);
