...
@SproutAction(
    path = "/Accounting/DepartmentContactMechanism/ContactMechanismAdd/Step1",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/accounting/departmentcontactmechanism/contactmechanismadd/step1.jsp")
    }
)
public class Step1Action
        extends BaseDepartmentContactMechanismAction {
