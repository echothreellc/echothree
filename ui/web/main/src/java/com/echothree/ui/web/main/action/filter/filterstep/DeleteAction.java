...
import com.echothree.control.user.filter.remote.form.DeleteFilterStepForm;
...
public class DeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            FilterUtil.getHome().deleteFilterStep(getUserVisitPK(request), commandForm);
