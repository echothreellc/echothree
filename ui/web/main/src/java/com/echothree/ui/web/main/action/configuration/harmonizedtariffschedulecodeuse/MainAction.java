...
@SproutAction(
    path = "/Configuration/HarmonizedTariffScheduleCodeUse/Main",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/configuration/harmonizedtariffschedulecodeuse/main.jsp")
    }
)
public class MainAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        if(harmonizedTariffScheduleCode == null) {
            ...
            request.setAttribute(AttributeConstants.HARMONIZED_TARIFF_SCHEDULE_CODE_USES, result.getHarmonizedTariffScheduleCodeUses());
