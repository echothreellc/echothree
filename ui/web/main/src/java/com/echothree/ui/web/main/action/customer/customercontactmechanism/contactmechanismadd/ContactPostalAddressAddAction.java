...
import com.echothree.control.user.contact.remote.form.CreateContactPostalAddressForm;
import com.echothree.ui.web.main.action.customer.customercontactmechanism.BaseCustomerContactMechanismAction;
...
@SproutAction(
    path = "/Customer/CustomerContactMechanism/ContactMechanismAdd/ContactPostalAddressAdd",
    mappingClass = SecureActionMapping.class,
    name = "CustomerContactPostalAddressAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Customer/CustomerContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/customer/customercontactmechanism/contactmechanismadd/contactPostalAddressAdd.jsp")
    }
)
public class ContactPostalAddressAddAction
        extends BaseCustomerContactMechanismAction<ContactPostalAddressAddActionForm> {
