    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    var commandForm = VendorUtil.getHome().getCreateItemPurchasingCategoryDescriptionForm();
                    ...
                    var commandResult = VendorUtil.getHome().createItemPurchasingCategoryDescription(getUserVisitPK(request), commandForm);
