...
import com.echothree.control.user.contact.remote.form.SetDefaultPostalAddressFormatForm;
...
@SproutAction(
    path = "/Configuration/PostalAddressFormat/SetDefault",
...
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            ...
            ContactUtil.getHome().setDefaultPostalAddressFormat(getUserVisitPK(request), commandForm);
