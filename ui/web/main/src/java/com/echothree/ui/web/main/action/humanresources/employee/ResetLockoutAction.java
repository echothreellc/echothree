...
@SproutAction(
    path = "/HumanResources/Employee/ResetLockout",
...
public class ResetLockoutAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        return returnUrl == null ? mapping.findForward(ForwardConstants.DISPLAY) : new ActionForward(returnUrl, true);
    }
