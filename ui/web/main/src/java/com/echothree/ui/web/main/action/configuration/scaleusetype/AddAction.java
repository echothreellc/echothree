...
import com.echothree.control.user.scale.remote.form.CreateScaleUseTypeForm;
...
@SproutAction(
    path = "/Configuration/ScaleUseType/Add",
    mappingClass = SecureActionMapping.class,
    name = "ScaleUseTypeAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Configuration/ScaleUseType/Main", redirect = true),
        @SproutForward(name = "Form", path = "/configuration/scaleusetype/add.jsp")
    }
)
public class AddAction
    ...
    public CommandResult doAdd(AddActionForm actionForm, HttpServletRequest request)
            throws NamingException {
        CreateScaleUseTypeForm commandForm = ScaleUtil.getHome().getCreateScaleUseTypeForm();
        ...
        return ScaleUtil.getHome().createScaleUseType(getUserVisitPK(request), commandForm);
    }
