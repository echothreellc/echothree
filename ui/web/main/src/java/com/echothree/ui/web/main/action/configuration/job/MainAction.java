...
import com.echothree.control.user.job.remote.result.GetJobsResult;
...
@SproutAction(
    path = "/Configuration/Job/Main",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/configuration/job/main.jsp")
    }
)
