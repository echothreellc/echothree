...
@SproutAction(
    path = "/Customer/Customer/CustomerUserLoginDelete",
    mappingClass = SecureActionMapping.class,
    name = "CustomerUserLoginDelete",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Customer/Customer/Review", redirect = true),
        @SproutForward(name = "Form", path = "/customer/customer/customerUserLoginDelete.jsp")
    }
)
public class CustomerUserLoginDeleteAction
    ...
    @Override
    public void setupParameters(CustomerUserLoginDeleteActionForm actionForm, HttpServletRequest request) {
    ...
    public CommandResult doDelete(CustomerUserLoginDeleteActionForm actionForm, HttpServletRequest request)
        ...
        return UserUtil.getHome().deleteUserLogin(getUserVisitPK(request), commandForm);
    }
    
    @Override
    public void setupForwardParameters(CustomerUserLoginDeleteActionForm actionForm, Map<String, String> parameters) {
