...
@SproutAction(
    path = "/Accounting/DepartmentContactMechanism/ContactMechanismAdd/ContactPostalAddressAdd",
    mappingClass = SecureActionMapping.class,
    name = "DepartmentContactPostalAddressAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Accounting/DepartmentContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/accounting/departmentcontactmechanism/contactmechanismadd/contactPostalAddressAdd.jsp")
    }
)
public class ContactPostalAddressAddAction
        extends BaseDepartmentContactMechanismAction<ContactPostalAddressAddActionForm> {
