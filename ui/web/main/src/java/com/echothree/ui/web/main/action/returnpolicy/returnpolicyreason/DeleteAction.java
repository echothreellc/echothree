...
@SproutAction(
    path = "/ReturnPolicy/ReturnPolicyReason/Delete",
...
public class DeleteAction
    ...
    throws Exception {
        ...
        try {
            DeleteReturnPolicyReasonForm commandForm = ReturnPolicyUtil.getHome().getDeleteReturnPolicyReasonForm();
            ...
            ReturnPolicyUtil.getHome().deleteReturnPolicyReason(getUserVisitPK(request), commandForm);
