...
import com.echothree.control.user.geo.common.form.SetDefaultGeoCodeTypeForm;
...
@SproutAction(
    path = "/Configuration/GeoCodeType/SetDefault",
...
public class SetDefaultAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        GeoUtil.getHome().setDefaultGeoCodeType(getUserVisitPK(request), commandForm);
