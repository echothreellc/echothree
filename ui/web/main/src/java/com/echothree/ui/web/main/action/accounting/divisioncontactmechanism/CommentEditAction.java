...
@SproutAction(
    path = "/Accounting/DivisionContactMechanism/CommentEdit",
    mappingClass = SecureActionMapping.class,
    name = "DivisionContactMechanismCommentEdit",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Accounting/DivisionContactMechanism/Review", redirect = true),
        @SproutForward(name = "Form", path = "/accounting/divisioncontactmechanism/commentEdit.jsp")
    }
)
