...
@SproutAction(
    path = "/Accounting/DepartmentContactMechanism/ContactMechanismAdd/ContactTelephoneAdd",
    mappingClass = SecureActionMapping.class,
    name = "DepartmentContactTelephoneAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Accounting/DepartmentContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/accounting/departmentcontactmechanism/contactmechanismadd/contactTelephoneAdd.jsp")
    }
)
public class ContactTelephoneAddAction
        extends BaseDepartmentContactMechanismAction<ContactTelephoneAddActionForm> {
