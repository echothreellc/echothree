...
import com.echothree.control.user.message.remote.form.DeleteMessageForm;
...
@SproutAction(
    path = "/Core/Message/Delete",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Core/Message/Main", redirect = true)
    }
)
public class DeleteAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            DeleteMessageForm commandForm = MessageUtil.getHome().getDeleteMessageForm();
            ...
            MessageUtil.getHome().deleteMessage(getUserVisitPK(request), commandForm);
