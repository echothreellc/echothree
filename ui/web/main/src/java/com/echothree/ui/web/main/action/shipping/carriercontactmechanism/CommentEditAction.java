...
@SproutAction(
    path = "/Shipping/CarrierContactMechanism/CommentEdit",
    mappingClass = SecureActionMapping.class,
    name = "CarrierContactMechanismCommentEdit",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Shipping/CarrierContactMechanism/Review", redirect = true),
        @SproutForward(name = "Form", path = "/shipping/carriercontactmechanism/commentEdit.jsp")
    }
)
