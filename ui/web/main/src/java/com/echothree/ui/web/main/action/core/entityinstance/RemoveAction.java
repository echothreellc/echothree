...
@SproutAction(
    path = "/Core/EntityInstance/Remove",
    mappingClass = SecureActionMapping.class,
    name = "EntityInstanceRemove",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Core/EntityInstance/Main", redirect = true),
        @SproutForward(name = "Form", path = "/core/entityinstance/remove.jsp")
    }
)
public class RemoveAction
        extends MainBaseDeleteAction<RemoveActionForm> {

    @Override
    public String getComponentVendorName(final RemoveActionForm actionForm) {
        return actionForm.getComponentVendorName();
    }

    @Override
    public String getEntityTypeName(final RemoveActionForm actionForm) {
        return actionForm.getEntityTypeName();
    }

    @Override
    public void setupParameters(RemoveActionForm actionForm, HttpServletRequest request) {
    ...
    @Override
    public void setupTransfer(RemoveActionForm actionForm, HttpServletRequest request)
    ...
    @Override
    public CommandResult doDelete(RemoveActionForm actionForm, HttpServletRequest request)
            throws NamingException {
        var commandForm = CoreUtil.getHome().getRemoveEntityInstanceForm();

        commandForm.setEntityRef(actionForm.getEntityRef());

        return CoreUtil.getHome().removeEntityInstance(getUserVisitPK(request), commandForm);
    }

    @Override
    public void setupForwardParameters(RemoveActionForm actionForm, Map<String, String> parameters) {
