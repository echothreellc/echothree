...
import com.echothree.control.user.search.remote.form.DeleteSearchSortOrderDescriptionForm;
import com.echothree.control.user.search.remote.form.GetSearchSortOrderDescriptionForm;
import com.echothree.control.user.search.remote.result.GetSearchSortOrderDescriptionResult;
...
@SproutAction(
    path = "/Configuration/SearchSortOrder/DescriptionDelete",
    mappingClass = SecureActionMapping.class,
    name = "SearchSortOrderDescriptionDelete",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Configuration/SearchSortOrder/Description", redirect = true),
        @SproutForward(name = "Form", path = "/configuration/searchsortorder/descriptionDelete.jsp")
    }
)
public class DescriptionDeleteAction
    ...
    public String getEntityTypeName() {
        return EntityTypes.SearchSortOrderDescription.name();
    }
    ...
    public CommandResult doDelete(DescriptionDeleteActionForm actionForm, HttpServletRequest request)
        ...
        return SearchUtil.getHome().deleteSearchSortOrderDescription(getUserVisitPK(request), commandForm);
    }
