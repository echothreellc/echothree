...
@SproutAction(
    path = "/Configuration/CommunicationSource/Delete",
...
public class DeleteAction
    ...
    throws Exception {
        ...
        try {
            DeleteCommunicationSourceForm commandForm = CommunicationUtil.getHome().getDeleteCommunicationSourceForm();
            ...
            CommunicationUtil.getHome().deleteCommunicationSource(getUserVisitPK(request), commandForm);
