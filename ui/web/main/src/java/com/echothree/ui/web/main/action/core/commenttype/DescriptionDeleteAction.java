...
import com.echothree.control.user.comment.remote.form.DeleteCommentTypeDescriptionForm;
...
@SproutAction(
    path = "/Core/CommentType/DescriptionDelete",
...
public class DescriptionDeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            DeleteCommentTypeDescriptionForm commandForm = CommentUtil.getHome().getDeleteCommentTypeDescriptionForm();
            ...
            CommentUtil.getHome().deleteCommentTypeDescription(getUserVisitPK(request), commandForm);
