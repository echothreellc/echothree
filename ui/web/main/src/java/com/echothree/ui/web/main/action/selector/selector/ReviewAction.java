...
import com.echothree.control.user.selector.remote.form.GetSelectorForm;
import com.echothree.control.user.selector.remote.result.GetSelectorResult;
...
@SproutAction(
    path = "/Selector/Selector/Review",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/selector/selector/review.jsp")
    }
)
public class ReviewAction
    ...
    throws Exception {
        ...
        try {
            GetSelectorForm commandForm = SelectorUtil.getHome().getGetSelectorForm();
            ...
            CommandResult commandResult = SelectorUtil.getHome().getSelector(getUserVisitPK(request), commandForm);
            ExecutionResult executionResult = commandResult.getExecutionResult();
            GetSelectorResult result = (GetSelectorResult)executionResult.getResult();
