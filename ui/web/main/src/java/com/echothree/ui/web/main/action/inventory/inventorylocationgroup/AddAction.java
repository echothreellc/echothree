...
@SproutAction(
    path = "/Inventory/InventoryLocationGroup/Add",
    mappingClass = SecureActionMapping.class,
    name = "InventoryLocationGroupAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Inventory/InventoryLocationGroup/Main", redirect = true),
        @SproutForward(name = "Form", path = "/inventory/inventorylocationgroup/add.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreateInventoryLocationGroupForm commandForm = InventoryUtil.getHome().getCreateInventoryLocationGroupForm();
                    ...
                    CommandResult commandResult = InventoryUtil.getHome().createInventoryLocationGroup(getUserVisitPK(request), commandForm);
