    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreateCancellationTypeDescriptionForm commandForm = CancellationPolicyUtil.getHome().getCreateCancellationTypeDescriptionForm();
                    ...
                    CommandResult commandResult = CancellationPolicyUtil.getHome().createCancellationTypeDescription(getUserVisitPK(request), commandForm);
