...
import com.echothree.control.user.returnpolicy.remote.form.SetDefaultReturnPolicyReasonForm;
...
@SproutAction(
    path = "/ReturnPolicy/ReturnPolicyReason/SetDefault",
...
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            SetDefaultReturnPolicyReasonForm commandForm = ReturnPolicyUtil.getHome().getSetDefaultReturnPolicyReasonForm();
            ...
            ReturnPolicyUtil.getHome().setDefaultReturnPolicyReason(getUserVisitPK(request), commandForm);
