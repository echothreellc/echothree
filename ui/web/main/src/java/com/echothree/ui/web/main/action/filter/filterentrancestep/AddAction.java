...
import com.echothree.control.user.filter.remote.form.CreateFilterEntranceStepForm;
...
@SproutAction(
    path = "/Filter/FilterEntranceStep/Add",
    mappingClass = SecureActionMapping.class,
    name = "FilterEntranceStepAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Filter/FilterEntranceStep/Main", redirect = true),
        @SproutForward(name = "Form", path = "/filter/filterentrancestep/add.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreateFilterEntranceStepForm commandForm = FilterUtil.getHome().getCreateFilterEntranceStepForm();
                    ...
                    commandForm.setFilterStepName(actionForm.getFilterStepChoice());
                    
                    CommandResult commandResult = FilterUtil.getHome().createFilterEntranceStep(getUserVisitPK(request), commandForm);
