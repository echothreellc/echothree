    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                var commandForm = CancellationPolicyUtil.getHome().getEditCancellationReasonDescriptionForm();
                var spec = CancellationPolicyUtil.getHome().getCancellationReasonDescriptionSpec();
                ...
                if(wasPost(request)) {
                    var edit = CancellationPolicyUtil.getHome().getCancellationReasonDescriptionEdit();
                    
                    commandForm.setEditMode(EditMode.UPDATE);
                    commandForm.setEdit(edit);
                    edit.setDescription(actionForm.getDescription());

                    var commandResult = CancellationPolicyUtil.getHome().editCancellationReasonDescription(getUserVisitPK(request), commandForm);
                    
                    if(commandResult.hasErrors()) {
                        var executionResult = commandResult.getExecutionResult();
                        
                        if(executionResult != null) {
                            var result = (EditCancellationReasonDescriptionResult)executionResult.getResult();
