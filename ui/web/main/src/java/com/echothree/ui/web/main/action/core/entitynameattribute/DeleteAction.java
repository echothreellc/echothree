...
import com.echothree.control.user.core.remote.form.DeleteEntityNameAttributeForm;
...
@SproutAction(
    path = "/Core/EntityNameAttribute/Delete",
...
public class DeleteAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            DeleteEntityNameAttributeForm commandForm = CoreUtil.getHome().getDeleteEntityNameAttributeForm();
            
            commandForm.setEntityRef(entityRef);
            commandForm.setEntityAttributeName(entityAttributeName);
            
            CoreUtil.getHome().deleteEntityNameAttribute(getUserVisitPK(request), commandForm);
