...
@SproutAction(
    path = "/Warehouse/WarehouseContactMechanism/ContactEmailAddressEdit",
    mappingClass = SecureActionMapping.class,
    name = "WarehouseContactEmailAddressEdit",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Warehouse/WarehouseContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/warehouse/warehousecontactmechanism/contactEmailAddressEdit.jsp")
    }
)
public class ContactEmailAddressEditAction
        extends BaseWarehouseContactMechanismAction<ContactEmailAddressEditActionForm> {
