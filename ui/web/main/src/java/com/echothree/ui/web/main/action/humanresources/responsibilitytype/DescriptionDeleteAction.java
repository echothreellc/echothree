...
import com.echothree.control.user.employee.common.form.DeleteResponsibilityTypeDescriptionForm;
...
@SproutAction(
    path = "/HumanResources/ResponsibilityType/DescriptionDelete",
...
public class DescriptionDeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            DeleteResponsibilityTypeDescriptionForm commandForm = EmployeeUtil.getHome().getDeleteResponsibilityTypeDescriptionForm();
            
            commandForm.setResponsibilityTypeName(responsibilityTypeName);
            commandForm.setLanguageIsoName(languageIsoName);
            
            EmployeeUtil.getHome().deleteResponsibilityTypeDescription(getUserVisitPK(request), commandForm);
