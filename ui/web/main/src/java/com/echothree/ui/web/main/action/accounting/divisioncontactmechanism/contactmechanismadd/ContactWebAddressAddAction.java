...
@SproutAction(
    path = "/Accounting/DivisionContactMechanism/ContactMechanismAdd/ContactWebAddressAdd",
    mappingClass = SecureActionMapping.class,
    name = "DivisionContactWebAddressAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Accounting/DivisionContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/accounting/divisioncontactmechanism/contactmechanismadd/contactWebAddressAdd.jsp")
    }
)
public class ContactWebAddressAddAction
        extends BaseDivisionContactMechanismAction<ContactWebAddressAddActionForm> {
