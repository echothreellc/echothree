...
@SproutAction(
    path = "/Accounting/CompanyContactMechanism/ContactMechanismAdd/Step1",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/accounting/companycontactmechanism/contactmechanismadd/step1.jsp")
    }
)
public class Step1Action
        extends BaseCompanyContactMechanismAction {
