...
import com.echothree.control.user.inventory.remote.form.GetInventoryConditionForm;
import com.echothree.control.user.inventory.remote.result.GetInventoryConditionResult;
...
@SproutAction(
    path = "/Inventory/InventoryCondition/Review",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/inventory/inventorycondition/review.jsp")
    }
)
