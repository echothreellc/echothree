...
@SproutAction(
    path = "/Club/Club/SetDefault",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Club/Club/Main", redirect = true)
    }
)
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            ...
            ClubUtil.getHome().setDefaultClub(getUserVisitPK(request), commandForm);
