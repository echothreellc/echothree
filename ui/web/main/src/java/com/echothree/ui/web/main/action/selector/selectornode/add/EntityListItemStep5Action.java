...
@SproutAction(
    path = "/Selector/SelectorNode/Add/EntityListItemStep5",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/selector/selectornode/add/entityListItemStep5.jsp")
    }
)
public class EntityListItemStep5Action
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            final String entityAttributeName = request.getParameter(ParameterConstants.ENTITY_ATTRIBUTE_NAME);
            ...
            CommandResult commandResult = CoreUtil.getHome().getEntityListItems(getUserVisitPK(request), commandForm);
            ...
            request.setAttribute(AttributeConstants.ENTITY_LIST_ITEMS, result.getEntityListItems());
