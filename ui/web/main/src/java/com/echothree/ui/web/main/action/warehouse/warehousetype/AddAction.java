...
@SproutAction(
    path = "/Warehouse/WarehouseType/Add",
    ...
    forwards = {
        ...
        @SproutForward(name = "Form", path = "/warehouse/warehousetype/add.jsp")
    }
)
public class AddAction
    ...
    public ActionForward executeAction(ActionMapping mapping, AddActionForm actionForm, HttpServletRequest request, HttpServletResponse response)
        ...
        if(wasPost(request)) {
            ...
            var commandResult = WarehouseUtil.getHome().createWarehouseType(getUserVisitPK(request), commandForm);
