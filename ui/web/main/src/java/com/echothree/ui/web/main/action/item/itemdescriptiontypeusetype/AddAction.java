...
@SproutAction(
    path = "/Item/ItemDescriptionTypeUseType/Add",
    mappingClass = SecureActionMapping.class,
    name = "ItemDescriptionTypeUseTypeAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Item/ItemDescriptionTypeUseType/Main", redirect = true),
        @SproutForward(name = "Form", path = "/item/itemdescriptiontypeusetype/add.jsp")
    }
)
public class AddAction
    ...
    public CommandResult doAdd(AddActionForm actionForm, HttpServletRequest request)
        ...
        return ItemUtil.getHome().createItemDescriptionTypeUseType(getUserVisitPK(request), commandForm);
    }
