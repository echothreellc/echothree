...
@SproutAction(
    path = "/Purchasing/VendorDocument/DescriptionDelete",
    mappingClass = SecureActionMapping.class,
    name = "VendorDocumentDescriptionDelete",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Purchasing/VendorDocument/Description", redirect = true),
        @SproutForward(name = "Form", path = "/purchasing/vendordocument/descriptionDelete.jsp")
    }
)
