...
@SproutAction(
    path = "/ReturnPolicy/ReturnReasonType/Delete",
...
public class DeleteAction
    ...
    throws Exception {
        ...
        try {
            DeleteReturnReasonTypeForm commandForm = ReturnPolicyUtil.getHome().getDeleteReturnReasonTypeForm();
            ...
            ReturnPolicyUtil.getHome().deleteReturnReasonType(getUserVisitPK(request), commandForm);
