...
@SproutAction(
    path = "/Customer/CustomerContactMechanism/ContactMechanismAdd/ContactWebAddressAdd",
    mappingClass = SecureActionMapping.class,
    name = "CustomerContactWebAddressAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Customer/CustomerContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/customer/customercontactmechanism/contactmechanismadd/contactWebAddressAdd.jsp")
    }
)
public class ContactWebAddressAddAction
        extends BaseCustomerContactMechanismAction<ContactWebAddressAddActionForm> {
