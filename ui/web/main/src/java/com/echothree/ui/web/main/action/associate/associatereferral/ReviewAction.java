...
import com.echothree.control.user.associate.remote.form.GetAssociateReferralForm;
import com.echothree.control.user.associate.remote.result.GetAssociateReferralResult;
...
@SproutAction(
    path = "/Associate/AssociateReferral/Review",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/associate/associatereferral/review.jsp")
    }
)
