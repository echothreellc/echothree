...
@SproutForm(name="VendorTypeEdit")
public class EditActionForm
        extends AddActionForm {
    
    private String originalVendorTypeName;
    
    public String getOriginalVendorTypeName() {
        return originalVendorTypeName;
    }
    
    public void setOriginalVendorTypeName(String originalVendorTypeName) {
