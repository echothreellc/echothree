...
import com.echothree.control.user.vendor.remote.form.GetVendorItemForm;
import com.echothree.control.user.vendor.remote.result.GetVendorItemResult;
...
@SproutAction(
    path = "/Purchasing/VendorItem/CommentEdit",
    mappingClass = SecureActionMapping.class,
    name = "VendorItemCommentEdit",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Purchasing/VendorItem/Review", redirect = true),
        @SproutForward(name = "Form", path = "/purchasing/vendoritem/commentEdit.jsp")
    }
)
public class CommentEditAction
    ...
    protected void setupActionForm(HttpServletRequest request, CommentEditActionForm actionForm, EditCommentResult result, CommentSpec spec, CommentEdit edit) {
        ...
        actionForm.setVendorItemName(request.getParameter(ParameterConstants.VENDOR_ITEM_NAME));
