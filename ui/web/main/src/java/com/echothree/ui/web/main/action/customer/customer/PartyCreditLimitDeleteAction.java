...
@SproutAction(
    path = "/Customer/Customer/PartyCreditLimitDelete",
...
public class PartyCreditLimitDeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            TermUtil.getHome().deletePartyCreditLimit(getUserVisitPK(request), commandForm);
