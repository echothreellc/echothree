...
@SproutAction(
    path = "/Configuration/PrinterGroupJob/Main",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/configuration/printergroupjob/main.jsp")
    }
)
public class MainAction
    ...
    throws Exception {
        ...
        try {
            ...
            var commandResult = PrinterUtil.getHome().getPrinterGroupJobs(getUserVisitPK(request), commandForm);
