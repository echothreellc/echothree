...
import com.echothree.control.user.contactlist.remote.form.GetContactListContactMechanismPurposesForm;
import com.echothree.control.user.contactlist.remote.result.GetContactListContactMechanismPurposesResult;
...
@SproutAction(
    path = "/ContactList/ContactList/ContactListContactMechanismPurpose",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/contactlist/contactlist/contactListContactMechanismPurpose.jsp")
    }
)
public class ContactListContactMechanismPurposeAction
