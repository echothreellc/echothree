...
@SproutAction(
    path = "/Accounting/DivisionContactMechanism/PartyContactMechanismPurposeSetDefault",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Review", path = "/action/Accounting/DivisionContactMechanism/Main", redirect = true)
    }
)
