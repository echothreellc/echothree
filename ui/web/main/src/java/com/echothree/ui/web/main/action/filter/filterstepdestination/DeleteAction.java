...
import com.echothree.control.user.filter.remote.form.DeleteFilterStepDestinationForm;
...
@SproutAction(
    path = "/Filter/FilterStepDestination/Delete",
...
public class DeleteAction
    ...
    throws Exception {
        ...
        try {
            String toFlterStepName = request.getParameter(ParameterConstants.TO_FILTER_STEP_NAME);
            DeleteFilterStepDestinationForm commandForm = FilterUtil.getHome().getDeleteFilterStepDestinationForm();
            ...
            commandForm.setToFilterStepName(toFlterStepName);
            
            FilterUtil.getHome().deleteFilterStepDestination(getUserVisitPK(request), commandForm);
