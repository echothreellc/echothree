...
@SproutAction(
    path = "/Purchasing/VendorContactMechanism/ContactMechanismAdd/ContactEmailAddressAdd",
    mappingClass = SecureActionMapping.class,
    name = "VendorContactEmailAddressAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Purchasing/VendorContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/purchasing/vendorcontactmechanism/contactmechanismadd/contactEmailAddressAdd.jsp")
    }
)
public class ContactEmailAddressAddAction
        extends BaseVendorContactMechanismAction<ContactEmailAddressAddActionForm> {
