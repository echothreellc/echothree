...
@SproutAction(
    path = "/Accounting/CompanyContactMechanism/ContactEmailAddressEdit",
    mappingClass = SecureActionMapping.class,
    name = "CompanyContactEmailAddressEdit",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Accounting/CompanyContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/accounting/companycontactmechanism/contactEmailAddressEdit.jsp")
    }
)
public class ContactEmailAddressEditAction
        extends BaseCompanyContactMechanismAction<ContactEmailAddressEditActionForm> {
