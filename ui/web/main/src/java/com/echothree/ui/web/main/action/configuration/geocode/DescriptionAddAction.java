...
import com.echothree.control.user.geo.remote.form.GetGeoCodeForm;
import com.echothree.control.user.geo.remote.result.GetGeoCodeResult;
...
public class DescriptionAddAction
    ...
    public CommandResult doAdd(DescriptionAddActionForm actionForm, HttpServletRequest request)
            throws NamingException {
        CreateGeoCodeDescriptionForm commandForm = GeoUtil.getHome().getCreateGeoCodeDescriptionForm();
