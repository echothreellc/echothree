...
@SproutAction(
    path = "/ReturnPolicy/ReturnType/Add",
    ...
    forwards = {
        ...
        @SproutForward(name = "Form", path = "/returnpolicy/returntype/add.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreateReturnTypeForm commandForm = ReturnPolicyUtil.getHome().getCreateReturnTypeForm();
                    
                    if(returnKindName == null)
                        returnKindName = actionForm.getReturnKindName();
                    
                    commandForm.setReturnKindName(returnKindName);
                    commandForm.setReturnTypeName(actionForm.getReturnTypeName());
                    commandForm.setReturnSequenceName(actionForm.getReturnSequenceChoice());
                    commandForm.setIsDefault(actionForm.getIsDefault().toString());
                    commandForm.setSortOrder(actionForm.getSortOrder());
                    commandForm.setDescription(actionForm.getDescription());
                    
                    CommandResult commandResult = ReturnPolicyUtil.getHome().createReturnType(getUserVisitPK(request), commandForm);
