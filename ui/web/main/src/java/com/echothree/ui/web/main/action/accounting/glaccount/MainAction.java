...
import com.echothree.control.user.accounting.remote.form.GetGlAccountsForm;
import com.echothree.control.user.accounting.remote.result.GetGlAccountsResult;
...
@SproutAction(
    path = "/Accounting/GlAccount/Main",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/accounting/glaccount/main.jsp")
    }
)
public class MainAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        if(glAccountCategoryName != null && glAccountCategory == null) {
            ...
            request.setAttribute(AttributeConstants.GL_ACCOUNT_CATEGORY, glAccountCategory);
            request.setAttribute(AttributeConstants.GL_ACCOUNTS, result.getGlAccounts());
