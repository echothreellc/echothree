...
@SproutAction(
    path = "/CancellationPolicy/CancellationPolicy/Add",
    ...
    forwards = {
        ...
        @SproutForward(name = "Form", path = "/cancellationpolicy/cancellationpolicy/add.jsp")
    }
)
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    ...
                    commandForm.setCancellationPolicyName(actionForm.getCancellationPolicyName());
