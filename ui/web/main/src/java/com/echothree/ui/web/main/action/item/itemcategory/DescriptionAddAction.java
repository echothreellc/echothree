...
import com.echothree.control.user.item.remote.form.CreateItemCategoryDescriptionForm;
import com.echothree.control.user.item.remote.form.GetItemCategoryForm;
import com.echothree.control.user.item.remote.result.GetItemCategoryResult;
...
@SproutAction(
    path = "/Item/ItemCategory/DescriptionAdd",
    mappingClass = SecureActionMapping.class,
    name = "ItemCategoryDescriptionAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Item/ItemCategory/Description", redirect = true),
        @SproutForward(name = "Form", path = "/item/itemcategory/descriptionAdd.jsp")
    }
)
public class DescriptionAddAction
    ...
    public CommandResult doAdd(DescriptionAddActionForm actionForm, HttpServletRequest request)
            throws NamingException {
        CreateItemCategoryDescriptionForm commandForm = ItemUtil.getHome().getCreateItemCategoryDescriptionForm();

        commandForm.setItemCategoryName( actionForm.getItemCategoryName());
        commandForm.setLanguageIsoName(actionForm.getLanguageChoice());
        commandForm.setDescription(actionForm.getDescription());

        return ItemUtil.getHome().createItemCategoryDescription(getUserVisitPK(request), commandForm);
    }
