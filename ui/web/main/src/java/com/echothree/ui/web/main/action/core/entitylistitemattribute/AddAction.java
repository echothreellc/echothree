...
@SproutAction(
    path = "/Core/EntityListItemAttribute/Add",
    mappingClass = SecureActionMapping.class,
    name = "EntityListItemAttributeAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Form", path = "/core/entitylistitemattribute/add.jsp")
    }
)
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(wasPost(request)) {
                ...
                CommandResult commandResult = CoreUtil.getHome().createEntityListItemAttribute(getUserVisitPK(request), commandForm);
