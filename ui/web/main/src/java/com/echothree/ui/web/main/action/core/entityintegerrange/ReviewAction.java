...
@SproutAction(
    path = "/Core/EntityIntegerRange/Review",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/core/entityintegerrange/review.jsp")
    }
)
public class ReviewAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        if(entityIntegerRange == null) {
            ...
            request.setAttribute(AttributeConstants.ENTITY_INTEGER_RANGE, entityIntegerRange);
