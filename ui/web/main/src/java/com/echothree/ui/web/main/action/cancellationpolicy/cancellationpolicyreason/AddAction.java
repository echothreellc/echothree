    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    var commandForm = CancellationPolicyUtil.getHome().getCreateCancellationPolicyReasonForm();
                    ...
                    var commandResult = CancellationPolicyUtil.getHome().createCancellationPolicyReason(getUserVisitPK(request), commandForm);
