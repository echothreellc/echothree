...
@SproutAction(
    path = "/Configuration/CommunicationEventPurpose/DescriptionEdit",
    mappingClass = SecureActionMapping.class,
    name = "CommunicationEventPurposeDescriptionEdit",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Configuration/CommunicationEventPurpose/Description", redirect = true),
        @SproutForward(name = "Form", path = "/configuration/communicationeventpurpose/descriptionEdit.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                spec.setCommunicationEventPurposeName(communicationEventPurposeName);
