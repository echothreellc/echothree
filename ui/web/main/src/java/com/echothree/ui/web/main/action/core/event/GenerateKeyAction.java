...
import com.echothree.control.user.core.remote.form.GenerateKeyForm;
import com.echothree.control.user.core.remote.result.GenerateKeyResult;
...
public class GenerateKeyAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        GenerateKeyForm commandForm = CoreUtil.getHome().getGenerateKeyForm();
        ...
        CommandResult commandResult = CoreUtil.getHome().generateKey(getUserVisitPK(request), commandForm);

        if(!commandResult.hasErrors()) {
            ExecutionResult executionResult = commandResult.getExecutionResult();
            GenerateKeyResult result = (GenerateKeyResult)executionResult.getResult();
        ...
        if(forwardKey != null) {
            ...
            parameters.put(ParameterConstants.KEY, key);
