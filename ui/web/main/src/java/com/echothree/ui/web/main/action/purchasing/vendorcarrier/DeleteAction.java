...
@SproutAction(
    path = "/Purchasing/VendorCarrier/Delete",
    mappingClass = SecureActionMapping.class,
    name = "VendorCarrierDelete",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Purchasing/VendorCarrier/Main", redirect = true),
        @SproutForward(name = "Form", path = "/purchasing/vendorcarrier/delete.jsp")
    }
)
public class DeleteAction
    ...
    public void setupTransfer(DeleteActionForm actionForm, HttpServletRequest request)
        ...
        BaseVendorCarrierAction.setupPartyCarrierTransfer(request, actionForm.getPartyName(), actionForm.getCarrierName());
