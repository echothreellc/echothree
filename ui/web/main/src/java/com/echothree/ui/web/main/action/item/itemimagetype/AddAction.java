...
import com.echothree.control.user.item.remote.form.CreateItemImageTypeForm;
...
@SproutAction(
    path = "/Item/ItemImageType/Add",
    mappingClass = SecureActionMapping.class,
    name = "ItemImageTypeAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Item/ItemImageType/Main", redirect = true),
        @SproutForward(name = "Form", path = "/item/itemimagetype/add.jsp")
    }
)
public class AddAction
    ...
    public CommandResult doAdd(AddActionForm actionForm, HttpServletRequest request)
        ...
        return ItemUtil.getHome().createItemImageType(getUserVisitPK(request), commandForm);
    }
