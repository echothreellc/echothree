...
import com.echothree.control.user.employee.remote.form.SetDefaultEmployeeTypeForm;
...
@SproutAction(
    path = "/HumanResources/EmployeeType/SetDefault",
...
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            ...
            EmployeeUtil.getHome().setDefaultEmployeeType(getUserVisitPK(request), commandForm);
