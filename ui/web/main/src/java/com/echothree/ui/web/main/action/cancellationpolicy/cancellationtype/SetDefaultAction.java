...
import com.echothree.control.user.cancellationpolicy.common.form.SetDefaultCancellationTypeForm;
...
@SproutAction(
    path = "/CancellationPolicy/CancellationType/SetDefault",
...
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            ...
            CancellationPolicyUtil.getHome().setDefaultCancellationType(getUserVisitPK(request), commandForm);
