...
import com.echothree.control.user.core.remote.form.SetEventGroupStatusForm;
...
@SproutAction(
    path = "/Core/EventGroup/Status",
    mappingClass = SecureActionMapping.class,
    name = "EventGroupStatus",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Core/EventGroup/Main", redirect = true),
        @SproutForward(name = "Form", path = "/core/eventgroup/status.jsp")
    }
)
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(wasPost(request)) {
                ...
                actionForm.setEventGroupName(eventGroupName);
                actionForm.setupEventGroupStatusChoices();
                forwardKey = ForwardConstants.FORM;
            }
