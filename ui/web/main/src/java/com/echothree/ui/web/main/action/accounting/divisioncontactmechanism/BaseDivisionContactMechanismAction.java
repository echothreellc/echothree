...
public abstract class BaseDivisionContactMechanismAction<A
        extends ActionForm>
    ...
    public static void setupDivision(HttpServletRequest request, String partyName)
            throws NamingException {
    ...
    public void setupDivision(HttpServletRequest request)
            throws NamingException {
        setupDivision(request, request.getParameter(ParameterConstants.PARTY_NAME));
    }
