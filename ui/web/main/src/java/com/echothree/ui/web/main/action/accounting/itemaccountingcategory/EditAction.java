...
@SproutAction(
    path = "/Accounting/ItemAccountingCategory/Edit",
    mappingClass = SecureActionMapping.class,
    name = "ItemAccountingCategoryEdit",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Accounting/ItemAccountingCategory/Main", redirect = true),
        @SproutForward(name = "Form", path = "/accounting/itemaccountingcategory/edit.jsp")
    }
)
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    ...
                    edit.setItemAccountingCategoryName(actionForm.getItemAccountingCategoryName());
                    edit.setParentItemAccountingCategoryName(actionForm.getParentItemAccountingCategoryChoice());
                    ...
                    if(result != null) {
                        ...
                        if(edit != null) {
                            ...
                            actionForm.setItemAccountingCategoryName(edit.getItemAccountingCategoryName());
                            actionForm.setParentItemAccountingCategoryChoice(edit.getParentItemAccountingCategoryName());
