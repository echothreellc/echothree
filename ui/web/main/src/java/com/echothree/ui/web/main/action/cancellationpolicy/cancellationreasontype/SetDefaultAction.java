...
import com.echothree.control.user.cancellationpolicy.remote.form.SetDefaultCancellationReasonTypeForm;
...
@SproutAction(
    path = "/CancellationPolicy/CancellationReasonType/SetDefault",
...
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            SetDefaultCancellationReasonTypeForm commandForm = CancellationPolicyUtil.getHome().getSetDefaultCancellationReasonTypeForm();
            ...
            CancellationPolicyUtil.getHome().setDefaultCancellationReasonType(getUserVisitPK(request), commandForm);
