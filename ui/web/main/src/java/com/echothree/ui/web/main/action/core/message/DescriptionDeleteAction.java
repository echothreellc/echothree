...
import com.echothree.control.user.message.common.form.DeleteMessageDescriptionForm;
...
@SproutAction(
    path = "/Core/Message/DescriptionDelete",
...
public class DescriptionDeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            DeleteMessageDescriptionForm commandForm = MessageUtil.getHome().getDeleteMessageDescriptionForm();
            ...
            MessageUtil.getHome().deleteMessageDescription(getUserVisitPK(request), commandForm);
