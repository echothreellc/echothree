...
import com.echothree.control.user.employee.remote.form.GetTerminationReasonDescriptionsForm;
import com.echothree.control.user.employee.remote.result.GetTerminationReasonDescriptionsResult;
...
@SproutAction(
    path = "/HumanResources/TerminationReason/Description",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/humanresources/terminationreason/description.jsp")
    }
)
public class DescriptionAction
    ...
    throws Exception {
        ...
        try {
            ...
            request.setAttribute(AttributeConstants.TERMINATION_REASON_DESCRIPTIONS, result.getTerminationReasonDescriptions());
