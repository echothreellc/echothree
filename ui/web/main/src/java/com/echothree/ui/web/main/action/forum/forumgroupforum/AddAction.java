...
import com.echothree.control.user.forum.remote.form.CreateForumGroupForumForm;
...
@SproutAction(
    path = "/Forum/ForumGroupForum/Add",
    mappingClass = SecureActionMapping.class,
    name = "ForumGroupForumAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Forum/ForumGroupForum/Main", redirect = true),
        @SproutForward(name = "Form", path = "/forum/forumgroupforum/add.jsp")
    }
)
