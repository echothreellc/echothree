...
import com.echothree.control.user.workrequirement.remote.form.DeleteWorkRequirementTypeForm;
...
@SproutAction(
    path = "/Configuration/WorkRequirementType/Delete",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Configuration/WorkRequirementType/Main", redirect = true)
    }
)
public class DeleteAction
    ...
    throws Exception {
        ...
        try {
            DeleteWorkRequirementTypeForm commandForm = WorkRequirementUtil.getHome().getDeleteWorkRequirementTypeForm();
            ...
            WorkRequirementUtil.getHome().deleteWorkRequirementType(getUserVisitPK(request), commandForm);
