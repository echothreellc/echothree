...
@SproutAction(
    path = "/Core/EntityAliasType/DescriptionAdd",
    mappingClass = SecureActionMapping.class,
    name = "CoreEntityAliasTypeDescriptionAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Core/EntityAliasType/Description", redirect = true),
        @SproutForward(name = "Form", path = "/core/entityaliastype/descriptionAdd.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    var commandForm = CoreUtil.getHome().getCreateEntityAliasTypeDescriptionForm();
                    ...
                    var commandResult = CoreUtil.getHome().createEntityAliasTypeDescription(getUserVisitPK(request), commandForm);
