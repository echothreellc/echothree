...
@SproutAction(
    path = "/Purchasing/VendorContactMechanism/ContactMechanismAdd/Step1",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/purchasing/vendorcontactmechanism/contactmechanismadd/step1.jsp")
    }
)
public class Step1Action
        extends BaseVendorContactMechanismAction {
