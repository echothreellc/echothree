...
import com.echothree.control.user.item.remote.form.CreateItemPriceForm;
...
@SproutAction(
    ...
    forwards = {
        ...
        @SproutForward(name = "Form", path = "/item/itemprice/add.jsp")
    }
)
public class AddAction
    ...
    public ActionForward executeAction(ActionMapping mapping, AddActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        if(wasPost(request)) {
            ...
            commandForm.setUnitPrice(form.getUnitPrice());
