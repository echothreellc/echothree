...
import com.echothree.control.user.cancellationpolicy.common.result.GetCancellationKindsResult;
...
@SproutAction(
    path = "/CancellationPolicy/CancellationKind/Main",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/cancellationpolicy/cancellationkind/main.jsp")
    }
)
