    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                var commandForm = PartyUtil.getHome().getEditDateTimeFormatDescriptionForm();
                var spec = PartyUtil.getHome().getDateTimeFormatDescriptionSpec();
                ...
                if(wasPost(request)) {
                    var edit = PartyUtil.getHome().getDateTimeFormatDescriptionEdit();
                    
                    commandForm.setEditMode(EditMode.UPDATE);
                    commandForm.setEdit(edit);
                    edit.setDescription(actionForm.getDescription());

                    var commandResult = PartyUtil.getHome().editDateTimeFormatDescription(getUserVisitPK(request), commandForm);
                    
                    if(commandResult.hasErrors()) {
                        var executionResult = commandResult.getExecutionResult();
                        
                        if(executionResult != null) {
                            var result = (EditDateTimeFormatDescriptionResult)executionResult.getResult();
