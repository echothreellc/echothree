...
@SproutAction(
    path = "/Configuration/PartySecurityRoleTemplate/Add",
    mappingClass = SecureActionMapping.class,
    name = "PartySecurityRoleTemplateAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Configuration/PartySecurityRoleTemplate/Main", redirect = true),
        @SproutForward(name = "Form", path = "/configuration/partysecurityroletemplate/add.jsp")
    }
)
