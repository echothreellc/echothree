...
import com.echothree.ui.web.main.action.humanresources.employeedocument.BaseEmployeeDocumentAction;
...
@SproutAction(
    path = "/HumanResources/EmployeeDocument/Add/Step2",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/humanresources/employeedocument/add/step2.jsp")
    }
)
