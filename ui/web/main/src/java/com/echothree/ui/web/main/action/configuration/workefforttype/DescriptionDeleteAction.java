...
@SproutAction(
    path = "/Configuration/WorkEffortType/DescriptionDelete",
...
public class DescriptionDeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            DeleteWorkEffortTypeDescriptionForm commandForm = WorkEffortUtil.getHome().getDeleteWorkEffortTypeDescriptionForm();
            
            commandForm.setWorkEffortTypeName(workEffortTypeName);
            commandForm.setLanguageIsoName(languageIsoName);
            
            WorkEffortUtil.getHome().deleteWorkEffortTypeDescription(getUserVisitPK(request), commandForm);
