...
@SproutAction(
    path = "/Core/EntityInstance/Unlock",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/core/entityinstance/unlock.jsp")
    }
)
public class UnlockAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute(TagConstants.CommandResultName, CoreUtil.getHome().unlockEntity(getUserVisitPK(request), commandForm));
