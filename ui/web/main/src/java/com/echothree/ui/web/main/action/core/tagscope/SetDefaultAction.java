...
import com.echothree.control.user.tag.remote.form.SetDefaultTagScopeForm;
...
public class SetDefaultAction
    ...
    throws Exception {
        ...
        TagUtil.getHome().setDefaultTagScope(getUserVisitPK(request), commandForm);
