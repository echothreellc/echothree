...
import com.echothree.control.user.accounting.common.form.SetDefaultGlResourceTypeForm;
...
@SproutAction(
    path = "/Accounting/GlResourceType/SetDefault",
...
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            ...
            AccountingUtil.getHome().setDefaultGlResourceType(getUserVisitPK(request), commandForm);
