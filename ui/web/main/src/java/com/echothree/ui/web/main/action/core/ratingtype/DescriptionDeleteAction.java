...
import com.echothree.control.user.rating.remote.form.DeleteRatingTypeDescriptionForm;
...
@SproutAction(
    path = "/Core/RatingType/DescriptionDelete",
...
public class DescriptionDeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            DeleteRatingTypeDescriptionForm commandForm = RatingUtil.getHome().getDeleteRatingTypeDescriptionForm();
            ...
            RatingUtil.getHome().deleteRatingTypeDescription(getUserVisitPK(request), commandForm);
