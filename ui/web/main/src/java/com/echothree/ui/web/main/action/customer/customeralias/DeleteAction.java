...
@SproutAction(
    path = "/Customer/CustomerAlias/Delete",
    mappingClass = SecureActionMapping.class,
    name = "CustomerAliasDelete",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Customer/CustomerAlias/Main", redirect = true),
        @SproutForward(name = "Form", path = "/customer/customeralias/delete.jsp")
    }
)
public class DeleteAction
    ...
    public void setupTransfer(DeleteActionForm actionForm, HttpServletRequest request)
        ...
        CustomerAliasUtil.getInstance().setupPartyAliasTransfer(request, actionForm.getPartyName(), actionForm.getPartyAliasTypeName());
        CustomerAliasUtil.getInstance().setupCustomer(request, actionForm.getPartyName());
    }
