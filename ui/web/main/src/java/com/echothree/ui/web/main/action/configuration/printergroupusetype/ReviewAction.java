...
import com.echothree.control.user.printer.remote.form.GetPrinterGroupUseTypeForm;
import com.echothree.control.user.printer.remote.result.GetPrinterGroupUseTypeResult;
...
@SproutAction(
    path = "/Configuration/PrinterGroupUseType/Review",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/configuration/printergroupusetype/review.jsp")
    }
)
public class ReviewAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        if(printerGroupUseType == null) {
            ...
            request.setAttribute(AttributeConstants.PRINTER_GROUP_USE_TYPE, printerGroupUseType);
