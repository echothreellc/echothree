    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    var commandForm = CancellationPolicyUtil.getHome().getCreateCancellationReasonForm();
                    ...
                    var commandResult = CancellationPolicyUtil.getHome().createCancellationReason(getUserVisitPK(request), commandForm);
