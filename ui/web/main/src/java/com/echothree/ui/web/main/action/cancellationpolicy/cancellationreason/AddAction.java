...
@SproutAction(
    path = "/CancellationPolicy/CancellationReason/Add",
    mappingClass = SecureActionMapping.class,
    name = "CancellationReasonAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/CancellationPolicy/CancellationReason/Main", redirect = true),
        @SproutForward(name = "Form", path = "/cancellationpolicy/cancellationreason/add.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreateCancellationReasonForm commandForm = CancellationPolicyUtil.getHome().getCreateCancellationReasonForm();
                    ...
                    commandForm.setCancellationReasonName(actionForm.getCancellationReasonName());
                    commandForm.setIsDefault(actionForm.getIsDefault().toString());
                    commandForm.setSortOrder(actionForm.getSortOrder());
                    commandForm.setDescription(actionForm.getDescription());
                    
                    CommandResult commandResult = CancellationPolicyUtil.getHome().createCancellationReason(getUserVisitPK(request), commandForm);
