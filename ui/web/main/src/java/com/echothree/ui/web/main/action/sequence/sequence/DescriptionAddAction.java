        ...
        try {
            if(forwardKey == null) {
                if(wasPost(request)) {
                    ...
                    var commandForm = SequenceUtil.getHome().getCreateSequenceDescriptionForm();
                    ...
                    var commandResult = SequenceUtil.getHome().createSequenceDescription(getUserVisitPK(request), commandForm);
