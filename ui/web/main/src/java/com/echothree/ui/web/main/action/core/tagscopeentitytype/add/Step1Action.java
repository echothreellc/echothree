...
import com.echothree.control.user.core.remote.result.GetComponentVendorsResult;
...
@SproutAction(
    path = "/Core/TagScopeEntityType/Add/Step1",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Form", path = "/core/tagscopeentitytype/add/step1.jsp")
    }
)
public class Step1Action
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        setupTagScopeTransfer(request, request.getParameter(ParameterConstants.TAG_SCOPE_NAME));
