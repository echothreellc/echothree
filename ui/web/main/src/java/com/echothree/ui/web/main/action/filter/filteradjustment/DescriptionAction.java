...
@SproutAction(
    path = "/Filter/FilterAdjustment/Description",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/filter/filteradjustment/description.jsp")
    }
)
public class DescriptionAction
    ...
    throws Exception {
        ...
        try {
            ...
            request.setAttribute("filterAdjustmentDescriptions", getFilterAdjustmentDescriptionsResult.getFilterAdjustmentDescriptions());
