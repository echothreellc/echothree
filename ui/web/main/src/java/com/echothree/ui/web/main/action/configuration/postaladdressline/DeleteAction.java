...
@SproutAction(
    path = "/Configuration/PostalAddressLine/Delete",
...
public class DeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            DeletePostalAddressLineForm commandForm = ContactUtil.getHome().getDeletePostalAddressLineForm();
            ...
            ContactUtil.getHome().deletePostalAddressLine(getUserVisitPK(request), commandForm);
