...
import com.echothree.control.user.accounting.remote.form.DeleteItemAccountingCategoryForm;
...
@SproutAction(
    path = "/Accounting/ItemAccountingCategory/Delete",
...
public class DeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            AccountingUtil.getHome().deleteItemAccountingCategory(getUserVisitPK(request), commandForm);
