...
import com.echothree.control.user.inventory.remote.form.DeleteInventoryConditionForm;
...
@SproutAction(
    path = "/Inventory/InventoryCondition/Delete",
...
public class DeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            InventoryUtil.getHome().deleteInventoryCondition(getUserVisitPK(request), commandForm);
