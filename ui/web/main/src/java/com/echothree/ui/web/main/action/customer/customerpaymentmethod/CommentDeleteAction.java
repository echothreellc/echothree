...
@SproutAction(
    path = "/Customer/CustomerPaymentMethod/CommentDelete",
    mappingClass = SecureActionMapping.class,
    name = "CustomerPaymentMethodCommentDelete",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Customer/CustomerPaymentMethod/Review", redirect = true),
        @SproutForward(name = "Form", path = "/customer/customerpaymentmethod/commentDelete.jsp")
    }
)
public class CommentDeleteAction
    ...
    public void setupPartyPaymentMethodTransfer(CommentDeleteActionForm actionForm, HttpServletRequest request)
    ...
    public void setupTransfer(CommentDeleteActionForm actionForm, HttpServletRequest request)
            throws NamingException {
        setupPartyPaymentMethodTransfer(actionForm, request);
