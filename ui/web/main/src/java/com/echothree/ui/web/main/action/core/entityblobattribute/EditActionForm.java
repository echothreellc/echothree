...
@SproutForm(name="EntityBlobAttributeEdit")
public class EditActionForm
    ...
    private FormFile blobAttribute;
    ...
    public FormFile getBlobAttribute() {
        return blobAttribute;
    }
    
    public void setBlobAttribute(FormFile blobAttribute) {
