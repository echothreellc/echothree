...
@SproutAction(
    path = "/Configuration/WorkEffortType/DescriptionAdd",
    mappingClass = SecureActionMapping.class,
    name = "WorkEffortTypeDescriptionAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Configuration/WorkEffortType/Description", redirect = true),
        @SproutForward(name = "Form", path = "/configuration/workefforttype/descriptionAdd.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreateWorkEffortTypeDescriptionForm commandForm = WorkEffortUtil.getHome().getCreateWorkEffortTypeDescriptionForm();
                    ...
                    CommandResult commandResult = WorkEffortUtil.getHome().createWorkEffortTypeDescription(getUserVisitPK(request), commandForm);
