...
@SproutAction(
    path = "/Core/EntityListItem/DescriptionAdd",
    mappingClass = SecureActionMapping.class,
    name = "CoreEntityListItemDescriptionAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Core/EntityListItem/Description", redirect = true),
        @SproutForward(name = "Form", path = "/core/entitylistitem/descriptionAdd.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreateEntityListItemDescriptionForm commandForm = CoreUtil.getHome().getCreateEntityListItemDescriptionForm();
                    ...
                    CommandResult commandResult = CoreUtil.getHome().createEntityListItemDescription(getUserVisitPK(request), commandForm);
