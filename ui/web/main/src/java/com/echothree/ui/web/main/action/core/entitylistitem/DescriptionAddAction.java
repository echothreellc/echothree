    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    var commandForm = CoreUtil.getHome().getCreateEntityListItemDescriptionForm();
                    ...
                    var commandResult = CoreUtil.getHome().createEntityListItemDescription(getUserVisitPK(request), commandForm);
