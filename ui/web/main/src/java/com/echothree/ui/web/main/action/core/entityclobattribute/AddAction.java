...
import com.echothree.control.user.core.remote.form.CreateEntityClobAttributeForm;
...
@SproutAction(
    path = "/Core/EntityClobAttribute/Add",
    mappingClass = SecureActionMapping.class,
    name = "EntityClobAttributeAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Form", path = "/core/entityclobattribute/add.jsp")
    }
)
