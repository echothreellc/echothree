...
@SproutAction(
    path = "/Purchasing/VendorContactMechanism/CommentEdit",
    mappingClass = SecureActionMapping.class,
    name = "VendorContactMechanismCommentEdit",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Purchasing/VendorContactMechanism/Review", redirect = true),
        @SproutForward(name = "Form", path = "/purchasing/vendorcontactmechanism/commentEdit.jsp")
    }
)
public class CommentEditAction
    ...
    public void setupTransfer(CommentEditActionForm actionForm, HttpServletRequest request)
            throws NamingException {
        BaseVendorContactMechanismAction.setupContactMechanismTransfer(request, actionForm.getContactMechanismName());
