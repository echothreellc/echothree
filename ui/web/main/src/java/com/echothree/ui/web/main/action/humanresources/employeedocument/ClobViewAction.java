...
@SproutAction(
    path = "/HumanResources/EmployeeDocument/ClobView",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/humanresources/employeedocument/clobView.jsp")
    }
)
public class ClobViewAction
        extends BaseEmployeeDocumentAction {
