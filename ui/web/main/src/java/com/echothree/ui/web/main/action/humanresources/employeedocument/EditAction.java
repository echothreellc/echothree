...
@SproutAction(
    ...
    forwards = {
        ...
        @SproutForward(name = "Form", path = "/humanresources/employeedocument/edit.jsp")
    }
)
public class EditAction
    ...
    private PartyDocumentTransfer getPartyDocumentTransfer(EditActionForm actionForm, HttpServletRequest request)
            throws NamingException {
        return BaseEmployeeDocumentAction.setupPartyDocumentTransfer(request, actionForm.getDocumentName(), null);
    }

    private PartyDocumentTransfer getPartyDocumentTransfer(DocumentSpec spec, HttpServletRequest request)
            throws NamingException {
        return BaseEmployeeDocumentAction.setupPartyDocumentTransfer(request, spec.getDocumentName(), null);
    }
