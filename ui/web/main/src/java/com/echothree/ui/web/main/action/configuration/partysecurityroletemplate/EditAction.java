...
import com.echothree.control.user.security.remote.edit.PartySecurityRoleTemplateEdit;
import com.echothree.control.user.security.remote.form.EditPartySecurityRoleTemplateForm;
import com.echothree.control.user.security.remote.result.EditPartySecurityRoleTemplateResult;
import com.echothree.control.user.security.remote.spec.PartySecurityRoleTemplateSpec;
...
@SproutAction(
    path = "/Configuration/PartySecurityRoleTemplate/Edit",
    mappingClass = SecureActionMapping.class,
    name = "PartySecurityRoleTemplateEdit",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Configuration/PartySecurityRoleTemplate/Main", redirect = true),
        @SproutForward(name = "Form", path = "/configuration/partysecurityroletemplate/edit.jsp")
    }
)
            ...
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    ...
                    if(wasCancelled) {
                        ...
                        edit.setPartySecurityRoleTemplateName(actionForm.getPartySecurityRoleTemplateName());
                    ...
                    if(result != null) {
                        ...
                        if(edit != null) {
                            ...
                            actionForm.setPartySecurityRoleTemplateName(edit.getPartySecurityRoleTemplateName());
