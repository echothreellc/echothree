    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    var commandForm = OfferUtil.getHome().getCreateUseTypeDescriptionForm();
                    ...
                    var commandResult = OfferUtil.getHome().createUseTypeDescription(getUserVisitPK(request), commandForm);
