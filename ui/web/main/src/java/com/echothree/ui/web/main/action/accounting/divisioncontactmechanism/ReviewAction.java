...
@SproutAction(
    path = "/Accounting/DivisionContactMechanism/Review",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/accounting/divisioncontactmechanism/review.jsp")
    }
)
public class ReviewAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        if(partyContactMechanism == null) {
            ...
            BaseDivisionContactMechanismAction.setupDivision(request, partyName);
