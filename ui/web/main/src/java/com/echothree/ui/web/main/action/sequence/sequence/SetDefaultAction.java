...
import com.echothree.control.user.sequence.remote.form.SetDefaultSequenceForm;
...
@SproutAction(
    path = "/Sequence/Sequence/SetDefault",
...
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            ...
            SetDefaultSequenceForm commandForm = SequenceUtil.getHome().getSetDefaultSequenceForm();
            
            commandForm.setSequenceTypeName(sequenceTypeName);
            commandForm.setSequenceName(sequenceName);
            
            SequenceUtil.getHome().setDefaultSequence(getUserVisitPK(request), commandForm);
