    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                var commandForm = InventoryUtil.getHome().getEditInventoryLocationGroupDescriptionForm();
                var spec = InventoryUtil.getHome().getInventoryLocationGroupDescriptionSpec();
                ...
                if(wasPost(request)) {
                    var edit = InventoryUtil.getHome().getInventoryLocationGroupDescriptionEdit();
                    
                    commandForm.setEditMode(EditMode.UPDATE);
                    commandForm.setEdit(edit);
                    edit.setDescription(actionForm.getDescription());

                    var commandResult = InventoryUtil.getHome().editInventoryLocationGroupDescription(getUserVisitPK(request), commandForm);
                    
                    if(commandResult.hasErrors()) {
                        var executionResult = commandResult.getExecutionResult();
                        
                        if(executionResult != null) {
                            var result = (EditInventoryLocationGroupDescriptionResult)executionResult.getResult();
