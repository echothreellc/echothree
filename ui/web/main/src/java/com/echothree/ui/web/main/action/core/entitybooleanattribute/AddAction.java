...
@SproutAction(
    path = "/Core/EntityBooleanAttribute/Add",
    mappingClass = SecureActionMapping.class,
    name = "EntityBooleanAttributeAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Form", path = "/core/entitybooleanattribute/add.jsp")
    }
)
public class AddAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(wasPost(request)) {
                CreateEntityBooleanAttributeForm commandForm = CoreUtil.getHome().getCreateEntityBooleanAttributeForm();
                ...
                commandForm.setBooleanAttribute(actionForm.getBooleanAttribute().toString());
                
                CommandResult commandResult = CoreUtil.getHome().createEntityBooleanAttribute(getUserVisitPK(request), commandForm);
