...
@SproutAction(
    path = "/Purchasing/VendorItem/CommentDelete",
    mappingClass = SecureActionMapping.class,
    name = "VendorItemCommentDelete",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Purchasing/VendorItem/Review", redirect = true),
        @SproutForward(name = "Form", path = "/purchasing/vendoritem/commentDelete.jsp")
    }
)
public class CommentDeleteAction
    ...
    public void setupVendorItemTransfer(CommentDeleteActionForm actionForm, HttpServletRequest request)
    ...
    public void setupTransfer(CommentDeleteActionForm actionForm, HttpServletRequest request)
            throws NamingException {
        setupVendorItemTransfer(actionForm, request);
