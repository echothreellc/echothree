...
@SproutAction(
    path = "/Warehouse/LocationNameElement/DescriptionAdd",
    mappingClass = SecureActionMapping.class,
    name = "LocationNameElementDescriptionAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Warehouse/LocationNameElement/Description", redirect = true),
        @SproutForward(name = "Form", path = "/warehouse/locationnameelement/descriptionAdd.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreateLocationNameElementDescriptionForm commandForm = WarehouseUtil.getHome().getCreateLocationNameElementDescriptionForm();
                    ...
                    CommandResult commandResult = WarehouseUtil.getHome().createLocationNameElementDescription(getUserVisitPK(request), commandForm);
