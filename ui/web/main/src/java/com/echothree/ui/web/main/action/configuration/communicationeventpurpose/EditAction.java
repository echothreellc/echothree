...
@SproutAction(
    path = "/Configuration/CommunicationEventPurpose/Edit",
    mappingClass = SecureActionMapping.class,
    name = "CommunicationEventPurposeEdit",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Configuration/CommunicationEventPurpose/Main", redirect = true),
        @SproutForward(name = "Form", path = "/configuration/communicationeventpurpose/edit.jsp")
    }
)
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    ...
                    edit.setCommunicationEventPurposeName(actionForm.getCommunicationEventPurposeName());
                    ...
                    if(result != null) {
                        ...
                        if(edit != null) {
                            ...
                            actionForm.setCommunicationEventPurposeName(edit.getCommunicationEventPurposeName());
