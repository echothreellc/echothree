...
import com.echothree.control.user.content.common.form.SetDefaultContentForumForm;
...
@SproutAction(
    path = "/Content/ContentForum/SetDefault",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Content/ContentForum/Main", redirect = true)
    }
)
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            ...
            SetDefaultContentForumForm commandForm = ContentUtil.getHome().getSetDefaultContentForumForm();
            
            commandForm.setContentCollectionName(contentCollectionName);
            commandForm.setForumName(forumName);
            
            ContentUtil.getHome().setDefaultContentForum(getUserVisitPK(request), commandForm);
