...
@SproutAction(
    path = "/Warehouse/WarehouseContactMechanism/CommentAdd",
    mappingClass = SecureActionMapping.class,
    name = "WarehouseContactMechanismCommentAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Warehouse/WarehouseContactMechanism/Review", redirect = true),
        @SproutForward(name = "Form", path = "/warehouse/warehousecontactmechanism/commentAdd.jsp")
    }
)
