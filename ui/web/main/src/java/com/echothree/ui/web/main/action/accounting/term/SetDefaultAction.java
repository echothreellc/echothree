...
import com.echothree.control.user.term.remote.form.SetDefaultTermForm;
...
@SproutAction(
    path = "/Accounting/Term/SetDefault",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Accounting/Term/Main", redirect = true)
    }
)
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            ...
            TermUtil.getHome().setDefaultTerm(getUserVisitPK(request), commandForm);
