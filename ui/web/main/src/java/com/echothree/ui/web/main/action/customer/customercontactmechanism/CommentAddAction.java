...
@SproutAction(
    path = "/Customer/CustomerContactMechanism/CommentAdd",
    mappingClass = SecureActionMapping.class,
    name = "CustomerContactMechanismCommentAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Customer/CustomerContactMechanism/Review", redirect = true),
        @SproutForward(name = "Form", path = "/customer/customercontactmechanism/commentAdd.jsp")
    }
)
