...
import com.echothree.control.user.uom.remote.form.CreateUnitOfMeasureTypeWeightForm;
...
@SproutAction(
    path = "/UnitOfMeasure/UnitOfMeasureType/WeightAdd",
    mappingClass = SecureActionMapping.class,
    name = "UnitOfMeasureTypeWeightAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/UnitOfMeasure/UnitOfMeasureType/Main", redirect = true),
        @SproutForward(name = "Form", path = "/uom/unitofmeasuretype/weightAdd.jsp")
    }
)
public class WeightAddAction
