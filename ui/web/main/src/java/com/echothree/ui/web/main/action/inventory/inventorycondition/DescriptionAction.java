...
@SproutAction(
    path = "/Inventory/InventoryCondition/Description",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/inventory/inventorycondition/description.jsp")
    }
)
public class DescriptionAction
    ...
    throws Exception {
        ...
        try {
            ...
            request.setAttribute(AttributeConstants.INVENTORY_CONDITION_DESCRIPTIONS, result.getInventoryConditionDescriptions());
