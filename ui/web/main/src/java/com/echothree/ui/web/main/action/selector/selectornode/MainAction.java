...
public class MainAction
    ...
    throws Exception {
        ...
        try {
            var commandForm = SelectorUtil.getHome().getGetSelectorNodesForm();
            ...
            var commandResult = SelectorUtil.getHome().getSelectorNodes(getUserVisitPK(request), commandForm);
