...
import com.echothree.control.user.contact.remote.form.GetPostalAddressFormatDescriptionsForm;
import com.echothree.control.user.contact.remote.result.GetPostalAddressFormatDescriptionsResult;
...
@SproutAction(
    path = "/Configuration/PostalAddressFormat/Description",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/configuration/postaladdressformat/description.jsp")
    }
)
