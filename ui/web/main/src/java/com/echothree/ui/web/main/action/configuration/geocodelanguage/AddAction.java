...
@SproutAction(
    path = "/Configuration/GeoCodeLanguage/Add",
    mappingClass = SecureActionMapping.class,
    name = "GeoCodeLanguageAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Configuration/GeoCodeLanguage/Main", redirect = true),
        @SproutForward(name = "Form", path = "/configuration/geocodelanguage/add.jsp")
    }
)
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreateGeoCodeLanguageForm commandForm = GeoUtil.getHome().getCreateGeoCodeLanguageForm();
                    ...
                    CommandResult commandResult = GeoUtil.getHome().createGeoCodeLanguage(getUserVisitPK(request), commandForm);
