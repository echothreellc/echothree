...
@SproutAction(
    path = "/Selector/SelectorNode/Add/EntityListItemStep2",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/selector/selectornode/add/entityListItemStep2.jsp")
    }
)
public class EntityListItemStep2Action
