...
@SproutAction(
    path = "/Configuration/GeoCodeDateTimeFormat/Delete",
...
public class DeleteAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            DeleteGeoCodeDateTimeFormatForm commandForm = GeoUtil.getHome().getDeleteGeoCodeDateTimeFormatForm();
            ...
            GeoUtil.getHome().deleteGeoCodeDateTimeFormat(getUserVisitPK(request), commandForm);
