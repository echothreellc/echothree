...
@SproutAction(
    path = "/Customer/CustomerDocument/Edit",
    mappingClass = SecureActionMapping.class,
    name = "CustomerDocumentEdit",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Customer/CustomerDocument/Main", redirect = true),
        @SproutForward(name = "Form", path = "/customer/customerdocument/edit.jsp")
    }
)
public class EditAction
    ...
    private PartyDocumentTransfer getPartyDocumentTransfer(EditActionForm actionForm, HttpServletRequest request)
            throws NamingException {
        return BaseCustomerDocumentAction.setupPartyDocumentTransfer(request, actionForm.getDocumentName(), null);
    }

    private PartyDocumentTransfer getPartyDocumentTransfer(DocumentSpec spec, HttpServletRequest request)
            throws NamingException {
        return BaseCustomerDocumentAction.setupPartyDocumentTransfer(request, spec.getDocumentName(), null);
    }
