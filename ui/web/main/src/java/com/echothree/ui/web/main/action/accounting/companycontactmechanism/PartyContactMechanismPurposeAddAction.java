...
@SproutAction(
    path = "/Accounting/CompanyContactMechanism/PartyContactMechanismPurposeAdd",
    mappingClass = SecureActionMapping.class,
    name = "CompanyPartyContactMechanismPurposeAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Accounting/CompanyContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/accounting/companycontactmechanism/partyContactMechanismPurposeAdd.jsp")
    }
)
public class PartyContactMechanismPurposeAddAction
        extends BaseCompanyContactMechanismAction<PartyContactMechanismPurposeAddActionForm> {
