...
@SproutAction(
    path = "/Filter/FilterEntranceStep/Delete",
...
public class DeleteAction
    ...
    throws Exception {
        ...
        String filterStepName = request.getParameter(ParameterConstants.FILTER_STEP_NAME);
            DeleteFilterEntranceStepForm commandForm = FilterUtil.getHome().getDeleteFilterEntranceStepForm();
            ...
            FilterUtil.getHome().deleteFilterEntranceStep(getUserVisitPK(request), commandForm);
