...
@SproutAction(
    path = "/Core/EntityListItem/Add",
    mappingClass = SecureActionMapping.class,
    name = "EntityListItemAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Core/EntityListItem/Main", redirect = true),
        @SproutForward(name = "Form", path = "/core/entitylistitem/add.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreateEntityListItemForm commandForm = CoreUtil.getHome().getCreateEntityListItemForm();
                    ...
                    CommandResult commandResult = CoreUtil.getHome().createEntityListItem(getUserVisitPK(request), commandForm);
