...
@SproutAction(
    path = "/Configuration/Job/DescriptionDelete",
...
public class DescriptionDeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            DeleteJobDescriptionForm commandForm = JobUtil.getHome().getDeleteJobDescriptionForm();
            
            commandForm.setJobName(jobName);
            commandForm.setLanguageIsoName(languageIsoName);
            
            JobUtil.getHome().deleteJobDescription(getUserVisitPK(request), commandForm);
