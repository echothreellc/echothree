...
import com.echothree.control.user.sequence.remote.result.GetSequenceTypesResult;
...
@SproutAction(
    path = "/Sequence/SequenceType/Main",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/sequence/sequencetype/main.jsp")
    }
)
