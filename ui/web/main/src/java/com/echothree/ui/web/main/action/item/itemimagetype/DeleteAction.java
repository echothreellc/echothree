...
import com.echothree.control.user.item.remote.form.GetItemImageTypeForm;
import com.echothree.control.user.item.remote.result.GetItemImageTypeResult;
...
@SproutAction(
    path = "/Item/ItemImageType/Delete",
    mappingClass = SecureActionMapping.class,
    name = "ItemImageTypeDelete",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Item/ItemImageType/Main", redirect = true),
        @SproutForward(name = "Form", path = "/item/itemimagetype/delete.jsp")
    }
)
public class DeleteAction
    ...
    public String getEntityTypeName() {
        return EntityTypes.ItemImageType.name();
    }
    ...
    public CommandResult doDelete(DeleteActionForm actionForm, HttpServletRequest request)
        ...
        return ItemUtil.getHome().deleteItemImageType(getUserVisitPK(request), commandForm);
    }
