...
@SproutAction(
    path = "/Accounting/DepartmentContactMechanism/ContactMechanismAdd/ContactEmailAddressAdd",
    mappingClass = SecureActionMapping.class,
    name = "DepartmentContactEmailAddressAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Accounting/DepartmentContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/accounting/departmentcontactmechanism/contactmechanismadd/contactEmailAddressAdd.jsp")
    }
)
public class ContactEmailAddressAddAction
        extends BaseDepartmentContactMechanismAction<ContactEmailAddressAddActionForm> {
