...
import com.echothree.control.user.printer.remote.form.SetDefaultPrinterGroupUseTypeForm;
...
@SproutAction(
    path = "/Configuration/PrinterGroupUseType/SetDefault",
...
public class SetDefaultAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        PrinterUtil.getHome().setDefaultPrinterGroupUseType(getUserVisitPK(request), commandForm);
