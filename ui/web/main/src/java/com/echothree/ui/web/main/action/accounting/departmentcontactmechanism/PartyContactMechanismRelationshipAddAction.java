...
import com.echothree.control.user.contact.remote.form.CreatePartyContactMechanismRelationshipForm;
...
@SproutAction(
    path = "/Accounting/DepartmentContactMechanism/PartyContactMechanismRelationshipAdd",
    mappingClass = SecureActionMapping.class,
    name = "DepartmentPartyContactMechanismRelationshipAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Accounting/DepartmentContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/accounting/departmentcontactmechanism/partyContactMechanismRelationshipAdd.jsp")
    }
)
public class PartyContactMechanismRelationshipAddAction
        extends BaseDepartmentContactMechanismAction<PartyContactMechanismRelationshipAddActionForm> {
