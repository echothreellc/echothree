...
import com.echothree.control.user.content.remote.form.GetContentForumsForm;
import com.echothree.control.user.content.remote.result.GetContentForumsResult;
...
@SproutAction(
    path = "/Content/ContentForum/Main",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/content/contentforum/main.jsp")
    }
)
public class MainAction
    ...
    throws Exception {
        ...
        try {
            ...
            request.setAttribute(AttributeConstants.CONTENT_FORUMS, result.getContentForums());
