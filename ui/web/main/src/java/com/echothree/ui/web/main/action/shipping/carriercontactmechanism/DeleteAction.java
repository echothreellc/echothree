...
@SproutAction(
    path = "/Shipping/CarrierContactMechanism/Delete",
    mappingClass = SecureActionMapping.class,
    name = "CarrierContactMechanismDelete",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Shipping/CarrierContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/shipping/carriercontactmechanism/delete.jsp")
    }
)
public class DeleteAction
    ...
    public void setupTransfer(DeleteActionForm actionForm, HttpServletRequest request)
        ...
        BaseCarrierContactMechanismAction.setupPartyContactMechanismTransfer(request, actionForm.getPartyName(), actionForm.getContactMechanismName());
