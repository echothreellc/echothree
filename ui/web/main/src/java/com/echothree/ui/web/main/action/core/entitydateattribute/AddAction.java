...
public class AddAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(wasPost(request)) {
                CreateEntityDateAttributeForm commandForm = CoreUtil.getHome().getCreateEntityDateAttributeForm();
                ...
                CommandResult commandResult = CoreUtil.getHome().createEntityDateAttribute(getUserVisitPK(request), commandForm);
