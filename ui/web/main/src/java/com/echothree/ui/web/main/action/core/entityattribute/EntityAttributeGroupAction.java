...
@SproutAction(
    path = "/Core/EntityAttribute/EntityAttributeGroup",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/core/entityattribute/entityAttributeGroup.jsp")
    }
)
public class EntityAttributeGroupAction
