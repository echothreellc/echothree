...
import com.echothree.control.user.forum.remote.form.CreateForumMimeTypeForm;
...
@SproutAction(
    path = "/Forum/ForumMimeType/Add",
    mappingClass = SecureActionMapping.class,
    name = "ForumMimeTypeAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Forum/ForumMimeType/Main", redirect = true),
        @SproutForward(name = "Form", path = "/forum/forummimetype/add.jsp")
    }
)
