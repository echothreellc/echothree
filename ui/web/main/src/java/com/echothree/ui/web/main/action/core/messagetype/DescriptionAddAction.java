...
@SproutAction(
    path = "/Core/MessageType/DescriptionAdd",
    mappingClass = SecureActionMapping.class,
    name = "CoreMessageTypeDescriptionAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Core/MessageType/Description", redirect = true),
        @SproutForward(name = "Form", path = "/core/messagetype/descriptionAdd.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreateMessageTypeDescriptionForm commandForm = MessageUtil.getHome().getCreateMessageTypeDescriptionForm();
                    ...
                    CommandResult commandResult = MessageUtil.getHome().createMessageTypeDescription(getUserVisitPK(request), commandForm);
