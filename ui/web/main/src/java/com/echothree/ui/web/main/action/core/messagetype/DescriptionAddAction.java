    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    var commandForm = MessageUtil.getHome().getCreateMessageTypeDescriptionForm();
                    ...
                    var commandResult = MessageUtil.getHome().createMessageTypeDescription(getUserVisitPK(request), commandForm);
