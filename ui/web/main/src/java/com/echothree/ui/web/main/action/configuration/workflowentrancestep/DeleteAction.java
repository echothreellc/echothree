...
import com.echothree.control.user.workflow.remote.form.DeleteWorkflowEntranceStepForm;
import com.echothree.control.user.workflow.remote.form.GetWorkflowEntranceStepForm;
import com.echothree.control.user.workflow.remote.result.GetWorkflowEntranceStepResult;
...
@SproutAction(
    path = "/Configuration/WorkflowEntranceStep/Delete",
    mappingClass = SecureActionMapping.class,
    name = "WorkflowEntranceStepDelete",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Configuration/WorkflowEntranceStep/Main", redirect = true),
        @SproutForward(name = "Form", path = "/configuration/workflowentrancestep/delete.jsp")
    }
)
public class DeleteAction
    ...
    public String getEntityTypeName() {
        return EntityTypes.WorkflowEntranceStep.name();
    }
    ...
    public void setupParameters(DeleteActionForm actionForm, HttpServletRequest request) {
        ...
        actionForm.setEntranceWorkflowName(findParameter(request, ParameterConstants.ENTRANCE_WORKFLOW_NAME, actionForm.getEntranceWorkflowName()));
        actionForm.setEntranceWorkflowStepName(findParameter(request, ParameterConstants.ENTRANCE_WORKFLOW_STEP_NAME, actionForm.getEntranceWorkflowStepName()));
    }
    ...
    public CommandResult doDelete(DeleteActionForm actionForm, HttpServletRequest request)
        ...
        return WorkflowUtil.getHome().deleteWorkflowEntranceStep(getUserVisitPK(request), commandForm);
    }
