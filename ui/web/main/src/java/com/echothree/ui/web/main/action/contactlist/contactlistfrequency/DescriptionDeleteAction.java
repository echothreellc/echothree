...
import com.echothree.control.user.contactlist.remote.form.DeleteContactListFrequencyDescriptionForm;
import com.echothree.control.user.contactlist.remote.form.GetContactListFrequencyDescriptionForm;
import com.echothree.control.user.contactlist.remote.result.GetContactListFrequencyDescriptionResult;
...
@SproutAction(
    path = "/ContactList/ContactListFrequency/DescriptionDelete",
    mappingClass = SecureActionMapping.class,
    name = "ContactListFrequencyDescriptionDelete",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/ContactList/ContactListFrequency/Description", redirect = true),
        @SproutForward(name = "Form", path = "/contactlist/contactlistfrequency/descriptionDelete.jsp")
    }
)
public class DescriptionDeleteAction
    ...
    public String getEntityTypeName() {
        return EntityTypes.ContactListFrequencyDescription.name();
    }
    ...
    public CommandResult doDelete(DescriptionDeleteActionForm actionForm, HttpServletRequest request)
        ...
        return ContactListUtil.getHome().deleteContactListFrequencyDescription(getUserVisitPK(request), commandForm);
    }
