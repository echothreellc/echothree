...
import com.echothree.control.user.message.remote.form.GetMessageDescriptionsForm;
import com.echothree.control.user.message.remote.result.GetMessageDescriptionsResult;
...
@SproutAction(
    path = "/Core/Message/Description",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/core/message/description.jsp")
    }
)
