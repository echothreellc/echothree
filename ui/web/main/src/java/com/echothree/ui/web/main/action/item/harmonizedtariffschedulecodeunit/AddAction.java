...
@SproutAction(
    path = "/Item/HarmonizedTariffScheduleCodeUnit/Add",
    mappingClass = SecureActionMapping.class,
    name = "HarmonizedTariffScheduleCodeUnitAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Item/HarmonizedTariffScheduleCodeUnit/Main", redirect = true),
        @SproutForward(name = "Form", path = "/item/harmonizedtariffschedulecodeunit/add.jsp")
    }
)
public class AddAction
    ...
    public CommandResult doAdd(AddActionForm actionForm, HttpServletRequest request)
        ...
        return ItemUtil.getHome().createHarmonizedTariffScheduleCodeUnit(getUserVisitPK(request), commandForm);
    }
