...
@SproutAction(
    path = "/Customer/CustomerContactMechanism/Review",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/customer/customercontactmechanism/review.jsp")
    }
)
public class ReviewAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        if(partyContactMechanism == null) {
            ...
            BaseCustomerContactMechanismAction.setupCustomer(request, partyName);
