...
@SproutAction(
    path = "/HumanResources/EmployeeDocument/DescriptionEdit",
    mappingClass = SecureActionMapping.class,
    name = "EmployeeDocumentDescriptionEdit",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/HumanResources/EmployeeDocument/Description", redirect = true),
        @SproutForward(name = "Form", path = "/humanresources/employeedocument/descriptionEdit.jsp")
    }
)
