...
import com.echothree.control.user.communication.remote.form.DeleteCommunicationEventPurposeForm;
...
@SproutAction(
    path = "/Configuration/CommunicationEventPurpose/Delete",
...
public class DeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            CommunicationUtil.getHome().deleteCommunicationEventPurpose(getUserVisitPK(request), commandForm);
