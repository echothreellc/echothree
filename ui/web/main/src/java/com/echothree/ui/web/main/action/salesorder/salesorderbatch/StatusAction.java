...
import com.echothree.control.user.sales.remote.form.SetSalesOrderBatchStatusForm;
...
@SproutAction(
    path = "/SalesOrder/SalesOrderBatch/Status",
    mappingClass = SecureActionMapping.class,
    name = "SalesOrderBatchStatus",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/SalesOrder/SalesOrderBatch/Main", redirect = true),
        @SproutForward(name = "Form", path = "/salesorder/salesorderbatch/status.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            ...
            if(wasPost(request)) {
                ...
                actionForm.setBatchName(batchName);
                actionForm.setupSalesOrderBatchStatusChoices();
                forwardKey = ForwardConstants.FORM;
            }
