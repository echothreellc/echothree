...
@SproutAction(
    path = "/ReturnPolicy/ReturnPolicy/SetDefault",
...
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            SetDefaultReturnPolicyForm commandForm = ReturnPolicyUtil.getHome().getSetDefaultReturnPolicyForm();
            ...
            ReturnPolicyUtil.getHome().setDefaultReturnPolicy(getUserVisitPK(request), commandForm);
