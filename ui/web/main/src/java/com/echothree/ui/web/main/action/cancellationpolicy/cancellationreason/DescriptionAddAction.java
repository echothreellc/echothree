...
@SproutAction(
    path = "/CancellationPolicy/CancellationReason/DescriptionAdd",
    mappingClass = SecureActionMapping.class,
    name = "CancellationReasonDescriptionAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/CancellationPolicy/CancellationReason/Description", redirect = true),
        @SproutForward(name = "Form", path = "/cancellationpolicy/cancellationreason/descriptionAdd.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreateCancellationReasonDescriptionForm commandForm = CancellationPolicyUtil.getHome().getCreateCancellationReasonDescriptionForm();
                    ...
                    CommandResult commandResult = CancellationPolicyUtil.getHome().createCancellationReasonDescription(getUserVisitPK(request), commandForm);
