...
import com.echothree.control.user.contactlist.remote.form.SetDefaultContactListFrequencyForm;
...
@SproutAction(
    path = "/ContactList/ContactListFrequency/SetDefault",
...
public class SetDefaultAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        ContactListUtil.getHome().setDefaultContactListFrequency(getUserVisitPK(request), commandForm);
