...
import com.echothree.control.user.content.remote.form.GetContentCollectionForm;
import com.echothree.control.user.content.remote.result.GetContentCollectionResult;
...
@SproutAction(
    path = "/Content/ContentCollection/Delete",
    mappingClass = SecureActionMapping.class,
    name = "ContentCollectionDelete",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Content/ContentCollection/Main", redirect = true),
        @SproutForward(name = "Form", path = "/content/contentcollection/delete.jsp")
    }
)
public class DeleteAction
    ...
    public String getEntityTypeName() {
        return EntityTypes.ContentCollection.name();
    }
    ...
    public CommandResult doDelete(DeleteActionForm actionForm, HttpServletRequest request)
        ...
        return ContentUtil.getHome().deleteContentCollection(getUserVisitPK(request), commandForm);
    }
