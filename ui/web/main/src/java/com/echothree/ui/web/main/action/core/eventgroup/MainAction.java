...
import com.echothree.control.user.core.remote.result.GetEventGroupsResult;
...
@SproutAction(
    path = "/Core/EventGroup/Main",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/core/eventgroup/main.jsp")
    }
)
