...
@SproutAction(
    path = "/Selector/SelectorNode/Add/EntityListItemStep3",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/selector/selectornode/add/entityListItemStep3.jsp")
    }
)
public class EntityListItemStep3Action
