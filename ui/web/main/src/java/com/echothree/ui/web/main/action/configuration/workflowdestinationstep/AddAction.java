...
@SproutAction(
    path = "/Configuration/WorkflowDestinationStep/Add",
    mappingClass = SecureActionMapping.class,
    name = "WorkflowDestinationStepAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Configuration/WorkflowDestinationStep/Main", redirect = true),
        @SproutForward(name = "Form", path = "/configuration/workflowdestinationstep/add.jsp")
    }
)
public class AddAction
    ...
    public void setupParameters(AddActionForm actionForm, HttpServletRequest request) {
        ...
        actionForm.setDestinationWorkflowName(findParameter(request, ParameterConstants.WORKFLOW_NAME, actionForm.getDestinationWorkflowName()));
    }
    ...
    public CommandResult doAdd(AddActionForm actionForm, HttpServletRequest request)
        ...
        commandForm.setDestinationWorkflowStepName(actionForm.getDestinationWorkflowStepChoice());

        return WorkflowUtil.getHome().createWorkflowDestinationStep(getUserVisitPK(request), commandForm);
    }
