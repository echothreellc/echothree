...
import com.echothree.control.user.core.remote.form.SetDefaultEntityAttributeGroupForm;
...
@SproutAction(
    path = "/Core/EntityAttributeGroup/SetDefault",
...
public class SetDefaultAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        CoreUtil.getHome().setDefaultEntityAttributeGroup(getUserVisitPK(request), commandForm);
