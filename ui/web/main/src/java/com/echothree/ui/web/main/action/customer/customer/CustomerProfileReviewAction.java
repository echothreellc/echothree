...
@SproutAction(
    path = "/Customer/Customer/CustomerProfileReview",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/customer/customer/customerProfileReview.jsp")
    }
)
public class CustomerProfileReviewAction
