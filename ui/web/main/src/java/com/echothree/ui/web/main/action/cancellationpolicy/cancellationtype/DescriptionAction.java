...
import com.echothree.control.user.cancellationpolicy.remote.form.GetCancellationTypeDescriptionsForm;
import com.echothree.control.user.cancellationpolicy.remote.result.GetCancellationTypeDescriptionsResult;
...
@SproutAction(
    path = "/CancellationPolicy/CancellationType/Description",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/cancellationpolicy/cancellationtype/description.jsp")
    }
)
