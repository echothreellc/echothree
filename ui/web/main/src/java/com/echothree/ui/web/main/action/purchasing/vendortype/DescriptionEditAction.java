...
import com.echothree.control.user.vendor.remote.form.EditVendorTypeDescriptionForm;
import com.echothree.control.user.vendor.remote.result.EditVendorTypeDescriptionResult;
...
@SproutAction(
    path = "/Purchasing/VendorType/DescriptionEdit",
    mappingClass = SecureActionMapping.class,
    name = "VendorTypeDescriptionEdit",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Purchasing/VendorType/Description", redirect = true),
        @SproutForward(name = "Form", path = "/purchasing/vendortype/descriptionEdit.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                spec.setVendorTypeName(vendorTypeName);
