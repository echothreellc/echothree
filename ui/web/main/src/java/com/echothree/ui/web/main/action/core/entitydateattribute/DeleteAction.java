...
import com.echothree.control.user.core.remote.form.DeleteEntityDateAttributeForm;
...
@SproutAction(
    path = "/Core/EntityDateAttribute/Delete",
...
public class DeleteAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            DeleteEntityDateAttributeForm commandForm = CoreUtil.getHome().getDeleteEntityDateAttributeForm();
            
            commandForm.setEntityRef(entityRef);
            commandForm.setEntityAttributeName(entityAttributeName);
            
            CoreUtil.getHome().deleteEntityDateAttribute(getUserVisitPK(request), commandForm);
