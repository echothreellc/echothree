    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreateAssociateProgramDescriptionForm commandForm = AssociateUtil.getHome().getCreateAssociateProgramDescriptionForm();
                    ...
                    CommandResult commandResult = AssociateUtil.getHome().createAssociateProgramDescription(getUserVisitPK(request), commandForm);
