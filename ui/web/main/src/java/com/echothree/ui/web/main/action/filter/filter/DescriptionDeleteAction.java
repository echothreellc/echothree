...
@SproutAction(
    path = "/Filter/Filter/DescriptionDelete",
...
public class DescriptionDeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            deleteFilterDescriptionForm.setFilterName(filterName);
            deleteFilterDescriptionForm.setLanguageIsoName(languageIsoName);
            
            FilterUtil.getHome().deleteFilterDescription(getUserVisitPK(request), deleteFilterDescriptionForm);
