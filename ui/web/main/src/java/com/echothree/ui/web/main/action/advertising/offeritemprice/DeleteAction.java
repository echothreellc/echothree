...
import com.echothree.control.user.offer.remote.form.DeleteOfferItemPriceForm;
import com.echothree.control.user.offer.remote.form.GetOfferItemPriceForm;
import com.echothree.control.user.offer.remote.result.GetOfferItemPriceResult;
...
public class DeleteAction
    ...
    public CommandResult doDelete(DeleteActionForm actionForm, HttpServletRequest request)
            throws NamingException {
        DeleteOfferItemPriceForm commandForm = OfferUtil.getHome().getDeleteOfferItemPriceForm();
