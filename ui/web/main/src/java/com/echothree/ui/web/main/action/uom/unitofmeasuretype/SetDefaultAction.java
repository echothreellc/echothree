...
@SproutAction(
    path = "/UnitOfMeasure/UnitOfMeasureType/SetDefault",
...
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            ...
            SetDefaultUnitOfMeasureTypeForm commandForm = UomUtil.getHome().getSetDefaultUnitOfMeasureTypeForm();
            
            commandForm.setUnitOfMeasureKindName(unitOfMeasureKindName);
            commandForm.setUnitOfMeasureTypeName(unitOfMeasureTypeName);
            
            UomUtil.getHome().setDefaultUnitOfMeasureType(getUserVisitPK(request), commandForm);
