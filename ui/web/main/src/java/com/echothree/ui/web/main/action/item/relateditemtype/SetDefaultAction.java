...
import com.echothree.control.user.item.common.form.SetDefaultRelatedItemTypeForm;
...
@SproutAction(
    path = "/Item/RelatedItemType/SetDefault",
...
public class SetDefaultAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        ItemUtil.getHome().setDefaultRelatedItemType(getUserVisitPK(request), commandForm);
