    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                var commandForm = EmployeeUtil.getHome().getEditSkillTypeDescriptionForm();
                var spec = EmployeeUtil.getHome().getSkillTypeDescriptionSpec();
                ...
                if(wasPost(request)) {
                    var edit = EmployeeUtil.getHome().getSkillTypeDescriptionEdit();
                    
                    commandForm.setEditMode(EditMode.UPDATE);
                    commandForm.setEdit(edit);
                    edit.setDescription(actionForm.getDescription());

                    var commandResult = EmployeeUtil.getHome().editSkillTypeDescription(getUserVisitPK(request), commandForm);
                    
                    if(commandResult.hasErrors()) {
                        var executionResult = commandResult.getExecutionResult();
                        
                        if(executionResult != null) {
                            var result = (EditSkillTypeDescriptionResult)executionResult.getResult();
