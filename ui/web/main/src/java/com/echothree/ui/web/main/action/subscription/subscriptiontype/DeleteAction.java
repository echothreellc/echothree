...
import com.echothree.control.user.subscription.remote.form.DeleteSubscriptionTypeForm;
...
@SproutAction(
    path = "/Subscription/SubscriptionType/Delete",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Subscription/SubscriptionType/Main", redirect = true)
    }
)
public class DeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            SubscriptionUtil.getHome().deleteSubscriptionType(getUserVisitPK(request), commandForm);
