...
@SproutAction(
    path = "/HumanResources/EmployeeScaleUse/Delete",
    ...
    forwards = {
        ...
        @SproutForward(name = "Form", path = "/humanresources/employeescaleuse/delete.jsp")
    }
)
public class DeleteAction
    ...
    public void setupTransfer(DeleteActionForm actionForm, HttpServletRequest request)
        ...
        BaseEmployeeScaleUseAction.setupPartyScaleUseTransfer(request, actionForm.getPartyName(), actionForm.getScaleUseTypeName());
