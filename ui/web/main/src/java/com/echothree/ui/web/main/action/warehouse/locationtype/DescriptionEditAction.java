...
import com.echothree.control.user.warehouse.remote.edit.LocationTypeDescriptionEdit;
import com.echothree.control.user.warehouse.remote.form.EditLocationTypeDescriptionForm;
import com.echothree.control.user.warehouse.remote.result.EditLocationTypeDescriptionResult;
import com.echothree.control.user.warehouse.remote.spec.LocationTypeDescriptionSpec;
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                EditLocationTypeDescriptionForm commandForm = WarehouseUtil.getHome().getEditLocationTypeDescriptionForm();
                LocationTypeDescriptionSpec spec = WarehouseUtil.getHome().getLocationTypeDescriptionSpec();
                ...
                if(wasPost(request)) {
                    LocationTypeDescriptionEdit edit = WarehouseUtil.getHome().getLocationTypeDescriptionEdit();
                    
                    commandForm.setEditMode(EditMode.UPDATE);
                    commandForm.setEdit(edit);
                    edit.setDescription(actionForm.getDescription());
                    
                    CommandResult commandResult = WarehouseUtil.getHome().editLocationTypeDescription(getUserVisitPK(request), commandForm);
                    
                    if(commandResult.hasErrors()) {
                        ExecutionResult executionResult = commandResult.getExecutionResult();
                        
                        if(executionResult != null) {
                            EditLocationTypeDescriptionResult result = (EditLocationTypeDescriptionResult)executionResult.getResult();
                    ...
                    if(result != null) {
                        LocationTypeDescriptionEdit edit = result.getEdit();
