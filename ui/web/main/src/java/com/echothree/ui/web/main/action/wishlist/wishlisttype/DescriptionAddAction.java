    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    var commandForm = WishlistUtil.getHome().getCreateWishlistTypeDescriptionForm();
                    ...
                    var commandResult = WishlistUtil.getHome().createWishlistTypeDescription(getUserVisitPK(request), commandForm);
