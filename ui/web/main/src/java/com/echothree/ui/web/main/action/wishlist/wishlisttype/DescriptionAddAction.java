...
import com.echothree.control.user.wishlist.remote.form.CreateWishlistTypeDescriptionForm;
...
@SproutAction(
    path = "/Wishlist/WishlistType/DescriptionAdd",
    mappingClass = SecureActionMapping.class,
    name = "WishlistTypeDescriptionAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Wishlist/WishlistType/Description", redirect = true),
        @SproutForward(name = "Form", path = "/wishlist/wishlisttype/descriptionAdd.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreateWishlistTypeDescriptionForm commandForm = WishlistUtil.getHome().getCreateWishlistTypeDescriptionForm();
                    ...
                    CommandResult commandResult = WishlistUtil.getHome().createWishlistTypeDescription(getUserVisitPK(request), commandForm);
