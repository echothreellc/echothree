...
@SproutAction(
    path = "/Accounting/DivisionContactMechanism/ContactPostalAddressEdit",
    mappingClass = SecureActionMapping.class,
    name = "DivisionContactPostalAddressEdit",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Accounting/DivisionContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/accounting/divisioncontactmechanism/contactPostalAddressEdit.jsp")
    }
)
public class ContactPostalAddressEditAction
        extends BaseDivisionContactMechanismAction<ContactPostalAddressEditActionForm> {
