...
@SproutAction(
    path = "/Accounting/DivisionContactMechanism/ContactMechanismAdd/ContactTelephoneAdd",
    mappingClass = SecureActionMapping.class,
    name = "DivisionContactTelephoneAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Accounting/DivisionContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/accounting/divisioncontactmechanism/contactmechanismadd/contactTelephoneAdd.jsp")
    }
)
public class ContactTelephoneAddAction
        extends BaseDivisionContactMechanismAction<ContactTelephoneAddActionForm> {
