...
import com.echothree.control.user.shipment.remote.form.DeleteShipmentTypeShippingMethodForm;
...
@SproutAction(
    path = "/Shipping/ShipmentTypeShippingMethod/Delete",
...
public class DeleteAction
    ...
    throws Exception {
        ...
        try {
            DeleteShipmentTypeShippingMethodForm commandForm = ShipmentUtil.getHome().getDeleteShipmentTypeShippingMethodForm();
            ...
            ShipmentUtil.getHome().deleteShipmentTypeShippingMethod(getUserVisitPK(request), commandForm);
