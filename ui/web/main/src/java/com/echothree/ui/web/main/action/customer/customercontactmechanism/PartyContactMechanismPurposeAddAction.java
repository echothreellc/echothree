...
@SproutAction(
    path = "/Customer/CustomerContactMechanism/PartyContactMechanismPurposeAdd",
    mappingClass = SecureActionMapping.class,
    name = "CustomerPartyContactMechanismPurposeAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Customer/CustomerContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/customer/customercontactmechanism/partyContactMechanismPurposeAdd.jsp")
    }
)
public class PartyContactMechanismPurposeAddAction
        extends BaseCustomerContactMechanismAction<PartyContactMechanismPurposeAddActionForm> {
