...
import com.echothree.control.user.printer.remote.form.DeletePrinterForm;
...
@SproutAction(
    path = "/Configuration/Printer/Delete",
...
public class DeleteAction
    ...
    throws Exception {
        ...
        try {
            DeletePrinterForm commandForm = PrinterUtil.getHome().getDeletePrinterForm();
            String printerName = request.getParameter(ParameterConstants.PRINTER_NAME);
            
            commandForm.setPrinterName(printerName);
            
            PrinterUtil.getHome().deletePrinter(getUserVisitPK(request), commandForm);
