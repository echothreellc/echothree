...
@SproutAction(
    path = "/Purchasing/VendorCarrier/Add",
    mappingClass = SecureActionMapping.class,
    name = "VendorCarrierAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Purchasing/VendorCarrier/Main", redirect = true),
        @SproutForward(name = "Form", path = "/purchasing/vendorcarrier/add.jsp")
    }
)
public class AddAction
    ...
    public void setupTransfer(AddActionForm actionForm, HttpServletRequest request)
        ...
        BaseVendorCarrierAction.setupVendor(request, actionForm.getPartyName());
    }
