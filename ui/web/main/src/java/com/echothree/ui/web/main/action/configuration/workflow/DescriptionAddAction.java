...
@SproutAction(
    path = "/Configuration/Workflow/DescriptionAdd",
    mappingClass = SecureActionMapping.class,
    name = "WorkflowDescriptionAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Configuration/Workflow/Description", redirect = true),
        @SproutForward(name = "Form", path = "/configuration/workflow/descriptionAdd.jsp")
    }
)
    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    CreateWorkflowDescriptionForm commandForm = WorkflowUtil.getHome().getCreateWorkflowDescriptionForm();
                    ...
                    CommandResult commandResult = WorkflowUtil.getHome().createWorkflowDescription(getUserVisitPK(request), commandForm);
