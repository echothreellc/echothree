...
@SproutAction(
    path = "/Accounting/DivisionContactMechanism/ContactPostalAddressStatus",
    mappingClass = SecureActionMapping.class,
    name = "DivisionContactPostalAddressStatus",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Accounting/DivisionContactMechanism/Main", redirect = true),
        @SproutForward(name = "Form", path = "/accounting/divisioncontactmechanism/contactPostalAddressStatus.jsp")
    }
)
public class ContactPostalAddressStatusAction
        extends BaseDivisionContactMechanismAction<ContactPostalAddressStatusActionForm> {
