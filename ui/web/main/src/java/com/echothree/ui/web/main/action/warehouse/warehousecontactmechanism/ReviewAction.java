...
@SproutAction(
    path = "/Warehouse/WarehouseContactMechanism/Review",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/warehouse/warehousecontactmechanism/review.jsp")
    }
)
public class ReviewAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        if(partyContactMechanism == null) {
            ...
            BaseWarehouseContactMechanismAction.setupWarehouse(request, partyName);
