...
@SproutAction(
    ...
    forwards = {
        ...
        @SproutForward(name = "Form", path = "/core/application/add.jsp")
    }
)
public class AddAction
    ...
    public CommandResult doAdd(AddActionForm actionForm, HttpServletRequest request)
            throws NamingException {
        CreateApplicationForm commandForm = CoreUtil.getHome().getCreateApplicationForm();
        ...
        return CoreUtil.getHome().createApplication(getUserVisitPK(request), commandForm);
    }
