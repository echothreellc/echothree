...
import com.echothree.control.user.geo.remote.form.GetCountryChoicesForm;
import com.echothree.control.user.geo.remote.result.GetCountryChoicesResult;
...
import com.echothree.model.control.geo.remote.choice.CountryChoicesBean;
import com.echothree.model.control.item.remote.choice.HarmonizedTariffScheduleCodeUseTypeChoicesBean;
...
@SproutForm(name="ItemHarmonizedTariffScheduleCodeAdd")
    ...
    private void setupHarmonizedTariffScheduleCodeUseTypeChoices() {
        if(harmonizedTariffScheduleCodeUseTypeChoices == null) {
            try {
                ...
                // failed, harmonizedTariffScheduleCodeUseTypeChoices remains null, no default
            }
        }
    }
