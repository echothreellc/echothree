...
import com.echothree.control.user.offer.remote.form.GetOfferItemsForm;
import com.echothree.control.user.offer.remote.result.GetOfferItemsResult;
...
@SproutAction(
    path = "/Advertising/OfferItem/Main",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/advertising/offeritem/main.jsp")
    }
)
