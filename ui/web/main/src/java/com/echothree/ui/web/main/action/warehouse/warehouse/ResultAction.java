...
@SproutAction(
    path = "/Warehouse/Warehouse/Result",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/warehouse/warehouse/result.jsp")
    }
)
public class ResultAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        if(results == null) {
            var offsetParameter = request.getParameter(new ParamEncoder(AttributeConstants.WAREHOUSE_RESULT).encodeParameterName(TableTagParameters.PARAMETER_PAGE));
        ...
        var commandResult = setCommandResultAttribute(request, SearchUtil.getHome().getWarehouseResults(getUserVisitPK(request), commandForm));
