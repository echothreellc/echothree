...
import com.echothree.control.user.core.remote.form.SetDefaultServerForm;
...
@SproutAction(
    path = "/Configuration/Server/SetDefault",
...
public class SetDefaultAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        CoreUtil.getHome().setDefaultServer(getUserVisitPK(request), commandForm);
