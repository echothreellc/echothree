...
import com.echothree.control.user.offer.remote.form.GetOfferUseForm;
import com.echothree.control.user.offer.remote.result.GetOfferUseResult;
...
@SproutAction(
    path = "/Advertising/OfferUse/Review",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/advertising/offeruse/review.jsp")
    }
)
