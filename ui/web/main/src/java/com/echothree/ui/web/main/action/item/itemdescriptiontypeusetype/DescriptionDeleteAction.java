...
import com.echothree.control.user.item.remote.form.DeleteItemDescriptionTypeUseTypeDescriptionForm;
import com.echothree.control.user.item.remote.form.GetItemDescriptionTypeUseTypeDescriptionForm;
import com.echothree.control.user.item.remote.result.GetItemDescriptionTypeUseTypeDescriptionResult;
...
@SproutAction(
    path = "/Item/ItemDescriptionTypeUseType/DescriptionDelete",
    mappingClass = SecureActionMapping.class,
    name = "ItemDescriptionTypeUseTypeDescriptionDelete",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Item/ItemDescriptionTypeUseType/Description", redirect = true),
        @SproutForward(name = "Form", path = "/item/itemdescriptiontypeusetype/descriptionDelete.jsp")
    }
)
public class DescriptionDeleteAction
    ...
    public String getEntityTypeName() {
        return EntityTypes.ItemDescriptionTypeUseTypeDescription.name();
    }
    ...
    public CommandResult doDelete(DescriptionDeleteActionForm actionForm, HttpServletRequest request)
        ...
        return ItemUtil.getHome().deleteItemDescriptionTypeUseTypeDescription(getUserVisitPK(request), commandForm);
    }
