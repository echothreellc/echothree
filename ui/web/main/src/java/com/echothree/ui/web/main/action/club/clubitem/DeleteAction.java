...
import com.echothree.control.user.club.remote.form.DeleteClubItemForm;
...
@SproutAction(
    path = "/Club/ClubItem/Delete",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Club/ClubItem/Main", redirect = true)
    }
)
public class DeleteAction
    ...
    throws Exception {
        ...
        try {
            ...
            ClubUtil.getHome().deleteClubItem(getUserVisitPK(request), commandForm);
