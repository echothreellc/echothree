...
@SproutAction(
    path = "/Purchasing/VendorAlias/Delete",
    mappingClass = SecureActionMapping.class,
    name = "VendorAliasDelete",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Purchasing/VendorAlias/Main", redirect = true),
        @SproutForward(name = "Form", path = "/purchasing/vendoralias/delete.jsp")
    }
)
public class DeleteAction
    ...
    public void setupTransfer(DeleteActionForm actionForm, HttpServletRequest request)
        ...
        VendorAliasUtil.getInstance().setupPartyAliasTransfer(request, actionForm.getPartyName(), actionForm.getPartyAliasTypeName());
        VendorAliasUtil.getInstance().setupVendor(request, actionForm.getPartyName());
    }
