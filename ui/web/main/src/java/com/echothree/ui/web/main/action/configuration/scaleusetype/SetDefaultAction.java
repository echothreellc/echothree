...
import com.echothree.control.user.scale.remote.form.SetDefaultScaleUseTypeForm;
...
@SproutAction(
    path = "/Configuration/ScaleUseType/SetDefault",
...
public class SetDefaultAction
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        ScaleUtil.getHome().setDefaultScaleUseType(getUserVisitPK(request), commandForm);
