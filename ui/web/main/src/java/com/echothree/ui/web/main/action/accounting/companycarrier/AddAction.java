...
import com.echothree.control.user.carrier.remote.form.CreatePartyCarrierForm;
...
@SproutAction(
    path = "/Accounting/CompanyCarrier/Add",
    mappingClass = SecureActionMapping.class,
    name = "CompanyCarrierAdd",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Accounting/CompanyCarrier/Main", redirect = true),
        @SproutForward(name = "Form", path = "/accounting/companycarrier/add.jsp")
    }
)
public class AddAction
    ...
    public void setupTransfer(AddActionForm actionForm, HttpServletRequest request)
        ...
        BaseCompanyCarrierAction.setupCompany(request, actionForm.getPartyName());
    }

    @Override
    public CommandResult doAdd(AddActionForm actionForm, HttpServletRequest request)
            throws NamingException {
        CreatePartyCarrierForm commandForm = CarrierUtil.getHome().getCreatePartyCarrierForm();

        commandForm.setPartyName(actionForm.getPartyName());
        commandForm.setCarrierName(actionForm.getCarrierChoice());
        commandForm.setCarrierName(actionForm.getCarrierChoice());

        return CarrierUtil.getHome().createPartyCarrier(getUserVisitPK(request), commandForm);
    }
