...
@SproutAction(
    path = "/Shipping/CarrierContactMechanism/CommentDelete",
    mappingClass = SecureActionMapping.class,
    name = "CarrierContactMechanismCommentDelete",
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/action/Shipping/CarrierContactMechanism/Review", redirect = true),
        @SproutForward(name = "Form", path = "/shipping/carriercontactmechanism/commentDelete.jsp")
    }
)
public class CommentDeleteAction
    ...
    public void setupTransfer(CommentDeleteActionForm actionForm, HttpServletRequest request)
            throws NamingException {
        BaseCarrierContactMechanismAction.setupContactMechanismTransfer(request, actionForm.getContactMechanismName());
