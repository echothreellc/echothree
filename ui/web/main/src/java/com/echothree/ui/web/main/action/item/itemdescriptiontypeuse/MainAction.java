...
import com.echothree.control.user.item.remote.form.GetItemDescriptionTypeUsesForm;
import com.echothree.control.user.item.remote.result.GetItemDescriptionTypeUsesResult;
...
@SproutAction(
    path = "/Item/ItemDescriptionTypeUse/Main",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "true")
    },
    forwards = {
        @SproutForward(name = "Display", path = "/item/itemdescriptiontypeuse/main.jsp")
    }
)
