...
import com.echothree.control.user.party.remote.form.SetDefaultCompanyForm;
...
@SproutAction(
    path = "/Accounting/Company/SetDefault",
...
public class SetDefaultAction
    ...
    throws Exception {
        ...
        try {
            ...
            PartyUtil.getHome().setDefaultCompany(getUserVisitPK(request), commandForm);
