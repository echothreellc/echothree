    ...
    throws Exception {
        ...
        try {
            if(forwardKey == null) {
                ...
                if(wasPost(request)) {
                    var commandForm = ReturnPolicyUtil.getHome().getCreateReturnReasonForm();
                    ...
                    var commandResult = ReturnPolicyUtil.getHome().createReturnReason(getUserVisitPK(request), commandForm);
