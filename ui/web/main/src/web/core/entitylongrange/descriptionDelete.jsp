...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            <p>You are about to delete the <c:out value="${entityLongRangeDescription.language.description}" />
            <c:out value="${fn:toLowerCase(partyEntityType.entityType.description)}" /> for &quot;<c:out value="${entityLongRangeDescription.entityLongRange.description}" />&quot;
            (<c:out value="${entityLongRangeDescription.entityLongRange.entityLongRangeName}" />).</p>
            <et:executionErrors id="errorMessage">
                <p class="executionErrors"><c:out value="${errorMessage}" /></p><br />
            </et:executionErrors>
            <html:form action="/Core/EntityLongRange/DescriptionDelete" method="POST">
                <table>
                    <tr>
