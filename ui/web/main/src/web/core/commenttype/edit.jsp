        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Core/CommentType/Edit" method="POST" focus="commentTypeName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.commentTypeName" />:</td>
                                <td>
                                    <html:text property="commentTypeName" size="40" maxlength="40" /> (*)
                                    <et:validationErrors id="errorMessage" property="CommentTypeName">
                                        <p><c:out value="${errorMessage}" /></p>
                                    </et:validationErrors>
                                </td>
                            </tr>
                            <tr>
                                <td align=right><fmt:message key="label.commentSequence" />:</td>
                                <td>
                                    <html:select property="commentSequenceChoice">
                                        <html:optionsCollection property="commentSequenceChoices" />
                                    </html:select>
                                    <et:validationErrors id="errorMessage" property="CommentSequenceName">
                                        <p><c:out value="${errorMessage}" /></p>
                                    </et:validationErrors>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <html:hidden property="originalCommentTypeName" />
                                </td>
