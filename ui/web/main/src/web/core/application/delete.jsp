    ...
    <body>
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    <p>You are about to delete the <c:out value="${fn:toLowerCase(partyEntityType.entityType.description)}" /> &quot;<c:out value="${thisApplication.description}" />.&quot;</p>
                    <html:form action="/Core/Application/Delete" method="POST">
                        <table>
                            <tr>
