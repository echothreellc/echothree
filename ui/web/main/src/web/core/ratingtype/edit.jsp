        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Core/RatingType/Edit" method="POST" focus="ratingTypeName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.ratingTypeName" />:</td>
                                <td>
                                    <html:text property="ratingTypeName" size="40" maxlength="40" /> (*)
                                    <et:validationErrors id="errorMessage" property="RatingTypeName">
                                        <p><c:out value="${errorMessage}" /></p>
                                    </et:validationErrors>
                                </td>
                            </tr>
                            <tr>
                                <td align=right><fmt:message key="label.ratingSequence" />:</td>
                                <td>
                                    <html:select property="ratingSequenceChoice">
                                        <html:optionsCollection property="ratingSequenceChoices" />
                                    </html:select>
                                    <et:validationErrors id="errorMessage" property="RatingSequenceName">
                                        <p><c:out value="${errorMessage}" /></p>
                                    </et:validationErrors>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <html:hidden property="originalRatingTypeName" />
                                </td>
