...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            <p>You are about to delete the <c:out value="${entityAliasTypeDescription.language.description}" />
            <c:out value="${fn:toLowerCase(partyEntityType.entityType.description)}" /> for &quot;<c:out value="${entityAliasTypeDescription.entityAliasType.description}" />&quot;
            (<c:out value="${entityAliasTypeDescription.entityAliasType.entityAliasTypeName}" />).</p>
            <et:executionErrors id="errorMessage">
                <p class="executionErrors"><c:out value="${errorMessage}" /></p><br />
            </et:executionErrors>
            <html:form action="/Core/EntityAliasType/DescriptionDelete" method="POST">
                <table>
                    <tr>
                ...
                <html:hidden property="entityAliasTypeName" />
