        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Core/EntityAliasType/Edit" method="POST" focus="entityAliasTypeName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.entityAliasTypeName" />:</td>
                                <td>
                                    <html:text property="entityAliasTypeName" size="40" maxlength="40" /> (*)
                                    <et:validationErrors id="errorMessage" property="EntityAliasTypeName">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <html:hidden property="originalEntityAliasTypeName" />
                                </td>
