        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Core/TagScope/Edit" method="POST" focus="tagScopeName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.tagScopeName" />:</td>
                                <td>
                                    <html:text property="tagScopeName" size="40" maxlength="40" /> (*)
                                    <et:validationErrors id="errorMessage" property="TagScopeName">
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="originalTagScopeName" />
                                </td>
