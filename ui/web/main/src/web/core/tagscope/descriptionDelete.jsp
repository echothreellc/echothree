...
<html:html xhtml="true">
    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <c:url var="descriptionsUrl" value="/action/Core/TagScope/Description">
                    <c:param name="TagScopeName" value="${tagScopeDescription.tagScope.tagScopeName}" />
                </c:url>
        ...
        <div id="Content">
            <p>You are about to delete the <c:out value="${tagScopeDescription.language.description}" />
            <c:out value="${fn:toLowerCase(partyEntityType.entityType.description)}" /> for &quot;<c:out value="${tagScopeDescription.tagScope.description}" />&quot;
            (<c:out value="${tagScopeDescription.tagScope.tagScopeName}" />).</p>
            <et:executionErrors id="errorMessage">
                <p class="executionErrors"><c:out value="${errorMessage}" /></p><br />
            </et:executionErrors>
            <html:form action="/Core/TagScope/DescriptionDelete" method="POST">
                <table>
                    <tr>
