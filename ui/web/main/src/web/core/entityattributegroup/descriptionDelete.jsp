...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            <p>You are about to delete the <c:out value="${entityAttributeGroupDescription.language.description}" />
            <c:out value="${fn:toLowerCase(partyEntityType.entityType.description)}" /> for &quot;<c:out value="${entityAttributeGroupDescription.entityAttributeGroup.description}" />&quot;
            (<c:out value="${entityAttributeGroupDescription.entityAttributeGroup.entityAttributeGroupName}" />).</p>
            <et:executionErrors id="errorMessage">
                <p class="executionErrors"><c:out value="${errorMessage}" /></p><br />
            </et:executionErrors>
            <html:form action="/Core/EntityAttributeGroup/DescriptionDelete" method="POST">
                <table>
                    <tr>
