...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            <html:form action="/Core/EntityAttributeGroup/Add" method="POST" focus="entityAttributeGroupName">
                <table>
                    <tr>
                        <td align=right><fmt:message key="label.entityAttributeGroupName" />:</td>
                        <td>
                            <html:text property="entityAttributeGroupName" size="40" maxlength="40" />
