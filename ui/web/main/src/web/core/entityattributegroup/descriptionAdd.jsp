    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <a href="${descriptionsUrl}"><fmt:message key="navigation.entityAttributeGroupDescriptions" /></a> &gt;&gt;
                Add
            </h2>
        </div>
        <div id="Content">
            ...
            <html:form action="/Core/EntityAttributeGroup/DescriptionAdd" method="POST" focus="description">
                <table>
                    <tr>
