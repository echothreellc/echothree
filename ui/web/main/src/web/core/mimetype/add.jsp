...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            <html:form action="/Core/MimeType/Add" method="POST" focus="mimeTypeName">
                <table>
                    <tr>
                        <td align=right><fmt:message key="label.mimeTypeName" />:</td>
                        <td>
                            <html:text property="mimeTypeName" size="40" maxlength="40" /> (*)
