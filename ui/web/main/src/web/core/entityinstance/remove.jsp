    ...
    <body>
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    <p>You are about to remove the <c:out value="${fn:toLowerCase(partyEntityType.entityType.description)}" /> &quot;<c:out value="${entityInstance.entityRef}" />.&quot;</p>
                    <br />
                    <html:form action="/Core/EntityInstance/Remove" method="POST">
                        <html:submit value="Remove" onclick="onSubmitDisable(this);" />&nbsp;<html:cancel onclick="onSubmitDisable(this);" /><html:hidden property="submitButton" />
