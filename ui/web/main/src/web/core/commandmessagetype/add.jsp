...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            <html:form action="/Core/CommandMessageType/Add" method="POST" focus="commandMessageTypeName">
                <table>
                    <tr>
                        <td align=right><fmt:message key="label.commandMessageTypeName" />:</td>
                        <td>
                            <html:text property="commandMessageTypeName" size="40" maxlength="40" /> (*)
                            <et:validationErrors id="errorMessage" property="CommandMessageTypeName">
