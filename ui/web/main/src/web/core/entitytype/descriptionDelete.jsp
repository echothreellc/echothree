...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            <p>You are about to delete the <c:out value="${entityTypeDescription.language.description}" />
            <c:out value="${fn:toLowerCase(partyEntityType.entityType.description)}" /> for &quot;<c:out value="${entityTypeDescription.entityType.description}" />&quot;
            (<c:out value="${entityTypeDescription.entityType.entityTypeName}" />).</p>
            <et:executionErrors id="errorMessage">
                <p class="executionErrors"><c:out value="${errorMessage}" /></p><br />
            </et:executionErrors>
            <html:form action="/Core/EntityType/DescriptionDelete" method="POST">
                <table>
                    <tr>
