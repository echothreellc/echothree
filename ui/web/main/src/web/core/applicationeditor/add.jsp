...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            <html:form action="/Core/ApplicationEditor/Add" method="POST" focus="applicationEditorName">
                <table>
                    <tr>
                        <td align=right><fmt:message key="label.editor" />:</td>
                        <td>
                            <html:select property="editorChoice">
                                <html:optionsCollection property="editorChoices" />
                            </html:select> (*)
