...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            <html:form action="/Core/Color/Add" method="POST" focus="colorName">
                <table>
                    <tr>
                        <td align=right><fmt:message key="label.colorName" />:</td>
                        <td>
                            <html:text property="colorName" size="40" maxlength="40" />
                            <et:validationErrors id="errorMessage" property="ColorName">
                                <p><c:out value="${errorMessage}" /></p>
                            </et:validationErrors>
                        </td>
                    </tr>
                    <tr>
                        <td align=right><fmt:message key="label.red" />:</td>
                        <td>
                            <html:text property="red" size="6" maxlength="3" /> (*)
                            <et:validationErrors id="errorMessage" property="Red">
                                <p><c:out value="${errorMessage}" /></p>
                            </et:validationErrors>
                        </td>
                    </tr>
                    <tr>
                        <td align=right><fmt:message key="label.green" />:</td>
                        <td>
                            <html:text property="green" size="6" maxlength="3" /> (*)
                            <et:validationErrors id="errorMessage" property="Green">
                                <p><c:out value="${errorMessage}" /></p>
                            </et:validationErrors>
                        </td>
                    </tr>
                    <tr>
                        <td align=right><fmt:message key="label.blue" />:</td>
                        <td>
                            <html:text property="blue" size="6" maxlength="3" /> (*)
                            <et:validationErrors id="errorMessage" property="Blue">
                                <p><c:out value="${errorMessage}" /></p>
                            </et:validationErrors>
                        </td>
                    </tr>
