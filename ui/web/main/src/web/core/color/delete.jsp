    ...
    <body>
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    <p>You are about to delete the <c:out value="${fn:toLowerCase(partyEntityType.entityType.description)}" /> &quot;<c:out value="${color.description}" />.&quot;</p>
                    <html:form action="/Core/Color/Delete" method="POST">
                        <table>
                            <tr>
                        ...
                        <html:hidden property="colorName" />
                    </html:form>
                </c:otherwise>
            </c:choose>
        </div>
