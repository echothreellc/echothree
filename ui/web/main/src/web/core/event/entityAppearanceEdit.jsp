        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Core/Event/EntityAppearanceEdit" method="POST">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.appearance" />:</td>
                                <td>
                                    <html:select property="appearanceChoice">
                                        <html:optionsCollection property="appearanceChoices" />
                                    </html:select> (*)
