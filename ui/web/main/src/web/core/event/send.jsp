    ...
    <body>
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    <html:form action="/Core/Event/Send" method="POST">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.eventType" />:</td>
                                <td>
                                    <html:select property="eventTypeChoice">
                                        <html:optionsCollection property="eventTypeChoices" />
                                    </html:select> (*)
                                    <et:validationErrors id="errorMessage" property="EventTypeChoice">
                            ...
                            <tr>
                                ...
                                <td>
                                    <html:submit value="Send Event" onclick="onSubmitDisable(this);" />&nbsp;<html:cancel onclick="onSubmitDisable(this);" /><html:hidden property="submitButton" />
                                </td>
                            </tr>
                        </table>
                    </html:form>
