...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            <html:form action="/Core/MessageType/Add" method="POST" focus="messageTypeName">
                <table>
                    <tr>
                        <td align=right><fmt:message key="label.messageTypeName" />:</td>
                        <td>
                            <html:text property="messageTypeName" size="40" maxlength="40" /> (*)
                            <et:validationErrors id="errorMessage" property="MessageTypeName">
                                <p><c:out value="${errorMessage}" /></p>
                            </et:validationErrors>
                        </td>
                    </tr>
                    <tr>
                        <td align=right><fmt:message key="label.mimeTypeUsageType" />:</td>
                        <td>
                            <html:select property="mimeTypeUsageTypeChoice">
                                <html:optionsCollection property="mimeTypeUsageTypeChoices" />
                            </html:select> (*)
                            <et:validationErrors id="errorMessage" property="MimeTypeUsageTypeName">
                                <p><c:out value="${errorMessage}" /></p>
                            </et:validationErrors>
                        </td>
                    </tr>
