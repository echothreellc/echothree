        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;Tag Scope <c:out value="${tagScopeEntityType.tagScope.description}" /><br />
                    &nbsp;&nbsp;&nbsp;&nbsp;Component Vendor: <c:out value="${tagScopeEntityType.entityType.componentVendor.description}" /><br />
                    &nbsp;&nbsp;&nbsp;&nbsp;Entity Type: <c:out value="${tagScopeEntityType.entityType.description}" /><br />
                    <html:form action="/Core/TagScopeEntityType/Delete" method="POST">
                        <table>
                            <tr>
