...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            <html:form action="/Core/ApplicationEditorUse/Add" method="POST" focus="applicationEditorUseName">
                <table>
                    <tr>
                        <td align=right><fmt:message key="label.applicationEditorUseName" />:</td>
                        <td>
                            <html:text property="applicationEditorUseName" size="40" maxlength="40" /> (*)
                            <et:validationErrors id="errorMessage" property="ApplicationEditorUseName">
                                <p><c:out value="${errorMessage}" /></p>
                            </et:validationErrors>
                        </td>
                    </tr>
                    <tr>
                        <td align=right><fmt:message key="label.defaultApplicationEditor" />:</td>
                        <td>
                            <html:select property="defaultEditorChoice">
                                <html:optionsCollection property="defaultApplicationEditorChoices" />
                            </html:select>
                            <et:validationErrors id="errorMessage" property="DefaultEditorName">
                                <p><c:out value="${errorMessage}" /></p>
                            </et:validationErrors>
                        </td>
                    </tr>
                    <tr>
                        <td align=right><fmt:message key="label.defaultHeight" />:</td>
                        <td>
                            <html:text property="defaultHeight" size="12" maxlength="12" />
                            <et:validationErrors id="errorMessage" property="DefaultHeight">
                                <p><c:out value="${errorMessage}" /></p>
                            </et:validationErrors>
                        </td>
                    </tr>
                    <tr>
                        <td align=right><fmt:message key="label.defaultWidth" />:</td>
                        <td>
                            <html:text property="defaultWidth" size="12" maxlength="12" />
                            <et:validationErrors id="errorMessage" property="DefaultWidth">
                                <p><c:out value="${errorMessage}" /></p>
                            </et:validationErrors>
                        </td>
                    </tr>
