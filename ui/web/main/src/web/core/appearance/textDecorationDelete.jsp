...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;Appearance: <c:out value="${appearanceTextDecoration.appearance.description}" /><br />
            &nbsp;&nbsp;&nbsp;&nbsp;Text Decoration: <c:out value="${appearanceTextDecoration.textDecoration.description}" /><br />
            <et:executionErrors id="errorMessage">
                <p class="executionErrors"><c:out value="${errorMessage}" /></p><br />
            </et:executionErrors>
            <html:form action="/Core/Appearance/TextDecorationDelete" method="POST">
                <table>
                    <tr>
                ...
                <html:hidden property="textDecorationName" />
            </html:form>
        </div>
