        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Core/EntityClobAttribute/Edit" method="POST" focus="clobAttribute">
                        <table>
                            <tr>
                            ...
                            <tr>
                                <td align=right><fmt:message key="label.clobAttribute" />:</td>
                                <td>
                                    <html:textarea property="clobAttribute" cols="${entityAttributeEditorUse.preferredWidth}" rows="${entityAttributeEditorUse.preferredHeight}" styleId="clobAttributeTA" /> (*)
                                    <et:validationErrors id="errorMessage" property="clobAttribute">
                                        <p><c:out value="${errorMessage}" /></p>
                                    </et:validationErrors>
                                </td>
                            </tr>
