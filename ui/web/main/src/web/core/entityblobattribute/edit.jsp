        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Core/EntityBlobAttribute/Edit" method="POST" enctype="multipart/form-data">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.blobAttribute" />:</td>
                                <td>
                                    <html:file property="blobAttribute" /> (*)
                                    <et:validationErrors id="errorMessage" property="BlobAttribute">
