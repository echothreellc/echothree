...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            <html:form action="/Core/EntityAttribute/EntityAttributeGroupAdd" method="POST" focus="description">
                <table>
                    <tr>
                        <td align=right><fmt:message key="label.entityAttributeGroup" />:</td>
                        <td>
                            <html:select property="entityAttributeGroupChoice">
                                <html:optionsCollection property="entityAttributeGroupChoices" />
                            </html:select> (*)
                            <et:validationErrors id="errorMessage" property="EntityAttributeGroupName">
