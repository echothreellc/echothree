    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <a href="${ratingTypeListItemsUrl}">List Items</a> &gt;&gt;
                Edit
            </h2>
        </div>
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Core/RatingTypeListItem/Edit" method="POST" focus="ratingTypeListItemName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.ratingTypeListItemName" />:</td>
                                <td>
                                    <html:text property="ratingTypeListItemName" size="40" maxlength="40" /> (*)
                            ...
                            <tr>
                                <td>
                                    ...
                                    <html:hidden property="originalRatingTypeListItemName" />
                                </td>
