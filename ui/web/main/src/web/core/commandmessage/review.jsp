...
<html:html xhtml="true">
    <head>
        <title>Review (<c:out value="${commandMessage.commandMessageKey}" />)</title>
        <html:base/>
    ...
    <body>
        <div id="Header">
            <h2>
                ...
                Review (<c:out value="${commandMessage.commandMessageKey}" />)
            </h2>
        </div>
        <div id="Content">
            <p><font size="+2"><b><c:out value="${commandMessage.commandMessageKey}" /></b></font></p>
            <br />
            
            <br />
            <c:set var="entityInstance" scope="request" value="${commandMessage.entityInstance}" />
