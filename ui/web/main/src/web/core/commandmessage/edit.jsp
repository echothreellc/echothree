        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Core/CommandMessage/Edit" method="POST" focus="commandMessageKey">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.commandMessageKey" />:</td>
                                <td>
                                    <html:text property="commandMessageKey" size="40" maxlength="80" /> (*)
                                    <et:validationErrors id="errorMessage" property="CommandMessageKey">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <html:hidden property="originalCommandMessageKey" />
                                </td>
