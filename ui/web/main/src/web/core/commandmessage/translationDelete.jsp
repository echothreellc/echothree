...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            <p>You are about to delete the <c:out value="${commandMessageTranslation.language.description}" />
            <c:out value="${fn:toLowerCase(partyEntityType.entityType.description)}" /> for &quot;<c:out value="${commandMessageTranslation.commandMessage.translation}" />&quot;
            (<c:out value="${commandMessageTranslation.commandMessage.commandMessageKey}" />).</p>
            <et:executionErrors id="errorMessage">
                <p class="executionErrors"><c:out value="${errorMessage}" /></p><br />
            </et:executionErrors>
            <html:form action="/Core/CommandMessage/TranslationDelete" method="POST">
                <table>
                    <tr>
