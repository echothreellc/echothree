    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <a href="${entityListItemsUrl}">Entity List Items</a> &gt;&gt;
                Edit
            </h2>
        </div>
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Core/EntityListItem/Edit" method="POST" focus="entityListItemName">
                        <table>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <html:hidden property="originalEntityListItemName" />
                                </td>
