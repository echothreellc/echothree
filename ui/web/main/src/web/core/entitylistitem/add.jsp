...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            <html:form action="/Core/EntityListItem/Add" method="POST" focus="entityListItemName">
                <table>
                    <tr>
                        <td align=right><fmt:message key="label.entityListItemName" />:</td>
                        <td>
                            <html:text property="entityListItemName" size="40" maxlength="40" />
                            <et:validationErrors id="errorMessage" property="EntityListItemName">
