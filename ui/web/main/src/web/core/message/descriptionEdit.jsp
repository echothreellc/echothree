    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <c:url var="descriptionsUrl" value="/action/Core/Message/Description">
                    ...
                    <c:param name="EntityTypeName" value="${entityTypeName}" />
                    <c:param name="MessageTypeName" value="${messageTypeName}" />
                    <c:param name="MessageName" value="${messageName}" />
                </c:url>
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    <html:form action="/Core/Message/DescriptionEdit" method="POST" focus="description">
                        <table>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <html:hidden property="messageTypeName" />
