...
<html:html xhtml="true">
    <head>
        <title><fmt:message key="pageTitle.queueTypeDescriptions" /></title>
        <html:base/>
        ...
        <div id="Header">
            <h2>
                ...
                <c:url var="descriptionsUrl" value="/action/Core/QueueType/Description">
                    <c:param name="QueueTypeName" value="${queueTypeDescription.queueType.queueTypeName}" />
                </c:url>
                <a href="${descriptionsUrl}"><fmt:message key="navigation.queueTypeDescriptions" /></a> &gt;&gt;
                Edit
            </h2>
        </div>
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Core/QueueType/DescriptionEdit" method="POST" focus="description">
                        <table>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="queueTypeName" />
