        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Core/QueueType/Edit" method="POST" focus="queueTypeName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.queueTypeName" />:</td>
                                <td>
                                    <html:text property="queueTypeName" size="40" maxlength="40" /> (*)
                                    <et:validationErrors id="errorMessage" property="QueueTypeName">
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="originalQueueTypeName" />
                                </td>
