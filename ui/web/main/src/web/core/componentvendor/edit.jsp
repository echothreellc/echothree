...
<html:html xhtml="true">
    <head>
        <title><fmt:message key="pageTitle.componentVendors" /></title>
        <html:base/>
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Core/ComponentVendor/Edit" method="POST" focus="componentVendorName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.componentVendorName" />:</td>
                                <td>
                                    <html:text property="componentVendorName" size="40" maxlength="40" /> (*)
                                    <et:validationErrors id="errorMessage" property="ComponentVendorName">
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="originalComponentVendorName" />
                                </td>
