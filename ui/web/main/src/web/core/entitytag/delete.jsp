    ...
    <body>
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    <p>You are about to delete the tag &quot;<c:out value="${entityTag.tag.tagName}" />&quot; from &quot;<c:out value="${entityTag.taggedEntityInstance.description}" />.&quot;</p>
                    <html:form action="/Core/EntityTag/Delete" method="POST">
                        <table>
                            <tr>
