        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Core/EntityIntegerRange/Edit" method="POST" focus="entityIntegerRangeName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.entityIntegerRangeName" />:</td>
                                <td>
                                    <html:text property="entityIntegerRangeName" size="40" maxlength="40" /> (*)
                                    <et:validationErrors id="errorMessage" property="EntityIntegerRangeName">
                                        <p><c:out value="${errorMessage}" /></p>
                                    </et:validationErrors>
                                </td>
                            </tr>
                            <tr>
                                <td align=right><fmt:message key="label.minimumIntegerValue" />:</td>
                                <td>
                                    <html:text property="minimumIntegerValue" size="12" maxlength="21" />
                                    <et:validationErrors id="errorMessage" property="MinimumIntegerValue">
                                        <p><c:out value="${errorMessage}" /></p>
                                    </et:validationErrors>
                                </td>
                            </tr>
                            <tr>
                                <td align=right><fmt:message key="label.maximumIntegerValue" />:</td>
                                <td>
                                    <html:text property="maximumIntegerValue" size="12" maxlength="21" />
                                    <et:validationErrors id="errorMessage" property="MaximumIntegerValue">
                                        <p><c:out value="${errorMessage}" /></p>
                                    </et:validationErrors>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <html:hidden property="originalEntityIntegerRangeName" />
                                </td>
