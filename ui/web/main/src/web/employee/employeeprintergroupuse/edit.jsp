...
<html:html xhtml="true">
    <head>
        <title>Employee Printer Group Use (<c:out value="${partyPrinterGroupUse.printerGroupUseType.printerGroupUseTypeName}" />)</title>
        <html:base/>
    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <a href="<c:url value="/action/Employee/EmployeePrinterGroupUse/Main" />"><fmt:message key="navigation.employeePrinterGroupUses" /></a> &gt;&gt;
                Edit
            </h2>
        </div>
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Employee/EmployeePrinterGroupUse/Edit" method="POST">
                        <table>
                            <tr>
