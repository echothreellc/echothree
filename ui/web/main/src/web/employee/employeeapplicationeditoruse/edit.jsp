        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Employee/EmployeeApplicationEditorUse/Edit" method="POST">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.applicationEditor" />:</td>
                                <td>
                                    <html:select property="editorChoice">
                                        <html:optionsCollection property="applicationEditorChoices" />
                                    </html:select>
