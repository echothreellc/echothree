...
<html:html xhtml="true">
    <head>
        <title>Employee Application Editor Uses</title>
        <html:base/>
    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <a href="<c:url value="/action/Employee/EmployeeApplicationEditorUse/Main" />"><fmt:message key="navigation.employeeApplicationEditorUses" /></a> &gt;&gt;
                Delete
            </h2>
        </div>
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;Application: <c:out value="${partyApplicationEditorUse.applicationEditorUse.application.description}" /><br />
                    &nbsp;&nbsp;&nbsp;&nbsp;Application Editor Use: <c:out value="${partyApplicationEditorUse.applicationEditorUse.description}" /><br />
                    <html:form action="/Employee/EmployeeApplicationEditorUse/Delete" method="POST">
                        <table>
                            <tr>
