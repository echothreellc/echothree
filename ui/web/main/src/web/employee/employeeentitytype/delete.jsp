...
<html:html xhtml="true">
    <head>
        <title>Employee Entity Types</title>
        <html:base/>
    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <a href="<c:url value="/action/Employee/EmployeeEntityType/Main" />"><fmt:message key="navigation.employeeEntityTypes" /></a> &gt;&gt;
                Delete
            </h2>
        </div>
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;Component Vendor <c:out value="${partyEntityType.entityType.componentVendor.description}" /><br />
                    &nbsp;&nbsp;&nbsp;&nbsp;Entity Type: <c:out value="${partyEntityType.entityType.description}" /><br />
                    <html:form action="/Employee/EmployeeEntityType/Delete" method="POST">
                        <table>
                            <tr>
