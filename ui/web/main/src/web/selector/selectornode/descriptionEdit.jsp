    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <c:url var="descriptionsUrl" value="/action/Selector/Selector/Description">
                    ...
                    <c:param name="SelectorTypeName" value="${selectorTypeName}" />
                    <c:param name="SelectorName" value="${selectorName}" />
                    <c:param name="SelectorNodeName" value="${selectorNodeName}" />
                </c:url>
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    <html:form action="/Selector/SelectorNode/DescriptionEdit" method="POST" focus="description">
                        <table>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <html:hidden property="selectorNodeName" />
