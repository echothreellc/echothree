...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            Entity Attributes:<br /><br />
            <c:forEach items="${entityAttributes}" var="entityAttribute">
                <c:url var="addUrl" value="/action/Selector/SelectorNode/Add/EntityListItemStep5">
                    <c:param name="SelectorKindName" value="${selectorKindName}" />
                    <c:param name="SelectorTypeName" value="${selectorTypeName}" />
                    <c:param name="SelectorName" value="${selectorName}" />
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;<a href="${addUrl}"><c:out value="${entityAttribute.description}" /></a><br />
            </c:forEach>
        </div>
