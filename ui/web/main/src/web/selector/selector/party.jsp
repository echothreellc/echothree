...
<html:html xhtml="true">
    <head>
        <title>
            <c:if test='${selectorKind.selectorKindName == "EMPLOYEE"}'>
                Employees
            </c:if>
        </title>
        <html:base/>
    ...
    <body>
        ...
        <div id="Content">
            <display:table name="selectorParties" id="selectorParty" class="displaytag">
                <c:if test='${selectorKind.selectorKindName == "EMPLOYEE"}'>
                    <display:column>
                        <c:url var="reviewUrl" value="/action/HumanResources/Employee/Review">
                            <c:param name="PartyName" value="${selectorParty.party.partyName}" />
                        </c:url>
                        <a href="${reviewUrl}">Review</a>
                    </display:column>
                </c:if>
                <display:column titleKey="columnTitle.firstName">
                    <c:out value="${selectorParty.party.person.firstName}" />
                </display:column>
                <display:column titleKey="columnTitle.lastName">
                    <c:out value="${selectorParty.party.person.lastName}" />
                </display:column>
            </display:table>
        </div>
