...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            <html:form action="/Selector/Selector/Add" method="POST" focus="selectorName">
                <table>
                    <tr>
                        <td align=right><fmt:message key="label.selectorName" />:</td>
                        <td>
                            <html:text property="selectorName" size="40" maxlength="40" /> (*)
                            <et:validationErrors id="errorMessage" property="SelectorName">
