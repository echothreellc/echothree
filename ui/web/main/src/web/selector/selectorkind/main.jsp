...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            <display:table name="selectorKinds" id="selectorKind" class="displaytag">
                <display:column property="selectorKindName" titleKey="columnTitle.name" />
                <display:column titleKey="columnTitle.description">
                    <c:out value="${selectorKind.description}" />
                </display:column>
                <display:column>
