        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Warehouse/LocationType/Edit" method="POST" focus="locationTypeName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.locationTypeName" />:</td>
                                <td>
                                    <html:text property="locationTypeName" size="40" maxlength="40" /> (*)
                        ...
                        <td>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <html:hidden property="originalLocationTypeName" />
                                </td>
