    ...
    <body>
        <div id="Header">
            <h2>
                ...
                Delete (<c:out value="${locationType.locationTypeName}" />)
            </h2>
        </div>
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    <p>You are about to delete the <c:out value="${fn:toLowerCase(partyEntityType.entityType.description)}" /> &quot;<c:out value="${locationType.description}" />.&quot;</p>
                    <html:form action="/Warehouse/LocationType/Delete" method="POST">
                        <table>
                            <tr>
