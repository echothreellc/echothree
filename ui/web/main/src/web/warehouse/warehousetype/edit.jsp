        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Warehouse/WarehouseType/Edit" method="POST" focus="warehouseTypeName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.warehouseTypeName" />:</td>
                                <td>
                                    <html:text property="warehouseTypeName" size="40" maxlength="40" /> (*)
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="originalWarehouseTypeName" />
                                </td>
