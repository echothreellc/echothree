    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <a href="<c:url value="/action/Warehouse/Main" />">Warehouse</a> &gt;&gt;
                <a href="<c:url value="/action/Warehouse/Warehouse/Main" />">Companies</a> &gt;&gt;
        ...
        <div id="Content">
            ...
            <html:form action="/Warehouse/WarehousePrinterGroupUse/Add" method="POST">
                <table>
                    <tr>
