...
<html:html xhtml="true">
    <head>
        <title>
            <fmt:message key="pageTitle.warehousePrinterGroupUse">
                <fmt:param value="${partyPrinterGroupUse.printerGroupUseType.printerGroupUseTypeName}" />
            </fmt:message>
        </title>
        <html:base/>
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Warehouse/WarehousePrinterGroupUse/Delete" method="POST">
                        <table>
                            <tr>
