        ...
        <div id="Header">
            <h2>
                ...
                <c:url var="descriptionsUrl" value="/action/Warehouse/LocationNameElement/Description">
                    <c:param name="WarehouseName" value="${warehouseName}" />
                    <c:param name="LocationTypeName" value="${locationTypeName}" />
                    <c:param name="LocationNameElementName" value="${locationNameElementName}" />
                </c:url>
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Warehouse/LocationNameElement/DescriptionEdit" method="POST" focus="description">
                        <table>
                            <tr>
