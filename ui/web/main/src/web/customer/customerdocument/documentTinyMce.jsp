...
<et:partyApplicationEditorUse applicationName="main" applicationEditorUseName="CustomerDocument" var="customerDocumentEditorUse" commandResultVar="unused" scope="request" />

<script type="text/javascript">
    var clobTAHasEditor = false;
    
    function mimeTypeChoiceChange() {
        <c:if test="${customerDocumentEditorUse.applicationEditor.editor.editorName == 'TINYMCE'}">
