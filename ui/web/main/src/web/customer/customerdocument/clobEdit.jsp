...
<html:form action="/Customer/CustomerDocument/Edit" method="POST" focus="stringDescription">
    <table>
        <tr>
        ...
        <tr>
            ...
            <td>
                <html:textarea property="clob" cols="${customerDocumentEditorUse.preferredWidth}" rows="${customerDocumentEditorUse.preferredHeight}" styleId="clobTA" /> (*)
