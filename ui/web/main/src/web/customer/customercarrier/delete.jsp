...
<html:html xhtml="true">
    <head>
        <title>Customer Carrier (<c:out value="${partyCarrier.carrier.partyGroup.name}" />)</title>
        <html:base/>
    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <a href="<c:url value="/action/Customer/Main" />">Customer</a> &gt;&gt;
                <a href="<c:url value="/action/Customer/Customer/Main" />">Customers</a> &gt;&gt;
                ...
                <c:url var="customerCarriersUrl" value="/action/Customer/CustomerCarrier/Main">
                    <c:param name="CustomerName" value="${customer.customerName}" />
                </c:url>
                <a href="${customerCarriersUrl}">Carriers</a> &gt;&gt;
                Delete <c:out value="${partyCarrier.carrier.partyGroup.name}" />
            </h2>
        </div>
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    &quot;<c:out value="${partyCarrier.carrier.partyGroup.name}" />.&quot;
                    </p>
                    <html:form action="/Customer/CustomerCarrier/Delete" method="POST">
                        <table>
                            <tr>
                        ...
                        <html:hidden property="carrierName" />
                    </html:form>
                </c:otherwise>
            </c:choose>
        </div>
