...
<html:html xhtml="true">
    <head>
        <title>Customer Carrier Account (<c:out value="${partyCarrierAccount.carrier.partyGroup.name}" />)</title>
        <html:base/>
    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <c:url var="customerCarrierAccountsUrl" value="/action/Customer/CustomerCarrierAccount/Main">
                    <c:param name="CustomerName" value="${customer.customerName}" />
                </c:url>
                <a href="${customerCarrierAccountsUrl}"><fmt:message key="navigation.customerCarrierAccounts" /></a> &gt;&gt;
                Edit
            </h2>
        </div>
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Customer/CustomerCarrierAccount/Edit" method="POST" focus="account">
                        <table>
                            <tr>
