        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Customer/CustomerPaymentMethod/CommentEdit" method="POST" focus="description">
                        <table>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <html:textarea property="clobComment" cols="${customerPaymentMethodCommentEditorUse.preferredWidth}" rows="${customerPaymentMethodCommentEditorUse.preferredHeight}" styleId="clobCommentTA" /> (*)
