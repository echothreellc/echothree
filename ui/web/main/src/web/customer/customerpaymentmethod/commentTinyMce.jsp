...
<et:partyApplicationEditorUse applicationName="main" applicationEditorUseName="CustomerPaymentMethodComment" var="customerPaymentMethodCommentEditorUse" commandResultVar="unused" scope="request" />

<script type="text/javascript">
    var clobCommentTAHasEditor = false;
    
    function mimeTypeChoiceChange() {
        <c:if test="${customerPaymentMethodCommentEditorUse.applicationEditor.editor.editorName == 'TINYMCE'}">
