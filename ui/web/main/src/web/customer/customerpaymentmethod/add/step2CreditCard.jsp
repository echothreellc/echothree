...
<c:if test='${paymentMethod.requestNameOnCard}'>
    <tr>
    ...
    <tr>
        ...
        <td>
            ...
            <c:if test='${paymentMethod.requireNameOnCard}'>
                (*)
            </c:if>
