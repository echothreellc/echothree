...
<html>
    <head>
        <title><fmt:message key="navigation.customers" /></title>
        <%@ include file="../include/environment-b.jsp" %>
    </head>
    <%@ include file="../include/body-start-b.jsp" %>
        <et:checkSecurityRoles securityRoles="CustomerType.List" />
        ...
        <a href="<c:url value="/action/Customer/Customer/Main" />">Customers</a><br />
        <et:hasSecurityRole securityRole="CustomerType.List">
            <a href="<c:url value="/action/Customer/CustomerType/Main" />">Customer Types</a><br />
        </et:hasSecurityRole>
