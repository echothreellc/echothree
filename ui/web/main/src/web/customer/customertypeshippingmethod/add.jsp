...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            <html:form action="/Customer/CustomerTypeShippingMethod/Add" method="POST">
                <table>
                    <tr>
                        <td align=right><fmt:message key="label.shippingMethod" />:</td>
                        <td>
                            <html:select property="shippingMethodChoice">
                                <html:optionsCollection property="shippingMethodChoices" />
                            </html:select> (*)
                            <et:validationErrors id="errorMessage" property="ShippingMethodName">
                                <p><c:out value="${errorMessage}" /></p>
                            </et:validationErrors>
                        </td>
                    </tr>
                    <tr>
                        <td align=right><fmt:message key="label.defaultSelectionPriority" />:</td>
                        <td>
                            <html:text property="defaultSelectionPriority" size="12" maxlength="12" /> (*)
                            <et:validationErrors id="errorMessage" property="DefaultSelectionPriority">
                                <p><c:out value="${errorMessage}" /></p>
                            </et:validationErrors>
                        </td>
                    </tr>
