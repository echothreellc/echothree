...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;Customer Type: <c:out value="${customerTypeShippingMethod.customerType.description}" /><br />
            &nbsp;&nbsp;&nbsp;&nbsp;Shipping Method: <c:out value="${customerTypeShippingMethod.shippingMethod.description}" /><br />
            <et:executionErrors id="errorMessage">
                <p class="executionErrors"><c:out value="${errorMessage}" /></p><br />
            </et:executionErrors>
            <html:form action="/Customer/CustomerTypeShippingMethod/Delete" method="POST">
                <table>
                    <tr>
