    ...
    <body>
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    <html:form action="/Customer/CustomerContactMechanism/ContactWebAddressStatus" method="POST">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.webAddressStatusChoice" />:</td>
                                <td>
                                    <html:select property="webAddressStatusChoice">
                                        <html:optionsCollection property="webAddressStatusChoices" />
                                    </html:select> (*)
                                    <et:validationErrors id="errorMessage" property="WebAddressStatusChoice">
