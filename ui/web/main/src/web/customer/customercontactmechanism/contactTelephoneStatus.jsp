    ...
    <body>
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    <html:form action="/Customer/CustomerContactMechanism/ContactTelephoneStatus" method="POST">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.telephoneStatusChoice" />:</td>
                                <td>
                                    <html:select property="telephoneStatusChoice">
                                        <html:optionsCollection property="telephoneStatusChoices" />
                                    </html:select> (*)
                                    <et:validationErrors id="errorMessage" property="TelephoneStatusChoice">
