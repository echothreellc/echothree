    ...
    <body>
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    <html:form action="/Customer/CustomerContactMechanism/ContactEmailAddressStatus" method="POST">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.emailAddressStatusChoice" />:</td>
                                <td>
                                    <html:select property="emailAddressStatusChoice">
                                        <html:optionsCollection property="emailAddressStatusChoices" />
                                    </html:select> (*)
                                    <et:validationErrors id="errorMessage" property="EmailAddressStatusChoice">
