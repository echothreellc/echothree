...
<et:partyApplicationEditorUse applicationName="main" applicationEditorUseName="CustomerContactMechanismComment" var="customerContactMechanismCommentEditorUse" commandResultVar="unused" scope="request" />

<script type="text/javascript">
    var clobCommentTAHasEditor = false;
    
    function mimeTypeChoiceChange() {
        <c:if test="${customerContactMechanismCommentEditorUse.applicationEditor.editor.editorName == 'TINYMCE'}">
