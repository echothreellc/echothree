    ...
    <body onLoad="pageLoaded()">
        <div id="Header">
            <h2>
                ...
                Edit <c:out value="${comment.commentType.description}" /> Comment
            </h2>
        </div>
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Customer/Customer/CommentEdit" method="POST" focus="description">
                        <table>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <html:textarea property="clobComment" cols="${customerCommentEditorUse.preferredWidth}" rows="${customerCommentEditorUse.preferredHeight}" styleId="clobCommentTA" /> (*)
