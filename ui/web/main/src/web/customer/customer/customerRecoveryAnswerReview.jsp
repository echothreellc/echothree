...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            <br />
            Recovery Question: <c:out value="${recoveryAnswer.recoveryQuestion.description}" /><br />
            Answer: <c:out value="${recoveryAnswer.answer}" /><br />
            <br />
            <br />
            <br />
            <c:set var="entityInstance" scope="request" value="${recoveryAnswer.entityInstance}" />
