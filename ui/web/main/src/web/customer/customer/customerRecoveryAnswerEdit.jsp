        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Customer/Customer/CustomerRecoveryAnswerEdit" method="POST" focus="answer">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.recoveryQuestion" />:</td>
                                <td>
                                    <html:select property="recoveryQuestionChoice">
                                        <html:optionsCollection property="recoveryQuestionChoices" />
                                    </html:select> (*)
                            ...
                            <tr>
                                ...
                                <td>
                                    <html:text property="answer" size="30" maxlength="40" /> (*)
