...
<et:partyApplicationEditorUse applicationName="main" applicationEditorUseName="CustomerComment" var="customerCommentEditorUse" commandResultVar="unused" scope="request" />

<script type="text/javascript">
    var clobCommentTAHasEditor = false;
    
    function mimeTypeChoiceChange() {
        <c:if test="${customerCommentEditorUse.applicationEditor.editor.editorName == 'TINYMCE'}">
