    ...
    <body>
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    <html:form action="/Customer/CustomerContactList/PartyContactListStatus" method="POST">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.partyContactListStatusChoice" />:</td>
                                <td>
                                    <html:select property="partyContactListStatusChoice">
                                        <html:optionsCollection property="partyContactListStatusChoices" />
                                    </html:select> (*)
                                    <et:validationErrors id="errorMessage" property="PartyContactListStatusChoice">
