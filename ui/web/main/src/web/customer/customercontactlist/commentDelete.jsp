    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <c:url var="reviewUrl" value="/action/Customer/CustomerContactList/Review">
                    <c:param name="PartyName" value="${customer.partyName}" />
                    <c:param name="ContactListName" value="${partyContactList.contactList.contactListName}" />
                </c:url>
                <a href="${reviewUrl}">Customer Contact List (<c:out value="${partyContactList.contactList.contactListName}" />)</a> &gt;&gt;
        ...
        <div id="Content">
            ...
            <html:form action="/Customer/CustomerContactList/CommentDelete" method="POST">
                <table>
                    <tr>
