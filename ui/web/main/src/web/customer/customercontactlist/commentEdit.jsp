        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Customer/CustomerContactList/CommentEdit" method="POST" focus="description">
                        <table>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <html:textarea property="clobComment" cols="${customerContactListCommentEditorUse.preferredWidth}" rows="${customerContactListCommentEditorUse.preferredHeight}" styleId="clobCommentTA" /> (*)
