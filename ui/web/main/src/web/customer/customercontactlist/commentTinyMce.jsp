...
<et:partyApplicationEditorUse applicationName="main" applicationEditorUseName="CustomerContactListComment" var="customerContactListCommentEditorUse" commandResultVar="unused" scope="request" />

<script type="text/javascript">
    var clobCommentTAHasEditor = false;
    
    function mimeTypeChoiceChange() {
        <c:if test="${customerContactListCommentEditorUse.applicationEditor.editor.editorName == 'TINYMCE'}">
