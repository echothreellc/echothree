...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;Customer Type: <c:out value="${customerTypePaymentMethod.customerType.description}" /><br />
            &nbsp;&nbsp;&nbsp;&nbsp;Payment Method: <c:out value="${customerTypePaymentMethod.paymentMethod.description}" /><br />
            <et:executionErrors id="errorMessage">
                <p class="executionErrors"><c:out value="${errorMessage}" /></p><br />
            </et:executionErrors>
            <html:form action="/Customer/CustomerTypePaymentMethod/Delete" method="POST">
                <table>
                    <tr>
