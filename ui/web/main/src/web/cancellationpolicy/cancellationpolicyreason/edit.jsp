    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <a href="${cancellationPolicyReasonsUrl}">Cancellation Reasons</a> &gt;&gt;
                Edit
            </h2>
        </div>
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/CancellationPolicy/CancellationPolicyReason/Edit" method="POST">
                        <table>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <html:hidden property="cancellationReasonName" />
                                </td>
