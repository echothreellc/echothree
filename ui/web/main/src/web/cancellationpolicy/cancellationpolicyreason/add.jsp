...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            <html:form action="/CancellationPolicy/CancellationPolicyReason/Add" method="POST">
                <table>
                    <tr>
                        <td align=right><fmt:message key="label.cancellationReasonChoice" />:</td>
                        <td>
                            <html:select property="cancellationReasonChoice">
                                <html:optionsCollection property="cancellationReasonChoices" />
                            </html:select>
