        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/CancellationPolicy/CancellationReason/Edit" method="POST" focus="cancellationReasonName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.cancellationReasonName" />:</td>
                                <td>
                                    <html:text property="cancellationReasonName" size="40" maxlength="40" /> (*)
                                    <et:validationErrors id="errorMessage" property="CancellationReasonName">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <html:hidden property="originalCancellationReasonName" />
                                </td>
