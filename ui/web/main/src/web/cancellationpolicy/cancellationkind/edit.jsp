        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/CancellationPolicy/CancellationKind/Edit" method="POST" focus="cancellationKindName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.cancellationKindName" />:</td>
                                <td>
                                    <html:text property="cancellationKindName" size="40" maxlength="40" /> (*)
                                    <et:validationErrors id="errorMessage" property="CancellationKindName">
                                        <p><c:out value="${errorMessage}" /></p>
                                    </et:validationErrors>
                                </td>
                            </tr>
                            <tr>
                                <td align=right><fmt:message key="label.cancellationSequenceType" />:</td>
                                <td>
                                    <html:select property="cancellationSequenceTypeChoice">
                                        <html:optionsCollection property="cancellationSequenceTypeChoices" />
                                    </html:select>
                                    <et:validationErrors id="errorMessage" property="CancellationSequenceTypeName">
                                        <p><c:out value="${errorMessage}" /></p>
                                    </et:validationErrors>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="originalCancellationKindName" />
                                </td>
