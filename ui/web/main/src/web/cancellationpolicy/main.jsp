...
<html>
    <head>
        <title><fmt:message key="pageTitle.cancellations" /></title>
        <%@ include file="../include/environment-b.jsp" %>
    </head>
    <%@ include file="../include/body-start-b.jsp" %>
        <et:checkSecurityRoles securityRoles="CancellationKind.List" />
        ...
        <et:hasSecurityRole securityRole="CancellationKind.List">
            <a href="<c:url value="/action/CancellationPolicy/CancellationKind/Main" />">Cancellation Kinds</a><br />
        </et:hasSecurityRole>
