...
<html:html xhtml="true">
    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <c:url var="descriptionsUrl" value="/action/CancellationPolicy/CancellationType/Description">
                    <c:param name="CancellationKindName" value="${cancellationKindName}" />
                    <c:param name="CancellationTypeName" value="${cancellationTypeName}" />
                </c:url>
        ...
        <div id="Content">
            ...
            <html:form action="/CancellationPolicy/CancellationType/DescriptionAdd" method="POST" focus="description">
                <table>
                    <tr>
