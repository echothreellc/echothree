        ...
        <div id="Header">
            <h2>
                ...
                <c:url var="cancellationReasonTypesUrl" value="/action/CancellationPolicy/CancellationReasonType/Main">
                    <c:param name="CancellationKindName" value="${cancellationKindName}" />
                    <c:param name="CancellationReasonName" value="${cancellationReasonName}" />
                </c:url>
                <a href="${cancellationReasonTypesUrl}">Cancellation Types</a> &gt;&gt;
                Edit
            </h2>
        </div>
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/CancellationPolicy/CancellationReasonType/Edit" method="POST">
                        <table>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <html:hidden property="cancellationTypeName" />
                                </td>
