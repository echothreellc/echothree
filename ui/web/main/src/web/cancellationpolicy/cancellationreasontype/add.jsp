...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            <html:form action="/CancellationPolicy/CancellationReasonType/Add" method="POST">
                <table>
                    <tr>
                        <td align=right><fmt:message key="label.cancellationTypeChoice" />:</td>
                        <td>
                            <html:select property="cancellationTypeChoice">
                                <html:optionsCollection property="cancellationTypeChoices" />
                            </html:select>
