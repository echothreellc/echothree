        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/CancellationPolicy/CancellationPolicy/Edit" method="POST" focus="cancellationPolicyName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.cancellationPolicyName" />:</td>
                                <td>
                                    <html:text property="cancellationPolicyName" size="40" maxlength="40" /> (*)
                            ...
                            <tr>
                                ...
                                <td>
                                    <html:textarea property="policy" cols="60" rows="5" styleId="policy" />
                            ...
                            <tr>
                                <td>
                                    ...
                                    <html:hidden property="originalCancellationPolicyName" />
                                </td>
