        ...
        <div id="Header">
            <h2>
                ...
                <c:url var="translationsUrl" value="/action/CancellationPolicy/CancellationPolicy/Translation">
                    <c:param name="CancellationKindName" value="${cancellationKindName}" />
                    <c:param name="CancellationPolicyName" value="${cancellationPolicyName}" />
                </c:url>
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/CancellationPolicy/CancellationPolicy/TranslationEdit" method="POST" focus="description">
                        <table>
                            <tr>
                            ...
                            <tr>
                                <td align=right><fmt:message key="label.policyMimeTypeChoice" />:</td>
                                <td>
                                    <html:select onchange="policyMimeTypeChoiceChange()" property="policyMimeTypeChoice" styleId="policyMimeTypeChoices">
                                        <html:optionsCollection property="policyMimeTypeChoices" />
                                    </html:select>
                                    <et:validationErrors id="errorMessage" property="PolicyMimeTypeName">
                                        <p><c:out value="${errorMessage}" /></p>
                                    </et:validationErrors>
                                </td>
                            </tr>
                            <tr>
                                <td align=right><fmt:message key="label.policy" />:</td>
                                <td>
                                    <html:textarea property="policy" cols="${cancellationPolicyTranslationEditorUse.preferredWidth}" rows="${cancellationPolicyTranslationEditorUse.preferredHeight}" styleId="policyTA" />
                                    <et:validationErrors id="errorMessage" property="Policy">
                                        <p><c:out value="${errorMessage}" /></p>
                                    </et:validationErrors>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    ...
                                    <html:hidden property="cancellationPolicyName" />
