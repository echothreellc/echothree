        ...
        <div id="Header">
            <h2>
                ...
                <c:url var="subscriptionTypesUrl" value="/action/Subscription/SubscriptionType/Main">
                    <c:param name="SubscriptionKindName" value="${subscriptionKindName}" />
                </c:url>
                <a href="${subscriptionTypesUrl}">Types</a> &gt;&gt;
                <c:url var="descriptionsUrl" value="/action/Subscription/SubscriptionType/Description">
                    <c:param name="SubscriptionKindName" value="${subscriptionKindName}" />
                    <c:param name="SubscriptionTypeName" value="${subscriptionTypeName}" />
                </c:url>
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Subscription/SubscriptionType/DescriptionEdit" method="POST" focus="description">
                        <table>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="subscriptionKindName" />
                                    <html:hidden property="subscriptionTypeName" />
