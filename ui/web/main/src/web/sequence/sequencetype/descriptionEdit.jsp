    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <c:url var="descriptionsUrl" value="/action/Sequence/SequenceType/Description">
            ...
            <c:choose>
                ...
                <c:otherwise>
                    <et:executionErrors id="errorMessage">
                        ...
                        <html:form action="/Sequence/SequenceType/DescriptionEdit" method="POST" focus="description">
                        <table>
                            <tr>
