    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <c:url var="descriptionsUrl" value="/action/Sequence/Sequence/Description">
                    <c:param name="SequenceTypeName" value="${sequenceTypeName}" />
                    <c:param name="SequenceName" value="${sequenceName}" />
                </c:url>
            ...
            <c:choose>
                ...
                <c:otherwise>
                    <et:executionErrors id="errorMessage">
                        ...
                        <html:form action="/Sequence/Sequence/DescriptionEdit" method="POST" focus="description">
                        <table>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <html:hidden property="sequenceName" />
