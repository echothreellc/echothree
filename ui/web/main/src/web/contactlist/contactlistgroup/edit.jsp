        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/ContactList/ContactListGroup/Edit" method="POST" focus="contactListGroupName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.contactListGroupName" />:</td>
                                <td>
                                    <html:text property="contactListGroupName" size="40" maxlength="40" /> (*)
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="originalContactListGroupName" />
                                </td>
