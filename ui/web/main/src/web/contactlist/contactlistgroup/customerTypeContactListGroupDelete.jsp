...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;Contact List Group: <c:out value="${customerTypeContactListGroup.contactListGroup.description}" /><br />
            &nbsp;&nbsp;&nbsp;&nbsp;Customer Type: <c:out value="${customerTypeContactListGroup.customerType.description}" /><br />
            <et:executionErrors id="errorMessage">
                <p class="executionErrors"><c:out value="${errorMessage}" /></p><br />
            </et:executionErrors>
            <html:form action="/ContactList/ContactListGroup/CustomerTypeContactListGroupDelete" method="POST">
                <table>
                    <tr>
