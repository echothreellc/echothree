...
<html:html xhtml="true">
    <head>
        <title><fmt:message key="pageTitle.contactListGroupDescriptions" /></title>
        <html:base/>
        ...
        <div id="Header">
            <h2>
                ...
                <c:url var="descriptionsUrl" value="/action/ContactList/ContactListGroup/Description">
                    <c:param name="ContactListGroupName" value="${contactListGroupDescription.contactListGroup.contactListGroupName}" />
                </c:url>
                <a href="${descriptionsUrl}"><fmt:message key="navigation.contactListGroupDescriptions" /></a> &gt;&gt;
                Edit
            </h2>
        </div>
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/ContactList/ContactListGroup/DescriptionEdit" method="POST" focus="description">
                        <table>
                            <tr>
