    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <c:url var="descriptionsUrl" value="/action/ContactList/ContactListGroup/PartyTypeContactListGroup">
                    <c:param name="ContactListGroupName" value="${partyTypeContactListGroup.contactListGroup.contactListGroupName}" />
                </c:url>
                <a href="${descriptionsUrl}"><fmt:message key="navigation.partyTypeContactListGroups" /></a> &gt;&gt;
                Edit
            </h2>
        </div>
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/ContactList/ContactListGroup/PartyTypeContactListGroupEdit" method="POST">
                        <table>
                            <tr>
