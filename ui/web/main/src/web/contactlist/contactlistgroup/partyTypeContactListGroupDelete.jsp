...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;Contact List Group: <c:out value="${partyTypeContactListGroup.contactListGroup.description}" /><br />
            &nbsp;&nbsp;&nbsp;&nbsp;Party Type: <c:out value="${partyTypeContactListGroup.partyType.description}" /><br />
            <et:executionErrors id="errorMessage">
                <p class="executionErrors"><c:out value="${errorMessage}" /></p><br />
            </et:executionErrors>
            <html:form action="/ContactList/ContactListGroup/PartyTypeContactListGroupDelete" method="POST">
                <table>
                    <tr>
