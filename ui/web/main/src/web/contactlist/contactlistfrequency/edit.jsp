        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/ContactList/ContactListFrequency/Edit" method="POST" focus="contactListFrequencyName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.contactListFrequencyName" />:</td>
                                <td>
                                    <html:text property="contactListFrequencyName" size="40" maxlength="40" /> (*)
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="originalContactListFrequencyName" />
                                </td>
