    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <a href="${contactListContactMechanismPurposesUrl}"><fmt:message key="navigation.contactListContactMechanismPurposes" /></a> &gt;&gt;
                Edit
            </h2>
        </div>
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/ContactList/ContactList/ContactListContactMechanismPurposeEdit" method="POST">
                        <table>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <html:hidden property="contactMechanismPurposeName" />
                                </td>
