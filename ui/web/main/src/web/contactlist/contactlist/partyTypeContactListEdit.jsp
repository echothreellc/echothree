...
<html:html xhtml="true">
    <head>
        <title><fmt:message key="pageTitle.partyTypeContactLists" /></title>
        <html:base/>
    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <c:url var="descriptionsUrl" value="/action/ContactList/ContactList/PartyTypeContactList">
                    <c:param name="ContactListName" value="${partyTypeContactList.contactList.contactListName}" />
                </c:url>
                <a href="${descriptionsUrl}"><fmt:message key="navigation.partyTypeContactLists" /></a> &gt;&gt;
                Edit
            </h2>
        </div>
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/ContactList/ContactList/PartyTypeContactListEdit" method="POST">
                        <table>
                            <tr>
