...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;Contact List: <c:out value="${contactListContactMechanismPurpose.contactList.description}" /><br />
            &nbsp;&nbsp;&nbsp;&nbsp;Contact Mechanism Purpose <c:out value="${contactListContactMechanismPurpose.contactMechanismPurpose.description}" /><br />
            <et:executionErrors id="errorMessage">
                <p class="executionErrors"><c:out value="${errorMessage}" /></p><br />
            </et:executionErrors>
            <html:form action="/ContactList/ContactList/ContactListContactMechanismPurposeDelete" method="POST">
                <table>
                    <tr>
