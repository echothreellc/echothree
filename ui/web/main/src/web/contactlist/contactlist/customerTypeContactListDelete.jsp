...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;Contact List: <c:out value="${customerTypeContactList.contactList.description}" /><br />
            &nbsp;&nbsp;&nbsp;&nbsp;Customer Type: <c:out value="${customerTypeContactList.customerType.description}" /><br />
            <et:executionErrors id="errorMessage">
                <p class="executionErrors"><c:out value="${errorMessage}" /></p><br />
            </et:executionErrors>
            <html:form action="/ContactList/ContactList/CustomerTypeContactListDelete" method="POST">
                <table>
                    <tr>
