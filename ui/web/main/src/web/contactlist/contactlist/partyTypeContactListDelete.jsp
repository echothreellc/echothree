...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;Contact List: <c:out value="${partyTypeContactList.contactList.description}" /><br />
            &nbsp;&nbsp;&nbsp;&nbsp;Party Type: <c:out value="${partyTypeContactList.partyType.description}" /><br />
            <et:executionErrors id="errorMessage">
                <p class="executionErrors"><c:out value="${errorMessage}" /></p><br />
            </et:executionErrors>
            <html:form action="/ContactList/ContactList/PartyTypeContactListDelete" method="POST">
                <table>
                    <tr>
