...
<html>
    <head>
        <title><fmt:message key="navigation.salesOrders" /></title>
        <%@ include file="../include/environment-b.jsp" %>
    </head>
    <%@ include file="../include/body-start-b.jsp" %>
        <et:checkSecurityRoles securityRoles="SalesOrder.List:SalesOrderBatch.List" />
        ...
        <et:hasSecurityRole securityRole="SalesOrder.List">
            <a href="<c:url value="/action/SalesOrder/SalesOrder/Main" />">Sales Orders</a><br />
        </et:hasSecurityRole>
        <et:hasSecurityRole securityRole="SalesOrderBatch.List">
            <a href="<c:url value="/action/SalesOrder/SalesOrderBatch/Main" />">Sales Order Batches</a><br />
        </et:hasSecurityRole>
