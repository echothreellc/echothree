        ...
        <div id="Header">
            <h2>
                ...
                <c:url var="returnTypeShippingMethodsUrl" value="/action/ReturnPolicy/ReturnTypeShippingMethod/Main">
                    <c:param name="ReturnKindName" value="${returnKindName}" />
                    <c:param name="ReturnTypeName" value="${returnTypeName}" />
                </c:url>
                <a href="${returnTypeShippingMethodsUrl}">Shipping Methods</a> &gt;&gt;
                Edit
            </h2>
        </div>
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/ReturnPolicy/ReturnTypeShippingMethod/Edit" method="POST">
                        <table>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <html:hidden property="returnTypeName" />
