        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/ReturnPolicy/ReturnKind/Edit" method="POST" focus="returnKindName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.returnKindName" />:</td>
                                <td>
                                    <html:text property="returnKindName" size="40" maxlength="40" /> (*)
                                    <et:validationErrors id="errorMessage" property="ReturnKindName">
                                        <p><c:out value="${errorMessage}" /></p>
                                    </et:validationErrors>
                                </td>
                            </tr>
                            <tr>
                                <td align=right><fmt:message key="label.returnSequenceType" />:</td>
                                <td>
                                    <html:select property="returnSequenceTypeChoice">
                                        <html:optionsCollection property="returnSequenceTypeChoices" />
                                    </html:select> (*)
                                    <et:validationErrors id="errorMessage" property="ReturnSequenceTypeName">
                                        <p><c:out value="${errorMessage}" /></p>
                                    </et:validationErrors>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="originalReturnKindName" />
                                </td>
