        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/ReturnPolicy/ReturnReason/Edit" method="POST" focus="returnReasonName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.returnReasonName" />:</td>
                                <td>
                                    <html:text property="returnReasonName" size="40" maxlength="40" /> (*)
                            ...
                            <tr>
                                <td>
                                    ...
                                    <html:hidden property="originalReturnReasonName" />
                                </td>
