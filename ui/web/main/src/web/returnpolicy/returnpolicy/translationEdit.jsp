        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/ReturnPolicy/ReturnPolicy/TranslationEdit" method="POST" focus="description">
                        <table>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <html:textarea property="policy" cols="${returnPolicyTranslationEditorUse.preferredWidth}" rows="${returnPolicyTranslationEditorUse.preferredHeight}" styleId="policyTA" />
