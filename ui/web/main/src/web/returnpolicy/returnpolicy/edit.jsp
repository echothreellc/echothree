        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/ReturnPolicy/ReturnPolicy/Edit" method="POST" focus="returnPolicyName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.returnPolicyName" />:</td>
                                <td>
                                    <html:text property="returnPolicyName" size="40" maxlength="40" /> (*)
                            ...
                            <tr>
                                <td>
                                    ...
                                    <html:hidden property="originalReturnPolicyName" />
                                </td>
