        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/ReturnPolicy/ReturnType/Edit" method="POST" focus="returnTypeName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.returnTypeName" />:</td>
                                <td>
                                    <html:text property="returnTypeName" size="40" maxlength="40" /> (*)
                                    <et:validationErrors id="errorMessage" property="ReturnTypeName">
                                        <p><c:out value="${errorMessage}" /></p>
                                    </et:validationErrors>
                                </td>
                            </tr>
                            <tr>
                                <td align=right><fmt:message key="label.returnSequence" />:</td>
                                <td>
                                    <html:select property="returnSequenceChoice">
                                        <html:optionsCollection property="returnSequenceChoices" />
                                    </html:select>
                                    <et:validationErrors id="errorMessage" property="ReturnSequenceName">
                                        <p><c:out value="${errorMessage}" /></p>
                                    </et:validationErrors>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <html:hidden property="originalReturnTypeName" />
                                </td>
