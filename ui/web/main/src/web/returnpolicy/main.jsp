...
<html>
    <head>
        <title><fmt:message key="navigation.returns" /></title>
        <%@ include file="../include/environment-b.jsp" %>
    </head>
    <%@ include file="../include/body-start-b.jsp" %>
        <et:checkSecurityRoles securityRoles="ReturnKind.List" />
        ...
        <et:hasSecurityRole securityRole="ReturnKind.List">
            <a href="<c:url value="/action/ReturnPolicy/ReturnKind/Main" />">Return Kinds</a><br />
        </et:hasSecurityRole>
