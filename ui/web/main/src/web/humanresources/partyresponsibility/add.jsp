    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <c:url var="responsibilitiesUrl" value="/action/HumanResources/PartyResponsibility/Main">
                    <c:param name="PartyName" value="${employee.partyName}" />
                </c:url>
                <a href="${responsibilitiesUrl}">Responsibilities</a> &gt;&gt;
                Add
            </h2>
        </div>
        <div id="Content">
            ...
            <html:form action="/HumanResources/PartyResponsibility/Add" method="POST">
                <table>
                    <tr>
