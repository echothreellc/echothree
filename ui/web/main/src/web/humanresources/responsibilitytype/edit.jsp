        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/HumanResources/ResponsibilityType/Edit" method="POST" focus="responsibilityTypeName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.responsibilityTypeName" />:</td>
                                <td>
                                    <html:text property="responsibilityTypeName" size="40" maxlength="40" /> (*)
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="originalResponsibilityTypeName" />
                                </td>
