...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            <html:form action="/HumanResources/EmployeeType/Add" method="POST" focus="employeeTypeName">
                <table>
                    <tr>
                        <td align=right><fmt:message key="label.employeeTypeName" />:</td>
                        <td>
                            <html:text property="employeeTypeName" size="40" maxlength="40" /> (*)
