    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <a href="${employeePrinterGroupUsesUrl}"><fmt:message key="navigation.employeePrinterGroupUses" /></a> &gt;&gt;
                Edit
            </h2>
        </div>
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/HumanResources/EmployeePrinterGroupUse/Edit" method="POST">
                        <table>
                            <tr>
