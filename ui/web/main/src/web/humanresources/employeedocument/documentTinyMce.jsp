...
<et:partyApplicationEditorUse applicationName="main" applicationEditorUseName="EmployeeDocument" var="employeeDocumentEditorUse" commandResultVar="unused" scope="request" />

<script type="text/javascript">
    var clobTAHasEditor = false;
    
    function mimeTypeChoiceChange() {
        <c:if test="${employeeDocumentEditorUse.applicationEditor.editor.editorName == 'TINYMCE'}">
