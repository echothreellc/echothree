    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <c:url var="employeeDocumentsUrl" value="/action/HumanResources/EmployeeDocument/Description">
                    <c:param name="PartyName" value="${employee.partyName}" />
                    <c:param name="DocumentName" value="${documentDescription.document.documentName}" />
                </c:url>
                <a href="${employeeDocumentsUrl}"><fmt:message key="navigation.employeeDocumentDescriptions" /></a> &gt;&gt;
                Delete
            </h2>
        </div>
        <div id="Content">
            ...
            <html:form action="/HumanResources/EmployeeDocument/DescriptionDelete" method="POST">
                <table>
                    <tr>
