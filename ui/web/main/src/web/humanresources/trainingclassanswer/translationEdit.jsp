        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/HumanResources/TrainingClassAnswer/TranslationEdit" method="POST" focus="description">
                        <table>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <html:textarea property="answer" cols="${trainingClassAnswerAnswerEditorUse.preferredWidth}" rows="${trainingClassAnswerAnswerEditorUse.preferredHeight}" styleId="answerTA" /> (*)
                            ...
                            <tr>
                                ...
                                <td>
                                    <html:textarea property="selected" cols="${trainingClassAnswerSelectedEditorUse.preferredWidth}" rows="${trainingClassAnswerSelectedEditorUse.preferredHeight}" styleId="selectedTA" />
                            ...
                            <tr>
                                <td>
                                    ...
                                    <html:hidden property="trainingClassAnswerName" />
