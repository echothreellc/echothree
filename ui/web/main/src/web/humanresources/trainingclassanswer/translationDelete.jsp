...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            <p>You are about to delete the <c:out value="${trainingClassAnswerTranslation.language.description}" />
            <c:out value="${fn:toLowerCase(partyEntityType.entityType.description)}" /> for &quot;<c:out value="${trainingClassAnswerTranslation.trainingClassAnswer.trainingClassAnswerName}" />.&quot;</p>
            <et:executionErrors id="errorMessage">
                <p class="executionErrors"><c:out value="${errorMessage}" /></p><br />
            </et:executionErrors>
            <html:form action="/HumanResources/TrainingClassAnswer/TranslationDelete" method="POST">
                <table>
                    <tr>
