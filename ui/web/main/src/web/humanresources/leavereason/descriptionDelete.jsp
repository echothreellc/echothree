    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <a href="${descriptionsUrl}"><fmt:message key="navigation.leaveReasonDescriptions" /></a> &gt;&gt;
                Delete
            </h2>
        </div>
        <div id="Content">
            <p>You are about to delete the <c:out value="${leaveReasonDescription.language.description}" />
            <c:out value="${fn:toLowerCase(partyEntityType.entityType.description)}" /> for &quot;<c:out value="${leaveReasonDescription.leaveReason.description}" />&quot;
            (<c:out value="${leaveReasonDescription.leaveReason.leaveReasonName}" />).</p>
            <et:executionErrors id="errorMessage">
                <p class="executionErrors"><c:out value="${errorMessage}" /></p><br />
            </et:executionErrors>
            <html:form action="/HumanResources/LeaveReason/DescriptionDelete" method="POST">
                <table>
                    <tr>
                ...
                <html:hidden property="leaveReasonName" />
