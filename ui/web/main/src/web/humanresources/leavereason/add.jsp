...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            <html:form action="/HumanResources/LeaveReason/Add" method="POST" focus="leaveReasonName">
                <table>
                    <tr>
                        <td align=right><fmt:message key="label.leaveReasonName" />:</td>
                        <td>
                            <html:text property="leaveReasonName" size="40" maxlength="40" /> (*)
