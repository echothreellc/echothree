...
<html:html xhtml="true">
    <head>
        <title><fmt:message key="pageTitle.leaveTypeDescriptions" /></title>
        <html:base/>
        ...
        <div id="Header">
            <h2>
                ...
                <c:url var="descriptionsUrl" value="/action/HumanResources/LeaveType/Description">
                    <c:param name="LeaveTypeName" value="${leaveTypeDescription.leaveType.leaveTypeName}" />
                </c:url>
                <a href="${descriptionsUrl}"><fmt:message key="navigation.leaveTypeDescriptions" /></a> &gt;&gt;
                Edit
            </h2>
        </div>
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/HumanResources/LeaveType/DescriptionEdit" method="POST" focus="description">
                        <table>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="leaveTypeName" />
