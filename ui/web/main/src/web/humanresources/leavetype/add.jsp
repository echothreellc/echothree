...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            <html:form action="/HumanResources/LeaveType/Add" method="POST" focus="leaveTypeName">
                <table>
                    <tr>
                        <td align=right><fmt:message key="label.leaveTypeName" />:</td>
                        <td>
                            <html:text property="leaveTypeName" size="40" maxlength="40" /> (*)
