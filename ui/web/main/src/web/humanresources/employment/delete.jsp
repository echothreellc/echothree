        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;Party: <c:out value="${employment.party.partyName}" /><br />
                    &nbsp;&nbsp;&nbsp;&nbsp;Company: <c:out value="${employment.company.partyGroup.name}" /><br />
                    &nbsp;&nbsp;&nbsp;&nbsp;Start Time <c:out value="${employment.startTime}" /><br />
                    <c:if test="${employment.endTime != null}">
                        &nbsp;&nbsp;&nbsp;&nbsp;End Time <c:out value="${employment.endTime}" /><br />
                    </c:if>
                    <html:form action="/HumanResources/Employment/Delete" method="POST">
                        <table>
                            <tr>
                        ...
                        <html:hidden property="employmentName" />
                    </html:form>
                </c:otherwise>
            </c:choose>
        </div>
