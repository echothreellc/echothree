...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            <html:form action="/HumanResources/Employment/Add" method="POST" focus="startTime">
                <table>
                    <tr>
                    ...
                    <tr>
                        <td align=right><fmt:message key="label.terminationType" />:</td>
                        <td>
                            <html:select property="terminationTypeChoice">
                                <html:optionsCollection property="terminationTypeChoices" />
                            </html:select>
                            <et:validationErrors id="errorMessage" property="TerminationTypeName">
                                <p><c:out value="${errorMessage}" /></p>
                            </et:validationErrors>
                        </td>
                    </tr>
                    <tr>
                        <td align=right><fmt:message key="label.terminationReason" />:</td>
                        <td>
                            <html:select property="terminationReasonChoice">
                                <html:optionsCollection property="terminationReasonChoices" />
                            </html:select>
                            <et:validationErrors id="errorMessage" property="TerminationReasonName">
                                <p><c:out value="${errorMessage}" /></p>
                            </et:validationErrors>
                        </td>
                    </tr>
