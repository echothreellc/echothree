        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/HumanResources/TerminationType/Edit" method="POST" focus="terminationTypeName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.terminationTypeName" />:</td>
                                <td>
                                    <html:text property="terminationTypeName" size="40" maxlength="40" /> (*)
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="originalTerminationTypeName" />
                                </td>
