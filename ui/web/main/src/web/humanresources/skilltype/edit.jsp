        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/HumanResources/SkillType/Edit" method="POST" focus="skillTypeName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.skillTypeName" />:</td>
                                <td>
                                    <html:text property="skillTypeName" size="40" maxlength="40" /> (*)
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="originalSkillTypeName" />
                                </td>
