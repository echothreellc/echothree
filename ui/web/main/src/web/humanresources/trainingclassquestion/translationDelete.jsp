...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            <p>You are about to delete the <c:out value="${trainingClassQuestionTranslation.language.description}" />
            <c:out value="${fn:toLowerCase(partyEntityType.entityType.description)}" /> for &quot;<c:out value="${trainingClassQuestionTranslation.trainingClassQuestion.trainingClassQuestionName}" />.&quot;</p>
            <et:executionErrors id="errorMessage">
                <p class="executionErrors"><c:out value="${errorMessage}" /></p><br />
            </et:executionErrors>
            <html:form action="/HumanResources/TrainingClassQuestion/TranslationDelete" method="POST">
                <table>
                    <tr>
