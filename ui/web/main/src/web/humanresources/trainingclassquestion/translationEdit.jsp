        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/HumanResources/TrainingClassQuestion/TranslationEdit" method="POST" focus="description">
                        <table>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <html:textarea property="question" cols="${trainingClassQuestionQuestionEditorUse.preferredWidth}" rows="${trainingClassQuestionQuestionEditorUse.preferredHeight}" styleId="questionTA" /> (*)
