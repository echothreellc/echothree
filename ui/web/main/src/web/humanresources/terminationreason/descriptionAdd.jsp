...
<html:html xhtml="true">
    <head>
        <title>Termination Reason Descriptions</title>
        <html:base/>
    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <c:url var="descriptionsUrl" value="/action/HumanResources/TerminationReason/Description">
                    <c:param name="TerminationReasonName" value="${terminationReasonName}" />
                </c:url>
        ...
        <div id="Content">
            ...
            <html:form action="/HumanResources/TerminationReason/DescriptionAdd" method="POST" focus="description">
                <table>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <html:hidden property="terminationReasonName" />
                        </td>
