        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/HumanResources/TerminationReason/Edit" method="POST" focus="terminationReasonName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.terminationReasonName" />:</td>
                                <td>
                                    <html:text property="terminationReasonName" size="40" maxlength="40" /> (*)
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="originalTerminationReasonName" />
                                </td>
