        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/HumanResources/TrainingClassSection/Edit" method="POST" focus="trainingClassSectionName">
                        <table>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <html:hidden property="originalTrainingClassSectionName" />
                                </td>
