...
<html:html xhtml="true">
    <head>
        <title>Review (<c:out value="${trainingClassSectionTranslation.trainingClassSection.trainingClassSectionName}" />, <c:out value="${trainingClassSectionTranslation.language.languageIsoName}" />)</title>
        <html:base/>
    ...
    <body>
        <div id="Header">
            <h2>
                ...
                Review (<c:out value="${trainingClassSectionTranslation.trainingClassSection.trainingClassSectionName}" />, <c:out value="${trainingClassSectionTranslation.language.languageIsoName}" />)
            </h2>
        </div>
        <div id="Content">
            <et:checkSecurityRoles securityRoles="TrainingClass.Review:TrainingClassSection.Review:Language.Review" />
            ...
            <p><font size="+2"><b><c:out value="${trainingClassSectionTranslation.trainingClassSection.trainingClassSectionName}" /></b></font></p>
            <br />
            ...
            <c:choose>
                <c:when test="${includeTrainingClassReviewUrl}">
                    ...
                    <a href="${trainingClassUrl}"><c:out value="${trainingClassSectionTranslation.trainingClassSection.trainingClass.description}" /></a>
                </c:when>
                <c:otherwise>
                    <c:out value="${trainingClassSectionTranslation.trainingClassSection.trainingClass.description}" />
                </c:otherwise>
            </c:choose>
            <br />
            ...
            <c:choose>
                <c:when test="${includeTrainingClassSectionReviewUrl}">
                    ...
                    <a href="${trainingClassUrl}"><c:out value="${trainingClassSectionTranslation.trainingClassSection.description}" /></a>
                </c:when>
                <c:otherwise>
                    <c:out value="${trainingClassSectionTranslation.trainingClassSection.description}" />
                </c:otherwise>
            </c:choose>
            <br />
            ...
            <c:choose>
                <c:when test="${includeLanguageReviewUrl}">
                    ...
                    <a href="${languageUrl}"><c:out value="${trainingClassSectionTranslation.language.description}" /></a>
                </c:when>
                <c:otherwise>
            ...
            <table class="displaytag">
                <tbody>
                    <tr class="odd">
                        <td>
                            <et:out value="${trainingClassSectionTranslation.overview}" mimeTypeName="${trainingClassSectionTranslation.overviewMimeType.mimeTypeName}" />
                        </td>
                    </tr>
                </tbody>
            </table>
            ...
            <table class="displaytag">
                <tbody>
                    <tr class="odd">
                        <td>
                            <et:out value="${trainingClassSectionTranslation.introduction}" mimeTypeName="${trainingClassSectionTranslation.introductionMimeType.mimeTypeName}" />
                        </td>
                    </tr>
                </tbody>
            </table>
