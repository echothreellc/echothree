        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/HumanResources/TrainingClassSection/TranslationEdit" method="POST" focus="description">
                        <table>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <html:textarea property="introduction" cols="${trainingClassSectionIntroductionEditorUse.preferredWidth}" rows="${trainingClassSectionIntroductionEditorUse.preferredHeight}" styleId="introductionTA" />
