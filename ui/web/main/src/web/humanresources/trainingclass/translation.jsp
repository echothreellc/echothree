...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            <c:url var="addUrl" value="/action/HumanResources/TrainingClass/TranslationAdd">
                <c:param name="TrainingClassName" value="${trainingClass.trainingClassName}" />
            </c:url>
            <p><a href="${addUrl}">Add Translation.</a></p>
            <display:table name="trainingClassTranslations" id="trainingClassTranslation" class="displaytag">
                <display:column>
                    <c:url var="reviewUrl" value="/action/HumanResources/TrainingClass/TranslationReview">
                ...
                <display:column titleKey="columnTitle.description">
                    <c:out value="${trainingClassTranslation.description}" />
                </display:column>
                <display:column>
                    <c:url var="editUrl" value="/action/HumanResources/TrainingClass/TranslationEdit">
                        <c:param name="TrainingClassName" value="${trainingClassTranslation.trainingClass.trainingClassName}" />
                        <c:param name="LanguageIsoName" value="${trainingClassTranslation.language.languageIsoName}" />
                    </c:url>
                    <a href="${editUrl}">Edit</a>
                    <c:url var="deleteUrl" value="/action/HumanResources/TrainingClass/TranslationDelete">
                        <c:param name="TrainingClassName" value="${trainingClassTranslation.trainingClass.trainingClassName}" />
                        <c:param name="LanguageIsoName" value="${trainingClassTranslation.language.languageIsoName}" />
                    </c:url>
