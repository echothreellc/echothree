...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            <c:url var="addUrl" value="/action/HumanResources/TrainingClassPage/TranslationAdd">
                <c:param name="TrainingClassName" value="${trainingClassPage.trainingClassSection.trainingClass.trainingClassName}" />
                <c:param name="TrainingClassSectionName" value="${trainingClassPage.trainingClassSection.trainingClassSectionName}" />
                <c:param name="TrainingClassPageName" value="${trainingClassPage.trainingClassPageName}" />
            </c:url>
            <p><a href="${addUrl}">Add Translation.</a></p>
            <display:table name="trainingClassPageTranslations" id="trainingClassPageTranslation" class="displaytag">
                <display:column>
                    <c:url var="reviewUrl" value="/action/HumanResources/TrainingClassPage/TranslationReview">
                ...
                <display:column titleKey="columnTitle.description">
                    <c:out value="${trainingClassPageTranslation.description}" />
                </display:column>
                <display:column>
                    <c:url var="editUrl" value="/action/HumanResources/TrainingClassPage/TranslationEdit">
                        <c:param name="TrainingClassName" value="${trainingClassPageTranslation.trainingClassPage.trainingClassSection.trainingClass.trainingClassName}" />
                        <c:param name="TrainingClassSectionName" value="${trainingClassPageTranslation.trainingClassPage.trainingClassSection.trainingClassSectionName}" />
                        <c:param name="TrainingClassPageName" value="${trainingClassPageTranslation.trainingClassPage.trainingClassPageName}" />
                        <c:param name="LanguageIsoName" value="${trainingClassPageTranslation.language.languageIsoName}" />
                    ...
                    <c:url var="deleteUrl" value="/action/HumanResources/TrainingClassPage/TranslationDelete">
                        <c:param name="TrainingClassName" value="${trainingClassPageTranslation.trainingClassPage.trainingClassSection.trainingClass.trainingClassName}" />
                        <c:param name="TrainingClassSectionName" value="${trainingClassPageTranslation.trainingClassPage.trainingClassSection.trainingClassSectionName}" />
                        <c:param name="TrainingClassPageName" value="${trainingClassPageTranslation.trainingClassPage.trainingClassPageName}" />
                        <c:param name="LanguageIsoName" value="${trainingClassPageTranslation.language.languageIsoName}" />
