        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/HumanResources/TrainingClassPage/Edit" method="POST" focus="trainingClassPageName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.trainingClassPageName" />:</td>
                                <td>
                                    <html:text property="trainingClassPageName" size="40" maxlength="40" /> (*)
                                    <et:validationErrors id="errorMessage" property="TrainingClassPageName">
                            ...
                            <tr>
                                ...
                                <td>
                                    <html:textarea property="page" cols="60" rows="5" styleId="page" />
                            ...
                            <tr>
                                <td>
                                    ...
                                    <html:hidden property="originalTrainingClassPageName" />
                                </td>
