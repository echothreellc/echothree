    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <c:url var="partyTrainingClassSessionUrl" value="/action/HumanResources/PartyTrainingClassSession/Review">
                    <c:param name="PartyTrainingClassName" value="${partyTrainingClassSession.partyTrainingClass.partyTrainingClassName}" />
                    <c:param name="PartyTrainingClassSessionSequence" value="${partyTrainingClassSession.partyTrainingClassSessionSequence}" />
                </c:url>
                <a href="${partyTrainingClassSessionUrl}"><fmt:message key="navigation.partyTrainingClassSession">
                    <fmt:param value="${partyTrainingClassSession.partyTrainingClass.partyTrainingClassName}" />
                    <fmt:param value="${partyTrainingClassSession.partyTrainingClassSessionSequence}" />
                </fmt:message></a> &gt;&gt;
                Delete
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;<fmt:message key="label.partyTrainingClassName" />: <c:out value="${partyTrainingClassSession.partyTrainingClass.partyTrainingClassName}" /><br />
                    ...
                    <html:form action="/HumanResources/PartyTrainingClassSession/Delete" method="POST">
                        <table>
                            <tr>
                        ...
                        <html:hidden property="partyTrainingClassSessionSequence" />
                    </html:form>
                </c:otherwise>
            </c:choose>
        </div>
