        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;Party: <c:out value="${leave.party.partyName}" /><br />
                    &nbsp;&nbsp;&nbsp;&nbsp;Company: <c:out value="${leave.company.partyGroup.name}" /><br />
                    &nbsp;&nbsp;&nbsp;&nbsp;Start Time <c:out value="${leave.startTime}" /><br />
                    <c:if test="${leave.endTime != null}">
                        &nbsp;&nbsp;&nbsp;&nbsp;End Time <c:out value="${leave.endTime}" /><br />
                    </c:if>
                    <html:form action="/HumanResources/Leave/Delete" method="POST">
                        <table>
                            <tr>
