    ...
    <body>
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    <html:form action="/HumanResources/PartyTrainingClass/Status" method="POST">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.partyTrainingClassStatus" />:</td>
                                <td>
                                    <html:select property="partyTrainingClassStatusChoice">
                                        <html:optionsCollection property="partyTrainingClassStatusChoices" />
                                    </html:select> (*)
                                    <et:validationErrors id="errorMessage" property="PartyTrainingClassStatusChoice">
