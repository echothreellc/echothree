    ...
    <body>
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    <p>You are about to delete the <c:out value="${fn:toLowerCase(partyEntityType.entityType.description)}" /> &quot;<c:out value="${forumGroup.description}" />.&quot;</p>
                    <html:form action="/Forum/ForumGroup/Delete" method="POST">
                        <table>
                            <tr>
                        ...
                        <html:hidden property="forumGroupName" />
                    </html:form>
                </c:otherwise>
            </c:choose>
        </div>
