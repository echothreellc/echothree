        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Forum/ForumGroup/Edit" method="POST" focus="forumGroupName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.forumGroupName" />:</td>
                                <td>
                                    <html:text property="forumGroupName" size="40" maxlength="40" /> (*)
                                    <et:validationErrors id="errorMessage" property="ForumGroupName">
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="originalForumGroupName" />
                                </td>
