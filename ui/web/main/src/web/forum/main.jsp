...
<html>
    <head>
        <title><fmt:message key="navigation.forums" /></title>
        <%@ include file="../include/environment-b.jsp" %>
    </head>
    <%@ include file="../include/body-start-b.jsp" %>
        <et:checkSecurityRoles securityRoles="ForumGroup.List:Forum.List" />
        ...
        <et:hasSecurityRole securityRole="ForumGroup.List">
            <a href="<c:url value="/action/Forum/ForumGroup/Main" />">Forum Groups</a><br />
        </et:hasSecurityRole>
        <et:hasSecurityRole securityRole="Forum.List">
            <a href="<c:url value="/action/Forum/Forum/Main" />">Forums</a><br />
        </et:hasSecurityRole>
