...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            <html:form action="/Forum/ForumGroupForum/Add" method="POST">
                <table>
                    <tr>
                        <td align=right><fmt:message key="label.forumGroupChoice" />:</td>
                        <td>
                            <html:select property="forumGroupChoice">
                                <html:optionsCollection property="forumGroupChoices" />
                            </html:select>
