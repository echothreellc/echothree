    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <a href="${forumMimeTypesUrl}">Party Type Roles</a> &gt;&gt;
                Add
            </h2>
        </div>
        <div id="Content">
            ...
            <html:form action="/Forum/ForumPartyTypeRole/Add" method="POST">
                <table>
                    <tr>
                        <td align=right><fmt:message key="label.partyTypeChoice" />:</td>
                        <td>
                    ...
                    <tr>
                        <td align=right><fmt:message key="label.forumRoleTypeChoice" />:</td>
                        <td>
                            <html:select property="forumRoleTypeChoice">
                                <html:optionsCollection property="forumRoleTypeChoices" />
                            </html:select>
                            <et:validationErrors id="errorMessage" property="ForumRoleTypeName">
                                <p><c:out value="${errorMessage}" /></p>
                            </et:validationErrors>
                        </td>
                    </tr>
