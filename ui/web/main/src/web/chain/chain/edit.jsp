        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Chain/Chain/Edit" method="POST" focus="chainName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.chainName" />:</td>
                                <td>
                                    <html:text property="chainName" size="40" maxlength="40" /> (*)
                                    <et:validationErrors id="errorMessage" property="ChainName">
                                        <p><c:out value="${errorMessage}" /></p>
                                    </et:validationErrors>
                                </td>
                            </tr>
                            <tr>
                                <td align=right><fmt:message key="label.chainInstanceSequence" />:</td>
                                <td>
                                    <html:select property="chainInstanceSequenceChoice">
                                        <html:optionsCollection property="chainInstanceSequenceChoices" />
                                    </html:select>
                                    <et:validationErrors id="errorMessage" property="ChainInstanceSequenceName">
                                        <p><c:out value="${errorMessage}" /></p>
                                    </et:validationErrors>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <html:hidden property="originalChainName" />
                                </td>
