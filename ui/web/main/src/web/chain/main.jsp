...
<html>
    ...
    <%@ include file="../include/body-start-b.jsp" %>
        <et:checkSecurityRoles securityRoles="Chain.List:LetterSource.List" />
        ...
        <et:hasSecurityRole securityRole="Chain.List">
            <a href="<c:url value="/action/Chain/ChainKind/Main" />">Chain Kinds</a><br />
        </et:hasSecurityRole>
        <et:hasSecurityRole securityRole="LetterSource.List">
            <a href="<c:url value="/action/Chain/LetterSource/Main" />">Letter Sources</a><br />
        </et:hasSecurityRole>
