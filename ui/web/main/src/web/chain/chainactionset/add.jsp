...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            <html:form action="/Chain/ChainActionSet/Add" method="POST" focus="chainActionSetName">
                <table>
                    <tr>
                        <td align=right><fmt:message key="label.chainActionSetName" />:</td>
                        <td>
                            <html:text property="chainActionSetName" size="40" maxlength="40" /> (*)
                            <et:validationErrors id="errorMessage" property="ChainActionSetName">
