...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            <p>You are about to delete the <c:out value="${chainKindDescription.language.description}" />
            <c:out value="${fn:toLowerCase(partyChainKind.chainKind.description)}" /> for &quot;<c:out value="${chainKindDescription.chainKind.description}" />&quot;
            (<c:out value="${chainKindDescription.chainKind.chainKindName}" />).</p>
            <et:executionErrors id="errorMessage">
                <p class="executionErrors"><c:out value="${errorMessage}" /></p><br />
            </et:executionErrors>
            <html:form action="/Chain/ChainKind/DescriptionDelete" method="POST">
                <table>
                    <tr>
