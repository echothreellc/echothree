    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <a href="${descriptionsUrl}"><fmt:message key="navigation.chainKindDescriptions" /></a> &gt;&gt;
                Edit
            </h2>
        </div>
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    <html:form action="/Chain/ChainKind/DescriptionEdit" method="POST" focus="description">
                        <table>
                            <tr>
