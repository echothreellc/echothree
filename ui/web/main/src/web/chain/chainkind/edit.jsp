        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Chain/ChainKind/Edit" method="POST" focus="chainKindName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.chainKindName" />:</td>
                                <td>
                                    <html:text property="chainKindName" size="40" maxlength="40" /> (*)
                                    <et:validationErrors id="errorMessage" property="ChainKindName">
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="originalChainKindName" />
                                </td>
