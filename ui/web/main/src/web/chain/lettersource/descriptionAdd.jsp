...
<html:html xhtml="true">
    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <c:url var="descriptionsUrl" value="/action/Chain/LetterSource/Description">
                    <c:param name="LetterSourceName" value="${letterSourceName}" />
                </c:url>
        ...
        <div id="Content">
            ...
            <html:form action="/Chain/LetterSource/DescriptionAdd" method="POST" focus="description">
                <table>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <html:hidden property="letterSourceName" />
                        </td>
