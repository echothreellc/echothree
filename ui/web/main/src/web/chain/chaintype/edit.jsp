        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Chain/ChainType/Edit" method="POST" focus="chainTypeName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.chainTypeName" />:</td>
                                <td>
                                    <html:text property="chainTypeName" size="40" maxlength="40" /> (*)
                                    <et:validationErrors id="errorMessage" property="ChainTypeName">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <html:hidden property="originalChainTypeName" />
                                </td>
