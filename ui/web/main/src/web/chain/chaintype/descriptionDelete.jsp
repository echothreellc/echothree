...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            <p>You are about to delete the <c:out value="${chainTypeDescription.language.description}" />
            <c:out value="${fn:toLowerCase(partyChainType.chainType.description)}" /> for &quot;<c:out value="${chainTypeDescription.chainType.description}" />&quot;
            (<c:out value="${chainTypeDescription.chainType.chainTypeName}" />).</p>
            <et:executionErrors id="errorMessage">
                <p class="executionErrors"><c:out value="${errorMessage}" /></p><br />
            </et:executionErrors>
            <html:form action="/Chain/ChainType/DescriptionDelete" method="POST">
                <table>
                    <tr>
