    ...
    <body>
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    <html:form action="/Inventory/InventoryCostingMethod/Edit" method="POST" focus="inventoryCostingMethodName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.inventoryCostingMethodName" />:</td>
                                <td>
                                    <html:text property="inventoryCostingMethodName" size="40" maxlength="40" /> (*)
                                    <et:validationErrors id="errorMessage" property="InventoryCostingMethodName">
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="originalInventoryCostingMethodName" />
                                </td>
