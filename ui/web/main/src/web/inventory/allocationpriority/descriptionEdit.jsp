...
<html:html xhtml="true">
    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <c:url var="descriptionsUrl" value="/action/Inventory/AllocationPriority/Description">
                    <c:param name="AllocationPriorityName" value="${allocationPriorityName}" />
                </c:url>
        ...
        <div id="Content">
            ...
            <html:form action="/Inventory/AllocationPriority/DescriptionEdit" method="POST" focus="description">
                <table>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <html:hidden property="allocationPriorityName" />
