...
<html:html xhtml="true">
    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <c:url var="inventoryConditionUsesUrl" value="/action/Inventory/InventoryConditionUse/Main">
                    <c:param name="InventoryConditionUseTypeName" value="${inventoryConditionUseTypeName}" />
                </c:url>
        ...
        <div id="Content">
            ...
            <html:form action="/Inventory/InventoryConditionUse/Add" method="POST">
                <table>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <html:hidden property="inventoryConditionUseTypeName" />
                        </td>
