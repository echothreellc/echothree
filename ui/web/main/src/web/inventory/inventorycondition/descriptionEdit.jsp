...
<html:html xhtml="true">
    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <c:url var="descriptionsUrl" value="/action/Inventory/InventoryCondition/Description">
                    <c:param name="InventoryConditionName" value="${inventoryConditionName}" />
                </c:url>
        ...
        <div id="Content">
            ...
            <html:form action="/Inventory/InventoryCondition/DescriptionEdit" method="POST" focus="description">
                <table>
                    <tr>
