    ...
    <body>
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    <html:form action="/Inventory/InventoryCondition/Edit" method="POST" focus="inventoryConditionName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.inventoryConditionName" />:</td>
                                <td>
                                    <html:text property="inventoryConditionName" size="40" maxlength="40" /> (*)
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="originalInventoryConditionName" />
                                </td>
