    ...
    <body>
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    <html:form action="/Inventory/InventoryBucketType/Edit" method="POST" focus="inventoryBucketTypeName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.inventoryBucketTypeName" />:</td>
                                <td>
                                    <html:text property="inventoryBucketTypeName" size="40" maxlength="40" /> (*)
                                    <et:validationErrors id="errorMessage" property="InventoryBucketTypeName">
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="originalInventoryBucketTypeName" />
                                </td>
