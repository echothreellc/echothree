        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Inventory/InventoryLocationGroup/Edit" method="POST" focus="inventoryLocationGroupName">
                        <table>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <html:hidden property="originalInventoryLocationGroupName" />
                                </td>
