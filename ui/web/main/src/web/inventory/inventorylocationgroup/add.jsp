    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <a href="${inventoryLocationGroupsUrl}">Inventory Location Group</a> &gt;&gt;
                Add
            </h2>
        </div>
        <div id="Content">
            ...
            <html:form action="/Inventory/InventoryLocationGroup/Add" method="POST" focus="inventoryLocationGroupName">
                <table>
                    <tr>
                        <td align=right><fmt:message key="label.inventoryLocationGroupName" />:</td>
                        <td>
                            <html:text property="inventoryLocationGroupName" size="40" maxlength="40" /> (*)
