        ...
        <div id="Header">
            <h2>
                ...
                <c:url var="descriptionsUrl" value="/action/Inventory/InventoryLocationGroup/Description">
                    <c:param name="WarehouseName" value="${warehouseName}" />
                    <c:param name="InventoryLocationGroupName" value="${inventoryLocationGroupName}" />
                </c:url>
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Inventory/InventoryLocationGroup/DescriptionEdit" method="POST" focus="description">
                        <table>
                            <tr>
