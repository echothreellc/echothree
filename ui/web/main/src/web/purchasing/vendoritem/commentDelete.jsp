    ...
    <body>
        <div id="Header">
            <h2>
                ...
                Delete <c:out value="${comment.commentType.description}" /> <c:out value="${partyEntityType.entityType.description}" />
            </h2>
        </div>
        <div id="Content">
            ...
            <html:form action="/Purchasing/VendorItem/CommentDelete" method="POST">
                <table>
                    <tr>
