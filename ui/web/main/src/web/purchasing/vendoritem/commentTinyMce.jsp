...
<et:partyApplicationEditorUse applicationName="main" applicationEditorUseName="VendorItemComment" var="vendorItemCommentEditorUse" commandResultVar="unused" scope="request" />

<script type="text/javascript">
    var clobCommentTAHasEditor = false;
    
    function mimeTypeChoiceChange() {
        <c:if test="${vendorItemCommentEditorUse.applicationEditor.editor.editorName == 'TINYMCE'}">
