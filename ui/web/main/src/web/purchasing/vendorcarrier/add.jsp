...
<html:html xhtml="true">
    <head>
        <title>Vendor Carriers (<c:out value="${vendor.vendorName}" />)</title>
        <html:base/>
    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <c:url var="vendorCarriersUrl" value="/action/Purchasing/VendorCarrier/Main">
                    <c:param name="VendorName" value="${vendor.vendorName}" />
                </c:url>
                <a href="${vendorCarriersUrl}">Carriers</a> &gt;&gt;
                Add Carrier
            </h2>
        </div>
        <div id="Content">
            ...
            <html:form action="/Purchasing/VendorCarrier/Add" method="POST">
                <table>
                    <tr>
