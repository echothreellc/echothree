...
<html:html xhtml="true">
    <head>
        <title>Vendor Documents (<c:out value="${vendor.vendorName}" />)</title>
        <html:base/>
    ...
    <body>
        ...
        <div id="Content">
            Document Type:<br /><br />
            <c:forEach items="${documentTypeUsages}" var="documentTypeUsage">
                <c:url var="addUrl" value="../../../action/Purchasing/VendorDocument/Add/Step3">
                    <c:param name="PartyName" value="${vendor.partyName}" />
                    <c:param name="DocumentTypeName" value="${documentTypeUsage.documentType.documentTypeName}" />
                </c:url>
                &nbsp;&nbsp;&nbsp;&nbsp;<a href="${addUrl}"><c:out value="${documentTypeUsage.documentType.description}" /></a><br />
             </c:forEach>
        </div>
