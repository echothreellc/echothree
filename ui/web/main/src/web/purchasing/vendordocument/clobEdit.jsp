...
<html:form action="/Purchasing/VendorDocument/Edit" method="POST" focus="stringDescription">
    <table>
        <tr>
        ...
        <tr>
            ...
            <td>
                <html:textarea property="clob" cols="${vendorDocumentEditorUse.preferredWidth}" rows="${vendorDocumentEditorUse.preferredHeight}" styleId="clobTA" /> (*)
