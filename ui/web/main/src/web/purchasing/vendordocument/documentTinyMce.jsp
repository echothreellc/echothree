...
<et:partyApplicationEditorUse applicationName="main" applicationEditorUseName="VendorDocument" var="vendorDocumentEditorUse" commandResultVar="unused" scope="request" />

<script type="text/javascript">
    var clobTAHasEditor = false;
    
    function mimeTypeChoiceChange() {
        <c:if test="${vendorDocumentEditorUse.applicationEditor.editor.editorName == 'TINYMCE'}">
