...
<et:partyApplicationEditorUse applicationName="main" applicationEditorUseName="VendorContactMechanismComment" var="vendorContactMechanismCommentEditorUse" commandResultVar="unused" scope="request" />

<script type="text/javascript">
    var clobCommentTAHasEditor = false;
    
    function mimeTypeChoiceChange() {
        <c:if test="${vendorContactMechanismCommentEditorUse.applicationEditor.editor.editorName == 'TINYMCE'}">
