...
<et:partyApplicationEditorUse applicationName="main" applicationEditorUseName="VendorComment" var="vendorCommentEditorUse" commandResultVar="unused" scope="request" />

<script type="text/javascript">
    var clobCommentTAHasEditor = false;
    
    function mimeTypeChoiceChange() {
        <c:if test="${vendorCommentEditorUse.applicationEditor.editor.editorName == 'TINYMCE'}">
