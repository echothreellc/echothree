        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Purchasing/Vendor/CommentEdit" method="POST" focus="description">
                        <table>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <html:textarea property="clobComment" cols="${vendorCommentEditorUse.preferredWidth}" rows="${vendorCommentEditorUse.preferredHeight}" styleId="clobCommentTA" /> (*)
