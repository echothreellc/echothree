...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            <html:form action="/Purchasing/Vendor/Status" method="POST">
                <table>
                    <tr>
                        <td align=right><fmt:message key="label.vendorStatusChoice" />:</td>
                        <td>
                            <html:select property="vendorStatusChoice">
                                <html:optionsCollection property="vendorStatusChoices" />
                            </html:select>
                            <et:validationErrors id="errorMessage" property="VendorStatusChoice">
