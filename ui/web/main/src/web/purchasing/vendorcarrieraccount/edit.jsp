...
<html:html xhtml="true">
    <head>
        <title>Vendor Carrier Account (<c:out value="${partyCarrierAccount.carrier.partyGroup.name}" />)</title>
        <html:base/>
    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <a href="${vendorCarrierAccountsUrl}"><fmt:message key="navigation.vendorCarrierAccounts" /></a> &gt;&gt;
                Edit
            </h2>
        </div>
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Purchasing/VendorCarrierAccount/Edit" method="POST" focus="account">
                        <table>
                            <tr>
