...
<html:html xhtml="true">
    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <c:url var="descriptionsUrl" value="/action/Purchasing/ItemPurchasingCategory/Description">
                    <c:param name="ItemPurchasingCategoryName" value="${itemPurchasingCategoryName}" />
                </c:url>
        ...
        <div id="Content">
            ...
            <html:form action="/Purchasing/ItemPurchasingCategory/DescriptionAdd" method="POST" focus="description">
                <table>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <html:hidden property="itemPurchasingCategoryName" />
                        </td>
