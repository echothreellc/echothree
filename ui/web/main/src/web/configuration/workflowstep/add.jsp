...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            <html:form action="/Configuration/WorkflowStep/Add" method="POST" focus="workflowStepName">
                <table>
                    <tr>
                        <td align=right><fmt:message key="label.workflowStepName" />:</td>
                        <td>
                            <html:text property="workflowStepName" size="40" maxlength="40" /> (*)
                            <et:validationErrors id="errorMessage" property="WorkflowStepName">
                                <p><c:out value="${errorMessage}" /></p>
                            </et:validationErrors>
                        </td>
                    </tr>
                    <tr>
                        <td align=right><fmt:message key="label.workflowStepType" />:</td>
                        <td>
                            <html:select property="workflowStepTypeChoice">
                                <html:optionsCollection property="workflowStepTypeChoices" />
                            </html:select> (*)
                            <et:validationErrors id="errorMessage" property="WorkflowStepTypeName">
                                <p><c:out value="${errorMessage}" /></p>
                            </et:validationErrors>
                        </td>
                    </tr>
