        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Configuration/PostalAddressFormat/Edit" method="POST" focus="postalAddressFormatName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.postalAddressFormatName" />:</td>
                                <td>
                                    <html:text property="postalAddressFormatName" size="40" maxlength="40" /> (*)
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="originalPostalAddressFormatName" />
                                </td>
