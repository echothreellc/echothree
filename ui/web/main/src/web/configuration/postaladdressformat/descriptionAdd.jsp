    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <c:url var="descriptionsUrl" value="/action/Configuration/PostalAddressFormat/Description">
        ...
        <div id="Content">
            ...
            <html:form action="/Configuration/PostalAddressFormat/DescriptionAdd" method="POST" focus="description">
                <table>
                    <tr>
