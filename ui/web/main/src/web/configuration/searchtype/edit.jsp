        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Configuration/SearchType/Edit" method="POST" focus="searchTypeName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.searchTypeName" />:</td>
                                <td>
                                    <html:text property="searchTypeName" size="40" maxlength="40" /> (*)
                                    <et:validationErrors id="errorMessage" property="SearchTypeName">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <html:hidden property="originalSearchTypeName" />
                                </td>
