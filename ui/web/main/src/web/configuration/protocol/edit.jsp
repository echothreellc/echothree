        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Configuration/Protocol/Edit" method="POST" focus="protocolName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.protocolName" />:</td>
                                <td>
                                    <html:text property="protocolName" size="40" maxlength="40" /> (*)
                                    <et:validationErrors id="errorMessage" property="ProtocolName">
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="originalProtocolName" />
                                </td>
