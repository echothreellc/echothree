    ...
    <body>
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    <p>You are about to delete the <c:out value="${fn:toLowerCase(partyEntityType.entityType.description)}" /> &quot;<c:out value="${protocol.description}" />.&quot;</p>
                    <html:form action="/Configuration/Protocol/Delete" method="POST">
                        <table>
                            <tr>
                        ...
                        <html:hidden property="protocolName" />
                    </html:form>
                </c:otherwise>
            </c:choose>
        </div>
