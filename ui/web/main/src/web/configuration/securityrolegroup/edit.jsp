        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Configuration/SecurityRoleGroup/Edit" method="POST" focus="securityRoleGroupName">
                        <table>
                            <tr>
                            ...
                            <tr>
                                <td align=right><fmt:message key="label.parentSecurityRoleGroup" />:</td>
                                <td>
                                    <html:select property="parentSecurityRoleGroupChoice">
                                        <html:optionsCollection property="parentSecurityRoleGroupChoices" />
                                    </html:select>
                                    <et:validationErrors id="errorMessage" property="ParentSecurityRoleGroupName">
                                        <p><c:out value="${errorMessage}" /></p>
                                    </et:validationErrors>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="originalSecurityRoleGroupName" />
