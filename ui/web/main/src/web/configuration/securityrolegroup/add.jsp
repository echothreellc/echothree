...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            <html:form action="/Configuration/SecurityRoleGroup/Add" method="POST" focus="securityRoleGroupName">
                <table>
                    <tr>
                        <td align=right><fmt:message key="label.securityRoleGroupName" />:</td>
                        <td>
                            <html:text property="securityRoleGroupName" size="40" maxlength="40" /> (*)
                            <et:validationErrors id="errorMessage" property="SecurityRoleGroupName">
                    ...
                    <tr>
                        <td>
                            <html:hidden property="parentSecurityRoleGroupName" />
                        </td>
