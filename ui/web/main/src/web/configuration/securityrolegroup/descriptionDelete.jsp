        ...
        <div id="Header">
            <h2>
                ...
                <c:url var="securityRoleGroupsUrl" value="/action/Configuration/SecurityRoleGroup/Main">
                    <c:param name="ParentSecurityRoleGroupName" value="${securityRoleGroupDescription.securityRoleGroup.parentSecurityRoleGroup.securityRoleGroupName}" />
                </c:url>
                ...
                <a href="${descriptionsUrl}"><fmt:message key="navigation.securityRoleGroupDescriptions" /></a> &gt;&gt;
                Delete
            </h2>
        </div>
        <div id="Content">
            <p>You are about to delete the <c:out value="${securityRoleGroupDescription.language.description}" />
            <c:out value="${fn:toLowerCase(partyEntityType.entityType.description)}" /> for &quot;<c:out value="${securityRoleGroupDescription.securityRoleGroup.description}" />&quot;
            (<c:out value="${securityRoleGroupDescription.securityRoleGroup.securityRoleGroupName}" />).</p>
            <et:executionErrors id="errorMessage">
                <p class="executionErrors"><c:out value="${errorMessage}" /></p><br />
            </et:executionErrors>
            <html:form action="/Configuration/SecurityRoleGroup/DescriptionDelete" method="POST">
                <table>
                    <tr>
