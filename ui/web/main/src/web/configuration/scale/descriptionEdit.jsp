    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <a href="<c:url value="/action/Configuration/Scale/Main" />">Scales</a> &gt;&gt;
                <c:url var="descriptionsUrl" value="/action/Configuration/Scale/Description">
                    <c:param name="ScaleName" value="${scaleName}" />
                </c:url>
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Configuration/Scale/DescriptionEdit" method="POST" focus="description">
                        <table>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="scaleName" />
