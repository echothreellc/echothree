    ...
    <body>
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    <html:form action="/Configuration/Scale/Edit" method="POST" focus="scaleName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.scaleName" />:</td>
                                <td>
                                    <html:text property="scaleName" size="40" maxlength="40" /> (*)
                            ...
                            <tr>
                                <td align=right><fmt:message key="label.scaleType" />:</td>
                                <td>
                                    <html:select property="scaleTypeChoice">
                                        <html:optionsCollection property="scaleTypeChoices" />
                                    </html:select> (*)
                                    <et:validationErrors id="errorMessage" property="ScaleTypeName">
                                        <p><c:out value="${errorMessage}" /></p>
                                    </et:validationErrors>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="originalScaleName" />
                                </td>
