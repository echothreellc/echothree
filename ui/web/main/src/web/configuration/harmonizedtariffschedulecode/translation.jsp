...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            <c:url var="addUrl" value="/action/Configuration/HarmonizedTariffScheduleCode/TranslationAdd">
                <c:param name="CountryName" value="${harmonizedTariffScheduleCode.countryGeoCode.geoCodeName}" />
            ...
            <display:table name="harmonizedTariffScheduleCodeTranslations" id="harmonizedTariffScheduleCodeTranslation" class="displaytag">
                <display:column>
                    <c:url var="reviewUrl" value="/action/Configuration/HarmonizedTariffScheduleCode/TranslationReview">
                ...
                <display:column titleKey="columnTitle.description">
                    <c:out value="${harmonizedTariffScheduleCodeTranslation.description}" />
                </display:column>
                <display:column>
                    <c:url var="editUrl" value="/action/Configuration/HarmonizedTariffScheduleCode/TranslationEdit">
                        <c:param name="CountryName" value="${harmonizedTariffScheduleCodeTranslation.harmonizedTariffScheduleCode.countryGeoCode.geoCodeName}" />
                        <c:param name="HarmonizedTariffScheduleCodeName" value="${harmonizedTariffScheduleCodeTranslation.harmonizedTariffScheduleCode.harmonizedTariffScheduleCodeName}" />
                        <c:param name="LanguageIsoName" value="${harmonizedTariffScheduleCodeTranslation.language.languageIsoName}" />
                    </c:url>
                    <a href="${editUrl}">Edit</a>
                    <c:url var="deleteUrl" value="/action/Configuration/HarmonizedTariffScheduleCode/TranslationDelete">
                        <c:param name="CountryName" value="${harmonizedTariffScheduleCodeTranslation.harmonizedTariffScheduleCode.countryGeoCode.geoCodeName}" />
                        <c:param name="HarmonizedTariffScheduleCodeName" value="${harmonizedTariffScheduleCodeTranslation.harmonizedTariffScheduleCode.harmonizedTariffScheduleCodeName}" />
                        <c:param name="LanguageIsoName" value="${harmonizedTariffScheduleCodeTranslation.language.languageIsoName}" />
                    </c:url>
