...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            <p>You are about to delete the <c:out value="${harmonizedTariffScheduleCodeTranslation.language.description}" />
            <c:out value="${fn:toLowerCase(partyEntityType.entityType.description)}" /> for &quot;<c:out value="${harmonizedTariffScheduleCodeTranslation.harmonizedTariffScheduleCode.description}" />&quot;
            (<c:out value="${harmonizedTariffScheduleCodeTranslation.harmonizedTariffScheduleCode.harmonizedTariffScheduleCodeName}" />).</p>
            <et:executionErrors id="errorMessage">
                <p class="executionErrors"><c:out value="${errorMessage}" /></p><br />
            </et:executionErrors>
            <html:form action="/Configuration/HarmonizedTariffScheduleCode/TranslationDelete" method="POST">
                <table>
                    <tr>
