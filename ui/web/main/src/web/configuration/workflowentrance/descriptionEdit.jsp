    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <c:url var="descriptionsUrl" value="/action/Configuration/WorkflowEntrance/Description">
                    <c:param name="WorkflowName" value="${workflowName}" />
                    <c:param name="WorkflowEntranceName" value="${workflowEntranceName}" />
                </c:url>
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    <html:form action="/Configuration/WorkflowEntrance/DescriptionEdit" method="POST" focus="description">
                        <table>
                            <tr>
