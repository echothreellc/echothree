        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Configuration/WorkflowEntrance/Edit" method="POST" focus="workflowEntranceName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.workflowEntranceName" />:</td>
                                <td>
                                    <html:text property="workflowEntranceName" size="40" maxlength="40" /> (*)
                                    <et:validationErrors id="errorMessage" property="WorkflowEntranceName">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <html:hidden property="originalWorkflowEntranceName" />
                                </td>
