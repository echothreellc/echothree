    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <a href="<c:url value="/action/Configuration/RecoveryQuestion/Main" />">Recovery Questiones</a> &gt;&gt;
                <c:url var="descriptionsUrl" value="/action/Configuration/RecoveryQuestion/Description">
                    <c:param name="RecoveryQuestionName" value="${recoveryQuestionName}" />
                </c:url>
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Configuration/RecoveryQuestion/DescriptionEdit" method="POST" focus="description">
                        <table>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="recoveryQuestionName" />
