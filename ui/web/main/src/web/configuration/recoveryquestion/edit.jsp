        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Configuration/RecoveryQuestion/Edit" method="POST" focus="recoveryQuestionName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.recoveryQuestionName" />:</td>
                                <td>
                                    <html:text property="recoveryQuestionName" size="40" maxlength="40" /> (*)
                                    <et:validationErrors id="errorMessage" property="RecoveryQuestionName">
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="originalRecoveryQuestionName" />
                                </td>
