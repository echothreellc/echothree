        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Configuration/SearchKind/Edit" method="POST" focus="searchKindName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.searchKindName" />:</td>
                                <td>
                                    <html:text property="searchKindName" size="40" maxlength="40" /> (*)
                                    <et:validationErrors id="errorMessage" property="SearchKindName">
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="originalSearchKindName" />
                                </td>
