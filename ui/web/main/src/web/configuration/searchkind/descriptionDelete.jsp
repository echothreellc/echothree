    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <a href="${descriptionsUrl}"><fmt:message key="navigation.searchKindDescriptions" /></a> &gt;&gt;
                Delete
            </h2>
        </div>
        <div id="Content">
            <p>You are about to delete the <c:out value="${searchKindDescription.language.description}" />
            <c:out value="${fn:toLowerCase(partySearchKind.searchKind.description)}" /> for &quot;<c:out value="${searchKindDescription.searchKind.description}" />&quot;
            (<c:out value="${searchKindDescription.searchKind.searchKindName}" />).</p>
            <et:executionErrors id="errorMessage">
                <p class="executionErrors"><c:out value="${errorMessage}" /></p><br />
            </et:executionErrors>
            <html:form action="/Configuration/SearchKind/DescriptionDelete" method="POST">
                <table>
                    <tr>
