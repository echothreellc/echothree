...
<html:html xhtml="true">
    <head>
        <title>
            <fmt:message key="pageTitle.securityRole">
                <fmt:param value="${securityRole.securityRoleName}" />
            </fmt:message>
        </title>
        <html:base/>
    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <fmt:message key="navigation.securityRole">
                    <fmt:param value="${securityRole.securityRoleName}" />
                </fmt:message>
            </h2>
        </div>
        <div id="Content">
            <c:choose>
                <c:when test="${securityRole.securityRoleName != securityRole.description}">
                    <p><font size="+2"><b><c:out value="${securityRole.description}" /></b></font></p>
                    <p><font size="+1"><c:out value="${securityRole.securityRoleName}" /></font></p>
                </c:when>
                <c:otherwise>
                    <p><font size="+2"><b><c:out value="${securityRole.securityRoleName}" /></b></font></p>
                </c:otherwise>
            </c:choose>
            <br />
            ...
            <br />
            <c:set var="entityInstance" scope="request" value="${securityRole.entityInstance}" />
