        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Configuration/SecurityRole/Edit" method="POST" focus="securityRoleName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.securityRoleName" />:</td>
                                <td>
                                    <html:text property="securityRoleName" size="40" maxlength="40" /> (*)
                            ...
                            <tr>
                                <td>
                                    ...
                                    <html:hidden property="originalSecurityRoleName" />
                                </td>
