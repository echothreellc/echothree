...
<html:html xhtml="true">
    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <c:url var="securityRoleGroupsUrl" value="/action/Configuration/SecurityRoleGroup/Main">
                    <c:if test="${securityRoleGroup.parentSecurityRoleGroup.securityRoleGroupName != 'ROOT'}">
        ...
        <div id="Content">
            ...
            <html:form action="/Configuration/SecurityRole/Add" method="POST" focus="securityRoleName">
                <table>
                    <tr>
