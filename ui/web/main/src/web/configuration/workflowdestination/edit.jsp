...
<html:html xhtml="true">
    <head>
        <title><fmt:message key="pageTitle.workflowDestinations" /></title>
        <html:base/>
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Configuration/WorkflowDestination/Edit" method="POST" focus="workflowDestinationName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.workflowDestinationName" />:</td>
                                <td>
                                    <html:text property="workflowDestinationName" size="40" maxlength="40" /> (*)
                                    <et:validationErrors id="errorMessage" property="WorkflowDestinationName">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <html:hidden property="originalWorkflowDestinationName" />
                                </td>
