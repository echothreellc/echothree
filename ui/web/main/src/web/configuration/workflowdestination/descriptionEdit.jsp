    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <c:url var="descriptionsUrl" value="/action/Configuration/WorkflowDestination/Description">
                    <c:param name="WorkflowName" value="${workflowName}" />
                    <c:param name="WorkflowStepName" value="${workflowStepName}" />
                    <c:param name="WorkflowDestinationName" value="${workflowDestinationName}" />
                </c:url>
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    <html:form action="/Configuration/WorkflowDestination/DescriptionEdit" method="POST" focus="description">
                        <table>
                            <tr>
