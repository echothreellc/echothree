        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;Workflow: <c:out value="${workflowDestinationPartyType.workflowDestination.workflowStep.workflow.description}" /><br />
                    &nbsp;&nbsp;&nbsp;&nbsp;Workflow Step: <c:out value="${workflowDestinationPartyType.workflowDestination.workflowStep.description}" /><br />
                    &nbsp;&nbsp;&nbsp;&nbsp;Workflow Destination: <c:out value="${workflowDestinationPartyType.workflowDestination.description}" /><br />
                    &nbsp;&nbsp;&nbsp;&nbsp;Party Type: <c:out value="${workflowDestinationPartyType.partyType.description}" /><br />
                    <html:form action="/Configuration/WorkflowDestinationPartyType/Delete" method="POST">
                        <table>
                            <tr>
