...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            <c:url var="addUrl" value="/action/Configuration/WorkflowDestinationPartyType/Add">
                <c:param name="WorkflowName" value="${workflowDestination.workflowStep.workflow.workflowName}" />
                <c:param name="WorkflowStepName" value="${workflowDestination.workflowStep.workflowStepName}" />
                <c:param name="WorkflowDestinationName" value="${workflowDestination.workflowDestinationName}" />
            </c:url>
            <p><a href="${addUrl}">Add Party Type.</a></p>
            <display:table name="workflowDestinationPartyTypes" id="workflowDestinationPartyType" class="displaytag">
                <display:column titleKey="columnTitle.partyType">
                    <c:out value="${workflowDestinationPartyType.partyType.description}" />
                </display:column>
                <display:column>
                    <c:url var="workflowDestinationSecurityRolesUrl" value="/action/Configuration/WorkflowDestinationSecurityRole/Main">
                    ...
                    <a href="${workflowDestinationSecurityRolesUrl}">Security Roles</a><br />
                    <c:url var="deleteUrl" value="/action/Configuration/WorkflowDestinationPartyType/Delete">
                        <c:param name="WorkflowName" value="${workflowDestinationPartyType.workflowDestination.workflowStep.workflow.workflowName}" />
                        <c:param name="WorkflowStepName" value="${workflowDestinationPartyType.workflowDestination.workflowStep.workflowStepName}" />
                        <c:param name="WorkflowDestinationName" value="${workflowDestinationPartyType.workflowDestination.workflowDestinationName}" />
                        <c:param name="PartyTypeName" value="${workflowDestinationPartyType.partyType.partyTypeName}" />
