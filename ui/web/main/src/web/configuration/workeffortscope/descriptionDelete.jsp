...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            <p>You are about to delete the <c:out value="${workEffortScopeDescription.language.description}" />
            <c:out value="${fn:toLowerCase(partyEntityType.entityType.description)}" /> for &quot;<c:out value="${workEffortScopeDescription.workEffortScope.description}" />&quot;
            (<c:out value="${workEffortScopeDescription.workEffortScope.workEffortScopeName}" />).</p>
            <et:executionErrors id="errorMessage">
                <p class="executionErrors"><c:out value="${errorMessage}" /></p><br />
            </et:executionErrors>
            <html:form action="/Configuration/WorkEffortScope/DescriptionDelete" method="POST">
                <table>
                    <tr>
