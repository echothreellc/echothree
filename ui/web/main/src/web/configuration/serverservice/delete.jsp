...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;Server <c:out value="${serverService.server.description}" /><br />
            &nbsp;&nbsp;&nbsp;&nbsp;Service: <c:out value="${serverService.service.description}" /><br />
            <et:executionErrors id="errorMessage">
                <p class="executionErrors"><c:out value="${errorMessage}" /></p><br />
            </et:executionErrors>
            <html:form action="/Configuration/ServerService/Delete" method="POST">
                <table>
                    <tr>
