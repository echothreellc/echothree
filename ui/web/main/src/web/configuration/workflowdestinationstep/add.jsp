    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <a href="${workflowDestinationStepsUrl}"><fmt:message key="navigation.workflowDestinationSteps" /></a> &gt;&gt;
                Add
            </h2>
        </div>
        <div id="Content">
            ...
            <html:form action="/Configuration/WorkflowDestinationStep/Add" method="POST">
                <table>
                    <tr>
                        <td align=right><fmt:message key="label.destinationWorkflowStep" />:</td>
                        <td>
                            <html:select property="destinationWorkflowStepChoice">
                                <html:optionsCollection property="destinationWorkflowStepChoices" />
                            </html:select> (*)
                            <et:validationErrors id="errorMessage" property="DestinationWorkflowStepName">
                    ...
                    <tr>
                        <td>
                            ...
                            <html:hidden property="destinationWorkflowName" />
                        </td>
