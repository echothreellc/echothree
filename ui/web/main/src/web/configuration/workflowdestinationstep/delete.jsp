    ...
    <body>
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    <p>You are about to delete the <c:out value="${fn:toLowerCase(partyEntityType.entityType.description)}" /> &quot;<c:out value="${workflowDestinationStep.workflowStep.description}" />.&quot;</p>
                    <html:form action="/Configuration/WorkflowDestinationStep/Delete" method="POST">
                        <table>
                            <tr>
                        ...
                        <html:hidden property="destinationWorkflowStepName" />
                    </html:form>
                </c:otherwise>
            </c:choose>
        </div>
