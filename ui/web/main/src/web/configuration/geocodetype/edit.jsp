        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Configuration/GeoCodeType/Edit" method="POST" focus="geoCodeTypeName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.geoCodeTypeName" />:</td>
                                <td>
                                    <html:text property="geoCodeTypeName" size="40" maxlength="40" /> (*)
                                    <et:validationErrors id="errorMessage" property="GeoCodeTypeName">
                                        <p><c:out value="${errorMessage}" /></p>
                                    </et:validationErrors>
                                </td>
                            </tr>
                            <tr>
                                <td align=right><fmt:message key="label.parentGeoCodeType" />:</td>
                                <td>
                                    <html:select property="parentGeoCodeTypeChoice">
                                        <html:optionsCollection property="parentGeoCodeTypeChoices" />
                                    </html:select>
                                    <et:validationErrors id="errorMessage" property="ParentGeoCodeTypeName">
                                        <p><c:out value="${errorMessage}" /></p>
                                    </et:validationErrors>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="originalGeoCodeTypeName" />
                                </td>
