...
<html:html xhtml="true">
    <head>
        <title><fmt:message key="pageTitle.geoCodeTypeDescriptions" /></title>
        <html:base/>
        ...
        <div id="Header">
            <h2>
                ...
                <c:url var="descriptionsUrl" value="/action/Configuration/GeoCodeType/Description">
                    <c:param name="GeoCodeTypeName" value="${geoCodeTypeDescription.geoCodeType.geoCodeTypeName}" />
                </c:url>
                <a href="${descriptionsUrl}"><fmt:message key="navigation.geoCodeTypeDescriptions" /></a> &gt;&gt;
                Edit
            </h2>
        </div>
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Configuration/GeoCodeType/DescriptionEdit" method="POST" focus="description">
                        <table>
                            <tr>
