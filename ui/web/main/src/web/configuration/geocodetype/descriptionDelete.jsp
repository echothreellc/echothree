...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            <p>You are about to delete the <c:out value="${geoCodeTypeDescription.language.description}" />
            <c:out value="${fn:toLowerCase(partyEntityType.entityType.description)}" /> for &quot;<c:out value="${geoCodeTypeDescription.geoCodeType.description}" />&quot;
            (<c:out value="${geoCodeTypeDescription.geoCodeType.geoCodeTypeName}" />).</p>
            <et:executionErrors id="errorMessage">
                <p class="executionErrors"><c:out value="${errorMessage}" /></p><br />
            </et:executionErrors>
            <html:form action="/Configuration/GeoCodeType/DescriptionDelete" method="POST">
                <table>
                    <tr>
