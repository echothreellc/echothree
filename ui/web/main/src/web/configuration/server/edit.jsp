        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Configuration/Server/Edit" method="POST" focus="serverName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.serverName" />:</td>
                                <td>
                                    <html:text property="serverName" size="40" maxlength="40" /> (*)
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="originalServerName" />
                                </td>
