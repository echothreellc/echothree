        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Configuration/SearchSortOrder/Edit" method="POST" focus="searchSortOrderName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.searchSortOrderName" />:</td>
                                <td>
                                    <html:text property="searchSortOrderName" size="40" maxlength="40" /> (*)
                            ...
                            <tr>
                                <td>
                                    ...
                                    <html:hidden property="originalSearchSortOrderName" />
                                </td>
