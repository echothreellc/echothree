    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <a href="${descriptionsUrl}"><fmt:message key="navigation.searchSortOrderDescriptions" /></a> &gt;&gt;
                Delete
            </h2>
        </div>
        <div id="Content">
            <p>You are about to delete the <c:out value="${searchSortOrderDescription.language.description}" />
            <c:out value="${fn:toLowerCase(partySearchSortOrder.searchSortOrder.description)}" /> for &quot;<c:out value="${searchSortOrderDescription.searchSortOrder.description}" />&quot;
            (<c:out value="${searchSortOrderDescription.searchSortOrder.searchSortOrderName}" />).</p>
            <et:executionErrors id="errorMessage">
                <p class="executionErrors"><c:out value="${errorMessage}" /></p><br />
            </et:executionErrors>
            <html:form action="/Configuration/SearchSortOrder/DescriptionDelete" method="POST">
                <table>
                    <tr>
                ...
                <html:hidden property="searchSortOrderName" />
