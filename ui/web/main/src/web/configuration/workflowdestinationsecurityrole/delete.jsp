        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;Workflow: <c:out value="${workflowDestinationSecurityRole.workflowDestinationPartyType.workflowDestination.workflowStep.workflow.description}" /><br />
                    &nbsp;&nbsp;&nbsp;&nbsp;Workflow Step: <c:out value="${workflowDestinationSecurityRole.workflowDestinationPartyType.workflowDestination.workflowStep.description}" /><br />
                    &nbsp;&nbsp;&nbsp;&nbsp;Workflow Destination: <c:out value="${workflowDestinationSecurityRole.workflowDestinationPartyType.workflowDestination.description}" /><br />
                    &nbsp;&nbsp;&nbsp;&nbsp;Party Type: <c:out value="${workflowDestinationSecurityRole.workflowDestinationPartyType.partyType.description}" /><br />
                    &nbsp;&nbsp;&nbsp;&nbsp;Security Role Group: <c:out value="${workflowDestinationSecurityRole.securityRole.securityRoleGroup.description}" /><br />
                    &nbsp;&nbsp;&nbsp;&nbsp;Security Role: <c:out value="${workflowDestinationSecurityRole.securityRole.description}" /><br />
                    <html:form action="/Configuration/WorkflowDestinationSecurityRole/Delete" method="POST">
                        <table>
                            <tr>
