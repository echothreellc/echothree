...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            <html:form action="/Configuration/PartySecurityRoleTemplate/Add" method="POST" focus="partySecurityRoleTemplateName">
                <table>
                    <tr>
                        <td align=right><fmt:message key="label.partySecurityRoleTemplateName" />:</td>
                        <td>
                            <html:text property="partySecurityRoleTemplateName" size="40" maxlength="40" /> (*)
