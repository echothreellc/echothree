...
<html:html xhtml="true">
    <head>
        <title>Security Role Template Descriptions</title>
        <html:base/>
        ...
        <div id="Header">
            <h2>
                ...
                <c:url var="descriptionsUrl" value="/action/Configuration/PartySecurityRoleTemplate/Description">
                    <c:param name="PartySecurityRoleTemplateName" value="${partySecurityRoleTemplateName}" />
                </c:url>
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Configuration/PartySecurityRoleTemplate/DescriptionEdit" method="POST" focus="description">
                        <table>
                            <tr>
