        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Configuration/PartySecurityRoleTemplate/Edit" method="POST" focus="partySecurityRoleTemplateName">
                        <table>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="originalPartySecurityRoleTemplateName" />
                                </td>
