        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Configuration/PrinterGroupUseType/Edit" method="POST" focus="printerGroupUseTypeName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.printerGroupUseTypeName" />:</td>
                                <td>
                                    <html:text property="printerGroupUseTypeName" size="40" maxlength="40" /> (*)
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="originalPrinterGroupUseTypeName" />
                                </td>
