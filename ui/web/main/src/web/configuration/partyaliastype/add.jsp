...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            <html:form action="/Configuration/PartyAliasType/Add" method="POST" focus="partyAliasTypeName">
                <table>
                    <tr>
                        <td align=right><fmt:message key="label.partyAliasTypeName" />:</td>
                        <td>
                            <html:text property="partyAliasTypeName" size="40" maxlength="40" /> (*)
