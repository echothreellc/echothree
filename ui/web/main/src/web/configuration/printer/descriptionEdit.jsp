        ...
        <div id="Header">
            <h2>
                ...
                <c:url var="descriptionsUrl" value="/action/Configuration/Printer/Description">
                    <c:param name="PrinterGroupName" value="${printerGroupName}" />
                    <c:param name="PrinterName" value="${printerName}" />
                </c:url>
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Configuration/Printer/DescriptionEdit" method="POST" focus="description">
                        <table>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <html:hidden property="printerName" />
