    ...
    <body>
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    <html:form action="/Configuration/Printer/Edit" method="POST" focus="printerName">
                        <table>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <html:select property="printerGroupChoice">
                                        <html:optionsCollection property="printerGroupChoices" />
                                    </html:select> (*)
                                    <et:validationErrors id="errorMessage" property="PrinterGroupChoice">
                                        <p><c:out value="${errorMessage}" /></p>
                                    </et:validationErrors>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <html:hidden property="originalPrinterName" />
                                </td>
