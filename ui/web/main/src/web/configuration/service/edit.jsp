        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Configuration/Service/Edit" method="POST" focus="serviceName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.serviceName" />:</td>
                                <td>
                                    <html:text property="serviceName" size="40" maxlength="40" /> (*)
                            ...
                            <tr>
                                <td align=right><fmt:message key="label.port" />:</td>
                                <td>
                                    <html:text property="port" size="12" maxlength="12" /> (*)
                                    <et:validationErrors id="errorMessage" property="Port">
                                        <p><c:out value="${errorMessage}" /></p>
                                    </et:validationErrors>
                                </td>
                            </tr>
                            <tr>
                                <td align=right><fmt:message key="label.protocol" />:</td>
                                <td>
                                    <html:select property="protocolChoice">
                                        <html:optionsCollection property="protocolChoices" />
                                    </html:select> (*)
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="originalServiceName" />
                                </td>
