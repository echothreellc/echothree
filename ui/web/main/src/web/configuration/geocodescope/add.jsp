...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            <html:form action="/Configuration/GeoCodeScope/Add" method="POST" focus="geoCodeScopeName">
                <table>
                    <tr>
                        <td align=right><fmt:message key="label.geoCodeScopeName" />:</td>
                        <td>
                            <html:text property="geoCodeScopeName" size="40" maxlength="40" /> (*)
                            <et:validationErrors id="errorMessage" property="GeoCodeScopeName">
