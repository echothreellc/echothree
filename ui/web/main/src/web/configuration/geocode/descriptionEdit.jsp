...
<html:html xhtml="true">
    <head>
        <title><fmt:message key="pageTitle.geoCodeDescriptions" /></title>
        <html:base/>
        ...
        <div id="Header">
            <h2>
                ...
                <c:url var="descriptionsUrl" value="/action/Configuration/GeoCode/Description">
                    <c:param name="GeoCodeName" value="${geoCodeDescription.geoCode.geoCodeName}" />
                </c:url>
                <a href="${descriptionsUrl}"><fmt:message key="navigation.geoCodeDescriptions" /></a> &gt;&gt;
                Edit
            </h2>
        </div>
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Configuration/GeoCode/DescriptionEdit" method="POST" focus="description">
                        <table>
                            <tr>
