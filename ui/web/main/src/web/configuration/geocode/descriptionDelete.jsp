...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            <p>You are about to delete the <c:out value="${geoCodeDescription.language.description}" />
            <c:out value="${fn:toLowerCase(partyEntityType.entityType.description)}" /> for &quot;<c:out value="${geoCodeDescription.geoCode.description}" />&quot;
            (<c:out value="${geoCodeDescription.geoCode.geoCodeName}" />).</p>
            <et:executionErrors id="errorMessage">
                <p class="executionErrors"><c:out value="${errorMessage}" /></p><br />
            </et:executionErrors>
            <html:form action="/Configuration/GeoCode/DescriptionDelete" method="POST">
                <table>
                    <tr>
