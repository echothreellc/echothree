        ...
        <div id="Header">
            <h2>
                ...
                <c:url var="descriptionsUrl" value="/action/Configuration/CommunicationEventPurpose/Description">
                    <c:param name="CommunicationEventPurposeName" value="${communicationEventPurposeName}" />
                </c:url>
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Configuration/CommunicationEventPurpose/DescriptionEdit" method="POST" focus="description">
                        <table>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="communicationEventPurposeName" />
