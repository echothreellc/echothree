        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Configuration/CommunicationEventPurpose/Edit" method="POST" focus="communicationEventPurposeName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.communicationEventPurposeName" />:</td>
                                <td>
                                    <html:text property="communicationEventPurposeName" size="40" maxlength="40" /> (*)
                                    <et:validationErrors id="errorMessage" property="CommunicationEventPurposeName">
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="originalCommunicationEventPurposeName" />
                                </td>
