        ...
        <div id="Header">
            <h2>
                ...
                <c:url var="workRequirementTypesUrl" value="/action/Configuration/WorkRequirementType/Main">
                    <c:param name="WorkEffortTypeName" value="${workEffortTypeName}" />
                </c:url>
                ...
                <c:url var="descriptionsUrl" value="/action/Configuration/WorkRequirementType/Description">
                    <c:param name="WorkEffortTypeName" value="${workEffortTypeName}" />
                    <c:param name="WorkRequirementTypeName" value="${workRequirementTypeName}" />
                </c:url>
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Configuration/WorkRequirementType/DescriptionEdit" method="POST" focus="description">
                        <table>
                            <tr>
                            ...
                            <html:hidden property="workRequirementTypeName" />
