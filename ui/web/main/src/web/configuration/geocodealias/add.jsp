...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            <html:form action="/Configuration/GeoCodeAlias/Add" method="POST" focus="alias">
                <table>
                    <tr>
                        <td align=right><fmt:message key="label.geoCodeAliasType" />:</td>
                        <td>
                            <html:select property="geoCodeAliasTypeChoice">
                                <html:optionsCollection property="geoCodeAliasTypeChoices" />
                            </html:select> (*)
