    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <a href="${aliasesUrl}"><fmt:message key="navigation.geoCodeAliases" /></a> &gt;&gt;
                Delete
            </h2>
        </div>
        <div id="Content">
            <p>You are about to delete the <c:out value="${geoCodeAlias.geoCodeAliasType.description}" />
            <c:out value="${fn:toLowerCase(partyEntityType.entityType.description)}" /> for &quot;<c:out value="${geoCodeAlias.geoCode.description}" />&quot;
            (<c:out value="${geoCodeAlias.geoCode.geoCodeName}" />).</p>
            <et:executionErrors id="errorMessage">
                <p class="executionErrors"><c:out value="${errorMessage}" /></p><br />
            </et:executionErrors>
            <html:form action="/Configuration/GeoCodeAlias/Delete" method="POST">
                <table>
                    <tr>
