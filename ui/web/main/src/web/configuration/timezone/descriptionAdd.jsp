    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <c:url var="descriptionsUrl" value="/action/Configuration/TimeZone/Description">
                    <c:param name="JavaTimeZoneName" value="${javaTimeZoneName}" />
                </c:url>
        ...
        <div id="Content">
            ...
            <html:form action="/Configuration/TimeZone/DescriptionAdd" method="POST" focus="description">
                <table>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <html:hidden property="javaTimeZoneName" />
                        </td>
