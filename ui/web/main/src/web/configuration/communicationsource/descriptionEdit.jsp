...
<html:html xhtml="true">
    <head>
        <title>Communication Source Descriptions</title>
        <html:base/>
        ...
        <div id="Header">
            <h2>
                ...
                <c:url var="descriptionsUrl" value="/action/Configuration/CommunicationSource/Description">
                    <c:param name="CommunicationSourceName" value="${communicationSourceName}" />
                </c:url>
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Configuration/CommunicationSource/DescriptionEdit" method="POST" focus="description">
                        <table>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="communicationSourceName" />
