    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <a href="<c:url value="/action/Configuration/Job/Main" />">Jobs</a> &gt;&gt;
                Edit
            </h2>
        </div>
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Configuration/Job/Edit" method="POST" focus="jobName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.jobName" />:</td>
                                <td>
                                    <html:text property="jobName" size="40" maxlength="40" /> (*)
                                    <et:validationErrors id="errorMessage" property="JobName">
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="originalJobName" />
                                </td>
