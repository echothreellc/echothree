    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <a href="<c:url value="/action/Configuration/PersonalTitle/Main" />">Personal Titles</a> &gt;&gt;
                Edit
            </h2>
        </div>
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Configuration/PersonalTitle/Edit" method="POST" focus="description">
                        <table>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="personalTitleId" />
                                </td>
