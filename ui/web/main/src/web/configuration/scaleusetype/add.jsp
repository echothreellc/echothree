...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            <html:form action="/Configuration/ScaleUseType/Add" method="POST" focus="scaleUseTypeName">
                <table>
                    <tr>
                        <td align=right><fmt:message key="label.scaleUseTypeName" />:</td>
                        <td>
                            <html:text property="scaleUseTypeName" size="40" maxlength="40" /> (*)
