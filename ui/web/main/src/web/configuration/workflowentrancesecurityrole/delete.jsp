        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;Workflow: <c:out value="${workflowEntranceSecurityRole.workflowEntrancePartyType.workflowEntrance.workflow.description}" /><br />
                    &nbsp;&nbsp;&nbsp;&nbsp;Workflow Entrance: <c:out value="${workflowEntranceSecurityRole.workflowEntrancePartyType.workflowEntrance.description}" /><br />
                    &nbsp;&nbsp;&nbsp;&nbsp;Party Type: <c:out value="${workflowEntranceSecurityRole.workflowEntrancePartyType.partyType.description}" /><br />
                    &nbsp;&nbsp;&nbsp;&nbsp;Security Role Group: <c:out value="${workflowEntranceSecurityRole.securityRole.securityRoleGroup.description}" /><br />
                    &nbsp;&nbsp;&nbsp;&nbsp;Security Role: <c:out value="${workflowEntranceSecurityRole.securityRole.description}" /><br />
                    <html:form action="/Configuration/WorkflowEntranceSecurityRole/Delete" method="POST">
                        <table>
                            <tr>
