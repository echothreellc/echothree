        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;Security Role Group: <c:out value="${securityRolePartyType.securityRole.securityRoleGroup.description}" /><br />
                    &nbsp;&nbsp;&nbsp;&nbsp;Security Role: <c:out value="${securityRolePartyType.securityRole.description}" /><br />
                    &nbsp;&nbsp;&nbsp;&nbsp;Party Type: <c:out value="${securityRolePartyType.partyType.description}" /><br />
                    <html:form action="/Configuration/SecurityRolePartyType/Delete" method="POST">
                        <table>
                            <tr>
