...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            <display:table name="filterTypes" id="filterType" class="displaytag">
                <display:column property="filterTypeName" titleKey="columnTitle.name" />
                <display:column titleKey="columnTitle.description">
                    <c:out value="${filterType.description}" />
                </display:column>
                <display:column>
