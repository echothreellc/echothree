...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            <html:form action="/Filter/FilterAdjustment/Add" method="POST" focus="filterAdjustmentName">
                <table>
                    <tr>
                        <td align=right><fmt:message key="label.filterAdjustmentName" />:</td>
                        <td>
                            <html:text property="filterAdjustmentName" size="40" maxlength="40" /> (*)
                    ...
                    <tr>
                        <td align=right><fmt:message key="label.filterAdjustmentSource" />:</td>
                        <td>
                            <html:select property="filterAdjustmentSourceChoice">
                                <html:optionsCollection property="filterAdjustmentSourceChoices" />
                            </html:select> (*)
                            <et:validationErrors id="errorMessage" property="FilterAdjustmentSourceName">
                                <p><c:out value="${errorMessage}" /></p>
                            </et:validationErrors>
                        </td>
                    </tr>
                    <tr>
                        <td align=right><fmt:message key="label.filterAdjustmentType" />:</td>
                        <td>
