...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            <display:table name="filterKinds" id="filterKind" class="displaytag">
                <display:column property="filterKindName" titleKey="columnTitle.name" />
                <display:column titleKey="columnTitle.description">
                    <c:out value="${filterKind.description}" />
                </display:column>
                <display:column>
