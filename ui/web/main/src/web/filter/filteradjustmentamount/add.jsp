    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <c:url var="filterAdjustmentsUrl" value="/action/Filter/FilterAdjustmentAmount/Main">
                    <c:param name="FilterKindName" value="${filterKindName}" />
        ...
        <div id="Content">
            ...
            <html:form action="/Filter/FilterAdjustmentAmount/Add" method="POST" focus="amount">
                <table>
                    <tr>
