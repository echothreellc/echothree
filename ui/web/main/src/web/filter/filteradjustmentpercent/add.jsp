    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <c:url var="filterAdjustmentsUrl" value="/action/Filter/FilterAdjustmentPercent/Main">
                    <c:param name="FilterKindName" value="${filterKindName}" />
        ...
        <div id="Content">
            ...
            <html:form action="/Filter/FilterAdjustmentPercent/Add" method="POST" focus="percent">
                <table>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <html:text property="percent" size="15" maxlength="15" /> (*)
