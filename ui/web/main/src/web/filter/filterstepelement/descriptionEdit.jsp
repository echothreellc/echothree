    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <c:url var="descriptionsUrl" value="/action/Filter/FilterStepElement/Description">
                    ...
                    <c:param name="FilterName" value="${filterName}" />
                    <c:param name="FilterStepName" value="${filterStepName}" />
                    <c:param name="FilterStepElementName" value="${filterStepElementName}" />
                </c:url>
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    <html:form action="/Filter/FilterStepElement/DescriptionEdit" method="POST" focus="description">
                        <table>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <html:hidden property="filterStepElementName" />
