    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <c:url var="filterStepElementsUrl" value="/action/Filter/FilterEntranceStep/Main">
                    <c:param name="FilterKindName" value="${filterKindName}" />
                    <c:param name="FilterTypeName" value="${filterTypeName}" />
                    <c:param name="FilterName" value="${filterName}" />
                </c:url>
                <a href="${filterStepElementsUrl}">Entrance Steps</a> &gt;&gt;
                Add
            </h2>
        </div>
        <div id="Content">
            ...
            <html:form action="/Filter/FilterEntranceStep/Add" method="POST">
                    <tr>
                        <td align=right><fmt:message key="label.filterStep" />:</td>
                        <td>
                            <html:select property="filterStepChoice">
                                <html:optionsCollection property="filterStepChoices" />
                            </html:select> (*)
                            <et:validationErrors id="errorMessage" property="FilterStepName">
