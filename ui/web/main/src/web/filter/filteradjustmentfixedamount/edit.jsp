        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Filter/FilterAdjustmentFixedAmount/Edit" method="POST" focus="unitAmount">
                        <table>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <html:hidden property="currencyChoice" />
                                    <html:hidden property="unitOfMeasureChoice" />
                                </td>
