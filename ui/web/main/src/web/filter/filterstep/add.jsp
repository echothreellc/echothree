...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            <html:form action="/Filter/FilterStep/Add" method="POST" focus="filterStepName">
                <table>
                    <tr>
                        <td align=right><fmt:message key="label.filterStepName" />:</td>
                        <td>
                            <html:text property="filterStepName" size="40" maxlength="40" /> (*)
