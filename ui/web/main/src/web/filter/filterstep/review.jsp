...
<html:html xhtml="true">
    <head>
        <title>Review (<c:out value="${filterStep.filterStepName}" />)</title>
        <html:base/>
    ...
    <body>
        <div id="Header">
            <h2>
                ...
                Review (<c:out value="${filterStep.filterStepName}" />)
            </h2>
        </div>
        <div id="Content">
            <p><font size="+2"><b><c:out value="${filterStep.description}" /></b></font></p>
            <br />
            Filter Kind: <c:out value="${filterStep.filter.filterType.filterKind.description}" /><br />
            Filter Type: <c:out value="${filterStep.filter.filterType.description}" /><br />
            <c:url var="filterUrl" value="/action/Filter/Filter/Review">
                <c:param name="FilterKindName" value="${filterStep.filter.filterType.filterKind.filterKindName}" />
                <c:param name="FilterTypeName" value="${filterStep.filter.filterType.filterTypeName}" />
                <c:param name="FilterName" value="${filterStep.filter.filterName}" />
            </c:url>
            Filter: <a href="${filterUrl}"><c:out value="${filterStep.filter.description}" /></a><br />
            <br />
            Filter Step Name: ${filterStep.filterStepName}<br />
            <br />
            <br />
            <br />
        </div>
