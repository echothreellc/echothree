...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            <html:form action="/Filter/Filter/Add" method="POST" focus="filterName">
                <table>
                    <tr>
                        <td align=right><fmt:message key="label.filterName" />:</td>
                        <td>
                            <html:text property="filterName" size="40" maxlength="40" /> (*)
                            <et:validationErrors id="errorMessage" property="FilterName">
                                <p><c:out value="${errorMessage}" /></p>
                            </et:validationErrors>
                        </td>
                    </tr>
                    </tr>
                        <td align=right><fmt:message key="label.initialFilterAdjustment" />:</td>
                        <td>
                            <html:select property="initialFilterAdjustmentChoice">
                                <html:optionsCollection property="initialFilterAdjustmentChoices" />
                            </html:select> (*)
                            <et:validationErrors id="errorMessage" property="InitialFilterAdjustmentName">
                                <p><c:out value="${errorMessage}" /></p>
                            </et:validationErrors>
                        </td>
                    </tr>
