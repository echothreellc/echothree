    ...
    <body>
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    <html:form action="/UnitOfMeasure/UnitOfMeasureKind/Edit" method="POST" focus="unitOfMeasureKindName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.unitOfMeasureKindName" />:</td>
                                <td>
                                    <html:text property="unitOfMeasureKindName" size="40" maxlength="40" /> (*)
                            ...
                            <tr>
                                <td align=right><fmt:message key="label.fractionDigits" />:</td>
                                <td>
                                    <html:text property="fractionDigits" size="12" maxlength="12" /> (*)
                                    <et:validationErrors id="errorMessage" property="FractionDigits">
                                        <p><c:out value="${errorMessage}" /></p>
                                    </et:validationErrors>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="originalUnitOfMeasureKindName" />
                                </td>
