...
<html>
    <head>
        <title><fmt:message key="navigation.unitsOfMeasure" /></title>
    ...
    <%@ include file="../include/body-start-b.jsp" %>
        ...
        <a href="<c:url value="/action/UnitOfMeasure/UnitOfMeasureKind/Main" />">Unit Of Measure Kinds</a><br />
        <a href="<c:url value="/action/UnitOfMeasure/UnitOfMeasureKindUseType/Main" />">Unit Of Measure Use Types</a>
