        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/UnitOfMeasure/UnitOfMeasureEquivalent/Edit" method="POST" focus="toQuantity">
                        <table>
                    <tr>
                        ...
                        <td>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <html:hidden property="fromUnitOfMeasureTypeName" />
                                    <html:hidden property="toUnitOfMeasureTypeName" />
                                </td>
