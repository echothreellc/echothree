...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            <html:form action="/Advertising/OfferChainType/Add/Step3" method="POST">
                <table>
                    <tr>
                        <td align=right><fmt:message key="label.chainChoice" />:</td>
                        <td>
                            <html:select property="chainChoice">
                                <html:optionsCollection property="chainChoices" />
                            </html:select>
