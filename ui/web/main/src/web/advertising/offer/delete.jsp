...
<html:html xhtml="true">
    <head>
        <title><fmt:message key="pageTitle.offers" /></title>
        <html:base/>
    ...
    <body>
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    <p>You are about to delete the <c:out value="${fn:toLowerCase(partyEntityType.entityType.description)}" /> &quot;<c:out value="${offer.description}" />.&quot;</p>
                    <html:form action="/Advertising/Offer/Delete" method="POST">
                        <table>
                            <tr>
