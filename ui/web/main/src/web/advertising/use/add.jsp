...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            <html:form action="/Advertising/Use/Add" method="POST" focus="useName">
                <table>
                    <tr>
                        <td align=right><fmt:message key="label.useName" />:</td>
                        <td>
                            <html:text property="useName" size="40" maxlength="40" /> (*)
                    ...
                    <tr>
                        <td align=right><fmt:message key="label.useType" />:</td>
                        <td>
                            <html:select property="useTypeChoice">
                                <html:optionsCollection property="useTypeChoices" />
                            </html:select> (*)
                            <et:validationErrors id="errorMessage" property="UseTypeName">
                                <p><c:out value="${errorMessage}" /></p>
                            </et:validationErrors>
                        </td>
                    </tr>
