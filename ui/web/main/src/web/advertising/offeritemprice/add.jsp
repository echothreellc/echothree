        ...
        <div id="Content">
            ...
            <c:choose>
                <c:when test="${item.itemPriceType.itemPriceTypeName == 'FIXED'}">
                    <html:form action="/Advertising/OfferItemPrice/Add" method="POST" focus="unitPrice">
                        <table>
                            <tr>
                ...
                <c:when test="${item.itemPriceType.itemPriceTypeName == 'VARIABLE'}">
                    <html:form action="/Advertising/OfferItemPrice/Add" method="POST" focus="minimumUnitPrice">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.inventoryConditionChoice" />:</td>
                                <td>
