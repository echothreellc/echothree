        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Advertising/UseType/Edit" method="POST" focus="useTypeName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.useTypeName" />:</td>
                                <td>
                                    <html:text property="useTypeName" size="40" maxlength="40" /> (*)
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="originalUseTypeName" />
                                </td>
