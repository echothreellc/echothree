...
<html:html xhtml="true">
    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <c:url var="descriptionsUrl" value="/action/Advertising/UseType/Description">
                    <c:param name="UseTypeName" value="${useTypeName}" />
                </c:url>
        ...
        <div id="Content">
            ...
            <html:form action="/Advertising/UseType/DescriptionAdd" method="POST" focus="description">
                <table>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <html:hidden property="useTypeName" />
                        </td>
