...
<html:html xhtml="true">
    ...
    <body onLoad="pageLoaded()">
        ...
        <div id="Content">
            ...
            <html:form action="/Content/ContentPageArea/Add" method="POST" focus="description">
                <table>
                    <tr>
                    ...
                    <c:if test="${contentPageLayoutArea.showDescriptionField}">
                        <tr>
                    ...
                    <c:if test="${contentPageLayoutArea.contentPageAreaType.contentPageAreaTypeName == 'LINK'}">
                        <tr>
