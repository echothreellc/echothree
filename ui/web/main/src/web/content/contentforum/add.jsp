...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            <html:form action="/Content/ContentForum/Add" method="POST">
                <table>
                    <tr>
                        <td align=right><fmt:message key="label.forumChoice" />:</td>
                        <td>
                            <html:select property="forumChoice">
                                <html:optionsCollection property="forumChoices" />
                            </html:select> (*)
