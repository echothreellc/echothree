...
<html:html xhtml="true">
    <head>
        <title>Review (<c:out value="${contentCategory.contentCategoryName}" />)</title>
        <html:base/>
    ...
    <body>
        <div id="Header">
            <h2>
                ...
                Review (<c:out value="${contentCategory.contentCategoryName}" />)
            </h2>
        </div>
        <div id="Content">
            <p><font size="+2"><b><c:out value="${contentCategory.description}" /></b></font></p>
            <br />
            Content Collection Name: ${contentCategory.contentCatalog.contentCollection.contentCollectionName}<br />
            Content Catalog Name: ${contentCategory.contentCatalog.contentCatalogName}<br />
            Content Category Name: ${contentCategory.contentCategoryName}<br />
            <br />
            <br />
            <br />
            <c:set var="tagScopes" scope="request" value="${contentCategory.tagScopes}" />
            <c:set var="entityAttributeGroups" scope="request" value="${contentCategory.entityAttributeGroups}" />
            <c:set var="entityInstance" scope="request" value="${contentCategory.entityInstance}" />
            <c:url var="returnUrl" scope="request" value="/../action/Content/ContentCategory/Review">
                <c:param name="ContentCollectionName" value="${contentCategory.contentCatalog.contentCollection.contentCollectionName}" />
                <c:param name="ContentCatalogName" value="${contentCategory.contentCatalog.contentCatalogName}" />
