...
<html:html xhtml="true">
    <head>
        <title><fmt:message key="pageTitle.contentSectionDescriptions" /></title>
        <html:base/>
    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <a href="${descriptionsUrl}"><fmt:message key="navigation.contentSectionDescriptions" /></a> &gt;&gt;
                Delete
            </h2>
        </div>
        <div id="Content">
            <p>You are about to delete the <c:out value="${contentSectionDescription.language.description}" />
            <c:out value="${fn:toLowerCase(partyEntityType.entityType.description)}" /> for &quot;<c:out value="${contentSectionDescription.contentSection.description}" />&quot;
            (<c:out value="${contentSectionDescription.contentSection.contentSectionName}" />).</p>
            <et:executionErrors id="errorMessage">
                <p class="executionErrors"><c:out value="${errorMessage}" /></p><br />
            </et:executionErrors>
            <html:form action="/Content/ContentSection/DescriptionDelete" method="POST">
                <table>
                    <tr>
