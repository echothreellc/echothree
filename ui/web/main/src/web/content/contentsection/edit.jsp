        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Content/ContentSection/Edit" method="POST" focus="contentSectionName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.contentSectionName" />:</td>
                                <td>
                                    <html:text property="contentSectionName" size="40" maxlength="40" /> (*)
                                    <et:validationErrors id="errorMessage" property="ContentSectionName">
                                        <p><c:out value="${errorMessage}" /></p>
                                    </et:validationErrors>
                                </td>
                            </tr>
                            <tr>
                                <td align=right><fmt:message key="label.parentContentSection" />:</td>
                                <td>
                                    <html:select property="parentContentSectionChoice">
                                        <html:optionsCollection property="parentContentSectionChoices" />
                                    </html:select>
                                    <et:validationErrors id="errorMessage" property="ParentContentSectionName">
                                        <p><c:out value="${errorMessage}" /></p>
                                    </et:validationErrors>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <html:hidden property="originalContentSectionName" />
                                </td>
