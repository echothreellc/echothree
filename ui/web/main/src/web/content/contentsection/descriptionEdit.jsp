    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <c:url var="descriptionsUrl" value="/action/Content/ContentSection/Description">
                    <c:param name="ContentCollectionName" value="${contentCollectionName}" />
        ...
        <div id="Content">
            ...
            <html:form action="/Content/ContentSection/DescriptionEdit" method="POST" focus="description">
                <table>
                    <tr>
