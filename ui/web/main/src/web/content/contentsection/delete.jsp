...
<html:html xhtml="true">
    <head>
        <title><fmt:message key="pageTitle.contentSections" /></title>
        <html:base/>
    ...
    <body>
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    <p>You are about to delete the <c:out value="${fn:toLowerCase(partyEntityType.entityType.description)}" /> &quot;<c:out value="${contentSection.description}" />.&quot;</p>
                    <html:form action="/Content/ContentSection/Delete" method="POST">
                        <table>
                            <tr>
