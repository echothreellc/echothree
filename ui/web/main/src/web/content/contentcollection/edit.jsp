        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Content/ContentCollection/Edit" method="POST" focus="contentCollectionName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.contentCollectionName" />:</td>
                                <td>
                                    <html:text property="contentCollectionName" size="40" maxlength="40" /> (*)
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="originalContentCollectionName" />
                                </td>
