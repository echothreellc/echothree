        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Content/ContentCatalog/Edit" method="POST" focus="contentCatalogName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.contentCatalogName" />:</td>
                                <td>
                                    <html:text property="contentCatalogName" size="40" maxlength="40" /> (*)
                                    <et:validationErrors id="errorMessage" property="ContentCatalogName">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <html:hidden property="originalContentCatalogName" />
                                </td>
