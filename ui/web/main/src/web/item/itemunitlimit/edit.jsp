...
<html:html xhtml="true">
    <head>
        <title>Unit Limits (<c:out value="${itemUnitLimit.item.itemName}" />)</title>
        <html:base/>
    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <a href="${reviewUrl}">Review (<c:out value="${itemUnitLimit.item.itemName}" />)</a> &gt;&gt;
                <c:url var="itemUnitLimitsUrl" value="/action/Item/ItemUnitLimit/Main">
                    <c:param name="ItemName" value="${itemUnitLimit.item.itemName}" />
                </c:url>
                <a href="${itemUnitLimitsUrl}">Unit Limits</a> &gt;&gt;
                Edit
            </h2>
        </div>
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Item/ItemUnitLimit/Edit" method="POST" focus="minimumQuantity">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.minimumQuantity" />:</td>
                                <td>
                                    <html:text property="minimumQuantity" size="12" maxlength="12" />
                                    <et:validationErrors id="errorMessage" property="MinimumQuantity">
                                        <p><c:out value="${errorMessage}" /></p>
                                    </et:validationErrors>
                                </td>
                            </tr>
                            <tr>
                                <td align=right><fmt:message key="label.maximumQuantity" />:</td>
                                <td>
                                    <html:text property="maximumQuantity" size="12" maxlength="12" />
                                    <et:validationErrors id="errorMessage" property="MaximumQuantity">
                                        <p><c:out value="${errorMessage}" /></p>
                                    </et:validationErrors>
                                </td>
                            </tr>
