...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;Item: <c:out value="${itemUnitLimit.item.description}" /><br />
            &nbsp;&nbsp;&nbsp;&nbsp;Inventory Condition: <c:out value="${itemUnitLimit.inventoryCondition.description}" /><br />
            &nbsp;&nbsp;&nbsp;&nbsp;Unit of Measure Type: <c:out value="${itemUnitLimit.unitOfMeasureType.description}" /><br />
            <et:executionErrors id="errorMessage">
                <p class="executionErrors"><c:out value="${errorMessage}" /></p><br />
            </et:executionErrors>
            <html:form action="/Item/ItemUnitLimit/Delete" method="POST">
                <table>
                    <tr>
