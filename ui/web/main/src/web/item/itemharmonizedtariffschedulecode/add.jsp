...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            <html:form action="/Item/ItemHarmonizedTariffScheduleCode/Add" method="POST" focus="harmonizedTariffScheduleCodeName">
                <table>
                    <tr>
                    ...
                    <tr>
                        <td align=right><fmt:message key="label.harmonizedTariffScheduleCodeUseType" />:</td>
                        <td>
                            <html:select property="harmonizedTariffScheduleCodeUseTypeChoice">
                    ...
                    <tr>
                        ...
                        <td>
                            <html:text property="harmonizedTariffScheduleCodeName" size="40" maxlength="40" /> (*)
