...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            <html:form action="/Item/ItemCategory/Add" method="POST" focus="itemCategoryName">
                <table>
                    <tr>
                        <td align=right><fmt:message key="label.itemCategoryName" />:</td>
                        <td>
                            <html:text property="itemCategoryName" size="40" maxlength="40" /> (*)
                    ...
                    <tr>
                        <td align=right><fmt:message key="label.parentItemCategory" />:</td>
                        <td>
                            <html:select property="parentItemCategoryChoice">
                                <html:optionsCollection property="parentItemCategoryChoices" />
                            </html:select>
                            <et:validationErrors id="errorMessage" property="ParentItemCategoryName">
                                <p><c:out value="${errorMessage}" /></p>
                            </et:validationErrors>
                        </td>
                    </tr>
