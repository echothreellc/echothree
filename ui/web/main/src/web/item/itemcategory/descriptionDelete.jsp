    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <a href="${descriptionsUrl}"><fmt:message key="navigation.itemCategoryDescriptions" /></a> &gt;&gt;
                Delete
            </h2>
        </div>
        <div id="Content">
            <p>You are about to delete the <c:out value="${itemCategoryDescription.language.description}" />
            <c:out value="${fn:toLowerCase(partyEntityType.entityType.description)}" /> for &quot;<c:out value="${itemCategoryDescription.itemCategory.description}" />&quot;
            (<c:out value="${itemCategoryDescription.itemCategory.itemCategoryName}" />).</p>
            <et:executionErrors id="errorMessage">
                <p class="executionErrors"><c:out value="${errorMessage}" /></p><br />
            </et:executionErrors>
            <html:form action="/Item/ItemCategory/DescriptionDelete" method="POST">
                <table>
                    <tr>
                ...
                <html:hidden property="itemCategoryName" />
