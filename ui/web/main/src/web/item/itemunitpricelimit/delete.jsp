...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;Item: <c:out value="${itemUnitPriceLimit.item.description}" /><br />
            &nbsp;&nbsp;&nbsp;&nbsp;Inventory Condition: <c:out value="${itemUnitPriceLimit.inventoryCondition.description}" /><br />
            &nbsp;&nbsp;&nbsp;&nbsp;Unit of Measure Type: <c:out value="${itemUnitPriceLimit.unitOfMeasureType.description}" /><br />
            &nbsp;&nbsp;&nbsp;&nbsp;Currency: <c:out value="${itemUnitPriceLimit.currency.description}" /><br />
            <et:executionErrors id="errorMessage">
                <p class="executionErrors"><c:out value="${errorMessage}" /></p><br />
            </et:executionErrors>
            <html:form action="/Item/ItemUnitPriceLimit/Delete" method="POST">
                <table>
                    <tr>
