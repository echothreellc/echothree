...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            <html:form action="/Item/ItemDescriptionTypeUse/Add" method="POST">
                <table>
                    <tr>
                        <td align=right><fmt:message key="label.itemDescriptionTypeUseType" />:</td>
                        <td>
                            <html:select property="itemDescriptionTypeUseTypeChoice">
                                <html:optionsCollection property="itemDescriptionTypeUseTypeChoices" />
                            </html:select> (*)
