    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <a href="${itemDescriptionTypeUsesUrl}"><fmt:message key="navigation.itemDescriptionTypeUses" /></a> &gt;&gt;
                Delete
            </h2>
        </div>
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;Item Description Type: <c:out value="${itemDescriptionTypeUse.itemDescriptionType.description}" /><br />
                    &nbsp;&nbsp;&nbsp;&nbsp;Item Description Type Use Type: <c:out value="${itemDescriptionTypeUse.itemDescriptionTypeUseType.description}" /><br />
                    <html:form action="/Item/ItemDescriptionTypeUse/Delete" method="POST">
                        <table>
                            <tr>
