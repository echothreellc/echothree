...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            <html:form action="/Item/HarmonizedTariffScheduleCodeUnit/Add" method="POST" focus="harmonizedTariffScheduleCodeUnitName">
                <table>
                    <tr>
                        <td align=right><fmt:message key="label.harmonizedTariffScheduleCodeUnitName" />:</td>
                        <td>
                            <html:text property="harmonizedTariffScheduleCodeUnitName" size="40" maxlength="40" /> (*)
                            <et:validationErrors id="errorMessage" property="HarmonizedTariffScheduleCodeUnitName">
