        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Item/HarmonizedTariffScheduleCodeUnit/Edit" method="POST" focus="harmonizedTariffScheduleCodeUnitName">
                        <table>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="originalHarmonizedTariffScheduleCodeUnitName" />
                                </td>
