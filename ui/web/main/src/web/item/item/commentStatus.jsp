    ...
    <body>
        <div id="Header">
            <h2>
                ...
                Status (<c:out value="${comment.commentName}" />)
            </h2>
        </div>
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    <html:form action="/Item/Item/CommentStatus" method="POST">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.commentStatus" />:</td>
                                <td>
                                    <html:select property="commentStatusChoice">
                                        <html:optionsCollection property="commentStatusChoices" />
                                    </html:select> (*)
                                    <et:validationErrors id="errorMessage" property="CommentStatusChoice">
