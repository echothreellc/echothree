        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Item/Item/CommentEdit" method="POST" focus="description">
                        <table>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <html:textarea property="clobComment" cols="${itemCommentEditorUse.preferredWidth}" rows="${itemCommentEditorUse.preferredHeight}" styleId="clobCommentTA" /> (*)
