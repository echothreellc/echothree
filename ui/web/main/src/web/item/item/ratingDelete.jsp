    ...
    <body>
        <div id="Header">
            <h2>
                ...
                Delete <c:out value="${rating.ratingTypeListItem.ratingType.description}" /> <c:out value="${partyEntityType.entityType.description}" />
            </h2>
        </div>
        <div id="Content">
            ...
            <html:form action="/Item/Item/RatingDelete" method="POST">
                <table>
                    <tr>
