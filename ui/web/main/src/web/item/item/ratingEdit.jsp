    ...
    <body onLoad="pageLoaded()">
        <div id="Header">
            <h2>
                ...
                Edit <c:out value="${rating.ratingTypeListItem.ratingType.description}" /> Rating
            </h2>
        </div>
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Item/Item/RatingEdit" method="POST" focus="description">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.ratingTypeListItem" />:</td>
                                <td>
                                    <html:select property="ratingTypeListItemChoice">
                                        <html:optionsCollection property="ratingTypeListItemChoices" />
                                    </html:select> (*)
                                    <et:validationErrors id="errorMessage" property="RatingTypeListItemName">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <html:hidden property="ratingName" />
                                </td>
