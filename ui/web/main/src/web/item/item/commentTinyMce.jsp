...
<et:partyApplicationEditorUse applicationName="main" applicationEditorUseName="ItemComment" var="itemCommentEditorUse" commandResultVar="unused" scope="request" />

<script type="text/javascript">
    var clobCommentTAHasEditor = false;
    
    function mimeTypeChoiceChange() {
        <c:if test="${itemCommentEditorUse.applicationEditor.editor.editorName == 'TINYMCE'}">
