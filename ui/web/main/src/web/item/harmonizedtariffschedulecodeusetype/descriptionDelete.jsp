...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            <p>You are about to delete the <c:out value="${harmonizedTariffScheduleCodeUseTypeDescription.language.description}" />
            <c:out value="${fn:toLowerCase(partyEntityType.entityType.description)}" /> for &quot;<c:out value="${harmonizedTariffScheduleCodeUseTypeDescription.harmonizedTariffScheduleCodeUseType.description}" />&quot;
            (<c:out value="${harmonizedTariffScheduleCodeUseTypeDescription.harmonizedTariffScheduleCodeUseType.harmonizedTariffScheduleCodeUseTypeName}" />).</p>
            <et:executionErrors id="errorMessage">
                <p class="executionErrors"><c:out value="${errorMessage}" /></p><br />
            </et:executionErrors>
            <html:form action="/Item/HarmonizedTariffScheduleCodeUseType/DescriptionDelete" method="POST">
                <table>
                    <tr>
