        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Item/HarmonizedTariffScheduleCodeUseType/Edit" method="POST" focus="harmonizedTariffScheduleCodeUseTypeName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.harmonizedTariffScheduleCodeUseTypeName" />:</td>
                                <td>
                                    <html:text property="harmonizedTariffScheduleCodeUseTypeName" size="40" maxlength="40" /> (*)
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="originalHarmonizedTariffScheduleCodeUseTypeName" />
                                </td>
