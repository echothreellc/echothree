...
<html:html xhtml="true">
    <head>
        <title>Pack Check Requirements (<c:out value="${itemPackCheckRequirement.item.itemName}" />)</title>
        <html:base/>
    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <a href="${reviewUrl}">Review (<c:out value="${itemPackCheckRequirement.item.itemName}" />)</a> &gt;&gt;
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Item/ItemPackCheckRequirement/Edit" method="POST" focus="minimumQuantity">
                        <table>
                            <tr>
