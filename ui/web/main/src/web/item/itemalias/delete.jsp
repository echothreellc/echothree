...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;Item: <c:out value="${itemAlias.item.description}" /><br />
            &nbsp;&nbsp;&nbsp;&nbsp;Unit of Measure Type: <c:out value="${itemAlias.unitOfMeasureType.description}" /><br />
            &nbsp;&nbsp;&nbsp;&nbsp;Item Alias Type: <c:out value="${itemAlias.itemAliasType.description}" /><br />
            &nbsp;&nbsp;&nbsp;&nbsp;Alias: <c:out value="${itemAlias.alias}" /><br />
            <et:executionErrors id="errorMessage">
                <p class="executionErrors"><c:out value="${errorMessage}" /></p><br />
            </et:executionErrors>
            <html:form action="/Item/ItemAlias/Delete" method="POST">
                <table>
                    <tr>
