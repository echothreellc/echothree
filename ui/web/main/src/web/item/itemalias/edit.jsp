...
<html:html xhtml="true">
    <head>
        <title>Aliases (<c:out value="${itemAlias.item.itemName}" />)</title>
        <html:base/>
    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <a href="${reviewUrl}">Review (<c:out value="${itemAlias.item.itemName}" />)</a> &gt;&gt;
                <c:url var="reviewUrl" value="/action/Item/ItemAlias/Main">
                    <c:param name="ItemName" value="${itemAlias.item.itemName}" />
                </c:url>
                <a href="${reviewUrl}">Aliases</a> &gt;&gt;
                Edit
            </h2>
        </div>
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Item/ItemAlias/Edit" method="POST" focus="alias">
                        <table>
                            <tr>
                            ...
                            <tr>
                                <td align=right><fmt:message key="label.itemAliasType" />:</td>
                                <td>
                                    <html:select property="itemAliasTypeChoice">
                                        <html:optionsCollection property="itemAliasTypeChoices" />
                                    </html:select> (*)
                            ...
                            <tr>
                                <td>
                                    ...
                                    <html:hidden property="originalAlias" />
                                </td>
