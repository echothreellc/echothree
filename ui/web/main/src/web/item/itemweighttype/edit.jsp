        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Item/ItemWeightType/Edit" method="POST" focus="itemWeightTypeName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.itemWeightTypeName" />:</td>
                                <td>
                                    <html:text property="itemWeightTypeName" size="40" maxlength="40" /> (*)
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="originalItemWeightTypeName" />
                                </td>
