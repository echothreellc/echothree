    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <a href="${descriptionsUrl}"><fmt:message key="navigation.itemWeightTypeDescriptions" /></a> &gt;&gt;
                Delete
            </h2>
        </div>
        <div id="Content">
            <p>You are about to delete the <c:out value="${itemWeightTypeDescription.language.description}" />
            <c:out value="${fn:toLowerCase(partyEntityType.entityType.description)}" /> for &quot;<c:out value="${itemWeightTypeDescription.itemWeightType.description}" />&quot;
            (<c:out value="${itemWeightTypeDescription.itemWeightType.itemWeightTypeName}" />).</p>
            <et:executionErrors id="errorMessage">
                <p class="executionErrors"><c:out value="${errorMessage}" /></p><br />
            </et:executionErrors>
            <html:form action="/Item/ItemWeightType/DescriptionDelete" method="POST">
                <table>
                    <tr>
