...
<html:html xhtml="true">
    <head>
        <title><fmt:message key="pageTitle.itemDescriptionTypeUseTypeDescriptions" /></title>
        <html:base/>
        ...
        <div id="Header">
            <h2>
                ...
                <c:url var="descriptionsUrl" value="/action/Item/ItemDescriptionTypeUseType/Description">
                    <c:param name="ItemDescriptionTypeUseTypeName" value="${itemDescriptionTypeUseTypeDescription.itemDescriptionTypeUseType.itemDescriptionTypeUseTypeName}" />
                </c:url>
                <a href="${descriptionsUrl}"><fmt:message key="navigation.itemDescriptionTypeUseTypeDescriptions" /></a> &gt;&gt;
                Edit
            </h2>
        </div>
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Item/ItemDescriptionTypeUseType/DescriptionEdit" method="POST" focus="description">
                        <table>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="itemDescriptionTypeUseTypeName" />
