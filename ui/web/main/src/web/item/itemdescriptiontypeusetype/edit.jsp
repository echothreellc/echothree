        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Item/ItemDescriptionTypeUseType/Edit" method="POST" focus="itemDescriptionTypeUseTypeName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.itemDescriptionTypeUseTypeName" />:</td>
                                <td>
                                    <html:text property="itemDescriptionTypeUseTypeName" size="40" maxlength="40" /> (*)
                                    <et:validationErrors id="errorMessage" property="ItemDescriptionTypeUseTypeName">
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="originalItemDescriptionTypeUseTypeName" />
                                </td>
