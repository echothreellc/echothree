        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Item/RelatedItemType/Edit" method="POST" focus="relatedItemTypeName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.relatedItemTypeName" />:</td>
                                <td>
                                    <html:text property="relatedItemTypeName" size="40" maxlength="40" /> (*)
                                    <et:validationErrors id="errorMessage" property="RelatedItemTypeName">
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="originalRelatedItemTypeName" />
                                </td>
