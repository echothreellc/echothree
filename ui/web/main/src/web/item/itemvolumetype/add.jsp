...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            <html:form action="/Item/ItemVolumeType/Add" method="POST" focus="itemVolumeTypeName">
                <table>
                    <tr>
                        <td align=right><fmt:message key="label.itemVolumeTypeName" />:</td>
                        <td>
                            <html:text property="itemVolumeTypeName" size="40" maxlength="40" /> (*)
