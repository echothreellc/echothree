...
<html:html xhtml="true">
    <head>
        <title><fmt:message key="pageTitle.itemImageTypeDescriptions" /></title>
        <html:base/>
        ...
        <div id="Header">
            <h2>
                ...
                <c:url var="descriptionsUrl" value="/action/Item/ItemImageType/Description">
                    <c:param name="ItemImageTypeName" value="${itemImageTypeDescription.itemImageType.itemImageTypeName}" />
                </c:url>
                <a href="${descriptionsUrl}"><fmt:message key="navigation.itemImageTypeDescriptions" /></a> &gt;&gt;
                Edit
            </h2>
        </div>
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Item/ItemImageType/DescriptionEdit" method="POST" focus="description">
                        <table>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="itemImageTypeName" />
