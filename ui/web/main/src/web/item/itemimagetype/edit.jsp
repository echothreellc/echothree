        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Item/ItemImageType/Edit" method="POST" focus="itemImageTypeName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.itemImageTypeName" />:</td>
                                <td>
                                    <html:text property="itemImageTypeName" size="40" maxlength="40" /> (*)
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="originalItemImageTypeName" />
                                </td>
