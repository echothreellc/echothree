...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;Party: <jsp:include page="../../include/party.jsp" /><br />
            &nbsp;&nbsp;&nbsp;&nbsp;Item: <c:out value="${partyInventoryLevel.item.description}" /><br />
            &nbsp;&nbsp;&nbsp;&nbsp;Inventory Condition: <c:out value="${partyInventoryLevel.inventoryCondition.description}" /><br />
            <et:executionErrors id="errorMessage">
                <p class="executionErrors"><c:out value="${errorMessage}" /></p><br />
            </et:executionErrors>
            <html:form action="/Item/PartyInventoryLevel/Delete" method="POST">
                <table>
                    <tr>
