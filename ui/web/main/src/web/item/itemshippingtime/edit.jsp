...
<html:html xhtml="true">
    <head>
        <title>Shipping Times (<c:out value="${itemShippingTime.item.itemName}" />)</title>
        <html:base/>
    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <a href="${reviewUrl}">Review (<c:out value="${itemShippingTime.item.itemName}" />)</a> &gt;&gt;
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Item/ItemShippingTime/Edit" method="POST" focus="unitShippingTime">
                        <table>
                            <tr>
