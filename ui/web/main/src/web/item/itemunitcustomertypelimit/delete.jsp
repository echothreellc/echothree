...
<html:html xhtml="true">
    <head>
        <title>Unit Customer Type Limits (<c:out value="${itemUnitCustomerTypeLimit.item.itemName}" />)</title>
        <html:base/>
    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <a href="${reviewUrl}">Review (<c:out value="${itemUnitCustomerTypeLimit.item.itemName}" />)</a> &gt;&gt;
        ...
        <div id="Content">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;Item: <c:out value="${itemUnitCustomerTypeLimit.item.description}" /><br />
            &nbsp;&nbsp;&nbsp;&nbsp;Inventory Condition: <c:out value="${itemUnitCustomerTypeLimit.inventoryCondition.description}" /><br />
            &nbsp;&nbsp;&nbsp;&nbsp;Unit of Measure Type: <c:out value="${itemUnitCustomerTypeLimit.unitOfMeasureType.description}" /><br />
            &nbsp;&nbsp;&nbsp;&nbsp;Customer Type: <c:out value="${itemUnitCustomerTypeLimit.customerType.description}" /><br />
            <et:executionErrors id="errorMessage">
                <p class="executionErrors"><c:out value="${errorMessage}" /></p><br />
            </et:executionErrors>
            <html:form action="/Item/ItemUnitCustomerTypeLimit/Delete" method="POST">
                <table>
                    <tr>
