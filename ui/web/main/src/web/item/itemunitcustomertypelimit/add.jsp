    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <c:url var="itemUnitCustomerTypeLimitsUrl" value="/action/Item/ItemUnitCustomerTypeLimit/Main">
                    <c:param name="ItemName" value="${item.itemName}" />
                </c:url>
                <a href="${itemUnitCustomerTypeLimitsUrl}">Unit Customer Type Limits</a> &gt;&gt;
                Add
            </h2>
        </div>
        <div id="Content">
            ...
            <html:form action="/Item/ItemUnitCustomerTypeLimit/Add" method="POST" focus="minimumQuantity">
                <table>
                    <tr>
