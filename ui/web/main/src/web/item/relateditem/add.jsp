...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            <html:form action="/Item/RelatedItem/Add" method="POST" focus="toItemName">
                <table>
                    <tr>
                        <td align=right><fmt:message key="label.toItemName" />:</td>
                        <td>
                            <html:text property="toItemName" size="40" maxlength="40" /> (*)
                            <et:validationErrors id="errorMessage" property="ToItemName">
