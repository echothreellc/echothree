...
<html:html xhtml="true">
    <head>
        <title>Unit Of Measure Types (<c:out value="${item.itemName}" />)</title>
        <html:base/>
    ...
    <body>
        ...
        <div id="Content">
            ...
            <display:table name="itemUnitOfMeasureTypes" id="itemUnitOfMeasureType" class="displaytag">
                <display:column titleKey="columnTitle.unitOfMeasureType">
                    <c:out value="${itemUnitOfMeasureType.unitOfMeasureType.description}" />
                </display:column>
                ...
                <display:column titleKey="columnTitle.default">
                    <c:choose>
                        ...
                        <c:otherwise>
                            <c:url var="setDefaultUrl" value="/action/Item/ItemUnitOfMeasureType/SetDefault">
