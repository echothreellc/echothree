...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;Item: <c:out value="${itemUnitOfMeasureType.item.description}" /><br />
            &nbsp;&nbsp;&nbsp;&nbsp;Unit of Measure Type: <c:out value="${itemUnitOfMeasureType.unitOfMeasureType.description}" /><br />
            <et:executionErrors id="errorMessage">
                <p class="executionErrors"><c:out value="${errorMessage}" /></p><br />
            </et:executionErrors>
            <html:form action="/Item/ItemUnitOfMeasureType/Delete" method="POST">
                <table>
                    <tr>
