...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;Item: <c:out value="${itemPrice.item.description}" /><br />
            &nbsp;&nbsp;&nbsp;&nbsp;Inventory Condition: <c:out value="${itemPrice.inventoryCondition.description}" /><br />
            &nbsp;&nbsp;&nbsp;&nbsp;Unit of Measure Type: <c:out value="${itemPrice.unitOfMeasureType.description}" /><br />
            &nbsp;&nbsp;&nbsp;&nbsp;Currency: <c:out value="${itemPrice.currency.description}" /><br />
            <et:executionErrors id="errorMessage">
                <p class="executionErrors"><c:out value="${errorMessage}" /></p><br />
            </et:executionErrors>
            <html:form action="/Item/ItemPrice/Delete" method="POST">
                <table>
                    <tr>
