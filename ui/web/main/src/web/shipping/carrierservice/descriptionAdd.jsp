...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            <html:form action="/Shipping/CarrierService/DescriptionAdd" method="POST" focus="description">
                <table>
                    <tr>
                    ...
                    <tr>
                        <td>
                            ...
                            <html:hidden property="carrierServiceName" />
                        </td>
