        ...
        <div id="Header">
            <h2>
                ...
                <c:url var="descriptionsUrl" value="/action/Shipping/CarrierOption/Description">
                    <c:param name="CarrierName" value="${carrierName}" />
                    <c:param name="CarrierOptionName" value="${carrierOptionName}" />
                </c:url>
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Shipping/CarrierOption/DescriptionEdit" method="POST" focus="description">
                        <table>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <html:hidden property="carrierOptionName" />
