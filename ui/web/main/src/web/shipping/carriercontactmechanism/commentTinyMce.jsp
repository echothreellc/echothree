...
<et:partyApplicationEditorUse applicationName="main" applicationEditorUseName="CarrierContactMechanismComment" var="carrierContactMechanismCommentEditorUse" commandResultVar="unused" scope="request" />

<script type="text/javascript">
    var clobCommentTAHasEditor = false;
    
    function mimeTypeChoiceChange() {
        <c:if test="${carrierContactMechanismCommentEditorUse.applicationEditor.editor.editorName == 'TINYMCE'}">
