    ...
    <body>
        <div id="Header">
            <h2>
                ...
                Carrier Contact Mechanism (<c:out value="${partyContactMechanism.contactMechanism.contactMechanismName}" />)
            </h2>
        </div>
        <div id="Content">
            ...
            <c:url var="addUrl" value="/action/Shipping/CarrierContactMechanism/CommentAdd">
            ...
            <c:choose>
                ...
                <c:otherwise>
                    <display:table name="comments.list" id="comment" class="displaytag">
                        ...
                        <display:column>
                            <c:url var="editUrl" value="/action/Shipping/CarrierContactMechanism/CommentEdit">
                                <c:param name="PartyName" value="${partyContactMechanism.party.partyName}" />
                                <c:param name="ContactMechanismName" value="${partyContactMechanism.contactMechanism.contactMechanismName}" />
                                <c:param name="CommentName" value="${comment.commentName}" />
                            </c:url>
                            <a href="${editUrl}">Edit</a>
                            <c:url var="deleteUrl" value="/action/Shipping/CarrierContactMechanism/CommentDelete">
                                <c:param name="PartyName" value="${partyContactMechanism.party.partyName}" />
                                <c:param name="ContactMechanismName" value="${partyContactMechanism.contactMechanism.contactMechanismName}" />
                                <c:param name="CommentName" value="${comment.commentName}" />
                            </c:url>
            ...
            <c:url var="returnUrl" scope="request" value="/../action/Shipping/CarrierContactMechanism/Review">
                <c:param name="PartyName" value="${partyContactMechanism.party.partyName}" />
                <c:param name="ContactMechanismName" value="${partyContactMechanism.contactMechanism.contactMechanismName}" />
            </c:url>
