        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Shipping/CarrierContactMechanism/CommentEdit" method="POST" focus="description">
                        <table>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <html:textarea property="clobComment" cols="${carrierContactMechanismCommentEditorUse.preferredWidth}" rows="${carrierContactMechanismCommentEditorUse.preferredHeight}" styleId="clobCommentTA" /> (*)
