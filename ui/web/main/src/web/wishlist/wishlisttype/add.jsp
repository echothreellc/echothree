...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            <html:form action="/Wishlist/WishlistType/Add" method="POST" focus="wishlistTypeName">
                <table>
                    <tr>
                        <td align=right><fmt:message key="label.wishlistTypeName" />:</td>
                        <td>
                            <html:text property="wishlistTypeName" size="40" maxlength="40" /> (*)
                            <et:validationErrors id="errorMessage" property="WishlistTypeName">
