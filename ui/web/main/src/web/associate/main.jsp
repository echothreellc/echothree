...
<html>
    <head>
        <title><fmt:message key="pageTitle.associates" /></title>
        <%@ include file="../include/environment-b.jsp" %>
    </head>
    <%@ include file="../include/body-start-b.jsp" %>
        <et:checkSecurityRoles securityRoles="AssociateProgram.List" />
        ...
        <et:hasSecurityRole securityRole="AssociateProgram.List">
