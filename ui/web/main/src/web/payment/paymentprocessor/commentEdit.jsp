    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <a href="${reviewUrl}">Review (<c:out value="${paymentProcessor.paymentProcessorName}" />)</a> &gt;&gt;
                Edit Comment
            </h2>
        </div>
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Payment/PaymentProcessor/CommentEdit" method="POST" focus="description">
                        <table>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <html:select property="mimeTypeChoice">
                            ...
                            <tr>
                                ...
                                <td>
                                    <html:textarea property="clobComment" cols="60" rows="20" /> (*)
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="paymentProcessorName" />
