...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            <html:form action="/Payment/PaymentProcessor/Add/Step2" method="POST" focus="paymentProcessorName">
                <table>
                    <tr>
                        <td align=right><fmt:message key="label.paymentProcessorName" />:</td>
                        <td>
                            <html:text property="paymentProcessorName" size="40" maxlength="40" /> (*)
                    ...
                    <tr>
                        <td>
                            <html:hidden property="paymentProcessorTypeName" />
                        </td>
