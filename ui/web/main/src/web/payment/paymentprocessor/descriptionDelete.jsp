...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            <p>You are about to delete the <c:out value="${paymentProcessorDescription.language.description}" />
            <c:out value="${fn:toLowerCase(partyEntityType.entityType.description)}" /> for &quot;<c:out value="${paymentProcessorDescription.paymentProcessor.description}" />&quot;
            (<c:out value="${paymentProcessorDescription.paymentProcessor.paymentProcessorName}" />).</p>
            <et:executionErrors id="errorMessage">
                <p class="executionErrors"><c:out value="${errorMessage}" /></p><br />
            </et:executionErrors>
            <html:form action="/Payment/PaymentProcessor/DescriptionDelete" method="POST">
                <table>
                    <tr>
