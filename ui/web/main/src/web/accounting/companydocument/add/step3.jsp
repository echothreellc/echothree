...
<html:html xhtml="true">
    <head>
        <title>Company Documents (<c:out value="${company.companyName}" />)</title>
        <html:base/>
    ...
    <body onLoad="pageLoaded()">
        ...
        <div id="Content">
            ...
            Adding <c:out value="${documentType.description}" />.<br />
            <c:choose>
                <c:when test='${documentType.mimeTypeUsageType.mimeTypeUsageTypeName == "TEXT"}'>
                    <jsp:include page="step3Clob.jsp" />
                </c:when>
                <c:otherwise>
                    <jsp:include page="step3Blob.jsp" />
                </c:otherwise>
            </c:choose>
        </div>
