...
<et:partyApplicationEditorUse applicationName="main" applicationEditorUseName="CompanyContactMechanismComment" var="companyContactMechanismCommentEditorUse" commandResultVar="unused" scope="request" />

<script type="text/javascript">
    var clobCommentTAHasEditor = false;
    
    function mimeTypeChoiceChange() {
        <c:if test="${companyContactMechanismCommentEditorUse.applicationEditor.editor.editorName == 'TINYMCE'}">
