    ...
    <body onLoad="pageLoaded()">
        <div id="Header">
            <h2>
                ...
                <c:url var="reviewUrl" value="/action/Accounting/CompanyContactMechanism/Review">
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Accounting/CompanyContactMechanism/CommentEdit" method="POST" focus="description">
                        <table>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <html:textarea property="clobComment" cols="${companyContactMechanismCommentEditorUse.preferredWidth}" rows="${companyContactMechanismCommentEditorUse.preferredHeight}" styleId="clobCommentTA" /> (*)
