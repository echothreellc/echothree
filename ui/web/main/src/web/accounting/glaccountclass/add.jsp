...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            <html:form action="/Accounting/GlAccountClass/Add" method="POST" focus="glAccountClassName">
                <table>
                    <tr>
                        <td align=right><fmt:message key="label.glAccountClassName" />:</td>
                        <td>
                            <html:text property="glAccountClassName" size="40" maxlength="40" /> (*)
                    ...
                    <tr>
                        <td align=right><fmt:message key="label.parentGlAccountClass" />:</td>
                        <td>
                            <html:select property="parentGlAccountClassChoice">
                                <html:optionsCollection property="parentGlAccountClassChoices" />
                            </html:select> (*)
                            <et:validationErrors id="errorMessage" property="ParentGlAccountClassName">
                                <p><c:out value="${errorMessage}" /></p>
                            </et:validationErrors>
                        </td>
                    </tr>
