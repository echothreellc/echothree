...
<html:html xhtml="true">
    <head>
        <title>Company Carrier Account (<c:out value="${partyCarrierAccount.carrier.partyGroup.name}" />)</title>
        <html:base/>
    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <c:url var="companyCarrierAccountsUrl" value="/action/Accounting/CompanyCarrierAccount/Main">
                    <c:param name="CompanyName" value="${company.companyName}" />
                </c:url>
                <a href="${companyCarrierAccountsUrl}">Carrier Accounts</a> &gt;&gt;
                Delete <c:out value="${partyCarrierAccount.carrier.partyGroup.name}" />
            </h2>
        </div>
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    &quot;<c:out value="${partyCarrierAccount.carrier.partyGroup.name}" />.&quot;
                    </p>
                    <html:form action="/Accounting/CompanyCarrierAccount/Delete" method="POST">
                        <table>
                            <tr>
