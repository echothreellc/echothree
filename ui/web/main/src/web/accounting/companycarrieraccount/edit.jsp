    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <a href="${companyCarrierAccountsUrl}"><fmt:message key="navigation.companyCarrierAccounts" /></a> &gt;&gt;
                Edit
            </h2>
        </div>
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Accounting/CompanyCarrierAccount/Edit" method="POST" focus="account">
                        <table>
                            <tr>
