...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            <display:table name="departments" id="department" class="displaytag">
                <display:column titleKey="columnTitle.name">
                    ...
                    <a href="${reviewUrl}"><c:out value="${department.departmentName}" /></a>
                </display:column>
                <display:column titleKey="columnTitle.description">
                    <c:out value="${department.partyGroup.name}" />
                </display:column>
                <display:column property="sortOrder" titleKey="columnTitle.sortOrder" />
                <display:column titleKey="columnTitle.default">
                    <c:choose>
                        <c:when test="${department.isDefault}">
                            Default
                        </c:when>
                        <c:otherwise>
                            <c:url var="setDefaultUrl" value="/action/Accounting/Department/SetDefault">
                                <c:param name="CompanyName" value="${department.division.company.companyName}" />
                                <c:param name="DivisionName" value="${department.division.divisionName}" />
                                <c:param name="DepartmentName" value="${department.departmentName}" />
                            </c:url>
                ...
                <display:column>
                    ...
                    <a href="${departmentContactMechanismsUrl}">Contact Mechanisms</a><br />
                    <c:url var="editUrl" value="/action/Accounting/Department/Edit">
                        <c:param name="CompanyName" value="${department.division.company.companyName}" />
                        <c:param name="DivisionName" value="${department.division.divisionName}" />
                        <c:param name="OriginalDepartmentName" value="${department.departmentName}" />
                    </c:url>
                    <a href="${editUrl}">Edit</a>
                    <c:url var="deleteUrl" value="/action/Accounting/Department/Delete">
                        <c:param name="CompanyName" value="${department.division.company.companyName}" />
                        <c:param name="DivisionName" value="${department.division.divisionName}" />
                        <c:param name="DepartmentName" value="${department.departmentName}" />
                    </c:url>
                ...
                <et:hasSecurityRole securityRole="Event.List">
                    <display:column>
                        <c:url var="eventsUrl" value="/action/Core/Event/Main">
                            <c:param name="EntityRef" value="${department.entityInstance.entityRef}" />
                        </c:url>
