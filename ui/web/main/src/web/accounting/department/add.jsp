...
<html:html xhtml="true">
    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <c:url var="departmentsUrl" value="/action/Accounting/Department/Main">
                    <c:param name="CompanyName" value="${companyName}" />
                    <c:param name="DivisionName" value="${divisionName}" />
                </c:url>
        ...
        <div id="Content">
            ...
            <html:form action="/Accounting/Department/Add" method="POST" focus="departmentName">
                <table>
                    <tr>
                        <td align=right><fmt:message key="label.departmentName" />:</td>
                        <td>
                            <html:text property="departmentName" size="40" maxlength="40" /> (*)
