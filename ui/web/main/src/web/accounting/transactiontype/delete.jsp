    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <a href="<c:url value="/action/Accounting/Main" />">Accountings</a> &gt;&gt;
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    <p>You are about to delete the <c:out value="${fn:toLowerCase(partyEntityType.entityType.description)}" /> &quot;<c:out value="${transactionType.description}" />.&quot;</p>
                    <html:form action="/Accounting/TransactionType/Delete" method="POST">
                        <table>
                            <tr>
