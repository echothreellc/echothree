        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Accounting/TransactionType/Edit" method="POST" focus="transactionTypeName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.transactionTypeName" />:</td>
                                <td>
                                    <html:text property="transactionTypeName" size="40" maxlength="40" /> (*)
                                    <et:validationErrors id="errorMessage" property="TransactionTypeName">
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="originalTransactionTypeName" />
                                </td>
