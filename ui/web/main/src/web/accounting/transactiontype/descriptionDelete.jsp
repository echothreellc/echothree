...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            <p>You are about to delete the <c:out value="${transactionTypeDescription.language.description}" />
            <c:out value="${fn:toLowerCase(partyEntityType.entityType.description)}" /> for &quot;<c:out value="${transactionTypeDescription.transactionType.description}" />&quot;
            (<c:out value="${transactionTypeDescription.transactionType.transactionTypeName}" />).</p>
            <et:executionErrors id="errorMessage">
                <p class="executionErrors"><c:out value="${errorMessage}" /></p><br />
            </et:executionErrors>
            <html:form action="/Accounting/TransactionType/DescriptionDelete" method="POST">
                <table>
                    <tr>
