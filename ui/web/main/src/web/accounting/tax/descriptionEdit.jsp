    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <c:url var="descriptionsUrl" value="/action/Accounting/Tax/Description">
                    <c:param name="TaxName" value="${taxName}" />
                </c:url>
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    <html:form action="/Accounting/Tax/DescriptionEdit" method="POST" focus="description">
                        <table>
                            <tr>
