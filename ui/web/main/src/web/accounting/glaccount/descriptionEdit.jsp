...
<html:html xhtml="true">
    <head>
        <title>Gl Account Descriptions</title>
        <html:base/>
        ...
        <div id="Header">
            <h2>
                ...
                <c:url var="descriptionsUrl" value="/action/Accounting/GlAccount/Description">
                    <c:param name="GlAccountName" value="${glAccountName}" />
                </c:url>
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Accounting/GlAccount/DescriptionEdit" method="POST" focus="description">
                        <table>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="glAccountName" />
