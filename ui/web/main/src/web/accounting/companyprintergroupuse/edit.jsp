    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <a href="${companyPrinterGroupUsesUrl}"><fmt:message key="navigation.companyPrinterGroupUses" /></a> &gt;&gt;
                Edit
            </h2>
        </div>
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Accounting/CompanyPrinterGroupUse/Edit" method="POST">
                        <table>
                            <tr>
