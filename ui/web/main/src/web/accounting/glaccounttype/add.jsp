...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            ...
            <html:form action="/Accounting/GlAccountCategory/Add" method="POST" focus="glAccountCategoryName">
                <table>
                    <tr>
                        <td align=right><fmt:message key="label.glAccountCategoryName" />:</td>
                        <td>
                            <html:text property="glAccountCategoryName" size="40" maxlength="40" /> (*)
                    ...
                    <tr>
                        <td align=right><fmt:message key="label.parentGlAccountCategory" />:</td>
                        <td>
                            <html:select property="parentGlAccountCategoryChoice">
                                <html:optionsCollection property="parentGlAccountCategoryChoices" />
                            </html:select> (*)
                            <et:validationErrors id="errorMessage" property="ParentGlAccountCategoryName">
                                <p><c:out value="${errorMessage}" /></p>
                            </et:validationErrors>
                        </td>
                    </tr>
