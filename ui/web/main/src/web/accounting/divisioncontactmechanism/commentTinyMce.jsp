...
<et:partyApplicationEditorUse applicationName="main" applicationEditorUseName="DivisionContactMechanismComment" var="divisionContactMechanismCommentEditorUse" commandResultVar="unused" scope="request" />

<script type="text/javascript">
    var clobCommentTAHasEditor = false;
    
    function mimeTypeChoiceChange() {
        <c:if test="${divisionContactMechanismCommentEditorUse.applicationEditor.editor.editorName == 'TINYMCE'}">
