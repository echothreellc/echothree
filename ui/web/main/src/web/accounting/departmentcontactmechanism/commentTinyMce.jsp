...
<et:partyApplicationEditorUse applicationName="main" applicationEditorUseName="DepartmentContactMechanismComment" var="departmentContactMechanismCommentEditorUse" commandResultVar="unused" scope="request" />

<script type="text/javascript">
    var clobCommentTAHasEditor = false;
    
    function mimeTypeChoiceChange() {
        <c:if test="${departmentContactMechanismCommentEditorUse.applicationEditor.editor.editorName == 'TINYMCE'}">
