    ...
    <body>
        <div id="Header">
            <h2>
                ...
                Department Contact Mechanism (<c:out value="${partyContactMechanism.contactMechanism.contactMechanismName}" />)
            </h2>
        </div>
        <div id="Content">
            ...
            <c:url var="addUrl" value="/action/Accounting/DepartmentContactMechanism/CommentAdd">
            ...
            <c:choose>
                ...
                <c:otherwise>
                    <display:table name="comments.list" id="comment" class="displaytag">
                        ...
                        <display:column>
                            <c:url var="editUrl" value="/action/Accounting/DepartmentContactMechanism/CommentEdit">
                                <c:param name="PartyName" value="${partyContactMechanism.party.partyName}" />
                                <c:param name="ContactMechanismName" value="${partyContactMechanism.contactMechanism.contactMechanismName}" />
                                <c:param name="CommentName" value="${comment.commentName}" />
                            </c:url>
                            <a href="${editUrl}">Edit</a>
                            <c:url var="deleteUrl" value="/action/Accounting/DepartmentContactMechanism/CommentDelete">
                                <c:param name="PartyName" value="${partyContactMechanism.party.partyName}" />
                                <c:param name="ContactMechanismName" value="${partyContactMechanism.contactMechanism.contactMechanismName}" />
                                <c:param name="CommentName" value="${comment.commentName}" />
                            </c:url>
            ...
            <c:url var="returnUrl" scope="request" value="/../action/Accounting/DepartmentContactMechanism/Review">
                <c:param name="PartyName" value="${partyContactMechanism.party.partyName}" />
                <c:param name="ContactMechanismName" value="${partyContactMechanism.contactMechanism.contactMechanismName}" />
            </c:url>
