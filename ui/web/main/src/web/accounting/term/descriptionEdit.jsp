    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <c:url var="descriptionsUrl" value="/action/Accounting/Term/Description">
                    <c:param name="TermName" value="${termName}" />
                </c:url>
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    <html:form action="/Accounting/Term/DescriptionEdit" method="POST" focus="description">
                        <table>
                            <tr>
