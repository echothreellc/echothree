...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div id="Content">
            <p>You are about to delete the <c:out value="${transactionEntityRoleTypeDescription.language.description}" />
            <c:out value="${fn:toLowerCase(partyEntityType.entityType.description)}" /> for &quot;<c:out value="${transactionEntityRoleTypeDescription.transactionEntityRoleType.description}" />&quot;
            (<c:out value="${transactionEntityRoleTypeDescription.transactionEntityRoleType.transactionEntityRoleTypeName}" />).</p>
            <et:executionErrors id="errorMessage">
                <p class="executionErrors"><c:out value="${errorMessage}" /></p><br />
            </et:executionErrors>
            <html:form action="/Accounting/TransactionEntityRoleType/DescriptionDelete" method="POST">
                <table>
                    <tr>
