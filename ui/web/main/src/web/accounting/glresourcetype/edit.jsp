    ...
    <body>
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    <html:form action="/Accounting/GlResourceType/Edit" method="POST" focus="glResourceTypeName">
                        <table>
                            <tr>
                                <td align=right><fmt:message key="label.glResourceTypeName" />:</td>
                                <td>
                                    <html:text property="glResourceTypeName" size="40" maxlength="40" /> (*)
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="originalGlResourceTypeName" />
                                </td>
