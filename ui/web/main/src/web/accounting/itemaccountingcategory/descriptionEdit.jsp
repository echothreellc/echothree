...
<html:html xhtml="true">
    <head>
        <title>Item Accounting Categories</title>
        <html:base/>
    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <a href="<c:url value="/action/Accounting/ItemAccountingCategory/Main" />">Item Accounting Categories</a> &gt;&gt;
                <c:url var="descriptionsUrl" value="/action/Accounting/ItemAccountingCategory/Description">
                    <c:param name="ItemAccountingCategoryName" value="${itemAccountingCategoryName}" />
                </c:url>
        ...
        <div id="Content">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <html:form action="/Accounting/ItemAccountingCategory/DescriptionEdit" method="POST" focus="description">
                        <table>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    <html:hidden property="itemAccountingCategoryName" />
