...
<html:html xhtml="true">
    <head>
        <title>Company Carriers (<c:out value="${company.companyName}" />)</title>
        <html:base/>
    ...
    <body>
        <div id="Header">
            <h2>
                ...
                <c:url var="companyCarriersUrl" value="/action/Accounting/CompanyCarrier/Main">
                    <c:param name="CompanyName" value="${company.companyName}" />
                </c:url>
                <a href="${companyCarriersUrl}">Carriers</a> &gt;&gt;
                Add Carrier
            </h2>
        </div>
        <div id="Content">
            ...
            <html:form action="/Accounting/CompanyCarrier/Add" method="POST">
                <table>
                    <tr>
