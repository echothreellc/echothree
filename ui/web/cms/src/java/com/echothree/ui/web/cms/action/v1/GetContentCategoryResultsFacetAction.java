...
import com.echothree.control.user.search.remote.form.GetContentCategoryResultsFacetForm;
...
@SproutAction(
    path = "/v1/GetContentCategoryResultsFacet",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "any")
    }
)
public class GetContentCategoryResultsFacetAction
        extends CmsBaseJsonAction {

    /** Creates a new instance of GetContentCategoryResultsFacetAction */
    public GetContentCategoryResultsFacetAction() {
        super(true, false);
    }
    ...
    protected CommandResult getCommandResult(HttpServletRequest request)
        ...
        return SearchUtil.getHome().getContentCategoryResultsFacet(getUserVisitPK(request), commandForm);
    }
