...
@SproutAction(
    path = "/v1/GetContentCategoryResults",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "any")
    }
)
public class GetContentCategoryResultsAction
        extends CmsBaseJsonAction {

    /** Creates a new instance of GetContentCategoryResultsAction */
    public GetContentCategoryResultsAction() {
        super(true, false);
    }
    ...
    protected CommandResult getCommandResult(HttpServletRequest request)
        ...
        return SearchUtil.getHome().getContentCategoryResults(getUserVisitPK(request), commandForm);
    }
