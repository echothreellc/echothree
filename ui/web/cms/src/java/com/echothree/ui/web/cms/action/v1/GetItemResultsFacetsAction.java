...
import com.echothree.control.user.search.remote.form.GetItemResultsFacetsForm;
...
@SproutAction(
    path = "/v1/GetItemResultsFacets",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "any")
    }
)
public class GetItemResultsFacetsAction
        extends CmsBaseJsonAction {

    /** Creates a new instance of GetItemResultsFacetsAction */
    public GetItemResultsFacetsAction() {
        super(true, false);
    }
    ...
    protected CommandResult getCommandResult(HttpServletRequest request)
        ...
        return SearchUtil.getHome().getItemResultsFacets(getUserVisitPK(request), commandForm);
    }
