...
@SproutAction(
    path = "/v1/GetItemResults",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "any")
    }
)
public class GetItemResultsAction
        extends CmsBaseJsonAction {

    /** Creates a new instance of GetItemResultsAction */
    public GetItemResultsAction() {
        super(true, false);
    }
    ...
    protected CommandResult getCommandResult(HttpServletRequest request)
        ...
        return SearchUtil.getHome().getItemResults(getUserVisitPK(request), commandForm);
    }
