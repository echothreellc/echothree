...
@SproutAction(
    path = "/v1/SearchForumMessages",
    mappingClass = SecureActionMapping.class,
    properties = {
        @SproutProperty(property = "secure", value = "any")
    }
)
public class SearchForumMessagesAction
        extends CmsBaseJsonAction {

    /** Creates a new instance of SearchForumMessagesAction */
    public SearchForumMessagesAction() {
        super(true, false);
    }
    ...
    protected CommandResult getCommandResult(HttpServletRequest request)
        ...
        commandForm.setIncludeFutureForumThreads(request.getParameter(ParameterConstants.INCLUDE_FUTURE_FORUM_THREADS));
        ...
        commandForm.setForumMessageTypeName(request.getParameter(ParameterConstants.FORUM_MESSAGE_TYPE_NAME));
        ...
        return SearchUtil.getHome().searchForumMessages(getUserVisitPK(request), commandForm);
    }
