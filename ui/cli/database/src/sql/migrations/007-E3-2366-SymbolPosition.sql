...
CREATE TABLE `symbolpositiondetails` (
  ...
  `symposdt_symbolpositionname` varchar(40) COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
CREATE TABLE `symbolpositiondescriptions` (
  ...
  `symposd_description` varchar(80) COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
ALTER TABLE currencies MODIFY cur_symbol VARCHAR(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
...
ALTER TABLE unitofmeasuretypedescriptions ADD COLUMN uomtd_symbol VARCHAR(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
UPDATE unitofmeasuretypedescriptions SET uomtd_symbol = 'PLACEHOLDER';
ALTER TABLE unitofmeasuretypedescriptions MODIFY COLUMN uomtd_symbol VARCHAR(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL;
