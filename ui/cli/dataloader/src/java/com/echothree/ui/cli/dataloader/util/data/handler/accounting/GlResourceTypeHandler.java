...
public class GlResourceTypeHandler
        extends BaseHandler {
    AccountingService accountingService;
    String glResourceTypeName;
    
    /** Creates a new instance of GlResourceTypeHandler */
    public GlResourceTypeHandler(InitialDataParser initialDataParser, BaseHandler parentHandler, String glResourceTypeName)
            throws SAXException {
    ...
    public void startElement(String namespaceURI, String localName, String qName, Attributes attrs)
        ...
        if(localName.equals("glResourceTypeDescription")) {
            ...
            accountingService.createGlResourceTypeDescription(initialDataParser.getUserVisit(), commandForm);
        }
    }
