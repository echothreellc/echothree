...
import com.echothree.control.user.forum.remote.form.CreateForumRoleTypeDescriptionForm;
...
public class ForumRoleTypeHandler
    ...
    throws SAXException {
        if(localName.equals("forumRoleTypeDescription")) {
            ...
            try {
                CreateForumRoleTypeDescriptionForm form = ForumFormFactory.getCreateForumRoleTypeDescriptionForm();
