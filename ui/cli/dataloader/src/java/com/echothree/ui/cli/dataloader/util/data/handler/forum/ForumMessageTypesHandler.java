...
public class ForumMessageTypesHandler
        extends BaseHandler {
    ForumService forumService;
    
    /** Creates a new instance of ForumMessageTypesHandler */
    public ForumMessageTypesHandler(InitialDataParser initialDataParser, BaseHandler parentHandler) {
    ...
    throws SAXException {
        if(localName.equals("forumMessageType")) {
            ...
            try {
                ...
                forumService.createForumMessageType(initialDataParser.getUserVisit(), form);
            } catch (Exception e) {
                throw new SAXException(e);
            }
            
            initialDataParser.pushHandler(new ForumMessageTypeHandler(initialDataParser, this, forumMessageTypeName));
        }
    }
    ...
    throws SAXException {
        if(localName.equals("forumMessageTypes")) {
