...
import com.echothree.control.user.core.remote.form.CreateServiceForm;
...
public class ServicesHandler
    ...
    public ServicesHandler(InitialDataParser initialDataParser, BaseHandler parentHandler)
            throws SAXException {
    ...
    public void startElement(String namespaceURI, String localName, String qName, Attributes attrs)
        ...
        if(localName.equals("service")) {
            ...
            coreService.createService(initialDataParser.getUserVisit(), commandForm);

            initialDataParser.pushHandler(new ServiceHandler(initialDataParser, this, commandForm.getServiceName()));
        }
    }
