...
import com.echothree.control.user.item.common.form.CreateItemUseTypeDescriptionForm;
...
public class ItemUseTypeHandler
    ...
    public void startElement(String namespaceURI, String localName, String qName, Attributes attrs)
        ...
        if(localName.equals("itemUseTypeDescription")) {
            ...
            try {
                CreateItemUseTypeDescriptionForm commandForm = ItemFormFactory.getCreateItemUseTypeDescriptionForm();
