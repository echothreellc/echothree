...
public class CommunicationEventRoleTypeHandler
        extends BaseHandler {
    CommunicationService communicationService;
    String communicationEventRoleTypeName;
    
    /** Creates a new instance of CommunicationEventRoleTypeHandler */
    public CommunicationEventRoleTypeHandler(InitialDataParser initialDataParser, BaseHandler parentHandler, String communicationEventRoleTypeName) {
    ...
    throws SAXException {
        if(localName.equals("communicationEventRoleTypeDescription")) {
            ...
            try {
                CreateCommunicationEventRoleTypeDescriptionForm form = CommunicationFormFactory.getCreateCommunicationEventRoleTypeDescriptionForm();
                
                form.setCommunicationEventRoleTypeName(communicationEventRoleTypeName);
                form.setLanguageIsoName(languageIsoName);
                form.setDescription(description);
                
                communicationService.createCommunicationEventRoleTypeDescription(initialDataParser.getUserVisit(), form);
            } catch (Exception e) {
