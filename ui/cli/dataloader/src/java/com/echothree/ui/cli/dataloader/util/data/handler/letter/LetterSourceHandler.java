...
public class LetterSourceHandler
        extends BaseHandler {
    LetterService letterService;
    String letterSourceName;
    
    /** Creates a new instance of LetterSourceHandler */
    public LetterSourceHandler(InitialDataParser initialDataParser, BaseHandler parentHandler, String letterSourceName)
            throws SAXException {
    ...
    public void startElement(String namespaceURI, String localName, String qName, Attributes attrs)
        ...
        if(localName.equals("letterSourceDescription")) {
            ...
            letterService.createLetterSourceDescription(initialDataParser.getUserVisit(), commandForm);
        }
    }
    ...
    public void endElement(String namespaceURI, String localName, String qName)
            throws SAXException {
        if(localName.equals("letterSource")) {
