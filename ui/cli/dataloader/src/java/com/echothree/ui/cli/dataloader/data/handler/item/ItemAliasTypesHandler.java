...
public class ItemAliasTypesHandler
    ...
    public void startElement(String namespaceURI, String localName, String qName, Attributes attrs)
        ...
        if(localName.equals("itemAliasType")) {
            ...
            itemService.createItemAliasType(initialDataParser.getUserVisit(), commandForm);
            
            initialDataParser.pushHandler(new ItemAliasTypeHandler(initialDataParser, this, commandForm.getItemAliasTypeName()));
        }
    }
