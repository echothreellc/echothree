...
import com.echothree.control.user.core.remote.form.CreateEditorDescriptionForm;
...
public class EditorHandler
    ...
    /** Creates a new instance of EditorHandler */
    public EditorHandler(InitialDataParser initialDataParser, BaseHandler parentHandler, String editorName)
            throws SAXException {
    ...
    public void startElement(String namespaceURI, String localName, String qName, Attributes attrs)
        ...
        if(localName.equals("editorDescription")) {
            ...
            coreService.createEditorDescription(initialDataParser.getUserVisit(), commandForm);
        }
    }
