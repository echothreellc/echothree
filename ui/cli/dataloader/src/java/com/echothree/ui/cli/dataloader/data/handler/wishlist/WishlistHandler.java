...
import com.echothree.control.user.wishlist.remote.form.CreateWishlistLineForm;
...
public class WishlistHandler
    ...
    throws SAXException {
        if(localName.equals("wishlistLine")) {
            ...
            try {
                CreateWishlistLineForm form = WishlistFormFactory.getCreateWishlistLineForm();
