...
import com.echothree.control.user.training.remote.form.CreatePartyTrainingClassForm;
...
public class PartyTrainingClassesHandler
    ...
    public void startElement(String namespaceURI, String localName, String qName, Attributes attrs)
        ...
        if(localName.equals("partyTrainingClass")) {
            CreatePartyTrainingClassForm commandForm = TrainingFormFactory.getCreatePartyTrainingClassForm();
