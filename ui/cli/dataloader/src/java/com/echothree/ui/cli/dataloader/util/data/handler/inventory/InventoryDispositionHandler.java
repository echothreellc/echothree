...
public class InventoryDispositionHandler
        extends BaseHandler {
    ...
    /** Creates a new instance of InventoryDispositionHandler */
    public InventoryDispositionHandler(InitialDataParser initialDataParser, BaseHandler parentHandler,
            String inventoryTransactionTypeName, String inventoryDispositionName)
            throws SAXException {
        ...
        this.inventoryDispositionName = inventoryDispositionName;
    }
    
    @Override
    public void startElement(String namespaceURI, String localName, String qName, Attributes attrs)
            throws SAXException {
        if(localName.equals("inventoryDispositionDescription")) {
            var commandForm = InventoryFormFactory.getCreateInventoryDispositionDescriptionForm();
    ...
    public void endElement(String namespaceURI, String localName, String qName)
            throws SAXException {
        if(localName.equals("inventoryDisposition")) {
