...
public class ItemImageTypeHandler
        extends BaseHandler {
    
    ItemService itemService;
    String itemImageTypeName;
    
    /** Creates a new instance of ItemImageTypeHandler */
    public ItemImageTypeHandler(InitialDataParser initialDataParser, BaseHandler parentHandler, String itemImageTypeName)
            throws SAXException {
    ...
    public void startElement(String namespaceURI, String localName, String qName, Attributes attrs)
            throws SAXException {
        if(localName.equals("itemImageTypeDescription")) {
            CreateItemImageTypeDescriptionForm commandForm = ItemFormFactory.getCreateItemImageTypeDescriptionForm();

            commandForm.setItemImageTypeName(itemImageTypeName);
            commandForm.set(getAttrsMap(attrs));

            itemService.createItemImageTypeDescription(initialDataParser.getUserVisit(), commandForm);
        }
    }
