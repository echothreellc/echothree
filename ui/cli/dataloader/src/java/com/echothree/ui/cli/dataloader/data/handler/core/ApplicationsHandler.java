...
import com.echothree.control.user.core.remote.form.CreateApplicationForm;
...
public class ApplicationsHandler
    ...
    public ApplicationsHandler(InitialDataParser initialDataParser, BaseHandler parentHandler)
            throws SAXException {
    ...
    public void startElement(String namespaceURI, String localName, String qName, Attributes attrs)
        ...
        if(localName.equals("application")) {
            ...
            coreService.createApplication(initialDataParser.getUserVisit(), commandForm);
            
            initialDataParser.pushHandler(new ApplicationHandler(initialDataParser, this, commandForm.getApplicationName()));
        }
    }
    ...
    public void endElement(String namespaceURI, String localName, String qName)
            throws SAXException {
        if(localName.equals("applications")) {
