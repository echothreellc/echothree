...
public class InventoryDispositionAdjustmentHandler
        extends BaseHandler {
    ...
    /** Creates a new instance of InventoryDispositionAdjustmentHandler */
    public InventoryDispositionAdjustmentHandler(InitialDataParser initialDataParser, BaseHandler parentHandler,
            String inventoryTransactionTypeName, String inventoryDispositionName, String inventoryDispositionAdjustmentName)
            throws SAXException {
    ...
    public void startElement(String namespaceURI, String localName, String qName, Attributes attrs)
            throws SAXException {
        if(localName.equals("inventoryDispositionAdjustmentDescription")) {
            var commandForm = InventoryFormFactory.getCreateInventoryDispositionAdjustmentDescriptionForm();
            ...
            checkCommandResult(inventoryService.createInventoryDispositionAdjustmentDescription(initialDataParser.getUserVisit(), commandForm));
        }
    }
    ...
    public void endElement(String namespaceURI, String localName, String qName)
            throws SAXException {
        if(localName.equals("inventoryDispositionAdjustment")) {
