...
public class TerminationTypesHandler
        extends BaseHandler {
    EmployeeService employeeService;
    
    /** Creates a new instance of TerminationTypesHandler */
    public TerminationTypesHandler(InitialDataParser initialDataParser, BaseHandler parentHandler) {
    ...
    throws SAXException {
        if(localName.equals("terminationType")) {
            ...
            try {
                ...
                employeeService.createTerminationType(initialDataParser.getUserVisit(), form);
                
                initialDataParser.pushHandler(new TerminationTypeHandler(initialDataParser, this, terminationTypeName));
            } catch (Exception e) {
    ...
    throws SAXException {
        if(localName.equals("terminationTypes")) {
