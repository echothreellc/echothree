...
public class ItemDescriptionTypeUseTypeHandler
        extends BaseHandler {
    
    ItemService itemService;
    String itemDescriptionTypeUseTypeName;
    
    /** Creates a new instance of ItemDescriptionTypeUseTypeHandler */
    public ItemDescriptionTypeUseTypeHandler(InitialDataParser initialDataParser, BaseHandler parentHandler, String itemDescriptionTypeUseTypeName)
            throws SAXException {
    ...
    public void startElement(String namespaceURI, String localName, String qName, Attributes attrs)
        ...
        if(localName.equals("itemDescriptionTypeUseTypeDescription")) {
            ...
            itemService.createItemDescriptionTypeUseTypeDescription(initialDataParser.getUserVisit(), commandForm);
        }
    }
