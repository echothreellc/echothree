...
import com.echothree.control.user.communication.remote.form.CreateCommunicationEventTypeDescriptionForm;
...
public class CommunicationEventTypeHandler
        extends BaseHandler {
    CommunicationService communicationService;
    String communicationEventTypeName;
    
    /** Creates a new instance of CommunicationEventTypeHandler */
    public CommunicationEventTypeHandler(InitialDataParser initialDataParser, BaseHandler parentHandler, String communicationEventTypeName) {
    ...
    throws SAXException {
        if(localName.equals("communicationEventTypeDescription")) {
            ...
            try {
                ...
                communicationService.createCommunicationEventTypeDescription(initialDataParser.getUserVisit(), form);
            } catch (Exception e) {
