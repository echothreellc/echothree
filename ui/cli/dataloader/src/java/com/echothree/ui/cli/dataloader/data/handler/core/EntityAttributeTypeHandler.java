...
import com.echothree.control.user.core.remote.form.CreateEntityAttributeTypeDescriptionForm;
...
public class EntityAttributeTypeHandler
    ...
    throws SAXException {
        if(localName.equals("entityAttributeTypeDescription")) {
            ...
            try {
                CreateEntityAttributeTypeDescriptionForm createEntityAttributeTypeDescriptionForm = CoreFormFactory.getCreateEntityAttributeTypeDescriptionForm();
