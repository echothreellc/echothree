...
public class GlAccountTypeHandler
        extends BaseHandler {
    AccountingService accountingService;
    String glAccountTypeName;
    
    /** Creates a new instance of GlAccountTypeHandler */
    public GlAccountTypeHandler(InitialDataParser initialDataParser, BaseHandler parentHandler, String glAccountTypeName)
            throws SAXException {
    ...
    public void startElement(String namespaceURI, String localName, String qName, Attributes attrs)
        ...
        if(localName.equals("glAccountTypeDescription")) {
            ...
            accountingService.createGlAccountTypeDescription(initialDataParser.getUserVisit(), commandForm);
        }
    }
