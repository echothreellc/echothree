...
import com.echothree.control.user.core.remote.form.CreateFontWeightDescriptionForm;
...
public class FontWeightHandler
        extends BaseHandler {
    
    CoreService coreService;
    String fontWeightName;
    
    /** Creates a new instance of FontWeightHandler */
    public FontWeightHandler(InitialDataParser initialDataParser, BaseHandler parentHandler, String fontWeightName)
            throws SAXException {
    ...
    public void startElement(String namespaceURI, String localName, String qName, Attributes attrs)
        ...
        if(localName.equals("fontWeightDescription")) {
            ...
            coreService.createFontWeightDescription(initialDataParser.getUserVisit(), commandForm);
        }
    }
    ...
    public void endElement(String namespaceURI, String localName, String qName)
            throws SAXException {
        if(localName.equals("fontWeight")) {
